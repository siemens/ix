...
const EventListItem = class {
  ...
  render() {
    ...
    return h(Host, { key: "ef4bd40aaeeb4088b069b7a02a03c57d6b5d59fa", class: {
      disabled: this.disabled,
      [`event-list-item-${this.variant}`]: true
    } }, h("div", { key: "e62ab2ddcde03e90232ede63e76e2c35c1958a86", role: "listitem", "aria-disabled": a11yBoolean(this.disabled), class: {
      "event-list-item": true,
      selected: this.selected,
      disabled: this.disabled
    } }, h("div", { key: "7e82f4d3579091c208a5f5469fdf6b79037d37f7", class: `indicator ${!this.itemColor ? "indicator-empty" : ""}`, style: {
      "background-color": this.itemColor ? color : "inherit",
      opacity: `${this.disabled ? 0.4 : 1}`
    } }), h("div", { key: "3fa16c0448a79bed6ed43c845920958a97fc6663", class: "event-list-item-container" }, h("div", { key: "e23aa0348e97038410607c3ed9e815987d2a2285", class: "event-content" }, h("slot", { key: "fd7a3c66fb1c5e7481375dc3de5b3eb56c04c207" })), this.chevron && h("ix-icon", { key: "f4ac2b179f720a8888bfddafd705b84a93de89a5", name: iconChevronRight, size: "16", class: "chevron-icon", "aria-hidden": "true" }))));
  }
};
