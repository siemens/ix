...
const RangeField = class extends Mixin(...DefaultMixins) {
  ...
  render() {
    return h(Host, { key: "a58fd9e777295838a55981a4c9b126a54e12ec57", class: { "hide-arrow": this.hideArrow }, role: "group" }, !this.hideArrow && h("ix-icon", { key: "15000cdbfaef97a2043697dcf02407392251071c", "aria-hidden": "true", class: {
      "range-delimiter": true,
      "has-label": this.hasLabel
    }, name: iconArrowRight }), h("slot", { key: "1783d0efbe0b827dcc97ac5fdf0d05ec8e5363f9" }));
  }
};
