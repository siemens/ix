import { M as Mixin, r as registerInstance, g as getElement, h, H as Host } from "./global-CSIWS5Ku.js";
import { B as BaseIconButton } from "./base-icon-button-DufFLJC--D-CyYZOB.js";
...
import "./base-button-DZdtpLxn-XzQQ3Iar.js";
...
const IconButton = class extends Mixin(...DefaultMixins, InheritAriaAttributesMixin) {
  ...
  render() {
    ...
    return h(Host, { key: "c2ac53a1e2550d1ad2b03199c38f0c839290a23a", class: {
      ...this.getIconSizeClass(),
      disabled: this.disabled || this.loading
    }, tabIndex: this.disabled ? -1 : 0 }, h(BaseIconButton, { key: "3f298aea82baf37434aba6dd7abb1d5f3b3c2d49", ...baseButtonProps }));
  }
...
const Spinner = class {
  ...
  render() {
    ...
    return h(Host, { key: "91bec561f0cc6c2a5d3889f87c40c1ebc1aade26", ...ariaProperties }, h("div", { key: "4af6dfc9636a3ba35e366fd22ae412703600dc71", class: {
