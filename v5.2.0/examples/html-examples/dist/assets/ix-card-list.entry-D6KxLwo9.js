import { r as registerInstance, c as createEvent, g as getElement, h, H as Host, F as Fragment } from "./global-CSIWS5Ku.js";
...
const CardList = class {
  ...
  render() {
    return h(Host, { key: "d1b1abd076a1b31129e19e274d6dab77f24313da" }, h(CardListTitle, { key: "b373cdd9bc13b74b14fa1a8c9dde0b334f69ea25", isCollapsed: this.collapse, label: this.label, showAllLabel: this.i18nShowAll, showAllCounter: this.showAllCount === void 0 ? this.numberOfAllChildElements : this.showAllCount, showLess: this.isShowingAll, labelShowLess: this.i18nShowLess, onClick: () => this.onCardListVisibilityToggle(), onShowAllClick: (e) => this.onShowAllClick(e), hideShowAll: this.hideShowAll }), h("div", { key: "65f52725508a90988475b2c857f19f413ac0eaea", class: {
      CardList__Overflow: true
    }, style: this.computeMaskLayer() }, h("div", { key: "8ac900d06594e871269031102b18a6eeee1d3328", class: {
    ...
    }, onScroll: () => this.onCardListScroll() }, h("slot", { key: "5e2d74d6ee44b418d10f9474ea1eb117de0e1dde", onSlotchange: () => {
      this.changeVisibilityOfSlotChildren();
