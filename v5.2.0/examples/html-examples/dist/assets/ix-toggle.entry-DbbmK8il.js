...
const Toggle = class extends Mixin(...DefaultMixins, InheritAriaAttributesMixin) {
  ...
  render() {
    ...
    return h(Host, { key: "dfce142e6f205af9dc1ea257a70eb856a79d9036", ...this.inheritAriaAttributes, role: "switch", tabindex: this.disabled ? -1 : 0, "aria-label": ariaLabel, "aria-checked": ariaChecked, "aria-disabled": a11yBoolean(this.disabled), "aria-required": a11yBoolean(this.required), class: {
    ...
    } }, h("div", { key: "955c8454334240caa26237b2b43f076bd182f3b0", class: "wrapper" }, h("div", { key: "4605ec40f60e55dcbf6b8b3a9dc62b7efc686cc7", class: {
      switch: true,
      checked: this.checked,
      indeterminate: this.indeterminate
    }, "aria-hidden": "true" }, h("div", { key: "dba466d3a8a56f0119d47b8cd9f841c94134f0f4", class: "slider" })), !this.hideText && h("ix-typography", { key: "9a27e29d71cbf24873b39b3ffadde5422f8b4d7c", class: "label", "aria-hidden": "true" }, toggleText)));
  }
