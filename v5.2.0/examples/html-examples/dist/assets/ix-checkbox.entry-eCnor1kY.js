import { r as registerInstance, c as createEvent, g as getElement, h, F as Fragment, H as Host } from "./global-CSIWS5Ku.js";
...
const Checkbox = class {
  ...
  render() {
    return h(Host, { key: "841d4e03e9bcffc66579809c0809bd37f305e864", "aria-checked": a11yBoolean(this.checked), "aria-disabled": a11yBoolean(this.disabled), role: "checkbox", class: {
      disabled: this.disabled,
      checked: this.checked,
      indeterminate: this.indeterminate,
      "label-less": this.isLabelLess
    }, onFocus: () => this.touched = true, onBlur: () => this.ixBlur.emit() }, h("label", { key: "524cbab0a0622122163987aa1a1f1e39a0db5ac3" }, h("input", { key: "bef29038de37671fa191f77fcdbb3b29c1dd3751", "aria-checked": a11yBoolean(this.checked), required: this.required, disabled: this.disabled, checked: this.checked, ref: this.inputRef, type: "checkbox", onChange: () => this.setCheckedState(!this.checked) }), h("div", { key: "efffb955c45ab14f6443575cf1e133a25b618b65", class: "checkbox-button" }, h("button", { key: "8ee2985582e72db56890f1ddb1dccc866b826bee", disabled: this.disabled, class: {
      checked: this.checked
    }, onClick: () => this.setCheckedState(!this.checked) }, this.renderCheckmark())), h("ix-typography", { key: "3e0cb500340b56defdd95c5852f83ecccb2f1ee2", format: "label", textColor: this.disabled ? "weak" : "std" }, this.label, h("slot", { key: "3ff1f016da3c3706688e6c6e696c15bb4c30273b", onSlotchange: () => this.updateDefaultSlotElements(), ref: (element) => this.defaultSlotElement = element }))));
  }
