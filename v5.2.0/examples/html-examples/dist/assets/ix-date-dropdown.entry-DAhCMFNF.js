...
import { B as BaseButton } from "./base-button-DZdtpLxn-XzQQ3Iar.js";
...
const DateDropdown = class extends Mixin(...DefaultMixins) {
  ...
  render() {
    ...
    return h(Host, { key: "78dc279b664c3c1f6e2573339fba8d8411f550c1", onFocusout: (event) => {
      ...
      this.closeDropdown();
    }, role: "presentation" }, h("ix-button", { key: "f75c81dc6216f9820592bf206bea339f885d6b86", "data-testid": "date-dropdown-trigger", "data-date-dropdown-trigger": true, variant: this.variant, loading: this.loading, icon: iconHistory, ref: this.triggerRef, disabled: this.disabled, ...this.inheritAriaAttributes, "aria-haspopup": "true", "aria-expanded": a11yBoolean(this.show), "aria-controls": "date-dropdown", "aria-label": ariaLabel, [TRAP_FOCUS_EXCLUDE_ATTRIBUTE]: true }, this.getButtonLabel()), h("ix-dropdown", { key: "8ce5b79d0835d7897bd173f9aa6621df059e3b8a", focusTrapOptions: {
    ...
    } }, h("div", { key: "5646a506601693624231edc419207f940d406d78", class: "container" }, this.dateRangeOptions?.length > 1 && h("div", { key: "3281223a893f899762410a38d7344900b6e7b660", class: {
    ...
    } }, dateRangeOption.label))), h("div", { key: "55483935e80df7b177050ebfa34e4b80e7595085", class: "picker-wrapper" }, h("ix-date-picker", { key: "4d4217263944a6e2b5dce4e66b48121af97589ec", ref: this.datePickerRef, embedded: true, locale: this.locale, onDateChange: (e) => {
      e.stopPropagation();
      this.currentRangeValue = {
        ...e.detail,
        id: "custom"
      };
    }, onDateRangeChange: (e) => e.stopPropagation(), format: this.format, singleSelection: this.singleSelection, from: this.from || this.currentRangeValue?.from, to: this.to || this.currentRangeValue?.to, minDate: this.minDate, maxDate: this.maxDate, today: this.today, weekStartIndex: this.weekStartIndex, showWeekNumbers: this.showWeekNumbers }), h("div", { key: "7eeb2c63d66113904afa26eb156e562765dcfd8b", class: "pull-right" }, h("ix-button", { key: "e08ceb4e5eb5bdd1251e0003ab38d8f0812bb2e4", onClick: () => {
      if (this.currentRangeValue) {
        this.onDateSelect(this.currentRangeValue);
        this.closeDropdown();
      }
