import { M as Mixin, r as registerInstance, g as getElement, h, H as Host, c as createEvent, a as readTask } from "./global-CSIWS5Ku.js";
...
import { I as InheritAriaAttributesMixin } from "./inherit-aria-attributes.mixin-nCmPujqf-FN3lQkIc.js";
...
const Pill = class extends Mixin(...DefaultMixins) {
  ...
  render() {
    ...
    return h(Host, { key: "c6cf91e2262d0de3124907b41df29c865c7bf9e8", style: this.variant === "custom" ? {
      "--ix-icon-button-color": this.pillColor
    } : {}, class: {
      "align-left": this.alignLeft
    }, role: hostRole }, h("div", { key: "9ed2a26ddfc89f2a0513e9f77dd0593b4fbb6937", ref: this.containerElementRef, style: { ...customStyle }, class: {
      container: true,
    ...
    } }, this.icon && h("ix-icon", { key: "7fb18ad45b61668971f4b80681c055a1464bd411", class: {
      "with-icon": true
    }, name: this.icon, size: "16", "aria-label": this.ariaLabelIcon, "aria-hidden": a11yBoolean(iconIsDecorative) }), h("span", { key: "90c873c38e483753e55f74d6011484f267428ea2", class: "slot-container" }, h("slot", { key: "c06188bc128054fcbe619e236bc1bd51f58bda04", onSlotchange: () => this.checkIfContentAvailable() }))), this.getTooltip());
  }
};
Pill.style = pillCss();
...
const TabItem = class extends Mixin(...DefaultMixins, ComponentIdMixin, BaseTabMixin) {
  ...
  render() {
    ...
    return h(Host, { key: "c423ec0f0b34d525d81d93af0d2dcc43ec685cc3", id: this.getHostElementId(), role: "tab", "aria-selected": a11yBoolean(this.selected), tabIndex: this.selected && !this.disabled ? 0 : -1, class: {
    ...
    } }, variant === "rounded" && h("div", { key: "ec1db119935bd5693ac51f5e02e7e4f3242736e5", class: {
      circle: true
    } }, this.icon && h("ix-icon", { key: "5cea2cc3c2c8d79062dec352fc214bccbb89a8ae", name: this.icon, size: "24" }), h("slot", { key: "ffc76fb1e1dd297b775b0cad91a0ccd6535be34c" })), this.icon && variant !== "rounded" && h("ix-icon", { key: "f546c939f3e5c818de0566536bf8ee8820d6630f", name: this.icon, size: "16", class: "tab-icon" }), variant === "normal" && h("div", { key: "0d3f3f7472fc3268af748ff488efd6fe33e7b093", class: {
      text: !!this.label,
      selected: this.selected,
      disabled: this.disabled
    } }, this.label, h("slot", { key: "8c80568d9b0ffbf484ff0e927af80b4a46cc1409" })), variant === "rounded" && this.counter !== void 0 && h("div", { key: "a8db1ac3b84882a4b4acc47627d0413d17e20fef", class: {
      counter: true,
      selected: this.selected,
      disabled: this.disabled
    } }, this.counter), this.counter && variant !== "rounded" && h("ix-pill", { key: "1950e9d85f17d7f272f4d9030ce1a2719a109d65", variant: "primary", outline: true, class: "tab-counter" }, this.counter), this.closable && variant !== "rounded" && h("ix-icon-button", { key: "533b8ff026ba1f3b79fb9b47ed4b08af04998094", "aria-label": this.ariaLabelCloseButton, class: "close-tab", size: "12", variant: "subtle-tertiary", icon: iconClose, onClick: (event) => {
      event.stopPropagation();
      event.preventDefault();
      this.tabClose.emit({
        tabKey: this.tabKey,
...
const TabSet = class {
  ...
  render() {
    return h(Host, { key: "f28c559bafdf3e05b4967e99404d7e85384066b3", onTabChange: () => this.checkPanelsVisibility() }, h("slot", { key: "1975df293f4dc62b9d90143507cedbca33173cc6" }));
  }
};
...
const Tabs = class extends Mixin(...DefaultMixins, InheritAriaAttributesMixin) {
  ...
  render() {
    return h(Host, { key: "d2a832712f08d37e96de8e74011b03bba351e183", onTabClick: (event) => this.onTabClick(event), class: {
      small: this.small
    } }, h("div", { key: "33a44d89607665ed75cafce82f708aa41752f2e0", ref: this.tabsContainerRef, class: {
      "tabs-container": true,
      top: this.placement === "top",
      bottom: this.placement === "bottom"
    } }, h("div", { key: "314a18c0bc383850f9f385d2a06c931d0ab7aa65", class: {
      "overflow-shadow-container": true,
      "overflow-shadow": this.isTabsOverflow
    } }, h("div", { key: "2c85fd1ec1386e57be5db175986f7f7fd75e6bb9", role: "tablist", ...this.inheritAriaAttributes, ref: this.tabsRef, class: {
      tabs: true,
      "tabs-stretched": this.layout === "stretched"
    }, tabIndex: this.isTabsOverflow ? 0 : -1, onKeyDown: (event) => this.onTabsNavigate(event) }, h("slot", { key: "d5544acd4f46ffb4213570080743a7f727f6ab70" }))), this.isTabsOverflow && this.layout !== "stretched" && h("ix-dropdown-button", { key: "4dd5009832886371778c248edeb6c88d11fa413a", ariaLabel: this.ariaLabelMoreTabs, icon: iconMoreMenu, class: {
