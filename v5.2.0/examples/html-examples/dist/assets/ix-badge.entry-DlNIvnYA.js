...
const Badge = class extends Mixin(...DefaultMixins, InheritAriaAttributesMixin, ComponentIdMixin) {
  ...
  render() {
    ...
    return h(Host, { key: "a1e470179571bf04b8d6e4ff4ec84e97e483fff2", ...this.hasAnchor ? {} : this.inheritAriaAttributes, class: {
    ...
    } }, h("slot", { key: "839f2b61f85bcee3ac924543f380ded20c5c35fe", name: BADGE_DESCRIPTION_SLOT }), h("div", { key: "8de1da037a7ee0ccbe467feea6c454f72ee4acf8", class: "anchor" }, h("slot", { key: "a8383610a6db3d3ae315dd21ba5aa7c18b9b46d0", ref: this.setSlotRef, onSlotchange: this.onSlotChange })), this.renderIndicator(type, variant, accessibleText, formattedLabel), this.getTooltip(formattedLabel));
  }
  static get watchers() {
    return {
      "role": [{
