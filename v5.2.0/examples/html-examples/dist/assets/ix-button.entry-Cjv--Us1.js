...
const Button = class extends Mixin(...DefaultMixins, InheritAriaAttributesMixin) {
  ...
  render() {
    ...
    return h(Host, { key: "6a0f74af1271c5450ed7bf27eb8aac22cbfb7e32", class: {
      disabled: this.disabled || this.loading
    }, tabIndex: this.disabled || this.loading ? -1 : 0 }, h(BaseButton, { key: "dd1470c1156ea58801a84b5ba7f7a1bbcc4ba1d1", ...baseButtonProps }, h("slot", { key: "becf633ca1af127c863e114ae123567057ace6d8" })));
  }
