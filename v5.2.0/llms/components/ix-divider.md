...
- divider
  - angular:
    - `angular/divider.ts`: [source](../../examples/angular-examples/src/preview-examples/divider.ts)
  - angular-standalone:
    - `angular-standalone/divider.ts`: [source](../../examples/angular-standalone-examples/src/preview-examples/divider.ts)
  - html:
    - `html/divider.html`: [source](../../examples/html-examples/src/preview-examples/divider.html)
  - react:
    - `react/divider.tsx`: [source](../../examples/react-examples/src/preview-examples/divider.tsx)
  - vue:
    - `vue/divider.vue`: [source](../../examples/vue-examples/src/preview-examples/divider.vue)
- dropdown
  - angular:
