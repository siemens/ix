...
const SiemensAboutContent = /*@__PURE__*/ proxyCustomElement(class SiemensAboutContent extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    static get style() { return IxSiemensAboutContentStyle0; }
...
//# sourceMappingURL=ix-siemens-about-content.js.map