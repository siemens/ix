...
const ExpandingSearch = class {
  ...
  render() {
    return h(Host, { key: "f1981aaa35a3437b84b131f32ba2c5e5c29e363d", class: {
      expanded: this.expanded,
      "right-position": this.expanded,
      fullWidth: this.fullWidth
    } }, h("ix-icon-button", { key: "e9dab8436d9e74ed8c4e434c689e6b59af4fdf29", size: this.expanded ? "16" : "24", icon: this.icon, variant: this.expanded ? "primary" : this.variant, ghost: this.ghost || this.expanded, outline: this.outline && !this.expanded, "data-testid": "button", onClick: () => this.expandInput(), tabindex: this.expanded ? -1 : 0, color: this.hasFocus ? "input-search-icon--color--focus" : void 0, class: {
      "btn-search": true,
      "btn-search--expanded": this.expanded
    } }), h("div", { key: "e5c9c707728595451c33efbdce5973884bfdf81e", class: {
      expanded: this.expanded,
      fullWidth: this.fullWidth,
      collapsed: !this.expanded,
      "disable-pointer": !this.expanded,
      "input-container": true
    }, "data-testid": "input-wrapper" }, h("input", { key: "93edc9d89807125a7de4ed7d40eaa7945534fd6a", class: {
      "form-control": true,
      input: this.expanded,
      "disable-pointer": !this.expanded,
