...
const CardList = class {
  ...
  render() {
    return h(Host, { key: "317a088e7cf0ac2ff01d46fabe293b6dafa55d49" }, h(CardListTitle, { key: "1eb6e1e6c43432737bd9d1718c89539ae9dce42b", isCollapsed: this.collapse, label: this.label, showAllLabel: this.i18nShowAll, showAllCounter: this.showAllCount === void 0 ? this.numberOfAllChildElements : this.showAllCount, onClick: () => this.onCardListVisibilityToggle(), onShowAllClick: (e) => this.onShowAllClick(e), hideShowAll: this.hideShowAll }), h("div", { key: "0c47be401efa5bd5dec00ad948b15d9d46a1a29f", class: {
