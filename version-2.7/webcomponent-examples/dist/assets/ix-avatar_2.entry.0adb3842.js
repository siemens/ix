import { r as registerInstance, a as readTask, h, F as Fragment, H as Host, g as getElement, c as createEvent } from "./global.7dd975c7.js";
import { B as BaseButton } from "./base-button-845f2463.e32101a2.js";
import { c as closestElement, h as hasSlottedElements } from "./shadow-dom-cc0bc152.fe0cdd32.js";
...
const MenuAvatarItem = class {
  ...
  render() {
    return h("ix-dropdown-item", { key: "ab0a400a5c753a7dd76b30b28cf1db867b97773a", ref: this.dropdownItemRef, icon: this.icon, label: this.label, onClick: (e) => this.itemClick.emit(e) });
  }
  get hostElement() {
    return getElement(this);
  }
