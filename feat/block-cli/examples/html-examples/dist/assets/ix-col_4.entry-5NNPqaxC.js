import { r as registerInstance, f as forceUpdate, h, H as Host, M as Mixin, c as createEvent, g as getElement } from "./global-CRrZCTD3.js";
...
import { O as OnListener } from "./listener-BjluJgvO-Qp8j9HFv.js";
...
const Col = class {
  ...
  render() {
    return h(Host, { key: "9b9db619595209b092c4fae44a59a0a4206cde9a", style: {
      ...this.getColumnSizeStyling()
    } }, h("slot", { key: "fdd0418160c3097827babefab6074be14bd6b05b" }));
  }
};
Col.style = colCss();
...
const LayoutGrid = class {
  ...
  columns = 12;
  render() {
    return h(Host, { key: "cd9e7dd67c43eba2b2ce9e3e3971b19557079cc0", class: {
      "no-margin": this.noMargin
    }, style: {
      "--ix-layout-grid-columns": `${this.columns}`,
      "--ix-layout-grid-gutter": `${this.gap}px`
    } }, h("slot", { key: "824328526c07d26793b7fd04adb4a1346ad181bb" }));
  }
};
...
const Row = class {
  ...
  render() {
    return h(Host, { key: "9fee47bdc1a028e0156b986f461dbd46e08b3dc0" }, h("slot", { key: "1b0f27c33dc6675778149b0ef1b5948ae39d7763" }));
  }
};
Row.style = rowCss();
...
const TimePicker = class extends Mixin(...DefaultMixins) {
  ...
  render() {
    const { bounds } = this.getUnitSelectionContext();
    return h(Host, { key: "2f9da3f41b00385615c47c07e1262802a4b827f4" }, h("ix-date-time-card", { key: "b03d9daa15f3bd37396ac0d6ac92ee9f9b229cad", embedded: this.embedded, timePickerAppearance: true, corners: this.corners, hasFooter: !this.dateTimePickerAppearance, hideHeader: this.hideHeader }, h("div", { key: "e843800f296f80af099cedeed93cff816c37998a", class: "header", slot: "header" }, h("ix-typography", { key: "89e02dcb4ffe8374e8ba2a87b60ef8954f9967f4", format: "body" }, this.i18nHeader)), h("div", { key: "150aeb3b09892cd4fc0f9909d3e06a9dec9eeed7", class: "clock" }, this.timePickerDescriptors.map((descriptor, index) => {
    ...
    }), this.timeRef && h("div", { key: "6b3650ef2292b0a67fa070bf926fc252bb2e8b08", class: "flex" }, h("div", { key: "7334a78429a9c8c33240b36bd9a8700058a58581", class: "column-separator" }), h("div", { key: "53eb46b2e790eced16387a5e4acd7daf3d3bc9de", class: "columns" }, h("div", { key: "07002160c02da39d29ace89fb2ae17f9feda1079", class: "column-header", title: "AM/PM" }), h("div", { key: "a231ff2e57117f8d5843593e498a461d918ad305", role: "listbox", "aria-label": "AM/PM", class: "element-list", tabindex: -1 }, h("button", { key: "2acdae10f8f1442491b280ed584a6c15b0e98ac0", role: "option", "aria-selected": this.timeRef === "AM" ? "true" : "false", "data-am-pm-id": "AM", class: {
      selected: this.timeRef === "AM",
      "element-container": true
    }, onClick: () => this.changeTimeReference("AM"), tabindex: "0", "aria-label": "AM" }, "AM"), h("button", { key: "afbe3331b80993b93dc82afa7e084e786d21a69c", role: "option", "aria-selected": this.timeRef === "PM" ? "true" : "false", "data-am-pm-id": "PM", class: {
      selected: this.timeRef === "PM",
      "element-container": true
    }, onClick: () => this.changeTimeReference("PM"), tabindex: "0", "aria-label": "PM" }, "PM"))))), h("div", { key: "fd543d9e9e7d44703bdab5a40664cf103da3d1e0", class: {
      footer: true,
      "footer--compact": this.timePickerDescriptors.length <= 2
    }, slot: "footer" }, h("ix-button", { key: "ec632810127ff32c3065bf19a074ed592eada066", class: "confirm-button", disabled: this.isConfirmDisabled(), onClick: () => {
