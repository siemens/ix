...
const EventList = class {
  ...
  render() {
    return h(Host, { key: "f9617fef17ea1cae9e93fafb3e7eace0627328ff", class: {
      "item-size-s": this.itemHeight === "S",
      "item-size-l": this.itemHeight === "L",
      compact: this.compact
    } }, h("div", { key: "e3a72915975867a0e84b5018d6410dcb0161c203", role: "list" }, h("slot", { key: "ec98403246e105c5865547b6b2fbb511dda8ec17" })));
  }
  static get watchers() {
    return {
      "chevron": [{
