...
import { L as iconArrowRight } from "./index-DgUGsIlh-CLxQRaVd.js";
...
const RangeField = class extends Mixin(...DefaultMixins) {
  ...
  render() {
    return h(Host, { key: "48f4df1f2126b29bf5ce5ebbcc7e203cae51b518", class: { "hide-arrow": this.hideArrow }, role: "group" }, !this.hideArrow && h("ix-icon", { key: "a434cc3ed7c9879f2344d9f69f01093e3e9c5e9b", "aria-hidden": "true", class: {
      "range-delimiter": true,
      "has-label": this.hasLabel
    }, name: iconArrowRight }), h("slot", { key: "c47261201dc6c4a2456d5eb93196c1d8a87073dd" }));
  }
};
