...
const Tree = class {
  ...
  render() {
    return h(Host, { key: "ecc42249b3819f652f912abffef383bb5e9916d4", onClick: (event) => this.onTreeItemClick(event) }, h("slot", { key: "269edb253d74504d856b5df5128b33ecdc3535b3" }));
  }
  static get watchers() {
    return {
      "model": [{
