...
const ToggleButton = class extends Mixin(...DefaultMixins, InheritAriaAttributesMixin) {
  ...
  render() {
    ...
    return h(Host, { key: "491a872c67ef5d3a326b39ac625c5020883756df", class: {
      disabled: this.disabled || this.loading
    } }, h(BaseButton, { key: "feeee0f3315777ca688701200c4924df76ee39e3", ...baseButtonProps }, h("slot", { key: "e04be2882acc75c0e76dda523a0c68be1c920faa" })));
  }
  static get watchers() {
    return {
      "role": [{
