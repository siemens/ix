...
import { t as iconEye, v as iconEyeCancelled } from "./index-CwfZ4aN6-mXhHymhu.js";
import { H as HookValidationLifecycle } from "./validation-PxJQmubQ-CMvuH4q8.js";
import { m as makeRef } from "./make-ref-Djkc69iv-BpP6uHEs.js";
import { m as mapValidationResult, a as addDisposableChangesAndVisibilityObservers, b as adjustPaddingForStartAndEnd, g as checkInternalValidity, i as getAriaAttributesForInput, d as SlotStart, I as InputElement, o as onInputBlurWithChange, j as onEnterKeyChangeEmit, f as onInputFocus, k as checkAllowedKeys, S as SlotEnd } from "./input.fc-Dp64niy5-Cqn2D97S.js";
...
const Input = class {
  ...
  render() {
    ...
    return h(Host, { key: "6ff5c244b1569fc6646538818fe5601f6cdf4d5f", class: {
      ...
      this.touched = true;
    }, ariaAttributes: inputAria, form: this.formInternals.form ?? void 0, suppressSubmitOnEnter: this.suppressSubmitOnEnter, textAlignment: this.textAlignment }), h(SlotEnd, { key: "5ebcd15cd5c15d57ed15719ede2110aa50ded103", slotEndRef: this.slotEndRef, onSlotChange: () => this.updatePaddings() }, h("ix-icon-button", { key: "4cef49e9f3b24a570b16a552ae48ceb24749488a", color: "color-weak-text", class: {
      "password-eye": true,
    ...
    } }))), !!this.maxLength && this.maxLength > 0 && h("ix-typography", { key: "caba9d91b85b8f3e75048e90f743557cc99148d9", class: "bottom-text", slot: "bottom-right", textColor: "soft" }, (this.value ?? "").length, "/", this.maxLength)));
  }
