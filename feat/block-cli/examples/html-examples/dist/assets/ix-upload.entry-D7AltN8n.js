import { g as getElement, r as registerInstance, c as createEvent, h, H as Host } from "./global-F68Qu5y3.js";
...
const Upload = class {
  ...
  render() {
    ...
    return h(Host, { key: "5e409b0838477f80fa7a3f9823e26ae4662ed6d5", ...a11y, "aria-disabled": disabled }, h("div", { key: "3266012d136b40ece878ddc0eb3e83a3b1b85433", class: {
    ...
    }, onDragOver: (e) => this.fileOver(e), onDragLeave: () => this.fileLeave() }, this.renderUploadState(), h("div", { key: "4bbfaf404d0f5615c321a3556b458d001a233bde" }, h("input", { key: "aea11005a705a4883986a15874ca2c970441d4a6", "aria-label": ariaLabel, "aria-disabled": disabled, multiple: this.multiple, type: "file", class: "upload-browser", id: "upload-browser", ...directoryAttributes, tabindex: "-1", onChange: (e) => {
      this.fileChangeEvent(e);
    }, accept: this.accept, disabled }), h("ix-button", { key: "f19b2f51e5c89cae323164158d73d87d2318494d", variant: "secondary", "aria-disabled": disabled, onClick: () => this.inputElement.click(), disabled }, this.i18nUploadFile ?? (this.directoryUpload ? "Upload folder…" : "Upload file…")))));
  }
};
