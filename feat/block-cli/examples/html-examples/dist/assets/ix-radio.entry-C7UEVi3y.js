...
import { c as createClassMutationObserver } from "./validation-PxJQmubQ-CMvuH4q8.js";
...
const Radio = class {
  ...
  render() {
    ...
    return h(Host, { key: "784cd8021a460a3b39ffd0597dad75661ac87a21", "aria-checked": a11yBoolean(this.checked), "aria-disabled": a11yBoolean(this.disabled), role: "radio", tabindex: tabIndex, class: {
      ...
      if (this.disabled)
        return;
      this.setCheckedState(true);
    }, onKeyDown: (event) => this.onKeyDown(event), onBlur: () => this.ixBlur.emit() }, h("label", { key: "976c24dbca616de9ebcedc27386ac2aae08cf6d1" }, h("div", { key: "191c7d77e30ad51e73044f091be9f20ef5c85f6b", class: "radio-button" }, h("div", { key: "fc3ccf9ee756869fd7c34bde1ed5c7092c1eb01b", "aria-hidden": "true", class: {
      ["radio-checkmark"]: true,
      checked: this.checked
    } }, h("div", { key: "af5be787520138d042f2c3299649029683722a49", class: "checkmark", style: { visibility: this.checked ? "visible" : "hidden" } }))), this.label && h("ix-typography", { key: "c9f09789a22cffea96c4a8805feed955dbe44774", format: "label", textColor: this.disabled ? "weak" : "std" }, this.label, h("slot", { key: "e786424270e8298b0eb49e7a0c83c012c07e76f3" }))));
  }
