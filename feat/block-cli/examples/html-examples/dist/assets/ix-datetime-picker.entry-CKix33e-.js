...
import { a as TRAP_FOCUS_INCLUDE_ATTRIBUTE } from "./focus-trap-CytyzUQ8-siBrmJiZ.js";
...
const DatetimePicker = class {
  ...
  render() {
    return h(Host, { key: "96a153a7efe788953480b3f2cd2b61fda947f797" }, h("ix-date-time-card", { key: "59550476b4022744a3091a4553f3f31e0754e128", hideHeader: true, hasFooter: true, embedded: this.embedded, corners: "rounded", noPadding: true }, h("ix-layout-grid", { key: "54d1a3121e9b513e25434276ec0758b1db5fe12f", class: "no-padding" }, h("ix-row", { key: "995ecc8e57074f62220733f235e72a45da5ba47b", class: "row-separator" }, h("ix-col", { key: "13d0dea6c98f1f07a594da72e25576440f741cf2", class: "col-separator" }, h("ix-date-picker", {
      key: "30eca827fcd85de9304743b01315ef7c8a32ef99",
    ...
    })), h("ix-col", { key: "5bae26b58434971da41348f1c1598c8a6c814944" }, h("ix-time-picker", {
      key: "07170955175f8052c7b0c8b4a38280f98f824592",
      class: "min-width",
      ...
      tabIndex: this.embedded ? -1 : 0,
      [TRAP_FOCUS_INCLUDE_ATTRIBUTE]: this.embedded
    })))), h("div", { key: "1c0191457c2d4e915535bb9a1a171b761b0d6ed2", slot: "footer", class: "btn-select-date-container" }, h("ix-button", { key: "10b8b7b397f66131107dcce7ce2d682205cee1c6", class: "btn-select-date", onClick: () => this.onDone() }, this.i18nDone))));
  }
};
