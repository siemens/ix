...
import { t as iconEye } from "./index-DLhpBBEI-C3tPjcQ4.js";
...
const FlipTile = class {
  ...
  render() {
    return h(Host, { key: "fd46f75169014a9ef47f2ff8fc5e80eef7136455", class: {
    ...
    } }, h("div", { key: "926bbbf3c46eb5e8ee041b0dec08850d466b5800", class: "flip-tile-container" }, h("div", { key: "6671afe39ec66662894df6f44d87c3443f387d64", class: "flip-tile-header" }, h("div", { key: "3860cb501d9d7e13c638d14a93dfc292f36cc55e", class: "header-slot-container text-l-title" }, h("slot", { key: "81264dcf7725fec39e3592b86930c59b6a89328d", name: "header" })), h("ix-icon-button", { key: "5a20cee1d6cc0730922bf399801cf737be629dc3", icon: iconEye, variant: "tertiary", onClick: () => this.toggleIndex(), "aria-label": this.ariaLabelEyeIconButton })), h("div", { key: "dfdf0ced1cab1081fd656e10c7be1b6a3ecc35cc", class: "content-container" }, h("slot", { key: "e1e164fc25a842023dd494ae41a494e824a37d70" })), h("div", { key: "441080f6af343c90ee540703fb4b27631328fb19", class: {
      footer: true,
      "show-footer": this.hasFooterSlot
    } }, h("slot", { key: "4eb26683d217e183e3301ea02e64fb415b93cbb4", name: "footer", onSlotchange: (event) => this.handleFooterSlotChange(event) }))));
  }
  static get watchers() {
    return {
      "index": [{
