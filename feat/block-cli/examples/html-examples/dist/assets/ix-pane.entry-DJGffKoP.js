...
const Pane = class {
  ...
  render() {
    ...
    return h(Host, { key: "517b555dcb7a4c14e6fe521187564fff199d2a78", class: {
    ...
    }, "aria-expanded": a11yBoolean(this.expanded) }, h("aside", { key: "8e387d951e01a1f5650f9a6c51c46364a88baf7e", id: `pane-${this.composition}`, class: {
      "top-bottom-pane": this.isBottomTopPane && !this.isMobile,
      "left-right-pane": this.isLeftRightPane && !this.isMobile,
      "mobile-pane": this.isMobile,
      expanded: this.expanded
    } }, h("div", { key: "415b058009d281114ef05a3d41ae8a93857a83ec", id: "title-div", class: {
    ...
    } }, h("ix-icon-button", { key: "353b0f64263d4dc729af9e3c105d43f4c1fe9575", class: "title-icon", size: "24", icon: this.expanded ? this.isMobile || this.hideOnCollapse ? iconClose : this.expandIcon : this.minimizeIcon, iconColor: this.expanded && (this.isMobile || this.hideOnCollapse) ? "color-soft-text" : void 0, variant: "subtle-tertiary", onClick: () => this.dispatchExpandedChangedEvent(), "aria-controls": `pane-${this.composition}`, "aria-label": paneButtonAriaLabel }), h("div", { key: "92103adb7c75ec5371002a3e193cbd8591ec2aa5", class: {
      "title-text": true,
      rotate
    } }, this.icon && h("ix-icon", { key: "6621f8dec6dbd1198ffaf33f9c891fd5d22d2191", class: "pane-icon", size: "24", name: this.icon, "aria-label": this.ariaLabelIcon }), h("div", { key: "ca9e22b1c7e689ebeef69a912f4626b17f16cd9d", class: "title-text-overflow" }, h("ix-typography", { key: "c84968452e4db00d450b1cba9bfc6fea3ec1e771", format: "h4" }, this.heading)), this.expanded && h("div", { key: "3eeba4e453280167c569d99d73bcd9493b76a0f9", class: "slot-header" }, h("slot", { key: "31024271eae2b3cf70bb6821f8ffb4836eb7bce5", name: "header" })))), h("div", { key: "5bbe67b57311360d2e387c81967990f5c2902ab6", class: {
      "side-pane-content": true,
      "no-padding": this.noPadding
    }, hidden: !this.showContent }, h("slot", { key: "296597411f15049ef49dafe5cfc2411922e1d2d2" }))));
  }
  static get watchers() {
    return {
      "expanded": [{
