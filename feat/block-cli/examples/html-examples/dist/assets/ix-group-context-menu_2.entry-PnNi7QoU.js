import { r as registerInstance, g as getElement, h, H as Host, c as createEvent } from "./global-Dfa5QLOG.js";
...
const GroupContextMenu = class {
  ...
  render() {
    return h(Host, { key: "3bd87567607d3c9a98178d11530c96e6930d307e" }, h("ix-icon-button", { key: "014b65f74f0047f722798a7ef024211ebb16efd3", class: { hide: !this.showContextMenu }, size: "24", variant: "subtle-tertiary", icon: iconContextMenu }), h("slot", { key: "2be8572eb8f4d2cb81855fac2af22eab83304830", onSlotchange: () => this.onSlotChange() }));
  }
};
