import { r as registerInstance, g as getElement, f as forceUpdate, h, H as Host } from "./global-B1t25MFd.js";
...
const Panes = class {
  ...
  render() {
    return h(Host, { key: "2cf2e09df3e0cd9d4b3c064490307b4972281d7a" }, !this.isMobile ? this.layout == "full-vertical" ? h("div", { class: "side-panes-wrapper" }, h("div", { class: {
      row: true,
