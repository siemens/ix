...
import { B as BaseButton } from "./base-button-D4FlHdn0-DDps6Vwt.js";
...
const CategoryFilter = class {
  ...
  render() {
    var _a, _b, _c;
    return h(Host, { key: "c9e7bdba1b9a6c9c368ff11d40ccf41883cc7d6d" }, h("form", { key: "1201a3a234a4c1c49f7897f1461dc9dcc7974c08", ref: (el) => this.formElement = el }, h("div", { key: "f6330fac3e425656ec2e3c1511edd822c091829e", "read-only": this.readonly, class: {
      "input-container": true,
      disabled: this.disabled,
      focus: this.hasFocus,
      readonly: this.readonly,
      "no-icon": this.hideIcon
    } }, h("ix-icon", { key: "dd3ba3a48b05fc1ac46e631c133fc58c0bd8b5bc", color: this.getIconColor(), class: { "display-none": this.hideIcon }, name: (_a = this.icon) !== null && _a !== void 0 ? _a : iconSearch, size: "16" }), h("div", { key: "cb89410ee85d600ba5eb8708f635f1fb7324673d", class: "token-container" }, h("div", { key: "b8b053df9ef5d6ac9db6a0e0c39d231943f7a96e", class: "list-unstyled" }, this.filterTokens.map((value, index) => h("span", { key: value.toString(), class: {
    ...
    } }, (_b = this.categories[this.category]) === null || _b === void 0 ? void 0 : _b.label), h("input", Object.assign({ key: "e589a93dc007d179d555e65fe655bb89d37f9e0a", class: {
      "text-input": true,
