...
import { K as iconArrowRight } from "./index-Dn2eQInl-mXhHymhu.js";
...
const RangeField = class extends Mixin(...DefaultMixins) {
  ...
  render() {
    return h(Host, { key: "64fe0527efed768d79cf316b2f6f44ecf91ed323", class: { "hide-arrow": this.hideArrow }, role: "group" }, !this.hideArrow && h("ix-icon", { key: "a5e58fdb873b38d480d3b1dc466895b2070a352c", "aria-hidden": "true", class: {
      "range-delimiter": true,
      "has-label": this.hasLabel
    }, name: iconArrowRight }), h("slot", { key: "d50e4ba9ff3a2a874f709a3acf1b523f2583cf91" }));
  }
};
