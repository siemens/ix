import { r as registerInstance, c as createEvent, h, H as Host, g as getElement } from "./global-Cr1KQvOo.js";
import { j as iconChevronRightSmall, D as iconChevronLeftSmall } from "./index-ClV1Tffv-Cwm_ckfF.js";
...
const Tabs = class {
  ...
  render() {
    return h(Host, { key: "55a9ce9d9f3aace87e3c7b6622a0f1611cd21a23" }, this.showArrowPrevious && h("button", { key: "fee841c02b3bd5ea7641169634c53fc26bf9aa66", class: "arrow", onClick: () => this.move(this.scrollAmount, true), "aria-label": this.ariaLabelChevronLeftIconButton }, h("ix-icon", { key: "e6628e01df44d5c0c9a616c9cfa8012c391561d4", name: iconChevronLeftSmall, "aria-hidden": "true" })), h("div", { key: "278733652842d0d1764ffb2039b58da65caed30f", class: {
      "tab-items": true,
    ...
    } }, h("div", { key: "28eb2a8f85d4c2b16c1cbbf6a513952e58b23688", class: "items-content", role: "tablist" }, h("slot", { key: "7ad15d18c789fe52c4a66163663a236fcb1dfecf" }))), this.showArrowNext && h("button", { key: "952f830c478cc8eb4898fe5b182958abade785ee", class: "arrow right", onClick: () => this.move(-this.scrollAmount, true), "aria-label": this.ariaLabelChevronRightIconButton }, h("ix-icon", { key: "fd2a54aed8381fd4235b9d06656b1774d443be83", name: iconChevronRightSmall, "aria-hidden": "true" })));
  }
  static get watchers() {
    return {
      "selected": [{
