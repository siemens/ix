import { r as registerInstance, c as createEvent, g as getElement, h, H as Host, M as Mixin } from "./global-DSse0xVy.js";
...
const SelectItem = class extends Mixin(...DefaultMixins, FocusVisibleMixin, ComponentIdMixin) {
  ...
  render() {
    ...
    return h(Host, { key: "81fb571efc2a461686e5f880629d700dbf0e5913", ...ariaAttributes, id: this.getHostElementId(), disableAriaSelectHandling: true, class: {
      [IX_FOCUS_VISIBLE]: true
    }, "aria-hidden": "true", role: "presentation" }, h("ix-dropdown-item", { key: "a214bf90f2f707e3ccebd0bf631de581ff898e33", "aria-hidden": "true", itemRole: "option", class: {
