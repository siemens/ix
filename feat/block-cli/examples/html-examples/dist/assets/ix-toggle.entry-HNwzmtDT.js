...
const Toggle = class extends Mixin(...DefaultMixins, InheritAriaAttributesMixin) {
  ...
  render() {
    ...
    return h(Host, { key: "c11656cb693c0645baed20aeba87c6c1902f2252", ...this.inheritAriaAttributes, role: "switch", tabindex: this.disabled ? -1 : 0, "aria-label": ariaLabel, "aria-checked": ariaChecked, "aria-disabled": a11yBoolean(this.disabled), "aria-required": a11yBoolean(this.required), class: {
    ...
    } }, h("div", { key: "896b8d52823670b30bbaf7c1ddb16cee0d559cc8", class: "wrapper" }, h("div", { key: "97971402498cb30e64d7f247a9c8d3c9fa0e7a71", class: {
      switch: true,
      checked: this.checked,
      indeterminate: this.indeterminate
    }, "aria-hidden": "true" }, h("div", { key: "904111f4c7546fa7a07ebe171a64cd09b97a3943", class: "slider" })), !this.hideText && h("ix-typography", { key: "79533bc9c7e1f6871f588311239095b265dab2bb", class: "label", "aria-hidden": "true" }, toggleText)));
  }
