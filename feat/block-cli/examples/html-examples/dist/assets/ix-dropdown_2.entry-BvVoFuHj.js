...
import { W as iconSingleCheck, j as iconChevronRightSmall } from "./index-BcWSlcx_-DijX28Uj.js";
import { a as a11yBoolean } from "./a11y-C21npbUc-CU_Bg8RX.js";
import { C as ComponentIdMixin } from "./id.mixin-CUbYLenp-DR0VgaO1.js";
import { F as FocusVisibleMixin } from "./focus-visible.mixin-CaRK3Ex_-DDC5PYcl.js";
...
const Dropdown = class extends Mixin(...DefaultMixins) {
  ...
  render() {
    ...
    return h(Host, { key: "4255b043c39b64ba155ce96483900a5092497b0d", ...ariaAttributes, "aria-modal": "true", "data-ix-dropdown": this.dropdownElementId, "data-ix-focus-trap": true, class: {
      "dropdown-menu": true,
      show: this.show,
...
const DropdownItem = class extends Mixin(...DefaultMixins, ComponentIdMixin, FocusVisibleMixin) {
  ...
  render() {
    ...
    return h(Host, { key: "4c9bab7e4fe2809337336d190219b0d9ac6203f2", id, role: this.itemRole, "aria-disabled": a11yBoolean(this.disabled), "aria-label": this.hostElement.ariaLabel ?? this.ariaLabelButton, class: {
      hover: this.hover,
    ...
    }, ...submenuAriaAttributes }, h("div", { key: "0f43b4bc33bb2f211ca03be818757ec2933b3c13", class: {
      "dropdown-item": true,
      "no-checked-field": this.suppressChecked,
      disabled: this.disabled
    } }, !this.suppressChecked ? h("div", { class: "dropdown-item-checked" }, this.checked ? h("ix-icon", { "aria-hidden": "true", class: "checkmark", name: iconSingleCheck, size: "16" }) : null) : null, this.icon ? h("ix-icon", { class: "dropdown-item-icon", name: this.icon, "aria-label": this.ariaLabelIcon }) : null, h("div", { key: "c4fa1d81a070946e8816ec24f4f5d74814e4aa6f", class: "dropdown-item-text" }, this.label, h("slot", { key: "5b8fbf91f4a50c818701feb58480044dd334779d" })), h("div", { key: "3c7194b822ba39b602ec9b905f339cafd6091a33", class: "dropdown-item-end" }, h("slot", { key: "92f0cb068a934c0035a1d3031286ea830307c8cd", name: "end" }), this.isSubMenu ? h("ix-icon", { name: iconChevronRightSmall, class: "submenu-icon" }) : null)));
  }
  static get watchers() {
    return {
      "ixFocusVisible": [{
