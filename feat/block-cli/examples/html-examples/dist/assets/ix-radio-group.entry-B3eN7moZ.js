...
const RadiobuttonGroup = class {
  ...
  render() {
    return h(Host, { key: "7ae9abb8c69b8a46e683122177f232abf7666f3c", onIxBlur: () => this.touched = true, ref: this.groupRef, role: "radiogroup" }, h("ix-field-wrapper", { key: "a6a931fa09c2856b24a0c6a6a90656d580e83fac", label: this.label, helperText: this.helperText, invalidText: this.invalidText, infoText: this.infoText, warningText: this.warningText, validText: this.validText, showTextAsTooltip: this.showTextAsTooltip, isValid: this.isValid, isInfo: this.isInfo, isWarning: this.isWarning, isInvalid: this.isInvalid, controlRef: this.groupRef }, h("div", { key: "421570a9d9ce4df96054daae96489d2455b9cc5e", class: {
      "checkbox-container": true,
      "row-layout": this.direction === "row"
    } }, h("slot", { key: "f2f91bb74e2733d032f7bc78292d30b34fce675f" }))));
  }
  get hostElement() {
