...
import { w as iconDoubleChevronDown, y as iconDoubleChevronRight, z as iconDoubleChevronUp, x as iconDoubleChevronLeft, r as iconClose } from "./index-Cl7fhG1I-C77BCFLW.js";
...
const Pane = class {
  ...
  render() {
    ...
    return h(Host, { key: "94e9bac3552b5ea0d1374209d8f25dff305511a3", class: {
    ...
    }, "aria-expanded": a11yBoolean(this.expanded) }, h("aside", { key: "bb1affbb2d8683032f106c263ed3675d0f51dac9", id: `pane-${this.composition}`, class: {
      "top-bottom-pane": this.isBottomTopPane && !this.isMobile,
      "left-right-pane": this.isLeftRightPane && !this.isMobile,
      "mobile-pane": this.isMobile,
      expanded: this.expanded
    } }, h("div", { key: "6b42222aa6e1a6c67b5e617882e85348dd53bfb7", id: "title-div", class: {
    ...
    } }, h("ix-icon-button", { key: "7f2ba2fcd40520e2dbf0feec4910b0c5cc6297df", class: "title-icon", size: "24", icon: this.expanded ? this.isMobile || this.hideOnCollapse ? iconClose : this.expandIcon : this.minimizeIcon, iconColor: this.expanded && (this.isMobile || this.hideOnCollapse) ? "color-soft-text" : void 0, variant: "subtle-tertiary", onClick: () => this.dispatchExpandedChangedEvent(), "aria-controls": `pane-${this.composition}`, "aria-label": paneButtonAriaLabel }), h("div", { key: "659bb17eb952e60275fe5e230a0775b161385a33", class: {
      "title-text": true,
      rotate
    } }, this.icon && h("ix-icon", { key: "d9381ffebb90e51ff4ffa0f1baef1c8ed3d8a922", class: "pane-icon", size: "24", name: this.icon, "aria-label": this.ariaLabelIcon }), h("div", { key: "265750c18904a336b0c96318d21eb3b1f068e4e5", class: "title-text-overflow" }, h("ix-typography", { key: "d4d703cded13484f584deda3bfdd1cf67d5246e7", format: "h4" }, this.heading)), this.expanded && h("div", { key: "71ddc8b9ac966052189f36cf739fe3aad1344da3", class: "slot-header" }, h("slot", { key: "16a765ee2198287e521d8b5ddd899a8933d26b53", name: "header" })))), h("div", { key: "b00d1829fef03430aee93c1bdda06f5e426788d6", class: "side-pane-content", hidden: !this.showContent }, h("slot", { key: "0fccb3724444e1a2e7ee6d36501860b38b0facd9" }))));
  }
  static get watchers() {
    return {
      "expanded": [{
