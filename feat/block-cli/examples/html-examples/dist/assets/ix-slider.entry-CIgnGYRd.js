...
const Slider = class {
  ...
  render() {
    ...
    return h(Host, { key: "a2b54fba6f1c5147cd8ce625f86ab9d9c981eb0c", class: {
      disabled: this.disabled,
      invalid: this.isInvalid,
      info: this.isInfo,
      valid: this.isValid,
      warning: this.isWarning
    }, onPointerDown: () => setTimeout(() => this.showTooltip = true) }, h("ix-field-wrapper", { key: "92f10ec2ef0fe137d88246a5d129aa53eec4f309", label: this.label, helperText: this.helperText, invalidText: this.invalidText, infoText: this.infoText, warningText: this.warningText, validText: this.validText, showTextAsTooltip: this.showTextAsTooltip, isValid: this.isValid, isInfo: this.isInfo, isWarning: this.isWarning, isInvalid: this.isInvalid, controlRef: this.controlRef }, h("div", { key: "7cbd73a021d25ddb8539e7d6e2d3b02c92b88c39", class: "slider-container" }, h("div", { key: "585d24f63885e86235b6f85ddbbab47a09282d2b", class: "slider" }, h("div", { key: "95195683d7656fe63273c3a8929fab95b2903be0", class: "track" }, h("div", { key: "8cf154256ebd1793dff60c4a73e3eabcd379d265", ref: this.thumbRef, class: "thumb", style: {
      left: `calc(${valueInPercentage} * (100% - 1rem))`
    } }), h("svg", { key: "473464c31c1a620ba819c5d272246976fc84fc53", class: "ticks", xmlns: "http://www.w3.org/2000/svg" }, this.marker?.filter((markerValue) => markerValue >= this.min && markerValue <= this.max).map((markerValue) => {
    ...
    }))), h("input", { key: "b14b87d66e1fa590a87537ff9083820857f98b2d", id: "slider", ref: this.controlRef, type: "range", list: this.marker ? "markers" : void 0, step: this.step, min: this.min, max: this.max, value: this.rangeInput, tabindex: this.disabled ? -1 : 0, onInput: (event) => this.onInput(event), onFocus: () => {
    ...
    }, role: "slider", "aria-valuenow": this.rangeInput, "aria-valuemin": this.min, "aria-valuemax": this.max, ...this.a11yAttributes }), h("ix-tooltip", { key: "39743f6f38f08878f18e446f32af7cd4b8f7ac16", ref: this.tooltipRef, class: {
      "hide-tooltip": !this.showTooltip
    }, animationFrame: true, for: this.thumbRef.waitForCurrent() }, this.rangeInput)), this.hasLabels && h("div", { key: "176dcdf4cca14057a1b13011a8efd1d3eb9b263f", class: "label" }, h("div", { key: "134db8e7296ec81e99ef5fbf22dd651f8c0a74f6" }, h("slot", { key: "640e5536efc1acc85e17dc07d709b876fc1e38d4", name: "label-start" })), h("div", { key: "c1e8ada1daa8e35eae4c8ea73913cfe2e8402542" }, h("slot", { key: "4038ec30b21393176418763f05b65b6ae1a99b09", name: "label-end" }))))));
  }
