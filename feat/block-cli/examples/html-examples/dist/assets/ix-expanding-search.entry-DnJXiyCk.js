...
import { m as iconClear, l as iconSearch } from "./index-DFdo1y_u-D_8X33yw.js";
...
const ExpandingSearch = class {
  ...
  render() {
    return h(Host, { key: "fab399dd0699fab720918637e389e876f188e9c6", class: {
      expanded: this.expanded,
      "right-position": this.expanded,
      fullWidth: this.fullWidth
    } }, h("ix-icon-button", { key: "40ae332aea156d83df7d23eaaa3612d2a22cec4f", size: this.expanded ? "16" : "24", icon: this.icon ?? iconSearch, variant: this.expanded ? "tertiary" : this.variant, "data-testid": "button", onClick: () => this.expandInput(), tabindex: this.expanded ? -1 : 0, color: this.hasFocus ? "input-search-icon--color--focus" : void 0, class: {
      "btn-search": true,
      "btn-search--expanded": this.expanded
    }, "aria-label": this.ariaLabelSearchIconButton }), h("div", { key: "a7c616b3abc6e9895418ddd229d78a60c8a3fa8b", class: {
      expanded: this.expanded,
      fullWidth: this.fullWidth,
      collapsed: !this.expanded,
      "disable-pointer": !this.expanded,
      "input-container": true
    }, "data-testid": "input-wrapper" }, h("input", { key: "41d5f5dc6ec833daf1dfda01fab8de2f795ce7f6", class: {
