import { r as registerInstance, c as createEvent, g as getElement, h, H as Host } from "./global-Cr1KQvOo.js";
import { Q as iconNavigationLeft, R as iconNavigationRight, f as iconApps, S as iconCogwheel, T as iconLightDark, i as iconInfo } from "./index-ClV1Tffv-Cwm_ckfF.js";
import { m as modulesExports } from "./index-CGJC9ptU-OtA7BVGg.js";
import { A as Animation } from "./animation-DNIQ2C1K-BYpQk_MF.js";
import { s as showAppSwitch } from "./index-CsGvK8CI-BDreCP0h.js";
...
const Menu = class {
   ...
   */
  i18nExpandSidebar = "Expand sidebar";
  /**
  ...
  render() {
    ...
    return h(Host, { key: "c880d1d6e8dabc461b6b800c21828e5dd14be96e", class: {
      expanded: this.expand,
      [`breakpoint-${this.breakpoint}`]: true
    }, slot: "menu" }, h("nav", { key: "f3eafaa601e2f448d9bba198437c569296280fe7", "aria-label": this.applicationName, class: {
      menu: true,
      expanded: this.expand
    } }, h("div", { key: "9e57e592c0e766b6fadf688c4d9d9e5ec34e26c5", class: "menu-buttons" }, this.breakpoint !== "sm" && h("ix-menu-expand-icon", { key: "8d65054ae8b6de1d9cc7866159e6392f48211cca", breakpoint: this.breakpoint, expanded: this.expand, pinned: this.pinned, class: "menu-expand-icon", onClick: async () => this.toggleMenu(), "data-testid": "expand-collapse-menu" }), this.breakpoint === "sm" && this.applicationLayoutContext?.appSwitchConfig && h("ix-icon-button", { key: "91bfe9a40c38067f477d852a2f4eb9fec4487e43", onClick: () => {
      this.showAppSwitch();
    }, icon: iconApps, variant: "subtle-tertiary" })), h("div", { key: "b9c6d74208532be22e0a71adef57cc7a910b9068", id: "menu-tabs", style: {
      display: "contents"
    }, onClick: (e) => this.onMenuItemsClick(e) }, h("div", { key: "ea23f9d0dff139be91b1ca928d18ba4bcec34cce", class: "tabs-shadow-container" }, h("div", { key: "96f2f387eba66e580a02bd11566526165ce026a3", class: {
      "tabs--shadow": true,
      "tabs--shadow-top": true,
      "tabs--shadow--show": this.itemsScrollShadowTop
    } }), h("div", { key: "48c98562b79970ff4db744db057841a4932712d2", class: {
      tabs: true,
      "show-scrollbar": this.expand
    }, onScroll: () => this.handleOverflowIndicator() }, h("div", { key: "6913849219b2d7e9cb40058e2f13718633a87ab0", class: "menu-avatar" }, h("slot", { key: "c183b825dff0cfb0dee9784be7587e3f78049849", name: "ix-menu-avatar" })), h("slot", { key: "1718f5efc7229afa1045dc721439d8d85b3be083", name: "home" }), this.breakpoint !== "sm" || !this.isHiddenFromViewport() ? h("slot", null) : null), h("div", { key: "6d6d817c52fae05cfba88b0cd1eaa97956bf6a2e", class: {
      "tabs--shadow": true,
      "tabs--shadow-bottom": true,
      "tabs--shadow--show": this.itemsScrollShadowBottom
    } }))), h("div", { key: "19090d1b6d70ea18408754c0193bdf96ea5ef2b5", class: "bottom-tab-divider" }), this.settings ? h("ix-menu-item", { disabled: this.isHiddenFromViewport(), id: "settings", class: {
      "internal-tab": true,
      "bottom-tab": true,
      active: this.showSettings
    }, icon: iconCogwheel, onClick: async () => this.toggleSettings(!this.showSettings), label: this.i18nSettings, "aria-expanded": this.showSettings.toString(), "aria-controls": "menu-overlay" }) : null, this.enableToggleTheme ? h("ix-menu-item", { disabled: this.isHiddenFromViewport(), id: "toggleTheme", onClick: () => themeSwitcher.toggleMode(), class: "internal-tab bottom-tab", icon: iconLightDark, label: this.i18nToggleTheme, role: "switch", "aria-checked": this.isDarkMode.toString() }) : null, h("div", { key: "51df9a15d69459a4907810b035781446ac8d29b7", onClick: (e) => this.onMenuItemsClick(e) }, h("slot", { key: "470124d59241592dd71a506e2d9a4177f0fc17a9", name: "bottom" })), h("div", { key: "bebd4acd802576e8d7a3b312552a3f6f3a857b94", id: "popover-area" }), this.enableMapExpand || this.applicationLayoutContext?.sidebar ? h("ix-menu-item", { disabled: this.isHiddenFromViewport(), id: "menu-collapse", onClick: () => this.sidebarToggle(), class: "internal-tab bottom-tab", icon: `${this.getCollapseIcon()}`, label: this.getCollapseText() }) : null, this.about ? h("ix-menu-item", { disabled: this.isHiddenFromViewport(), id: "aboutAndLegal", class: {
      "internal-tab": true,
      "bottom-tab": true,
      active: this.showAbout
    }, icon: iconInfo, onClick: async () => this.toggleAbout(!this.showAbout), label: this.i18nLegal, "aria-expanded": this.showAbout.toString(), "aria-controls": "menu-overlay" }) : null), h("section", { key: "f8d9be5d18aacb57c977c61af90ecb4ae7c5b582", id: "menu-overlay", "aria-label": overlayLabel, class: {
      "menu-overlay": true,
      ...
      this.checkTransition();
    } }, h("div", { key: "94439d5bbd3fe1d52e1f28c857fa4a449206fceb", class: "menu-overlay-container" }, this.showSettings ? h("slot", { name: "ix-menu-settings" }) : null), h("div", { key: "c5877c972d91fd0004d5b3649b8ce6d999d1bbf5", class: "menu-overlay-container" }, this.showAbout ? h("slot", { name: "ix-menu-about" }) : null)));
  }
  static get watchers() {
    return {
      "expand": [{
