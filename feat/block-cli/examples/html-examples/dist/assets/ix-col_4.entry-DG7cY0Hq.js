import { r as registerInstance, f as forceUpdate, h, H as Host, M as Mixin, c as createEvent, g as getElement } from "./global-F68Qu5y3.js";
...
import { O as OnListener } from "./listener-BjluJgvO-C56iGYEd.js";
...
const Col = class {
  ...
  render() {
    return h(Host, { key: "a42569c5fb4ca763b64cd336fd51ded0b8f69b0d", style: {
      ...this.getColumnSizeStyling()
    } }, h("slot", { key: "e7ad5f6bb589835ffaee2a02faca3af7d49a8ae8" }));
  }
};
Col.style = colCss();
...
const LayoutGrid = class {
  ...
  columns = 12;
  render() {
    return h(Host, { key: "f6f8d658d5cc950891afeb6aad5969d193042d4a", class: {
      "no-margin": this.noMargin
    }, style: {
      "--ix-layout-grid-columns": `${this.columns}`,
      "--ix-layout-grid-gutter": `${this.gap}px`
    } }, h("slot", { key: "15e4cc43f6ea9e8372b1df860c2a08decc4f9513" }));
  }
};
...
const Row = class {
  ...
  render() {
    return h(Host, { key: "bdeadc12ccd11f97e9b65653ef599e6442dafe20" }, h("slot", { key: "fbf096d773829463a2e86ae70c5b228fd2fc765f" }));
  }
};
Row.style = rowCss();
...
const TimePicker = class extends Mixin(...DefaultMixins) {
  ...
  render() {
    const { bounds } = this.getUnitSelectionContext();
    return h(Host, { key: "b21a1bf896216102afab0a51639bec4a1f5d9fa7" }, h("ix-date-time-card", { key: "4667a2101f245114243a487eff26cbcbbcca09eb", embedded: this.embedded, timePickerAppearance: true, corners: this.corners, hasFooter: !this.dateTimePickerAppearance, hideHeader: this.hideHeader }, h("div", { key: "5966392fcae9e2732b3db2b206a43415df84456f", class: "header", slot: "header" }, h("ix-typography", { key: "ea536e6760b14fcb5a5b6d6532622d7ea3bc3ba8", format: "body" }, this.i18nHeader)), h("div", { key: "ebe1c57c683635620fb5dbe4d004501d2d90e851", class: "clock" }, this.timePickerDescriptors.map((descriptor, index) => {
    ...
    }), this.timeRef && h("div", { key: "46cb09082b0c8c5ae78d5374f6b0481c87a094f8", class: "flex" }, h("div", { key: "f41c613032ad084b603933f95306ce06a1fa58ba", class: "column-separator" }), h("div", { key: "658dc46e4c6dc139085665ac349d5ad974dd032c", class: "columns" }, h("div", { key: "fc3597bcae6a2a59cdc96cab339027a1aea7b635", class: "column-header", title: "AM/PM" }), h("div", { key: "92971b026f70aff902cbdcbce5eae13d28d052ba", role: "listbox", "aria-label": "AM/PM", class: "element-list", tabindex: -1 }, h("button", { key: "5ef62840656dd33910352ede9d729f80cca7b405", role: "option", "aria-selected": this.timeRef === "AM" ? "true" : "false", "data-am-pm-id": "AM", class: {
      selected: this.timeRef === "AM",
      "element-container": true
    }, onClick: () => this.changeTimeReference("AM"), tabindex: "0", "aria-label": "AM" }, "AM"), h("button", { key: "dbecac42d1879543f68265bf82cece41246aac29", role: "option", "aria-selected": this.timeRef === "PM" ? "true" : "false", "data-am-pm-id": "PM", class: {
      selected: this.timeRef === "PM",
      "element-container": true
    }, onClick: () => this.changeTimeReference("PM"), tabindex: "0", "aria-label": "PM" }, "PM"))))), h("div", { key: "ca36cd857c894f9feff55fbe138f02560c4a9c81", class: {
      footer: true,
      "footer--compact": this.timePickerDescriptors.length <= 2
    }, slot: "footer" }, h("ix-button", { key: "c5e65f9274566c51cc5d0d143ec6c55b84860349", class: "confirm-button", disabled: this.isConfirmDisabled(), onClick: () => {
