...
const Chip = class extends Mixin(...DefaultMixins, InheritAriaAttributesMixin) {
  ...
  render() {
    ...
    return h(Host, { key: "6ce19a1a2bda4c12d5cb429a2e123a534b3483bc", role: this.getHostRole(needsGroupRole), class: {
      inactive: this.inactive
    } }, h("div", { key: "83d7a361abc404b7b6318d7027a267b689cc14d1", ref: this.containerElementRef, class: wrapClasses, style: customWrapStyle }, h("button", { key: "c54df8d68aaa96adf9e5f6920e9f0f0469e2b481", type: "button", class: "chip-main", ...this.inheritAriaAttributes, disabled: this.inactive, style: customMainStyle }, h("div", { key: "6abf77fb820680446c1bf0744d433b571b8aca6d", class: "content-wrapper" }, this.icon && h("ix-icon", { key: "063b18a1cb6e0e290d03c6b551c7ca91818c319a", class: {
      "with-icon": true
    }, name: this.icon, size: "24", "aria-label": this.ariaLabelIcon, "aria-hidden": a11yBoolean(iconIsDecorative), style: this.getIconStyle(variant) }), h("span", { key: "b912ba028613456bc165bfc64f93cd725bb82f8c", class: "slot-container" }, h("slot", { key: "1e269d8dc604e1adc46470c767cd23a6f9b5f7bb" })))), showClose && h("button", { key: "83a186746cbb7a93abb8b8a2841fb23b9a6d4b68", type: "button", class: "chip-close", "aria-label": this.ariaLabelCloseButton, onClick: (event) => {
      this.closeChip.emit(event);
      event.stopPropagation();
    } }, h("ix-icon", { key: "05849ca9967b1b19113cf3220c77a5a8e4dff753", class: "chip-close__icon", name: iconCloseSmall, size: "16", "aria-hidden": "true" }))), this.getTooltip());
  }
  static get watchers() {
    return {
      "role": [{
