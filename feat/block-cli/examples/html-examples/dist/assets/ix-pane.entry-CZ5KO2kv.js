...
import { G as iconDoubleChevronDown, H as iconDoubleChevronRight, I as iconDoubleChevronUp, J as iconDoubleChevronLeft, r as iconClose } from "./index-DLhpBBEI-C3tPjcQ4.js";
...
const Pane = class {
  ...
  render() {
    ...
    return h(Host, { key: "39e4b3e56e9ad6d14a17e753cb032599741bfaa2", class: {
    ...
    }, "aria-expanded": a11yBoolean(this.expanded) }, h("aside", { key: "74956381eccaa50e8ab7f19b8b6c1e01eb3cf629", id: `pane-${this.composition}`, class: {
      "top-bottom-pane": this.isBottomTopPane && !this.isMobile,
      "left-right-pane": this.isLeftRightPane && !this.isMobile,
      "mobile-pane": this.isMobile,
      expanded: this.expanded
    } }, h("div", { key: "d4070174a41bd66c49a3e4a4053862f02fb081ed", id: "title-div", class: {
    ...
    } }, h("ix-icon-button", { key: "0c6ffbec533d33d0cb18f039e23c62706223a6b5", class: "title-icon", size: "24", icon: this.expanded ? this.isMobile || this.hideOnCollapse ? iconClose : this.expandIcon : this.minimizeIcon, iconColor: this.expanded && (this.isMobile || this.hideOnCollapse) ? "color-soft-text" : void 0, variant: "subtle-tertiary", onClick: () => this.dispatchExpandedChangedEvent(), "aria-controls": `pane-${this.composition}`, "aria-label": paneButtonAriaLabel }), h("div", { key: "8765f5b277be9ff95b52af2640f001fcf038f2b7", class: {
      "title-text": true,
      rotate
    } }, this.icon && h("ix-icon", { key: "74da760aa76f5650aa0765a33d13a29bce9834fd", class: "pane-icon", size: "24", name: this.icon, "aria-label": this.ariaLabelIcon }), h("div", { key: "2ccc38d4c204927eec74929eb2e90088b8d677c5", class: "title-text-overflow" }, h("ix-typography", { key: "9d6b2ab54e8857383a49cc5fadabdfbc130b2887", format: "h4" }, this.heading)), this.expanded && h("div", { key: "b025c5dd3455abf823b4c4b84723ddc632402915", class: "slot-header" }, h("slot", { key: "ee351fc56e72b38f72b8ac6851f9de9f3e84f13b", name: "header" })))), h("div", { key: "c94bca4d84e6bf00a961ecf40cb1b58199dc4692", class: "side-pane-content", hidden: !this.showContent }, h("slot", { key: "768eb927801f84ace7b1847e39e871ae8db683f2" }))));
  }
  static get watchers() {
    return {
      "expanded": [{
