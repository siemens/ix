import { r as registerInstance, g as getElement, h, H as Host, M as Mixin } from "./global-J1r-v9CX.js";
...
import { c as createClassMutationObserver } from "./validation-VVt5EFy0-BYsRUFvy.js";
import { r as resolveTextFromValidationState, h as hasAnyText, H as HelperText$1 } from "./helper-text-util-CVIfu8-i-sqHmGyYH.js";
...
const FormFieldLabel = class {
  ...
  render() {
    return h(Host, { key: "fc92b8c7d45d6b0ea7404664576b970155b3cb05", onClick: () => this.focusOnClick(), class: {
      "text-overflow-wrap": this.textOverflow === "wrap",
      "text-overflow-no-wrap": this.textOverflow === "no-wrap"
    } }, h("label", { key: "43fc2bf9730f10e56eb7c84dc3246dfa08789125", htmlFor: this.htmlFor, ...this.a11yAttributes, ref: this.labelRef }, h("ix-typography", { key: "9a591242fa5acf40d2df14ee71a0ccbb542cd86d", textColor: this.isInvalid ? "alarm" : "soft", format: "label" }, h("slot", { key: "92d8be436b86e0bebb42b4991b106ede400d212b" }), this.required && h("span", { key: "95d08908193c10dae2c8e3b9b27d34f0e94a7fee" }, "*"))));
  }
  static get watchers() {
    return {
      "isInvalid": [{
...
const FieldWrapper = class extends Mixin(...DefaultMixins, ComponentIdMixin) {
  ...
  render() {
    ...
    return h(Host, { key: "d09b5a019e7459cf7b2d4f3b9ff36b3382a67a4d", ...additionalAriaAttributes }, this.label && h("div", { key: "23a180fbc1504fdbc11cb99b67e550547c475f07", class: "field-top" }, h("ix-field-label", { key: "807790507a4673f00b63ee439711da84317e402b", required: this.required, controlRef: this.controlRef, isInvalid: this.isInvalid, ariaHidden: true }, this.label)), h("div", { key: "143af6124c0e4e493c03040ff07de4d47187b565", class: {
      "slot-wrapper": true
    }, ref: this.slotRef }, h("slot", { key: "d4d68cf45d96b41d992b926738883caf517ba054" })), h("div", { key: "8730844570f2636126260dcb9400eec68925a147", class: "field-bottom" }, !this.showTextAsTooltip && h(HelperText$1, { key: "bd36ac31f448d3995e76edbc515e55a880372b56", ...textOptions }), h("div", { key: "f395f37618846f52b9221bdff29b2e681d1cf37f", class: "bottom-right" }, h("slot", { key: "3abb7416fc46329e789e140cf4120311ce068c5d", name: "bottom-right" }))), this.showTextAsTooltip === true && hasAnyText(textOptions) && h("ix-tooltip", { key: "1e15c9dcbf8cd1757e1d90bbbd6d702471c6bfd3", for: this.slotRef.waitForCurrent(), showDelay: 500, placement: "bottom" }, h(HelperText$1, { key: "30fb33715a5fc4f3ee8ca02b526b82b5e3a633be", ...textOptions })));
  }
  static get watchers() {
    return {
      "label": [{
