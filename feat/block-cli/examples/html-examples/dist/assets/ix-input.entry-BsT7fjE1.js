...
import { m as mapValidationResult, a as addDisposableChangesAndVisibilityObservers, b as adjustPaddingForStartAndEnd, f as checkInternalValidity, g as getAriaAttributesForInput, d as SlotStart, I as InputElement, i as checkAllowedKeys, o as onInputBlur, S as SlotEnd } from "./input.fc-CPEIRuou-CIjfkkD9.js";
...
const Input = class {
  ...
  render() {
    ...
    return h(Host, { key: "d9e367ef40af7c62e219e4c7613833f1f6dc2be9", class: {
      disabled: this.disabled,
      readonly: this.readonly
    } }, h("ix-field-wrapper", { key: "d431699e04200d6cc61498e12c32ca311a8519b0", htmlForLabel: this.inputId, required: this.required, label: this.label, helperText: this.helperText, invalidText: this.invalidText, infoText: this.infoText, warningText: this.warningText, validText: this.validText, showTextAsTooltip: this.showTextAsTooltip, isInvalid: this.isInvalid, isValid: this.isValid, isInfo: this.isInfo, isWarning: this.isWarning, controlRef: this.inputRef }, h("div", { key: "a3806990efd872bbd81c667225a503a128ef8f2b", class: "input-wrapper" }, h(SlotStart, { key: "d72de27032bdc45bec4b1dbf89e893f3665911a5", slotStartRef: this.slotStartRef, onSlotChange: () => this.updatePaddings() }), h(InputElement, { key: "33559f160e999ef36e7929aa02bfabc525bc3b02", id: this.inputId, readonly: this.readonly, disabled: this.disabled, maxLength: this.maxLength, minLength: this.minLength, pattern: this.pattern, type: this.inputType, isInvalid: this.isInvalid, required: this.required, value: this.value, placeholder: this.placeholder, inputRef: this.inputRef, onKeyPress: (event) => checkAllowedKeys(this, event), valueChange: (value) => this.valueChange.emit(value), updateFormInternalValue: (value) => this.updateFormInternalValue(value), onBlur: () => {
      onInputBlur(this, this.inputRef.current);
      this.touched = true;
    }, ariaAttributes: inputAria, form: (_a = this.formInternals.form) !== null && _a !== void 0 ? _a : void 0, suppressSubmitOnEnter: this.suppressSubmitOnEnter, textAlignment: this.textAlignment }), h(SlotEnd, { key: "e6ce52cf5a117a99efd082c74a9e3cf8787d1c5d", slotEndRef: this.slotEndRef, onSlotChange: () => this.updatePaddings() }, h("ix-icon-button", { key: "2e6a8d0c4bccf602189cdf8ac448d892825316d9", color: "color-weak-text", class: {
      "password-eye": true,
    ...
    } }))), !!this.maxLength && this.maxLength > 0 && h("ix-typography", { key: "aa9ca521df8a66f4646c2562565cd6df28a1a0e8", class: "bottom-text", slot: "bottom-right", textColor: "soft" }, ((_b = this.value) !== null && _b !== void 0 ? _b : "").length, "/", this.maxLength)));
  }
