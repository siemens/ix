...
import { F as iconMinus, G as iconPlus } from "./index-BcWSlcx_-DijX28Uj.js";
import { m as makeRef } from "./make-ref-Djkc69iv-BpP6uHEs.js";
import { m as mapValidationResult, a as addDisposableChangesAndVisibilityObservers, b as adjustPaddingForStartAndEnd, g as checkInternalValidity, o as onInputBlurWithChange, d as SlotStart, I as InputElement, j as onEnterKeyChangeEmit, f as onInputFocus, k as checkAllowedKeys, S as SlotEnd } from "./input.fc-Bz7Vc1eE-D5-0GlU2.js";
...
const NumberInput = class {
  ...
  render() {
    ...
    }, onBlur: this.handleBlur, form: this.formInternals.form ?? void 0, suppressSubmitOnEnter: this.suppressSubmitOnEnter, textAlignment: this.textAlignment }), h(SlotEnd, { key: "1894fec4fa75a3a0d5a5c4ad0fe66bad1a2224a5", slotEndRef: this.slotEndRef, onSlotChange: () => this.updatePaddings() }, h("div", { key: "22793904504d60f5d543de676a6228a61183ffe6", class: {
      "number-stepper-container": true,
      "container-hidden": !showStepperButtons
    } }, h("ix-icon-button", { key: "4fa008349a6111384d284067ad29ab95f13a08c1", variant: "subtle-tertiary", icon: iconMinus, size: "16", class: "number-stepper-button step-minus", "aria-label": "decrement number", onClick: () => this.handleStepOperation("down") }), h("ix-icon-button", { key: "3afcff2990f0b6210c5f14a39b10010de979bed6", variant: "subtle-tertiary", icon: iconPlus, size: "16", class: "number-stepper-button step-plus", "aria-label": "increment number", onClick: () => this.handleStepOperation("up") }))))));
  }
