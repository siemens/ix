...
import { g as iconChevronLeftSmall, j as iconChevronRightSmall } from "./index-Cl7fhG1I-C77BCFLW.js";
import { D as DateTime, I as Info } from "./luxon-wpz4A-OQ-B58AoryR.js";
import { q as queryElements } from "./focus-utilities-DnaItyVQ-Degzwldb.js";
...
const DatePicker = class extends Mixin(...DefaultMixins) {
  ...
  render() {
    return h(Host, { key: "4a1f9b6e19f1226fb8066c98d2a4fbb8cd9f17fc", onKeyDown: (event) => this.onKeyDown(event), onFocusin: () => {
      if (hasKeyboardMode()) {
        this.changeFocusedDay();
      }
    } }, h("ix-date-time-card", { key: "f0a365e06804d1ce728383ad604f119d587c7d83", corners: this.corners, embedded: this.embedded }, h("div", { key: "104ae3c2b5c13d9f53b1fbe52d4798f7f72bc227", class: "header", slot: "header" }, h("ix-icon-button", { key: "a38d9f7f8515c724aa3e7a62daf6f7343534122e", onClick: () => this.changeCalendarView(-1), icon: iconChevronLeftSmall, variant: "tertiary", class: "arrows", "aria-label": this.ariaLabelPreviousMonthButton }), h("div", { key: "4d8ad795185a2d622e79946c7b4e16de6f5ac13d", class: "selector" }, h("ix-dropdown-button", { key: "eb5a36c8a2714e8b4c71ee40304ea4191607bd1e", focusCheckedItem: true, "aria-label": this.ariaLabelMonthSelection, variant: "tertiary", label: null, onShowChanged: (event) => {
      event.stopPropagation();
    } }, h("ix-typography", { key: "1ba108cf7411e34dc25d0c9055e7d24adfd21d6f", bold: true, class: "capitalize", slot: "button-label" }, this.monthNames[this.selectedMonth]), this.renderMonths()), h("ix-dropdown-button", { key: "6dd372f06faff2110a4437c38bf995aa9e9f8320", focusCheckedItem: true, "aria-label": this.ariaLabelYearSelection, ref: this.yearDropdownButtonRef, variant: "tertiary", label: null, onShowChanged: (event) => {
      event.stopPropagation();
      if (event.detail) {
        requestAnimationFrameNoNgZone(() => {
    ...
    } }, h("div", { key: "90235a563e7908e0c9d2c9b125f94dced7945be7", class: "infinite-scrolling-spacer" }, h("div", { key: "910f696ff95add4d677082d77901881b770005e6", class: "sentinel", "data-sentinel": "top" })), h("ix-typography", { key: "f999e8273b30c150eb58ff53f0142a65495a82bf", bold: true, class: "capitalize", slot: "button-label" }, this.selectedYear), this.renderYears(), h("div", { key: "3a91edc88e8aeaf4e86eeedbfa467a4c679ea255", class: "infinite-scrolling-spacer" }, h("div", { key: "abc534a89fa683401533f15a9777808d705e84f3", class: "sentinel", "data-sentinel": "bottom" })))), h("ix-icon-button", { key: "54d1ad1e400759127ad0b499db107d9fa0f879e5", onClick: () => this.changeCalendarView(1), icon: iconChevronRightSmall, variant: "tertiary", class: "arrows", "aria-label": this.ariaLabelNextMonthButton })), h("div", { key: "b8c8cf92d967f7531e3954ea5858aa0ad0f037ff", role: "grid", class: {
      grid: true,
      "grid--show-week-numbers": this.showWeekNumbers
    } }, h("div", { key: "2afd3e475d26cab6771af1fb8cac67b74d119b7d", role: "row" }, this.showWeekNumbers && h("div", { key: "41c0a7b5b3e6c300a4f01841e235319ac03cb527", class: "calendar-item week-day", role: "columnheader" }), this.dayNames.map((name) => h("div", { key: name, class: "calendar-item week-day", role: "columnheader" }, h("div", { class: "overflow" }, name.slice(0, 3))))), this.calendar.map((week) => {
    ...
    })), h("div", { key: "346461244ad7df3e44cf0348f85fe74d22a34b25", class: {
      button: true,
      hidden: this.singleSelection || this.embedded
    } }, h("ix-button", { key: "13eb8bff675a5a7cccc466ca4bf9d54c8e8bc32f", hidden: this.singleSelection || this.embedded, onClick: () => this.onDone() }, this.i18nDone))));
  }
