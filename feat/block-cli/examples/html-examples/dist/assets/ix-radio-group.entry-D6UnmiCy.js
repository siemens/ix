...
const RadiobuttonGroup = class {
  ...
  render() {
    return h(Host, { key: "e3c8958d652c29f2ca8b814b7bb3ada2e906238c", onIxBlur: () => this.touched = true, ref: this.groupRef, role: "radiogroup" }, h("ix-field-wrapper", { key: "c26c5e60449ea758e8e83573c66a71bf6ba20ec7", label: this.label, helperText: this.helperText, invalidText: this.invalidText, infoText: this.infoText, warningText: this.warningText, validText: this.validText, showTextAsTooltip: this.showTextAsTooltip, isValid: this.isValid, isInfo: this.isInfo, isWarning: this.isWarning, isInvalid: this.isInvalid, controlRef: this.groupRef }, h("div", { key: "eb23ccdc945e97c6476c7caa20a89bd5d0daf55d", class: {
      "checkbox-container": true,
      "row-layout": this.direction === "row"
    } }, h("slot", { key: "2deb89f76cef431788fdab9da7690d5d4cecf8ec" }))));
  }
  static get watchers() {
    return {
      "value": [{
