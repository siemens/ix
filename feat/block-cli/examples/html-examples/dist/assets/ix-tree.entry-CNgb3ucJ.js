...
const Tree = class {
  ...
  render() {
    return h(Host, { key: "82cd6ba2fbca0bcfb08f2cc4d499f19996d20901", onClick: (event) => this.onTreeItemClick(event) }, h("slot", { key: "54838d116539121c2d5665b3c6846b75e6f8be23" }));
  }
  static get watchers() {
    return {
      "model": [{
