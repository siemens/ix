import { r as registerInstance, c as createEvent, g as getElement, h, H as Host } from "./global-DSse0xVy.js";
...
const Menu = class {
  ...
  render() {
    ...
    return h(Host, { key: "96dea873002b250415ca89292fa5c4f41f470e74", class: {
      expanded: this.expand,
      [`breakpoint-${this.breakpoint}`]: true
    }, slot: "menu" }, h("nav", { key: "5c05324190b22c0b4db09c013d4954bdf6931313", "aria-label": this.applicationName, class: {
      menu: true,
      expanded: this.expand
    } }, h("div", { key: "afd7525b8ef34b972385edb4a91e7c37598066bc", class: "menu-buttons" }, this.breakpoint !== "sm" && h("ix-menu-expand-icon", { key: "62956b5a3b33fa38dc1355987aa680eba640a1f1", breakpoint: this.breakpoint, expanded: this.expand, "i18n-expand": this.i18nExpand, "i18n-collapse": this.i18nCollapse, pinned: this.pinned, class: "menu-expand-icon", onClick: async () => this.toggleMenu(), "data-testid": "expand-collapse-menu" }), this.breakpoint === "sm" && this.applicationLayoutContext?.appSwitchConfig && h("ix-icon-button", { key: "20687d77f9c350828fe974aecbf6b33dfec92a15", onClick: () => {
      this.showAppSwitch();
    }, icon: iconApps, variant: "subtle-tertiary" })), h("div", { key: "09469664ab893c2fef697a33ac655610fc5ae66e", role: "menubar", "aria-orientation": "vertical", "aria-label": this.i18nAriaLabelMenu, "aria-description": this.i18nNavigationHint, class: {
      "menu-navigation": true,
      "menu-navigation--fill": this.shouldFillMenuNavigation
    }, tabIndex: 0, onKeyDown: (e) => this.handleMenuKeyDown(e), onFocusin: (e) => this.handleMenuFocusIn(e), onFocusout: () => this.resetRovingTabIndex() }, h("div", { key: "eea23ee5129393d8cac403be687ebf4d0cf17526", id: "menu-tabs", style: {
      display: "contents"
    }, onClick: (e) => this.onMenuItemsClick(e) }, h("div", { key: "3cad7e895b0c0cffd85229b21239c84b23061a1b", class: "tabs-shadow-container" }, h("div", { key: "23f51b8fc68478203d99769c63eaefef07dcd1c7", class: {
      "tabs--shadow": true,
      "tabs--shadow-top": true,
      "tabs--shadow--show": this.itemsScrollShadowTop
    } }), h("div", { key: "8c0026b6c5a6e3db35646036ed8f66c0f1a34706", class: {
      tabs: true,
      "show-scrollbar": this.expand
    }, onScroll: () => this.handleOverflowIndicator() }, h("div", { key: "5cd914758d8f0401e8e0b107b8e7c0f5b23d1aed", class: "menu-avatar" }, h("slot", { key: "3c1cf2ed1d99fc2eb9af2276fe245c04dbc9101c", name: "ix-menu-avatar" })), h("slot", { key: "70cdeecc904a7c22ea2dcb33accf5360f4c32dd6", name: "home" }), this.breakpoint !== "sm" || !this.isHiddenFromViewport() ? h("slot", null) : null), h("div", { key: "2fb91d7bccd1fea91adb24ef3807d06b7f8758df", class: {
      "tabs--shadow": true,
      "tabs--shadow-bottom": true,
      "tabs--shadow--show": this.itemsScrollShadowBottom
    } }))), h("div", { key: "0e40364d4c6e4501c4fc1d7d6709adc1840efff6", onClick: (e) => this.onMenuItemsClick(e) }, h("slot", { key: "bd8f681ea9e1a961748761e79ec8829490bcb027", name: "bottom", onSlotchange: () => this.updateBottomSlotState() })), h("div", { key: "0011029b7a595deb41f27789bd675c665850b356", class: "bottom-tab-divider" }), h("div", { key: "1efb408c674276f666f40b4aa7dfff512e52c705", class: "menu-utility-controls" }, this.settings ? h("ix-menu-item", { disabled: this.isHiddenFromViewport(), id: "settings", class: {
      "internal-tab": true,
      "bottom-tab": true,
    ...
    }, icon: iconInfo, onClick: async () => this.toggleAbout(!this.showAbout), label: this.i18nLegal, "aria-haspopup": "dialog", "aria-expanded": this.showAbout.toString(), "aria-controls": "menu-overlay" }) : null)), h("div", { key: "e8e1323b69d3db4f39733de19340d979cb1d842d", id: "popover-area" })), h("section", { key: "b38f41deeb36869c087e9b19df93c1178b12e8bd", id: "menu-overlay", role: "dialog", "aria-label": overlayLabel, class: {
      "menu-overlay": true,
      ...
      this.checkTransition();
    } }, h("div", { key: "e2c8546c40811429b5177fbb65e2c3a4814ca93f", class: "menu-overlay-container" }, this.showSettings ? h("slot", { name: "ix-menu-settings" }) : null), h("div", { key: "a4d438f8ec99b43c242efeed726a26a56addf5b0", class: "menu-overlay-container" }, this.showAbout ? h("slot", { name: "ix-menu-about" }) : null)));
  }
  static get watchers() {
    return {
      "expand": [{
