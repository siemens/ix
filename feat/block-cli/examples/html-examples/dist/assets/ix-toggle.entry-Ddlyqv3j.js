...
const Toggle = class extends Mixin(...DefaultMixins, InheritAriaAttributesMixin) {
  ...
  render() {
    ...
    return h(Host, { key: "fe3280319e6d7e0b12f0ca14d1344b57c662ceef", ...this.inheritAriaAttributes, role: "switch", tabindex: this.disabled ? -1 : 0, "aria-label": ariaLabel, "aria-checked": ariaChecked, "aria-disabled": a11yBoolean(this.disabled), "aria-required": a11yBoolean(this.required), class: {
    ...
    } }, h("div", { key: "bbbe78c1cdb191f829c314a834759b8e61478709", class: "wrapper" }, h("div", { key: "4d5ba5978da872bb11fed0cbd2f2e570b3a5c137", class: {
      switch: true,
      checked: this.checked,
      indeterminate: this.indeterminate
    }, "aria-hidden": "true" }, h("div", { key: "d1304f4402839001c771f6ac815a5c266cfcd415", class: "slider" })), !this.hideText && h("ix-typography", { key: "9538ca2e6ddb742588eec4e53894d7b3fc892f7c", class: "label", "aria-hidden": "true" }, toggleText)));
  }
