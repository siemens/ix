...
const RadiobuttonGroup = class {
  ...
  render() {
    return h(Host, { key: "ef586ac5a742b527815b257579b73dfa0096ec14", onIxBlur: () => this.touched = true, ref: this.groupRef, role: "radiogroup" }, h("ix-field-wrapper", { key: "7e8dd8c3191158f02c0d1962a449745923593310", label: this.label, helperText: this.helperText, invalidText: this.invalidText, infoText: this.infoText, warningText: this.warningText, validText: this.validText, showTextAsTooltip: this.showTextAsTooltip, isValid: this.isValid, isInfo: this.isInfo, isWarning: this.isWarning, isInvalid: this.isInvalid, controlRef: this.groupRef }, h("div", { key: "1aacd8d22c70f5b2049579a2fae9f5826dc27964", class: {
      "checkbox-container": true,
      "row-layout": this.direction === "row"
    } }, h("slot", { key: "394ecc801ead572a7c28d17daa0aa46e70727a2e" }))));
  }
  static get watchers() {
    return {
      "value": [{
