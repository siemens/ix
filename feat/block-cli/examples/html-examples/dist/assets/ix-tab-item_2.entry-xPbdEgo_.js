import { r as registerInstance, c as createEvent, h, H as Host, g as getElement } from "./global-B1t25MFd.js";
import { j as iconChevronRightSmall, F as iconChevronLeftSmall } from "./index-CwfZ4aN6-mXhHymhu.js";
...
const TabItem = class {
  ...
  render() {
    return h(Host, { key: "c477409985023d83ae3c592c9c245e95aa1fa2ac", role: "tab", class: this.tabItemClasses({
    ...
    } }, h("div", { key: "22bd1b0cc2dd892a4aa7bd9f7928fbef6c44162c", class: {
      circle: this.rounded,
      text: !this.rounded,
      selected: this.selected,
      disabled: this.disabled
    } }, h("slot", { key: "b617f6f548b622675f525226e6fb0b37d65a3366" })), h("div", { key: "4cbda4f2e47202c72f2c0eb805eeaf5ff55bc0f5", class: {
      counter: true,
      selected: this.selected,
...
const Tabs = class {
  ...
  render() {
    return h(Host, { key: "89d21baa05a5c36f0cf56e8f1f184b937191cf5c" }, this.showArrowPrevious && h("button", { key: "7ba6b9d5bf22f9d6d78cde48f9415a48e3d2d51a", class: "arrow", onClick: () => this.move(this.scrollAmount, true), "aria-label": this.ariaLabelChevronLeftIconButton }, h("ix-icon", { key: "be9c67c9bb72d62aaa2b330cc04b0490349d6215", name: iconChevronLeftSmall, "aria-hidden": "true" })), h("div", { key: "5d65741d61e68318b0550f495aa2379eebe6ea30", class: {
      "tab-items": true,
    ...
    } }, h("div", { key: "c2eb21be7335fe4fa951a7205716466da13fe899", class: "items-content", role: "tablist" }, h("slot", { key: "477e5e0caaef174274102e6f3974d7a403cd00f6" }))), this.showArrowNext && h("button", { key: "fcdda4fc2ece7a398f7e371c1c101a6bd35ec11c", class: "arrow right", onClick: () => this.move(-this.scrollAmount, true), "aria-label": this.ariaLabelChevronRightIconButton }, h("ix-icon", { key: "007c5f31d4b5e045cb30f83c371de7afd349d34d", name: iconChevronRightSmall, "aria-hidden": "true" })));
  }
  static get watchers() {
    return {
      "selected": [{
