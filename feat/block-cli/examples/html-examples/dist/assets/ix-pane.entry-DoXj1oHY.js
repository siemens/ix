...
import { E as iconDoubleChevronDown, F as iconDoubleChevronRight, G as iconDoubleChevronUp, H as iconDoubleChevronLeft, r as iconClose } from "./index-ClV1Tffv-Cwm_ckfF.js";
...
const Pane = class {
  ...
  render() {
    ...
    return h(Host, { key: "bd849c65afb3704b194f63d9be72326d4f499b3c", class: {
    ...
    }, "aria-expanded": a11yBoolean(this.expanded) }, h("aside", { key: "60faaef948056e6244682d5ce5e90ff5da5bd2bf", id: `pane-${this.composition}`, class: {
      "top-bottom-pane": this.isBottomTopPane && !this.isMobile,
      "left-right-pane": this.isLeftRightPane && !this.isMobile,
      "mobile-pane": this.isMobile,
      expanded: this.expanded
    } }, h("div", { key: "cac6a375bc0c6bd2260d0d59c8dc0dde82886641", id: "title-div", class: {
    ...
    } }, h("ix-icon-button", { key: "216d39fdb353922997be2afb1975e03331307529", class: "title-icon", size: "24", icon: this.expanded ? this.isMobile || this.hideOnCollapse ? iconClose : this.expandIcon : this.minimizeIcon, iconColor: this.expanded && (this.isMobile || this.hideOnCollapse) ? "color-soft-text" : void 0, variant: "subtle-tertiary", onClick: () => this.dispatchExpandedChangedEvent(), "aria-controls": `pane-${this.composition}`, "aria-label": paneButtonAriaLabel }), h("div", { key: "01305e78c9beed914490422a36839218fe523521", class: {
      "title-text": true,
      rotate
    } }, this.icon && h("ix-icon", { key: "a18c27873d74fdea3f664d10d101076320599f0e", class: "pane-icon", size: "24", name: this.icon, "aria-label": this.ariaLabelIcon }), h("div", { key: "73447bac4cecccf7ac8ce60dbc8bf2bba56aeef0", class: "title-text-overflow" }, h("ix-typography", { key: "92b142dada0a7974efdcb4d4d607714084796b22", format: "h4" }, this.heading)), this.expanded && h("div", { key: "849cf80a73129aa2d78a05f43002bf7e712a65d3", class: "slot-header" }, h("slot", { key: "d294c206973a1c615e6719f213e6b22884b9f416", name: "header" })))), h("div", { key: "baac9d164c0e7f00f635cea40e020ccb799249b3", class: "side-pane-content", hidden: !this.showContent }, h("slot", { key: "e2095e6e72d822614c8d362169cbc105aeb551ae" }))));
  }
  static get watchers() {
    return {
      "expanded": [{
