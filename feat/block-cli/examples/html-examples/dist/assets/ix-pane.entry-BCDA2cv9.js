...
const Pane = class {
  ...
  render() {
    ...
    return h(Host, { key: "38e4c42239340ae43a9551b6385971b1849452e1", class: {
    ...
    }, "aria-expanded": a11yBoolean(this.expanded) }, h("aside", { key: "971dc7f10dedc7eb869571455950f36f578e41f3", id: `pane-${this.composition}`, class: {
      "top-bottom-pane": this.isBottomTopPane && !this.isMobile,
      "left-right-pane": this.isLeftRightPane && !this.isMobile,
      "mobile-pane": this.isMobile,
      expanded: this.expanded
    } }, h("div", { key: "245646fdf680e968e3d379767e639c7571e40287", id: "title-div", class: {
    ...
    } }, h("ix-icon-button", { key: "9c2cae5eaedb3481862131d587f0f55da644a9fa", class: "title-icon", size: "24", icon: this.expanded ? this.isMobile || this.hideOnCollapse ? iconClose : this.expandIcon : this.minimizeIcon, iconColor: this.expanded && (this.isMobile || this.hideOnCollapse) ? "color-soft-text" : void 0, variant: "subtle-tertiary", onClick: () => this.dispatchExpandedChangedEvent(), "aria-controls": `pane-${this.composition}`, "aria-label": paneButtonAriaLabel }), h("div", { key: "9180df06948d3a9c12de7e95a979449485ba783f", class: {
      "title-text": true,
      rotate
    } }, this.icon && h("ix-icon", { key: "c63b416888be8a46e222f7976d32b45c3caec444", class: "pane-icon", size: "24", name: this.icon, "aria-label": this.ariaLabelIcon }), h("div", { key: "50f3267ae2c7e616a9dfb9cab2b93ff94df7736b", class: "title-text-overflow" }, h("ix-typography", { key: "f6cb18f41486f50c89241f382d9d41ce361c2bab", format: "h4" }, this.heading)), this.expanded && h("div", { key: "0d787fc69b960d7f735996e5c53b9049a452b8be", class: "slot-header" }, h("slot", { key: "13ac41571608712b33a23208644961b18f0c1afc", name: "header" })))), h("div", { key: "3d32b591c974af2b8a7f8cc9232ce43f4053055b", class: "side-pane-content", hidden: !this.showContent }, h("slot", { key: "f00602afbe67d4d281dbba4ee14eb5938ff7d9fc" }))));
  }
  static get watchers() {
    return {
      "expanded": [{
