...
import { p as iconCalendar } from "./index-8HpPmDK_-DinFJk0z.js";
import { D as DateTime } from "./datetime-bDicGJUN-GV0o9Ayg.js";
import { c as createPickerValidityStateTracker, a as addDisposableChangesAndVisibilityObservers, b as adjustPaddingForStartAndEnd, h as handleSubmitOnEnterKeydown, S as SlotEnd, d as SlotStart, e as emitPickerValidityState } from "./input.fc-CPEIRuou-DiipvlwH.js";
...
const DateInput = class {
  ...
  render() {
    ...
    return h(Host, { key: "ad5e8c7026a8a43f8e32f316fd2eb18057878f82", class: {
      disabled: this.disabled,
      readonly: this.readonly
    } }, h("ix-field-wrapper", { key: "0f6c738f36584823826ba24dd1de92de021e79ec", label: this.label, helperText: this.helperText, isInvalid: this.isInvalid, invalidText, infoText: this.infoText, isInfo: this.isInfo, isWarning: this.isWarning, warningText: this.warningText, isValid: this.isValid, validText: this.validText, showTextAsTooltip: this.showTextAsTooltip, required: this.required, controlRef: this.inputElementRef }, this.renderInput()), h("ix-dropdown", { key: "fa6346b23f4c377b000f0991bb7fbff44d368f99", "data-testid": "date-dropdown", trigger: this.inputElementRef.waitForCurrent(), ref: this.dropdownElementRef, closeBehavior: "outside", enableTopLayer: this.enableTopLayer, suppressOverflowBehavior: true, show: this.show, onShowChanged: (event) => {
      this.show = event.detail;
    } }, h("ix-date-picker", { key: "ddd7b6c834ae39cbc4d208592f0c95670338c05c", ref: this.datepickerRef, format: this.format, locale: this.locale, singleSelection: true, from: (_a = this.from) !== null && _a !== void 0 ? _a : "", minDate: this.minDate, maxDate: this.maxDate, onDateChange: (event) => {
