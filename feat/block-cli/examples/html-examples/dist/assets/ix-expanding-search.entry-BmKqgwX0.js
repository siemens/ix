import { a as registerInstance, c as createEvent, h, H as Host } from "./global-Ba1Wm6ph.js";
import { p as iconClear, N as iconSearch } from "./index-Cl7fhG1I-C77BCFLW.js";
...
const ExpandingSearch = class {
  ...
  render() {
    return h(Host, { key: "c9c488013be180e7bde2e5e357c9a6ced1208072", class: {
      expanded: this.expanded,
      "right-position": this.expanded,
      fullWidth: this.fullWidth
    } }, h("ix-icon-button", { key: "559f7315c09340fe97eaa44459f8191c2c36cd59", size: this.expanded ? "16" : "24", icon: this.icon ?? iconSearch, variant: this.expanded ? "tertiary" : this.variant, "data-testid": "button", onClick: () => this.expandInput(), tabindex: this.expanded ? -1 : 0, color: this.hasFocus ? "input-search-icon--color--focus" : void 0, class: {
      "btn-search": true,
      "btn-search--expanded": this.expanded
    }, "aria-label": this.ariaLabelSearchIconButton ?? (this.expanded ? "Close search" : "Open search") }), h("div", { key: "fedcb65eb441180c9d723e0088f84eb205d3367c", class: {
      expanded: this.expanded,
      fullWidth: this.fullWidth,
      collapsed: !this.expanded,
      "disable-pointer": !this.expanded,
      "input-container": true
    }, "data-testid": "input-wrapper" }, h("input", { key: "4c90fe97d5c062ff0220072bebaf136e8a1a2612", class: {
