...
import { S as iconDocument } from "./index-DLhpBBEI-C3tPjcQ4.js";
...
const MenuItem = class {
  ...
  render() {
    ...
    const menuContent = [
      this.icon && h("ix-icon", { key: "8209842fa9f081d96f53c1296a4824c20c022db4", class: "tab-icon", name: this.icon, "aria-hidden": "true" }),
      this.notifications ? h("div", { class: "notification" }, h("div", { class: "pill" }, this.notifications)) : null,
      h("span", { key: "82af59753368d66b4a7701788b10159f439c2119", id: this.internalItemId, class: "tab-text text-default" }, this.label, h("slot", { key: "900ab3d234de85fb6ee07314ee44bd6695bc930a" }))
    ];
    return h(Host, { key: "147627118dbc15358426c777c558a507c2f2cd68", class: {
    ...
    } }, menuContent) : h("button", { ...commonAttributes, ref: this.buttonRef }, menuContent), h("ix-tooltip", { key: "5287865f3894e0f2fbbb88eba859406337f2419c", for: this.buttonRef.waitForCurrent(), placement: "right", showDelay: 1e3, interactive: false, "aria-hidden": a11yBoolean(this.ariaHiddenTooltip), "aria-labelledby": this.internalItemId }, this.tooltip));
  }
