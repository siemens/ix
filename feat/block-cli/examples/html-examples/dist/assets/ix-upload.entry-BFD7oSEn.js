...
import { c as iconSuccess, b as iconError } from "./index-8HpPmDK_-DinFJk0z.js";
...
const Upload = class {
  ...
  render() {
    ...
    return h(Host, Object.assign({ key: "86f46021d8411ed37c036ac8844709bf4f18a8e1" }, a11y, { "aria-disabled": disabled }), h("div", { key: "4e812c550b74d3ff2efee94408391ab34f2e958a", class: {
    ...
    }, onDragOver: (e) => this.fileOver(e), onDragLeave: () => this.fileLeave(), draggable: !this.disabled }, this.renderUploadState(), h("div", { key: "043f4ce74e0da5da6ff7146ea959f5e4abbbaf42" }, h("input", { key: "7781d5dfb001d09f876886c62670ad851684f8e4", "aria-label": ariaLabel, "aria-disabled": disabled, multiple: this.multiple, type: "file", class: "upload-browser", id: "upload-browser", tabindex: "-1", onChange: (e) => {
      this.fileChangeEvent(e);
    }, accept: this.accept, disabled }), h("ix-button", { key: "b2b896877fae3370cae656923413947618fbb037", variant: "secondary", "aria-disabled": disabled, onClick: () => this.inputElement.click(), disabled }, this.i18nUploadFile))));
  }
  get hostElement() {
