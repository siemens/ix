...
import { f as createPickerValidityStateTracker, b as addDisposableChangesAndVisibilityObservers, c as adjustPaddingForStartAndEnd, i as handleSubmitOnEnterKeydown, S as SlotEnd, j as onInputBlurWithChange, a as SlotStart, g as emitPickerValidityState } from "./input.fc-BSbP1M60-GQ5TkkNA.js";
...
const DateInput = class extends Mixin(...DefaultMixins, InputPickerMixin) {
  ...
  render() {
    ...
    return h(Host, { key: "7997cf01789b837ac780aabf5a7f0fa5d5af4eec", class: {
      ...
      this.closeDropdown();
    } }, h("ix-field-wrapper", { key: "2a638648674564d4c1f0baed977352ad8e24c122", label: this.label, helperText: this.helperText, isInvalid: this.isInvalid, invalidText, infoText: this.infoText, isInfo: this.isInfo, isWarning: this.isWarning, warningText: this.warningText, isValid: this.isValid, validText: this.validText, showTextAsTooltip: this.showTextAsTooltip, required: this.required, controlRef: this.inputElementRef }, this.renderInput()), h("ix-dropdown", { key: "a3df151fc204b66192839d8e43a92ffd86233378", "data-testid": "date-dropdown", trigger: this.inputElementRef.waitForCurrent(), ref: this.dropdownElementRef, closeBehavior: "outside", enableTopLayer: this.enableTopLayer, suppressOverflowBehavior: true, show: this.show, onShowChanged: (event) => {
      ...
      return true;
    }, keyboardActivationKeys: ["ArrowUp", "ArrowDown"] }, h("ix-date-picker", { key: "b17a834351cd5423c81b0ac0a4f0d5ca678e0584", ref: this.datepickerRef, format: this.format, locale: this.locale, singleSelection: true, from: this.from ?? "", minDate: this.minDate, maxDate: this.maxDate, onDateChange: (event) => {
