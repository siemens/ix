import { M as Mixin, r as registerInstance, g as getElement, h, H as Host, c as createEvent, a as readTask } from "./global-Cx3A0XQN.js";
...
import { I as InheritAriaAttributesMixin } from "./inherit-aria-attributes.mixin-nCmPujqf-BJ79XzP6.js";
...
const Pill = class extends Mixin(...DefaultMixins) {
  ...
  render() {
    ...
    return h(Host, { key: "26c2152ec63950fc01f6460e772d027f762a4a0a", style: this.variant === "custom" ? {
      "--ix-icon-button-color": this.pillColor
    } : {}, class: {
      "align-left": this.alignLeft
    }, role: hostRole }, h("div", { key: "17e8e5e699bb64d232c2e81ca6be68585228927c", ref: this.containerElementRef, style: { ...customStyle }, class: {
      container: true,
    ...
    } }, this.icon && h("ix-icon", { key: "c5614fc4c331304c99a0a2fad980c9e18bb7408c", class: {
      "with-icon": true
    }, name: this.icon, size: "16", "aria-label": this.ariaLabelIcon, "aria-hidden": a11yBoolean(iconIsDecorative) }), h("span", { key: "76fd87b79984cce7636781cd2fed4183440d3751", class: "slot-container" }, h("slot", { key: "7dc550e762b716fd7cf79316c0c8ca49a712fdd4", onSlotchange: () => this.checkIfContentAvailable() }))), this.getTooltip());
  }
};
Pill.style = pillCss();
...
const TabItem = class extends Mixin(...DefaultMixins, ComponentIdMixin, BaseTabMixin) {
  ...
  render() {
    ...
    return h(Host, { key: "9f53b89ab328101e44cf31bdaae47e960151cf9f", id: this.getHostElementId(), role: "tab", "aria-selected": a11yBoolean(this.selected), tabIndex: this.selected && !this.disabled ? 0 : -1, class: {
    ...
    } }, variant === "rounded" && h("div", { key: "531763df0b2e045de1fa2f219bda644a06d44e8a", class: {
      circle: true
    } }, this.icon && h("ix-icon", { key: "9bfa26eba62007b029317f83d4011de9357b9c31", name: this.icon, size: "24" }), h("slot", { key: "06f2ae923ca30b8c368b45fe0ef54e753f793fd2" })), this.icon && variant !== "rounded" && h("ix-icon", { key: "3f5e5cd0493be078746d0b8a32f1a43cad92104e", name: this.icon, size: "16", class: "tab-icon" }), variant === "normal" && h("div", { key: "24d4afc0a9a0a709be9e14e76da0e783e5725b85", class: {
      text: !!this.label,
      selected: this.selected,
      disabled: this.disabled
    } }, this.label, h("slot", { key: "7ce07f7b0554f5fee6f1fe1cefe73449b0794193" })), variant === "rounded" && this.counter !== void 0 && h("div", { key: "224ec120f2c79245ae69656530e6fb1113d4ec85", class: {
      counter: true,
      selected: this.selected,
      disabled: this.disabled
    } }, this.counter), this.counter && variant !== "rounded" && h("ix-pill", { key: "3710493a5d3e4fb0c6ab6c3bc8a011f533941f88", variant: "primary", outline: true, class: "tab-counter" }, this.counter), this.closable && variant !== "rounded" && h("ix-icon-button", { key: "8ca8ea9a1b17e724239b2e6a3777e106da5601a1", "aria-label": this.ariaLabelCloseButton, class: "close-tab", size: "12", variant: "subtle-tertiary", icon: iconClose, onClick: (event) => {
      event.stopPropagation();
      event.preventDefault();
      this.tabClose.emit({
        tabKey: this.tabKey,
...
const TabSet = class {
  ...
  render() {
    return h(Host, { key: "8d0cbab590cc75f361d5f4a55815fdeebfad344f", onTabChange: () => this.checkPanelsVisibility() }, h("slot", { key: "fd5830583854f24f39d3001d037fdc796b2a26b7" }));
  }
};
...
const Tabs = class extends Mixin(...DefaultMixins, InheritAriaAttributesMixin) {
  ...
  render() {
    return h(Host, { key: "8535270f6e038c5411961500a26f6828de7004ee", onTabClick: (event) => this.onTabClick(event), class: {
      small: this.small
    } }, h("div", { key: "91e0c3b9405e37bc507f35b67780a0b30079fb12", ref: this.tabsContainerRef, class: {
      "tabs-container": true,
      top: this.placement === "top",
      bottom: this.placement === "bottom"
    } }, h("div", { key: "312136649f49647f7ecdfb71f7dc6ebf004f991a", class: {
      "overflow-shadow-container": true,
      "overflow-shadow": this.isTabsOverflow
    } }, h("div", { key: "3668ddb3eaa401029c746e305903e01d348f16b9", role: "tablist", ...this.inheritAriaAttributes, ref: this.tabsRef, class: {
      tabs: true,
      "tabs-stretched": this.layout === "stretched"
    }, tabIndex: this.isTabsOverflow ? 0 : -1, onKeyDown: (event) => this.onTabsNavigate(event) }, h("slot", { key: "24329b89745786035455a514abc589c19f003cdb" }))), this.isTabsOverflow && this.layout !== "stretched" && h("ix-dropdown-button", { key: "9d0fac5ca11295497f0e661a4a98d49165e7cade", ariaLabel: this.ariaLabelMoreTabs, icon: iconMoreMenu, class: {
