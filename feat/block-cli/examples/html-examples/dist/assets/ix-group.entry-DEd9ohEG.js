...
const Group = class {
  ...
  render() {
    return h(Host, { key: "2ff4c250685f165c31aad63da1e958fde95b0f68" }, h("div", { key: "aedd02c16f06d9fb3427991fa8f25045eaf28738", class: {
      "group-header": true,
      expand: this.expanded,
      selected: this.selected
    }, tabindex: "0" }, h("div", { key: "86d7ed73a0c19528e5b33561891cdc79bdfdbe8b", class: "group-header-clickable", onClick: (e) => this.onHeaderClick(e) }, h("div", { key: "cfe630b24e4ff623345d5d08ce0f8352b02ac436", class: {
      "group-header-selection-indicator": true,
      "group-header-selection-indicator-item-selected": this.itemSelected
    } }), h("div", { key: "5962ac0ce5c14b3ca0411206877220d701b3f527", class: "btn-expand-header" }, h("ix-icon", { key: "c88ba732a023e8a8084ae238ff6eb421d02168c3", "data-testid": "expand-collapsed-icon", class: {
      hidden: !this.showExpandCollapsedIcon
    }, name: this.expanded ? iconChevronUpSmall : iconChevronDownSmall, onClick: (event) => this.onExpandClick(event) })), h("div", { key: "12ddafca3e989e79c7c7f6a7d6bf46996fb457c0", class: "group-header-content" }, this.header ? h("div", { class: "group-header-props-container" }, h("div", { class: "group-header-title" }, h("span", { title: this.header }, this.header)), h("div", { class: "group-subheader", title: this.subHeader }, this.subHeader)) : null, h("slot", { key: "17e3568541c7173bd6e9be57b2f8a01095dee2f7", name: "header" }))), this.hasDropdown && h("ix-group-context-menu", { key: "ad18a2de5117e176d8b145c830fdef2ae730149a" }, h("slot", { key: "12b7945cb0428b1eb79707afa4d1972570d911a0", name: "dropdown" }))), h("div", { key: "5bfda0e6082b15f4c5c1e34314537620a72ce6d4", class: {
      "group-content": true
    } }, h("div", { key: "ce69e054f185ed622c5edc4355db37b9f6602159", style: {
      display: this.expanded ? "contents" : "none"
    } }, h("slot", { key: "84501666dfa48755e7c6382a999e148878ad2f43", onSlotchange: () => {
      const slot = this.hostElement.shadowRoot?.querySelector("slot:not([name])");
      this.showExpandCollapsedIcon = hasSlottedElements(slot);
    } }), h("ix-group-item", { key: "d29874821689fabda86907014dcaeea51f7421b1", class: {
      footer: true,
      "footer-visible": this.footerVisible
    }, groupFooter: true, suppressSelection: true }, h("slot", { key: "9b6fcf2255681a54be75b289894a15dbde842034", name: "footer", onSlotchange: () => this.onSlotChange() })))));
  }
  static get watchers() {
    return {
      "selected": [{
