...
const RangeField = class extends Mixin(...DefaultMixins) {
  ...
  render() {
    return h(Host, { key: "424e900b3b75c511367f8c8b296828cb97ab2429", class: { "hide-arrow": this.hideArrow }, role: "group" }, !this.hideArrow && h("ix-icon", { key: "649762116115c6058eece372b074126529f42c04", "aria-hidden": "true", class: {
      "range-delimiter": true,
      "has-label": this.hasLabel
    }, name: iconArrowRight }), h("slot", { key: "19f20e958888dd00686310e5a019e6673d8f2740" }));
  }
};
