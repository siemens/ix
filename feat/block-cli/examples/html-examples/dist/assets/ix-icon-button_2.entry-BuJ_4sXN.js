...
import { B as BaseIconButton } from "./base-icon-button-DufFLJC--B7Zn2jH_.js";
...
import "./base-button-DZdtpLxn-DweJabkL.js";
...
const IconButton = class extends Mixin(...DefaultMixins, InheritAriaAttributesMixin) {
  ...
  render() {
    ...
    return h(Host, { key: "5548680fb14a8576c891896b0c5f8a7694908627", class: {
      ...this.getIconSizeClass(),
      disabled: this.disabled || this.loading
    }, tabIndex: this.disabled ? -1 : 0 }, h(BaseIconButton, { key: "15e72fb6fe5b996b431966c65bab32bc4e0e2b5e", ...baseButtonProps }));
  }
...
const Spinner = class {
  ...
  render() {
    ...
    return h(Host, { key: "50b814cd2a395fc5413629a3ffbf28d992573d37", ...ariaProperties }, h("div", { key: "bd0eb8f9173b957eed52ba33b88485faa27afdeb", class: {
