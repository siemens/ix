...
const CardList = class {
  ...
  render() {
    return h(Host, { key: "336f8d896342bb5daf2773e8b6538374742a5ae2" }, h(CardListTitle, { key: "f0753f9ab4be66512efb1105e772b8e05fd0fb45", isCollapsed: this.collapse, label: this.label, showAllLabel: this.i18nShowAll, showAllCounter: this.showAllCount === void 0 ? this.numberOfAllChildElements : this.showAllCount, onClick: () => this.onCardListVisibilityToggle(), onShowAllClick: (e) => this.onShowAllClick(e), hideShowAll: this.hideShowAll }), h("div", { key: "140d50e38a691e3787978c92c06f759accc2243d", class: {
      CardList__Overflow: true
    }, style: this.computeMaskLayer() }, h("div", { key: "c3bcceb7976cb85692056adb4c7739cd24702575", class: {
    ...
    }, onScroll: () => this.onCardListScroll() }, h("slot", { key: "54517199d3ad20e0505290a56d47505606f26aeb", onSlotchange: () => this.changeVisibilityOfSlotChildren() }), this.isShowMoreCardVisible() ? h("ix-card", { class: {
