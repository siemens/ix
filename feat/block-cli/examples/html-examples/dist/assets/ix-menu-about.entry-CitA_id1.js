...
const MenuAbout = class {
  ...
  render() {
    return h(Host, { key: "f1c53cfcc20206757bfe038dcb333b73042416fb", slot: "ix-menu-about", class: {
      show: this.show,
      ["legacy-tabs"]: !this.suppressLegacyTabs
    } }, h("div", { key: "bff2c605a18fd8e5960677a0d11e1a61ac08f3df", class: "about-header" }, h("h2", { key: "0c706ce1ab007c1017324c80ba45a86270941f51", class: "text-h2" }, this.label), h("ix-icon-button", { key: "5a3e5539bb500764c382bfd56fcc067bdc9129e9", variant: "tertiary", size: "24", icon: iconClose, iconColor: "color-soft-text", "aria-label": this.ariaLabelCloseButton, onClick: (e) => this.close.emit({
      name: "ix-menu-about",
      nativeEvent: e
