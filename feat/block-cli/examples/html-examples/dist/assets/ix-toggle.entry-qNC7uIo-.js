...
const Toggle = class extends Mixin(...DefaultMixins, InheritAriaAttributesMixin) {
  ...
  render() {
    ...
    return h(Host, { key: "d4bf70303518ce1e3d5e1e29eb72bdb7f1fadd5d", ...this.inheritAriaAttributes, role: "switch", tabindex: this.disabled ? -1 : 0, "aria-label": ariaLabel, "aria-checked": ariaChecked, "aria-disabled": a11yBoolean(this.disabled), "aria-required": a11yBoolean(this.required), class: {
    ...
    } }, h("div", { key: "7b63d47339f457b4dea2c9379d0799b99025993e", class: "wrapper" }, h("div", { key: "247efa6dd01413f5c70e79f977212c18a9728495", class: {
      switch: true,
      checked: this.checked,
      indeterminate: this.indeterminate
    }, "aria-hidden": "true" }, h("div", { key: "a7ee81e539ad15453d2625ffac1780a962b92a4a", class: "slider" })), !this.hideText && h("ix-typography", { key: "e0251fc400c01d00c38a48bab3eeb6fb58e31154", class: "label", "aria-hidden": "true" }, toggleText)));
  }
