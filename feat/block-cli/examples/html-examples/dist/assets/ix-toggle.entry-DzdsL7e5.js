...
const Toggle = class {
  ...
  render() {
    ...
    return h(Host, { key: "37073d5c2736c2fe90190471088e8fc094a561b6", role: "switch", "aria-checked": a11yBoolean(this.checked), "aria-disabled": a11yBoolean(this.disabled), class: {
      disabled: this.disabled
    }, onBlur: () => this.ixBlur.emit(), onFocus: () => this.touched = true }, h("label", { key: "52da08966a4d0c2d59f83eef93114f59eac81078", class: "wrapper" }, h("button", { key: "d581308dc30f9908c51dc4b85de09b6fe0db2389", class: {
      switch: true,
      checked: this.checked,
      indeterminate: this.indeterminate
    }, onClick: () => this.onCheckedChange(!this.checked), tabindex: -1, "aria-hidden": "true" }, h("div", { key: "3fdcd6bacbffb6acb8bb7660798844e93541c0c7", class: "slider" })), h("input", { key: "a7426482f5f2779c4f240bbcd344a048fe4b8c08", type: "checkbox", disabled: this.disabled, indeterminate: this.indeterminate, checked: this.checked, tabindex: 0, "aria-hidden": a11yBoolean(true), "aria-checked": a11yBoolean(this.checked), onChange: (event) => this.onCheckedChange(event.target.checked) }), !this.hideText && h("ix-typography", { key: "cce62df94222170a962dc6b3262478da14088854", class: "label" }, toggleText)));
  }
