...
const Pane = class {
  ...
  render() {
    ...
    return h(Host, { key: "2329ec7edbf5be351919ce26817a6851c76a67c9", class: {
    ...
    }, "aria-expanded": a11yBoolean(this.expanded) }, h("aside", { key: "089e4e4915065f12e69dec4207881554397270a6", id: `pane-${this.composition}`, class: {
      "top-bottom-pane": this.isBottomTopPane && !this.isMobile,
      "left-right-pane": this.isLeftRightPane && !this.isMobile,
      "mobile-pane": this.isMobile,
      expanded: this.expanded
    } }, h("div", { key: "c8eff2ae9479a932d4e8a52b796d93d3760135a6", id: "title-div", class: {
    ...
    } }, h("ix-icon-button", { key: "16ad917745a6cb856542722e2842fb8e4abd1bc7", class: "title-icon", size: "24", icon: this.expanded ? this.isMobile || this.hideOnCollapse ? iconClose : this.expandIcon : this.minimizeIcon, iconColor: this.expanded && (this.isMobile || this.hideOnCollapse) ? "color-soft-text" : void 0, variant: "subtle-tertiary", onClick: () => this.dispatchExpandedChangedEvent(), "aria-controls": `pane-${this.composition}`, "aria-label": paneButtonAriaLabel }), h("div", { key: "d7d5a30a43fe6409c4378a2f47e9302d2af37ea4", class: {
      "title-text": true,
      rotate
    } }, this.icon && h("ix-icon", { key: "94b2d29697d9672260719ff530eca440e5a8e371", class: "pane-icon", size: "24", name: this.icon, "aria-label": this.ariaLabelIcon }), h("div", { key: "874b3d0de81af8f2d032cf2cacd0ef2999e81c20", class: "title-text-overflow" }, h("ix-typography", { key: "da47bbe44ecf3cbb709e40301f0f5a3b6fec5708", format: "h4" }, this.heading)), this.expanded && h("div", { key: "eddc035730bf3f1e54ccca65dd006bacf4dd154b", class: "slot-header" }, h("slot", { key: "489f77a8b97ffc51d035b807e18ba1fb2a7b97df", name: "header" })))), h("div", { key: "f206e3b81c37c7bf3d1de808f4fc0c5596e55a3b", class: {
      "side-pane-content": true,
      "no-padding": this.noPadding
    }, hidden: !this.showContent }, h("slot", { key: "c636ecef36efc012943c7a73f8fba64fbbc0f390" }))));
  }
  static get watchers() {
    return {
      "expanded": [{
