...
const MenuItem = class {
  ...
  render() {
    ...
    const menuContent = [
      this.icon && h("ix-icon", { key: "fced162d95a62c954fbf547795e20f9109f0d2ae", class: "tab-icon", name: this.icon, "aria-hidden": "true" }),
      this.notifications ? h("div", { class: "notification" }, h("div", { class: "pill" }, this.notifications)) : null,
      h("span", { key: "d23b3d0ec03a7413eab70ab6f12c8cb6f49b9722", id: this.internalItemId, class: "tab-text text-default" }, this.label, h("slot", { key: "6a6130eaf5e68700ece76479f944d39e710680ce" }))
    ];
    return h(Host, Object.assign({ key: "9706dbbb4035ed513c3ceb8dba43daa4915273d2", class: {
