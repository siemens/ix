import { r as registerInstance, g as getElement, f as forceUpdate, h, H as Host } from "./global-CRrZCTD3.js";
...
const Panes = class {
  ...
  render() {
    return h(Host, { key: "b34c539cbb7d608cf11d8ffda54647453c1752ce" }, !this.isMobile ? this.layout == "full-vertical" ? h("div", { class: "side-panes-wrapper" }, h("div", { class: {
      row: true,
