...
import { O as OnListener } from "./listener-DAJkOQte-PLWfXSKj.js";
...
const Select = class {
  ...
  render() {
    var _a, _b, _c, _d;
    return h(Host, { key: "a914bdaab316583d0f0376e92d9f5cee27f61449", "aria-disabled": a11yBoolean(this.disabled), class: {
      disabled: this.disabled
    } }, h("ix-field-wrapper", { key: "d0f527d565db0cb3978a07241d3262bf89698327", required: this.required, label: this.label, helperText: this.helperText, invalidText: this.invalidText, infoText: this.infoText, warningText: this.warningText, validText: this.validText, showTextAsTooltip: this.showTextAsTooltip, isInvalid: this.isInvalid, isValid: this.isValid, isInfo: this.isInfo, isWarning: this.isWarning, controlRef: this.inputRef }, h("div", { key: "bea541b65630d8b43550af06b38eed93edd6cbce", class: {
      select: true,
      disabled: this.disabled,
    ...
    } }, h("div", { key: "c5b3b8ff7247f8b8f5309eeb897e8be506dcae05", class: "input-container" }, h("div", { key: "f646ec159a97a99c943413184c68417d47d6d71f", class: "chips" }, this.isMultipleMode && this.items.length !== 0 && (this.shouldDisplayAllChip() ? this.renderAllChip() : (_a = this.selectedItems) === null || _a === void 0 ? void 0 : _a.map((item) => this.renderChip(item))), h("div", { key: "a8fce5708ded394b376277c946afbb813001bb86", class: "trigger" }, h("input", { key: "920cec9650f8e051e294d016b2f7ef09a01c9c60", autocomplete: "off", "data-testid": "input", disabled: this.disabled, readOnly: this.readonly, required: this.required, type: "text", class: {
      ...
      if (this.editable)
        this.dropdownWrapperRef(ref);
    }, "aria-label": this.ariaLabelChevronDownIconButton })))))), h("ix-dropdown", { key: "de7510a901248f87731dcd1fac7790f7252d8ae8", ref: (ref) => this.dropdownElement = ref, show: this.dropdownShow, closeBehavior: this.isMultipleMode ? "outside" : "both", class: {
    ...
    } }, h("div", { key: "06d9a6862bbe98a21196db866095dde74a94910e", class: {
      "select-list-header": true,
      hidden: this.hideListHeader || this.isDropdownEmpty
    }, title: this.i18nSelectListHeader, onClick: (e) => e.preventDefault() }, this.i18nSelectListHeader), h("slot", { key: "eef65aca0c86bd061562effd738ce9c812702f1a", onSlotchange: () => {
      this.updateSelection();
    } }), h("div", { key: "a9a18108422b8d8e80b2e1a2382aad1451efd491", ref: (ref) => this.customItemsContainerElement = ref }), this.isAddItemVisible() ? h("ix-dropdown-item", { "data-testid": "add-item", icon: iconPlus, class: {
      "add-item": true
