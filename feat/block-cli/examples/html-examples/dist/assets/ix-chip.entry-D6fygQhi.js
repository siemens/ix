...
import { n as iconCloseSmall } from "./index-Dn2eQInl-mXhHymhu.js";
...
const Chip = class {
  ...
  render() {
    ...
    return h(Host, { key: "2ba142b772c20883d729effd073f1784b88f79b0", tabIndex: "-1", class: {
      inactive: this.inactive
    }, style: this.variant === "custom" ? {
      "--ix-icon-button-color": this.chipColor
    } : {} }, h("div", { key: "fda89ce6c282148f4e3affbb330ff29954923301", ref: this.containerElementRef, style: { ...customStyle }, class: {
      container: true,
    ...
    } }, h("div", { key: "8de181f9c4228a25d9be593bc51f05ab592f598b", class: "content-wrapper" }, this.icon && h("ix-icon", { key: "768c4b797c279f11c29ec4686df2b145be516d6e", class: {
      "with-icon": true
    }, name: this.icon, size: "24", style: this.variant === "custom" ? { color: this.outline ? this.background : this.chipColor } : void 0 }), h("span", { key: "805fa53ce1423c55061b808772c4e58c8bb4d3e5", class: "slot-container" }, h("slot", { key: "d18cb41169fe487e20e3857b3b24c699fbaf6d96" }))), this.inactive === false && this.closable && this.getCloseButton()), this.getTooltip());
  }
};
Chip.style = chipCss();
export {
