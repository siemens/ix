import { r as registerInstance, f as forceUpdate, h, H as Host, M as Mixin, c as createEvent, g as getElement } from "./global-Dfa5QLOG.js";
...
import { O as OnListener } from "./listener-Dk6XGheN-BV-FjhwE.js";
...
const Col = class {
  ...
  render() {
    return h(Host, { key: "495286d08d9e7f6a356f0806b10633c40feed2f7", style: {
      ...this.getColumnSizeStyling()
    } }, h("slot", { key: "57501e5ae522d5c7dfaa365319908117973c7801" }));
  }
};
Col.style = colCss();
...
const LayoutGrid = class {
  ...
  columns = 12;
  render() {
    return h(Host, { key: "e79d0ec8965bbd1ad96ff855dbfdf5d1b13dad98", class: {
      "no-margin": this.noMargin
    }, style: {
      "--ix-layout-grid-columns": `${this.columns}`,
      "--ix-layout-grid-gutter": `${this.gap}px`
    } }, h("slot", { key: "08dc2df800a2c526a4fc08b88481ab219fe9c7d4" }));
  }
};
...
const Row = class {
  ...
  render() {
    return h(Host, { key: "c20d87ca93ccf4ceb5e6087067f7b49a353912a8" }, h("slot", { key: "264ebb84c0a15559411b13c82eb9dd29526e5038" }));
  }
};
Row.style = rowCss();
...
const TimePicker = class extends Mixin(...DefaultMixins) {
  ...
  render() {
    const { bounds } = this.getUnitSelectionContext();
    return h(Host, { key: "a9c7f7c09eee5303117583a839e39a7b7943794e" }, h("ix-date-time-card", { key: "1aa7bb2a0006c621ac629bf33c5935dcb9ee7a20", embedded: this.embedded, timePickerAppearance: true, corners: this.corners, hasFooter: !this.dateTimePickerAppearance, hideHeader: this.hideHeader }, h("div", { key: "9f91bd5e7fe24c8e4f863e54ffaaba1fc770d927", class: "header", slot: "header" }, h("ix-typography", { key: "75cbb1cd141512f352b875367a61fbd80944e326", format: "body" }, this.i18nHeader)), h("div", { key: "38cd0f17934e5c377800e65c1243adc520d78207", class: "clock" }, this.timePickerDescriptors.map((descriptor, index) => {
      return h("div", { class: "flex" }, h("div", { class: { columns: true, hidden: descriptor.hidden }, hidden: descriptor.hidden }, h("div", { class: "column-header", title: descriptor.header }, descriptor.header), h("div", { "data-element-list-id": descriptor.unit, class: "element-list", tabindex: -1 }, descriptor.numberArray.map((number) => {
    ...
    }), this.timeRef && h("div", { key: "6dc5da08a0557528c071d1651c022f8a8dd216c3", class: "flex" }, h("div", { key: "4a6a2d70a8503e6869798dee6be4393d08f2f480", class: "column-separator" }), h("div", { key: "120561adbd798207e94446cfe90cfea22179de8d", class: "columns" }, h("div", { key: "a388bb5ee6d06dec7eee33c72a61ea156374ddff", class: "column-header", title: "AM/PM" }), h("div", { key: "e1fdce26dd482f4b0b0fefeb176d3c5fc12d736c", class: "element-list", tabindex: -1 }, h("button", { key: "33bc00916875dcdd8d86c3ad5919e8cd93db97f1", "data-am-pm-id": "AM", class: {
      selected: this.timeRef === "AM",
      "element-container": true
    }, onClick: () => this.changeTimeReference("AM"), tabindex: "0", "aria-label": "AM" }, "AM"), h("button", { key: "2894f3855029f7edfc816251744bced317018884", "data-am-pm-id": "PM", class: {
      selected: this.timeRef === "PM",
      "element-container": true
    }, onClick: () => this.changeTimeReference("PM"), tabindex: "0", "aria-label": "PM" }, "PM"))))), h("div", { key: "0097d87e14f5757a370ccba23d608767a09db8b9", class: {
      footer: true,
      "footer--compact": this.timePickerDescriptors.length <= 2
    }, slot: "footer" }, h("ix-button", { key: "255252bea51736621be6b23ff956012beb65462b", class: "confirm-button", disabled: this.isConfirmDisabled(), onClick: () => {
