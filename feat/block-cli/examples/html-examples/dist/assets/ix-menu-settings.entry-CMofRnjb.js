import { r as registerInstance, c as createEvent, g as getElement, f as forceUpdate, h, H as Host } from "./global-F68Qu5y3.js";
...
const MenuSettings = class {
  ...
  render() {
    return h(Host, { key: "84ef287e8087dfe3c8a50b17de64a8507f31fafa", slot: "ix-menu-settings", class: {
      show: this.show,
      ["legacy-tabs"]: !this.suppressLegacyTabs
    } }, h("div", { key: "c95e46df3ea73130e2bea585c0de12c317236bca", class: "settings-header" }, h("h2", { key: "ea7e07c54e64f208b932c4033afe60f736a8ce75", class: "text-h2" }, this.label), h("ix-icon-button", { key: "c97014e908da3175009779041bb35bfce8f60b38", variant: "tertiary", size: "24", icon: iconClose, iconColor: "color-soft-text", "aria-label": this.ariaLabelCloseButton, onClick: (e) => this.close.emit({
