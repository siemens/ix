...
const TimePicker = class {
  ...
  render() {
    return h(Host, { key: "fbd91df72649558b205ea0e337e8a29b6f9256ea" }, h("ix-date-time-card", { key: "a5449eff4179a9df0e1cf8bf72435f848f9360ff", embedded: this.embedded, timePickerAppearance: true, corners: this.corners, hasFooter: !this.dateTimePickerAppearance, hideHeader: this.hideHeader }, h("div", { key: "401fdc761ac11d1c68112807a790b1f8cbad622d", class: "header", slot: "header" }, h("ix-typography", { key: "0000299d5d33f4858f6cfdcbbc4e615779bb556c", format: "body" }, this.i18nHeader)), h("div", { key: "f734dc3a8ce505e3cc3539bb1835ad85ded7b7b7", class: "clock" }, this.timePickerDescriptors.map((descriptor, index) => h("div", { class: "flex" }, h("div", { class: { columns: true, hidden: descriptor.hidden } }, h("div", { class: "column-header", title: descriptor.header }, descriptor.header), h("div", { "data-element-list-id": descriptor.unit, class: "element-list", tabIndex: -1 }, descriptor.numberArray.map((number) => {
    ...
    } }, this.getColumnSeparator(index)))), this.timeRef && h("div", { key: "bb49977f48acb00f3d1d60fb43fc7edec4faeb0a", class: "flex" }, h("div", { key: "e4f2b5aa7a8084a33e008294d62d1bb00f17ed90", class: "column-separator" }), h("div", { key: "5ea1646bc59a33e8fd97822667aa3777f33c0477", class: "columns" }, h("div", { key: "7b352f58b254ec207f421e560c7c921b790b4342", class: "column-header", title: "AM/PM" }), h("div", { key: "be780d8e25f6da94829387112aac9b288f4188a1", class: "element-list", tabIndex: -1 }, h("button", { key: "289383e707ec51a48f8f29090be8556da72e639a", "data-am-pm-id": "AM", class: {
      selected: this.timeRef === "AM",
      "element-container": true
    }, onClick: () => this.changeTimeReference("AM"), tabindex: "0", "aria-label": "AM" }, "AM"), h("button", { key: "01f4275c4c3983b834b87de3884f39ef0901915d", "data-am-pm-id": "PM", class: {
      selected: this.timeRef === "PM",
      "element-container": true
    }, onClick: () => this.changeTimeReference("PM"), tabindex: "0", "aria-label": "PM" }, "PM"))))), h("div", { key: "9ee77d7fb2a4149f673d8e6b87e240a3e7123a40", class: {
      footer: true,
      "footer--compact": this.timePickerDescriptors.length <= 2
    }, slot: "footer" }, h("ix-button", { key: "5c87feafc47a5df411614d45147c66f11cd4228e", class: "confirm-button", onClick: () => {
      var _a;
