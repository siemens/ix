import { r as registerInstance, f as forceUpdate, h, H as Host, M as Mixin, c as createEvent, g as getElement } from "./global-J1r-v9CX.js";
...
import { O as OnListener } from "./listener-BjluJgvO-DTWAtIX6.js";
...
const Col = class {
  ...
  render() {
    return h(Host, { key: "412eea32348c7910232c407238c372cc486a8cc8", style: {
      ...this.getColumnSizeStyling()
    } }, h("slot", { key: "8153e1ed8a0147e0a78fb70ada1d1535b42116f8" }));
  }
};
Col.style = colCss();
...
const LayoutGrid = class {
  ...
  columns = 12;
  render() {
    return h(Host, { key: "7736bd7b659bcc76e66757018cef9a6ef4b698f0", class: {
      "no-margin": this.noMargin
    }, style: {
      "--ix-layout-grid-columns": `${this.columns}`,
      "--ix-layout-grid-gutter": `${this.gap}px`
    } }, h("slot", { key: "17aebdd5ed496b81d18d0acaa97d1a2027e1e51f" }));
  }
};
...
const Row = class {
  ...
  render() {
    return h(Host, { key: "c00aa4484ae1e13b68052daccd6fa6d9def0406b" }, h("slot", { key: "3c3f41b67bb4a105d0fdf04ea638f930cd36386c" }));
  }
};
Row.style = rowCss();
...
const TimePicker = class extends Mixin(...DefaultMixins) {
  ...
  render() {
    const { bounds } = this.getUnitSelectionContext();
    return h(Host, { key: "bed952282d864a263f05a9717eaef8282d1541b4" }, h("ix-date-time-card", { key: "4e3a626b71fe06d72c1f05195c5738df37ff2b37", embedded: this.embedded, timePickerAppearance: true, corners: this.corners, hasFooter: !this.dateTimePickerAppearance, hideHeader: this.hideHeader }, h("div", { key: "eb4d211985003910df9a62598dc2d8966eea46f9", class: "header", slot: "header" }, h("ix-typography", { key: "dd0676b888b9e44214dace11caebb614306cd09e", format: "body" }, this.i18nHeader)), h("div", { key: "af0581a491cab9661d7fbc9985f63c405ec6f8a4", class: "clock" }, this.timePickerDescriptors.map((descriptor, index) => {
    ...
    }), this.timeRef && h("div", { key: "35ce51dbaa1426a2bb0fda5265fa7d90082e4d4a", class: "flex" }, h("div", { key: "9fe285d0c6280d1eb0711d3bbf596ebc2a344e70", class: "column-separator" }), h("div", { key: "0dd3949de68ebe30ada10e64b658e48f8c926ee9", class: "columns" }, h("div", { key: "e79e36a77fcb8d511220ad8f0015dff1abb0eafc", class: "column-header", title: "AM/PM" }), h("div", { key: "6577f1573e6a2537fe2f8024ef7a996333dece2e", role: "listbox", "aria-label": "AM/PM", class: "element-list", tabindex: -1 }, h("button", { key: "1456763df8d542eac6627d4db641c10c46544f0f", role: "option", "aria-selected": this.timeRef === "AM" ? "true" : "false", "data-am-pm-id": "AM", class: {
      selected: this.timeRef === "AM",
      "element-container": true
    }, onClick: () => this.changeTimeReference("AM"), tabindex: "0", "aria-label": "AM" }, "AM"), h("button", { key: "7a7f7e01b14bcaed98f147fa326403c28a4c9f64", role: "option", "aria-selected": this.timeRef === "PM" ? "true" : "false", "data-am-pm-id": "PM", class: {
      selected: this.timeRef === "PM",
      "element-container": true
    }, onClick: () => this.changeTimeReference("PM"), tabindex: "0", "aria-label": "PM" }, "PM"))))), h("div", { key: "4896150b809586371d076f752ec4c130cfb2a419", class: {
      footer: true,
      "footer--compact": this.timePickerDescriptors.length <= 2
    }, slot: "footer" }, h("ix-button", { key: "028888f610dc0fb3612b70abd8441a14e27e8f29", class: "confirm-button", disabled: this.isConfirmDisabled(), onClick: () => {
