...
import { r as iconClose, a as iconWarning, c as iconSuccess, b as iconError, i as iconInfo } from "./index-CwfZ4aN6-mXhHymhu.js";
...
const Toast = class {
  ...
  render() {
    ...
    return h(Host, { key: "77d9694837a21131302108562bf71fccea6e7da4", role: "alert", "aria-live": "polite", "aria-atomic": "true", class: "animate__animated animate__fadeIn" }, h("div", { key: "e7a45f61b805e3164bb938691d2812014b562061", class: "toast-body", onPointerLeave: () => {
      this.touched = false;
    }, onPointerEnter: () => {
      this.touched = true;
    } }, (this.type || this.icon) && !this.hideIcon ? h("div", { class: "toast-icon" }, this.getIcon()) : null, h("div", { key: "ac2062305e882e35f76f5f64dee90112d0206a46", class: "toast-content" }, this.toastTitle ? h("ix-typography", { class: "toast-title", format: "h5" }, this.toastTitle) : null, h("div", { key: "bc0dc57cdbcb40937e65713eb03f4601e28f07b6", class: "toast-message" }, h("slot", { key: "8527808a5e34497f5396d2c8a933af183acbfa6d" })), h("div", { key: "c33900706400db587a9e3017122a1f73d014d89c", class: "toast-action" }, h("slot", { key: "a71c3ed97f9362ffaf5eea3ad48ccebea3929b7b", name: "action" }))), h("div", { key: "e4a3b968003b8ecaaf79112e735c9f2b9e5e3be3", class: "toast-close" }, h("ix-icon-button", { key: "9c603ae19110c9eb1296ae65b22cbcbd45ab81df", icon: iconClose, iconColor: "color-soft-text", size: "24", variant: "tertiary", onClick: () => this.closeToast.emit(), "aria-label": this.ariaLabelCloseIconButton }))), !this.preventAutoClose && h("div", { key: "c7c7616ad9af50731a3c167cb17d852e27e7124f", class: progressBarClass.join(" "), style: progressBarStyle, onAnimationEnd: () => {
      this.close();
    }, onTransitionEnd: () => {
      if (this.progress === 0) {
        this.close();
