import { M as Mixin, r as registerInstance, c as createEvent, g as getElement, h, f as forceUpdate, H as Host } from "./global-J1r-v9CX.js";
import { s as iconClear, v as iconChevronUpSmall, h as iconChevronDownSmall, G as iconPlus } from "./index-BcWSlcx_-DijX28Uj.js";
import { a as a11yBoolean } from "./a11y-C21npbUc-CU_Bg8RX.js";
import { P as PROXY_LISTITEM_ID_SUFFIX, a as PROXY_LIST_ID_SUFFIX, u as updateFocusProxyList, F as FocusProxy } from "./focus-proxy-BQyoX-Kl-0lewoSX0.js";
...
const Select = class extends Mixin(...DefaultMixins, ComponentIdMixin, AriaActiveDescendantMixin) {
  ...
  render() {
    return h(Host, { key: "3d53983a1911f291cbae4a0641524d7892e7bbd0", id: this.getHostElementId(), class: {
      readonly: this.readonly,
      disabled: this.disabled,
      "show-focus-outline": this.hasInputFocus && !this.dropdownItemsVisualFocused
    }, tabIndex: this.disabled ? -1 : 0 }, h("ix-field-wrapper", { key: "9e8e761691b9cae92246fa7eb89d48810cf27557", required: this.required, label: this.label, helperText: this.helperText, invalidText: this.invalidText, infoText: this.infoText, warningText: this.warningText, validText: this.validText, showTextAsTooltip: this.showTextAsTooltip, isInvalid: this.isInvalid, isValid: this.isValid, isInfo: this.isInfo, isWarning: this.isWarning, controlRef: this.inputRef }, h("div", { key: "d832ffb64fac08a5227169972429a71808219674", class: {
      select: true,
      disabled: this.disabled,
      readonly: this.readonly
    }, ref: (ref) => {
    ...
    } }, h("div", { key: "b6a6fbbb40048059c6116dddf28ab60095d787db", class: "input-container" }, h("div", { key: "91715b733986a20bca4403d8a302e306ed28b8c2", class: "chips", ref: this.chipsContainerRef }, this.isMultipleMode && this.renderMultipleModeChips(), h("div", { key: "ba707bc06dcb4d27c7f4d534e63e350b4e442988", class: "trigger" }, h("input", { key: "f6de0e20db7b691ab67c0f3533924a9224c2a3b4", id: `${this.hostId}-input`, role: "combobox", "aria-controls": `${this.hostId}-proxy-listbox`, "aria-expanded": a11yBoolean(this.dropdownShow), "aria-autocomplete": "list", "aria-disabled": a11yBoolean(this.disabled), autocomplete: "off", "data-testid": "input", disabled: this.disabled, readOnly: this.readonly, required: this.required, type: "text", class: {
    ...
    }, "data-select-dropdown": true, key: "dropdown", class: { "dropdown-visible": this.dropdownShow }, icon: this.dropdownShow ? iconChevronUpSmall : iconChevronDownSmall, variant: "subtle-tertiary" })))))), h("ix-dropdown", { key: "87cf2b7047dd99cb70e0ba1f9f44a5d4e302f921", id: `${this.hostId}-listbox`, keyboardActivationKeys: ["ArrowUp", "ArrowDown"], keyboardItemTriggerKeys: ["Enter"], disableFocusTrap: true, focusHost: this.hostElement, ref: this.dropdownRef, show: this.dropdownShow, closeBehavior: this.isMultipleMode ? "outside" : "both", hidden: this.disabled || this.readonly, anchor: this.dropdownAnchorRef.waitForCurrent(), trigger: this.dropdownWrapperRef.waitForCurrent(), onShowChange: (event) => {
    ...
    } }, h("div", { key: "431aeb27b2dd2753e9cef02082e339ca80835c42", "aria-hidden": "true", class: {
      "select-list-header": true,
      hidden: this.hideListHeader || this.isDropdownEmpty
    }, title: this.i18nSelectListHeader, onClick: (e) => e.preventDefault() }, this.i18nSelectListHeader), h("slot", { key: "35d7e5db2f71413f198c08fb40ac8b0ebc219546", onSlotchange: () => {
      this.updateSelection();
    } }), h(FocusProxy, { key: "f03a895c7d96f3aebd83d96c9d0aa419fab28d07", hostId: this.hostId, otherProps: {
    ...
    } }), this.isDropdownEmpty && !this.editable && h("div", { key: "2f20fddd865ea84a0663c0c02e4005403762cc04", class: "select-list-header" }, this.i18nNoMatches)), this.isMultipleMode && !this.shouldDisplayAllChip() && this.hiddenChipValues.length > 0 && this.renderOverflowDropdown());
  }
