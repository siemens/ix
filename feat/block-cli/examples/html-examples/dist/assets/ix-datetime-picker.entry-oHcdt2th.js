...
const DatetimePicker = class {
  ...
  render() {
    ...
    return h(Host, { key: "0b394b173758931e6613028c378cf29934660085" }, h("ix-date-time-card", { key: "95d8b2d893af1f6d96a199b8d2c54d4be5037cf8", hideHeader: true, hasFooter: true, embedded: this.embedded, corners: "rounded", noPadding: true }, h("ix-layout-grid", { key: "5732f0be4aee5cd9879ad143920c449d8198c8cd", class: "no-padding" }, h("ix-row", { key: "f62c102ecb6e86c990951a78424747e89bee99a7", class: "row-separator" }, h("ix-col", { key: "f612ec470dd6b5ba8d25dbbf23b93f39b903433b", class: "col-separator" }, h("ix-date-picker", {
      key: "b8234a5c1b9a5752227ce7032776b966b7b95ccc",
    ...
    })), h("ix-col", { key: "ac7993660145a8c341e711d0265d16e9081ff438" }, h("ix-time-picker", {
      key: "b84b8647be07f5bf4050219c1f9784c2f34f620f",
      class: "min-width",
      ...
      tabIndex: this.embedded ? -1 : 0,
      [TRAP_FOCUS_INCLUDE_ATTRIBUTE]: this.embedded
    })))), h("div", { key: "7a51775e66ac79996a166f84757b7f8fc5485fc4", slot: "footer", class: "btn-select-date-container" }, h("ix-button", { key: "007d96be37d204b82fcea2d30f996512157a8b51", class: "btn-select-date", onClick: () => this.onDone() }, this.i18nDone))));
  }
  static get watchers() {
    return {
      "from": [{
