import { M as Mixin, r as registerInstance, g as getElement, h, H as Host, c as createEvent, a as readTask } from "./global-CRrZCTD3.js";
...
const Pill = class extends Mixin(...DefaultMixins) {
  ...
  render() {
    ...
    return h(Host, { key: "c57ad4c666eedaac0ce42f70e4f2a0e7add2e363", style: this.variant === "custom" ? {
      "--ix-icon-button-color": this.pillColor
    } : {}, class: {
      "align-left": this.alignLeft
    }, role: hostRole }, h("div", { key: "db7f5392cda9e1c82fb7c0c6b19f62cf2d63fc8c", ref: this.containerElementRef, style: { ...customStyle }, class: {
      container: true,
    ...
    } }, this.icon && h("ix-icon", { key: "b21054da16776266228d4097c9372f84deb011c5", class: {
      "with-icon": true
    }, name: this.icon, size: "16", "aria-label": this.ariaLabelIcon, "aria-hidden": a11yBoolean(iconIsDecorative) }), h("span", { key: "c3d3923a593aec4a1b1a4a64c6ed937aa3ca9172", class: "slot-container" }, h("slot", { key: "7697d702e507e6666a955f7816f661ccd9f413d8", onSlotchange: () => this.checkIfContentAvailable() }))), this.getTooltip());
  }
};
Pill.style = pillCss();
...
const TabItem = class extends Mixin(...DefaultMixins, ComponentIdMixin, BaseTabMixin) {
  ...
  render() {
    ...
    return h(Host, { key: "24a58141253d1f2c5435d08a50a01c49349b5903", id: this.getHostElementId(), role: "tab", "aria-selected": a11yBoolean(this.selected), tabIndex: this.selected && !this.disabled ? 0 : -1, class: {
    ...
    } }, variant === "rounded" && h("div", { key: "72acea577bd202550231f184ca70ca92c41511c6", class: {
      circle: true
    } }, this.icon && h("ix-icon", { key: "ae3cc1005bd80e1de0269dde413fb3f42aba7a5b", name: this.icon, size: "24" }), h("slot", { key: "ef73d0bdb434f4e6f9e7c10dab07fd3f3fbc8c3f" })), this.icon && variant !== "rounded" && h("ix-icon", { key: "83c738bcae4e2135e0cfe6136017aede61fe19d5", name: this.icon, size: "16", class: "tab-icon" }), variant === "normal" && h("div", { key: "76289565134da0334ef0f5354125f83b4f0e98f1", class: {
      text: !!this.label,
      selected: this.selected,
      disabled: this.disabled
    } }, this.label, h("slot", { key: "f4bbeb6b42873c3216c64cbe1383b1b220c5ffdf" })), variant === "rounded" && this.counter !== void 0 && h("div", { key: "3df96fbeea65cbbc795ce110bd2ba86bd4b6db0f", class: {
      counter: true,
      selected: this.selected,
      disabled: this.disabled
    } }, this.counter), this.counter && variant !== "rounded" && h("ix-pill", { key: "94b88c1b36cfaa1c78b04c658b511ceee5512ca2", variant: "primary", outline: true, class: "tab-counter" }, this.counter), this.closable && variant !== "rounded" && h("ix-icon-button", { key: "819ac4e91e5139af1fcd8ad9c54bca695e39dc3a", "aria-label": this.ariaLabelCloseButton, class: "close-tab", size: "12", variant: "subtle-tertiary", icon: iconClose, onClick: (event) => {
      event.stopPropagation();
      event.preventDefault();
      this.tabClose.emit({
        tabKey: this.tabKey,
...
const TabSet = class {
  ...
  render() {
    return h(Host, { key: "d12bb3d11d45c66a93f8bbfc4d7855dd936e2a44", onTabChange: () => this.checkPanelsVisibility() }, h("slot", { key: "20251cec7410d8c9473ff16e11323cfa73792d06" }));
  }
};
...
const Tabs = class extends Mixin(...DefaultMixins, InheritAriaAttributesMixin) {
  ...
  render() {
    return h(Host, { key: "f54583d4a429f3777fca0c92edb2da88a2762617", onTabClick: (event) => this.onTabClick(event), class: {
      small: this.small
    } }, h("div", { key: "d50ef2343423021edc703bdd166bb51c0f02ee08", ref: this.tabsContainerRef, class: {
      "tabs-container": true,
      top: this.placement === "top",
      bottom: this.placement === "bottom"
    } }, h("div", { key: "fbe48ee07d88ce3d60b6bca099a02ac329006315", class: {
      "overflow-shadow-container": true,
      "overflow-shadow": this.isTabsOverflow
    } }, h("div", { key: "745e8f0345640a992767c5e6a74f3474f3e896e3", role: "tablist", ...this.inheritAriaAttributes, ref: this.tabsRef, class: {
      tabs: true,
      "tabs-stretched": this.layout === "stretched"
    }, tabIndex: this.isTabsOverflow ? 0 : -1, onKeyDown: (event) => this.onTabsNavigate(event) }, h("slot", { key: "29e0c605c7c073fe618943dc9394c51feb30ae8b" }))), this.isTabsOverflow && this.layout !== "stretched" && h("ix-dropdown-button", { key: "9317f344b89d6e1066a52d645aeb434dc0f7fe32", ariaLabel: this.ariaLabelMoreTabs, icon: iconMoreMenu, class: {
