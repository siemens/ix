...
const MenuCategory = class extends Mixin(...DefaultMixins, InheritAriaAttributesMixin) {
  ...
  render() {
    ...
    return h(Host, { key: "445fed5ec6daff0c353fd3ceda9233898b97e9c2", class: {
    ...
    } }, h("ix-menu-item", { key: "252565736da19f01300038d657680aabbae1f31f", ...inheritedA11yWithoutRole, "aria-haspopup": "menu", "aria-expanded": this.showItems || this.showDropdown ? "true" : "false", id: this.categoryId, ref: this.categoryParentRef, class: "category-parent", active: this.isNestedItemActive(), notifications: this.notifications, icon: this.icon, onClick: (e) => this.onCategoryClick(e), onKeyDown: (event) => this.onKeyDown(event), tooltipText: this.tooltipText, isCategory: true, menuCategoryLabel: this.label }, h("span", { key: "d1b757ad17a92e544d472577d189f366d618f707", class: "category" }, h("span", { key: "c488b17280271cdc6ecbfba0fcc3506e17bec251", class: "category-text" }, this.label), h("ix-icon", { key: "8ca4d0e7b0e500c0132e07e1c2644f8f67f093b1", name: iconChevronDownSmall, class: {
      "category-chevron": true,
      "category-chevron--open": this.showItems
    }, "aria-hidden": "true" }))), h("div", { key: "13f6653d504ddc7a059675b0327f46e1e9a68ee3", ref: (ref) => this.menuItemsContainer = ref, class: {
      "menu-items": true,
      "menu-items--expanded": this.showItems,
      "menu-items--collapsed": !this.showItems
    }, role: "menu", "aria-labelledby": this.categoryId, onKeyDown: (e) => this.onMenuItemsKeyDown(e) }, this.showItems ? h("slot", null) : null), h("ix-dropdown", { key: "2b1d77d1c2523214f8e27d6286a5f6a2de374a59", ref: this.dropdownRef, hostRole: "menu", "aria-label": this.label, closeBehavior: "both", show: this.showDropdown, onShowChange: ({ detail }) => this.onDropdownShowChange(detail), onShowChanged: ({ detail }) => this.onDropdownShowChanged(detail), class: "category-dropdown", anchor: this.hostElement, placement: "right-start", offset: {
      mainAxis: 3
    ...
    }, onFocusout: () => this.onDropdownFocusOut() }, h("ix-dropdown-item", { key: "c38c99ca8e0771c59de7374f96a0779b150f5255", class: "category-dropdown-header", tabindex: -1, "aria-hidden": "true" }, h("ix-typography", { key: "f8b387537d4001cc6a829e7d9732c653e8d38403", format: "label", bold: true, textColor: "std" }, this.label)), h("ix-divider", { key: "0340973bffd54b8799b50d41e84d063f5272bc82" }), h("slot", { key: "e494694ee245bbc8645fcddd4eddc56d9ac08198" })));
  }
