import { r as registerInstance, g as getElement, h, H as Host, c as createEvent } from "./global-Cx3A0XQN.js";
...
const GroupContextMenu = class {
  ...
  render() {
    return h(Host, { key: "e16f5e0101ff63a8327e13d2cb4e8bd60c147984" }, h("ix-icon-button", { key: "72de69c25f4cd3abfda3891c9f699b4a5039aaf2", class: { hide: !this.showContextMenu }, size: "24", variant: "subtle-tertiary", icon: iconContextMenu }), h("slot", { key: "00f66a7717f4cd1bc908055d484f164bac726abe", onSlotchange: () => this.onSlotChange() }));
  }
};
