import { r as registerInstance, c as createEvent, g as getElement, h, H as Host, F as Fragment } from "./global-C8IWpzMv.js";
...
const CardList = class {
  ...
  render() {
    return h(Host, { key: "0bf111da4568c609a349e75edc5339642dea49a8" }, h(CardListTitle, { key: "850b76a7c3d49fa268f899565f0eaf94ed99bc46", isCollapsed: this.collapse, label: this.label, showAllLabel: this.i18nShowAll, showAllCounter: this.showAllCount === void 0 ? this.numberOfAllChildElements : this.showAllCount, showLess: this.isShowingAll, labelShowLess: this.i18nShowLess, onClick: () => this.onCardListVisibilityToggle(), onShowAllClick: (e) => this.onShowAllClick(e), hideShowAll: this.hideShowAll }), h("div", { key: "8b3f3c698d262e3c9bd73c410e15c318af5179a4", class: {
      CardList__Overflow: true
    }, style: this.computeMaskLayer() }, h("div", { key: "26f16f501cc7dc0b034ae37a3ad5583ae18734c5", class: {
    ...
    }, onScroll: () => this.onCardListScroll() }, h("slot", { key: "11e5591377829754f32e35201d234bee78734789", onSlotchange: () => {
      this.changeVisibilityOfSlotChildren();
