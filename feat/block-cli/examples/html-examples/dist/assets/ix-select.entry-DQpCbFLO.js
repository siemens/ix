...
import { C as iconPlus, l as iconClear, r as iconChevronUpSmall, h as iconChevronDownSmall } from "./index-BBzEV-f4-ChQfUIyc.js";
import { a as a11yBoolean } from "./a11y-DAzBNVe7-CO1Uj69l.js";
import { A as ArrowFocusController } from "./focus-BAKpVknt-BX94nhwN.js";
import { H as HookValidationLifecycle } from "./validation-CTBekLDe-YfJiut_i.js";
import { O as OnListener } from "./listener-DcAn-vyA-DnHiip0F.js";
...
const Select = class {
  ...
  render() {
    var _a, _b, _c, _d;
    return h(Host, { key: "8d9ad9d9b0f769df416131f0cf1e070fd339dacb", "aria-disabled": a11yBoolean(this.disabled), class: {
      disabled: this.disabled
    } }, h("ix-field-wrapper", { key: "ec4258679e37cc0b41bfc29b3bb7f92fd587a0cf", required: this.required, label: this.label, helperText: this.helperText, invalidText: this.invalidText, infoText: this.infoText, warningText: this.warningText, validText: this.validText, showTextAsTooltip: this.showTextAsTooltip, isInvalid: this.isInvalid, isValid: this.isValid, isInfo: this.isInfo, isWarning: this.isWarning, controlRef: this.inputRef }, h("div", { key: "e24cab01440b19e8afa73a1bc1747e47502bff1b", class: {
      select: true,
      disabled: this.disabled,
    ...
    } }, h("div", { key: "daa88237d4b0f90ab5c2eced6f1b2f71eff753e5", class: "input-container" }, h("div", { key: "d2cc4328c2f3b23ed443305841f038ea722d419a", class: "chips" }, this.isMultipleMode && this.items.length !== 0 && (this.shouldDisplayAllChip() ? this.renderAllChip() : (_a = this.selectedItems) === null || _a === void 0 ? void 0 : _a.map((item) => this.renderChip(item))), h("div", { key: "da2a8d7afe5b037fcf5fb147d4d5a81a27d51db6", class: "trigger" }, h("input", { key: "69ba017bf3d398b485b309c978a6ce72e44a0dc5", autocomplete: "off", "data-testid": "input", disabled: this.disabled, readOnly: this.readonly, required: this.required, type: "text", class: {
      ...
      this.navigationItem = void 0;
    }, onInput: () => this.filterItemsWithTypeahead(), onKeyDown: (e) => this.onKeyDown(e) }), this.allowClear && !this.disabled && !this.readonly && (((_d = this.selectedLabels) === null || _d === void 0 ? void 0 : _d.length) || this.inputFilterText) ? h("ix-icon-button", { key: "clear", class: "clear", icon: iconClear, variant: "subtle-tertiary", oval: true, size: "16", onClick: (e) => {
      e.preventDefault();
      e.stopPropagation();
      this.clear();
    }, "aria-label": this.ariaLabelClearIconButton }) : null, this.disabled || this.readonly ? null : h("ix-icon-button", { "data-select-dropdown": true, key: "dropdown", class: { "dropdown-visible": this.dropdownShow }, icon: this.dropdownShow ? iconChevronUpSmall : iconChevronDownSmall, variant: "subtle-tertiary", ref: (ref) => {
      if (this.editable)
        this.dropdownWrapperRef(ref);
    }, "aria-label": this.ariaLabelChevronDownIconButton })))))), h("ix-dropdown", { key: "9aa4c3054a0745d5330862aceccd5e8da0758bea", ref: (ref) => this.dropdownElement = ref, show: this.dropdownShow, closeBehavior: this.isMultipleMode ? "outside" : "both", class: {
    ...
    } }, h("div", { key: "5d90b00e587652c9c0bfe29bd42608e94355d009", class: {
      "select-list-header": true,
      hidden: this.hideListHeader || this.isDropdownEmpty
    }, title: this.i18nSelectListHeader, onClick: (e) => e.preventDefault() }, this.i18nSelectListHeader), h("slot", { key: "3c8a57b2c872b86216332553b82c094517ac67e0", onSlotchange: () => {
      this.updateSelection();
    } }), h("div", { key: "270f28776f93667d3743e9f625d7f7fb0631cd28", ref: (ref) => this.customItemsContainerElement = ref }), this.isAddItemVisible() ? h("ix-dropdown-item", { "data-testid": "add-item", icon: iconPlus, class: {
      "add-item": true
