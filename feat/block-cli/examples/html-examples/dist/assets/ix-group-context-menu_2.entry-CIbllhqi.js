import { r as registerInstance, g as getElement, h, H as Host, c as createEvent } from "./global-J1r-v9CX.js";
...
const GroupContextMenu = class {
  ...
  render() {
    return h(Host, { key: "adc49d0cecee74dc2fc7e68889c08bfeac7ab065" }, h("ix-icon-button", { key: "bb88d76e2580a365350b727ccb5dce2bd858d7fc", class: { hide: !this.showContextMenu }, size: "24", variant: "subtle-tertiary", icon: iconContextMenu }), h("slot", { key: "f3ad77af3006acc80a0ba93010398a736e80628c", onSlotchange: () => this.onSlotChange() }));
  }
};
