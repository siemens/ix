...
import { p as iconHistory } from "./index-BcWSlcx_-DijX28Uj.js";
...
import { B as BaseButton } from "./base-button-DZdtpLxn-CTGi7raT.js";
...
const DateDropdown = class extends Mixin(...DefaultMixins) {
  ...
  render() {
    ...
    return h(Host, { key: "2939b76488d9493d1d95b811eca5679c5e7fcca4", onFocusout: (event) => {
      const relatedTarget = event.relatedTarget;
      if (!relatedTarget) {
        return;
      }
      this.closeDropdown();
    }, role: "presentation" }, h("ix-button", { key: "9a552e59f9c7cf315d2c9c792d8f1aa395507e62", "data-testid": "date-dropdown-trigger", "data-date-dropdown-trigger": true, variant: this.variant, loading: this.loading, icon: iconHistory, ref: this.triggerRef, disabled: this.disabled, ...this.inheritAriaAttributes, "aria-haspopup": "true", "aria-expanded": a11yBoolean(this.show), "aria-controls": "date-dropdown", "aria-label": ariaLabel, [TRAP_FOCUS_EXCLUDE_ATTRIBUTE]: true }, this.getButtonLabel()), h("ix-dropdown", { key: "e9fe6fc2dd5bf210c321500426f82ff885fa50c0", focusTrapOptions: {
    ...
    } }, h("div", { key: "e61d2842ed1ccbcbae63814ca349f3407b6a2f98", class: "container" }, this.dateRangeOptions?.length > 1 && h("div", { key: "b13799399fa142c118c66a28eba2ecac06d8d544", class: {
    ...
    } }, dateRangeOption.label))), h("div", { key: "1f5202f49f1fbe02b5ec84b6b2ee24ca52041ef0", class: "picker-wrapper" }, h("ix-date-picker", { key: "7afac6ea2d68082b3e179c949af8a186c7a26dbb", ref: this.datePickerRef, embedded: true, locale: this.locale, onDateChange: (e) => {
      e.stopPropagation();
      this.currentRangeValue = {
        ...e.detail,
        id: "custom"
      };
    }, onDateRangeChange: (e) => e.stopPropagation(), format: this.format, singleSelection: this.singleSelection, from: this.from || this.currentRangeValue?.from, to: this.to || this.currentRangeValue?.to, minDate: this.minDate, maxDate: this.maxDate, today: this.today, weekStartIndex: this.weekStartIndex, showWeekNumbers: this.showWeekNumbers }), h("div", { key: "6ceb51dffec89321254dfcd1fe7c53533f9464c1", class: "pull-right" }, h("ix-button", { key: "a72c7b70dc76188a9d50ef8b934b1a6c2fd96aea", onClick: () => {
      if (this.currentRangeValue) {
        this.onDateSelect(this.currentRangeValue);
        this.closeDropdown();
      }
