...
import { O as iconSingleCheck, w as iconChevronRightSmall } from "./index-BBzEV-f4-ChQfUIyc.js";
...
const DropdownItem = class {
  ...
  render() {
    return h(Host, { key: "e752f9334ee0ca95757f0d8eaed1babc05f2c44e", class: {
      hover: this.hover,
      "icon-only": this.isIconOnly(),
      disabled: this.disabled,
      submenu: this.isSubMenu
    }, role: "listitem" }, h("button", { key: "2ca782b52754f534de1f9f80a0e1ed0d6daac793", type: "button", tabIndex: this.disabled ? -1 : 0, class: {
      "dropdown-item": true,
