...
import { t as iconEye, u as iconEyeCancelled } from "./index-BBzEV-f4-ChQfUIyc.js";
...
import { m as mapValidationResult, a as addDisposableChangesAndVisibilityObservers, b as adjustPaddingForStartAndEnd, g as checkInternalValidity, i as getAriaAttributesForInput, e as SlotStart, I as InputElement, d as onInputBlurWithChange, o as onEnterKeyChangeEmit, j as onInputFocus, k as checkAllowedKeys, S as SlotEnd } from "./input.fc-CyTJ73r0-MncRToPr.js";
...
const Input = class {
  ...
  render() {
    ...
    return h(Host, { key: "861342a40bf3b94bc0fcab82c83cb5c0749af33c", class: {
      disabled: this.disabled,
      readonly: this.readonly
    } }, h("ix-field-wrapper", { key: "880d2230afa921e32afa904e43c33e40fdf740b7", htmlForLabel: this.inputId, required: this.required, label: this.label, helperText: this.helperText, invalidText: this.invalidText, infoText: this.infoText, warningText: this.warningText, validText: this.validText, showTextAsTooltip: this.showTextAsTooltip, isInvalid: this.isInvalid, isValid: this.isValid, isInfo: this.isInfo, isWarning: this.isWarning, controlRef: this.inputRef }, h("div", { key: "6b3162c00c2f889018aceaf4c180d24f05f15925", class: "input-wrapper" }, h(SlotStart, { key: "ebfcc94fc06c9ef807fd1f5af7b43cc22afb1949", slotStartRef: this.slotStartRef, onSlotChange: () => this.updatePaddings() }), h(InputElement, { key: "11c4221e715c9a8046305675405a24ad97b30997", id: this.inputId, readonly: this.readonly, disabled: this.disabled, maxLength: this.maxLength, minLength: this.minLength, pattern: this.pattern, type: this.inputType, isInvalid: this.isInvalid, required: this.required, value: this.value, placeholder: this.placeholder, inputRef: this.inputRef, onKeyPress: (event) => checkAllowedKeys(this, event), onFocus: () => onInputFocus(this, this.value), onEnterKeyChange: (event) => onEnterKeyChangeEmit(event, this, this.value), valueChange: (value) => this.valueChange.emit(value), updateFormInternalValue: (value) => this.updateFormInternalValue(value), onBlur: () => {
      onInputBlurWithChange(this, this.inputRef.current, this.value);
      this.touched = true;
    }, ariaAttributes: inputAria, form: (_a = this.formInternals.form) !== null && _a !== void 0 ? _a : void 0, suppressSubmitOnEnter: this.suppressSubmitOnEnter, textAlignment: this.textAlignment }), h(SlotEnd, { key: "4e1def6ac6ff418e4dc8aa355e20d64e14fcd12a", slotEndRef: this.slotEndRef, onSlotChange: () => this.updatePaddings() }, h("ix-icon-button", { key: "d54d7e98e8f9acf37a5421f93637c9fc3d76904a", color: "color-weak-text", class: {
      "password-eye": true,
    ...
    } }))), !!this.maxLength && this.maxLength > 0 && h("ix-typography", { key: "4b23a603cf46352487efa01341a5954f55958c13", class: "bottom-text", slot: "bottom-right", textColor: "soft" }, ((_b = this.value) !== null && _b !== void 0 ? _b : "").length, "/", this.maxLength)));
  }
