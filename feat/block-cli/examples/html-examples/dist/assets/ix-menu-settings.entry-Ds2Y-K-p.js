import { r as registerInstance, c as createEvent, g as getElement, f as forceUpdate, h, H as Host } from "./global-Dfa5QLOG.js";
...
const MenuSettings = class {
  ...
  render() {
    return h(Host, { key: "2e42cc3f9cb4e5effce88696da959c055c73a0a3", slot: "ix-menu-settings", class: {
      show: this.show,
      ["legacy-tabs"]: !this.suppressLegacyTabs
    } }, h("div", { key: "a1992c71a5e196d217d3e1632baa74b1a8a0bcec", class: "settings-header" }, h("h2", { key: "d0a1d6982ee7190352d85741f6c22d2300bd22c2", class: "text-h2" }, this.label), h("ix-icon-button", { key: "3a1f4b2556f4a51c84930588e8fc0abe833cd653", variant: "tertiary", size: "24", icon: iconClose, iconColor: "color-soft-text", "aria-label": this.ariaLabelCloseButton, onClick: (e) => this.close.emit({
      name: "ix-menu-settings",
      nativeEvent: e
    }) })), !this.suppressLegacyTabs ? h("ix-tab-panels", null, h("ix-tabs", { activeTabKey: this.activeTabKey }, this.items.map(({ label, tabKey }) => h("ix-tab-item", { tabKey, selected: tabKey === this.activeTabKey, label }))), h("slot", null)) : h("slot", null));
  }
};
