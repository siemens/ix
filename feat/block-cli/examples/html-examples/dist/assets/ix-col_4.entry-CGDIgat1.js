import { r as registerInstance, f as forceUpdate, h, H as Host, M as Mixin, c as createEvent, g as getElement } from "./global-X6m21_-k.js";
...
const TimePicker = class extends Mixin(...DefaultMixins) {
  ...
  render() {
    return h(Host, { key: "8c3ed4e6070b7660b7b28e8a45f8052e17eaa493" }, h("ix-date-time-card", { key: "a0b84813aa82f32f27aa682434aa07dd722f6c47", embedded: this.embedded, timePickerAppearance: true, corners: this.corners, hasFooter: !this.dateTimePickerAppearance, hideHeader: this.hideHeader }, h("div", { key: "2ddfd84a8c2e60591b3e0ad1c8b045f342e9bd1e", class: "header", slot: "header" }, h("ix-typography", { key: "9839bec26d1ab7fdb394d09d44cdc95259b32c2d", format: "body" }, this.i18nHeader)), h("div", { key: "56fdb4717cef7b59504f7cb89dc80ed1d33ba579", class: "clock" }, this.timePickerDescriptors.map((descriptor, index) => {
    ...
    }), this.timeRef && h("div", { key: "abf6c56943a909f4466d59ea0f2670a0b24aa2a6", class: "flex" }, h("div", { key: "bfeba603e550f8962f02f8bec3864d531a23c9b2", class: "column-separator" }), h("div", { key: "1ac11f733d40c0c4dee5bee1adce3765c7ade713", class: "columns" }, h("div", { key: "5a7bb21b5d59146bc940ffe3167321937e5e272c", class: "column-header", title: "AM/PM" }), h("div", { key: "ef471da4ef071bfb0d9a1f10fbdb6de3463523db", class: "element-list", tabIndex: -1 }, h("button", { key: "01554ad9fcf5fec2d263c0406e9cc26cda75fa12", "data-am-pm-id": "AM", class: {
      selected: this.timeRef === "AM",
      "element-container": true
    }, onClick: () => this.changeTimeReference("AM"), tabindex: "0", "aria-label": "AM" }, "AM"), h("button", { key: "56f2e2844499cb5be5d8e1c752c267de9e1e0a83", "data-am-pm-id": "PM", class: {
      selected: this.timeRef === "PM",
      "element-container": true
    }, onClick: () => this.changeTimeReference("PM"), tabindex: "0", "aria-label": "PM" }, "PM"))))), h("div", { key: "f5dfafd335fe9042937678423f85e6514e112daa", class: {
      footer: true,
      "footer--compact": this.timePickerDescriptors.length <= 2
    }, slot: "footer" }, h("ix-button", { key: "793deb22a84e8d703b40b3abdb6922028cf4e47a", class: "confirm-button", onClick: () => {
