...
import { f as findElement, a as arrow, h as hide, c as computePosition, b as autoUpdate, o as offset, d as flip, s as shift } from "./find-element-wg9fw2rj-DBJU0m-Q.js";
...
const Popover = class extends Mixin(...DefaultMixins, InheritAriaAttributesMixin, ComponentIdMixin) {
  ...
  render() {
    return h(Host, { key: "d3950e6a33913834d9ac23937918ed2a119c339e", class: { visible: this.show }, "data-ix-popover": this.popoverPanelId }, h("dialog", { key: "5c2c659d9fbd6c8c6124e48ac23d0563a6a349dd", ref: this.dialogRef, id: this.popoverPanelId, class: "dialog", popover: "manual", inert: !this.show, ...this.inheritAriaAttributes, role: this.inheritAriaAttributes["role"] ?? "dialog", onMouseEnter: () => this.onDialogMouseEnter(), onMouseLeave: () => this.onDialogMouseLeave() }, h("div", { key: "020ab467f0f869f890e99dfae2eb8882ec6b313c", class: "popover-container" }, h("div", { key: "6d765907691e15b9f37782c0b4c64e31bae5cf22", class: "popover-body" }, h("slot", { key: "e1f14fa9be44cc63f15dbb3d3c8e75c0019646b0" })), this.hasSpike ? h("div", { class: "spike" }) : null)));
  }
  static get watchers() {
    return {
      "role": [{
