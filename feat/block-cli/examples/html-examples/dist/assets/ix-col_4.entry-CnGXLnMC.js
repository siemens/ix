import { r as registerInstance, f as forceUpdate, h, H as Host, M as Mixin, c as createEvent, g as getElement } from "./global-DSse0xVy.js";
...
const LayoutGrid = class {
  ...
  columns = 12;
  render() {
    return h(Host, { key: "079a5d530952ccf05c06003b203a36bda3f8d6b1", class: {
      "no-margin": this.noMargin
    }, style: {
      "--ix-layout-grid-columns": `${this.columns}`,
      "--ix-layout-grid-gutter": `${this.gap}px`
    } }, h("slot", { key: "1efc7a089edf9285ed5c0de645203244b2f88202" }));
  }
};
...
const Row = class {
  ...
  render() {
    return h(Host, { key: "032a4198d3905f769803426dce3bbaca54de71ab" }, h("slot", { key: "644167f51992fd4f3a378be3d9cb331b55b20938" }));
  }
};
Row.style = rowCss();
...
const TimePicker = class extends Mixin(...DefaultMixins) {
  ...
  render() {
    const { bounds } = this.getUnitSelectionContext();
    return h(Host, { key: "a42e9072c012b05c4c84a5cae80b9e1da5ad0d9c" }, h("ix-date-time-card", { key: "55456f4680e9df052cde4964c610c1fc567cc372", embedded: this.embedded, timePickerAppearance: true, corners: this.corners, hasFooter: !this.dateTimePickerAppearance, hideHeader: this.hideHeader }, h("div", { key: "af72e59c8f31eb936b65439bf8d1a8538cc5a3f0", class: "header", slot: "header" }, h("ix-typography", { key: "ff4af2cf2a2bbff46485af19e4947d61eb107a0e", format: "body" }, this.i18nHeader)), h("div", { key: "528558bd68880efca3c59c9e683f9f06d0171983", class: "clock" }, this.timePickerDescriptors.map((descriptor, index) => {
    ...
    }), this.timeRef && h("div", { key: "7534ced6e8fe54208c7cac80c4c9ad47e3a46113", class: "flex" }, h("div", { key: "bb04b558bbce66b68fbdf5f98efec3db544ca82b", class: "column-separator" }), h("div", { key: "c93fb73379f2e54d07397661cb696cf43b3d9496", class: "columns" }, h("div", { key: "8d9417092795256f77db8d42e9108a5f4c75ce2b", class: "column-header", title: "AM/PM" }), h("div", { key: "89e94487a5330a5d11ab53dc37a88015e6d66b7c", role: "listbox", "aria-label": "AM/PM", class: "element-list", tabindex: -1 }, h("button", { key: "5a2a3113c36b7c59d6d7e320aae8ca4ca4146d2f", role: "option", "aria-selected": this.timeRef === "AM" ? "true" : "false", "data-am-pm-id": "AM", class: {
      selected: this.timeRef === "AM",
      "element-container": true
    }, onClick: () => this.changeTimeReference("AM"), tabindex: "0", "aria-label": "AM" }, "AM"), h("button", { key: "b5dd697c42f90985a4898895ce700453f8589538", role: "option", "aria-selected": this.timeRef === "PM" ? "true" : "false", "data-am-pm-id": "PM", class: {
      selected: this.timeRef === "PM",
      "element-container": true
    }, onClick: () => this.changeTimeReference("PM"), tabindex: "0", "aria-label": "PM" }, "PM"))))), h("div", { key: "5a8b183a216965428bb71961f679a375708993f3", class: {
      footer: true,
      "footer--compact": this.timePickerDescriptors.length <= 2
    }, slot: "footer" }, h("ix-button", { key: "a0cd6fc9b2b59c9aefea02d52a5189d223c20e1d", class: "confirm-button", disabled: this.isConfirmDisabled(), onClick: () => {
