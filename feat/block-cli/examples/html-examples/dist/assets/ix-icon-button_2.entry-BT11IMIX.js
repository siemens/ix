...
const IconButton = class extends Mixin(...DefaultMixins, InheritAriaAttributesMixin) {
  ...
  render() {
    ...
    return h(Host, { key: "b91f0aa6ffa326f47585b7a8c2f8ce42bbda1c17", class: {
      ...this.getIconSizeClass(),
      disabled: this.disabled || this.loading
    }, tabIndex: this.disabled ? -1 : 0 }, h(BaseIconButton, { key: "aa2cd91e3a5f5f6262c3122626d57c7ba7a70114", ...baseButtonProps }));
  }
...
const Spinner = class {
  ...
  render() {
    ...
    return h(Host, { key: "b11e319be097481ecca19b6a31d32b9b73a290b0", ...ariaProperties }, h("div", { key: "5a6c30136f976febe039569f7067455d2da1f526", class: {
