...
const Breadcrumb = class extends Mixin(...DefaultMixins) {
  ...
  render() {
    ...
    return h(Host, { key: "c3e4f145fe7d568ff7220213632592dff1bef8f0", ...this.inheritAriaAttributes, role: "navigation" }, this.items?.length > this.visibleItemCount && h("ix-dropdown-button", { key: "76b39efb5e1a0af98ae360faa115744bd15fce45", "aria-label": this.ariaLabelPreviousButton, label: "...", variant: "tertiary", class: "previous-button", enableTopLayer: this.enableTopLayer }, h("ix-icon", { key: "714c20eca91ce21df2e3634a6a7504bee760d4fd", slot: "button-label", name: iconChevronRightSmall, size: "16", class: "chevron" }), this.items.slice(0, this.items.length - this.visibleItemCount).map((item) => {
    ...
    })), h("div", { key: "2485920ff5f0ff2d68335cc57f646009f99f7288", class: "crumb-items" }, h("slot", { key: "ce452dd2c1307a6a6788c5995132bae642f2f716" })), this.shouldRenderNextDropdown && h("ix-dropdown-button", { key: "dc8d31e142c9b628cde1875635b70d238cbdf1ad", label: labelLastItem.label ?? labelLastItem.innerText, class: "next-button", variant: "tertiary", enableTopLayer: this.enableTopLayer, "aria-current": "page" }, h("ix-icon", { key: "84335d9da320ec8272b45421dffb94583f57dbb1", slot: "button-label", name: iconChevronRightSmall, size: "16", class: "chevron" }), this.nextItems?.map((item) => h("ix-dropdown-item", { label: item.label, onClick: (e) => {
      this.nextClick.emit({
        event: e,
        item
      });
