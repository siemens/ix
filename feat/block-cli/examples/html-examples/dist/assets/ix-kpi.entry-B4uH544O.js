...
import { a as iconWarning, w as iconAlarm } from "./index-Dn2eQInl-mXhHymhu.js";
...
const Kpi = class {
  ...
  render() {
    return h(Host, { key: "81769ad68716666989edc4d30726480fc1e71ec7", title: this.getTooltipText(), tabindex: "1", class: {
      stacked: this.orientation === "vertical"
    } }, h("div", { key: "de4cc4c80d3c598ae4183ae9a7ec5b5c1b2f1d91", class: {
      "kpi-container": true,
      alarm: this.state === "alarm",
      warning: this.state === "warning"
    } }, h("span", { key: "7f41a0eaceb035dfbe5c0868b7b99b85f9b357d8", class: "kpi-label" }, this.getStateIcon(), h("span", { key: "9e57a9c9aede28ed8fc25dca6e1620f56e120400", class: "kpi-label-text" }, this.label)), h("span", { key: "4c5fa41b571973d1b6099287498b9f3640c20443", class: "kpi-value-container" }, h("span", { key: "0096cb50a164a8d68b899fea66f2ab38c82f91d3", class: "kpi-value" }, this.value), this.unit ? h("span", { class: "kpi-unit" }, this.unit) : "")));
  }
};
Kpi.style = kpiCss();
export {
