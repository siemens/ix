import { r as registerInstance, h, H as Host, g as getElement } from "./global-CfZV-boF.js";
...
const Tooltip = class {
  ...
  render() {
    return h(Host, { key: "682cc1f0cc62163a87113f6e1e803d220b5db716", role: "tooltip", class: { visible: this.visible } }, h("dialog", { key: "c12e5107c68039d8689291d1771121e697223f1f", ref: this.dialogRef, id: "tooltip-" + this.instance, class: "dialog", popover: "manual", inert: !this.visible }, h("div", { key: "6fe8c464e70442c3b629be576ddcf4984ee155a1", class: "tooltip-container" }, h("div", { key: "b0cc67360a4988786796e565b08c76c90d91cb36", class: "content-wrapper" }, h("div", { key: "5097e3b2b68bcd75e01285793294d60f5dac15db", class: "tooltip-title" }, h("slot", { key: "f0b86340bf7e5163a8970ea6b4c17f9bc6631255", name: "title-icon", onSlotchange: (e) => this.handleTitleIconSlotChange(e) }), h("ix-typography", { key: "44618c64116435d5032fa031c1503e11b5a12a94", format: "h5" }, this.titleContent, h("slot", { key: "5646d3eefac1f32e6313cd76ffbc8296f575fc22", name: "title-content" }))), h("slot", { key: "78ba14bb163ad2e06a8e17e32b2e38a9a62bdcbc" }), h("div", { key: "bd9fdd5d2ecda93b71ad5a0609218d1a19bd303a", class: "arrow" })))));
  }
  get hostElement() {
