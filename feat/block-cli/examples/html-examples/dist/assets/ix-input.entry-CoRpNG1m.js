...
import { t as iconEye, u as iconEyeCancelled } from "./index-8HpPmDK_-DinFJk0z.js";
...
import { m as mapValidationResult, a as addDisposableChangesAndVisibilityObservers, b as adjustPaddingForStartAndEnd, f as checkInternalValidity, g as getAriaAttributesForInput, d as SlotStart, I as InputElement, o as onInputBlur, i as checkAllowedKeys, S as SlotEnd } from "./input.fc-CPEIRuou-DiipvlwH.js";
...
const Input = class {
  ...
  render() {
    ...
    return h(Host, { key: "b7a5c24ae5395ed0cdec4e4770666120d84cfb24", class: {
      disabled: this.disabled,
      readonly: this.readonly
    } }, h("ix-field-wrapper", { key: "7e11f8386719824525eb170dd39e8138e684a84a", htmlForLabel: this.inputId, required: this.required, label: this.label, helperText: this.helperText, invalidText: this.invalidText, infoText: this.infoText, warningText: this.warningText, validText: this.validText, showTextAsTooltip: this.showTextAsTooltip, isInvalid: this.isInvalid, isValid: this.isValid, isInfo: this.isInfo, isWarning: this.isWarning, controlRef: this.inputRef }, h("div", { key: "1828e131ae867ce5d03d8c070c7a20583f94390b", class: "input-wrapper" }, h(SlotStart, { key: "292cf83d7b665ba82dd5dfdfb4d197c498b949e5", slotStartRef: this.slotStartRef, onSlotChange: () => this.updatePaddings() }), h(InputElement, { key: "f9852c9396d9fddcb17a689ded7be94c84082529", id: this.inputId, readonly: this.readonly, disabled: this.disabled, maxLength: this.maxLength, minLength: this.minLength, pattern: this.pattern, type: this.inputType, isInvalid: this.isInvalid, required: this.required, value: this.value, placeholder: this.placeholder, inputRef: this.inputRef, onKeyPress: (event) => checkAllowedKeys(this, event), valueChange: (value) => this.valueChange.emit(value), updateFormInternalValue: (value) => this.updateFormInternalValue(value), onBlur: () => {
      onInputBlur(this, this.inputRef.current);
      this.touched = true;
    }, ariaAttributes: inputAria, form: (_a = this.formInternals.form) !== null && _a !== void 0 ? _a : void 0, suppressSubmitOnEnter: this.suppressSubmitOnEnter, textAlignment: this.textAlignment }), h(SlotEnd, { key: "9e271fa14ebb05159ed1ff56a7da81e705830d87", slotEndRef: this.slotEndRef, onSlotChange: () => this.updatePaddings() }, h("ix-icon-button", { key: "970ace6db7b6c85b72e952a2c24db40fba4b28cd", color: "color-weak-text", class: {
      "password-eye": true,
    ...
    } }))), !!this.maxLength && this.maxLength > 0 && h("ix-typography", { key: "c27b8099250cda0b471c2dcd87efea0c7fda7326", class: "bottom-text", slot: "bottom-right", textColor: "soft" }, ((_b = this.value) !== null && _b !== void 0 ? _b : "").length, "/", this.maxLength)));
  }
