...
const KeyValue = class {
  ...
  value;
  render() {
    return h(Host, { key: "0078c012f4252919011602d11178cd582d022d60", class: `keyValue keyValue--${this.labelPosition === "top" ? "column" : "row"}` }, this.icon && h("ix-icon", { key: "52af76bc14cca38886d13275771bf0594bef6e26", name: this.icon, size: "24", class: "keyValue__icon", "aria-label": this.ariaLabelIcon }), h("div", { key: "94ec6793dbff5cbc3deaf654f8c15d71fcc54067", class: "keyValue__content" }, h("div", { key: "ae2bf6e5b41eb02bdd33b644f0f2441f7a948553", class: "content__label" }, this.label), h("div", { key: "048c94268e0929a07d21f40ee7f87291e3a757d7", class: {
      content__value: true,
