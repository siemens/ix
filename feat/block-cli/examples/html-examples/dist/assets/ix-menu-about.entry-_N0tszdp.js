...
const MenuAbout = class {
  ...
  render() {
    return h(Host, { key: "52f6b73badd5eabb379f39a7b81d772115649478", slot: "ix-menu-about", class: {
      show: this.show,
      ["legacy-tabs"]: !this.suppressLegacyTabs
    } }, h("div", { key: "75959617d53f5c166d14c9fc57e35576fd72189b", class: "about-header" }, h("h2", { key: "e9219d749bf13e1d1672caa122d1bcb2d0dbde07", class: "text-h2" }, this.label), h("ix-icon-button", { key: "f40a1e0f30f35daeb8db2205c6964e98a15e8897", variant: "tertiary", size: "24", icon: iconClose, iconColor: "color-soft-text", "aria-label": this.ariaLabelCloseButton, onClick: (e) => this.close.emit({
      name: "ix-menu-about",
      nativeEvent: e
