...
import { U as iconCloseSmall } from "./index-BcWSlcx_-DijX28Uj.js";
...
const Chip = class extends Mixin(...DefaultMixins, InheritAriaAttributesMixin) {
  ...
  render() {
    ...
    return h(Host, { key: "e23390ea1e695eef8b815942dbb5b61eddae4bac", role: this.getHostRole(needsGroupRole), class: {
      inactive: this.inactive
    } }, h("div", { key: "0e8c2949850596e3c3d130dce4c248571494a535", ref: this.containerElementRef, class: wrapClasses, style: customWrapStyle }, h("button", { key: "52d5db14e8cf8704c19c2c726575db89e64edeba", type: "button", class: "chip-main", ...this.inheritAriaAttributes, disabled: this.inactive, style: customMainStyle }, h("div", { key: "f38fe3da5f623a330e230e15a2d6697031ffe0fa", class: "content-wrapper" }, this.icon && h("ix-icon", { key: "d5c03d508089425bd4a42c5eeff8ab3386c064e8", class: {
      "with-icon": true
    }, name: this.icon, size: "24", "aria-label": this.ariaLabelIcon, "aria-hidden": a11yBoolean(iconIsDecorative), style: this.getIconStyle(variant) }), h("span", { key: "7ce87274a9ae64a9ae30e6c67e5d996b84167f71", class: "slot-container" }, h("slot", { key: "6c93249d5615e937c1d07384739c6dd4dc19b04f" })))), this.closable && h("button", { key: "df92480e74569d2ac860e9945c1ebca849db858c", type: "button", class: "chip-close", "aria-label": this.ariaLabelCloseButton, onClick: (event) => {
      this.closeChip.emit(event);
      event.stopPropagation();
    } }, h("ix-icon", { key: "f1e4d79ccf9c8c1247b790e8d3f8c2c35f5babba", class: "chip-close__icon", name: iconCloseSmall, size: "16", "aria-hidden": "true" }))), this.getTooltip());
  }
  static get watchers() {
    return {
      "role": [{
