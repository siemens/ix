...
const CardAccordion = class {
  ...
  render() {
    return h(Host, { key: "b0d28388bb0c1b871cc5e4f1abde41167115529c", slot: "card-accordion", class: {
      [`variant-${this.variant}`]: true
    } }, h("button", { key: "7ac0a92bc44bbb66ab3353641a2e0ff08dd21fa8", tabIndex: 0, class: { "expand-action": true, show: this.expandContent }, onClick: (event) => this.onExpandActionClick(event), role: "button", type: "button", "aria-expanded": this.expandContent, "aria-controls": getAriaControlsId(), "aria-label": this.ariaLabelExpandButton }, h("ix-icon", { key: "3fa012e7d019ea0a7bd09e4e792f94d62d100769", name: iconChevronDownSmall, class: {
      "expand-icon": true,
      show: this.expandContent
    } })), h("div", { key: "2eddc155aeedc555d1f3994467f8805ace3f441f", class: {
      "expand-content": true,
      show: this.expandContent
    } }, h("div", { key: "ffee5be875c77ca17fc1d966f9e2a131e217030d", class: "expand-content-inner" }, h("div", { key: "515d8843755df6214630964f91cb13a1d77a7fd4", class: "expand-content-body" }, h("slot", { key: "1bbb15d8348da0a5f946b646c5417fa6e33c138f" })), h("div", { key: "f88d731398822a6908e21b2864afaa1fd1c32af1", class: "expand-content-footer" }))));
  }
  static get watchers() {
    return {
      "collapse": [{
...
const CardHeader = class {
  ...
  render() {
    return h(Host, { key: "966a8bf9176df210e24fe3f46b406715200ad091" }, h("slot", { key: "a52240f22f62719b6de4d6b0e928c31c05d9db9b" }), h("div", { key: "52f080e2f49ba973eff9a8876df17759d4d5985a", class: "title-actions" }, h("slot", { key: "08cbbc4fdd0697c37a6c3242aa3402670c539cb2", name: "title-actions" })));
  }
};
