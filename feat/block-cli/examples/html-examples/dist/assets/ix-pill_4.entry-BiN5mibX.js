import { M as Mixin, r as registerInstance, g as getElement, h, H as Host, c as createEvent, a as readTask } from "./global-C8IWpzMv.js";
...
import { y as iconClose, e as iconMoreMenu } from "./index-DgUGsIlh-CLxQRaVd.js";
...
import { I as InheritAriaAttributesMixin } from "./inherit-aria-attributes.mixin-nCmPujqf-CWDk8al3.js";
...
const Pill = class extends Mixin(...DefaultMixins) {
  ...
  render() {
    ...
    return h(Host, { key: "dbbf3699a590c3e61046215e81485fa898716b51", style: this.variant === "custom" ? {
      "--ix-icon-button-color": this.pillColor
    } : {}, class: {
      "align-left": this.alignLeft
    }, role: hostRole }, h("div", { key: "581272890b94ea4dad8ccd9e15b72e7c1eef58cc", ref: this.containerElementRef, style: { ...customStyle }, class: {
      container: true,
    ...
    } }, this.icon && h("ix-icon", { key: "ab4d7fa54d797401f130648edce963ba1d0149e7", class: {
      "with-icon": true
    }, name: this.icon, size: "16", "aria-label": this.ariaLabelIcon, "aria-hidden": a11yBoolean(iconIsDecorative) }), h("span", { key: "5cbff6577af56e4c8972ad7222d78e549ef0ae43", class: "slot-container" }, h("slot", { key: "0855a3e6109c1af034f3a2b5f5d3b018b2e2271a", onSlotchange: () => this.checkIfContentAvailable() }))), this.getTooltip());
  }
};
Pill.style = pillCss();
...
const TabItem = class extends Mixin(...DefaultMixins, ComponentIdMixin, BaseTabMixin) {
  ...
  render() {
    ...
    return h(Host, { key: "14fddef94a0e86e5c221bb798bb1d279350987d1", id: this.getHostElementId(), role: "tab", "aria-selected": a11yBoolean(this.selected), tabIndex: this.selected && !this.disabled ? 0 : -1, class: {
    ...
    } }, variant === "rounded" && h("div", { key: "6bd8fac4776e40bf9f74f985f15187de90e9ee1c", class: {
      circle: true
    } }, this.icon && h("ix-icon", { key: "6abe1a88d1f119ebda3b0e2e35cb81e501502b76", name: this.icon, size: "24" }), h("slot", { key: "7b2c51e5fffc479d1f0732da702a2cae1845a139" })), this.icon && variant !== "rounded" && h("ix-icon", { key: "323583910b0c46ef26a6f96297af3cc7cfdba08f", name: this.icon, size: "16", class: "tab-icon" }), variant === "normal" && h("div", { key: "1af6cd3c513c01aaf5f70b9a30a99de7d3f50513", class: {
      text: !!this.label,
      selected: this.selected,
      disabled: this.disabled
    } }, this.label, h("slot", { key: "4b07b5edd44b60b4966e27cbac79b48cc30b5448" })), variant === "rounded" && this.counter !== void 0 && h("div", { key: "1e1fbc80ec49d6d0ab5100e59f38c086a6d11993", class: {
      counter: true,
      selected: this.selected,
      disabled: this.disabled
    } }, this.counter), this.counter && variant !== "rounded" && h("ix-pill", { key: "d34e1f8436ae3ee14186c9d26a1b9f177f27ffbe", variant: "primary", outline: true, class: "tab-counter" }, this.counter), this.closable && variant !== "rounded" && h("ix-icon-button", { key: "3f586a2b052f114ee6b100401c758169a1c928c1", "aria-label": this.ariaLabelCloseButton, class: "close-tab", size: "12", variant: "subtle-tertiary", icon: iconClose, onClick: (event) => {
      event.stopPropagation();
      event.preventDefault();
      this.tabClose.emit({
        tabKey: this.tabKey,
...
const TabSet = class {
  ...
  render() {
    return h(Host, { key: "164869e448dc7e1e061b43f1e386a618ec9d3e98", onTabChange: () => this.checkPanelsVisibility() }, h("slot", { key: "8ce970352c713e4b0aeab6817c719cc7ff773b34" }));
  }
};
...
const Tabs = class extends Mixin(...DefaultMixins, InheritAriaAttributesMixin) {
  ...
  render() {
    return h(Host, { key: "6b1435a68e5693523a3d0bae2ce589f154fad6ad", onTabClick: (event) => this.onTabClick(event), class: {
      small: this.small
    } }, h("div", { key: "9ed14c9fbff90f8d9f1ba4ed41c2691c3d10b393", ref: this.tabsContainerRef, class: {
      "tabs-container": true,
      top: this.placement === "top",
      bottom: this.placement === "bottom"
    } }, h("div", { key: "b1cffb7094b9c0d490ce76c8b90ccbb70b102a92", class: {
      "overflow-shadow-container": true,
      "overflow-shadow": this.isTabsOverflow
    } }, h("div", { key: "231919d04c9ee8162d31dff4cd421db8d80609d4", role: "tablist", ...this.inheritAriaAttributes, ref: this.tabsRef, class: {
      tabs: true,
      "tabs-stretched": this.layout === "stretched"
    }, tabIndex: this.isTabsOverflow ? 0 : -1, onKeyDown: (event) => this.onTabsNavigate(event) }, h("slot", { key: "09ceaf5430a42fa166f9d8e3c0c0480bcee60216" }))), this.isTabsOverflow && this.layout !== "stretched" && h("ix-dropdown-button", { key: "a2c97dd05665f64f9c889e845139d98af8724fe0", ariaLabel: this.ariaLabelMoreTabs, icon: iconMoreMenu, class: {
