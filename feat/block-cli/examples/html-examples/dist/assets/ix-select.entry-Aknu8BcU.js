import { M as Mixin, r as registerInstance, c as createEvent, g as getElement, h, H as Host } from "./global-X6m21_-k.js";
import { m as iconClear, u as iconChevronUpSmall, h as iconChevronDownSmall, E as iconPlus } from "./index-Dn2eQInl-mXhHymhu.js";
...
import { H as HookValidationLifecycle } from "./validation-DIqrnj8M-Fd-uzID5.js";
...
import { P as PROXY_LISTITEM_ID_SUFFIX, a as PROXY_LIST_ID_SUFFIX, u as updateFocusProxyList, F as FocusProxy } from "./focus-proxy-oI3DguYy-_C-eofB5.js";
...
const Select = class extends Mixin(...DefaultMixins, ComponentIdMixin, AriaActiveDescendantMixin) {
  ...
  render() {
    return h(Host, { key: "e6c6a395c331cafe795c6505645577e05343a24c", id: this.getHostElementId(), class: {
      readonly: this.readonly,
      disabled: this.disabled,
      "show-focus-outline": this.hasInputFocus && !this.dropdownItemsVisualFocused
    }, tabIndex: this.disabled ? -1 : 0 }, h("ix-field-wrapper", { key: "5a146d7de603cc939324d3e8655888934e378f3d", required: this.required, label: this.label, helperText: this.helperText, invalidText: this.invalidText, infoText: this.infoText, warningText: this.warningText, validText: this.validText, showTextAsTooltip: this.showTextAsTooltip, isInvalid: this.isInvalid, isValid: this.isValid, isInfo: this.isInfo, isWarning: this.isWarning, controlRef: this.inputRef }, h("div", { key: "b61083958c93932ea8a7439fd66d35cf4797e33d", class: {
      select: true,
      disabled: this.disabled,
      readonly: this.readonly
    }, ref: (ref) => {
    ...
    } }, h("div", { key: "01fb599886be5aff292e3865aae177b63b492264", class: "input-container" }, h("div", { key: "6dd7b1726c5ec6a1f9fb8dbcfd21a63808aa1975", class: "chips" }, this.isMultipleMode && this.items.length !== 0 && (this.shouldDisplayAllChip() ? this.renderAllChip() : this.selectedItems?.map((item) => this.renderChip(item))), h("div", { key: "fbafa725e7280fbdb014f457fe9b8f0ddf6b4527", class: "trigger" }, h("input", { key: "d0d199a1b6a8bd9b1d691fece3ed5d82333b0fc8", id: `${this.hostId}-input`, role: "combobox", "aria-controls": `${this.hostId}-proxy-listbox`, "aria-expanded": a11yBoolean(this.dropdownShow), "aria-autocomplete": "list", "aria-disabled": a11yBoolean(this.disabled), autocomplete: "off", "data-testid": "input", disabled: this.disabled, readOnly: this.readonly, required: this.required, type: "text", class: {
      ...
      e.stopPropagation();
      this.clear();
    }, "aria-label": this.ariaLabelClearIconButton }) : null, this.disabled || this.readonly ? null : h("ix-icon-button", { "aria-label": this.ariaLabelChevronDownIconButton ?? (this.dropdownShow ? "Close select dropdown" : "Open select dropdown"), "aria-hidden": "true", ref: (ref) => {
      const element = ref;
      element.tabIndex = -1;
      element.ariaHidden = "true";
    }, "data-select-dropdown": true, key: "dropdown", class: { "dropdown-visible": this.dropdownShow }, icon: this.dropdownShow ? iconChevronUpSmall : iconChevronDownSmall, variant: "subtle-tertiary" })))))), h("ix-dropdown", { key: "28d92884c14d1c5f34bf56edc2c64a822d57f7b9", id: `${this.hostId}-listbox`, keyboardActivationKeys: ["ArrowUp", "ArrowDown"], keyboardItemTriggerKeys: ["Enter"], disableFocusTrap: true, focusHost: this.hostElement, ref: this.dropdownRef, show: this.dropdownShow, closeBehavior: this.isMultipleMode ? "outside" : "both", hidden: this.disabled || this.readonly, anchor: this.dropdownAnchorRef.waitForCurrent(), trigger: this.dropdownWrapperRef.waitForCurrent(), onShowChange: (event) => {
    ...
    } }, h("div", { key: "fe14f1e80df65d0cce5b1f237c86671155a1e92a", "aria-hidden": "true", class: {
      "select-list-header": true,
      hidden: this.hideListHeader || this.isDropdownEmpty
    }, title: this.i18nSelectListHeader, onClick: (e) => e.preventDefault() }, this.i18nSelectListHeader), h("slot", { key: "08067621b5bb7486c49e9698c8ae4e61851b994f", onSlotchange: () => {
      this.updateSelection();
    } }), h(FocusProxy, { key: "586b735f11c7abb196376de26de9d50db2b5a66e", hostId: this.hostId, otherProps: {
    ...
    } }), this.isDropdownEmpty && !this.editable && h("div", { key: "c709275cde4334fe2104e4fdeb1d492ef16075cc", class: "select-list-header" }, this.i18nNoMatches)));
  }
