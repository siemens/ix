...
const Modal = class {
  ...
  render() {
    return h(Host, { key: "ebe62e5bb0db3fe2e49df3fbfb51f76d92aeefe0", class: {
      visible: this.modalVisible,
      "no-backdrop": this.hideBackdrop,
      "align-center": this.centered,
      "non-blocking": this.isNonBlocking
    } }, h("div", { key: "e92207ec4319607ab4d3b1d9197437f051b22c82", class: "dialog-backdrop" }, h("dialog", { key: "1206a50aeb35ed80de172450d3431210f175d511", "aria-modal": a11yBoolean(!this.isNonBlocking), "aria-describedby": this.ariaAttributes["aria-describedby"], "aria-labelledby": this.ariaAttributes["aria-labelledby"], class: {
      modal: true,
      ...
      e.preventDefault();
      void this.dismissModal();
    } }, h("slot", { key: "348c7ab8a11deabb3286d5ba59732ce472bc69c3" }))));
  }
};
