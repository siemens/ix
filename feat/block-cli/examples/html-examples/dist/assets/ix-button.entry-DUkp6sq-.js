...
const Button = class extends Mixin(...DefaultMixins, InheritAriaAttributesMixin) {
  constructor(hostRef) {
    super();
  ...
  setFocus() {
    this.hostElement.shadowRoot.querySelector(this.href ? "a" : "button")?.focus();
  }
  render() {
    ...
    return h(Host, { key: "9a9f71e41f86272a9dc05d7b0c2b2ff0b0a88a3f", class: {
      disabled: this.disabled || this.loading
    }, tabIndex: this.disabled || this.loading ? -1 : 0 }, h(BaseButton, { key: "0c549d49bf0af91ab57f293ab9a70933e74d17b1", ...baseButtonProps }, h("slot", { key: "ceeea74bb80fb493fde8fe93648261682c64225d" })));
  }
