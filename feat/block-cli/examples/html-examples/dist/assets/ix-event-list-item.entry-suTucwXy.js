...
import { r as iconChevronRight } from "./index-BcWSlcx_-DijX28Uj.js";
...
const EventListItem = class {
  ...
  render() {
    ...
    return h(Host, { key: "5f5b1ceb22069977576bf5c33249c6d4db28f976", class: {
      disabled: this.disabled,
      [`event-list-item-${this.variant}`]: true
    } }, h("div", { key: "75f82814371ed97f0aa5ae4ac811b6167ccddd74", role: "listitem", "aria-disabled": a11yBoolean(this.disabled), class: {
      "event-list-item": true,
      selected: this.selected,
      disabled: this.disabled
    } }, h("div", { key: "7060cce0835f4d55197aa3352cea070643a8dead", class: `indicator ${!this.itemColor ? "indicator-empty" : ""}`, style: {
      "background-color": this.itemColor ? color : "inherit",
      opacity: `${this.disabled ? 0.4 : 1}`
    } }), h("div", { key: "4c2c3225c457846fb7bbe197d114c7fd09ae1edc", class: "event-list-item-container" }, h("div", { key: "cec7dc944305f80b87e64462359b9e34ec254b7d", class: "event-content" }, h("slot", { key: "0f323e40391c4a668c227e0d12aca59d984e07bb" })), this.chevron && h("ix-icon", { key: "a2c77c126d9c4e60eba05d6c1f983accdb18a441", name: iconChevronRight, size: "16", class: "chevron-icon", "aria-hidden": "true" }))));
  }
};
