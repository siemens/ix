...
import { a as createClassMutationObserver } from "./validation-VVt5EFy0-CdA71F27.js";
...
const Radio = class {
  ...
  render() {
    ...
    return h(Host, { key: "58c8ee76535d0b9ade37614a056de98892b517ed", "aria-checked": a11yBoolean(this.checked), "aria-disabled": a11yBoolean(this.disabled), role: "radio", tabindex: tabIndex, class: {
      ...
      if (this.disabled)
        return;
      this.setCheckedState(true);
    }, onKeyDown: (event) => this.onKeyDown(event), onBlur: () => this.ixBlur.emit() }, h("label", { key: "ab70675f8a4037239fc72eda2bf47df57050d9e0" }, h("div", { key: "00878e50d8c09f093f101afca57a40ee613e97ae", class: "radio-button" }, h("div", { key: "55d09c21917b547f40bc24c8a4f9610f500ca2fb", "aria-hidden": "true", class: {
      ["radio-checkmark"]: true,
      checked: this.checked
    } }, h("div", { key: "e2481a752f37d0e52ff0db21d90061efd0dd376c", class: "checkmark", style: { visibility: this.checked ? "visible" : "hidden" } }))), this.label && h("ix-typography", { key: "a4049e3781a081a5e66953da6b7995693f4531f6", format: "label", textColor: this.disabled ? "weak" : "std" }, this.label, h("slot", { key: "0181658cf85aeb177fb22a820aa49776d03e0005" }))));
  }
