...
import { m as iconClear, u as iconChevronUpSmall, h as iconChevronDownSmall, E as iconPlus } from "./index-CwfZ4aN6-mXhHymhu.js";
import { a as a11yBoolean } from "./a11y-B5k8YVR0-BOSd6BQK.js";
import { q as queryElements, I as IX_FOCUS_VISIBLE_ACTIVE } from "./focus-utilities-Cmy8BJlr-BZaPzC8e.js";
import { H as HookValidationLifecycle } from "./validation-PxJQmubQ-CMvuH4q8.js";
...
import { P as PROXY_LISTITEM_ID_SUFFIX, a as PROXY_LIST_ID_SUFFIX, u as updateFocusProxyList, F as FocusProxy } from "./focus-proxy-G0pM1d3O-Bozzl8Gc.js";
...
const Select = class extends Mixin(...DefaultMixins, ComponentIdMixin, AriaActiveDescendantMixin) {
  ...
  render() {
    return h(Host, { key: "c8262a6772b4c11f03f7db9faeb4c525f555ef55", id: this.getHostElementId(), class: {
      readonly: this.readonly,
      disabled: this.disabled,
      "show-focus-outline": this.hasInputFocus && !this.dropdownItemsVisualFocused
    }, tabIndex: this.disabled ? -1 : 0 }, h("ix-field-wrapper", { key: "786bdb15bae61045b23f9e9f9b3e1d6ee9aef6fe", required: this.required, label: this.label, helperText: this.helperText, invalidText: this.invalidText, infoText: this.infoText, warningText: this.warningText, validText: this.validText, showTextAsTooltip: this.showTextAsTooltip, isInvalid: this.isInvalid, isValid: this.isValid, isInfo: this.isInfo, isWarning: this.isWarning, controlRef: this.inputRef }, h("div", { key: "8acd88427db55211111c1ac14ae8062afd7cfc7d", class: {
      select: true,
      disabled: this.disabled,
      readonly: this.readonly
    }, ref: (ref) => {
    ...
    } }, h("div", { key: "d069c695c3323f6b87d0d891f4f53f6a8a0d9d36", class: "input-container" }, h("div", { key: "0099dd5ce4b5ddefda33dbae48b21e770fbeb053", class: "chips" }, this.isMultipleMode && this.items.length !== 0 && (this.shouldDisplayAllChip() ? this.renderAllChip() : this.selectedItems?.map((item) => this.renderChip(item))), h("div", { key: "4f5b5b0dcfa81f958ed39b0eef7944f96c8754c8", class: "trigger" }, h("input", { key: "fd2c65aa1c5c172caaa83a26acd52b106c47cfeb", id: `${this.hostId}-input`, role: "combobox", "aria-controls": `${this.hostId}-proxy-listbox`, "aria-expanded": a11yBoolean(this.dropdownShow), "aria-autocomplete": "list", "aria-disabled": a11yBoolean(this.disabled), autocomplete: "off", "data-testid": "input", disabled: this.disabled, readOnly: this.readonly, required: this.required, type: "text", class: {
    ...
    }, "data-select-dropdown": true, key: "dropdown", class: { "dropdown-visible": this.dropdownShow }, icon: this.dropdownShow ? iconChevronUpSmall : iconChevronDownSmall, variant: "subtle-tertiary" })))))), h("ix-dropdown", { key: "20c1c053ecd307a64fa3df9250e6fb83f963097a", id: `${this.hostId}-listbox`, keyboardActivationKeys: ["ArrowUp", "ArrowDown"], keyboardItemTriggerKeys: ["Enter"], disableFocusTrap: true, focusHost: this.hostElement, ref: this.dropdownRef, show: this.dropdownShow, closeBehavior: this.isMultipleMode ? "outside" : "both", hidden: this.disabled || this.readonly, anchor: this.dropdownAnchorRef.waitForCurrent(), trigger: this.dropdownWrapperRef.waitForCurrent(), onShowChange: (event) => {
    ...
    } }, h("div", { key: "0e3c176f17c90492a115fa5e29c56dfa67e8af73", "aria-hidden": "true", class: {
      "select-list-header": true,
      hidden: this.hideListHeader || this.isDropdownEmpty
    }, title: this.i18nSelectListHeader, onClick: (e) => e.preventDefault() }, this.i18nSelectListHeader), h("slot", { key: "6771220582813e176baf23ccc5d395f67d4ac780", onSlotchange: () => {
      this.updateSelection();
    } }), h(FocusProxy, { key: "6cb4ee56a9b468d3eb4e4f9377fa3f6f20b4d80b", hostId: this.hostId, otherProps: {
    ...
    } }), this.isDropdownEmpty && !this.editable && h("div", { key: "851195757238c0a077f4d27092f7a655cfa985d1", class: "select-list-header" }, this.i18nNoMatches)));
  }
