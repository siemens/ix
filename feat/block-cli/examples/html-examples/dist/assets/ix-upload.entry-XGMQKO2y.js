import { g as getElement, r as registerInstance, c as createEvent, h, H as Host } from "./global-C_dy4gBz.js";
import { U as UploadFileState } from "./upload-file-state-BGzrnl_l-DLdhtkd7.js";
import { c as iconSuccess, b as iconError } from "./index-DFdo1y_u-D_8X33yw.js";
...
const Upload = class {
  ...
  render() {
    ...
    return h(Host, { key: "30d21d48f1aec6ee6a37e96b0dee7884a77653c5", ...a11y, "aria-disabled": disabled }, h("div", { key: "d9577ecc859b48e31c41e6c8aa5c6df86b284ab8", class: {
    ...
    }, onDragOver: (e) => this.fileOver(e), onDragLeave: () => this.fileLeave(), draggable: !this.disabled }, this.renderUploadState(), h("div", { key: "1550f7401a3c33e52acf2cf5539dd90f065fa4f3" }, h("input", { key: "bb90e1f3bab387a339fc6ff38049b6f10373b142", "aria-label": ariaLabel, "aria-disabled": disabled, multiple: this.multiple, type: "file", class: "upload-browser", id: "upload-browser", tabindex: "-1", onChange: (e) => {
      this.fileChangeEvent(e);
    }, accept: this.accept, disabled }), h("ix-button", { key: "01cd99a8b6ecbcc33edfead48b02e7ecd5594965", variant: "secondary", "aria-disabled": disabled, onClick: () => this.inputElement.click(), disabled }, this.i18nUploadFile))));
  }
};
