import { r as registerInstance, f as forceUpdate, h, H as Host, g as getElement } from "./global-BlVZeLef.js";
...
const Panes = class {
  ...
  render() {
    return h(Host, { key: "2bdfc7e65c085c41d5edbfd35a5dbed7ed172075" }, !this.isMobile ? this.layout == "full-vertical" ? h("div", { class: "side-panes-wrapper" }, h("div", { class: {
      row: true,
