...
import { O as OnListener } from "./listener-BjluJgvO-BSHlkVEu.js";
...
const Slider = class {
  ...
  render() {
    ...
    return h(Host, { key: "e588d5e68aa363d730d06ef551d247472c0c82a1", class: {
      disabled: this.disabled,
      invalid: this.isInvalid,
      info: this.isInfo,
      valid: this.isValid,
      warning: this.isWarning
    }, onPointerDown: () => setTimeout(() => this.showTooltip = true) }, h("ix-field-wrapper", { key: "94dc64ca3f779a964a77eb01f68ff96bed969790", label: this.label, helperText: this.helperText, invalidText: this.invalidText, infoText: this.infoText, warningText: this.warningText, validText: this.validText, showTextAsTooltip: this.showTextAsTooltip, isValid: this.isValid, isInfo: this.isInfo, isWarning: this.isWarning, isInvalid: this.isInvalid, controlRef: this.controlRef }, h("div", { key: "06ac6b109c55e7a2b37ff579927fa3a38548f4e7", class: "slider-container" }, h("div", { key: "9f937c660103d750219bb576cb8008244b0d2e4f", class: "slider" }, h("div", { key: "51a261916bbccbbdc44dd489aeb43afb737b319e", class: "track" }, h("div", { key: "cbbc75341bf7c33c1b3ba0ef98e44d33072868f3", ref: this.thumbRef, class: "thumb", style: {
      left: `calc(${valueInPercentage} * (100% - 1rem))`
    } }), h("svg", { key: "fd1ef628423e8a02368b458c458f14206cf51acc", class: "ticks", xmlns: "http://www.w3.org/2000/svg" }, this.marker?.filter((markerValue) => markerValue >= this.min && markerValue <= this.max).map((markerValue) => {
    ...
    }))), h("input", { key: "3a6b4c17623a16766648553a1d1d34f6a580e239", id: "slider", ref: this.controlRef, type: "range", list: this.marker ? "markers" : void 0, step: this.step, min: this.min, max: this.max, value: this.rangeInput, tabindex: this.disabled ? -1 : 0, onInput: (event) => this.onInput(event), onFocus: () => {
    ...
    }, role: "slider", "aria-valuenow": this.rangeInput, "aria-valuemin": this.min, "aria-valuemax": this.max, ...this.a11yAttributes }), h("ix-tooltip", { key: "b90cf57cbb8d11372159179d7e630b120aba4df3", ref: this.tooltipRef, class: {
      "hide-tooltip": !this.showTooltip
    }, animationFrame: true, for: this.thumbRef.waitForCurrent() }, this.rangeInput)), this.hasLabels && h("div", { key: "253fb36d19eb9253c70ed034f93ab0ea1e7ef28b", class: "label" }, h("div", { key: "688ce7f2df2425113998905903d83d82a9935121" }, h("slot", { key: "82b4a81ced24d34654196d3a72a0cb7e8e3d4a02", name: "label-start" })), h("div", { key: "8b43bea2198ee4bf0c02657bb46b82c01be9efdf" }, h("slot", { key: "6448e9c4473dc3009489d190e9c871269b9a5de4", name: "label-end" }))))));
  }
