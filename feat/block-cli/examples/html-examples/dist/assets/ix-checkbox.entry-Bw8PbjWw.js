import { a as registerInstance, c as createEvent, g as getElement, h, F as Fragment, H as Host } from "./global-DX2OdaCL.js";
...
const Checkbox = class {
  ...
  render() {
    return h(Host, { key: "648fd4f11ea3464e876345098c0d1536ed8ccccb", "aria-checked": a11yBoolean(this.checked), "aria-disabled": a11yBoolean(this.disabled), role: "checkbox", class: {
      disabled: this.disabled,
      checked: this.checked,
      indeterminate: this.indeterminate
    }, onFocus: () => this.touched = true, onBlur: () => this.ixBlur.emit() }, h("label", { key: "944809870d87faf7b61960e8ec1b0a3c7e00c2be" }, h("input", { key: "4d09a86c7790ffb0631b4f5f60168e3b9ed98a40", "aria-checked": a11yBoolean(this.checked), required: this.required, disabled: this.disabled, checked: this.checked, ref: this.inputRef, type: "checkbox", onChange: () => this.setCheckedState(!this.checked) }), h("button", { key: "f2572e32a8557b4766a63a38eb3d6354f979b734", disabled: this.disabled, class: {
      checked: this.checked
    }, onClick: () => this.setCheckedState(!this.checked) }, this.renderCheckmark()), h("ix-typography", { key: "1ffcb8adced0dd1d496d650acc8b076e0a153cda", format: "label", textColor: this.disabled ? "weak" : "std" }, this.label, h("slot", { key: "5bfa3808d7c5613fe0226e4d9007f1001a6fa0a9" }))));
  }
