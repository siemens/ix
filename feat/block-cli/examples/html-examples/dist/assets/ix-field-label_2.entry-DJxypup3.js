import { r as registerInstance, g as getElement, h, H as Host, M as Mixin } from "./global-Dfa5QLOG.js";
...
import { r as resolveTextFromValidationState, h as hasAnyText, H as HelperText$1 } from "./helper-text-util-BnQvL--b-DPwPibtJ.js";
...
const FormFieldLabel = class {
  ...
  render() {
    return h(Host, { key: "64b25fc45ce932075dac78c66391f5db27341e46", onClick: () => this.focusOnClick(), class: {
      "text-overflow-wrap": this.textOverflow === "wrap",
      "text-overflow-no-wrap": this.textOverflow === "no-wrap"
    } }, h("label", { key: "8665034b0383d9a1a84b73e0e81a21a5fd72d0b8", htmlFor: this.htmlFor, ...this.a11yAttributes, ref: this.labelRef }, h("ix-typography", { key: "e5e2c00aa17831767e142ddb6d85f4b4df6d3dde", textColor: this.isInvalid ? "alarm" : "soft", format: "label" }, h("slot", { key: "f5090ed96d55df4f76c2972040b04fdb5e60ad13" }), this.required && h("span", { key: "44b4e1c2a2edfa02d9b3be9b088dd2c4de443ef5" }, "*"))));
  }
  static get watchers() {
    return {
      "isInvalid": [{
...
const FieldWrapper = class extends Mixin(...DefaultMixins, ComponentIdMixin) {
  ...
  render() {
    ...
    return h(Host, { key: "8bc29bc18898df47c497c3c217c0c54134d35b3e", ...additionalAriaAttributes }, this.label && h("div", { key: "46930ac2b0d0ac7e6a41e11706977993d6d473a7", class: "field-top" }, h("ix-field-label", { key: "f1a8835566773eb56bd2b601dd34f19e2a8dc3c3", required: this.required, controlRef: this.controlRef, isInvalid: this.isInvalid, ariaHidden: true }, this.label)), h("div", { key: "a5e99f75c0b1c336311ae2ed367ebbca4517db4e", class: {
      "slot-wrapper": true
    }, ref: this.slotRef }, h("slot", { key: "df7f49a0d2e26a49dae6b32c6629483d3cb302f3" })), h("div", { key: "d3c76fef4d7565c957ee2e57ba78a9dd37316542", class: "field-bottom" }, !this.showTextAsTooltip && h(HelperText$1, { key: "0c53f6ba98228f498cea948346d0ee672eaee2aa", ...textOptions }), h("div", { key: "440314f4bb8f09b160f1f1394971c4eaeef0056a", class: "bottom-right" }, h("slot", { key: "dc69b4469c84fa0d6748d9b5a9edbe7221b46c55", name: "bottom-right" }))), this.showTextAsTooltip === true && hasAnyText(textOptions) && h("ix-tooltip", { key: "35e000d8ecfad0faeb5253d99abee6da8c7110b8", for: this.slotRef.waitForCurrent(), showDelay: 500, placement: "bottom" }, h(HelperText$1, { key: "3aa39e0ed037315c15fdef718df22f1b82c28858", ...textOptions })));
  }
  static get watchers() {
    return {
      "label": [{
