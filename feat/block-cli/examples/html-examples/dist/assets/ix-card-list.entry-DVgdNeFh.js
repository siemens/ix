import { r as registerInstance, c as createEvent, g as getElement, h, H as Host, F as Fragment } from "./global-F68Qu5y3.js";
...
const CardList = class {
  ...
  render() {
    return h(Host, { key: "5c54412dd5af459ff3339fe13cfbc1aec800a0d8" }, h(CardListTitle, { key: "a320c5d7f1736c9701f0db30a3bb51abbb9fbaa8", isCollapsed: this.collapse, label: this.label, showAllLabel: this.i18nShowAll, showAllCounter: this.showAllCount === void 0 ? this.numberOfAllChildElements : this.showAllCount, showLess: this.isShowingAll, labelShowLess: this.i18nShowLess, onClick: () => this.onCardListVisibilityToggle(), onShowAllClick: (e) => this.onShowAllClick(e), hideShowAll: this.hideShowAll }), h("div", { key: "39635899fa6892674482f0903bbbf439bbfe7356", class: {
      CardList__Overflow: true
    }, style: this.computeMaskLayer() }, h("div", { key: "e9a9a881fdb1da623d398ede0abcf6af15c2a605", class: {
    ...
    }, onScroll: () => this.onCardListScroll() }, h("slot", { key: "c076e8df46254a235ac9d3820d7e1d8fa7132825", onSlotchange: () => {
      this.changeVisibilityOfSlotChildren();
