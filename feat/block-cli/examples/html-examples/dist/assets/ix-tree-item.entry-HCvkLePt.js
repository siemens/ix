...
const TreeItem = class {
  ...
  render() {
    ...
    return h(Host, { key: "c524e6ab6caee82c29ae8712ac265f0f4663be7b", class: {
      selected: !!this.context?.isSelected,
      disabled: !!isDisabled
    } }, h("div", { key: "beb83bae107359e656ab9d782c5b4ced7892b902", class: "icon-toggle-container" }, this.hasChildren ? h("ix-icon", { name: iconChevronRightSmall, size: "24", class: {
      ...
      e.stopPropagation();
      this.toggle.emit();
    }, "aria-label": this.ariaLabelChevronIcon ?? (this.context?.isExpanded ? "Collapse tree item" : "Expand tree item") }) : null), h("div", { key: "dc682463e04a7de8fc8a4f847551dddfa1b0f6cf", class: "tree-node-container", onClick: () => {
      if (isDisabled) {
        return;
      }
      this.itemClick.emit();
    } }, h("div", { key: "1995c6bf165c055c32be7b6fab8dc71809e0a480", class: "tree-node-text" }, this.text), h("slot", { key: "afed9990854c853b2074397767065b7f575390cf" })));
  }
};
