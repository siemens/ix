...
const Pill = class {
  ...
  render() {
    ...
    return h(Host, { key: "88992fbcc056d069bfe4fed760109c3ab5fc042a", style: this.variant === "custom" ? {
      "--ix-icon-button-color": this.pillColor
    } : {}, class: {
      "align-left": this.alignLeft
    } }, h("div", { key: "09638e4644bca0154084acf94d4346a962b6343e", ref: this.containerElementRef, style: { ...customStyle }, class: {
      container: true,
    ...
    } }, this.icon && h("ix-icon", { key: "14aa0a1e716cb666cacd367f898f81cc74888f5e", class: {
      "with-icon": true
    }, name: this.icon, size: "16", "aria-label": this.ariaLabelIcon }), h("span", { key: "1b91242931013e84024352dfe4116a35f465e6d7", class: "slot-container" }, h("slot", { key: "8f6de384837f9dc34ede356f0103dc4ae1633587", onSlotchange: () => this.checkIfContentAvailable() }))), this.getTooltip());
  }
};
Pill.style = pillCss();
export {
