import { r as registerInstance, c as createEvent, g as getElement, h, F as Fragment, H as Host } from "./global-CRrZCTD3.js";
...
const Checkbox = class {
  ...
  render() {
    return h(Host, { key: "18729c6196cce43f20c4b3f7a7fca9bd1cc92377", "aria-checked": a11yBoolean(this.checked), "aria-disabled": a11yBoolean(this.disabled), role: "checkbox", class: {
      disabled: this.disabled,
      checked: this.checked,
      indeterminate: this.indeterminate,
      "label-less": this.isLabelLess
    }, onFocus: () => this.touched = true, onBlur: () => this.ixBlur.emit() }, h("label", { key: "76704a9540093c7431fc28a7bdd362b5abd08e73" }, h("input", { key: "2ef1588b0f0bc8811326521ac251e6fb1952e0d7", "aria-checked": a11yBoolean(this.checked), required: this.required, disabled: this.disabled, checked: this.checked, ref: this.inputRef, type: "checkbox", onChange: () => this.setCheckedState(!this.checked) }), h("div", { key: "5ca7f512929f44d3756c1c53c330cbb82a737408", class: "checkbox-button" }, h("button", { key: "f91a1d002e3af0c16833466d79344b033a07782d", disabled: this.disabled, class: {
      checked: this.checked
    }, onClick: () => this.setCheckedState(!this.checked) }, this.renderCheckmark())), h("ix-typography", { key: "ae4b328a43fb57a4c9d19f586b5256d605819192", format: "label", textColor: this.disabled ? "weak" : "std" }, this.label, h("slot", { key: "7241aacbdb41ebd6905b45629860f8f9dc357065", onSlotchange: () => this.updateDefaultSlotElements(), ref: (element) => this.defaultSlotElement = element }))));
  }
