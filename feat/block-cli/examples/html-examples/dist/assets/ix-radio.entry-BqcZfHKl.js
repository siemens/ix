...
import { c as createClassMutationObserver } from "./validation-VVt5EFy0-CrVzSL7p.js";
...
const Radio = class {
  ...
  render() {
    ...
    return h(Host, { key: "8391d4171a66c8eb67c48d83717d7956acffe560", "aria-checked": a11yBoolean(this.checked), "aria-disabled": a11yBoolean(this.disabled), role: "radio", tabindex: tabIndex, class: {
      ...
      if (this.disabled)
        return;
      this.setCheckedState(true);
    }, onKeyDown: (event) => this.onKeyDown(event), onBlur: () => this.ixBlur.emit() }, h("label", { key: "b87104c10dbc581e53ce21f95c4fa23be236c875" }, h("div", { key: "487155989aa0009a1984ca628830ed4a0a0ea212", class: "radio-button" }, h("div", { key: "35a43541fe4a5b9eab0013c1ed5f4652ccc1d2ac", "aria-hidden": "true", class: {
      ["radio-checkmark"]: true,
      checked: this.checked
    } }, h("div", { key: "216845fc3f31c71a4bd45af606973bbeeefcc4ce", class: "checkmark", style: { visibility: this.checked ? "visible" : "hidden" } }))), this.label && h("ix-typography", { key: "5e281501ee6ab2c6e498de0c9088012634e7159e", format: "label", textColor: this.disabled ? "weak" : "std" }, this.label, h("slot", { key: "2104508d56087e2da7cd87ceac6878b9a4af5728" }))));
  }
