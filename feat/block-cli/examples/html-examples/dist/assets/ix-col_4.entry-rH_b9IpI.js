import { r as registerInstance, f as forceUpdate, h, H as Host, M as Mixin, c as createEvent, g as getElement } from "./global-Cr1KQvOo.js";
...
const Row = class {
  ...
  render() {
    return h(Host, { key: "e52017d7fe80956a0d68089decc17c4f8f5de360" }, h("slot", { key: "21a9f020f3afa15594ae029dd50643126303697c" }));
  }
};
Row.style = rowCss();
...
const TimePicker = class extends Mixin(...DefaultMixins) {
  ...
  render() {
    return h(Host, { key: "e9191045806bd3ef6faf2299261e3d6f3a763fc8" }, h("ix-date-time-card", { key: "caf1f2cce682a93716daecda3d8d4683dc10a11b", embedded: this.embedded, timePickerAppearance: true, corners: this.corners, hasFooter: !this.dateTimePickerAppearance, hideHeader: this.hideHeader }, h("div", { key: "fe3430a527615db09b2180d908fcd3517594de3e", class: "header", slot: "header" }, h("ix-typography", { key: "c2a506e54a3d3489dec2dc26467ea33f8cdbd9e8", format: "body" }, this.i18nHeader)), h("div", { key: "2e83d3feea618d207ec0bd71647ee563ea1682d2", class: "clock" }, this.timePickerDescriptors.map((descriptor, index) => {
    ...
    }), this.timeRef && h("div", { key: "7acb3f6e17ed32a73f8d6f7de965596254e84e50", class: "flex" }, h("div", { key: "f34ac35eedd7e861094171f9a950bdc1aa5e870e", class: "column-separator" }), h("div", { key: "eebc5f7beb7d3e925aa3638436613f18a92aff2d", class: "columns" }, h("div", { key: "76a9ac90d1fd202a4ed192fad70758387a762fc5", class: "column-header", title: "AM/PM" }), h("div", { key: "cdb4d2e958e7c57a147c738035e21ad9430031f3", class: "element-list", tabIndex: -1 }, h("button", { key: "cf0e80f65818e4112e8ee8132ee96d8e8493a69a", "data-am-pm-id": "AM", class: {
      selected: this.timeRef === "AM",
      "element-container": true
    }, onClick: () => this.changeTimeReference("AM"), tabindex: "0", "aria-label": "AM" }, "AM"), h("button", { key: "767295779c89a009db895370b407435b575aa2c8", "data-am-pm-id": "PM", class: {
      selected: this.timeRef === "PM",
      "element-container": true
    }, onClick: () => this.changeTimeReference("PM"), tabindex: "0", "aria-label": "PM" }, "PM"))))), h("div", { key: "0ed49308c515453ad9fbb553813b57bb13955a73", class: {
      footer: true,
      "footer--compact": this.timePickerDescriptors.length <= 2
    }, slot: "footer" }, h("ix-button", { key: "ece47c7c5430d843b5bb50b3fe2dff58ee077867", class: "confirm-button", onClick: () => {
