...
const Tree = class {
  ...
  render() {
    return h(Host, { key: "d144ff5b676bdcafc424afea72834ea712c95dff", onClick: (event) => this.onTreeItemClick(event) }, h("slot", { key: "fc2f5555f95788c57fa66b150cc844024bc6677a" }));
  }
  get hostElement() {
