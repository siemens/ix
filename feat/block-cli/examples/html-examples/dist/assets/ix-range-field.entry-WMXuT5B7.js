...
import { N as iconArrowRight } from "./index-BcWSlcx_-DijX28Uj.js";
...
const RangeField = class extends Mixin(...DefaultMixins) {
  ...
  render() {
    return h(Host, { key: "d39e2a1a8379ce38067af0f1cc74a7deac535c5f", class: { "hide-arrow": this.hideArrow }, role: "group" }, !this.hideArrow && h("ix-icon", { key: "74b2ce3c890282fc8c11321ee94fbbb4f998aea9", "aria-hidden": "true", class: {
      "range-delimiter": true,
      "has-label": this.hasLabel
    }, name: iconArrowRight }), h("slot", { key: "df7bb22bd55c930cd07bec21704a1b0a15198d65" }));
  }
};
