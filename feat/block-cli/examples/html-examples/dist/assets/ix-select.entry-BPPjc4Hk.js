import { M as Mixin, a as registerInstance, c as createEvent, g as getElement, h, H as Host } from "./global-DX2OdaCL.js";
import { p as iconClear, k as iconChevronUpSmall, f as iconChevronDownSmall, L as iconPlus } from "./index-Cl7fhG1I-C77BCFLW.js";
import { a as a11yBoolean } from "./a11y-B5k8YVR0-BOSd6BQK.js";
import { P as PROXY_LISTITEM_ID_SUFFIX, a as PROXY_LIST_ID_SUFFIX, u as updateFocusProxyList, F as FocusProxy } from "./focus-proxy-BgLEsVE2-CDAem0gF.js";
import { q as queryElements, a as IX_FOCUS_VISIBLE_ACTIVE } from "./focus-utilities-DnaItyVQ-Degzwldb.js";
import { D as DefaultMixins } from "./component-Chfbghog-DFMCI9TH.js";
...
import { H as HookValidationLifecycle } from "./validation-BT5aAuSO-B8Y62WGw.js";
...
const Select = class extends Mixin(...DefaultMixins, ComponentIdMixin, AriaActiveDescendantMixin) {
  ...
  render() {
    return h(Host, { key: "7d5921f34fee8a4791bd77b1dee334837735704f", id: this.getHostElementId(), class: {
      readonly: this.readonly,
      disabled: this.disabled,
      "show-focus-outline": this.hasInputFocus && !this.dropdownItemsVisualFocused
    }, tabIndex: this.disabled ? -1 : 0 }, h("ix-field-wrapper", { key: "1a4a20e572b53ad95d360793adff832a44d7f968", required: this.required, label: this.label, helperText: this.helperText, invalidText: this.invalidText, infoText: this.infoText, warningText: this.warningText, validText: this.validText, showTextAsTooltip: this.showTextAsTooltip, isInvalid: this.isInvalid, isValid: this.isValid, isInfo: this.isInfo, isWarning: this.isWarning, controlRef: this.inputRef }, h("div", { key: "1a8e78d500836eda4530b38226f7e982e82854c5", class: {
      select: true,
      disabled: this.disabled,
      readonly: this.readonly
    }, ref: (ref) => {
    ...
    } }, h("div", { key: "41446b5cae8a4d0233d5fe173357d75cecc66220", class: "input-container" }, h("div", { key: "6ef183c8c2f9506a8d64178e0c7985ac49584081", class: "chips" }, this.isMultipleMode && this.items.length !== 0 && (this.shouldDisplayAllChip() ? this.renderAllChip() : this.selectedItems?.map((item) => this.renderChip(item))), h("div", { key: "72ac766f9e5cc62e662163a3ae460c87e9e534f7", class: "trigger" }, h("input", { key: "df62168c0e61b7f0bc2beb601c853cc130329d44", id: `${this.hostId}-input`, role: "combobox", "aria-controls": `${this.hostId}-proxy-listbox`, "aria-expanded": a11yBoolean(this.dropdownShow), "aria-autocomplete": "list", "aria-disabled": a11yBoolean(this.disabled), autocomplete: "off", "data-testid": "input", disabled: this.disabled, readOnly: this.readonly, required: this.required, type: "text", class: {
      ...
      e.stopPropagation();
      this.clear();
    }, "aria-label": this.ariaLabelClearIconButton }) : null, this.disabled || this.readonly ? null : h("ix-icon-button", { "aria-label": this.dropdownShow ? "Close select dropdown" : "Open select dropdown", "aria-hidden": "true", ref: (ref) => {
      const element = ref;
      element.tabIndex = -1;
      element.ariaHidden = "true";
    }, "data-select-dropdown": true, key: "dropdown", class: { "dropdown-visible": this.dropdownShow }, icon: this.dropdownShow ? iconChevronUpSmall : iconChevronDownSmall, variant: "subtle-tertiary" })))))), h("ix-dropdown", { key: "7987cfd56bc036b839be648b4526ebc45bc0cb11", id: `${this.hostId}-listbox`, keyboardActivationKeys: ["ArrowUp", "ArrowDown"], keyboardItemTriggerKeys: ["Enter"], disableFocusTrap: true, focusHost: this.hostElement, ref: this.dropdownRef, show: this.dropdownShow, closeBehavior: this.isMultipleMode ? "outside" : "both", hidden: this.disabled || this.readonly, anchor: this.dropdownAnchorRef.waitForCurrent(), trigger: this.dropdownWrapperRef.waitForCurrent(), onShowChange: (event) => {
    ...
    } }, h("div", { key: "303f74372b203d62a83113bf2a446493085d1d93", "aria-hidden": "true", class: {
      "select-list-header": true,
      hidden: this.hideListHeader || this.isDropdownEmpty
    }, title: this.i18nSelectListHeader, onClick: (e) => e.preventDefault() }, this.i18nSelectListHeader), h("slot", { key: "dc4547568bd057a3aa5d42b561c6672f215e25a6", onSlotchange: () => {
      this.updateSelection();
    } }), h(FocusProxy, { key: "b83e4d68b90484bb5f1636ea2884c0843d3807d6", hostId: this.hostId, otherProps: {
    ...
    } }), this.isDropdownEmpty && !this.editable && h("div", { key: "b000709ecd176fcdb74eecf9a571010932ad2eca", class: "select-list-header" }, this.i18nNoMatches)));
  }
