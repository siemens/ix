...
import { m as mapValidationResult, g as checkInternalValidity, T as TextareaElement, o as onInputBlurWithChange, f as onInputFocus, i as getAriaAttributesForInput } from "./input.fc-mVVYOifc-Dt2B7_tz.js";
...
const Textarea = class {
  ...
  render() {
    return h(Host, { key: "a4a1b31724fa53ea3fdd1caf8c440bff2b36c65c", class: {
      disabled: this.disabled,
      readonly: this.readonly
    } }, h("ix-field-wrapper", { key: "9d61457e5de530be56bc27cc79f9d5d8d0018f0e", required: this.required, label: this.label, helperText: this.helperText, invalidText: this.invalidText, infoText: this.infoText, warningText: this.warningText, validText: this.validText, showTextAsTooltip: this.showTextAsTooltip, isInvalid: this.isInvalid, isValid: this.isValid, isInfo: this.isInfo, isWarning: this.isWarning, controlRef: this.textAreaRef }, !!this.maxLength && this.maxLength > 0 && h("ix-typography", { key: "4c9b12e4de681a68e917b8837eed509526d4051f", class: "bottom-text", slot: "bottom-right", textColor: "soft" }, (this.value ?? "").length, "/", this.maxLength), h("div", { key: "ab05ef194e0d8e5f2d85e90adfc34b6cc45eee6b", class: "input-wrapper" }, h(TextareaElement, { key: "fcdb9b0f03ea801d3cc036079c5e5d45e219d010", id: this.inputId, minLength: this.minLength, maxLength: this.maxLength, textareaCols: this.textareaCols, textareaRows: this.textareaRows, textareaHeight: this.getTextareaHeight(), textareaWidth: this.getTextareaWidth(), resizeBehavior: this.resizeBehavior, readonly: this.readonly, disabled: this.disabled, isInvalid: this.isInvalid, required: this.required, value: this.value, placeholder: this.placeholder, textAreaRef: this.textAreaRef, ariaAttributes: getAriaAttributesForInput(this), onFocus: () => onInputFocus(this, this.value), valueChange: (value) => this.valueChange.emit(value), updateFormInternalValue: (value) => this.updateFormInternalValue(value), onBlur: () => {
