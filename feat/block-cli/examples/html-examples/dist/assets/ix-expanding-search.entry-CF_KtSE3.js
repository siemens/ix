...
import { m as iconClear, l as iconSearch } from "./index-DLhpBBEI-C3tPjcQ4.js";
...
const ExpandingSearch = class {
  ...
  render() {
    return h(Host, { key: "72bab8b6996e2954b9e4e51c9305ee51dfe310d4", class: {
      expanded: this.expanded,
      "right-position": this.expanded,
      fullWidth: this.fullWidth
    } }, h("ix-icon-button", { key: "005c9785ed06fe9ec08c540c22b11af906ae44a5", size: this.expanded ? "16" : "24", icon: this.icon ?? iconSearch, variant: this.expanded ? "tertiary" : this.variant, "data-testid": "button", onClick: () => this.expandInput(), tabindex: this.expanded ? -1 : 0, color: this.hasFocus ? "input-search-icon--color--focus" : void 0, class: {
      "btn-search": true,
      "btn-search--expanded": this.expanded
    }, "aria-label": this.ariaLabelSearchIconButton ?? (this.expanded ? "Close search" : "Open search") }), h("div", { key: "03d6c441a46ae57f5b1f59f1c9931c8264bf295d", class: {
      expanded: this.expanded,
      fullWidth: this.fullWidth,
      collapsed: !this.expanded,
      "disable-pointer": !this.expanded,
      "input-container": true
    }, "data-testid": "input-wrapper" }, h("input", { key: "e6510cd2e1f8fdc362c8b90e9356434fe59e5ad8", class: {
