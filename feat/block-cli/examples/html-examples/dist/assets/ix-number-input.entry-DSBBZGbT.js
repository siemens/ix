...
import { d as onInputBlurWithChange, m as mapValidationResult, a as addDisposableChangesAndVisibilityObservers, b as adjustPaddingForStartAndEnd, g as checkInternalValidity, e as SlotStart, I as InputElement, o as onEnterKeyChangeEmit, j as onInputFocus, k as checkAllowedKeys, S as SlotEnd } from "./input.fc-CyTJ73r0-MncRToPr.js";
...
const NumberInput = class {
  ...
  render() {
    ...
    return h(Host, { key: "2d567e373bf55a559ebfea9569baab9c556de5e3", class: {
      disabled: this.disabled,
      readonly: this.readonly
    } }, h("ix-field-wrapper", { key: "da2c557602ada49d82a004cc82914d9dfc21db38", id: this.numberInputId, required: this.required, label: this.label, helperText: this.helperText, invalidText: this.invalidText, infoText: this.infoText, warningText: this.warningText, validText: this.validText, showTextAsTooltip: this.showTextAsTooltip, isInvalid: this.isInvalid, isValid: this.isValid, isInfo: this.isInfo, isWarning: this.isWarning, controlRef: this.inputRef }, h("div", { key: "c35a5e95e648479ff8d4105c6582ba16b54dfb23", class: {
      "input-wrapper": true,
      "show-stepper-buttons": !!this.showStepperButtons
    } }, h(SlotStart, { key: "51420f4d860445083866612f15f7ef7325d5c879", slotStartRef: this.slotStartRef, onSlotChange: () => this.updatePaddings() }), h(InputElement, { key: "3762298c0a1a5ff4c4027d293bda77dd8bed9ead", id: this.numberInputId, readonly: this.readonly, disabled: this.disabled, step: this.step, min: this.min, max: this.max, pattern: this.pattern, type: "number", isInvalid: this.isInvalid, required: this.required, value: this.formatValue(this.value), placeholder: this.placeholder, inputRef: this.inputRef, onKeyPress: (event) => checkAllowedKeys(this, event), onKeyDown: (event) => this.handleKeyDown(event), onBeforeInput: (event) => this.handleBeforeInput(event), onPaste: (event) => this.handlePaste(event), onFocus: () => onInputFocus(this, this.value), onEnterKeyChange: (event) => onEnterKeyChangeEmit(event, this, this.value), valueChange: this.handleInputChange, updateFormInternalValue: (value) => {
      const isScientificNotation = this.isScientificNotation(value.trim());
      if (!isScientificNotation) {
        const parsedValue = this.convertNumberStringToFloat(value);
        this.updateFormInternalValue(parsedValue);
      }
    }, onBlur: this.handleBlur, form: (_a = this.formInternals.form) !== null && _a !== void 0 ? _a : void 0, suppressSubmitOnEnter: this.suppressSubmitOnEnter, textAlignment: this.textAlignment }), h(SlotEnd, { key: "6802b35d0ec1a2d1a01a2e47fd1bd441a091247b", slotEndRef: this.slotEndRef, onSlotChange: () => this.updatePaddings() }, h("div", { key: "aac7e9a1a2d8deeedaf5d43fa4f1f230482e1497", class: {
      "number-stepper-container": true,
      "container-hidden": !showStepperButtons
    } }, h("ix-icon-button", { key: "4e7a3359734e4d36bbaf6f3045170095d33f7306", variant: "subtle-tertiary", icon: iconMinus, size: "16", class: "number-stepper-button step-minus", "aria-label": "decrement number", onClick: () => this.handleStepOperation("down") }), h("ix-icon-button", { key: "961ac14ecef1a7b2fa263ed03aba941c0ef4d978", variant: "subtle-tertiary", icon: iconPlus, size: "16", class: "number-stepper-button step-plus", "aria-label": "increment number", onClick: () => this.handleStepOperation("up") }))))));
  }
