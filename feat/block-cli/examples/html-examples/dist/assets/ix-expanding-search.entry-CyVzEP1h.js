...
import { q as iconClear, r as iconSearch } from "./index-DgUGsIlh-CLxQRaVd.js";
...
const ExpandingSearch = class {
  ...
  render() {
    return h(Host, { key: "84b3c892cc5b9e547fcabf03f8c20f6026a92582", class: {
      expanded: this.expanded,
      "right-position": this.expanded,
      fullWidth: this.fullWidth
    } }, h("ix-icon-button", { key: "dfab273a5d6876bdba94f36f956793b63b2dd97c", size: this.expanded ? "16" : "24", icon: this.icon ?? iconSearch, variant: this.expanded ? "tertiary" : this.variant, "data-testid": "button", onClick: () => this.expandInput(), tabindex: this.expanded ? -1 : 0, color: this.hasFocus ? "input-search-icon--color--focus" : void 0, class: {
      "btn-search": true,
      "btn-search--expanded": this.expanded
    }, "aria-label": this.ariaLabelSearchIconButton ?? (this.expanded ? "Close search" : "Open search") }), h("div", { key: "5058cd6036d64ab8c3cc1788dad18cf3248bf077", class: {
      expanded: this.expanded,
      fullWidth: this.fullWidth,
      collapsed: !this.expanded,
      "disable-pointer": !this.expanded,
      "input-container": true
    }, "data-testid": "input-wrapper" }, h("input", { key: "3491f0e30644a93cd37b29ac7eb38de9a065b7c0", class: {
