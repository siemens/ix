import { r as registerInstance, g as getElement, h, H as Host, c as createEvent } from "./global-DSse0xVy.js";
...
const GroupContextMenu = class {
  ...
  render() {
    return h(Host, { key: "f8d6aa4cfbc05dcefc8e5bb20527f470c31449ab" }, h("ix-icon-button", { key: "ff8bdd272470e56a0205f5e0df4c660c2a04ddd8", class: { hide: !this.showContextMenu }, size: "24", variant: "subtle-tertiary", icon: iconContextMenu }), h("slot", { key: "ffd650f461a2bf3e039a5e07a42f1912b30f0a54", onSlotchange: () => this.onSlotChange() }));
  }
};
