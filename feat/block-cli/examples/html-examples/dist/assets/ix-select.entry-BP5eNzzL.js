import { M as Mixin, r as registerInstance, c as createEvent, g as getElement, h, f as forceUpdate, H as Host } from "./global-CSIWS5Ku.js";
...
import { P as PROXY_LISTITEM_ID_SUFFIX, a as PROXY_LIST_ID_SUFFIX, u as updateFocusProxyList, F as FocusProxy } from "./focus-proxy-BQyoX-Kl-rT4t-mTj.js";
...
import { H as HookValidationLifecycle } from "./validation-VVt5EFy0-B5a3jl_7.js";
...
const Select = class extends Mixin(...DefaultMixins, ComponentIdMixin, AriaActiveDescendantMixin) {
  ...
  render() {
    return h(Host, { key: "53d4304506c391c9b62ce853d818c57069a0fe6c", id: this.getHostElementId(), class: {
      readonly: this.readonly,
      disabled: this.disabled,
      "show-focus-outline": this.hasInputFocus && !this.dropdownItemsVisualFocused
    }, tabIndex: this.disabled ? -1 : 0 }, h("ix-field-wrapper", { key: "d8b33c2d839cb3823e3b976d8205d4ffb1afe5dc", required: this.required, label: this.label, helperText: this.helperText, invalidText: this.invalidText, infoText: this.infoText, warningText: this.warningText, validText: this.validText, showTextAsTooltip: this.showTextAsTooltip, isInvalid: this.isInvalid, isValid: this.isValid, isInfo: this.isInfo, isWarning: this.isWarning, controlRef: this.inputRef }, h("div", { key: "a2563141cd49757eef3e0b0384e7d6636beaa6c0", class: {
      select: true,
      disabled: this.disabled,
      readonly: this.readonly
    }, ref: (ref) => {
    ...
    } }, h("div", { key: "46e1f8123a2cdcd2c0581d79b137fe6e51f64ccc", class: "input-container" }, h("div", { key: "0be2d39cc4ec00f0f9f2c632e7717c920037825c", class: "chips", ref: this.chipsContainerRef }, this.isMultipleMode && this.renderMultipleModeChips(), h("div", { key: "5894760954dfe8928660b1878abb1b5d81105f01", class: "trigger" }, h("input", { key: "39192aef4d2cb53a678aedf08d9fd94b7c70958f", id: `${this.hostId}-input`, role: "combobox", "aria-controls": `${this.hostId}-proxy-listbox`, "aria-expanded": a11yBoolean(this.dropdownShow), "aria-autocomplete": "list", "aria-disabled": a11yBoolean(this.disabled), autocomplete: "off", "data-testid": "input", disabled: this.disabled, readOnly: this.readonly, required: this.required, type: "text", class: {
    ...
    }, "data-select-dropdown": true, key: "dropdown", class: { "dropdown-visible": this.dropdownShow }, icon: this.dropdownShow ? iconChevronUpSmall : iconChevronDownSmall, variant: "subtle-tertiary" })))))), h("ix-dropdown", { key: "970bc1a66abbde95fb1d36563aa27cc8f0d2519d", id: `${this.hostId}-listbox`, keyboardActivationKeys: ["ArrowUp", "ArrowDown"], keyboardItemTriggerKeys: ["Enter"], disableFocusTrap: true, focusHost: this.hostElement, ref: this.dropdownRef, show: this.dropdownShow, closeBehavior: this.isMultipleMode ? "outside" : "both", hidden: this.disabled || this.readonly, anchor: this.dropdownAnchorRef.waitForCurrent(), trigger: this.dropdownWrapperRef.waitForCurrent(), onShowChange: (event) => {
    ...
    } }, h("div", { key: "2ffb3c459c35b6dbf7afceb1269ad64cabbcd5ab", "aria-hidden": "true", class: {
      "select-list-header": true,
      hidden: this.hideListHeader || this.isDropdownEmpty
    }, title: this.i18nSelectListHeader, onClick: (e) => e.preventDefault() }, this.i18nSelectListHeader), h("slot", { key: "b6b1a56295823d74e03358470c11667ac8dbad8b", onSlotchange: () => {
      this.updateSelection();
    } }), h(FocusProxy, { key: "2dbdec68c3d406ddfa48fd2b75ce2701ad593f7b", hostId: this.hostId, otherProps: {
    ...
    } }), this.isDropdownEmpty && !this.editable && h("div", { key: "691eb876c8bd1fe373780dd2ab21032b448a0cde", class: "select-list-header" }, this.i18nNoMatches)), this.isMultipleMode && !this.shouldDisplayAllChip() && this.hiddenChipValues.length > 0 && this.renderOverflowDropdown());
  }
