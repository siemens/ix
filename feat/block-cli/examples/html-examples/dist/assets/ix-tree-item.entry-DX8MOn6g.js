...
const TreeItem = class {
  ...
  render() {
    ...
    return h(Host, { key: "4585bc79558a89709f661d5213b515e9d6060775", class: {
      selected: !!this.context?.isSelected,
      disabled: !!isDisabled
    } }, h("div", { key: "1e06b72fefd6b641676ef943a6a1a94419a7fdfd", class: "icon-toggle-container" }, this.hasChildren ? h("ix-icon", { name: iconChevronRightSmall, size: "24", class: {
      ...
      e.stopPropagation();
      this.toggle.emit();
    }, "aria-label": this.ariaLabelChevronIcon ?? (this.context?.isExpanded ? "Collapse tree item" : "Expand tree item") }) : null), h("div", { key: "ae6618dd33903fdc4e4882bf9ab749c072c50b3c", class: "tree-node-container", onClick: () => {
      if (isDisabled) {
        return;
      }
      this.itemClick.emit();
    } }, h("div", { key: "06ce12109c28bfac4beffa9920a9820e77ef288a", class: "tree-node-text" }, this.text), h("slot", { key: "59eba2172783761c39595c44e481cf35f5a74e7e" })));
  }
};
