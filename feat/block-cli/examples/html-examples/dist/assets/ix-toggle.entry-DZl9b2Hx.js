...
const Toggle = class extends Mixin(...DefaultMixins, InheritAriaAttributesMixin) {
  ...
  render() {
    ...
    return h(Host, { key: "8b968c79d81bc721b183791b79c5ef581ad41cd9", ...this.inheritAriaAttributes, role: "switch", tabindex: this.disabled ? -1 : 0, "aria-label": ariaLabel, "aria-checked": ariaChecked, "aria-disabled": a11yBoolean(this.disabled), "aria-required": a11yBoolean(this.required), class: {
    ...
    } }, h("div", { key: "70a1a1e4954c78cfe83708c6f24206939a9e245c", class: "wrapper" }, h("div", { key: "10c2e987029b3d4b45987419e0842f9b273d2b47", class: {
      switch: true,
      checked: this.checked,
      indeterminate: this.indeterminate
    }, "aria-hidden": "true" }, h("div", { key: "04ee4c92e44dde77789e476da6d2c61b5f1f53bb", class: "slider" })), !this.hideText && h("ix-typography", { key: "d2af0f2fa76679a231e87a8cc98cef7450ae14cf", class: "label", "aria-hidden": "true" }, toggleText)));
  }
