...
import { B as BaseButton } from "./base-button-D4FlHdn0-oEkZqEQ6.js";
...
const CategoryFilter = class {
  ...
  render() {
    var _a, _b, _c;
    return h(Host, { key: "82a591732a2d386c87a737da5e15cdb79c7cbf83" }, h("form", { key: "b782785708d75d2b9d42587550b063eeacf8fe99", ref: (el) => this.formElement = el }, h("div", { key: "68f8ac95656913e1d46b7abfa1a9e7c72a1b7b37", "read-only": this.readonly, class: {
      "input-container": true,
      disabled: this.disabled,
      focus: this.hasFocus,
      readonly: this.readonly,
      "no-icon": this.hideIcon
    } }, h("ix-icon", { key: "456a762fce23ff6ee96bee152656dfb2a37e19b0", color: this.getIconColor(), class: { "display-none": this.hideIcon }, name: (_a = this.icon) !== null && _a !== void 0 ? _a : iconSearch, size: "16" }), h("div", { key: "ebc66878730f499a4668f79bc7e90a6843c18da6", class: "token-container" }, h("div", { key: "7bb211165ea9204cb3e978463ce8d695ddeb5a94", class: "list-unstyled" }, this.filterTokens.map((value, index) => h("span", { key: value.toString(), class: {
    ...
    } }, (_b = this.categories[this.category]) === null || _b === void 0 ? void 0 : _b.label), h("input", Object.assign({ key: "aab62f63b56903ec7b13634e1dc970c2630f84de", class: {
      "text-input": true,
