...
const Kpi = class {
  ...
  render() {
    return h(Host, { key: "4f9ce89fb082b10dae871b6f8326023be639c527", title: this.getTooltipText(), tabindex: "1", class: {
      stacked: this.orientation === "vertical"
    } }, h("div", { key: "1a4eae0f549b39ffc6d4c23200a4e17a95a963eb", class: {
      "kpi-container": true,
      alarm: this.state === "alarm",
      warning: this.state === "warning"
    } }, h("span", { key: "efb64d8e2893c2e20af2ed42eef2c245263a4b26", class: "kpi-label" }, this.getStateIcon(), h("span", { key: "162fb207b034224c752628c39da13dbfc7527ec2", class: "kpi-label-text" }, this.label)), h("span", { key: "77ccae957f731c587bbaa017fd0be3752c1e2b43", class: "kpi-value-container" }, h("span", { key: "d10511790c68dae00f059c2c81c8d5418daf88b9", class: "kpi-value" }, this.value), this.unit ? h("span", { class: "kpi-unit" }, this.unit) : "")));
  }
};
Kpi.style = kpiCss();
export {
