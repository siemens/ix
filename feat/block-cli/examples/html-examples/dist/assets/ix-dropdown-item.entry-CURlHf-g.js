...
const DropdownItem = class {
  ...
  render() {
    return h(Host, { key: "3654e59a54a489be7787b434d17fceaf887a40f4", class: {
      hover: this.hover,
      "icon-only": this.isIconOnly(),
      disabled: this.disabled,
      submenu: this.isSubMenu
    }, role: "listitem" }, h("button", { key: "c600baf9f4b9bc1fe08d07b55104b84ea4b3f90e", type: "button", tabIndex: this.disabled ? -1 : 0, class: {
      "dropdown-item": true,
