...
const EventListItem = class {
  ...
  render() {
    ...
    return h(Host, { key: "57306d6433405f384e1350a096acbd94a7df8e74", class: {
      disabled: this.disabled,
      [`event-list-item-${this.variant}`]: true
    } }, h("div", { key: "1ea12e00b6a8eafd6cf890acbf9b5c93a5b0fa66", role: "listitem", "aria-disabled": a11yBoolean(this.disabled), class: {
      "event-list-item": true,
      selected: this.selected,
      disabled: this.disabled
    } }, h("div", { key: "ea788a71a34056f67926239f3897910b108a0e1f", class: `indicator ${!this.itemColor ? "indicator-empty" : ""}`, style: {
      "background-color": this.itemColor ? color : "inherit",
      opacity: `${this.disabled ? 0.4 : 1}`
    } }), h("div", { key: "be84c1a9d2469eba381279d256f9c0ee96fc4ca5", class: "event-list-item-container" }, h("div", { key: "7f2828f915cd0c767b9781503e5ec3573949594d", class: "event-content" }, h("slot", { key: "4e5304e8f8ec27006ae02ad217aa40677e128b32" })), this.chevron && h("ix-icon", { key: "13f99e22463e96b9e3ac6384db9a1a3d916d0d69", name: iconChevronRight, size: "16", class: "chevron-icon", "aria-hidden": "true" }))));
  }
};
