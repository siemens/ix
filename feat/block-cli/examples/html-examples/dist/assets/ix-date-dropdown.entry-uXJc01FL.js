...
import { p as iconHistory } from "./index-DLhpBBEI-C3tPjcQ4.js";
...
import { T as TRAP_FOCUS_EXCLUDE_ATTRIBUTE } from "./focus-trap-Ci7SFoiU-By66Ri_a.js";
...
const DateDropdown = class extends Mixin(...DefaultMixins) {
  ...
  render() {
    ...
    return h(Host, { key: "6c8cdf6fcc0aeccb737fe31447875995a0e93426", onFocusout: (event) => {
      const relatedTarget = event.relatedTarget;
      if (!relatedTarget) {
        return;
      }
      this.closeDropdown();
    }, role: "presentation" }, h("ix-button", { key: "78fd0d1c7ae3d142e5718ea9fa8fa73b03ca5244", "data-testid": "date-dropdown-trigger", "data-date-dropdown-trigger": true, variant: this.variant, loading: this.loading, icon: iconHistory, ref: this.triggerRef, disabled: this.disabled, ...this.inheritAriaAttributes, "aria-haspopup": "true", "aria-expanded": a11yBoolean(this.show), "aria-controls": "date-dropdown", "aria-label": ariaLabel, [TRAP_FOCUS_EXCLUDE_ATTRIBUTE]: true }, this.getButtonLabel()), h("ix-dropdown", { key: "79ca0b78eebd5b93106cb0feb9f059dd8a9c488e", focusTrapOptions: {
    ...
    } }, h("div", { key: "9d97a12362a47dfdbe95ce95a549376118caf81b", class: "container" }, this.dateRangeOptions?.length > 1 && h("div", { key: "e6d75ad781ffafe4ff18022bb106e65c592cda34", class: {
    ...
    } }, dateRangeOption.label))), h("div", { key: "d0c6518952fb25646088f7e8806f6e098ad965d0", class: "picker-wrapper" }, h("ix-date-picker", { key: "08749a5a1bac21673230ddaa47f6ef1ba8951ba4", ref: this.datePickerRef, embedded: true, locale: this.locale, onDateChange: (e) => {
      e.stopPropagation();
      this.currentRangeValue = {
        ...e.detail,
        id: "custom"
      };
    }, onDateRangeChange: (e) => e.stopPropagation(), format: this.format, singleSelection: this.singleSelection, from: this.from || this.currentRangeValue?.from, to: this.to || this.currentRangeValue?.to, minDate: this.minDate, maxDate: this.maxDate, today: this.today, weekStartIndex: this.weekStartIndex, showWeekNumbers: this.showWeekNumbers }), h("div", { key: "3aa28c17863acaed2bb7eef507337e19e709ae4f", class: "pull-right" }, h("ix-button", { key: "dbb2b75b59d964a137b101089aafbc8a7ba24ba5", onClick: () => {
      if (this.currentRangeValue) {
        this.onDateSelect(this.currentRangeValue);
        this.closeDropdown();
      }
