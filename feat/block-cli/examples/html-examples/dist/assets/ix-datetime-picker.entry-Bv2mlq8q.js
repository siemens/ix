...
const DatetimePicker = class {
  ...
  render() {
    ...
    return h(Host, { key: "c003b12dbd265a6c146f868b08cbb2d39aff0480" }, h("ix-date-time-card", { key: "1430d3da80c2f65465a5686c6489fac63c252f51", hideHeader: true, hasFooter: true, embedded: this.embedded, corners: "rounded", noPadding: true }, h("ix-layout-grid", { key: "6359640b7614d113696bcaf22b2a38789150a163", class: "no-padding" }, h("ix-row", { key: "5463098b09fb3938faaa99363b6d73c021c63346", class: "row-separator" }, h("ix-col", { key: "9a586d50bd876ced58e4907fdfad2065e0c42dfe", class: "col-separator" }, h("ix-date-picker", {
      key: "c311e113d6dd1fb4fc13ba62aadf3fa4a677fe3c",
    ...
    })), h("ix-col", { key: "7506c55668b9a627dd8d9c25d42736c451392398" }, h("ix-time-picker", {
      key: "3e7b11315bc7995408e79db513769b1defacdd6b",
      class: "min-width",
      ...
      tabIndex: this.embedded ? -1 : 0,
      [TRAP_FOCUS_INCLUDE_ATTRIBUTE]: this.embedded
    })))), h("div", { key: "e2f93128b403d4154e1ec4d6823a020d16bab46a", slot: "footer", class: "btn-select-date-container" }, h("ix-button", { key: "60eb0b63d02efd9db2d71171c4760e506cb3617d", class: "btn-select-date", onClick: () => this.onDone() }, this.i18nDone))));
  }
  static get watchers() {
    return {
      "from": [{
