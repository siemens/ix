...
const IxActionCard = class {
  ...
  render() {
    ...
    return h(Host, { key: "0198c32223a28cc0cb3f8334e87777984c507846" }, h("ix-card", { key: "4317601a04b312d92e49bf130dc22d56cb0de719", selected: this.selected, variant: this.variant, passive: this.passive, class: "pointer", "aria-label": this.ariaLabelCard, "aria-labelledby": ariaLabelledBy, role: ariaLabelledBy ? "group" : void 0 }, h("ix-card-content", { key: "07d2862c28610950345bf9779102d9407a82b6c0" }, this.icon ? h("ix-icon", { class: "icon", name: this.icon, size: "32", "aria-label": this.ariaLabelIcon || getFallbackLabelFromIconName(this.icon) }) : null, h("div", { key: "fe58b940d8ae1a85618a50bdd0e0ba1f10eaaf1a" }, this.heading ? h("ix-typography", { id: "ix-action-card-heading", "aria-hidden": a11yBoolean(!ariaLabelledBy), format: "h4" }, this.heading) : null, this.subheading ? h("ix-typography", { format: "h5", "text-color": this.getSubheadingTextColor() }, this.subheading) : null, h("slot", { key: "9c4f7dd6d67192f30f4801f9f8622836c570a201" })))));
  }
};
