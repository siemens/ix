...
const MenuAbout = class {
  ...
  render() {
    return h(Host, { key: "4235cb47234f4a664de8842682e179c09aa842d1", slot: "ix-menu-about", class: {
      show: this.show,
      ["legacy-tabs"]: !this.suppressLegacyTabs
    } }, h("div", { key: "d574351a468aec0be10e6de4c77447448949b30f", class: "about-header" }, h("h2", { key: "cfe96ab47a0d021f773ece026afe080501e48a50", class: "text-h2" }, this.label), h("ix-icon-button", { key: "e639ce5a0ce2903d138431b2a9845ce4a9b55f01", variant: "tertiary", size: "24", icon: iconClose, iconColor: "color-soft-text", "aria-label": this.ariaLabelCloseButton, onClick: (e) => this.close.emit({
      name: "ix-menu-about",
      nativeEvent: e
