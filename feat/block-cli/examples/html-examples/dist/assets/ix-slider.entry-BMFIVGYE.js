...
import { O as OnListener } from "./listener-Gv04YF3F-CPTkJ94B.js";
...
const Slider = class {
  ...
  render() {
    ...
    return h(Host, { key: "633e8fb6d733092ebd31144f4395caa6717fc091", class: {
    ...
    }, onPointerDown: () => setTimeout(() => this.showTooltip = true) }, h("ix-field-wrapper", { key: "bc77f9015e92ff9dbfaa0fa019c9824e22c673fa", label: this.label, helperText: this.helperText, invalidText: this.invalidText, infoText: this.infoText, warningText: this.warningText, validText: this.validText, showTextAsTooltip: this.showTextAsTooltip, isValid: this.isValid, isInfo: this.isInfo, isWarning: this.isWarning, isInvalid: this.isInvalid, controlRef: this.controlRef }, h("div", { key: "5f03b5818b6f414f31e13ce1863467d581eb6f37", class: "slider-container" }, h("div", { key: "b7b504a03cf29ee7537ef5c28c29c5e4a11efcdb", class: "slider" }, h("div", { key: "b4a2062243ffaf49952aa2de4edda97e7761ca34", class: "track" }, h("div", { key: "4948b1da977041885154555074836b1492e9a4c9", ref: this.thumbRef, class: "thumb", style: {
      left: `calc(${valueInPercentage} * (100% - 1rem))`
    } }), h("svg", { key: "050eef3c2de8de0cf996c6d5c978fc9487d1f6f8", class: "ticks", xmlns: "http://www.w3.org/2000/svg" }, this.marker?.filter((markerValue) => markerValue >= this.min && markerValue <= this.max).map((markerValue) => {
    ...
    }))), h("input", { key: "3983c79eca76d93d59bdde023ccb2655ca321fd0", id: "slider", ref: this.controlRef, type: "range", list: this.marker ? "markers" : void 0, step: this.step, min: this.min, max: this.max, value: this.rangeInput, tabindex: this.disabled ? -1 : 0, onInput: (event) => this.onInput(event), onFocus: () => {
    ...
    }, role: "slider", "aria-valuenow": this.rangeInput, "aria-valuemin": this.min, "aria-valuemax": this.max, ...this.a11yAttributes }), h("ix-tooltip", { key: "134efa8432ebc10bee9a0e6606b7ea8dff76d09b", ref: this.tooltipRef, class: {
      "hide-tooltip": !this.showTooltip
    }, animationFrame: true, for: this.thumbRef.waitForCurrent() }, this.rangeInput)), this.hasLabels && h("div", { key: "b3d8d2c4d1a7f1360777f505db130b832a50cd95", class: "label" }, h("div", { key: "64a66af37e71903c8c6a04e4c986b60119d884f4" }, h("slot", { key: "87ae3c3aec527f25fc9ea8d0b649bbca9dfebc86", name: "label-start" })), h("div", { key: "dce84ba7f3718895471d00070096141d216cf1f6" }, h("slot", { key: "34e06d271638ba869d2b091e943f2b8bbf1b22ca", name: "label-end" }))), this.error ? h("ix-typography", { textColor: "alarm" }, this.error) : null)));
  }
