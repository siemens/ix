...
import { w as iconChevronRightSmall, D as iconChevronLeftSmall } from "./index-BBzEV-f4-ChQfUIyc.js";
...
const TabItem = class {
  ...
  render() {
    return h(Host, { key: "b78f6f726ffd7fe7589dda9ec8cba8c565f36d5f", role: "tab", class: this.tabItemClasses({
    ...
    } }, h("div", { key: "31f32c37c0ee9793697bc77afdbf69321e59ead3", class: {
      circle: this.rounded,
      text: !this.rounded,
      selected: this.selected,
      disabled: this.disabled
    } }, h("slot", { key: "9c791015face065520249bf6ec286fd7a067659f" })), h("div", { key: "6ded4533c5599605cdbcfa810f24a6d859b999e1", class: {
      counter: true,
      selected: this.selected,
...
const Tabs = class {
  ...
  render() {
    return h(Host, { key: "addc9c0390e362e5ccd6ec19e80847f210a37e9a", role: "tablist" }, this.showArrowPrevious && h("button", { key: "b36ccd8b3c21a7ee67fb7172d3052bd627be0a66", class: "arrow", onClick: () => this.move(this.scrollAmount, true), "aria-label": this.ariaLabelChevronLeftIconButton }, h("ix-icon", { key: "a898bfb2dc5e8439a9cc6ddaf8c19702152ed874", name: iconChevronLeftSmall })), h("div", { key: "9dcf9dd16c1834a9f1096a143b46f8064bedada4", class: {
      "tab-items": true,
    ...
    } }, h("div", { key: "978993fe81c34b315d1e38e81468a49b929dfc48", class: "items-content" }, h("slot", { key: "ec7fdbe43781822801ea461fad0a7f93552636f4" }))), this.showArrowNext && h("button", { key: "7f8c68b05c0e81205055e37f64add78114b6fe00", class: "arrow right", onClick: () => this.move(-this.scrollAmount, true), "aria-label": this.ariaLabelChevronRightIconButton }, h("ix-icon", { key: "ba5c3cde5924765c9c29129842de80dac4476064", name: iconChevronRightSmall })));
  }
  get hostElement() {
