...
import { H as iconDoubleChevronLeft, F as iconDoubleChevronRight } from "./index-DFdo1y_u-D_8X33yw.js";
import { g as getButtonClasses } from "./base-button-Blr8QCqk-DKoBlT2G.js";
...
const MenuExpandIcon = class {
  ...
  getLargeScreenIcon() {
    return h("ix-icon-button", { icon: this.expanded ? iconDoubleChevronLeft : iconDoubleChevronRight, "aria-hidden": "true", variant: "subtle-tertiary" });
  }
  getMenuIcon() {
    if (this.pinned) {
  ...
  render() {
    return h(Host, { key: "b350511cf29731e165b28f1349a3ebf0c3ac8784", class: {
