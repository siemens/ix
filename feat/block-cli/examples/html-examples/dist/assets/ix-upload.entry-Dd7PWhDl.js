import { g as getElement, r as registerInstance, c as createEvent, h, H as Host } from "./global-Cr1KQvOo.js";
import { U as UploadFileState } from "./upload-file-state-BGzrnl_l-DLdhtkd7.js";
import { c as iconSuccess, b as iconError } from "./index-ClV1Tffv-Cwm_ckfF.js";
...
const Upload = class {
  ...
  render() {
    ...
    return h(Host, { key: "f90cc3510ccced53200ef78d9ec9a2420cdc816d", ...a11y, "aria-disabled": disabled }, h("div", { key: "379c465bf10fbfb349ee97023b4c3616d76d6cfe", class: {
    ...
    }, onDragOver: (e) => this.fileOver(e), onDragLeave: () => this.fileLeave() }, this.renderUploadState(), h("div", { key: "c4b8daec9d17c1aa8f3893a8132b1162db2b8c41" }, h("input", { key: "e91fc8ee30a6ed9595897ecf71d4b81218d2cce9", "aria-label": ariaLabel, "aria-disabled": disabled, multiple: this.multiple, type: "file", class: "upload-browser", id: "upload-browser", tabindex: "-1", onChange: (e) => {
      this.fileChangeEvent(e);
    }, accept: this.accept, disabled }), h("ix-button", { key: "4cee792d1e80f0c2f929b0ae89d7a395df6357e0", variant: "secondary", "aria-disabled": disabled, onClick: () => this.inputElement.click(), disabled }, this.i18nUploadFile))));
  }
};
