import { r as registerInstance, h, H as Host, c as createEvent, g as getElement } from "./global-C8IWpzMv.js";
...
const ModalContent = class {
  ...
  render() {
    return h(Host, { key: "34893b91efcad398303e0dec015255bc998bb0c8" }, h("slot", { key: "3eb2689dc0cf721ece58640703c20ae77bc838b5" }));
  }
};
...
const ModalHeader = class {
  ...
  render() {
    return h(Host, { key: "5cfb6ebb01e553c54c234be3eba403cdd7fb11d7" }, this.icon ? h("ix-icon", { name: this.icon, color: this.iconColor, size: "32", "aria-label": this.ariaLabelIcon }) : null, h("div", { key: "091e9cf25e3e3746bb923b1aa6e9c3fccbef92e3", class: "modal-title" }, h("ix-typography", { key: "852971244b6ac3e5217ba8f207ef5a7f0bc945e0", format: "h5" }, h("slot", { key: "927c63db24d2851914453774ec749fc3b22c74da" }))), !this.hideClose ? h("ix-icon-button", { class: "modal-close", onClick: (event) => this.onCloseClick(event), variant: "tertiary", icon: iconClose, iconColor: "color-soft-text", "aria-label": this.ariaLabelCloseIconButton }) : null);
  }
