...
const Dropdown = class extends Mixin(...DefaultMixins) {
  ...
  render() {
    ...
    return h(Host, { key: "25a5855be490e559d161c6107d21b27670cecaa9", ...ariaAttributes, "aria-modal": "true", "data-ix-dropdown": this.dropdownElementId, "data-ix-focus-trap": true, class: {
      "dropdown-menu": true,
      show: this.show,
...
const DropdownItem = class extends Mixin(...DefaultMixins, ComponentIdMixin, FocusVisibleMixin) {
  ...
  render() {
    ...
    return h(Host, { key: "65fdebb6bcfb0b6fc40691a9d30c9e253363ab59", id, role: this.itemRole, "aria-disabled": a11yBoolean(this.disabled), "aria-label": this.hostElement.ariaLabel ?? this.ariaLabelButton, class: {
      hover: this.hover,
    ...
    }, ...submenuAriaAttributes }, h("div", { key: "a48fa322465dac323d315df0578096c241111e96", class: {
      "dropdown-item": true,
      "no-checked-field": this.suppressChecked,
      disabled: this.disabled
    } }, !this.suppressChecked ? h("div", { class: "dropdown-item-checked" }, this.checked ? h("ix-icon", { "aria-hidden": "true", class: "checkmark", name: iconSingleCheck, size: "16" }) : null) : null, this.icon ? h("ix-icon", { class: "dropdown-item-icon", name: this.icon, "aria-label": this.ariaLabelIcon }) : null, h("div", { key: "121390035bc5bdf9339771cee7e96a649539befa", class: "dropdown-item-text" }, this.label, h("slot", { key: "765dd63e2ec3bff919df4a2c9c4e83686544f7b8" })), this.isSubMenu ? h("ix-icon", { name: iconChevronRightSmall, class: "submenu-icon" }) : null));
  }
  static get watchers() {
    return {
      "ixFocusVisible": [{
