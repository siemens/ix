...
import { t as tryFocusElement } from "./focus-utilities-COIIN2Es-jUaNMCSm.js";
...
const Modal = class {
  ...
  render() {
    return h(Host, { key: "be164aea2ae397c2b046bf43fdbc34d074655f94", class: {
      visible: this.modalVisible,
      "no-backdrop": this.hideBackdrop,
      "align-center": this.centered,
      "non-blocking": this.isNonBlocking
    } }, h("div", { key: "f40cd061ccb672363902109c2731151ce618a931", class: "dialog-backdrop" }, h("dialog", { key: "b1e21cf7dac3126e084fc98a6a4190c3a04ca8e1", "aria-modal": a11yBoolean(!this.isNonBlocking), "aria-describedby": this.ariaAttributes["aria-describedby"], "aria-labelledby": this.ariaAttributes["aria-labelledby"], class: {
      modal: true,
      ...
      e.preventDefault();
      void this.dismissModal();
    } }, h("slot", { key: "8250e3e46eeef1fb882ce9e4b629692c7c029dc1" }))));
  }
};
