import { r as registerInstance, h, H as Host } from "./global-X6m21_-k.js";
import { J as iconDoubleChevronLeft, H as iconDoubleChevronRight } from "./index-Dn2eQInl-mXhHymhu.js";
import { g as getButtonClasses } from "./base-button-B4oMpb0M-CdZoth2M.js";
...
const MenuExpandIcon = class {
  ...
  pinned = false;
  getSmallScreenIcon() {
    return h("button", { "aria-label": this.expanded ? this.i18nCollapse : this.i18nExpand, "aria-pressed": a11yBoolean(this.expanded), class: {
  ...
  getLargeScreenIcon() {
    return h("ix-icon-button", { "aria-pressed": a11yBoolean(this.expanded), "aria-label": this.expanded ? this.i18nCollapse : this.i18nExpand, icon: this.expanded ? iconDoubleChevronLeft : iconDoubleChevronRight, variant: "subtle-tertiary" });
  }
  getMenuIcon() {
  ...
  render() {
    return h(Host, { key: "ad345afc468d6cd1dae19c074e6de12d8083cbc7", class: {
