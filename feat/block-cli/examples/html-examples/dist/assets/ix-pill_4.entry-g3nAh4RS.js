import { M as Mixin, r as registerInstance, g as getElement, h, H as Host, c as createEvent, a as readTask } from "./global-F68Qu5y3.js";
...
const Pill = class extends Mixin(...DefaultMixins) {
  ...
  render() {
    ...
    return h(Host, { key: "b8b4422836490a2c262311ff7ef3881e0fb80c77", style: this.variant === "custom" ? {
      "--ix-icon-button-color": this.pillColor
    } : {}, class: {
      "align-left": this.alignLeft
    }, role: hostRole }, h("div", { key: "fddbce8423fe104d6416669910fb7ad8b538d559", ref: this.containerElementRef, style: { ...customStyle }, class: {
      container: true,
    ...
    } }, this.icon && h("ix-icon", { key: "5f292fbd611e3461418811ddf4fefccb78f34ee6", class: {
      "with-icon": true
    }, name: this.icon, size: "16", "aria-label": this.ariaLabelIcon, "aria-hidden": a11yBoolean(iconIsDecorative) }), h("span", { key: "e8086e4a7d35f779588d8dd5075c3671915aa96b", class: "slot-container" }, h("slot", { key: "1f8609b8fdb42d700c510a51c55cdd1fda9051e1", onSlotchange: () => this.checkIfContentAvailable() }))), this.getTooltip());
  }
};
Pill.style = pillCss();
...
const TabItem = class extends Mixin(...DefaultMixins, ComponentIdMixin, BaseTabMixin) {
  ...
  render() {
    ...
    return h(Host, { key: "11b0dda2a87508923353220c4cfba9a5d9b27a5d", id: this.getHostElementId(), role: "tab", "aria-selected": a11yBoolean(this.selected), tabIndex: this.selected && !this.disabled ? 0 : -1, class: {
    ...
    } }, variant === "rounded" && h("div", { key: "e4d2c0ef8610e574336c384e087c0d0cd278d76b", class: {
      circle: true
    } }, this.icon && h("ix-icon", { key: "9e719aa9b405d11369063eced3c4d35156403b85", name: this.icon, size: "24" }), h("slot", { key: "49780fc74974a0f2cb51ebe423ab46cb99659b97" })), this.icon && variant !== "rounded" && h("ix-icon", { key: "50bc47df3d11562bc32ab4bda0e8b980cd57cff1", name: this.icon, size: "16", class: "tab-icon" }), variant === "normal" && h("div", { key: "4f44bef73d334b6504413e9df1893dd947dadd7c", class: {
      text: !!this.label,
      selected: this.selected,
      disabled: this.disabled
    } }, this.label, h("slot", { key: "87537eb83b7b0bf6b7b7d793496595c4e18d32b1" })), variant === "rounded" && this.counter !== void 0 && h("div", { key: "7663e9d820f2a99f686eb4863ced8cf6cfe57239", class: {
      counter: true,
      selected: this.selected,
      disabled: this.disabled
    } }, this.counter), this.counter && variant !== "rounded" && h("ix-pill", { key: "ef8ca07b771557df3e1a366e1ba5dff68d568f5d", variant: "primary", outline: true, class: "tab-counter" }, this.counter), this.closable && variant !== "rounded" && h("ix-icon-button", { key: "9e7b82d93425582a27dd6f9005d4fb8b56e6d3ed", "aria-label": this.ariaLabelCloseButton, class: "close-tab", size: "12", variant: "subtle-tertiary", icon: iconClose, onClick: (event) => {
      event.stopPropagation();
      event.preventDefault();
      this.tabClose.emit({
        tabKey: this.tabKey,
...
const TabSet = class {
  ...
  render() {
    return h(Host, { key: "1a7600cb589816e53ecf469f8d01982bb507903c", onTabChange: () => this.checkPanelsVisibility() }, h("slot", { key: "043b7e4dbb129446eea90df857d9625a7b51f2e0" }));
  }
};
...
const Tabs = class extends Mixin(...DefaultMixins, InheritAriaAttributesMixin) {
  ...
  render() {
    return h(Host, { key: "2ba67ca74d02e41930dbeefc0f16cf67ac6e619b", onTabClick: (event) => this.onTabClick(event), class: {
      small: this.small
    } }, h("div", { key: "4ded7e9f89381768500836e1fa88b1d79ef6b226", ref: this.tabsContainerRef, class: {
      "tabs-container": true,
      top: this.placement === "top",
      bottom: this.placement === "bottom"
    } }, h("div", { key: "5760f87bf2f510afadd48f0f78f4b38124ef9ce9", class: {
      "overflow-shadow-container": true,
      "overflow-shadow": this.isTabsOverflow
    } }, h("div", { key: "3d4bc3601030884b9315b63487f8a092d2f6e66a", role: "tablist", ...this.inheritAriaAttributes, ref: this.tabsRef, class: {
      tabs: true,
      "tabs-stretched": this.layout === "stretched"
    }, tabIndex: this.isTabsOverflow ? 0 : -1, onKeyDown: (event) => this.onTabsNavigate(event) }, h("slot", { key: "c6162880fea3e18de20384e6dcf9574077ea1214" }))), this.isTabsOverflow && this.layout !== "stretched" && h("ix-dropdown-button", { key: "a129a2dc8714def741383d879727ffa9fb88619d", ariaLabel: this.ariaLabelMoreTabs, icon: iconMoreMenu, class: {
