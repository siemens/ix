...
import { F as iconChevronLeftSmall, j as iconChevronRightSmall } from "./index-DgUGsIlh-CLxQRaVd.js";
...
const DatePicker = class extends Mixin(...DefaultMixins) {
  ...
  render() {
    return h(Host, { key: "e744352d4349d211dac0bce50973fbebef02f61e", onKeyDown: (event) => this.onKeyDown(event), onFocusin: () => {
      if (hasKeyboardMode()) {
        this.changeFocusedDay();
      }
    } }, h("ix-date-time-card", { key: "cf292500af10942a48d80917b53bd19ed765f09d", corners: this.corners, embedded: this.embedded }, h("div", { key: "c9c481a57b5189223a56eea94a115fd0743247df", class: "header", slot: "header" }, h("ix-icon-button", { key: "d5fca2ebd215ec4da6f5e82d90709a2dbab5fa63", onClick: () => this.changeCalendarView(-1), icon: iconChevronLeftSmall, variant: "tertiary", class: "arrows", "aria-label": this.ariaLabelPreviousMonthButton }), h("div", { key: "426781cc40d85f094583e1d1692938435ead31b8", class: "selector" }, h("ix-dropdown-button", { key: "29d1d4ec9e6388f94c32f714fc93af81f84af8b3", class: "month-selector", focusCheckedItem: true, "aria-label": this.ariaLabelMonthSelection, variant: "tertiary", label: null, onShowChanged: (event) => {
      event.stopPropagation();
    } }, h("ix-typography", { key: "2d1d5725fb537b7366709bbdc79f6ca2ae151ed1", bold: true, class: "capitalize", slot: "button-label" }, this.monthNames[this.selectedMonth]), this.renderMonths()), h("ix-dropdown-button", { key: "93c0b9af846d3105c21c469252f8325960642bd2", class: "year-selector", focusCheckedItem: true, "aria-label": this.ariaLabelYearSelection, ref: this.yearDropdownButtonRef, variant: "tertiary", label: null, onShowChanged: (event) => {
      event.stopPropagation();
      if (event.detail) {
        requestAnimationFrameNoNgZone(() => {
    ...
    } }, h("div", { key: "bb4ca7b584e04d20792b2822ef716e3253fe10e5", class: "infinite-scrolling-spacer" }, h("div", { key: "393dafb6169ab711f4d6fa39a0cee3797b6a49a8", class: "sentinel", "data-sentinel": "top" })), h("ix-typography", { key: "73f4692a54088de78874d3e9fd7b80d5f50fe2eb", bold: true, class: "capitalize", slot: "button-label" }, this.selectedYear), this.renderYears(), h("div", { key: "41f6c69b00d4fb2bc16ad1a64b3c3e328cb1fb94", class: "infinite-scrolling-spacer" }, h("div", { key: "c79888fec1f44535c82ec0e8e240f6a39d758993", class: "sentinel", "data-sentinel": "bottom" })))), h("ix-icon-button", { key: "ac97824c956f881c9a56cf959d75ddd5cc1fdc2e", onClick: () => this.changeCalendarView(1), icon: iconChevronRightSmall, variant: "tertiary", class: "arrows", "aria-label": this.ariaLabelNextMonthButton })), h("div", { key: "b623a95f9108ba6cc04311e61e609f789dd70c02", role: "grid", class: {
      grid: true,
      "grid--show-week-numbers": this.showWeekNumbers
    } }, h("div", { key: "b8d2964586d57f328b0b3d82b5672bd6f524498d", role: "row" }, this.showWeekNumbers && h("div", { key: "41d67b950685366747813d953fdca3cf72c000e7", class: "calendar-item week-day", role: "columnheader" }), this.dayNames.map((name) => h("div", { key: name, class: "calendar-item week-day", role: "columnheader" }, h("div", { class: "overflow" }, name.slice(0, 3))))), this.calendar.map((week) => {
    ...
    })), h("div", { key: "5e6b8681c6ea9415862aea8894e2daf20ef8b156", class: {
      button: true,
      hidden: this.singleSelection || this.embedded
    } }, h("ix-button", { key: "089a0c86d18a9cdd07fee15aad52745c41494e6f", hidden: this.singleSelection || this.embedded, onClick: () => this.onDone() }, this.i18nDone))));
  }
