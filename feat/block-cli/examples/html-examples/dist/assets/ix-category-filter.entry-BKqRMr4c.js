...
const CategoryFilter = class {
  ...
  render() {
    return h(Host, { key: "2725059373205563c3f38adbb6b0d87a2b80b3d2" }, h("form", { key: "65a383c98d0a028692053d9f9de7201b33ef9d26", ref: (el) => this.formElement = el }, h("div", { key: "aa0fb0d53a9a0f5067c52c9bf815d5b8c776192e", "read-only": this.readonly, class: {
      "input-container": true,
      disabled: this.disabled,
      focus: this.hasFocus,
      readonly: this.readonly,
      "no-icon": this.hideIcon
    } }, h("ix-icon", { key: "6da16f44a4e268f5c5aa7793282cc74357363790", color: this.getIconColor(), class: { "display-none": this.hideIcon }, name: this.icon ?? iconSearch, size: "16" }), h("div", { key: "7dbc503dd860431bcc84ffe0d963f314de92136b", class: "token-container" }, h("div", { key: "bc746b192be401d7acc5b1ac75eaecee30c68184", class: "list-unstyled" }, this.filterTokens.map((value, index) => h("span", { key: value.toString(), class: {
    ...
    } }, this.categories[this.category]?.label), h("input", { key: "eac23b6926a9cfe648f63c08f00a28d72400223b", class: {
      "text-input": true,
