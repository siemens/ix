import { r as registerInstance, c as createEvent, g as getElement, a as readTask, h, H as Host } from "./global-Cx3A0XQN.js";
...
const ApplicationHeader = class {
  ...
  render() {
    ...
    return h(Host, { key: "17c756fb2976ef879462a886bee52006f123517f", class: {
      [`breakpoint-${this.breakpoint}`]: true,
      "hide-bottom-border": this.hideBottomBorder
    }, slot: "application-header", role: "banner" }, h("div", { key: "f3a575d9d277f99e8aa8e0243ddf45070785bebf", class: "left-side" }, this.appIcon && this.breakpoint !== "sm" && h("div", { key: "0015e31d3cc84bf9b3e6636b292a427e1f60190e", class: {
      "app-icon": true,
      "app-icon-outline": this.appIconOutline
    } }, h("img", { key: "3333859a5cedbb199e6301bb88340699bbadf08b", src: this.appIcon, alt: this.appIconAlt })), (this.showMenu || showMenuByApplicationFrame) && h("ix-menu-expand-icon", { key: "d9d642a45896d642e9b5993195fe9700ede22d0b", onClick: () => this.onMenuClick(), expanded: this.menuExpanded }), showApplicationSwitch && h("ix-icon-button", { key: "17c4c2c9aa3771f7566e8f617b84bdf565da2ac0", onClick: () => this.showAppSwitch(), icon: iconApps, variant: "subtle-tertiary", class: {
      "app-switch": true,
      "without-app-icon": !this.appIcon
    }, "aria-label": this.ariaLabelAppSwitchIconButton }), showCompanyLogoByProperty && h("div", { key: "9ae9bbc5b97ae749b44988d12e88fb6387863503", class: "logo" }, h("img", { key: "4b8f24ae1e4463e9a31f5063ef001d538e06739b", src: this.companyLogo, alt: this.companyLogoAlt })), h("div", { key: "ad8335c39455025ede29fa20db13bcbdc6c52f0a", class: {
      logo: true,
      "hide-logo": !this.hasSlottedLogo
    } }, h("slot", { key: "4dbc6cd98d269e0c6da54d69d1ded37be209c9ec", name: "logo", onSlotchange: () => this.hasSlottedLogo = this.checkLogoSlot() })), h("div", { key: "54493626e63556a0558849b6f79eeadf3378cca5", class: "name" }, h("ix-typography", { key: "b79a4b3be8528eb09fa776f28fcfe11d7c41bdbd", format: "body-lg", class: "application-name" }, this.name), this.nameSuffix && this.breakpoint !== "sm" && h("ix-typography", { key: "fc0aa140fc98f1b8a52ce8231989278b335751c7", format: "body-xs", class: "application-name-suffix" }, this.nameSuffix))), h("div", { key: "2b3ea902bb6e0e9bc81927e578e0c30ac96864a1", class: { "right-side": true, sm: this.breakpoint === "sm" } }, this.breakpoint !== "sm" && h("div", { key: "5fedfa04ea66a19618889098aad257deeecc3aaf", class: "secondary" }, h("slot", { key: "f020d528951abd58ac74f76811a995271b7ee6cd", name: "secondary" })), h("div", { key: "5df2e4aa2ef680707a516deb9d33086e617505da", class: "content" }, this.breakpoint !== "sm" && h("slot", { key: "f98ebdb7a4a0ad2caaabdd682c72bab3d6ee972b" }), h("ix-icon-button", { key: "64baf1a97efd99297284bc0ab8136383e204c4bf", class: {
      "context-menu": true,
      "context-menu-visible": this.hasOverflowContextMenu
    }, "data-context-menu": true, "data-testid": "show-more", icon: iconMoreMenu, variant: "subtle-tertiary", "aria-label": this.ariaLabelMoreMenuIconButton, "aria-hidden": a11yBoolean(!this.hasOverflowContextMenu) }), h("ix-dropdown", { key: "3d6c027413c6d5e467614b09244a12289c369041", "data-overflow-dropdown": true, class: "dropdown", discoverAllSubmenus: true, trigger: this.resolveContextMenuButton(), "aria-hidden": a11yBoolean(!this.hasOverflowContextMenu), enableTopLayer: this.enableTopLayer }, h("div", { key: "67e7f928f80dda88d3ad9ac89de18bd32da40c77", class: "dropdown-content", onClick: (e) => this.onContentBgClick(e) }, this.breakpoint === "sm" && h("div", { key: "328d1445b83f7000ff8dcdade5ca1e4a60805d03", class: {
      "slot-content": true,
      "slot-content-active": this.hasSecondarySlotElements
    } }, h("slot", { key: "02b9712babb7a8db6e492a79f4edc999efd73def", name: "secondary", onSlotchange: () => this.updateHasSlotAssignedElementsStates() })), this.breakpoint === "sm" && h("div", { key: "959263a2aa29da9cf0da360c285c97c440e232cb", class: {
      "slot-content": true,
      "slot-content-active": this.hasDefaultSlotElements
    } }, h("slot", { key: "fa8380971ec0f2c1d8b4407a3555e5149611375e", onSlotchange: () => this.updateHasSlotAssignedElementsStates() })), h("div", { key: "7e1b3c1bf78bd72015d8334513091c157d73623c", class: {
      "slot-content": true,
      "slot-content-active": this.hasOverflowSlotElements
    } }, h("slot", { key: "def8b9fc32a10a9134ff383677c6fcdbec509cd2", name: "overflow", onSlotchange: () => this.updateHasSlotAssignedElementsStates() })))), h("slot", { key: "14bc217de72919dd98b78fd42edeb4104d8a15d7", name: "ix-application-header-avatar" }))));
  }
  static get watchers() {
    return {
      "applicationLayoutContext": [{
