...
const ToggleButton = class extends Mixin(...DefaultMixins, InheritAriaAttributesMixin) {
  ...
  render() {
    ...
    return h(Host, { key: "c0f1dae3f4a1e17505cab57b3386a980a29ecc76", class: {
      disabled: this.disabled || this.loading
    } }, h(BaseButton, { key: "75a720f974dae29aacb40abc11f327ce78c504ed", ...baseButtonProps }, h("slot", { key: "b814693b76693dd3d79a65b82013869635270bd0" })));
  }
  static get watchers() {
    return {
      "role": [{
