...
const Tree = class {
  ...
  render() {
    return h(Host, { key: "ddfa7d4282cae262ff888a073672f37b89d58f98", onClick: (event) => this.onTreeItemClick(event) }, h("slot", { key: "a8bdc0452b1dc232831c4b40de9eccf265e3ce3c" }));
  }
  static get watchers() {
    return {
      "model": [{
