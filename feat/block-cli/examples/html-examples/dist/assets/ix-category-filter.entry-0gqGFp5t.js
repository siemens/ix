...
import { l as iconSearch, m as iconClear } from "./index-CwfZ4aN6-mXhHymhu.js";
import { B as BaseButton } from "./base-button-pKJwknBx-DQM5mrPG.js";
...
import { L as LogicalFilterOperator, I as InputState } from "./logical-filter-operator-C9HBQRMb-BOZGh-G7.js";
...
const CategoryFilter = class {
  ...
  render() {
    return h(Host, { key: "8ca7f88e391a7a8d2d3f9698d4cb4eddc7dc2816" }, h("form", { key: "a5b554910a2c356576e37d17c33818f9c39d2837", ref: (el) => this.formElement = el }, h("div", { key: "98bc2ac43a2b49f998b32ace31247fe941bb6a25", "read-only": this.readonly, class: {
      "input-container": true,
      disabled: this.disabled,
      focus: this.hasFocus,
      readonly: this.readonly,
      "no-icon": this.hideIcon
    } }, h("ix-icon", { key: "fffee39c088ec8d1c2a4c95e830a446ada8346d5", color: this.getIconColor(), class: { "display-none": this.hideIcon }, name: this.icon ?? iconSearch, size: "16" }), h("div", { key: "e79d5a0bfa7febe212bbbb376f8140a25d7dfbaf", class: "token-container" }, h("div", { key: "129f6f25efe16f531fe50472770aa3fcb1cc7b15", class: "list-unstyled" }, this.filterTokens.map((value, index) => h("span", { key: value.toString(), class: {
    ...
    } }, this.categories[this.category]?.label), h("input", { key: "0bda73beddc62a66ac481585c1b659c42b5308eb", class: {
      "text-input": true,
