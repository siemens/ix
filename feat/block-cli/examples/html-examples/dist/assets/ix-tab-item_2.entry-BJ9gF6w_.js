import { r as registerInstance, c as createEvent, h, H as Host, g as getElement } from "./global-C_dy4gBz.js";
import { r as requestAnimationFrameNoNgZone } from "./requestAnimationFrame-BEuV0Xpe-CBtvTq-Q.js";
import { j as iconChevronRightSmall, D as iconChevronLeftSmall } from "./index-DFdo1y_u-D_8X33yw.js";
...
const TabItem = class {
  ...
  render() {
    return h(Host, { key: "ec2996763856f0552f2c91e699b0978b91250462", role: "tab", class: this.tabItemClasses({
    ...
    } }, h("div", { key: "70de6371178e980f3fd7341bb585c48cb1f5678d", class: {
      circle: this.rounded,
      text: !this.rounded,
      selected: this.selected,
      disabled: this.disabled
    } }, h("slot", { key: "d968f6a4c86ee215c112de4bfee2db49d99c784e" })), h("div", { key: "638dd9696d19839e524051d30b1f2c53c123fe32", class: {
      counter: true,
      selected: this.selected,
...
const Tabs = class {
  ...
  render() {
    return h(Host, { key: "23b0e80f77242dd51de4dd3d03cda2784e98a75b", role: "tablist" }, this.showArrowPrevious && h("button", { key: "365bc17d38f5e24330d5be7a39d9ce426a26d40c", class: "arrow", onClick: () => this.move(this.scrollAmount, true), "aria-label": this.ariaLabelChevronLeftIconButton }, h("ix-icon", { key: "2cb82a76e3388332cd0072a2e03c82fbd440b39c", name: iconChevronLeftSmall })), h("div", { key: "7b44565a6de42874b3d172e262e5ce8ba68bf1fd", class: {
      "tab-items": true,
    ...
    } }, h("div", { key: "5ae852ddfeca79889a4c894f8f3ea5662bdeffac", class: "items-content" }, h("slot", { key: "2aa99221b0bb1d543364f133687ab27346ef0410" }))), this.showArrowNext && h("button", { key: "2e6e85065fc91cf519c54cd86eab59bfada163b7", class: "arrow right", onClick: () => this.move(-this.scrollAmount, true), "aria-label": this.ariaLabelChevronRightIconButton }, h("ix-icon", { key: "d967b24d26c5ca77fd9c4f8ae8d52476aebc0eac", name: iconChevronRightSmall })));
  }
  static get watchers() {
    return {
      "selected": [{
