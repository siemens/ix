import { M as Mixin, r as registerInstance, g as getElement, h, H as Host } from "./global-CtBDOAVb.js";
import { B as BaseIconButton } from "./base-icon-button-CHV7CtEL-SXdMQi9b.js";
import { g as getFallbackLabelFromIconName, b as a11yHostAttributes } from "./a11y-B5k8YVR0-BOSd6BQK.js";
import { D as DefaultMixins } from "./component-YJmg0LbX-Cdi_gd8D.js";
import { I as InheritAriaAttributesMixin } from "./inherit-aria-attributes.mixin-Ccj65H2q-Bb5sHhKS.js";
import "./base-button-BGDMz9xc-PuIypGYZ.js";
...
const IconButton = class extends Mixin(...DefaultMixins, InheritAriaAttributesMixin) {
  constructor(hostRef) {
    super();
  ...
  render() {
    ...
    if (ariaAttributes["aria-label"] === void 0) {
      ariaAttributes = {
        ...ariaAttributes,
    ...
    const baseButtonProps = {
      ...
      tabIndex: this.hostElement.hasAttribute("tabindex") ? this.hostElement.tabIndex : void 0
    };
    return h(Host, { key: "89c69e307fbb561ac385fbd52ebd53db9dab0abe", class: {
      ...this.getIconSizeClass(),
      disabled: this.disabled || this.loading
    }, tabIndex: this.disabled ? -1 : 0 }, h(BaseIconButton, { key: "8492e3c2dea2acee9afca3e2c95542158ba979f3", ...baseButtonProps }));
  }
...
const Spinner = class {
  ...
  render() {
    ...
    if (ariaProperties["aria-label"] === void 0) {
      ariaProperties["aria-label"] = "Loading";
    }
    ariaProperties.role = "status";
    ariaProperties["aria-busy"] = "true";
    return h(Host, { key: "0e8c9f1dc2ab7f31bcb78c7791806ad845da4d34", ...ariaProperties }, h("div", { key: "fd30c13a03a4fef8366b08047c91d90805aeab46", class: {
