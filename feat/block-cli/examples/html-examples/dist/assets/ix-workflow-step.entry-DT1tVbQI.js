...
const WorkflowStep = class {
  ...
  render() {
    ...
    return h(Host, { key: "f3910de29acc577df4566e5afaa6ef03a545fd97", class: { "host-vertical": this.vertical }, onClick: () => this.onStepClick() }, h("div", { key: "f3d81f04bf3025c59de8e6e9e1bab400c1001134", tabIndex: 0, class: {
      step: true,
      selected: this.selected,
      vertical: this.vertical,
      disabled: this.disabled,
      clickable: this.clickable && !this.disabled
    } }, h("div", { key: "1eacb7abd573a1a9fff76cdbf1c155c6f3773266", class: "wrapper" }, h("div", { key: "3e77846eb1ef7fc355884ef8949f9b84b708f01a", class: {
      line: true,
      selected: this.selected,
      [this.status]: true,
      [this.position]: true
    } }), h("div", { key: "c40b23c245d26e23e0a7b2715a85bb1107882d17", class: "iconWrapper" }, icons, h("slot", { key: "80cb7a575c31441135c3b04afe7c3098881c26ba", name: "custom-icon" }))), h("div", { key: "43260a12fc3ddd71c9678efe7b1619b50b39bce2", class: "text" }, h("slot", { key: "24bd3fb217538c60ae07dcbce6b972deaa2e52a1" }))));
  }
  static get watchers() {
    return {
      "selected": [{
