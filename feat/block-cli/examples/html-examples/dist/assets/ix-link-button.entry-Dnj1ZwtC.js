...
const LinkButton = class {
  ...
  render() {
    return h(Host, { key: "909b15be9d2a24157507ad60d7c13560b24595f4" }, h("a", { key: "2025d90efeeeb5fcfb5156e3a960f9a4a3670199", title: this.url, tabindex: "0", class: {
      "link-button": true,
      disabled: this.disabled
    }, href: this.disabled ? void 0 : this.url, target: this.target }, h("ix-icon", { key: "72bd2443e79a22e46f7ebc7a06a3e6bfbfb83356", class: "icon", name: iconChevronRightSmall, size: "16", "aria-hidden": "true" }), h("div", { key: "aaf370ffc413905499e99ae991f3665a7f269f34", class: {
      link: true,
      disabled: this.disabled
    } }, h("slot", { key: "929d9a0c6fee8b3d89322f4b44738afc1893620b" }))));
  }
};
