...
const TimePicker = class {
  ...
  render() {
    return h(Host, { key: "57f5e5895f338aa5d5311568b262ada3a3719bf5" }, h("ix-date-time-card", { key: "c3b7c5cfb0919128802278530fd64612f04caa83", embedded: this.embedded, timePickerAppearance: true, corners: this.corners, hasFooter: !this.dateTimePickerAppearance, hideHeader: this.hideHeader }, h("div", { key: "c5a202de6d745f0844dcb5623de995027aea2873", class: "header", slot: "header" }, h("ix-typography", { key: "af491faea33a652b8e422d9e15275405c41f0dae", format: "body" }, this.i18nHeader)), h("div", { key: "a108955bdcb3580bc6d1583cde3dbc1b97f30a71", class: "clock" }, this.timePickerDescriptors.map((descriptor, index) => h("div", { class: "flex" }, h("div", { class: { columns: true, hidden: descriptor.hidden } }, h("div", { class: "column-header", title: descriptor.header }, descriptor.header), h("div", { "data-element-list-id": descriptor.unit, class: "element-list", tabIndex: -1 }, descriptor.numberArray.map((number) => {
    ...
    } }, this.getColumnSeparator(index)))), this.timeRef && h("div", { key: "c74ceda331715afac9d80fb5f23ce8b1a2368ab8", class: "flex" }, h("div", { key: "d94108946341b718907db33e0cd161625d90e94d", class: "column-separator" }), h("div", { key: "64af40a364e6677ec1223e8361a87d773cb0cba5", class: "columns" }, h("div", { key: "449dbc26f5f9158a959411a2dcf624d3874e4739", class: "column-header", title: "AM/PM" }), h("div", { key: "ffc57696331802cb204ec2dfcd1b17c37ffd34e8", class: "element-list", tabIndex: -1 }, h("button", { key: "70f9c9869c1710642defe9d9a3d01f633dec6b58", "data-am-pm-id": "AM", class: {
      selected: this.timeRef === "AM",
      "element-container": true
    }, onClick: () => this.changeTimeReference("AM"), tabindex: "0", "aria-label": "AM" }, "AM"), h("button", { key: "a1de1100dadcaa8a8b4b6718489b0af45191c6df", "data-am-pm-id": "PM", class: {
      selected: this.timeRef === "PM",
      "element-container": true
    }, onClick: () => this.changeTimeReference("PM"), tabindex: "0", "aria-label": "PM" }, "PM"))))), h("div", { key: "7cc2e746c2fbe5810c9127c73d8efbc97093aa73", class: {
      footer: true,
      "footer--compact": this.timePickerDescriptors.length <= 2
    }, slot: "footer" }, h("ix-button", { key: "cbff9e80463e3f1e8aa67675dcde1dafaee8aad6", class: "confirm-button", onClick: () => {
      var _a;
