import { g as getElement, r as registerInstance, c as createEvent, h, H as Host } from "./global-B1t25MFd.js";
import { U as UploadFileState } from "./upload-file-state-BGzrnl_l-DLdhtkd7.js";
import { c as iconSuccess, b as iconError } from "./index-CwfZ4aN6-mXhHymhu.js";
...
const Upload = class {
  ...
  render() {
    ...
    return h(Host, { key: "3dc8c55066375bdbcf0ba8c9fcf1fc5f29110bc0", ...a11y, "aria-disabled": disabled }, h("div", { key: "fc33cab95fa973424d2b22e31a3652b56f513a9e", class: {
    ...
    }, onDragOver: (e) => this.fileOver(e), onDragLeave: () => this.fileLeave() }, this.renderUploadState(), h("div", { key: "70cab1f0dfea03aec6f60c77ed96d38715bab7f2" }, h("input", { key: "2c9a565023fc152660b8b8ca5f777fb3c1153369", "aria-label": ariaLabel, "aria-disabled": disabled, multiple: this.multiple, type: "file", class: "upload-browser", id: "upload-browser", tabindex: "-1", onChange: (e) => {
      this.fileChangeEvent(e);
    }, accept: this.accept, disabled }), h("ix-button", { key: "7bb6da02c5cd3396586328438a109624ac7d82e3", variant: "secondary", "aria-disabled": disabled, onClick: () => this.inputElement.click(), disabled }, this.i18nUploadFile))));
  }
};
