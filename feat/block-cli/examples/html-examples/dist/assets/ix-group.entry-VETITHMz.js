...
import { k as iconChevronUpSmall, e as iconChevronDownSmall } from "./index-DgUGsIlh-FNhczk6p.js";
...
const Group = class {
  ...
  render() {
    return h(Host, { key: "4ea07acff127d75027a314df7e836d8e15624d65" }, h("div", { key: "35a5f84ce780ced5f7ce0781a4794d7ff6a9e296", class: {
      "group-header": true,
      expand: this.expanded,
      selected: this.selected
    }, tabindex: "0" }, h("div", { key: "4ba8f7375bac149e3cd6a2dae47b7432bf32626e", class: "group-header-clickable", onClick: (e) => this.onHeaderClick(e) }, h("div", { key: "d3820ecc32980f2c051fc08c423f597061819560", class: {
      "group-header-selection-indicator": true,
      "group-header-selection-indicator-item-selected": this.itemSelected
    } }), h("div", { key: "a8d55e045d77ff75de44807a1e989ddc3a4c859a", class: "btn-expand-header" }, h("ix-icon", { key: "91795fa7eb2d2854942f8f4e5d48a44bc828ccad", "data-testid": "expand-collapsed-icon", class: {
      hidden: !this.showExpandCollapsedIcon
    }, name: this.expanded ? iconChevronUpSmall : iconChevronDownSmall, onClick: (event) => this.onExpandClick(event) })), h("div", { key: "54216a2300f11c1352c59fc79f1db044f39c2dcf", class: "group-header-content" }, this.header ? h("div", { class: "group-header-props-container" }, h("div", { class: "group-header-title" }, h("span", { title: this.header }, this.header)), h("div", { class: "group-subheader", title: this.subHeader }, this.subHeader)) : null, h("slot", { key: "3bb2bdcbc3d46756fd45afd8feb0737b09ead2d5", name: "header" }))), this.hasDropdown && h("ix-group-context-menu", { key: "b78aa9be98670077c766263d49917f6152cf4ee5" }, h("slot", { key: "c74a4be9574d9a70ebce8ec169d6754353611c6e", name: "dropdown" }))), h("div", { key: "2cafae1c14ced4367c5770fe96194cae00a35696", class: {
      "group-content": true
    } }, h("div", { key: "12e6d32595befbc30eabe6667f84df0d5d0f0a46", style: {
      display: this.expanded ? "contents" : "none"
    } }, h("slot", { key: "f2f48a06de1930eda83d951937be61ea5de69077", onSlotchange: () => {
      const slot = this.hostElement.shadowRoot?.querySelector("slot:not([name])");
      this.showExpandCollapsedIcon = hasSlottedElements(slot);
    } }), h("ix-group-item", { key: "8996fd7fdd040a586c6453cfc0fbd0d5fd0e5214", class: {
      footer: true,
      "footer-visible": this.footerVisible
    }, groupFooter: true, suppressSelection: true }, h("slot", { key: "881acb9c08ab5e63427e1a735266eeaf6c879e8f", name: "footer", onSlotchange: () => this.onSlotChange() })))));
  }
  static get watchers() {
    return {
      "selected": [{
