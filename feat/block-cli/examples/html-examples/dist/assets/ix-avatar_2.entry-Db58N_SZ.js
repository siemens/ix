import { M as Mixin, r as registerInstance, g as getElement, a as readTask, h, F as Fragment, H as Host, c as createEvent } from "./global-Dfa5QLOG.js";
...
import { c as closestElement, h as hasSlottedElements } from "./shadow-dom-BIe8Nw9M-C-dhDpq3.js";
import { P as PROXY_LISTITEM_ID_SUFFIX, u as updateFocusProxyList, F as FocusProxy } from "./focus-proxy-BgLEsVE2-Boc7uU3D.js";
...
const Avatar = class extends Mixin(...DefaultMixins, ComponentIdMixin, AriaActiveDescendantMixin) {
  ...
  render() {
    ...
    const Avatar2 = h(Fragment, null, h(AvatarImage, { image: this.image, initials: this.initials, a11yLabel: a11yLabel ?? this.a11yLabel }), !!tooltipText && h("ix-tooltip", { ref: this.tooltipRef, for: this.resolveTooltipTrigger(), "aria-hidden": a11yBoolean(ariaHidden), "aria-label": this.ariaLabelTooltip }, tooltipText));
...
const MenuAvatarItem = class {
  ...
  render() {
    return h("ix-dropdown-item", { key: "9e1cc85e687316dced00e9bae2726e2c6f23cf2d", ref: this.dropdownItemRef, icon: this.icon, label: this.label, onClick: (e) => this.itemClick.emit(e) });
  }
};
