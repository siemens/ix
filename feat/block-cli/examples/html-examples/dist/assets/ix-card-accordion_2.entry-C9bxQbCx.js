...
const CardAccordion = class {
  ...
  render() {
    return h(Host, { key: "ae47f421d545478e608e7138c5be50b4bee2d7f5", slot: "card-accordion", class: {
      [`variant-${this.variant}`]: true
    } }, h("button", { key: "5b19b6bcf6d00f6c02b168d71903810bf6f75d92", tabIndex: 0, class: { "expand-action": true, show: this.expandContent }, onClick: (event) => this.onExpandActionClick(event), role: "button", type: "button", "aria-expanded": this.expandContent, "aria-controls": getAriaControlsId(), "aria-label": this.ariaLabelExpandButton }, h("ix-icon", { key: "87ea8a37518c2ff285245ced1a40d749367d8d3a", name: iconChevronDownSmall, class: {
      "expand-icon": true,
      show: this.expandContent
    } })), h("div", { key: "7fd1eaadbd7b1f611c1c5ce57c4c0fd3d10293d4", class: {
      "expand-content": true,
      show: this.expandContent
    } }, h("div", { key: "4036efde4f99957106e1b4ac63c34c6fe4c6c764", class: "expand-content-inner" }, h("div", { key: "d51403413e62712291dde0058fa53fcc9531b174", class: "expand-content-body" }, h("slot", { key: "cbab42ce890e9b9679ec4724c58fd19b0e54f8f1" })), h("div", { key: "974166e0651273aa8541ca3e67dfa961a811a691", class: "expand-content-footer" }))));
  }
  static get watchers() {
    return {
      "collapse": [{
...
const CardHeader = class {
  ...
  render() {
    return h(Host, { key: "887b34783f5432813780d60515dd995b987a6109" }, h("slot", { key: "07f40642f321d1064181d232920c231b35637440" }), h("div", { key: "118a032d61626b1e6c36737bea9ce08a339b587e", class: "title-actions" }, h("slot", { key: "5af36b4326fa0c3cf00069afefdcbfa5cef3ebe7", name: "title-actions" })));
  }
};
