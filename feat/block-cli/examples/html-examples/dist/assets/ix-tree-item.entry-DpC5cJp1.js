...
const TreeItem = class {
  ...
  render() {
    ...
    return h(Host, { key: "d4442429762ec03685587f178c66e01e8daca45f", class: {
      selected: !!this.context?.isSelected,
      disabled: !!isDisabled
    } }, h("div", { key: "7200d70b32f34e931d8de28a4377238c768da01d", class: "icon-toggle-container" }, this.hasChildren ? h("ix-icon", { name: iconChevronRightSmall, size: "24", class: {
      ...
      e.stopPropagation();
      this.toggle.emit();
    }, "aria-label": this.ariaLabelChevronIcon ?? (this.context?.isExpanded ? "Collapse tree item" : "Expand tree item") }) : null), h("div", { key: "e8f6da36ff5ced9dbcb8acfc40ea50ba88936858", class: "tree-node-container", onClick: () => {
      if (isDisabled) {
        return;
      }
      this.itemClick.emit();
    } }, h("div", { key: "c4ac8371e877d9669f2ed8df44282620f0c52500", class: "tree-node-text" }, this.text), h("slot", { key: "94efb1d47bd1a086dd4b40bdef608c22b6926aee" })));
  }
};
