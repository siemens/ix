import { M as Mixin, r as registerInstance, g as getElement, h, H as Host } from "./global-F68Qu5y3.js";
import { B as BaseIconButton } from "./base-icon-button-DufFLJC--CTDNERTl.js";
...
import "./base-button-DZdtpLxn-pLLOE8Sr.js";
...
const IconButton = class extends Mixin(...DefaultMixins, InheritAriaAttributesMixin) {
  ...
  render() {
    ...
    return h(Host, { key: "2c354f35d606ca997d8dd83d2ff47941cafe14aa", class: {
      ...this.getIconSizeClass(),
      disabled: this.disabled || this.loading
    }, tabIndex: this.disabled ? -1 : 0 }, h(BaseIconButton, { key: "887b6d6c86ea9e01b9293f938f43565621243e49", ...baseButtonProps }));
  }
...
const Spinner = class {
  ...
  render() {
    ...
    return h(Host, { key: "c69ab9f6350574dfc592f226798bdbe1c23a40d5", ...ariaProperties }, h("div", { key: "b72de52eb5040c4b94eb61d24208d87285b85d41", class: {
