...
import { q as iconClock } from "./index-Cl7fhG1I-C77BCFLW.js";
import { D as DateTime } from "./luxon-wpz4A-OQ-B58AoryR.js";
import { f as createPickerValidityStateTracker, o as onEnterKeyChangeEmit, i as handleSubmitOnEnterKeydown, b as addDisposableChangesAndVisibilityObservers, c as adjustPaddingForStartAndEnd, S as SlotEnd, j as onInputBlurWithChange, a as SlotStart, g as emitPickerValidityState } from "./input.fc-BSbP1M60-GQ5TkkNA.js";
import { g as getTimePickerConstraintBounds, i as isWithinTimePickerConstraints } from "./time-picker-constraints-Bxf6UOLL-CUdaHz5_.js";
...
const TimeInput = class extends Mixin(...DefaultMixins, InputPickerMixin) {
  ...
  renderInput() {
    return h("div", { class: "input-wrapper" }, h(SlotStart, { slotStartRef: this.slotStartRef, onSlotChange: () => this.updatePaddings() }), h("input", { "aria-haspopup": "true", autoComplete: "off", class: {
      ...
      this.touched = true;
      this.emitValidityStateChangeIfChanged();
    }, onKeyDown: (event) => this.handleInputKeyDown(event) }), h(SlotEnd, { slotEndRef: this.slotEndRef, onSlotChange: () => this.updatePaddings() }, h("ix-icon-button", { tabindex: -1, ref: (ref) => ref.tabIndex = -1, "data-testid": "open-time-picker", class: { "time-icon-hidden": this.disabled || this.readonly }, variant: "subtle-tertiary", size: "16", icon: iconClock, onClick: (event) => this.onTimeIconClick(event), "aria-label": this.ariaLabelTimeToggleButton, "aria-expanded": this.show })));
  }
