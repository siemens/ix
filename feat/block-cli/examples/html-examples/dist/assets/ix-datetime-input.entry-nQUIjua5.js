...
import { d as iconCalendar } from "./index-Cl7fhG1I-C77BCFLW.js";
import { D as DateTime } from "./luxon-wpz4A-OQ-B58AoryR.js";
import { f as createPickerValidityStateTracker, i as handleSubmitOnEnterKeydown, g as emitPickerValidityState, b as addDisposableChangesAndVisibilityObservers, c as adjustPaddingForStartAndEnd, S as SlotEnd, k as onInputFocus, j as onInputBlurWithChange, a as SlotStart } from "./input.fc-BSbP1M60-GQ5TkkNA.js";
import { i as isWithinTimePickerConstraints, g as getTimePickerConstraintBounds } from "./time-picker-constraints-Bxf6UOLL-CUdaHz5_.js";
import { I as InputPickerMixin, h as handleIconClick, o as openDropdown, c as closeDropdown, a as createValidityState } from "./input-picker.mixin-Bo_sZpC4-CV4l0wpD.js";
...
import { a as createClassMutationObserver, g as getValidationText, H as HookValidationLifecycle } from "./validation-BT5aAuSO-B8Y62WGw.js";
import "./a11y-B5k8YVR0-BOSd6BQK.js";
import "./mutation-observer-CX81WQtk-DFcmhOTk.js";
import "./rwd.util-JJddxCCh-B7dE3uhl.js";
import "./index-DCm5XQXq-CfBgwJIC.js";
...
const DatetimeInput = class extends Mixin(...DefaultMixins, InputPickerMixin) {
  ...
  getTimeConstraintBoundsForDate(dateTime, minDateTime, maxDateTime) {
    ...
    const bounds = getTimePickerConstraintBounds(this.minTime, this.maxTime, this.timeOnlyFormat, dateTime.startOf("day"));
  ...
  renderInput() {
    ...
    }, onKeyDown: (event) => this.handleInputKeyDown(event) }), h(SlotEnd, { slotEndRef: this.slotEndRef, onSlotChange: () => this.updatePaddings() }, h("ix-icon-button", { "aria-label": this.ariaLabelCalendarButton, tabindex: -1, class: { "calendar-hidden": this.disabled || this.readonly }, variant: "subtle-tertiary", icon: iconCalendar, size: "16", onClick: (event) => this.onCalendarClick(event) })));
  }
  render() {
    const invalidText = getValidationText(this.isInputInvalid, this.invalidText, this.i18nErrorDateTimeUnparsable);
    return h(Host, { key: "71e43042e770959dbc22198d9444e9ea7c6f17fc", class: {
      disabled: this.disabled,
      readonly: this.readonly
    } }, h("ix-field-wrapper", { key: "3da77d1b86370fd5cd75ecfb4ef3b23694ade8cb", controlRef: this.inputElementRef, helperText: this.helperText, infoText: this.infoText, invalidText, isInfo: this.isInfo, isInvalid: this.isInvalid, isValid: this.isValid, isWarning: this.isWarning, label: this.label, required: this.required, showTextAsTooltip: this.showTextAsTooltip, validText: this.validText, warningText: this.warningText }, this.renderInput()), h("ix-dropdown", { key: "3a5066da2b6fbd59a90ffe8a818b26a4a0631fa0", class: "datetime-dropdown", closeBehavior: "outside", "data-testid": "datetime-dropdown", enableTopLayer: this.enableTopLayer, ref: this.dropdownElementRef, show: this.show, suppressOverflowBehavior: true, trigger: this.inputElementRef.waitForCurrent(), onShowChanged: (event) => {
