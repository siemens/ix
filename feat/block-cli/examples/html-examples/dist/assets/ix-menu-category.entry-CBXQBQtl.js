...
const MenuCategory = class extends Mixin(...DefaultMixins) {
  ...
  render() {
    ...
    }, "aria-hidden": "true" }))), h("div", { key: "b3230021f091e9ab12b73f3ead4cfce72c8d1c10", ref: (ref) => this.menuItemsContainer = ref, class: {
      "menu-items": true,
      "menu-items--expanded": this.showItems,
      "menu-items--collapsed": !this.showItems
    }, role: "menu", onKeyDown: (e) => this.onMenuItemsKeyDown(e) }, this.showItems ? h("slot", null) : null), h("ix-dropdown", { key: "99108530243979a1bc9d8ae36c3f97d55832f1ce", ref: this.dropdownRef, hostRole: "menu", "aria-label": this.label, closeBehavior: "both", show: this.showDropdown, onShowChange: ({ detail: dropdownShow }) => {
      if (dropdownShow) {
        return;
      }
    ...
    } }, h("ix-dropdown-item", { key: "fd5dff6125396a22292c5bcb1a04f0e1c591e404", class: "category-dropdown-header", tabindex: -1, "aria-hidden": "true" }, h("ix-typography", { key: "705973f0053d1a4e7e2759c521b84ba5d4ffc536", format: "label", bold: true, textColor: "std" }, this.label)), h("ix-divider", { key: "697e53fc9f7d39e5c63d6cbb2bc2235e7c3ad352" }), h("slot", { key: "f8a5c59e2cded3d63acdc028b9ab8d859da644c2" })));
  }
