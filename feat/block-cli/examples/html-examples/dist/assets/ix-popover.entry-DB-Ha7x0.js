...
const Popover = class extends Mixin(...DefaultMixins, InheritAriaAttributesMixin, ComponentIdMixin) {
  ...
  render() {
    return h(Host, { key: "95dbf143e674bcb0cd976c114a892201c42af6f4", class: { visible: this.show }, "data-ix-popover": this.popoverPanelId }, h("dialog", { key: "d674675e90ef6288047117e5058c18dd8233378d", ref: this.dialogRef, id: this.popoverPanelId, class: "dialog", popover: "manual", inert: !this.show, ...this.inheritAriaAttributes, role: this.inheritAriaAttributes["role"] ?? "dialog", onMouseEnter: () => this.onDialogMouseEnter(), onMouseLeave: () => this.onDialogMouseLeave() }, h("div", { key: "b0a7901412a53cff56518a7776b58ba392ba7b21", class: "popover-container" }, h("div", { key: "1226cfeb2110a8d628e50404d72d4ecd0c4f3a8b", class: "popover-body" }, h("slot", { key: "6c5701b2a20896db8fccf4edd67d9c65c1a81d36" })), this.hasSpike ? h("div", { class: "spike" }) : null)));
  }
  static get watchers() {
    return {
      "role": [{
