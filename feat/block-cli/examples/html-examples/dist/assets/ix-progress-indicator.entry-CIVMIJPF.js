import { r as registerInstance, g as getElement, h, F as Fragment, H as Host } from "./global-Dfa5QLOG.js";
import { K as iconCirclePause, c as iconSuccess, a as iconWarning, i as iconInfo, b as iconError } from "./index-DLhpBBEI-C3tPjcQ4.js";
...
const ProgressIndicator = class {
  ...
  render() {
    ...
    return h(Host, { key: "70cf803ff5bd34231857b724786dd1042e7d3bd5", class: {
      linear: this.type === "linear",
      circular: this.type === "circular"
    }, tabIndex: -1 }, h("div", { key: "0f2c4d1f2a8704612723c3432518a8c93d14cfa3", class: {
