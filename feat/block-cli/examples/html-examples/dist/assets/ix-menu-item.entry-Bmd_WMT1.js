...
import { T as iconDocument } from "./index-BBzEV-f4-ChQfUIyc.js";
...
const MenuItem = class {
  ...
  render() {
    ...
    const menuContent = [
      this.icon && h("ix-icon", { key: "77989079a486c5aeb3116f7fc734e6197f5b39ef", class: "tab-icon", name: this.icon, "aria-hidden": "true" }),
      this.notifications ? h("div", { class: "notification" }, h("div", { class: "pill" }, this.notifications)) : null,
      h("span", { key: "167fd3896eddbd0dccfaeb98b3fa3bd7644a4b06", id: this.internalItemId, class: "tab-text text-default" }, this.label, h("slot", { key: "1a72a0c542ef756b67392dbf222c9dfc6de4846e" }))
    ];
    return h(Host, Object.assign({ key: "a07642092c64e8302e05ed906854bba172a8f98c", class: {
      disabled: this.disabled,
      "home-tab": this.home,
      "bottom-tab": this.bottom,
      active: this.active,
      "tab-nested": this.isHostedInsideCategory
    }, "aria-disabled": this.disabled ? "true" : null }, extendedAttributes), this.href ? h("a", Object.assign({}, commonAttributes, { href: this.disabled ? void 0 : this.href, target: this.target, rel: this.rel, role: "button", ref: this.buttonRef, onClick: (e) => {
      if (this.disabled) {
        e.preventDefault();
        e.stopPropagation();
      }
    } }), menuContent) : h("button", Object.assign({}, commonAttributes, { ref: this.buttonRef }), menuContent), h("ix-tooltip", { key: "c9a96c24f74865dd0d387dd986ad20459eaca9b2", for: this.buttonRef.waitForCurrent(), placement: "right", showDelay: 1e3, interactive: false, "aria-hidden": a11yBoolean(this.ariaHiddenTooltip), "aria-labelledby": this.internalItemId }, this.tooltip));
  }
  get hostElement() {
