...
import { P as iconNavigationLeft, Q as iconNavigationRight, f as iconApps, R as iconCogwheel, S as iconLightDark, i as iconInfo } from "./index-BBzEV-f4-ChQfUIyc.js";
import { a as animate } from "./anime.esm-DhE1t8Qh-cS95-bBh.js";
import { A as Animation } from "./animation-C5MWUgDN-BXCJNYHu.js";
import { s as showAppSwitch } from "./index-bj9mw7qP-BzLqv619.js";
...
const Menu = class {
  ...
  render() {
    ...
    return h(Host, { key: "12e12584b5a3689bb6b38220544b13836f950d57", class: {
      expanded: this.expand,
      [`breakpoint-${this.breakpoint}`]: true
    }, slot: "menu" }, h("nav", { key: "c239809b94d00a58cda5c4cbccf69403ca485703", "aria-label": this.applicationName, class: {
      menu: true,
      expanded: this.expand
    } }, h("div", { key: "a2d7e2be5ee53afcd5bf0204634eede03dc97ff0", class: "menu-buttons" }, this.breakpoint !== "sm" && h("ix-menu-expand-icon", { key: "6449e95d957a62ea75520ae82266bc7bb5eabe6e", breakpoint: this.breakpoint, expanded: this.expand, pinned: this.pinned, class: "menu-expand-icon", onClick: async () => this.toggleMenu(), "data-testid": "expand-collapse-menu" }), this.breakpoint === "sm" && ((_a = this.applicationLayoutContext) === null || _a === void 0 ? void 0 : _a.appSwitchConfig) && h("ix-icon-button", { key: "09e2947feac4324c9ddcd1fe013ab65afbc5fc2f", onClick: () => {
      this.showAppSwitch();
    }, icon: iconApps, variant: "subtle-tertiary" })), h("div", { key: "9988dee201da656481e81abf59ea42b7781f6c23", id: "menu-tabs", style: {
      display: "contents"
    }, onClick: (e) => this.onMenuItemsClick(e) }, h("div", { key: "dd5ce6b2a83fe76148c8501839785ff734a1c878", class: "tabs-shadow-container" }, h("div", { key: "d1a60303c9abe5f2355ad51ebac95e4b91e2e107", class: {
      "tabs--shadow": true,
      "tabs--shadow-top": true,
      "tabs--shadow--show": this.itemsScrollShadowTop
    } }), h("div", { key: "8ac20aa0ad7d20db32267d55d0f32b2073f62ecc", class: {
      tabs: true,
      "show-scrollbar": this.expand
    }, onScroll: () => this.handleOverflowIndicator() }, h("div", { key: "1f857761f588572ddc48f96f4b453371fac0d960", class: "menu-avatar" }, h("slot", { key: "5fbb3aa39e59a5f64f64647f699b1fb992917ddb", name: "ix-menu-avatar" })), h("slot", { key: "5a7843add43bf9b632c1d54c3b7f7b5150895ecf", name: "home" }), this.breakpoint !== "sm" || !this.isHiddenFromViewport() ? h("slot", null) : null), h("div", { key: "5019334f72ebb6c1aa5082a673ec036161f57a84", class: {
      "tabs--shadow": true,
      "tabs--shadow-bottom": true,
      "tabs--shadow--show": this.itemsScrollShadowBottom
    } }))), h("div", { key: "06f09b984c9639f5ba314b1d4dd3a8b75c083160", class: "bottom-tab-divider" }), this.settings ? h("ix-menu-item", { disabled: this.isHiddenFromViewport(), id: "settings", class: {
      "internal-tab": true,
      "bottom-tab": true,
      active: this.showSettings
    }, icon: iconCogwheel, onClick: async () => this.toggleSettings(!this.showSettings), label: this.i18nSettings, "aria-expanded": this.showSettings.toString(), "aria-controls": "menu-overlay" }) : null, this.enableToggleTheme ? h("ix-menu-item", { disabled: this.isHiddenFromViewport(), id: "toggleTheme", onClick: () => themeSwitcher.toggleMode(), class: "internal-tab bottom-tab", icon: iconLightDark, label: this.i18nToggleTheme, role: "switch", "aria-checked": this.isDarkMode.toString() }) : null, h("div", { key: "e62f91741982b159575a8e48d756fa2e03f9db5d", onClick: (e) => this.onMenuItemsClick(e) }, h("slot", { key: "560e09e7575f55947a8fb0f965846922c035c4e6", name: "bottom" })), h("div", { key: "e87638f0b62e95f578f7e98e7d74bb264bdf0d1d", id: "popover-area" }), this.enableMapExpand || ((_b = this.applicationLayoutContext) === null || _b === void 0 ? void 0 : _b.sidebar) ? h("ix-menu-item", { disabled: this.isHiddenFromViewport(), id: "menu-collapse", onClick: () => this.sidebarToggle(), class: "internal-tab bottom-tab", icon: `${this.getCollapseIcon()}`, label: this.getCollapseText() }) : null, this.about ? h("ix-menu-item", { disabled: this.isHiddenFromViewport(), id: "aboutAndLegal", class: {
      "internal-tab": true,
      "bottom-tab": true,
      active: this.showAbout
    }, icon: iconInfo, onClick: async () => this.toggleAbout(!this.showAbout), label: this.i18nLegal, "aria-expanded": this.showAbout.toString(), "aria-controls": "menu-overlay" }) : null), h("section", { key: "0418fe0757a2afb8914a1377651facec4e88f3f3", id: "menu-overlay", "aria-label": overlayLabel, class: {
      "menu-overlay": true,
      ...
      this.checkTransition();
    } }, h("div", { key: "b46540b165c7147ffeb3c9ed0ff282b59965fccf", class: "menu-overlay-container" }, this.showSettings ? h("slot", { name: "ix-menu-settings" }) : null), h("div", { key: "c2cbaa2cdcca29f2552e258bc86893685bf923de", class: "menu-overlay-container" }, this.showAbout ? h("slot", { name: "ix-menu-about" }) : null)));
  }
  get hostElement() {
