import { r as registerInstance, c as createEvent, g as getElement, h, H as Host } from "./global-B1t25MFd.js";
import { f as iconApps, x as iconCogwheel, y as iconLightDark, i as iconInfo } from "./index-CwfZ4aN6-mXhHymhu.js";
import { m as modulesExports } from "./index-CGJC9ptU-OtA7BVGg.js";
import { A as Animation } from "./animation-DNIQ2C1K-BYpQk_MF.js";
import { s as showAppSwitch } from "./index-DdswAEHW-Dq7JPGv3.js";
...
const Menu = class {
  ...
  render() {
    ...
    return h(Host, { key: "2cf84c97b6190ada72614397bdfb8edf9cec5389", class: {
      expanded: this.expand,
      [`breakpoint-${this.breakpoint}`]: true
    }, slot: "menu" }, h("nav", { key: "cb3bcb99349da705b94693d5acf1522516d14c7f", "aria-label": this.applicationName, class: {
      menu: true,
      expanded: this.expand
    } }, h("div", { key: "f16c293c444c8a842b3cb10eda78b1e64481297e", class: "menu-buttons" }, this.breakpoint !== "sm" && h("ix-menu-expand-icon", { key: "c0ac18b587cb6124bdd11e24b4da6829ebb77945", breakpoint: this.breakpoint, expanded: this.expand, "i18n-expand": this.i18nExpand, "i18n-collapse": this.i18nCollapse, pinned: this.pinned, class: "menu-expand-icon", onClick: async () => this.toggleMenu(), "data-testid": "expand-collapse-menu" }), this.breakpoint === "sm" && this.applicationLayoutContext?.appSwitchConfig && h("ix-icon-button", { key: "dafb23f2747eb799388c0636965a65b680612b90", onClick: () => {
      this.showAppSwitch();
    }, icon: iconApps, variant: "subtle-tertiary" })), h("div", { key: "369295cf2be1c9ffd7198a66708288f43cc2f316", id: "menu-tabs", style: {
      display: "contents"
    }, onClick: (e) => this.onMenuItemsClick(e) }, h("div", { key: "0711190d431b7674be404e0b6800b6fca6a5794f", class: "tabs-shadow-container" }, h("div", { key: "ad67564fdff9360e331a59feaec6f5e8c140633f", class: {
      "tabs--shadow": true,
      "tabs--shadow-top": true,
      "tabs--shadow--show": this.itemsScrollShadowTop
    } }), h("div", { key: "141cec70ee1c98c248121e567d2944b6ffb4243a", class: {
      tabs: true,
      "show-scrollbar": this.expand
    }, onScroll: () => this.handleOverflowIndicator() }, h("div", { key: "51ecc035fd00a4132690001ab1ae76514f0b024f", class: "menu-avatar" }, h("slot", { key: "a25856be5b398fb5725ada9e4b587e9448d4af9f", name: "ix-menu-avatar" })), h("slot", { key: "bc8ef2d95c645a9fce597831b4150301cc646541", name: "home" }), this.breakpoint !== "sm" || !this.isHiddenFromViewport() ? h("slot", null) : null), h("div", { key: "806c11de40f34fa32257d3044561351c0c1b3842", class: {
      "tabs--shadow": true,
      "tabs--shadow-bottom": true,
      "tabs--shadow--show": this.itemsScrollShadowBottom
    } }))), h("div", { key: "8a08fe8478c1552f74f637802c335989f80b3257", class: "bottom-tab-divider" }), this.settings ? h("ix-menu-item", { disabled: this.isHiddenFromViewport(), id: "settings", class: {
      "internal-tab": true,
      "bottom-tab": true,
      active: this.showSettings
    }, icon: iconCogwheel, onClick: async () => this.toggleSettings(!this.showSettings), label: this.i18nSettings, "aria-expanded": this.showSettings.toString(), "aria-controls": "menu-overlay" }) : null, this.enableToggleTheme ? h("ix-menu-item", { disabled: this.isHiddenFromViewport(), id: "toggleTheme", onClick: () => themeSwitcher.toggleMode(), class: "internal-tab bottom-tab", icon: iconLightDark, label: this.i18nToggleTheme, role: "switch", "aria-checked": this.isDarkMode.toString() }) : null, h("div", { key: "75b3618a3c538365c46fa94af2b9ee3911480943", onClick: (e) => this.onMenuItemsClick(e) }, h("slot", { key: "a6dae219dd06ed4736f22b0e31f488d93c70cee5", name: "bottom" })), h("div", { key: "9bc620d762e6798c2db6e58cea3af3c97ee4458f", id: "popover-area" }), this.about ? h("ix-menu-item", { disabled: this.isHiddenFromViewport(), id: "aboutAndLegal", class: {
      "internal-tab": true,
      "bottom-tab": true,
      active: this.showAbout
    }, icon: iconInfo, onClick: async () => this.toggleAbout(!this.showAbout), label: this.i18nLegal, "aria-expanded": this.showAbout.toString(), "aria-controls": "menu-overlay" }) : null), h("section", { key: "34349312ce2aad4a7873a42225e8e29a9a47a3ee", id: "menu-overlay", "aria-label": overlayLabel, class: {
      "menu-overlay": true,
      ...
      this.checkTransition();
    } }, h("div", { key: "93ca8552fa6a4a40e4662714a8e3c668a03b7bda", class: "menu-overlay-container" }, this.showSettings ? h("slot", { name: "ix-menu-settings" }) : null), h("div", { key: "3d4d99dc08154ea33282e6da083bcb6bf9bfc17e", class: "menu-overlay-container" }, this.showAbout ? h("slot", { name: "ix-menu-about" }) : null)));
  }
  static get watchers() {
    return {
      "expand": [{
