...
const Pill = class extends Mixin(...DefaultMixins) {
  ...
  render() {
    ...
    return h(Host, { key: "3540ab0ac92514f4ec06f63a91b1ecabcf6ac9d3", style: this.variant === "custom" ? {
      "--ix-icon-button-color": this.pillColor
    } : {}, class: {
      "align-left": this.alignLeft
    }, role: hostRole }, h("div", { key: "8c299b156a0951a743607905be9f6f0a941684c5", ref: this.containerElementRef, style: { ...customStyle }, class: {
      container: true,
    ...
    } }, this.icon && h("ix-icon", { key: "a5c91592729fde1333ae83c3b129347a9bc6ceab", class: {
      "with-icon": true
    }, name: this.icon, size: "16", "aria-label": this.ariaLabelIcon, "aria-hidden": a11yBoolean(iconIsDecorative) }), h("span", { key: "e85ff7dfc8632c404578a1adc34b2908f01e0d19", class: "slot-container" }, h("slot", { key: "d9a6b4617bbadc5130084fd64bb376fdb2282df0", onSlotchange: () => this.checkIfContentAvailable() }))), this.getTooltip());
  }
};
Pill.style = pillCss();
export {
