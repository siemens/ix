...
const EventListItem = class {
  ...
  render() {
    ...
    return h(Host, { key: "afada37ac3a4e7ec5f2366bbb587408d9d1cf9d0", class: {
      disabled: this.disabled,
      [`event-list-item-${this.variant}`]: true
    } }, h("div", { key: "56095d36962fcf23c9d4152c1b4c8bfcb9e700b0", role: "listitem", "aria-disabled": a11yBoolean(this.disabled), class: {
      "event-list-item": true,
      selected: this.selected,
      disabled: this.disabled
    } }, h("div", { key: "2ee56d88327c322ed779dcd4161a596c9f7b6c08", class: `indicator ${!this.itemColor ? "indicator-empty" : ""}`, style: {
      "background-color": this.itemColor ? color : "inherit",
      opacity: `${this.disabled ? 0.4 : 1}`
    } }), h("div", { key: "302e2a811978353b5eecb038cb9d6fc333f1762e", class: "event-list-item-container" }, h("div", { key: "f6e26e658636f49a4ba76a367760952e034cf7bc", class: "event-content" }, h("slot", { key: "9d98ffce75e800a605e7879fa5c9ca1c3ec558b8" })), this.chevron && h("ix-icon", { key: "fef48c3d836f6009c04cb68a66a47adb3895e1d1", name: iconChevronRight, size: "16", class: "chevron-icon", "aria-hidden": "true" }))));
  }
};
