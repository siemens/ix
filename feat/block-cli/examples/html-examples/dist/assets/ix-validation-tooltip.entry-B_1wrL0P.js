...
const ValidationTooltip = class {
  ...
  render() {
    return h(Host, { key: "c681de8dcc953481bb7d6c6326317c8cb944a94a" }, h("slot", { key: "2ff37dc28335aaeffcce9b47b402ef5bac46a0b9" }), h("div", { key: "541cabac7c6acc268d29bcdf8516364bdaa6a794", role: "tooltip", style: {
      display: "none",
      position: "fixed",
      top: "0",
      left: "0",
      transform: `translate(${Math.round(this.tooltipPosition?.x ?? 0)}px,${Math.round(this.tooltipPosition?.y ?? 0)}px)`
    }, class: "validation-tooltip text-default" }, this.message, h("slot", { key: "8214829fbf9c8c95eb4706e1f80bd8e7ad8b369a", name: "tooltip-message" }), h("div", { key: "ebb61d57d34408c3eb273617628a7a2ba9923469", id: "arrow" })));
  }
  static get watchers() {
    return {
      "isInputValid": [{
