...
const BaseButton = (props, children) => {
  ...
  return h("button", { ...commonAttributes, "aria-disabled": a11yBoolean(props.disabled), disabled: props.disabled || props.loading, onClick: (e) => handleOnClick(e, props), type: props.type }, buttonContent);
};
export {
  BaseButton as B,
