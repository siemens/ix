import { a as registerInstance, g as getElement, h, H as Host, M as Mixin } from "./global-DX2OdaCL.js";
...
import { a as createClassMutationObserver } from "./validation-BT5aAuSO-B8Y62WGw.js";
import { r as resolveTextFromValidationState, h as hasAnyText, H as HelperText$1 } from "./helper-text-util-AEl-1QU6-B6f_WEYI.js";
...
const FormFieldLabel = class {
  ...
  render() {
    return h(Host, { key: "b3815ffb3e2a9cee5587809634a57612945ae06b", onClick: () => this.focusOnClick(), class: {
      "text-overflow-wrap": this.textOverflow === "wrap",
      "text-overflow-no-wrap": this.textOverflow === "no-wrap"
    } }, h("label", { key: "f2d0e6bd0bb4c2ced6258db9e6745eab602194dd", htmlFor: this.htmlFor, ...this.a11yAttributes, ref: this.labelRef }, h("ix-typography", { key: "45fe0db89d6475f6058c2f2b22d8d5eb4cef425c", textColor: this.isInvalid ? "alarm" : "soft", format: "label" }, h("slot", { key: "01d20fec2abdb6f12647d68c41ed37f1bee83c31" }), this.required && h("span", { key: "485a5f67698962e15a22cfee476dd26507c765fa" }, "*"))));
  }
  static get watchers() {
    return {
      "isInvalid": [{
...
const FieldWrapper = class extends Mixin(...DefaultMixins, ComponentIdMixin) {
  ...
  render() {
    ...
    return h(Host, { key: "a4f662cd63da96de568d5e07e0f6a45c94bcd584", ...additionalAriaAttributes }, this.label && h("div", { key: "1346c736edc70179f2059775f374291769a421f7", class: "field-top" }, h("ix-field-label", { key: "618c08136bad64dad9db510093823d733515a73a", required: this.required, controlRef: this.controlRef, isInvalid: this.isInvalid, ariaHidden: true }, this.label)), h("div", { key: "2828a6fb240b15aea2cc70bf7ddef77db0075fcb", class: {
      "slot-wrapper": true
    }, ref: this.slotRef }, h("slot", { key: "d778378932be23d0a791b3669960fa649a4ec5c1" })), h("div", { key: "ed43976cd734aa9875e2c93e91d2eefd26335c37", class: "field-bottom" }, !this.showTextAsTooltip && h(HelperText$1, { key: "16431fc816256f1725b79724cd8f6074859238a8", ...textOptions }), h("div", { key: "add4cb3093d060e453ceedf72a77cdbe7d7384fa", class: "bottom-right" }, h("slot", { key: "db90b01c037ea3821cfa651e2e1b37c2d5be5056", name: "bottom-right" }))), this.showTextAsTooltip === true && hasAnyText(textOptions) && h("ix-tooltip", { key: "5e26bbe7f3a8915b7066701158a5db6eb83466f6", for: this.slotRef.waitForCurrent(), showDelay: 500, placement: "bottom" }, h(HelperText$1, { key: "8ba126d47085141f329a2c691c44bfb5a61f099a", ...textOptions })));
  }
  static get watchers() {
    return {
      "label": [{
