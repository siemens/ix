...
const MenuItem = class {
  ...
  render() {
    ...
    const menuContent = [
      this.icon && h("ix-icon", { key: "214065891c3da44e16f41f2366791c4958057efe", class: "tab-icon", name: this.icon, "aria-hidden": "true" }),
      this.notifications ? h("div", { class: "notification" }, h("div", { class: "pill" }, this.notifications)) : null,
      h("span", { key: "8cd63e85e9420a28e1c403115e1a21936512fb6f", id: this.internalItemId, class: "tab-text text-default" }, this.label, h("slot", { key: "24a5bdc2d3bee55d7dbab9774aebe24e001c1e00" }))
    ];
    return h(Host, { key: "903da4f162006592126a2a54f2562aa5f5d745cd", class: {
