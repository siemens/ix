...
const MenuAbout = class {
  ...
  render() {
    return h(Host, { key: "a06dda14ad8eba86d9720d81a1ec9e943f08c0bd", slot: "ix-menu-about", class: {
      show: this.show,
      ["legacy-tabs"]: !this.suppressLegacyTabs
    } }, h("div", { key: "4c2bdb619642da7dc06b7eb76f34ed195bf4f623", class: "about-header" }, h("h2", { key: "791cbc94c126c0315cdc8330e8043f8eecafffd9", class: "text-h2" }, this.label), h("ix-icon-button", { key: "5e2f95294dd0a8c2c4f1b4569bc9f794c4a6e123", variant: "tertiary", size: "24", icon: iconClose, iconColor: "color-soft-text", "aria-label": this.ariaLabelCloseButton, onClick: (e) => this.close.emit({
      name: "ix-menu-about",
      nativeEvent: e
