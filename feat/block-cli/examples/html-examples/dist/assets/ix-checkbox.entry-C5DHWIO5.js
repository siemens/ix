import { r as registerInstance, c as createEvent, g as getElement, h, F as Fragment, H as Host } from "./global-J1r-v9CX.js";
...
const Checkbox = class {
  ...
  render() {
    return h(Host, { key: "d057fa172f7a8d3b5b425506b4e89b23234484a7", "aria-checked": a11yBoolean(this.checked), "aria-disabled": a11yBoolean(this.disabled), role: "checkbox", class: {
      disabled: this.disabled,
      checked: this.checked,
      indeterminate: this.indeterminate,
      "label-less": this.isLabelLess
    }, onFocus: () => this.touched = true, onBlur: () => this.ixBlur.emit() }, h("label", { key: "eb5beed2eb18887747b9bdc95d9b89c8fc43e857" }, h("input", { key: "ed1f8a10753948b4d66846b567d651f84ec32aba", "aria-checked": a11yBoolean(this.checked), required: this.required, disabled: this.disabled, checked: this.checked, ref: this.inputRef, type: "checkbox", onChange: () => this.setCheckedState(!this.checked) }), h("div", { key: "3272123ee89e5e493b0d204cdb7173b1d9c786e5", class: "checkbox-button" }, h("button", { key: "04f8ec99ddf0ae9ea1aacf339e9e1f31d040d6ca", disabled: this.disabled, class: {
      checked: this.checked
    }, onClick: () => this.setCheckedState(!this.checked) }, this.renderCheckmark())), h("ix-typography", { key: "99aeed47a9a431333dcf12e2207f2058ac795eb0", format: "label", textColor: this.disabled ? "weak" : "std" }, this.label, h("slot", { key: "7e83754fc0c24e773ff2c2aba5d3e2ff1adfa5e6", onSlotchange: () => this.updateDefaultSlotElements(), ref: (element) => this.defaultSlotElement = element }))));
  }
