...
const CardAccordion = class {
  ...
  render() {
    return h(Host, { key: "513f3552ac1c8a5ddf060ff6820aa02f98fd4bba", slot: "card-accordion", class: {
      [`variant-${this.variant}`]: true
    } }, h("button", { key: "2e0e166f5c2ba002e8c2bca0f702d7ac73362bad", tabIndex: 0, class: { "expand-action": true, show: this.expandContent }, onClick: (event) => this.onExpandActionClick(event), role: "button", type: "button", "aria-expanded": this.expandContent, "aria-controls": getAriaControlsId(), "aria-label": this.ariaLabelExpandButton }, h("ix-icon", { key: "9101985fc7068c96e05f76778f65a9aae531f7b7", name: iconChevronDownSmall, class: {
      "expand-icon": true,
      show: this.expandContent
    } })), h("div", { key: "386aa725bdf74d0fa4da7a9bafdbe66219d6c0d1", class: {
      "expand-content": true,
      show: this.expandContent
    } }, h("div", { key: "d720b8b17cb1d07f3666a18ec0d34921a57d43f6", class: "expand-content-inner" }, h("div", { key: "66df4ccb6fac9944420da47a08dec5627d48551f", class: "expand-content-body" }, h("slot", { key: "5fe91570d13d00afa0589ab3b08c128e705baea1" })), h("div", { key: "f1356470b4983b9512065a2522c786d5c0977bed", class: "expand-content-footer" }))));
  }
  static get watchers() {
    return {
      "collapse": [{
...
const CardHeader = class {
  ...
  render() {
    return h(Host, { key: "1f12063ecacbbe2aef0108d2000559dfe77f9cc3" }, h("slot", { key: "5e9e9dbae13374b86a455dca409a6de9735d3adb" }), h("div", { key: "1b900ab8a2e23aca2257cd6bc324442410e8e7ab", class: "title-actions" }, h("slot", { key: "6069257ba4b26b96d671c84c4694cb90b99f8362", name: "title-actions" })));
  }
};
