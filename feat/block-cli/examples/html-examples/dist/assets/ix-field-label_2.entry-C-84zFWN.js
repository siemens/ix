import { r as registerInstance, g as getElement, h, H as Host, M as Mixin } from "./global-CtBDOAVb.js";
...
import { r as resolveTextFromValidationState, h as hasAnyText, H as HelperText$1 } from "./helper-text-util-DhSxH3e6-CoRGG_MG.js";
...
const FormFieldLabel = class {
  ...
  render() {
    return h(Host, { key: "8163159e71da96351d21a99a4e537b5da2263c72", onClick: () => this.focusOnClick(), class: {
      "text-overflow-wrap": this.textOverflow === "wrap",
      "text-overflow-no-wrap": this.textOverflow === "no-wrap"
    } }, h("label", { key: "760205f7c883d9443023cee05b6089b93e47bbcf", htmlFor: this.htmlFor, ...this.a11yAttributes, ref: this.labelRef }, h("ix-typography", { key: "a32dde33c922e1c42d6fc762278f107a8426e1a0", textColor: this.isInvalid ? "alarm" : "soft", format: "label" }, h("slot", { key: "f1653c499f7618497ed13bfe46538faf4fdc1ca5" }), this.required && h("span", { key: "6d49568df82fd3795506d2fdcd70160985e4b50e" }, "*"))));
  }
  static get watchers() {
    return {
      "isInvalid": [{
