import { r as registerInstance, f as forceUpdate, h, H as Host, c as createEvent, F as Fragment, g as getElement } from "./global-DXu0UsM0.js";
import { m as matchBreakpoint } from "./breakpoints-D_Hmobxf-DBbixPq4.js";
import { w as iconChevronRightSmall, D as iconChevronLeftSmall, O as iconSingleCheck } from "./index-8HpPmDK_-DinFJk0z.js";
import { D as DateTime, I as Info } from "./datetime-bDicGJUN-GV0o9Ayg.js";
...
const DatePicker = class {
  ...
  render() {
    return h(Host, { key: "25ff0855fadc808d957d9ad4ff7727b7626c162c" }, h("ix-date-time-card", { key: "60edc6a47c1eee6920e82eb7a8f1dd31232b79f1", corners: this.corners, embedded: this.embedded }, h("div", { key: "8803196803751cdcb1d2d88f5173ae4096c296ce", class: "header", slot: "header" }, h("ix-icon-button", { key: "395c805efdaa838e25d850d0352cb0270035a4af", onClick: () => this.changeToAdjacentMonth(-1), icon: iconChevronLeftSmall, variant: "tertiary", class: "arrows", "aria-label": this.ariaLabelPreviousMonthButton }), h("div", { key: "15882b0cd88356417bae57b669b1f4774f771288", class: "selector" }, h("ix-button", { key: "3f5676ff331dd9a086b24f59c8fa1534c9d1bd55", variant: "tertiary", ref: this.dropdownButtonRef, "data-testid": "year-month-button" }, h("span", { key: "935fc22b61eab55d92fb13bf8a1ff36f0eb53ec0", class: "capitalize" }, this.monthNames[this.selectedMonth], " ", this.selectedYear)), h("ix-dropdown", { key: "0b1724c5fa4ab875d5148385d76ca3de725a183b", "data-testid": "year-month-dropdown", class: "dropdown", trigger: this.dropdownButtonRef.waitForCurrent(), ignoreRelatedSubmenu: true, placement: "bottom-start", enableTopLayer: this.enableTopLayer }, h("div", { key: "8ba05d6dc9220594e5bc07f97036628a095eb90c", class: "wrapper" }, h("div", { key: "90b29000a595df5c447474b5f13463724f16d010", "data-testid": "year-container", class: "overflow", onScroll: () => this.infiniteScrollYears(), ref: this.yearContainerRef }, this.renderYears()), h("div", { key: "5bf50056167f456c868e2926c21f137d64665149", class: "overflow", "data-testid": "month-container" }, this.monthNames.map((month, index) => h("div", { key: month, ref: (ref) => {
      ...
      checkPosition: true
    }, name: iconSingleCheck, size: "16" }), h("div", null, h("span", { class: "capitalize monthMargin" }, `${month} ${this.tempYear}`)))))))), h("ix-icon-button", { key: "2a113b58b8d8d85ba2dacebe4cd27c1596fd63ed", onClick: () => this.changeToAdjacentMonth(1), icon: iconChevronRightSmall, variant: "tertiary", class: "arrows", "aria-label": this.ariaLabelNextMonthButton })), h("div", { key: "21c2a21c4f77329accd540c4d0c723a8f96ce07c", class: {
      grid: true,
      "grid--show-week-numbers": this.showWeekNumbers
    } }, this.showWeekNumbers && h("div", { key: "e5efecc7ea1b22acc4656a06ea5e7c933a6c9bde", class: "calendar-item week-day" }), this.dayNames.map((name) => h("div", { key: name, class: "calendar-item week-day" }, h("div", { class: "overflow" }, name.slice(0, 3)))), this.calendar.map((week) => {
    ...
    })), h("div", { key: "19e61f1c4f82ce919f215e87389da91993febdec", class: {
      button: true,
      hidden: this.singleSelection || this.embedded
    } }, h("ix-button", { key: "35e38857c4e836ea8dea64c0c19f3f231d2631fe", onClick: () => this.onDone() }, this.i18nDone))));
  }
  get hostElement() {
...
const LayoutGrid = class {
  ...
  render() {
    return h(Host, { key: "e29a4c497ec1f2fac5e36ca6099b8362ae88c73a", class: {
      "no-margin": this.noMargin
    }, style: {
      "--ix-layout-grid-columns": `${this.columns}`,
      "--ix-layout-grid-gutter": `${this.gap}px`
    } }, h("slot", { key: "0bf8702378d9c44b28d8886e095aef17285fb1b2" }));
  }
};
