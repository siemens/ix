...
import { V as iconDocument } from "./index-BcWSlcx_-DijX28Uj.js";
...
const MenuItem = class extends Mixin(...DefaultMixins, InheritAriaAttributesMixin) {
  ...
  render() {
    ...
    const menuContent = [
      this.icon && h("ix-icon", { key: "3461f60cda48c6f3429621bd1c8f02942af5ce5d", class: "tab-icon", name: this.icon, "aria-hidden": "true" }),
      this.notifications ? h("div", { class: "notification" }, h("div", { class: "pill" }, this.notifications)) : null,
      h("span", { key: "a7ae8f46a8180a6411c2a927bb262d401cabe24d", id: this.internalItemId, class: "tab-text text-default" }, this.label, h("slot", { key: "41e85296b862905223a8abc5b9a861a6bdf4cfda" }))
    ];
    const ariaLabel = this.getAriaLabel();
    return h(Host, { key: "ce24c7dfd5012466d06b9ccb588c860700257f9c", class: {
