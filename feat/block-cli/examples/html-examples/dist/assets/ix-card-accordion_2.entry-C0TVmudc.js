...
const CardAccordion = class {
  ...
  render() {
    return h(Host, { key: "e1de56777d4c2aa70bdeded08aca7c318218c119", slot: "card-accordion", class: {
      [`variant-${this.variant}`]: true
    } }, h("button", { key: "9a3814b5352c799edd6bf189f7acd5e6e98ad505", tabIndex: 0, class: { "expand-action": true, show: this.expandContent }, onClick: (event) => this.onExpandActionClick(event), role: "button", type: "button", "aria-expanded": this.expandContent, "aria-controls": getAriaControlsId(), "aria-label": this.ariaLabelExpandButton }, h("ix-icon", { key: "f6fa94da30381daab69885fd5683e2959d889a0c", name: iconChevronDownSmall, class: {
      "expand-icon": true,
      show: this.expandContent
    } })), h("div", { key: "798a167769c15e0871cfd44a73357e5c0a2dee55", class: {
      "expand-content": true,
      show: this.expandContent
    } }, h("div", { key: "53f82cc33f8ee5ca4f0513bcb81a51ad94eb3291", class: "expand-content-inner" }, h("div", { key: "e30ae3cf5ebb23221aef091da7b2df50ac9bd3c2", class: "expand-content-body" }, h("slot", { key: "75c5df901c40f8ff5dcf6116f7bb9da9fdcf61ba" })), h("div", { key: "6556e55b244eae8aafc4b74140021b480f6fa10e", class: "expand-content-footer" }))));
  }
  static get watchers() {
    return {
      "collapse": [{
...
const CardHeader = class {
  ...
  render() {
    return h(Host, { key: "bd0d485d6b386fb59bcbfac55a42d87f08debb58" }, h("slot", { key: "05336bd05dec1bcefdc782716e1d0b07d8e60358" }), h("div", { key: "88e5100291c795aa3ef5f2507c082cf836f4f29d", class: "title-actions" }, h("slot", { key: "c7ca8aff491e1c0f29cdbe01664141e10c859caa", name: "title-actions" })));
  }
};
