...
const KeyValue = class {
  ...
  value;
  render() {
    return h(Host, { key: "557c10eceaa8c0f728cf2ccb2ec248f4c30bc26c", class: `keyValue keyValue--${this.labelPosition === "top" ? "column" : "row"}` }, this.icon && h("ix-icon", { key: "4ccdf23f094e927116dca5ea4da4c40b258d6292", name: this.icon, size: "24", class: "keyValue__icon", "aria-label": this.ariaLabelIcon }), h("div", { key: "f70d048178237d495419abeaddd7e60bb9a5c7b0", class: "keyValue__content" }, h("div", { key: "784c61d7b046d7946da8a01f35b2ab74ebc64b03", class: "content__label" }, this.label), h("div", { key: "2d57a5685b0c3c1d734b8431126ec727bb0b09c9", class: {
      content__value: true,
