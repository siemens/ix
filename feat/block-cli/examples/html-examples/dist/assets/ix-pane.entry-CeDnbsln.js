...
import { I as iconDoubleChevronDown, J as iconDoubleChevronRight, K as iconDoubleChevronUp, L as iconDoubleChevronLeft, A as iconClose } from "./index-BcWSlcx_-DijX28Uj.js";
...
const Pane = class {
  ...
  render() {
    ...
    return h(Host, { key: "b36d13c3957738c7afb31683e5ded610e2604e9f", class: {
    ...
    }, "aria-expanded": a11yBoolean(this.expanded) }, h("aside", { key: "5a93a071fcd8440c30900046c74091bf3b5fa1e1", id: `pane-${this.composition}`, class: {
      "top-bottom-pane": this.isBottomTopPane && !this.isMobile,
      "left-right-pane": this.isLeftRightPane && !this.isMobile,
      "mobile-pane": this.isMobile,
      expanded: this.expanded
    } }, h("div", { key: "28a48b0feec05f4a4619833a4c3b09b115f0549c", id: "title-div", class: {
    ...
    } }, h("ix-icon-button", { key: "1955d07f954ee4c8b2ab5f667138c6ee56cdf468", class: "title-icon", size: "24", icon: this.expanded ? this.isMobile || this.hideOnCollapse ? iconClose : this.expandIcon : this.minimizeIcon, iconColor: this.expanded && (this.isMobile || this.hideOnCollapse) ? "color-soft-text" : void 0, variant: "subtle-tertiary", onClick: () => this.dispatchExpandedChangedEvent(), "aria-controls": `pane-${this.composition}`, "aria-label": paneButtonAriaLabel }), h("div", { key: "ab66e4b6867485df8bcf612f63014a20eef7111d", class: {
      "title-text": true,
      rotate
    } }, this.icon && h("ix-icon", { key: "002d0bd921a486eca0806f21dae7878fb4944aba", class: "pane-icon", size: "24", name: this.icon, "aria-label": this.ariaLabelIcon }), h("div", { key: "4444a2f4a8d1c3576169f62be27f9644e170880f", class: "title-text-overflow" }, h("ix-typography", { key: "961a4b268107180df3d05dac6b0db86907da69d0", format: "h4" }, this.heading)), this.expanded && h("div", { key: "0387902ab1c5fff741dce1e0b5ff68be4445531d", class: "slot-header" }, h("slot", { key: "707d680c27e50962b0aaf75f3710fe85cdda5c88", name: "header" })))), h("div", { key: "3030f854f0a24770c7178093b7554673a4f63e8e", class: {
      "side-pane-content": true,
      "no-padding": this.noPadding
    }, hidden: !this.showContent }, h("slot", { key: "0c7a4983ec0d0c1bda176a036becf8e0db20ccd8" }))));
  }
  static get watchers() {
    return {
      "expanded": [{
