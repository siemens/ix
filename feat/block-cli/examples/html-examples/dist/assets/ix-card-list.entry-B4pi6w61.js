import { r as registerInstance, c as createEvent, g as getElement, h, H as Host, F as Fragment } from "./global-Dfa5QLOG.js";
import { c as createMutationObserver } from "./mutation-observer-CX81WQtk-DFcmhOTk.js";
import { e as iconMoreMenu, k as iconChevronDown } from "./index-DLhpBBEI-C3tPjcQ4.js";
...
const CardList = class {
  ...
  render() {
    return h(Host, { key: "2a817ebd35fb357f4ca44db36ee3a8c1f61524d7" }, h(CardListTitle, { key: "5039c04989d3c6e6b84f7f162c0ab124601cd0cf", isCollapsed: this.collapse, label: this.label, showAllLabel: this.i18nShowAll, showAllCounter: this.showAllCount === void 0 ? this.numberOfAllChildElements : this.showAllCount, showLess: this.isShowingAll, labelShowLess: this.i18nShowLess, onClick: () => this.onCardListVisibilityToggle(), onShowAllClick: (e) => this.onShowAllClick(e), hideShowAll: this.hideShowAll }), h("div", { key: "012b3465e657624ca92ec65268d418967894436d", class: {
      CardList__Overflow: true
    }, style: this.computeMaskLayer() }, h("div", { key: "b7ad698c708a85f8c6bfba3016a3a24fd5d84517", class: {
    ...
    }, onScroll: () => this.onCardListScroll() }, h("slot", { key: "fccb661a43b7555a1c92ab3cf6ffa6f7bf5bb973", onSlotchange: () => {
      this.changeVisibilityOfSlotChildren();
