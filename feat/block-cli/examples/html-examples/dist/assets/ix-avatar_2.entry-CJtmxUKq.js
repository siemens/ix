import { r as registerInstance, a as readTask, h, F as Fragment, H as Host, g as getElement, c as createEvent } from "./global-Cn4dOqNA.js";
...
const Avatar = class {
  ...
  render() {
    ...
    if (this.isClosestApplicationHeader) {
      return h(Host, { slot: "ix-application-header-avatar", class: "avatar-button" }, h(BaseButton, { disabled: false, iconOval: false, icon: void 0, iconOnly: false, loading: false, selected: false, type: "button", variant: "tertiary" }, Avatar2), h("ix-dropdown", { ref: (ref) => this.dropdownElement = ref, trigger: this.resolveAvatarTrigger(), class: "avatar-dropdown", onClick: (e) => this.onDropdownClick(e), onShowChanged: (event) => {
...
const MenuAvatarItem = class {
  ...
  render() {
    return h("ix-dropdown-item", { key: "437aead7832603097e4f814abef0108dcb0ad386", ref: this.dropdownItemRef, icon: this.icon, label: this.label, onClick: (e) => this.itemClick.emit(e) });
  }
  get hostElement() {
    return getElement(this);
  }
