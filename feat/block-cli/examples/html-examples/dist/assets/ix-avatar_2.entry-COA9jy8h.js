import { M as Mixin, a as registerInstance, g as getElement, r as readTask, h, F as Fragment, H as Host, c as createEvent } from "./global-B8nXsUf-.js";
...
import { c as closestElement, h as hasSlottedElements } from "./shadow-dom-BIe8Nw9M-DxOF84uP.js";
import { P as PROXY_LISTITEM_ID_SUFFIX, u as updateFocusProxyList, F as FocusProxy } from "./focus-proxy-B-7DiiT3-ByUGxtyN.js";
...
const MenuAvatarItem = class {
  ...
  render() {
    return h("ix-dropdown-item", { key: "f96a631b215cb1d42035b4d5ffb7ce7fbea2b34a", ref: this.dropdownItemRef, icon: this.icon, label: this.label, onClick: (e) => this.itemClick.emit(e) });
  }
};
