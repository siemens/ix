...
import { r as iconClose, a as iconWarning, c as iconSuccess, b as iconError, i as iconInfo } from "./index-Dn2eQInl-mXhHymhu.js";
...
const Toast = class {
  ...
  render() {
    ...
    return h(Host, { key: "aef69a3056d521398e919329e6491845d9e5539e", class: "animate__animated animate__fadeIn" }, h("div", { key: "95026351e39f1b43a34b494bd95944b6c0e87e20", class: "toast-body", onPointerLeave: () => {
      this.touched = false;
    }, onPointerEnter: () => {
      this.touched = true;
    } }, (this.type || this.icon) && !this.hideIcon ? h("div", { class: "toast-icon" }, this.getIcon()) : null, h("div", { key: "7d74934b03961a32707edb31c78062671f992155", class: "toast-content" }, this.toastTitle ? h("ix-typography", { class: "toast-title", format: "h5" }, this.toastTitle) : null, h("div", { key: "b97d3b7e1249751147e88c03d0573e975891608c", class: "toast-message" }, h("slot", { key: "7cff3fa7f6ecb864de9920f1a07094a2eeb14bfb" })), h("div", { key: "6454393f4e47810e170128f565390176107315c5", class: "toast-action" }, h("slot", { key: "45a6e12bd3c4eb32a549b23c16e41e41a320ebef", name: "action" }))), h("div", { key: "25a8e595cd72999ffa561fa78f7d3e244bd55f29", class: "toast-close" }, h("ix-icon-button", { key: "a9eb948f4e62fd76d6ccb09ecd14691e83b42c09", icon: iconClose, iconColor: "color-soft-text", size: "24", variant: "tertiary", onClick: () => this.closeToast.emit(), "aria-label": this.ariaLabelCloseIconButton }))), !this.preventAutoClose && h("div", { key: "c7ce8923eeff1367a931fbdd1e978a263eb5ad9a", class: progressBarClass.join(" "), style: progressBarStyle, onAnimationEnd: () => {
      this.close();
    }, onTransitionEnd: () => {
      if (this.progress === 0) {
        this.close();
