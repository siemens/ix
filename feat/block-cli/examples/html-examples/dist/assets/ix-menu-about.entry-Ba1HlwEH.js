import { r as registerInstance, c as createEvent, g as getElement, f as forceUpdate, h, H as Host } from "./global-CRrZCTD3.js";
...
const MenuAbout = class {
  ...
  render() {
    return h(Host, { key: "a5d9ec181593cb8db3dc77a46d8d56a903bbadcb", slot: "ix-menu-about", class: {
      show: this.show,
      ["legacy-tabs"]: !this.suppressLegacyTabs
    } }, h("div", { key: "ec5d8480569877d04d829ab12118f37c4b67446d", class: "about-header" }, h("h2", { key: "b76850199073347d6931e7100cab3e0756a65191", class: "text-h2" }, this.label), h("ix-icon-button", { key: "d16e5b7dbc5bbf855735c847f6aa0c9b99efc9ea", variant: "tertiary", size: "24", icon: iconClose, iconColor: "color-soft-text", "aria-label": this.ariaLabelCloseButton, onClick: (e) => this.close.emit({
      name: "ix-menu-about",
      nativeEvent: e
