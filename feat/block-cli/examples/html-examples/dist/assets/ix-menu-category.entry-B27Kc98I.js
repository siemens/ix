...
import { g as getComposedPath } from "./shadow-dom-BIe8Nw9M-C-dhDpq3.js";
...
const MenuCategory = class extends Mixin(...DefaultMixins) {
  ...
  render() {
    return h(Host, { key: "7bd646c124e521d59b7a78207d2c9a77e9e896b0", class: {
    ...
    } }, h("ix-menu-item", { key: "48ee634970113847ab9083d79a466fd02ff2d64b", "aria-haspopup": "true", class: "category-parent", active: this.isNestedItemActive(), notifications: this.notifications, icon: this.icon, onClick: (e) => this.onCategoryClick(e), onKeyDown: (event) => this.onKeyDown(event), tooltipText: this.tooltipText, isCategory: true }, h("span", { key: "f0528461e7508152931d4d7529d059913e05d083", class: "category" }, h("span", { key: "dbb1429dfe14406e199a373f1ef7c5a0944033ba", class: "category-text" }, this.label), h("ix-icon", { key: "56bc393fee5151d3647d4cc609ceebcbd4794e48", name: iconChevronDownSmall, class: {
      "category-chevron": true,
      "category-chevron--open": this.showItems
    }, "aria-hidden": "true" }))), h("div", { key: "4c3d2d225b8dc0e716eb2dce8d6b237899b74450", ref: (ref) => this.menuItemsContainer = ref, class: {
      "menu-items": true,
      "menu-items--expanded": this.showItems,
      "menu-items--collapsed": !this.showItems
    } }, this.showItems ? h("slot", null) : null), h("ix-dropdown", { key: "0ef9eca49ee9ec210b4b8887e6284c4643146e5d", ref: this.dropdownRef, closeBehavior: "both", show: this.showDropdown, onShowChange: ({ detail: dropdownShow }) => {
      if (dropdownShow) {
        return;
      }
    ...
    } }, h("ix-dropdown-item", { key: "95c95a1100e20dc0b572f5e13ac2f4b42bc7790e", class: "category-dropdown-header", tabindex: -1 }, h("ix-typography", { key: "f7cd705067ff6b84f83bb2e18098be9e33ee883b", format: "label", bold: true, textColor: "std" }, this.label)), h("ix-divider", { key: "a683fa5ceee2538f95e02832d84c7a54cfadf946" }), h("slot", { key: "b6f25332f9e221b83a127bbef4b3cccce2f23412" })));
  }
