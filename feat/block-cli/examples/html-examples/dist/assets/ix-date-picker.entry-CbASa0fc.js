...
import { H as iconChevronLeftSmall, j as iconChevronRightSmall } from "./index-BcWSlcx_-DijX28Uj.js";
...
const DatePicker = class extends Mixin(...DefaultMixins) {
  ...
  render() {
    return h(Host, { key: "e46629d18a79571d4b81fbff009710cc192c88fb", onKeyDown: (event) => this.onKeyDown(event), onFocusin: () => {
      if (hasKeyboardMode()) {
        this.changeFocusedDay();
      }
    } }, h("ix-date-time-card", { key: "342d0138ede9bfec6cbad6a3a3a1389d85fdc68f", corners: this.corners, embedded: this.embedded }, h("div", { key: "26e7c5b014c650e6439b548e0fd07afcb8219307", class: "header", slot: "header" }, h("ix-icon-button", { key: "0158b40846b65e4b8cc9a63db61f099884997cdd", onClick: () => this.changeCalendarView(-1), icon: iconChevronLeftSmall, variant: "tertiary", class: "arrows", "aria-label": this.ariaLabelPreviousMonthButton }), h("div", { key: "095f835c23a79ef1979b88cc98a7efacfc7388e3", class: "selector" }, h("ix-dropdown-button", { key: "57d9d3dec0be8c6aeb00eafeee11e7514d6b2023", class: "month-selector", focusCheckedItem: true, "aria-label": this.ariaLabelMonthSelection, variant: "tertiary", label: null, onShowChanged: (event) => {
      event.stopPropagation();
    } }, h("ix-typography", { key: "56c23aa882fdab509c0a7cdd6d3fe8b01aecb601", bold: true, class: "capitalize", slot: "button-label" }, this.monthNames[this.selectedMonth]), this.renderMonths()), h("ix-dropdown-button", { key: "6b6980ab73724a14551de0f62a58c0a65a34bbd4", class: "year-selector", focusCheckedItem: true, "aria-label": this.ariaLabelYearSelection, ref: this.yearDropdownButtonRef, variant: "tertiary", label: null, onShowChanged: (event) => {
      event.stopPropagation();
      if (event.detail) {
        requestAnimationFrameNoNgZone(() => {
    ...
    } }, h("div", { key: "ced7a4ec6f51ddd02d85589538afdb196e902bc0", class: "infinite-scrolling-spacer" }, h("div", { key: "a5f027bc235ea14de80742e53fb717b99f47c742", class: "sentinel", "data-sentinel": "top" })), h("ix-typography", { key: "c5aca23b8a4843d6d6db0d58048c4ccc3534b35f", bold: true, class: "capitalize", slot: "button-label" }, this.selectedYear), this.renderYears(), h("div", { key: "6de309021f2f3bbbd505a3114fccd0f664878ecb", class: "infinite-scrolling-spacer" }, h("div", { key: "c0bad429530ae54ac19cb678b0a2b15bbb0f6c30", class: "sentinel", "data-sentinel": "bottom" })))), h("ix-icon-button", { key: "4fe0a09bf92e6685afc94a9abaf79e355933204b", onClick: () => this.changeCalendarView(1), icon: iconChevronRightSmall, variant: "tertiary", class: "arrows", "aria-label": this.ariaLabelNextMonthButton })), h("div", { key: "4633ec3f74d69116b7a24c710d22a6b4bf15dbfd", role: "grid", class: {
      grid: true,
      "grid--show-week-numbers": this.showWeekNumbers
    } }, h("div", { key: "f5a883ed2d3b3146bf77390654eeaf1f5a6674df", role: "row" }, this.showWeekNumbers && h("div", { key: "dae6373def9ee10078fb8f5c57629cc81ee487dd", class: "calendar-item week-day", role: "columnheader" }), this.dayNames.map((name) => h("div", { key: name, class: "calendar-item week-day", role: "columnheader" }, h("div", { class: "overflow" }, name.slice(0, 3))))), this.calendar.map((week) => {
    ...
    })), h("div", { key: "f5d6bd8e4e352e1bfb0c1e63ff709b6770c7d900", class: {
      button: true,
      hidden: this.singleSelection || this.embedded
    } }, h("ix-button", { key: "c4874caa9f593c8865e94b4394a1e155514f26b5", hidden: this.singleSelection || this.embedded, onClick: () => this.onDone() }, this.i18nDone))));
  }
