...
const DatePicker = class extends Mixin(...DefaultMixins) {
  ...
  render() {
    return h(Host, { key: "d3069d1895021eafcdbf31b1e3efb3fc9c9bd45c", onKeyDown: (event) => this.onKeyDown(event), onFocusin: () => {
      if (hasKeyboardMode()) {
        this.changeFocusedDay();
      }
    } }, h("ix-date-time-card", { key: "565f344168f3cd6d5ec6cf52c995986069b8b283", corners: this.corners, embedded: this.embedded }, h("div", { key: "0736fee99626beb804c8cc12029fe54e7d548e2b", class: "header", slot: "header" }, h("ix-icon-button", { key: "f7a6a2cf70bcc64d3c302b7030b6d3d6576e0f2a", onClick: () => this.changeCalendarView(-1), icon: iconChevronLeftSmall, variant: "tertiary", class: "arrows", "aria-label": this.ariaLabelPreviousMonthButton }), h("div", { key: "74181a640e8fc12a42b5e781a7c34e181cf1eb8a", class: "selector" }, h("ix-dropdown-button", { key: "4cf5f39ae313b65da3e2ac5a5fa52ccb82122e6d", class: "month-selector", focusCheckedItem: true, "aria-label": this.ariaLabelMonthSelection, variant: "tertiary", label: null, onShowChanged: (event) => {
      event.stopPropagation();
    } }, h("ix-typography", { key: "b2faf7ed035bbb6fdd6340b670293c8e0ca1621b", bold: true, class: "capitalize", slot: "button-label" }, this.monthNames[this.selectedMonth]), this.renderMonths()), h("ix-dropdown-button", { key: "98ddd8a4b98971281f13604223b26875d8e98f95", class: "year-selector", focusCheckedItem: true, "aria-label": this.ariaLabelYearSelection, ref: this.yearDropdownButtonRef, variant: "tertiary", label: null, onShowChanged: (event) => {
      event.stopPropagation();
      if (event.detail) {
        requestAnimationFrameNoNgZone(() => {
    ...
    } }, h("div", { key: "189b2b69780bf591ec3c389805b6c812ee9dd1d7", class: "infinite-scrolling-spacer" }, h("div", { key: "38342a0944a2b608d070edba51bbdbe70ed2e13a", class: "sentinel", "data-sentinel": "top" })), h("ix-typography", { key: "a3929dc20ed2dfc94c294a9b8224de6f63eba4bb", bold: true, class: "capitalize", slot: "button-label" }, this.selectedYear), this.renderYears(), h("div", { key: "637a5ecac5369f0650409fc5c0e5495382a2fc78", class: "infinite-scrolling-spacer" }, h("div", { key: "26db6286c919b4ebb5fde09089042c008ff357a9", class: "sentinel", "data-sentinel": "bottom" })))), h("ix-icon-button", { key: "c65933ad02d8ca67ee15b897da7d7803bb48390d", onClick: () => this.changeCalendarView(1), icon: iconChevronRightSmall, variant: "tertiary", class: "arrows", "aria-label": this.ariaLabelNextMonthButton })), h("div", { key: "95063f09aa44b93bc6c350313cc49febc5480222", role: "grid", class: {
      grid: true,
      "grid--show-week-numbers": this.showWeekNumbers
    } }, h("div", { key: "2ed900e0286f83823283f0deb94ea0038246c68e", role: "row" }, this.showWeekNumbers && h("div", { key: "96e8c49c28b2d0279f09fcdc782dcdf9aa0262a8", class: "calendar-item week-day", role: "columnheader" }), this.dayNames.map((name) => h("div", { key: name, class: "calendar-item week-day", role: "columnheader" }, h("div", { class: "overflow" }, name.slice(0, 3))))), this.calendar.map((week) => {
    ...
    })), h("div", { key: "7ee6d4587f148a9b6a839e09fda41ded54576585", class: {
      button: true,
      hidden: this.singleSelection || this.embedded
    } }, h("ix-button", { key: "ce7f12a657c5995190eca0cbac146e0edd8f7f57", hidden: this.singleSelection || this.embedded, onClick: () => this.onDone() }, this.i18nDone))));
  }
