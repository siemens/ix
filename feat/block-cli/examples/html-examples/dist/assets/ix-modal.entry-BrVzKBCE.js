...
const Modal = class {
  ...
  render() {
    return h(Host, { key: "2efc401a013ea2fbdf2c111d27fe72bb513ffe9e", class: {
      visible: this.modalVisible,
      "no-backdrop": this.hideBackdrop,
      "align-center": this.centered,
      "non-blocking": this.isNonBlocking
    } }, h("div", { key: "254ea2da03df87a56a11f45bb04803d4cc644031", class: "dialog-backdrop" }, h("dialog", { key: "2b147a0da66028310e8eb471548feab44355d0d4", "aria-modal": a11yBoolean(!this.isNonBlocking), "aria-describedby": this.ariaAttributes["aria-describedby"], "aria-labelledby": this.ariaAttributes["aria-labelledby"], class: {
      modal: true,
      ...
      e.preventDefault();
      void this.dismissModal();
    } }, h("slot", { key: "5c581b93a6dbceb5432a65367f262d3b8158d08c" }))));
  }
};
