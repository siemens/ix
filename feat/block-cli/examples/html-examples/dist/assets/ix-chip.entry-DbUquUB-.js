...
const Chip = class extends Mixin(...DefaultMixins, InheritAriaAttributesMixin) {
  ...
  render() {
    ...
    return h(Host, { key: "ee2c4fb8a38d7227c803914afe10014747000e21", role: this.getHostRole(needsGroupRole), class: {
      inactive: this.inactive
    } }, h("div", { key: "ee682113b04e7ac6e460a47bb71440828e955f6c", ref: this.containerElementRef, class: wrapClasses, style: customWrapStyle }, h("button", { key: "a65f568cd03bb075dcfa0be8005d6ee8a31c602a", type: "button", class: "chip-main", ...this.inheritAriaAttributes, disabled: this.inactive, style: customMainStyle }, h("div", { key: "5ea15ee26bef345718b285e3fa17f45c3a676a74", class: "content-wrapper" }, this.icon && h("ix-icon", { key: "754a363c9bcb1f420a6a8275ef7357808e00801a", class: {
      "with-icon": true
    }, name: this.icon, size: "24", "aria-label": this.ariaLabelIcon, "aria-hidden": a11yBoolean(iconIsDecorative), style: this.getIconStyle(variant) }), h("span", { key: "7fef9a3b80509fed425e011ddcca279fc86324f6", class: "slot-container" }, h("slot", { key: "4cf188424a7054f82d6414275d80f60f51c4aa1b" })))), showClose && h("button", { key: "551fa16d2de03a1ccaa4068ce4d293ab340476a9", type: "button", class: "chip-close", "aria-label": this.ariaLabelCloseButton, onClick: (event) => {
      this.closeChip.emit(event);
      event.stopPropagation();
    } }, h("ix-icon", { key: "a202fee99f31aac3a737e8ab37be9fdeda66e013", class: "chip-close__icon", name: iconCloseSmall, size: "16", "aria-hidden": "true" }))), this.getTooltip());
  }
  static get watchers() {
    return {
      "role": [{
