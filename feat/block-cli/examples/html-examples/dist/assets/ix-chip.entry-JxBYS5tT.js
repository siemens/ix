...
const Chip = class {
  ...
  render() {
    ...
    return h(Host, { key: "0387f3fda3207c26e606c9a11cfdaf5ca999d6d6", tabIndex: "-1", class: {
      inactive: this.inactive
    }, style: this.variant === "custom" ? {
      "--ix-icon-button-color": this.chipColor
    } : {} }, h("div", { key: "410ada59194a6201489fe428b6ed0f12b05e7ca1", ref: this.containerElementRef, style: { ...customStyle }, class: {
      container: true,
    ...
    } }, h("div", { key: "7e03d51b3231a4340fdf294ca76577578619e0d0", class: "content-wrapper" }, this.icon && h("ix-icon", { key: "e6988c81b90cea0f6943a873b5a47156a95eeb7a", class: {
      "with-icon": true
    }, name: this.icon, size: "24", style: this.variant === "custom" ? { color: this.outline ? this.background : this.chipColor } : void 0 }), h("span", { key: "5826ccde8cc17d74c4130cf17d647e590644efb5", class: "slot-container" }, h("slot", { key: "c6611f9a631955565140efa5646ffcfe05f66ce9" }))), this.inactive === false && this.closable && this.getCloseButton()), this.getTooltip());
  }
};
Chip.style = chipCss();
export {
