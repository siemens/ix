import { r as registerInstance, g as getElement, h, H as Host } from "./global-CtBDOAVb.js";
import { S as iconDocument } from "./index-Dn2eQInl-mXhHymhu.js";
...
const MenuItem = class {
  ...
  render() {
    ...
    const menuContent = [
      this.icon && h("ix-icon", { key: "1a56c9cf472402ddcabb42f74709d7dcf54d7b96", class: "tab-icon", name: this.icon, "aria-hidden": "true" }),
      this.notifications ? h("div", { class: "notification" }, h("div", { class: "pill" }, this.notifications)) : null,
      h("span", { key: "8420f189dd96512fa9d1eaeb7fa8103ed39d35b4", id: this.internalItemId, class: "tab-text text-default" }, this.label, h("slot", { key: "fbe179e04cdcbf82975923c943ba957a040f5a16" }))
    ];
    return h(Host, { key: "ec15c3dacfbf758477a7b116a67c8c9a21aac74a", class: {
