...
const Select = class {
  ...
  render() {
    var _a, _b, _c, _d;
    return h(Host, { key: "e3d77369d07f0be332ab7fd89d7fb50824eda98a", "aria-disabled": a11yBoolean(this.disabled), class: {
      disabled: this.disabled
    } }, h("ix-field-wrapper", { key: "f62cee3ed30fc22ef5ef53946de9496576699501", required: this.required, label: this.label, helperText: this.helperText, invalidText: this.invalidText, infoText: this.infoText, warningText: this.warningText, validText: this.validText, showTextAsTooltip: this.showTextAsTooltip, isInvalid: this.isInvalid, isValid: this.isValid, isInfo: this.isInfo, isWarning: this.isWarning, controlRef: this.inputRef }, h("div", { key: "d34ee64beafd5b4cd3e040312d480b07b2003276", class: {
      select: true,
      disabled: this.disabled,
    ...
    } }, h("div", { key: "f4a776d773572345e499410ed4493df6757e6797", class: "input-container" }, h("div", { key: "166b816069512be7c25b36231af7e0857d720420", class: "chips" }, this.isMultipleMode && this.items.length !== 0 && (this.shouldDisplayAllChip() ? this.renderAllChip() : (_a = this.selectedItems) === null || _a === void 0 ? void 0 : _a.map((item) => this.renderChip(item))), h("div", { key: "cdd9b95c6a356244e986a0fbd62a55f47b1b76fc", class: "trigger" }, h("input", { key: "652dd3f92b77d996ec0918e2ee352d702ccdd4ff", autocomplete: "off", "data-testid": "input", disabled: this.disabled, readOnly: this.readonly, required: this.required, type: "text", class: {
      ...
      if (this.editable)
        this.dropdownWrapperRef(ref);
    }, "aria-label": this.ariaLabelChevronDownIconButton })))))), h("ix-dropdown", { key: "37e2f2974a094afd980a8bc68c261c136a667dc7", ref: (ref) => this.dropdownElement = ref, show: this.dropdownShow, closeBehavior: this.isMultipleMode ? "outside" : "both", class: {
    ...
    } }, h("div", { key: "97db72e168337ce557083361cd4b9c22ba1bec6d", class: {
      "select-list-header": true,
      hidden: this.hideListHeader || this.isDropdownEmpty
    }, title: this.i18nSelectListHeader, onClick: (e) => e.preventDefault() }, this.i18nSelectListHeader), h("slot", { key: "ceb168aedd28f921543332534391dd7f3976b087", onSlotchange: () => {
      this.updateSelection();
    } }), h("div", { key: "458c6397c298d6a41ce34ac9cf4ac4e6902e8471", ref: (ref) => this.customItemsContainerElement = ref }), this.isAddItemVisible() ? h("ix-dropdown-item", { "data-testid": "add-item", icon: iconPlus, class: {
      "add-item": true
