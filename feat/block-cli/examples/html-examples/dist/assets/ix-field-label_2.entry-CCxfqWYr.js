...
import { h as hasAnyText, H as HelperText$1 } from "./helper-text-util-C9sLzo0k-Bf2DPYYR.js";
...
const FormFieldLabel = class {
  ...
  render() {
    return h(Host, { key: "23f1be0180a85db937a7666c9b30a6128f73e9b8", onClick: () => this.focusOnClick() }, h("label", Object.assign({ key: "2150a0113aa029451019257b91dc46992c5e2f79", htmlFor: this.htmlFor }, this.a11yAttributes, { ref: this.labelRef }), h("ix-typography", { key: "df0d5cb5d4e84d62e3e0d8a412f92606c25a5974", textColor: this.isInvalid ? "alarm" : "soft", format: "label" }, h("slot", { key: "2a547b030c4098b8dff1dd31e14e3f9a2773deae" }), this.required && h("span", { key: "9779ab62bd06a39bb76310cbf718cdfde4389227" }, "*"))));
  }
  get hostElement() {
