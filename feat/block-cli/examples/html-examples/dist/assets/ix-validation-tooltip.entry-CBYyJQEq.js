...
const ValidationTooltip = class {
  ...
  render() {
    return h(Host, { key: "0a52c03c92f1a6613c48e0bfeb646f2108e27d2a" }, h("slot", { key: "a9b755944268f9f19078509ccbd0062d4b65808c" }), h("div", { key: "83a000c87392a5e14322d2c20df7c4444d725d29", role: "tooltip", style: {
      display: "none",
      position: "fixed",
      top: "0",
      left: "0",
      transform: `translate(${Math.round(this.tooltipPosition?.x ?? 0)}px,${Math.round(this.tooltipPosition?.y ?? 0)}px)`
    }, class: "validation-tooltip text-default" }, this.message, h("slot", { key: "14fad0925fb8a1dee2292219b807795b492516fb", name: "tooltip-message" }), h("div", { key: "3100e9d39710cb5c4dd280c0db68f3bccfc4f593", id: "arrow" })));
  }
  static get watchers() {
    return {
      "isInputValid": [{
