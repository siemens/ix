...
const Toggle = class {
  ...
  render() {
    ...
    return h(Host, { key: "eae8bfa5dcb9ebf3b6739e833e245027bc641ef8", role: "switch", "aria-checked": a11yBoolean(this.checked), "aria-disabled": a11yBoolean(this.disabled), class: {
      disabled: this.disabled
    }, onBlur: () => this.ixBlur.emit(), onFocus: () => this.touched = true }, h("label", { key: "3f5d1168afbb739c63f4b8615a6d881318d4efc6", class: "wrapper" }, h("button", { key: "5e9b72f88a765c5d228fc3a96cace5853c1deeaa", class: {
      switch: true,
      checked: this.checked,
      indeterminate: this.indeterminate
    }, onClick: () => this.onCheckedChange(!this.checked), tabindex: -1, "aria-hidden": "true" }, h("div", { key: "d7e065e3d493bf9094c413578be7d99280393337", class: "slider" })), h("input", { key: "a235fef4101af2b38fcd83e966bec0ed82ba3cbe", type: "checkbox", disabled: this.disabled, indeterminate: this.indeterminate, checked: this.checked, tabindex: 0, "aria-hidden": a11yBoolean(true), "aria-checked": a11yBoolean(this.checked), onChange: (event) => this.onCheckedChange(event.target.checked) }), !this.hideText && h("ix-typography", { key: "15d6647e7f5438d9e23dcb3d57999bf649b7534e", class: "label" }, toggleText)));
  }
