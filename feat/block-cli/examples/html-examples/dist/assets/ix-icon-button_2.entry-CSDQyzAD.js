...
import { B as BaseIconButton } from "./base-icon-button-_xVULsPr-B6tIJOzc.js";
...
import "./base-button-hppF0uUM-2ArA-T9z.js";
...
const IconButton = class extends Mixin(...DefaultMixins, InheritAriaAttributesMixin) {
  ...
  render() {
    ...
    return h(Host, { key: "b045a90ed1bd11b3415b7e81c53ebb6357b3d23c", class: {
      ...this.getIconSizeClass(),
      disabled: this.disabled || this.loading
    }, tabIndex: this.disabled ? -1 : 0 }, h(BaseIconButton, { key: "72a8cb47f53df14174a5be856bf694602aa090ca", ...baseButtonProps }));
  }
...
const Spinner = class {
  ...
  render() {
    ...
    return h(Host, { key: "00f40a06882c8da21f92e080bd8aedab957b2d4a", ...ariaProperties }, h("div", { key: "bc30830559065bc7c6085efe446089ae794626ee", class: {
