...
const EventListItem = class {
  ...
  render() {
    ...
    return h(Host, { key: "566e7c147d8dd1ae5dc8dc879ba6b4b8eff78b2b", class: {
      disabled: this.disabled,
      [`event-list-item-${this.variant}`]: true
    } }, h("div", { key: "4258114f72056374d3881dd6629739f70754eb2b", role: "listitem", "aria-disabled": a11yBoolean(this.disabled), class: {
      "event-list-item": true,
      selected: this.selected,
      disabled: this.disabled
    } }, h("div", { key: "79161664fc4e059d7d79069e3f8c684d65b6ac20", class: `indicator ${!this.itemColor ? "indicator-empty" : ""}`, style: {
      "background-color": this.itemColor ? color : "inherit",
      opacity: `${this.disabled ? 0.4 : 1}`
    } }), h("div", { key: "08d74a92a21dcdacc6cfdcdeb97fb1f05b8d0eb1", class: "event-list-item-container" }, h("div", { key: "21af030f1a0dc9ffbbefb3883f34da0b254db8e0", class: "event-content" }, h("slot", { key: "f0507ac0325707b37f007834a3d1a129efda441a" })), this.chevron && h("ix-icon", { key: "c00b526d28dcb8c584039735d9c09c739167dcf1", name: iconChevronRight, size: "16", class: "chevron-icon", "aria-hidden": "true" }))));
  }
};
