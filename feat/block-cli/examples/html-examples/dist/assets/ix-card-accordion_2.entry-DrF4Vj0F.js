...
const CardAccordion = class {
  ...
  render() {
    return h(Host, { key: "15031f9ae9283d0a925d7a8961c30421a74afd00", slot: "card-accordion", class: {
      [`variant-${this.variant}`]: true
    } }, h("button", { key: "f9519a8d6a0dca6fea235a088cde7d2dc625f6a9", tabIndex: 0, class: { "expand-action": true, show: this.expandContent }, onClick: (event) => this.onExpandActionClick(event), role: "button", type: "button", "aria-expanded": this.expandContent, "aria-controls": getAriaControlsId(), "aria-label": this.ariaLabelExpandButton }, h("ix-icon", { key: "31d3504ed5080013a3164f774468d7c8d0405836", name: iconChevronDownSmall, class: {
      "expand-icon": true,
      show: this.expandContent
    } })), h("div", { key: "d05d1fd69c4547a590052a1367f73b6d293f661c", class: {
      "expand-content": true,
      show: this.expandContent
    } }, h("div", { key: "ae53caf39da7535218cbafea371517aa1f605a38", class: "expand-content-inner" }, h("div", { key: "28e530d0e6c5ff8f382acbe67816ac57feaad6f5", class: "expand-content-body" }, h("slot", { key: "b9dbf625e2ad24a2f38cc02f4f237f5f6630ae8b" })), h("div", { key: "e8a4659a1197989f7c422b6e4687710b89f9b78e", class: "expand-content-footer" }))));
  }
  static get watchers() {
    return {
      "collapse": [{
...
const CardHeader = class {
  ...
  render() {
    return h(Host, { key: "3c4fcd36490a262e10f3713bd00aba05bc23f57c" }, h("slot", { key: "12f3385e0779463b0c3bf1ed4b094cb336a1dbfe" }), h("div", { key: "31dc82bc323a4362c4cd53d5b61a6313631b2ae4", class: "title-actions" }, h("slot", { key: "c815200d67da86bcc9534b6a88475569399fea5c", name: "title-actions" })));
  }
};
