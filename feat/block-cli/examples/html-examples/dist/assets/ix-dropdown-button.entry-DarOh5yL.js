...
const DropdownButton = class extends Mixin(...DefaultMixins, ComponentIdMixin, AriaActiveDescendantMixin) {
  ...
  render() {
    ...
    return h(Host, { key: "e4d1e8143e1b174237544db571f1358dead3d8aa", class: {
      disabled: this.disabled,
    ...
    }, ref: this.dropdownAnchor, tabIndex: this.disabled ? -1 : 0, ...ariaAttributes }, h("div", { key: "76344142336f980aa5bd3b975a0a9bc0f7a4bddf", class: "dropdown-button" }, this.label || this.label === null ? h("ix-button", { ...commonProperties, class: "internal-button", alignment: "start", ref: (ref) => ref.tabIndex = -1, ariaLabelButton: this.ariaLabelDropdownButton ?? (this.dropdownShow ? "Close dropdown" : "Open dropdown") }, h("div", { class: "content" }, this.icon ? h("ix-icon", { name: this.icon, size: "24", class: "dropdown-icon" }) : null, h("div", { class: "button-label" }, this.label), h("slot", { name: "button-label" }), !hideChevron && h("ix-icon", { "aria-hidden": "true", name: this.dropdownShow ? iconChevronUpSmall : iconChevronDownSmall, size: "24" }))) : h("div", null, h("ix-icon-button", { ...commonProperties, icon: this.icon, ref: (ref) => ref.tabIndex = -1, "aria-label": this.ariaLabelDropdownButton ?? (this.dropdownShow ? "Close dropdown" : "Open dropdown") }), !hideChevron && this.getTriangle())), h("ix-dropdown", { key: "a2488a724c59ff6582b0f15ebc948188a9d4bc98", role: "menu", ref: this.dropdownRef, id: `dropdown-button-menu-${this.dropdownButtonId}`, "aria-labelledby": `dropdown-button-${this.dropdownButtonId}`, trigger: this.dropdownAnchor.waitForCurrent(), placement: this.placement, closeBehavior: this.closeBehavior, enableTopLayer: this.enableTopLayer, disableFocusTrap: true, focusCheckedItem: this.focusCheckedItem, onShowChanged: (event) => this.onDropdownShowChanged(event), onScroll: (event) => {
    ...
    } }, h("slot", { key: "c698cb7ae1f4ed8fb1a0437f5512f995f27e212a" })));
  }
};
