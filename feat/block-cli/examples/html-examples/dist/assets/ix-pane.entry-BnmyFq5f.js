...
const Pane = class {
  ...
  render() {
    ...
    return h(Host, { key: "e35f034aa3f1eb6c7a7d8cab0dac9bafad6e9080", class: {
    ...
    }, "aria-expanded": a11yBoolean(this.expanded) }, h("aside", { key: "a6824e24d1b1c0cf7da456dbd578b8b16be01d20", id: `pane-${this.composition}`, class: {
      "top-bottom-pane": this.isBottomTopPane && !this.isMobile,
      "left-right-pane": this.isLeftRightPane && !this.isMobile,
      "mobile-pane": this.isMobile,
      expanded: this.expanded
    } }, h("div", { key: "0a0ed1a132b90e7bc62c41cbdd017af922fba680", id: "title-div", class: {
    ...
    } }, h("ix-icon-button", { key: "da58437899d590a030cbac6366a33402fad07667", class: "title-icon", size: "24", icon: this.expanded ? this.isMobile || this.hideOnCollapse ? iconClose : this.expandIcon : this.minimizeIcon, iconColor: this.expanded && (this.isMobile || this.hideOnCollapse) ? "color-soft-text" : void 0, variant: "subtle-tertiary", onClick: () => this.dispatchExpandedChangedEvent(), "aria-controls": `pane-${this.composition}`, "aria-label": paneButtonAriaLabel }), h("div", { key: "9386f740e31572047d18197a916483b66d591983", class: {
      "title-text": true,
      rotate
    } }, this.icon && h("ix-icon", { key: "e7862a283da66a87d9b5c3bdc14a9130fdee97d7", class: "pane-icon", size: "24", name: this.icon, "aria-label": this.ariaLabelIcon }), h("div", { key: "6a1117f3abc2b00ede85a925c5e9678fe4c38ad8", class: "title-text-overflow" }, h("ix-typography", { key: "3e0d53c44c8301467cd0fc080545e298b53ff1c6", format: "h4" }, this.heading)), this.expanded && h("div", { key: "09b8a6864ba4d9261144e491d3fc6386ba774a84", class: "slot-header" }, h("slot", { key: "c756eaf7769cd325531313c6c12094d1466a7b3b", name: "header" })))), h("div", { key: "5d0068d651fc6a0f564a25bc1e5eacd16c9e8716", class: {
      "side-pane-content": true,
      "no-padding": this.noPadding
    }, hidden: !this.showContent }, h("slot", { key: "26b3ec487e50bb00619c2e025806d269b3b7e191" }))));
  }
  static get watchers() {
    return {
      "expanded": [{
