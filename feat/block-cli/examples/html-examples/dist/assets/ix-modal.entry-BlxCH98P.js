...
const Modal = class {
  ...
  render() {
    return h(Host, { key: "46cd0d00c7a294d5a83856dc4d7734e9fc8e49d5", class: {
      visible: this.modalVisible,
      "no-backdrop": this.hideBackdrop,
      "align-center": this.centered,
      "non-blocking": this.isNonBlocking
    } }, h("div", { key: "c15f9fee4608bf37d19926bbc3a5f49b1b387365", class: "dialog-backdrop" }, h("dialog", { key: "682f7aae588acfab1ae4a1c40ca01a0909d96220", "aria-modal": a11yBoolean(!this.isNonBlocking), "aria-describedby": this.ariaAttributes["aria-describedby"], "aria-labelledby": this.ariaAttributes["aria-labelledby"], class: {
      modal: true,
      ...
      e.preventDefault();
      void this.dismissModal();
    } }, h("slot", { key: "3548a6e711fb033c99d0cb9db9c5630394e8f477" }))));
  }
};
