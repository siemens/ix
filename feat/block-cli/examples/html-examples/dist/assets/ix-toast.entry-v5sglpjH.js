...
import { A as iconClose, c as iconWarning, a as iconSuccess, b as iconError, d as iconInfo } from "./index-BcWSlcx_-DijX28Uj.js";
...
const Toast = class {
  ...
  render() {
    ...
    return h(Host, { key: "15788d8de0bc221bfa5c6004de285d27eb671d88", role: "alert", "aria-live": "polite", "aria-atomic": "true", class: "animate__animated animate__fadeIn" }, h("div", { key: "02b0c3b73c3c7986037e57e78755f0ccb16cfeb9", class: "toast-body", onPointerLeave: () => {
      this.touched = false;
    }, onPointerEnter: () => {
      this.touched = true;
    } }, (this.type || this.icon) && !this.hideIcon ? h("div", { class: "toast-icon" }, this.getIcon()) : null, h("div", { key: "6de6bfbcc06cb344b0c31fa19a01624c4019ae3d", class: "toast-content" }, this.toastTitle ? h("ix-typography", { class: "toast-title", format: "h5" }, this.toastTitle) : null, h("div", { key: "2d7d7c3780d0f256fe109a64d10e8d6cacf705ac", class: "toast-message" }, h("slot", { key: "560f64d98179bcd6903c4a2afd0fbbed618efdd9" })), h("div", { key: "51bbbd4609124b2f6f44416cb4c3c3b79c93b777", class: "toast-action" }, h("slot", { key: "76887e721605867fdab0fd214b8b52d1080a50ad", name: "action" }))), h("div", { key: "1e43a244d52a00fd909e491e5e78de371c974705", class: "toast-close" }, h("ix-icon-button", { key: "0221815ce7c93eb11702402bd054e0d8f3982ce6", icon: iconClose, iconColor: "color-soft-text", size: "24", variant: "tertiary", onClick: () => this.closeToast.emit(), "aria-label": this.ariaLabelCloseIconButton }))), !this.preventAutoClose && h("div", { key: "dcd86987e47c15635c12df7b037ba458cc413771", class: progressBarClass.join(" "), style: progressBarStyle, onAnimationEnd: () => {
      this.close();
    }, onTransitionEnd: () => {
      if (this.progress === 0) {
        this.close();
