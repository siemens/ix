import { r as registerInstance, c as createEvent, g as getElement, h, H as Host, M as Mixin } from "./global-Dfa5QLOG.js";
import { n as iconCloseSmall } from "./index-DLhpBBEI-C3tPjcQ4.js";
import { I as IX_FOCUS_VISIBLE_ACTIVE, a as IX_FOCUS_VISIBLE } from "./focus-utilities-COIIN2Es-jUaNMCSm.js";
...
const FilterChip = class {
  ...
  render() {
    return h(Host, { key: "087e05c0086275a9de72ee4e58f8b1490a6f6ea7", class: { disabled: this.disabled, readonly: this.readonly }, title: this.hostElement.textContent }, h("div", { key: "67ad1ba59798591eca45077e0b2ba15e56134d58", class: "slot-container" }, h("slot", { key: "f371537a951f856ba539a09f32646861fd143863" })), !this.disabled && !this.readonly ? h("ix-icon-button", { variant: "tertiary", oval: true, icon: iconCloseSmall, size: "16", disabled: this.disabled, onClick: (event) => {
...
const SelectItem = class extends Mixin(...DefaultMixins, FocusVisibleMixin, ComponentIdMixin) {
  ...
  render() {
    ...
    return h(Host, { key: "4b9a59268d40f3d2942fc84751e8de55e5771607", ...ariaAttributes, id: this.getHostElementId(), class: {
      [IX_FOCUS_VISIBLE]: true
    }, "aria-hidden": "true", role: "presentation" }, h("ix-dropdown-item", { key: "dca008a8d5af1a9a00222587a51b58c8a3a44a9d", "aria-hidden": "true", role: "option", class: {
