...
const ValidationTooltip = class {
  ...
  render() {
    return h(Host, { key: "e8b14b29808b0ee59065ed9dcb255461bce3ddff" }, h("slot", { key: "5c1c5aa889b002e479820d2379b50ed2f8c798de" }), h("div", { key: "872b658123222a09db426a884721360297fdb61c", role: "tooltip", style: {
      display: "none",
      position: "fixed",
      top: "0",
      left: "0",
      transform: `translate(${Math.round(this.tooltipPosition?.x ?? 0)}px,${Math.round(this.tooltipPosition?.y ?? 0)}px)`
    }, class: "validation-tooltip text-default" }, this.message, h("slot", { key: "6e5252dbef3ce4fa8c1913b806ed6132670f7f27", name: "tooltip-message" }), h("div", { key: "60c0ea9212ad66338ccddd80ee051fea822436e5", id: "arrow" })));
  }
  static get watchers() {
    return {
      "isInputValid": [{
