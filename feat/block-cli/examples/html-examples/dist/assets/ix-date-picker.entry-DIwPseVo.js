...
import { f as iconChevronLeftSmall, h as iconChevronRightSmall } from "./index-DgUGsIlh-FNhczk6p.js";
...
const DatePicker = class extends Mixin(...DefaultMixins) {
  ...
  render() {
    ...
    } }, h("div", { key: "01097982f01d5a56c2fe7328b80763ec2fadde78", class: "infinite-scrolling-spacer" }, h("div", { key: "ddabc29161998bf1a3b5091a054e61094b20a98d", class: "sentinel", "data-sentinel": "top" })), h("ix-typography", { key: "8058e68c64348b5155da83e82d86746ef1ec2a18", bold: true, class: "capitalize", slot: "button-label" }, this.selectedYear), this.renderYears(), h("div", { key: "551e9f53a5614649b1043a75b5589b5dc773d189", class: "infinite-scrolling-spacer" }, h("div", { key: "84fd13048faf191dcd5066353c49cb3e81df618c", class: "sentinel", "data-sentinel": "bottom" })))), h("ix-icon-button", { key: "3dd841967af21ff9e0f22fb04ff055612731945f", onClick: () => this.changeCalendarView(1), icon: iconChevronRightSmall, variant: "tertiary", class: "arrows", "aria-label": this.ariaLabelNextMonthButton })), h("div", { key: "de060f11f27d5dad952af42bc3a266fae00cdfc5", role: "grid", class: {
      grid: true,
      "grid--show-week-numbers": this.showWeekNumbers
    } }, h("div", { key: "254fd54c9165ec36b2a5252a75c26feed2eaf5e7", role: "row" }, this.showWeekNumbers && h("div", { key: "091b76c0a893681bbda12ad4ba3e2cb62dad1db6", class: "calendar-item week-day", role: "columnheader" }), this.dayNames.map((name) => h("div", { key: name, class: "calendar-item week-day", role: "columnheader" }, h("div", { class: "overflow" }, name.slice(0, 3))))), this.calendar.map((week) => {
    ...
    })), h("div", { key: "b0d8aa1b08010d659b27324a6cd4a93402bdfe69", class: {
      button: true,
      hidden: this.singleSelection || this.embedded
    } }, h("ix-button", { key: "e11065b31eeba8993b2802d1c9473b3a0e0a90d8", hidden: this.singleSelection || this.embedded, onClick: () => this.onDone() }, this.i18nDone))));
  }
