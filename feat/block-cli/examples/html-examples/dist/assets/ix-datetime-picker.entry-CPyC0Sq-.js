...
const DatetimePicker = class {
  ...
  render() {
    ...
    return h(Host, { key: "31456afb5cb113f399cb3361d14fb2f417d86046" }, h("ix-date-time-card", { key: "efa1e72eb869157efb241862cae79b63dabc44fe", hideHeader: true, hasFooter: true, embedded: this.embedded, corners: "rounded", noPadding: true }, h("ix-layout-grid", { key: "4daae7f08d23d165dbf9c0799698e144f8229326", class: "no-padding" }, h("ix-row", { key: "660cdadda027525dedaf044b50e83df274a5e554", class: "row-separator" }, h("ix-col", { key: "6f63b76686fa48ae49025df7a5b22a0aa6c4fdd6", class: "col-separator" }, h("ix-date-picker", {
      key: "f127c81e8173b94f8b6df7bec54bbf1991c555a8",
    ...
    })), h("ix-col", { key: "93375c20d51b676ee5a409cbc5206707e8653437" }, h("ix-time-picker", {
      key: "aedbe1daf48082fd072815c72029bf40cfc0697e",
      class: "min-width",
      ...
      tabIndex: this.embedded ? -1 : 0,
      [TRAP_FOCUS_INCLUDE_ATTRIBUTE]: this.embedded
    })))), h("div", { key: "0a7482376fbff91fccecc82bbd1444b71113d7a7", slot: "footer", class: "btn-select-date-container" }, h("ix-button", { key: "de0bfbe84fa505d01880a217de812183cf4e9a6b", class: "btn-select-date", onClick: () => this.onDone() }, this.i18nDone))));
  }
  static get watchers() {
    return {
      "from": [{
