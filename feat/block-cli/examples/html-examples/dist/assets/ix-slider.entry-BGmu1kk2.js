...
const Slider = class {
  ...
  render() {
    ...
    return h(Host, { key: "3ea1eb9c558126e36eb77227c515ca1dee194997", class: {
      disabled: this.disabled,
      invalid: this.isInvalid,
      info: this.isInfo,
      valid: this.isValid,
      warning: this.isWarning
    }, onPointerDown: () => setTimeout(() => this.showTooltip = true) }, h("ix-field-wrapper", { key: "9358f9eb87b29b1b59aed83b598ed93c4ec79696", label: this.label, helperText: this.helperText, invalidText: this.invalidText, infoText: this.infoText, warningText: this.warningText, validText: this.validText, showTextAsTooltip: this.showTextAsTooltip, isValid: this.isValid, isInfo: this.isInfo, isWarning: this.isWarning, isInvalid: this.isInvalid, controlRef: this.controlRef }, h("div", { key: "147dd20fe90b857e1424b0150667aa2d746732f5", class: "slider-container" }, h("div", { key: "60dd9e4bfc6697c6380765ae777cfb2cf4da7a9f", class: "slider" }, h("div", { key: "7c8d1b618df5cb946c79f03a77184a55a84e70bc", class: "track" }, h("div", { key: "615899dd1db1461360c7622defdaa0b327ac5d33", ref: this.thumbRef, class: "thumb", style: {
      left: `calc(${valueInPercentage} * (100% - 1rem))`
    } }), h("svg", { key: "4bc0c0fe96e7b9a3cab981a8672765c36a6bd223", class: "ticks", xmlns: "http://www.w3.org/2000/svg" }, this.marker?.filter((markerValue) => markerValue >= this.min && markerValue <= this.max).map((markerValue) => {
    ...
    }))), h("input", { key: "13ee97e5e20c00a8f8b863866a5fb40e70e85fd6", id: "slider", ref: this.controlRef, type: "range", list: this.marker ? "markers" : void 0, step: this.step, min: this.min, max: this.max, value: this.rangeInput, tabindex: this.disabled ? -1 : 0, onInput: (event) => this.onInput(event), onFocus: () => {
    ...
    }, role: "slider", "aria-valuenow": this.rangeInput, "aria-valuemin": this.min, "aria-valuemax": this.max, ...this.a11yAttributes }), h("ix-tooltip", { key: "86630b3be34a9844d7144abe42c8b4cc8a76440f", ref: this.tooltipRef, class: {
      "hide-tooltip": !this.showTooltip
    }, animationFrame: true, for: this.thumbRef.waitForCurrent() }, this.rangeInput)), this.hasLabels && h("div", { key: "a88c76a2daa63d0e654175330aca8746149b4e2d", class: "label" }, h("div", { key: "f5e0774cda71ba3a4a5f11281998ee111ff452ba" }, h("slot", { key: "675d1b2fa5ed6f40ac4b32fee3fa464c37b5179e", name: "label-start" })), h("div", { key: "56abb810327801dccafe82a62a701d328f99a325" }, h("slot", { key: "5b64737ab0e2836de674d0921d573339f83aa88f", name: "label-end" }))))));
  }
