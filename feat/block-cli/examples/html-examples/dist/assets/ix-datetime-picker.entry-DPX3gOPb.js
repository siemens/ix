...
const DatetimePicker = class {
  ...
  render() {
    return h(Host, { key: "3dc2e40ff8f98b333e21a53d04a322320f19a08b" }, h("ix-date-time-card", { key: "14cc49509c3d61e46cd5c9aaccf408ff97f2f5cf", hideHeader: true, hasFooter: true, embedded: this.embedded, corners: "rounded", noPadding: true }, h("ix-layout-grid", { key: "c65586328545a75e43ea35894f8ccb725805fd3f", class: "no-padding" }, h("ix-row", { key: "5d791a88dd6caf340b3a9612547d7bec78d7cd63", class: "row-separator" }, h("ix-col", { key: "cdffd08c0e9e2ab843f764681e9ec57baa3dc6cd", class: "col-separator" }, h("ix-date-picker", {
      key: "d642940cf702a7f08300097025c654e57bbed6dd",
    ...
    })), h("ix-col", { key: "bc37b21f693438b8cf8af18461f878e829294a95" }, h("ix-time-picker", {
      key: "49451f00ae0feace435590e5d891c04ecbd32c91",
      class: "min-width",
      ...
      tabIndex: this.embedded ? -1 : 0,
      [TRAP_FOCUS_INCLUDE_ATTRIBUTE]: this.embedded
    })))), h("div", { key: "2c63352462d25a8c4a061c869884f1c87a0e1b13", slot: "footer", class: "btn-select-date-container" }, h("ix-button", { key: "46a351850ed2870548e055193d5195d5c61c9b57", class: "btn-select-date", onClick: () => this.onDone() }, this.i18nDone))));
  }
};
