...
const Group = class {
  ...
  render() {
    return h(Host, { key: "aa97b483cde57ea5ddf8a0d6e876e401a360c9e1" }, h("div", { key: "a7a538948127262d6266477a70167374fb44cdef", class: {
      "group-header": true,
      expand: this.expanded,
      selected: this.selected
    }, tabindex: "0" }, h("div", { key: "17c3c7657f0d91a14b408c3f55dbf502a7a58815", class: "group-header-clickable", onClick: (e) => this.onHeaderClick(e) }, h("div", { key: "e29cc0974478abe2776f566407d1437f86ea5af3", class: {
      "group-header-selection-indicator": true,
      "group-header-selection-indicator-item-selected": this.itemSelected
    } }), h("div", { key: "a86f1f979e4eee0aa4effa9faf3bc9c8f32c052e", class: "btn-expand-header" }, h("ix-icon", { key: "28a9e3652106ffc6d3b50281e86dff052cb871ef", "data-testid": "expand-collapsed-icon", class: {
      hidden: !this.showExpandCollapsedIcon
    }, name: this.expanded ? iconChevronUpSmall : iconChevronDownSmall, onClick: (event) => this.onExpandClick(event) })), h("div", { key: "18dde3e15440e1479d1149ca4ab8c3fdace6b561", class: "group-header-content" }, this.header ? h("div", { class: "group-header-props-container" }, h("div", { class: "group-header-title" }, h("span", { title: this.header }, this.header)), h("div", { class: "group-subheader", title: this.subHeader }, this.subHeader)) : null, h("slot", { key: "1df794ab081f83811ae294c88c35057e3439e454", name: "header" }))), this.hasDropdown && h("ix-group-context-menu", { key: "4762013ce5b77c82dc49185683069c6c0e560454" }, h("slot", { key: "b10ee9765c827e5b35fb0dff69f4371d92b17c6c", name: "dropdown" }))), h("div", { key: "f51ed4ea477cb73bad0d51a2112e8a75874112d1", class: {
      "group-content": true
    } }, h("div", { key: "8ca240124d0d88fd3fd8b670a67c9ab6c997174c", style: {
      display: this.expanded ? "contents" : "none"
    } }, h("slot", { key: "08fe6e8210795ca6b759358c2732cb16149ddd47", onSlotchange: () => {
      const slot = this.hostElement.shadowRoot?.querySelector("slot:not([name])");
      this.showExpandCollapsedIcon = hasSlottedElements(slot);
    } }), h("ix-group-item", { key: "636a7737128decef06b74d6714cb916319b508f7", class: {
      footer: true,
      "footer-visible": this.footerVisible
    }, groupFooter: true, suppressSelection: true }, h("slot", { key: "aa82fbacdb9e28adccfb8ad834efe411c1960d8f", name: "footer", onSlotchange: () => this.onSlotChange() })))));
  }
  static get watchers() {
    return {
      "selected": [{
