import { r as registerInstance, c as createEvent, g as getElement, h, F as Fragment, H as Host } from "./global-Dfa5QLOG.js";
...
const Checkbox = class {
  ...
  render() {
    return h(Host, { key: "8b54e522b13813ad8530c153030a8d6495c0566f", "aria-checked": a11yBoolean(this.checked), "aria-disabled": a11yBoolean(this.disabled), role: "checkbox", class: {
      disabled: this.disabled,
      checked: this.checked,
      indeterminate: this.indeterminate
    }, onFocus: () => this.touched = true, onBlur: () => this.ixBlur.emit() }, h("label", { key: "3cf0b435681861acedb146dc567b0b69c5e0759d" }, h("input", { key: "32b9a41f0505544b1526f006ddc3a2882b98a37d", "aria-checked": a11yBoolean(this.checked), required: this.required, disabled: this.disabled, checked: this.checked, ref: this.inputRef, type: "checkbox", onChange: () => this.setCheckedState(!this.checked) }), h("button", { key: "c2514f2b88d44db2e9e967ab7db10579e2ba8c8d", disabled: this.disabled, class: {
      checked: this.checked
    }, onClick: () => this.setCheckedState(!this.checked) }, this.renderCheckmark()), h("ix-typography", { key: "c0dcdd88745e489082d0cb4ce483b480d2b620e4", format: "label", textColor: this.disabled ? "weak" : "std" }, this.label, h("slot", { key: "2a257feca5e539ddf0d00c3e66ff374314168b83" }))));
  }
