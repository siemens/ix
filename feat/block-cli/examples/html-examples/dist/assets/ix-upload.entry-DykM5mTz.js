import { g as getElement, r as registerInstance, c as createEvent, h, H as Host } from "./global-DSse0xVy.js";
...
const Upload = class {
  ...
  render() {
    ...
    return h(Host, { key: "cd4d0d0c25faa05e94f3595b909a4084dfa1ebe1", ...a11y, "aria-disabled": disabled }, h("div", { key: "de3808af6761a884bcd5cc99e67fe8ddd232186f", class: {
    ...
    }, onDragOver: (e) => this.fileOver(e), onDragLeave: () => this.fileLeave() }, this.renderUploadState(), h("div", { key: "cda64c3a8060c4a841be847e3991dbfcda23e7cb" }, h("input", { key: "f26ec6c2a7f490a4c650a13d9cab25ca16cc12be", "aria-label": ariaLabel, "aria-disabled": disabled, multiple: this.multiple, type: "file", class: "upload-browser", id: "upload-browser", ...directoryAttributes, tabindex: "-1", onChange: (e) => {
      this.fileChangeEvent(e);
    }, accept: this.accept, disabled }), h("ix-button", { key: "f4f1271fe3be597825314c158070ae1a4ae4cac3", variant: "secondary", "aria-disabled": disabled, onClick: () => this.inputElement.click(), disabled }, this.i18nUploadFile ?? (this.directoryUpload ? "Upload folder…" : "Upload file…")))));
  }
};
