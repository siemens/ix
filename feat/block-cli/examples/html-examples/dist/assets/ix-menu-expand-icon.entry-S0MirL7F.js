...
import { J as iconDoubleChevronLeft, H as iconDoubleChevronRight } from "./index-DgUGsIlh-CLxQRaVd.js";
import { g as getButtonClasses } from "./base-button-DZdtpLxn-CXmN3hUZ.js";
...
const MenuExpandIcon = class {
  ...
  pinned = false;
  getSmallScreenIcon() {
    return h("button", { "aria-label": this.expanded ? this.i18nCollapse : this.i18nExpand, "aria-expanded": a11yBoolean(this.expanded), class: {
  ...
  getLargeScreenIcon() {
    return h("ix-icon-button", { "aria-label": this.expanded ? this.i18nCollapse : this.i18nExpand, "aria-expanded": a11yBoolean(this.expanded), icon: this.expanded ? iconDoubleChevronLeft : iconDoubleChevronRight, variant: "subtle-tertiary" });
  }
  getMenuIcon() {
  ...
  render() {
    return h(Host, { key: "f10d5490d40ee858353cd6dd8b465b688e6ea489", class: {
