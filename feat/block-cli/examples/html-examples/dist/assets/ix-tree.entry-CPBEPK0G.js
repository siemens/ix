...
const Tree = class {
  ...
  render() {
    return h(Host, { key: "ab35ef980ab517a58f74e15d9f479f146bd1023d", onClick: (event) => this.onTreeItemClick(event) }, h("slot", { key: "ce748f0de03a31919b4eb8bd367a2084088c3570" }));
  }
  static get watchers() {
    return {
      "model": [{
