...
import { h as iconChevronRight } from "./index-Cl7fhG1I-C77BCFLW.js";
...
const EventListItem = class {
  ...
  render() {
    ...
    return h(Host, { key: "bb04871724bb2c300511a2e8e17781fcbcf9d6d5", class: {
      disabled: this.disabled,
      [`event-list-item-${this.variant}`]: true
    } }, h("div", { key: "31f45375fc5821524921be43cde02bbddb7447dd", role: "listitem", "aria-disabled": a11yBoolean(this.disabled), class: {
      "event-list-item": true,
      selected: this.selected,
      disabled: this.disabled
    } }, h("div", { key: "28f0fca6e6d4e7ca3a43f0b4928fe451563a4a3d", class: `indicator ${!this.itemColor ? "indicator-empty" : ""}`, style: {
      "background-color": this.itemColor ? color : "inherit",
      opacity: `${this.disabled ? 0.4 : 1}`
    } }), h("div", { key: "4e8195799f98b6d89512f8abe018317a2f02fb9b", class: "event-list-item-container" }, h("div", { key: "bd4816da711184411fd07702bd393803c49b4dea", class: "event-content" }, h("slot", { key: "8a86a6f7a91cfd5bac38e42c10d7a5c0e6cd37a5" })), this.chevron && h("ix-icon", { key: "e4844bc1e6f772c36597fc442f4981a3128c8cf8", name: iconChevronRight, size: "16", class: "chevron-icon", "aria-hidden": "true" }))));
  }
};
