...
const CustomField = class {
  ...
  render() {
    return h(Host, { key: "141e9884e9294d19d91ca4e04de38898cf520b3e" }, h("ix-field-wrapper", { key: "76890503cabd0cf67e628df916b8a625f203ddd8", label: this.label, helperText: this.helperText, infoText: this.infoText, warningText: this.warningText, invalidText: this.invalidText, validText: this.validText, showTextAsTooltip: this.showTextAsTooltip, isInvalid: this.isInvalid, isValid: this.isValid, isInfo: this.isInfo, isWarning: this.isWarning, required: this.required }, h("slot", { key: "711c0ddafe9917709a8bd6bf36e0dd29aefc4c58" })));
  }
};
__decorate([
