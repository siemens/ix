...
import { O as OnListener } from "./listener-HgmS6ENE-D21cIY5g.js";
...
const Slider = class {
  ...
  render() {
    ...
    return h(Host, { key: "90788f9039eece0f5e866be1408198b992b74940", class: {
    ...
    }, onPointerDown: () => setTimeout(() => this.showTooltip = true) }, h("ix-field-wrapper", { key: "6eed0dc166e30c7b9e0b168de13ca3fcd4e06117", label: this.label, helperText: this.helperText, invalidText: this.invalidText, infoText: this.infoText, warningText: this.warningText, validText: this.validText, showTextAsTooltip: this.showTextAsTooltip, isValid: this.isValid, isInfo: this.isInfo, isWarning: this.isWarning, isInvalid: this.isInvalid, controlRef: this.controlRef }, h("div", { key: "003de924a41c08ae7e6638e43b13d531baed5016", class: "slider-container" }, h("div", { key: "8e09337db1dd59daa8832bdddb1ba5d4af3c9f51", class: "slider" }, h("div", { key: "7578e3e85a7f7d095744876fbf47d1e26f74469f", class: "track" }, h("div", { key: "2043e44b79d19d099449bb3a0cd938c756bb4aff", ref: this.thumbRef, class: "thumb", style: {
      left: `calc(${valueInPercentage} * (100% - 1rem))`
    } }), h("svg", { key: "2e936cb3bd11c37bb86c81756d883884c5f79856", class: "ticks", xmlns: "http://www.w3.org/2000/svg" }, this.marker?.filter((markerValue) => markerValue >= this.min && markerValue <= this.max).map((markerValue) => {
    ...
    }))), h("input", { key: "fdd023b6d3a09f97ace923de316b94b7ef2dd313", id: "slider", ref: this.controlRef, type: "range", list: this.marker ? "markers" : void 0, step: this.step, min: this.min, max: this.max, value: this.rangeInput, tabindex: this.disabled ? -1 : 0, onInput: (event) => this.onInput(event), onFocus: () => {
    ...
    }, role: "slider", "aria-valuenow": this.rangeInput, "aria-valuemin": this.min, "aria-valuemax": this.max, ...this.a11yAttributes }), h("ix-tooltip", { key: "0444b5331dcdd43fbc1bacfa3f99702206cd4839", ref: this.tooltipRef, class: {
      "hide-tooltip": !this.showTooltip
    }, animationFrame: true, for: this.thumbRef.waitForCurrent() }, this.rangeInput)), this.hasLabels && h("div", { key: "f3787dd9152207a4ca71f13f738196aaf8bfb56d", class: "label" }, h("div", { key: "6f5e13ccddbf7d0ee27a385bc597b64ef3e24ccc" }, h("slot", { key: "ffc9227a17374824e1ede5acf07f05bf4fb59b70", name: "label-start" })), h("div", { key: "ef9b7b7c91c491893519f3d4f865eda4388f8429" }, h("slot", { key: "fd913e61099c61025f5109da35f23e6860d9232f", name: "label-end" }))), this.error ? h("ix-typography", { textColor: "alarm" }, this.error) : null)));
  }
