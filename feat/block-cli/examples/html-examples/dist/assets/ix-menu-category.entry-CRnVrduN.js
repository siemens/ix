...
const MenuCategory = class {
  ...
  render() {
    ...
    } }, h("ix-menu-item", { key: "b3fbd62c77f657ee630dcc9c2395a6cf4bdd62cd", class: "category-parent", active: this.isNestedItemActive(), notifications: this.notifications, icon: this.icon, onClick: (e) => this.onCategoryClick(e), onFocus: () => this.onPointerEnter(), tooltipText: this.tooltipText, isCategory: true }, h("span", { key: "f66533195caf3b0f6e254827d62550d950ed8944", class: "category" }, h("span", { key: "45353a268d68f45a6785b9bc7f94025679048bf3", class: "category-text" }, this.label), h("ix-icon", { key: "8bc1272ba1766ee0b64c3f6926d7c0eaed5389ad", name: iconChevronDownSmall, class: {
      "category-chevron": true,
      "category-chevron--open": this.showItems
    }, "aria-hidden": "true" }))), h("div", { key: "e3d2df791d53472e5469fdad166081098b249b7c", ref: (ref) => this.menuItemsContainer = ref, class: {
      "menu-items": true,
      "menu-items--expanded": this.showItems,
      "menu-items--collapsed": !this.showItems
    } }, this.showItems ? h("slot", null) : null), h("ix-dropdown", { key: "c509727127187e16e1a370218678fc5f29f0aed4", closeBehavior: "both", show: this.showDropdown, onShowChanged: ({ detail: dropdownShown }) => {
    ...
    } }, h("ix-dropdown-item", { key: "d48b9fa97df866069e220ff03b2a7b376c0d6fdc", class: "category-dropdown-header" }, h("ix-typography", { key: "e55d8100b3c9bb89b982b063dbf25eea2379feab", format: "label", bold: true, textColor: "std" }, this.label)), h("ix-divider", { key: "262ace028e6ae0cb35b7494562b4934ef8cddc4b" }), h("slot", { key: "20e150304abf074a5534734e42bd7898fa4d3513" })));
  }
  get hostElement() {
