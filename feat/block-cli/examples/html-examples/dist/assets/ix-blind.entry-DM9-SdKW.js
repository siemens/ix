import { r as registerInstance, c as createEvent, h, F as Fragment, H as Host, g as getElement } from "./global-BlVZeLef.js";
...
const Blind = class {
  ...
  render() {
    return h(Host, { key: "d64558181bcb0a6d953808e56a6e22d825ad5757", class: {
      [`blind-${this.variant}`]: true
    } }, h("div", { key: "499ba01c67dacdba35167a8c45b409c87b5be351", class: "blind-header-wrapper" }, h("button", { key: "e41290c8cc9319e475255a64dc94c14b3c98473f", class: {
      "blind-header": true,
      [`blind-${this.variant}`]: true,
      closed: this.collapsed
    }, type: "button", "aria-labelledby": `ix-blind-header-title-${this.blindId}`, "aria-controls": `ix-blind-content-section-${this.blindId}`, "aria-expanded": a11yBoolean(!this.collapsed), onClick: () => this.onHeaderClick() }, h("slot", { key: "6a0fb08b029a210a1d669103347b1c9c3d01e516", name: "custom-header" })), h("div", { key: "9968980adf43d9430f25eecba8b922114f19be5d", class: "blind-header-content" }, h("ix-icon", { key: "ade4b42a1180ab50a45b54bcbc1c8e8d3bc5a2e2", class: "collapse-icon", name: iconChevronDownSmall, color: this.variant === "filled" || this.variant === "outline" ? "color-std-text" : `color-${this.variant}--contrast`, ref: (ref) => this.chevronRef = ref }), h("div", { key: "7942f5c5def4e93b9836dafe40c38e19b44789b6", class: "blind-header-title", id: `ix-blind-header-title-${this.blindId}` }, this.label !== void 0 ? h(Fragment, null, this.icon && h("ix-icon", { class: "blind-header-title-icon", name: this.icon, color: this.variant === "filled" || this.variant === "outline" ? "color-std-text" : `color-${this.variant}--contrast` }), h("div", { class: "blind-header-title-row" }, h("div", { class: "blind-header-title-col" }, h("ix-typography", { title: this.label, format: "label-lg", bold: true }, h("div", { class: "blind-header-title-label", title: this.label }, this.label))), this.sublabel && h("div", { class: "blind-header-title-col" }, h("ix-typography", { title: this.sublabel }, h("div", { class: "blind-header-title-sublabel" }, this.sublabel)))), h("div", { class: "header-actions" }, h("slot", { name: "header-actions" }))) : null))), h("section", { key: "7ebf2728aca4781ea0a4707e106bd06d1730c813", id: `ix-blind-content-section-${this.blindId}`, "aria-labelledby": `ix-blind-header-title-${this.blindId}` }, h("div", { key: "aae31a1d465ecf46ade591e562ff0194e7c37d9b", class: {
      "blind-content": true,
      hide: this.collapsed
