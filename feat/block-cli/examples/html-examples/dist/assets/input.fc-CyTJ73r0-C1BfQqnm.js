import { h } from "./global-CfZV-boF.js";
import { a as a11yBoolean } from "./a11y-DAzBNVe7-CO1Uj69l.js";
import { s as shouldSuppressInternalValidation } from "./validation-CTBekLDe-B46Sj2yD.js";
...
function TextareaElement(props) {
  ...
  }, required: props.required, value: props.value, placeholder: props.placeholder, onFocus: () => {
    var _a;
    return (_a = props.onFocus) === null || _a === void 0 ? void 0 : _a.call(props);
  }, onInput: (inputEvent) => {
...
function InputElement(props) {
  return h("input", Object.assign({ id: props.id, autoComplete: "off", readOnly: props.readonly, disabled: props.disabled, step: props.step, min: props.min, max: props.max, maxLength: props.maxLength ? Number(props.maxLength) : void 0, minLength: props.minLength ? Number(props.minLength) : void 0, ref: props.inputRef, pattern: props.pattern, type: props.type, class: {
    ...
    (_b = props.onEnterKeyChange) === null || _b === void 0 ? void 0 : _b.call(props, e);
...
export {
  ...
  onInputBlurWithChange as d,
  SlotStart as e,
  emitPickerValidityState as f,
