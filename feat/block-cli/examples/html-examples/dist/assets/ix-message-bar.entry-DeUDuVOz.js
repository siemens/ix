...
import { B as iconNotification, i as iconInfo, c as iconSuccess, a as iconWarning, C as iconWarningRhomb, b as iconError, r as iconClose } from "./index-Dn2eQInl-mXhHymhu.js";
...
const MessageBar = class {
  ...
  render() {
    return h(Host, { key: "ed05526195e1677f3520d80126fb4240cc7b4c10" }, h("div", { key: "1c94e84af7058d140d188aa76b7b883f03d3a45b", class: { "message-container": true, [this.type]: true }, role: "alert", ref: (el) => this.divElement = el }, h("ix-icon", { key: "7ae60ba2dbfa479223b9b1fca5cb2df80b055109", color: this.color, name: this.icon }), h("div", { key: "39d2d6825467bfea1eab61648afa59e1945eebcb", class: "message-content" }, h("slot", { key: "99339d5e3d5291ced3c7049b253ccd335e559f13" })), !this.persistent && h("ix-icon-button", { key: "dd72bb57e6e0f840d61c8ed50230d432ac53c83e", icon: iconClose, iconColor: "color-soft-text", size: "24", variant: "tertiary", onClick: () => {
      if (this.divElement) {
