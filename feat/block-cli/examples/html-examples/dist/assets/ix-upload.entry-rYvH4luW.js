import { g as getElement, r as registerInstance, c as createEvent, h, H as Host } from "./global-CRrZCTD3.js";
import { a as iconSuccess, b as iconError } from "./index-DgUGsIlh-CLxQRaVd.js";
...
const Upload = class {
  ...
  render() {
    ...
    return h(Host, { key: "c083054d0cf2a59a2fbfb5fe37cb425b78f0beff", ...a11y, "aria-disabled": disabled }, h("div", { key: "a977d8f93e9d337384106a3aa712ade78feb3fcb", class: {
    ...
    }, onDragOver: (e) => this.fileOver(e), onDragLeave: () => this.fileLeave() }, this.renderUploadState(), h("div", { key: "aee6c3cbb866a77156f77eb1f163973fc298d9d7" }, h("input", { key: "701e6b787f45a4cadf0febea60b53e7ce4cb8880", "aria-label": ariaLabel, "aria-disabled": disabled, multiple: this.multiple, type: "file", class: "upload-browser", id: "upload-browser", ...directoryAttributes, tabindex: "-1", onChange: (e) => {
      this.fileChangeEvent(e);
    }, accept: this.accept, disabled }), h("ix-button", { key: "9b2dc91551a114fa4c7ca6f520ea74d7273588f9", variant: "secondary", "aria-disabled": disabled, onClick: () => this.inputElement.click(), disabled }, this.i18nUploadFile ?? (this.directoryUpload ? "Upload folder…" : "Upload file…")))));
  }
};
