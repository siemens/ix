...
import { D as iconNotification, d as iconInfo, a as iconSuccess, c as iconWarning, E as iconWarningRhomb, b as iconError, A as iconClose } from "./index-BcWSlcx_-DijX28Uj.js";
...
const MessageBar = class {
  ...
  render() {
    return h(Host, { key: "444295d497fd1566058f97ae98187dc09a0a16f4" }, h("div", { key: "0741779d0b65921d476c0ecc51215bdada49d841", class: { "message-container": true, [this.type]: true }, role: "alert", ref: (el) => this.divElement = el }, h("ix-icon", { key: "a38e2b50c05b6d2dcc72c18696cd50eca3e7bc0d", color: this.color, name: this.icon }), h("div", { key: "46a3db138413792d8856b9ce10acd8a76944ec48", class: "message-content" }, h("slot", { key: "a860a8d066e4cfbb7177dc910d9e2eb4b6243104" })), !this.persistent && h("ix-icon-button", { key: "5e9af0f033a43ada4a6a2ce8ece94a61c147d1a4", icon: iconClose, iconColor: "color-soft-text", size: "24", variant: "tertiary", onClick: () => {
      if (this.divElement) {
