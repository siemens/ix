...
import { c as iconWarning, x as iconAlarm } from "./index-BcWSlcx_-DijX28Uj.js";
...
const Kpi = class {
  ...
  render() {
    return h(Host, { key: "5b95feae1e05f3fb738623fc360986d42b03d07b", title: this.getTooltipText(), tabindex: "1", class: {
      stacked: this.orientation === "vertical"
    } }, h("div", { key: "adb8317a65e6e339a196152c8570f9b52f1c5498", class: {
      "kpi-container": true,
      alarm: this.state === "alarm",
      warning: this.state === "warning"
    } }, h("span", { key: "d50eb1fd88e6740151e9b5cf0a01fb8cfde4f456", class: "kpi-label" }, this.getStateIcon(), h("span", { key: "3a4d5d9f02cdeabbbeaf0965e05ca250f2e81921", class: "kpi-label-text" }, this.label)), h("span", { key: "c9d4c9f4ff7b736e1af00c7ac00f6fe2b4df7599", class: "kpi-value-container" }, h("span", { key: "d2910f17aab189d0f2e95c1f67d4e48649243c2e", class: "kpi-value" }, this.value), this.unit ? h("span", { class: "kpi-unit" }, this.unit) : "")));
  }
};
Kpi.style = kpiCss();
export {
