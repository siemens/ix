import { M as Mixin, r as registerInstance, g as getElement, a as readTask, h, F as Fragment, H as Host, c as createEvent } from "./global-J1r-v9CX.js";
...
import { P as PROXY_LISTITEM_ID_SUFFIX, u as updateFocusProxyList, F as FocusProxy } from "./focus-proxy-BQyoX-Kl-0lewoSX0.js";
...
const MenuAvatarItem = class {
  ...
  render() {
    return h("ix-dropdown-item", { key: "3ef1a3be3ea175f25e232ad5c4f50aa44a226888", ref: this.dropdownItemRef, icon: this.icon, label: this.label, onClick: (e) => this.itemClick.emit(e) });
  }
};
