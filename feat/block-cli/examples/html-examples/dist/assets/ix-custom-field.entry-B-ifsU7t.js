...
const CustomField = class {
  ...
  render() {
    return h(Host, { key: "fa5ce034f61db6526407119b866403b3945c1ace" }, h("ix-field-wrapper", { key: "cb673d4ee02483b77b118a60bf1b8d7fdc35de45", label: this.label, helperText: this.helperText, infoText: this.infoText, warningText: this.warningText, invalidText: this.invalidText, validText: this.validText, showTextAsTooltip: this.showTextAsTooltip, isInvalid: this.isInvalid, isValid: this.isValid, isInfo: this.isInfo, isWarning: this.isWarning, required: this.required }, h("slot", { key: "11dd1d4a44c58cb5e1cc67795fc2ae10220d97e1" })));
  }
};
__decorate([
