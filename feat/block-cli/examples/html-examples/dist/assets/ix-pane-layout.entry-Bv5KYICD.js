import { r as registerInstance, g as getElement, f as forceUpdate, h, H as Host } from "./global-DSse0xVy.js";
...
const Panes = class {
  ...
  render() {
    return h(Host, { key: "121b6700d4fc8399a653e5a37bebe99ab71bcec0" }, !this.isMobile ? this.layout == "full-vertical" ? h("div", { class: "side-panes-wrapper" }, h("div", { class: {
      row: true,
