import { M as Mixin, r as registerInstance, g as getElement, h, H as Host } from "./global-C_dy4gBz.js";
...
const Button = class extends Mixin(...DefaultMixins) {
  constructor(hostRef) {
    super();
  ...
  render() {
    ...
    return h(Host, { key: "49ccec169248da0ce8943783a8d8a84b8a8b7dcf", class: {
      disabled: this.disabled || this.loading
    }, tabIndex: this.disabled || this.loading ? -1 : 0 }, h(BaseButton, { key: "cde63b027b66167c10de9245756d591e4fdb3e6a", ...baseButtonProps }, h("slot", { key: "4e26bf1e30ad0de9fc24493af2682ea598ce5122" })));
  }
