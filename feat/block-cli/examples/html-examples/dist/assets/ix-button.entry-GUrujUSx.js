...
const Button = class extends Mixin(...DefaultMixins, InheritAriaAttributesMixin) {
  ...
  render() {
    ...
    return h(Host, { key: "29acf8103090870a19e98bd7a6b2ca2a971c33af", class: {
      disabled: this.disabled || this.loading
    }, tabIndex: this.disabled || this.loading ? -1 : 0 }, h(BaseButton, { key: "7366b8c8e92eb423e7dd263d997c9a7c44473a2e", ...baseButtonProps }, h("slot", { key: "e07a63b01fd9a889e82d5474423b58f76f465677" })));
  }
