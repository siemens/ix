...
import { c as createClassMutationObserver } from "./validation-DnyZtQqc-C5Ryfcp9.js";
...
const Radio = class {
  ...
  render() {
    ...
    return h(Host, { key: "dd80bb5b3cbb88a2ad456cd56165670f1c7924da", "aria-checked": a11yBoolean(this.checked), "aria-disabled": a11yBoolean(this.disabled), role: "radio", tabindex: tabIndex, class: {
      ...
      if (this.disabled)
        return;
      this.setCheckedState(true);
    }, onKeyDown: (event) => this.onKeyDown(event), onBlur: () => this.ixBlur.emit() }, h("label", { key: "4973842fffb1f98e35ee0931d22c726d7e6c6f29" }, h("div", { key: "95877a6bac0bfe381067cb5c40958cae0f2b72bb", class: "radio-button" }, h("div", { key: "d1e11adbff497801d4db7ad93111c2509c93925a", "aria-hidden": "true", class: {
      ["radio-checkmark"]: true,
      checked: this.checked
    } }, h("div", { key: "b77bd9126f8ee94b1d7a4824535d5cffdffbb829", class: "checkmark", style: { visibility: this.checked ? "visible" : "hidden" } }))), this.label && h("ix-typography", { key: "4a35a1b6dfd56c4f5a6f7906a8255441ebb0bb28", format: "label", textColor: this.disabled ? "weak" : "std" }, this.label, h("slot", { key: "01d5fbdc42e521df1f976b46091c513d39764389" }))));
  }
