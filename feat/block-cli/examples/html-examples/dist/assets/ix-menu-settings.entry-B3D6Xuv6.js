import { r as registerInstance, c as createEvent, g as getElement, f as forceUpdate, h, H as Host } from "./global-DSse0xVy.js";
...
const MenuSettings = class {
  ...
  render() {
    return h(Host, { key: "1240428223abd15a955665d2750c95abdfcf5c5d", slot: "ix-menu-settings", class: {
      show: this.show,
      ["legacy-tabs"]: !this.suppressLegacyTabs
    } }, h("div", { key: "159ffeb708034dc062490eb31d94368b81db2137", class: "settings-header" }, h("h2", { key: "8408f85bdc2595f38d1140bacd76472e91cca8d3", class: "text-h2" }, this.label), h("ix-icon-button", { key: "e588dadc5dcbdc4aba4bc356d302205317489f40", variant: "tertiary", size: "24", icon: iconClose, iconColor: "color-soft-text", "aria-label": this.ariaLabelCloseButton, onClick: (e) => this.close.emit({
