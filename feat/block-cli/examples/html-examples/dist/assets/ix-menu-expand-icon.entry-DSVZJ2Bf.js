import { r as registerInstance, h, H as Host } from "./global-Cr1KQvOo.js";
import { H as iconDoubleChevronLeft, F as iconDoubleChevronRight } from "./index-ClV1Tffv-Cwm_ckfF.js";
import { g as getButtonClasses } from "./base-button-dgtIhz81-D-Ni86l8.js";
...
const MenuExpandIcon = class {
  ...
  ixAriaLabel = "Expand";
  getSmallScreenIcon() {
    return h("button", { "aria-hidden": "true", class: {
  ...
  getLargeScreenIcon() {
    return h("ix-icon-button", { icon: this.expanded ? iconDoubleChevronLeft : iconDoubleChevronRight, "aria-hidden": "true", variant: "subtle-tertiary", "aria-label": this.expanded ? "Collapse menu" : "Expand menu" });
  }
  getMenuIcon() {
    if (this.pinned) {
  ...
  render() {
    return h(Host, { key: "2b896d364e8e5402e517237a8f5575d30e67b432", class: {
      expanded: this.expanded,
      "ix-focusable": true
    }, "aria-label": this.ixAriaLabel, "aria-pressed": a11yBoolean(this.expanded) }, this.getMenuIcon());
  }
