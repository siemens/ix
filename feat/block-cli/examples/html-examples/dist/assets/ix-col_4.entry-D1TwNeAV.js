import { r as registerInstance, f as forceUpdate, h, H as Host, M as Mixin, c as createEvent, g as getElement } from "./global-C8IWpzMv.js";
...
import { O as OnListener } from "./listener-BjluJgvO-_NsNdydD.js";
...
const Col = class {
  ...
  render() {
    return h(Host, { key: "005d0fc9cd15712284a7cb926db0c1e5b3a8c446", style: {
      ...this.getColumnSizeStyling()
    } }, h("slot", { key: "b5d52bb0be25af58cbcf44b410648b662cefcae2" }));
  }
};
Col.style = colCss();
...
const LayoutGrid = class {
  ...
  columns = 12;
  render() {
    return h(Host, { key: "cf999b564a7299145b9826f7ccfa14ac78b59fa1", class: {
      "no-margin": this.noMargin
    }, style: {
      "--ix-layout-grid-columns": `${this.columns}`,
      "--ix-layout-grid-gutter": `${this.gap}px`
    } }, h("slot", { key: "b129c28c62c80001e1c6bfda9a726f37765853f5" }));
  }
};
...
const Row = class {
  ...
  render() {
    return h(Host, { key: "0f64cae960e3bd1900b506ac7985365896dab5de" }, h("slot", { key: "e224162b23c43050ad9dd81ad04ef165221dbf62" }));
  }
};
Row.style = rowCss();
