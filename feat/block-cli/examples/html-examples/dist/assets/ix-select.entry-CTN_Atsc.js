...
import { C as iconPlus, l as iconClear, r as iconChevronUpSmall, h as iconChevronDownSmall } from "./index-8HpPmDK_-DinFJk0z.js";
...
import { O as OnListener } from "./listener-DAJkOQte-B9AMANTr.js";
...
const Select = class {
  ...
  render() {
    var _a, _b, _c, _d;
    return h(Host, { key: "16454f9b21b23a17baac6e5eaa957aa453b0e0a2", "aria-disabled": a11yBoolean(this.disabled), class: {
      disabled: this.disabled
    } }, h("ix-field-wrapper", { key: "96b609b89bef44bf6c82dc917edba6ecd88e51c2", required: this.required, label: this.label, helperText: this.helperText, invalidText: this.invalidText, infoText: this.infoText, warningText: this.warningText, validText: this.validText, showTextAsTooltip: this.showTextAsTooltip, isInvalid: this.isInvalid, isValid: this.isValid, isInfo: this.isInfo, isWarning: this.isWarning, controlRef: this.inputRef }, h("div", { key: "4dd833dc65b9f45ac0385591594a7d99b1de28f6", class: {
      select: true,
      disabled: this.disabled,
    ...
    } }, h("div", { key: "65c49fc23c705bd5364e10f39ee87ba462a057a6", class: "input-container" }, h("div", { key: "0079646e32601565ada100451382706439fa64ff", class: "chips" }, this.isMultipleMode && this.items.length !== 0 && (this.shouldDisplayAllChip() ? this.renderAllChip() : (_a = this.selectedItems) === null || _a === void 0 ? void 0 : _a.map((item) => this.renderChip(item))), h("div", { key: "fa3c5d8c3ddaa1ed0219c1eb90473bd8752e0c27", class: "trigger" }, h("input", { key: "c1f859d6205dcef08b82e2756ad596af673fe970", autocomplete: "off", "data-testid": "input", disabled: this.disabled, readOnly: this.readonly, required: this.required, type: "text", class: {
      ...
      if (this.editable)
        this.dropdownWrapperRef(ref);
    }, "aria-label": this.ariaLabelChevronDownIconButton })))))), h("ix-dropdown", { key: "15f75d4cf2d81b0c6aa58d8e662282e7e1c72dc4", ref: (ref) => this.dropdownElement = ref, show: this.dropdownShow, closeBehavior: this.isMultipleMode ? "outside" : "both", class: {
    ...
    } }, h("div", { key: "01c0dc6db08b6439b9de3cefa0ac293f4bc04c14", class: {
      "select-list-header": true,
      hidden: this.hideListHeader || this.isDropdownEmpty
    }, title: this.i18nSelectListHeader, onClick: (e) => e.preventDefault() }, this.i18nSelectListHeader), h("slot", { key: "153ab49821fcba5e4f4dd82e1fb8e42c433d46a9", onSlotchange: () => {
      this.updateSelection();
    } }), h("div", { key: "5ea826f1b837b3f6945b796923cbf5f24f52eb0d", ref: (ref) => this.customItemsContainerElement = ref }), this.isAddItemVisible() ? h("ix-dropdown-item", { "data-testid": "add-item", icon: iconPlus, class: {
      "add-item": true
