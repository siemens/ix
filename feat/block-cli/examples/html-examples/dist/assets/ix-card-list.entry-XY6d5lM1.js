...
const CardList = class {
  ...
  render() {
    return h(Host, { key: "ccebc94e27c528ef46549e297d3e775d68f1bfe4" }, h(CardListTitle, { key: "1e432e26434fb3dd69b7c98cb25afb70dfcb16ac", isCollapsed: this.collapse, label: this.label, showAllLabel: this.i18nShowAll, showAllCounter: this.showAllCount === void 0 ? this.numberOfAllChildElements : this.showAllCount, showLess: this.isShowingAll, labelShowLess: this.i18nShowLess, onClick: () => this.onCardListVisibilityToggle(), onShowAllClick: (e) => this.onShowAllClick(e), hideShowAll: this.hideShowAll }), h("div", { key: "85d4e7d14cd2139508e2d53889f6eb74f4cff884", class: {
      CardList__Overflow: true
    }, style: this.computeMaskLayer() }, h("div", { key: "b35c9a4225045f20cb37120b0cd07fa6479c88ad", class: {
    ...
    }, onScroll: () => this.onCardListScroll() }, h("slot", { key: "90bd9868dd71f350b9b96aeee1577fdb4a90e387", onSlotchange: () => {
      this.changeVisibilityOfSlotChildren();
