import { a as registerInstance, c as createEvent, g as getElement, h, H as Host, M as Mixin } from "./global-DX2OdaCL.js";
import { s as iconCloseSmall } from "./index-Cl7fhG1I-C77BCFLW.js";
import { b as a11yHostAttributes } from "./a11y-B5k8YVR0-BOSd6BQK.js";
import { a as IX_FOCUS_VISIBLE_ACTIVE, I as IX_FOCUS_VISIBLE } from "./focus-utilities-DnaItyVQ-Degzwldb.js";
import { D as DefaultMixins } from "./component-Chfbghog-DFMCI9TH.js";
import { F as FocusVisibleMixin } from "./focus-visible.mixin-CoMZ6z5Z-Do56_3Dn.js";
...
const FilterChip = class {
  ...
  render() {
    return h(Host, { key: "9841430ba413f80306e58e57a00171a5c25dcb30", class: { disabled: this.disabled, readonly: this.readonly }, title: this.hostElement.textContent }, h("div", { key: "35110f7c7d5e10b2f0369b0662b7c09f476f2808", class: "slot-container" }, h("slot", { key: "6ab57ea45ff84f87f4cc569c455fb896336c8392" })), !this.disabled && !this.readonly ? h("ix-icon-button", { variant: "tertiary", oval: true, icon: iconCloseSmall, size: "16", disabled: this.disabled, onClick: (event) => {
...
const SelectItem = class extends Mixin(...DefaultMixins, FocusVisibleMixin, ComponentIdMixin) {
  ...
  render() {
    ...
    return h(Host, { key: "bd36d9c3766ad10aab248610c75f30794d1382a4", ...ariaAttributes, id: this.getHostElementId(), disableAriaSelectHandling: true, class: {
      [IX_FOCUS_VISIBLE]: true
    }, "aria-hidden": "true", role: "presentation" }, h("ix-dropdown-item", { key: "8bca28e8053fc2a06c4c856e0ded3d1f7bfd11b5", "aria-hidden": "true", itemRole: "option", class: {
