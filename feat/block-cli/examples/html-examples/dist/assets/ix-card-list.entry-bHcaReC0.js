...
import { e as iconMoreMenu, j as iconChevronDown } from "./index-8HpPmDK_-DinFJk0z.js";
...
const CardList = class {
  ...
  render() {
    return h(Host, { key: "e8a189b7c1eae4b670d721927ac76918d026994c" }, h(CardListTitle, { key: "0a3ecf9bb88cb6a4e138969a510bb1f51c986eb1", isCollapsed: this.collapse, label: this.label, showAllLabel: this.i18nShowAll, showAllCounter: this.showAllCount === void 0 ? this.numberOfAllChildElements : this.showAllCount, onClick: () => this.onCardListVisibilityToggle(), onShowAllClick: (e) => this.onShowAllClick(e), hideShowAll: this.hideShowAll }), h("div", { key: "c87aad6c816bd6194471880c1544e33d8961f184", class: {
      CardList__Overflow: true
    }, style: this.computeMaskLayer() }, h("div", { key: "486d503dbe836bf9d7c41b5962e029e60bf2f60b", class: {
    ...
    }, onScroll: () => this.onCardListScroll() }, h("slot", { key: "85d916aed9cfd14190efcb3c542dfaab2414b398", onSlotchange: () => this.changeVisibilityOfSlotChildren() }), this.isShowMoreCardVisible() ? h("ix-card", { class: {
