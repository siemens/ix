...
const Tree = class {
  ...
  render() {
    return h(Host, { key: "a5f82422606cfcfd35ebf7e5b421d7d2ab5d4f3b", onClick: (event) => this.onTreeItemClick(event) }, h("slot", { key: "9a9d460a7fc15012264c8bb733b90d6c308ce131" }));
  }
  static get watchers() {
    return {
      "model": [{
