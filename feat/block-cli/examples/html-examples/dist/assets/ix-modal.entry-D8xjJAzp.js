...
const Modal = class {
  ...
  slideInModal() {
    ...
    modulesExports.animate(this.dialog, {
      duration,
      opacity: [0, 1],
      translateY,
      translateX: ["-50%", "-50%"],
  ...
  render() {
    return h(Host, { key: "2fb1d780737a69f1cd5ed11d2a1997587e916ca7", class: {
      visible: this.modalVisible,
      "no-backdrop": this.hideBackdrop,
      "align-center": this.centered
    } }, h("div", { key: "8ee737baa4f0a1f2a3227d01e5794d991dea343c", class: "dialog-backdrop" }, h("dialog", { key: "52cdd037026710572231f3c03e34d00ab9dbbd65", "aria-modal": a11yBoolean(true), "aria-describedby": this.ariaAttributes["aria-describedby"], "aria-labelledby": this.ariaAttributes["aria-labelledby"], class: {
      modal: true,
      [`modal-size-${this.size}`]: true
    }, onClose: () => this.dismissModal(), onMouseDown: (event) => this.onMouseDown(event), onMouseUp: (event) => this.onMouseUp(event), onCancel: (e) => {
      e.preventDefault();
      this.dismissModal();
    } }, h("slot", { key: "7cc3406200c783595a78babb1c4baa0a8644057f" }))));
  }
};
__decorate([
