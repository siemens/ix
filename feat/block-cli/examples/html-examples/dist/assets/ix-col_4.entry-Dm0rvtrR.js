import { r as registerInstance, f as forceUpdate, h, H as Host, M as Mixin, c as createEvent, g as getElement } from "./global-B1t25MFd.js";
...
const LayoutGrid = class {
  ...
  columns = 12;
  render() {
    return h(Host, { key: "018739414152eb1bad9ed6f3a0e715b9bebf2778", class: {
      "no-margin": this.noMargin
    }, style: {
      "--ix-layout-grid-columns": `${this.columns}`,
      "--ix-layout-grid-gutter": `${this.gap}px`
    } }, h("slot", { key: "5e2249e45e8bd06da4a3a6cc0c6990f3db63dea9" }));
  }
};
...
const Row = class {
  ...
  render() {
    return h(Host, { key: "3e0a505aacd239c514c417fcbef7fe9cd696b702" }, h("slot", { key: "40cc60c3f0a2be4624df1a5679960710f0698df7" }));
  }
};
Row.style = rowCss();
...
const TimePicker = class extends Mixin(...DefaultMixins) {
  ...
  render() {
    return h(Host, { key: "10bb40400839985afcf199cd2a3a728bdde8a52e" }, h("ix-date-time-card", { key: "10a5d8a0ea8dca5e29554a4567335cc1b7743995", embedded: this.embedded, timePickerAppearance: true, corners: this.corners, hasFooter: !this.dateTimePickerAppearance, hideHeader: this.hideHeader }, h("div", { key: "5f561f3f7e986083b0940f7884f780bb3ae23235", class: "header", slot: "header" }, h("ix-typography", { key: "a964f8607e49fb771ec6bf2e4a85b80976633a78", format: "body" }, this.i18nHeader)), h("div", { key: "6752db17ebdc8d4e766546432f63081936182ac3", class: "clock" }, this.timePickerDescriptors.map((descriptor, index) => {
    ...
    }), this.timeRef && h("div", { key: "f620387635c171b33ee3b969aa687a320a03b0bc", class: "flex" }, h("div", { key: "16dd5c4db711c24d5eb7ceead482dc1d7de7dbe2", class: "column-separator" }), h("div", { key: "1a65c1de10da1f4e9e30dc9b32958cdc1ec55ecf", class: "columns" }, h("div", { key: "629da7696485b8d7f17da66bb31c60b029db3326", class: "column-header", title: "AM/PM" }), h("div", { key: "73ae52af178a467b7a8683f1c09b2231d9869ac3", class: "element-list", tabIndex: -1 }, h("button", { key: "2a001d0803e8e77c8367576598c4461ad95ba4e5", "data-am-pm-id": "AM", class: {
      selected: this.timeRef === "AM",
      "element-container": true
    }, onClick: () => this.changeTimeReference("AM"), tabindex: "0", "aria-label": "AM" }, "AM"), h("button", { key: "45b48e90464913777a641ff6ea1613cf25774010", "data-am-pm-id": "PM", class: {
      selected: this.timeRef === "PM",
      "element-container": true
    }, onClick: () => this.changeTimeReference("PM"), tabindex: "0", "aria-label": "PM" }, "PM"))))), h("div", { key: "574e3febdb04fd971bf62d0ef595c1224b99bb53", class: {
      footer: true,
      "footer--compact": this.timePickerDescriptors.length <= 2
    }, slot: "footer" }, h("ix-button", { key: "944dc540c7c7ddcb307f33bb05b106db8e137e20", class: "confirm-button", onClick: () => {
