...
const Pane = class {
  ...
  render() {
    ...
    return h(Host, { key: "954e31cf356f32c3ac963a56f24bd445f94da694", class: {
    ...
    }, "aria-expanded": a11yBoolean(this.expanded) }, h("aside", { key: "bc04a82f8fa16c09f259eb2bf0c089e798743da9", id: `pane-${this.composition}`, class: {
      "top-bottom-pane": this.isBottomTopPane && !this.isMobile,
      "left-right-pane": this.isLeftRightPane && !this.isMobile,
      "mobile-pane": this.isMobile,
      expanded: this.expanded
    } }, h("div", { key: "77eb7a898948474691cec9ace48e90a2435863f9", id: "title-div", class: {
    ...
    } }, h("ix-icon-button", { key: "7dccca21d3095659749fa56512cf9ed864db3f49", class: "title-icon", size: "24", icon: this.expanded ? this.isMobile || this.hideOnCollapse ? iconClose : this.expandIcon : this.minimizeIcon, iconColor: this.expanded && (this.isMobile || this.hideOnCollapse) ? "color-soft-text" : void 0, variant: "subtle-tertiary", onClick: () => this.dispatchExpandedChangedEvent(), "aria-controls": `pane-${this.composition}`, "aria-label": this.ariaLabelCollapseCloseButton }), h("div", { key: "cc5a26129d28bff8686c6fc6977dc4d7f9e694ba", class: {
      "title-text": true,
      rotate
    } }, this.icon && h("ix-icon", { key: "1dd4f3769f7cab70e051834f9b11194f0a84acd8", class: "pane-icon", size: "24", name: this.icon, "aria-label": this.ariaLabelIcon }), h("div", { key: "d18bd30e5838361763b6dff1a3683d84fe6bc0ee", class: "title-text-overflow" }, h("ix-typography", { key: "6baded335be9e595ff962d64f7c31b8487e8ccec", format: "h4" }, this.heading)), this.expanded && h("div", { key: "b9e4497309d457d6746756179905be836f59b5a7", class: "slot-header" }, h("slot", { key: "3058bc3b3992bf7ed4a4572343cf0593bf4814cd", name: "header" })))), h("div", { key: "1948e53696862a67535e1649f8d02847c35d4bcd", class: "side-pane-content", hidden: !this.showContent }, h("slot", { key: "d225b1ea27e8abfaf1a59b91a3e4da6ac4cc2a3f" }))));
  }
  get hostElement() {
