import { r as registerInstance, c as createEvent, h, H as Host } from "./global-Cr1KQvOo.js";
import { m as iconClear, l as iconSearch } from "./index-ClV1Tffv-Cwm_ckfF.js";
...
const ExpandingSearch = class {
  ...
  render() {
    return h(Host, { key: "62f548528f3c5108192fa1d2dbb23fa99ce77cb3", class: {
      expanded: this.expanded,
      "right-position": this.expanded,
      fullWidth: this.fullWidth
    } }, h("ix-icon-button", { key: "a44ac00e756e5d8972996fd2cd07ab913cd07b40", size: this.expanded ? "16" : "24", icon: this.icon ?? iconSearch, variant: this.expanded ? "tertiary" : this.variant, "data-testid": "button", onClick: () => this.expandInput(), tabindex: this.expanded ? -1 : 0, color: this.hasFocus ? "input-search-icon--color--focus" : void 0, class: {
      "btn-search": true,
      "btn-search--expanded": this.expanded
    }, "aria-label": this.ariaLabelSearchIconButton ?? (this.expanded ? "Close search" : "Open search") }), h("div", { key: "5da9d63094163f7034f57dba40aa2e1641defe28", class: {
      expanded: this.expanded,
      fullWidth: this.fullWidth,
      collapsed: !this.expanded,
      "disable-pointer": !this.expanded,
      "input-container": true
    }, "data-testid": "input-wrapper" }, h("input", { key: "f80abdc294c58deb8f622fcd640ffffbdd29ca93", class: {
