...
const Pane = class {
  ...
  render() {
    ...
    return h(Host, { key: "1bc487ffd749edafef9d0c992a76c3cc617fb048", class: {
    ...
    }, "aria-expanded": a11yBoolean(this.expanded) }, h("aside", { key: "c798d7c9b45c2266c0ed9387ce1aa4dfe71f8595", id: `pane-${this.composition}`, class: {
      "top-bottom-pane": this.isBottomTopPane && !this.isMobile,
      "left-right-pane": this.isLeftRightPane && !this.isMobile,
      "mobile-pane": this.isMobile,
      expanded: this.expanded
    } }, h("div", { key: "45fec10ec55ad4e95f1c5892f5f9750643da8792", id: "title-div", class: {
    ...
    } }, h("ix-icon-button", { key: "c47667a2a46c56b017c4d43e52d873939ee43bf7", class: "title-icon", size: "24", icon: this.expanded ? this.isMobile || this.hideOnCollapse ? iconClose : this.expandIcon : this.minimizeIcon, iconColor: this.expanded && (this.isMobile || this.hideOnCollapse) ? "color-soft-text" : void 0, variant: "subtle-tertiary", onClick: () => this.dispatchExpandedChangedEvent(), "aria-controls": `pane-${this.composition}`, "aria-label": paneButtonAriaLabel }), h("div", { key: "260523073b378f6d4e18c766687fd4296252271c", class: {
      "title-text": true,
      rotate
    } }, this.icon && h("ix-icon", { key: "35e65ec0f219cc13501a0c70204187f4540e960d", class: "pane-icon", size: "24", name: this.icon, "aria-label": this.ariaLabelIcon }), h("div", { key: "bbb892642e49e50526f8c5803052b1491bde8e29", class: "title-text-overflow" }, h("ix-typography", { key: "e522eb43062e01bc6fad8772d90c597a9f1764f2", format: "h4" }, this.heading)), this.expanded && h("div", { key: "174b4d3799a6b292b0ecba50d64d52fe0528b625", class: "slot-header" }, h("slot", { key: "7e54f7b81fe2d15b57587370eadb4b2bff6149cc", name: "header" })))), h("div", { key: "89e5a31089b5ca95dc60bf6ef8d2d6f21b9a6aec", class: {
      "side-pane-content": true,
      "no-padding": this.noPadding
    }, hidden: !this.showContent }, h("slot", { key: "8c0b5b86f53553ec2cc4d95c14400b2bf0bf79e0" }))));
  }
  static get watchers() {
    return {
      "expanded": [{
