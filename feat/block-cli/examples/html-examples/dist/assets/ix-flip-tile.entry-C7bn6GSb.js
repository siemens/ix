...
import { u as iconEye } from "./index-BcWSlcx_-DijX28Uj.js";
...
const FlipTile = class {
  ...
  render() {
    return h(Host, { key: "351db54bcb39b92cff1022b23283351f67a41394", class: {
    ...
    } }, h("div", { key: "75f4fb383226418d6a4f8c3b908941123c9c82e1", class: "flip-tile-container" }, h("div", { key: "bbd41d5a87888702f2bc827a5c8c9e55bfd6375f", class: "flip-tile-header" }, h("div", { key: "0de8aec4da45463ae578e262e570e8f1fc63c1f3", class: "header-slot-container text-l-title" }, h("slot", { key: "aa2a076b0f4057d09637caa6fe2ec8e2b42246af", name: "header" })), h("ix-icon-button", { key: "3f36bab2521a9491344e75440c839c4a8398c6f8", icon: iconEye, variant: "tertiary", onClick: () => this.toggleIndex(), "aria-label": this.ariaLabelEyeIconButton })), h("div", { key: "1736ed16a769843efd2b4213c45915d0b1b95562", class: "content-container" }, h("slot", { key: "c49c5863e55ae882029c91b916ecc768e69099ea" })), h("div", { key: "f589dc26f2d7083c90522f257bd82cb2864a57ac", class: {
      footer: true,
      "show-footer": this.hasFooterSlot
    } }, h("slot", { key: "77b25a027e2de25e3072c15e284f4d30720b910c", name: "footer", onSlotchange: (event) => this.handleFooterSlotChange(event) }))));
  }
  static get watchers() {
    return {
      "index": [{
