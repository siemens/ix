...
import { p as iconCalendar } from "./index-BBzEV-f4-ChQfUIyc.js";
import { D as DateTime } from "./datetime-D1WplX1z-grPSvmS5.js";
import { c as createPickerValidityStateTracker, a as addDisposableChangesAndVisibilityObservers, b as adjustPaddingForStartAndEnd, o as onEnterKeyChangeEmit, h as handleSubmitOnEnterKeydown, S as SlotEnd, d as onInputBlurWithChange, e as SlotStart, f as emitPickerValidityState } from "./input.fc-CyTJ73r0-C1BfQqnm.js";
import { c as createClassMutationObserver, g as getValidationText, H as HookValidationLifecycle } from "./validation-CTBekLDe-B46Sj2yD.js";
...
const DateInput = class {
  ...
  async onInput(value) {
    ...
    if (this.isInputInvalid) {
      this.invalidReason = (_a = date.invalidReason) !== null && _a !== void 0 ? _a : void 0;
      this.from = void 0;
    } else {
      this.updateFormInternalValue(value);
      this.closeDropdown();
  ...
  render() {
    ...
    return h(Host, { key: "207e865e04753a6c38b4ed7854e24479519f947c", class: {
      disabled: this.disabled,
      readonly: this.readonly
    } }, h("ix-field-wrapper", { key: "6a413f82cc426c93fd3fdb5483864e18695a5b39", label: this.label, helperText: this.helperText, isInvalid: this.isInvalid, invalidText, infoText: this.infoText, isInfo: this.isInfo, isWarning: this.isWarning, warningText: this.warningText, isValid: this.isValid, validText: this.validText, showTextAsTooltip: this.showTextAsTooltip, required: this.required, controlRef: this.inputElementRef }, this.renderInput()), h("ix-dropdown", { key: "cdc768876fcaa2bdd194f0f9b1929a7b25a181be", "data-testid": "date-dropdown", trigger: this.inputElementRef.waitForCurrent(), ref: this.dropdownElementRef, closeBehavior: "outside", enableTopLayer: this.enableTopLayer, suppressOverflowBehavior: true, show: this.show, onShowChanged: (event) => {
      this.show = event.detail;
    } }, h("ix-date-picker", { key: "fa7dbbd78bf76346be14c9ecd51c5a074b669d4b", ref: this.datepickerRef, format: this.format, locale: this.locale, singleSelection: true, from: (_a = this.from) !== null && _a !== void 0 ? _a : "", minDate: this.minDate, maxDate: this.maxDate, onDateChange: (event) => {
