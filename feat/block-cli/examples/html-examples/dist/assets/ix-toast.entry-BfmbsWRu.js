...
const Toast = class {
  ...
  render() {
    ...
    return h(Host, { key: "93241b305d87fe553f0328aaf8824ee9baa37924", role: "alert", "aria-live": "polite", "aria-atomic": "true", class: "animate__animated animate__fadeIn" }, h("div", { key: "eb209b2c0fbeaf2ed1dd78201d88249fb8706d0f", class: "toast-body", onPointerLeave: () => {
      this.touched = false;
    }, onPointerEnter: () => {
      this.touched = true;
    } }, (this.type || this.icon) && !this.hideIcon ? h("div", { class: "toast-icon" }, this.getIcon()) : null, h("div", { key: "c3ec5ac56211e83a3ed38109e52c77f2f267d2c5", class: "toast-content" }, this.toastTitle ? h("ix-typography", { class: "toast-title", format: "h5" }, this.toastTitle) : null, h("div", { key: "21502e7e222bb5b32bea409fe9f25d96c958e5c3", class: "toast-message" }, h("slot", { key: "11341ed14d4095ebe6c1b75644b4cd112afc8548" })), h("div", { key: "cdff5e012e72b2e074a889da039ef8a9dc4c23f6", class: "toast-action" }, h("slot", { key: "23e2f7f290b1dc79b3b92f92842da24e7a4023e6", name: "action" }))), h("div", { key: "0a208a5b0a72a4a551184fe3b6767b818c836389", class: "toast-close" }, h("ix-icon-button", { key: "5a7b22fd07cc1fd1e67add017fb5a44cb0c02ee8", icon: iconClose, iconColor: "color-soft-text", size: "24", variant: "tertiary", onClick: () => this.closeToast.emit(), "aria-label": this.ariaLabelCloseIconButton }))), !this.preventAutoClose && h("div", { key: "64d3635d03a37e0695a37b64785ce3c3d9efb893", class: progressBarClass.join(" "), style: progressBarStyle, onAnimationEnd: () => {
      this.close();
    }, onTransitionEnd: () => {
      if (this.progress === 0) {
        this.close();
