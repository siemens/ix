import { M as Mixin, r as registerInstance, c as createEvent, g as getElement, h, F as Fragment, H as Host } from "./global-Dfa5QLOG.js";
import { F as iconChevronLeftSmall, j as iconChevronRightSmall } from "./index-DLhpBBEI-C3tPjcQ4.js";
...
const DatePicker = class extends Mixin(...DefaultMixins) {
  ...
  render() {
    return h(Host, { key: "2bf3ba5005b0189dfca2e874565a0ac46e91ea22", onKeyDown: (event) => this.onKeyDown(event), onFocusin: () => {
      if (hasKeyboardMode()) {
        this.changeFocusedDay();
      }
    } }, h("ix-date-time-card", { key: "ff436532d7962eaf2638db7f8786951d9f63d3ba", corners: this.corners, embedded: this.embedded }, h("div", { key: "fa56471269f4c40a51038816845c9268c5f1c71d", class: "header", slot: "header" }, h("ix-icon-button", { key: "5ff97656c57e0ac41cd94d3951e170236696654b", onClick: () => this.changeCalendarView(-1), icon: iconChevronLeftSmall, variant: "tertiary", class: "arrows", "aria-label": this.ariaLabelPreviousMonthButton }), h("div", { key: "174b5e31b979f79f4aa1fea190e16443d48f2d22", class: "selector" }, h("ix-dropdown-button", { key: "f816e91358a234de21c1a1bec7be4a08bc5ac55b", focusCheckedItem: true, "aria-label": this.ariaLabelMonthSelection, variant: "tertiary", label: null, onShowChanged: (event) => {
      event.stopPropagation();
    } }, h("ix-typography", { key: "c196b7dc81c0e1002021c2e8eec3e86accbb4193", bold: true, class: "capitalize", slot: "button-label" }, this.monthNames[this.selectedMonth]), this.renderMonths()), h("ix-dropdown-button", { key: "0866cf8a83559ff74c2f7a292706d1c2039f0764", focusCheckedItem: true, "aria-label": this.ariaLabelYearSelection, ref: this.yearDropdownButtonRef, variant: "tertiary", label: null, onShowChanged: (event) => {
      event.stopPropagation();
      if (event.detail) {
        requestAnimationFrameNoNgZone(() => {
    ...
    } }, h("div", { key: "c01dd39f14b29faffd6e7836714b07d4315d8fa3", class: "infinite-scrolling-spacer" }, h("div", { key: "42dfc7ae52dcd7544060a387051d658676ff3a52", class: "sentinel", "data-sentinel": "top" })), h("ix-typography", { key: "70570123f131a904d08818853222c44b27e85749", bold: true, class: "capitalize", slot: "button-label" }, this.selectedYear), this.renderYears(), h("div", { key: "02b8156fcbe2d24047c6184292bf96c1d640ea0a", class: "infinite-scrolling-spacer" }, h("div", { key: "a25b967fcd742877020b3f1b5cc0e66e914bd529", class: "sentinel", "data-sentinel": "bottom" })))), h("ix-icon-button", { key: "af886641531e293697ba82c10ab8a71938ba56d4", onClick: () => this.changeCalendarView(1), icon: iconChevronRightSmall, variant: "tertiary", class: "arrows", "aria-label": this.ariaLabelNextMonthButton })), h("div", { key: "451364ec39d0b56fad6bae16755d82c95368c231", class: {
      grid: true,
      "grid--show-week-numbers": this.showWeekNumbers
    } }, this.showWeekNumbers && h("div", { key: "a1f5340193abb17be964a7248e279420a6a1acec", class: "calendar-item week-day" }), this.dayNames.map((name) => h("div", { key: name, class: "calendar-item week-day" }, h("div", { class: "overflow" }, name.slice(0, 3)))), this.calendar.map((week) => {
    ...
    })), h("div", { key: "daf87c91128970937417f6f6efcd9790c5daad94", class: {
      button: true,
      hidden: this.singleSelection || this.embedded
    } }, h("ix-button", { key: "22fd6117118ff925a1867c3c10cb0d3d46ed763f", hidden: this.singleSelection || this.embedded, onClick: () => this.onDone() }, this.i18nDone))));
  }
