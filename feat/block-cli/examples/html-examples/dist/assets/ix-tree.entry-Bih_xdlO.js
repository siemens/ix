...
const Tree = class {
  ...
  render() {
    return h(Host, { key: "89491fe6a3eacbc9af31a16cfca9a78003475dd9", onClick: (event) => this.onTreeItemClick(event) }, h("slot", { key: "ee11c06ee162fbaf2df4743c7fb306f66b3fea79" }));
  }
  static get watchers() {
    return {
      "model": [{
