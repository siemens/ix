import { g as getElement, r as registerInstance, c as createEvent, h, H as Host } from "./global-Dfa5QLOG.js";
import { U as UploadFileState } from "./upload-file-state-BGzrnl_l-DLdhtkd7.js";
import { c as iconSuccess, b as iconError } from "./index-DLhpBBEI-C3tPjcQ4.js";
...
const Upload = class {
  ...
  render() {
    ...
    return h(Host, { key: "8e5cd70c22e4cc18a4326beca5d718d97abfb351", ...a11y, "aria-disabled": disabled }, h("div", { key: "074d1c2d9452a13ad7132605e10b2b7c863da368", class: {
    ...
    }, onDragOver: (e) => this.fileOver(e), onDragLeave: () => this.fileLeave() }, this.renderUploadState(), h("div", { key: "8378f659039b570d9b5998f9ec56cb1821626c46" }, h("input", { key: "5565267279be8ba9f46e6a23dfa7fc2ec806d9df", "aria-label": ariaLabel, "aria-disabled": disabled, multiple: this.multiple, type: "file", class: "upload-browser", id: "upload-browser", tabindex: "-1", onChange: (e) => {
      this.fileChangeEvent(e);
    }, accept: this.accept, disabled }), h("ix-button", { key: "540c0a09313d4ed6bc72d7cf283ab2edde2d2c2a", variant: "secondary", "aria-disabled": disabled, onClick: () => this.inputElement.click(), disabled }, this.i18nUploadFile))));
  }
};
