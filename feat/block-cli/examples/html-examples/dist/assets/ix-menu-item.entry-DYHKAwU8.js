...
import { v as iconDocument } from "./index-Cl7fhG1I-C77BCFLW.js";
...
const MenuItem = class {
  ...
  render() {
    ...
    const menuContent = [
      this.icon && h("ix-icon", { key: "1583a0740fb448be1d82b0cf1869361f8f614861", class: "tab-icon", name: this.icon, "aria-hidden": "true" }),
      this.notifications ? h("div", { class: "notification" }, h("div", { class: "pill" }, this.notifications)) : null,
      h("span", { key: "3910621e229c962efe17529f9d2d33b24a53eddc", id: this.internalItemId, class: "tab-text text-default" }, this.label, h("slot", { key: "ce15a0cb64085c91c46c67bca4131c6f5fb62b8a" }))
    ];
    return h(Host, { key: "f6f6b591168c0a900bc72d20b89be410cb8a34c3", class: {
    ...
    } }, menuContent) : h("button", { ...commonAttributes, ref: this.buttonRef, onKeyDown: (e) => this.handleCategoryKeyDown(e) }, menuContent), h("ix-tooltip", { key: "e8b89e7b172f7cf4e57f4bebe38f1ff52e7393b4", for: this.buttonRef.waitForCurrent(), placement: "right", showDelay: 1e3, interactive: false, "aria-hidden": a11yBoolean(this.ariaHiddenTooltip), "aria-labelledby": this.internalItemId }, this.tooltip));
  }
