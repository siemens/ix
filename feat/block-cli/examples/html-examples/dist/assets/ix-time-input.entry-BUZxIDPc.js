...
import { N as iconClock } from "./index-DLhpBBEI-C3tPjcQ4.js";
import { D as DateTime } from "./luxon-wpz4A-OQ-B58AoryR.js";
import { c as createPickerValidityStateTracker, j as onEnterKeyChangeEmit, h as handleSubmitOnEnterKeydown, a as addDisposableChangesAndVisibilityObservers, b as adjustPaddingForStartAndEnd, S as SlotEnd, o as onInputBlurWithChange, d as SlotStart, e as emitPickerValidityState } from "./input.fc-mVVYOifc-Dt2B7_tz.js";
...
import { c as createClassMutationObserver, g as getValidationText, H as HookValidationLifecycle } from "./validation-DnyZtQqc-C5Ryfcp9.js";
...
import { I as InputPickerMixin } from "./input-picker.mixin-B1gjzEiN-BlCM_uNY.js";
...
const TimeInput = class extends Mixin(...DefaultMixins, InputPickerMixin) {
  ...
  render() {
    ...
    return h(Host, { key: "bcff83490f066d681337f6b1b4bb47c1cce5e20b", class: {
      disabled: this.disabled,
      readonly: this.readonly
    }, onFocusout: () => {
      this.closeDropdown();
    } }, h("ix-field-wrapper", { key: "8dc6d4af83addb744047bcdfd26cc331b94ebfb4", label: this.label, helperText: this.helperText, isInvalid: this.isInvalid, invalidText, infoText: this.infoText, isInfo: this.isInfo, isWarning: this.isWarning, warningText: this.warningText, isValid: this.isValid, validText: this.validText, showTextAsTooltip: this.showTextAsTooltip, required: this.required, controlRef: this.inputElementRef }, this.renderInput()), h("ix-dropdown", { key: "4a194da8c70783dcdab0139a487b85e48101328a", "data-testid": "time-dropdown", trigger: this.inputElementRef.waitForCurrent(), ref: this.dropdownElementRef, closeBehavior: "outside", enableTopLayer: this.enableTopLayer, suppressOverflowBehavior: true, show: this.show, onShowChanged: (event) => {
      this.show = event.detail;
    }, focusTrapOptions: {
      targetElement: this.timePickerRef,
      trapFocusInShadowDom: true
    } }, h("ix-time-picker", { key: "fb82cee7e6f0b505db240b15cdf920ad0dd98bf6", ref: this.timePickerRef, format: this.format, time: this.time ?? "", minTime: this.minTime, maxTime: this.maxTime, hourInterval: this.hourInterval, minuteInterval: this.minuteInterval, secondInterval: this.secondInterval, millisecondInterval: this.millisecondInterval, embedded: true, hideHeader: this.hideHeader, i18nConfirmTime: this.i18nSelectTime, i18nHeader: this.i18nTime, i18nHourColumnHeader: this.i18nHourColumnHeader, i18nSecondColumnHeader: this.i18nSecondColumnHeader, i18nMinuteColumnHeader: this.i18nMinuteColumnHeader, i18nMillisecondColumnHeader: this.i18nMillisecondColumnHeader, onTimeSelect: (event) => {
