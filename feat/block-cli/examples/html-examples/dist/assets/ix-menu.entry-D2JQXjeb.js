...
import { f as iconApps, y as iconCogwheel, z as iconLightDark, d as iconInfo } from "./index-BcWSlcx_-DijX28Uj.js";
...
const Menu = class {
  ...
  render() {
    ...
    return h(Host, { key: "a597f5d8ffe724c641ec1eaab2741ef7ad6019a1", class: {
      expanded: this.expand,
      [`breakpoint-${this.breakpoint}`]: true
    }, slot: "menu" }, h("nav", { key: "212f69634be94bdcbb830f025111f25039ecb064", "aria-label": this.applicationName, class: {
      menu: true,
      expanded: this.expand
    } }, h("div", { key: "102983112975a36c92f7e82edfedee78bb061dff", class: "menu-buttons" }, this.breakpoint !== "sm" && h("ix-menu-expand-icon", { key: "e4c5bc3c7154f51f6808b2729f2a319cb2228e35", breakpoint: this.breakpoint, expanded: this.expand, "i18n-expand": this.i18nExpand, "i18n-collapse": this.i18nCollapse, pinned: this.pinned, class: "menu-expand-icon", onClick: async () => this.toggleMenu(), "data-testid": "expand-collapse-menu" }), this.breakpoint === "sm" && this.applicationLayoutContext?.appSwitchConfig && h("ix-icon-button", { key: "f07d6a79d21a0ea46cccaf9a568a6b12eb91c1df", onClick: () => {
      this.showAppSwitch();
    }, icon: iconApps, variant: "subtle-tertiary" })), h("div", { key: "5682b326c40750ae5671deac9b1b589f5f533b2c", role: "menubar", "aria-orientation": "vertical", "aria-label": this.i18nAriaLabelMenu, "aria-description": this.i18nNavigationHint, class: {
      "menu-navigation": true,
      "menu-navigation--fill": this.shouldFillMenuNavigation
    }, tabIndex: 0, onKeyDown: (e) => this.handleMenuKeyDown(e), onFocusin: (e) => this.handleMenuFocusIn(e), onFocusout: () => this.resetRovingTabIndex() }, h("div", { key: "a05a71dda38ebaece232d9c7861386fd619f5f74", id: "menu-tabs", style: {
      display: "contents"
    }, onClick: (e) => this.onMenuItemsClick(e) }, h("div", { key: "ffb46a59a03aedae67667f26d625903965df41aa", class: "tabs-shadow-container" }, h("div", { key: "ef087988a92fa940485e2854a5da85f52cf2a294", class: {
      "tabs--shadow": true,
      "tabs--shadow-top": true,
      "tabs--shadow--show": this.itemsScrollShadowTop
    } }), h("div", { key: "ac52029b447aaa2995b8c9a47169602b9ac12cd0", class: {
      tabs: true,
      "show-scrollbar": this.expand
    }, onScroll: () => this.handleOverflowIndicator() }, h("div", { key: "e9cd55ef4792ed55e36d1d521e0afbe2c7a5b610", class: "menu-avatar" }, h("slot", { key: "6379264cfe0ec1d4d791168d40a1312a41bcd33d", name: "ix-menu-avatar" })), h("slot", { key: "6027caa36065290e5c3758bd3e5df9261f79293c", name: "home" }), this.breakpoint !== "sm" || !this.isHiddenFromViewport() ? h("slot", null) : null), h("div", { key: "5f30c1ffba67e6717310a9911febdadef2a42d03", class: {
      "tabs--shadow": true,
      "tabs--shadow-bottom": true,
      "tabs--shadow--show": this.itemsScrollShadowBottom
    } }))), h("div", { key: "b1e97cb467eff68c128ca68559e07a28ab70e977", onClick: (e) => this.onMenuItemsClick(e) }, h("slot", { key: "81fcf22b21dfcdd62ad2c1bfc8bd22c24d0603c0", name: "bottom", onSlotchange: () => this.updateBottomSlotState() })), h("div", { key: "05bb41bd6539ee9d806b4207a7ed40e0f4b7acfb", class: "bottom-tab-divider" }), h("div", { key: "f8abcb4bb8b9134f69eb765989bc65d2f845a225", class: "menu-utility-controls" }, this.settings ? h("ix-menu-item", { disabled: this.isHiddenFromViewport(), id: "settings", class: {
      "internal-tab": true,
      "bottom-tab": true,
    ...
    }, icon: iconInfo, onClick: async () => this.toggleAbout(!this.showAbout), label: this.i18nLegal, "aria-haspopup": "dialog", "aria-expanded": this.showAbout.toString(), "aria-controls": "menu-overlay" }) : null)), h("div", { key: "9f6cc55f1113116b6d5dfdebd05a34dec0b8baf8", id: "popover-area" })), h("section", { key: "5bed5017318452a1e69d1714264b52c84ce275b0", id: "menu-overlay", role: "dialog", "aria-label": overlayLabel, class: {
      "menu-overlay": true,
      ...
      this.checkTransition();
    } }, h("div", { key: "c89b7e04f3c31f0c43117ae0604d71d6ae0b3270", class: "menu-overlay-container" }, this.showSettings ? h("slot", { name: "ix-menu-settings" }) : null), h("div", { key: "8177c8e0a9967fd375aa73ab2c1b6316631be411", class: "menu-overlay-container" }, this.showAbout ? h("slot", { name: "ix-menu-about" }) : null)));
  }
  static get watchers() {
    return {
      "expand": [{
