import { g as getElement, r as registerInstance, c as createEvent, h, H as Host } from "./global-J1r-v9CX.js";
import { a as iconSuccess, b as iconError } from "./index-BcWSlcx_-DijX28Uj.js";
...
const Upload = class {
  ...
  render() {
    ...
    return h(Host, { key: "cfaf116c9461ea808a60a0bc9467446b1bec962b", ...a11y, "aria-disabled": disabled }, h("div", { key: "b8536e1f5ffcf1c70a45d68f977a7c23b7de84bc", class: {
    ...
    }, onDragOver: (e) => this.fileOver(e), onDragLeave: () => this.fileLeave() }, this.renderUploadState(), h("div", { key: "da6f49d853c9d1e636ee230270f9e6037264f13a" }, h("input", { key: "a39dfdb708c80b19111f241cae2f03b7de34d835", "aria-label": ariaLabel, "aria-disabled": disabled, multiple: this.multiple, type: "file", class: "upload-browser", id: "upload-browser", ...directoryAttributes, tabindex: "-1", onChange: (e) => {
      this.fileChangeEvent(e);
    }, accept: this.accept, disabled }), h("ix-button", { key: "3f60ba199797e7542c2b9d37a0071c687f385c0c", variant: "secondary", "aria-disabled": disabled, onClick: () => this.inputElement.click(), disabled }, this.i18nUploadFile ?? (this.directoryUpload ? "Upload folder…" : "Upload file…")))));
  }
};
