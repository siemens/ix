...
import { s as iconClear, t as iconSearch } from "./index-BcWSlcx_-DijX28Uj.js";
...
const ExpandingSearch = class {
  ...
  render() {
    return h(Host, { key: "b4635fe6f0a054c0f07bee0cde81ce273e0fa3fe", class: {
      expanded: this.expanded,
      "right-position": this.expanded,
      fullWidth: this.fullWidth
    } }, h("ix-icon-button", { key: "8b6d97849bc6fa9a2fbfb7d0a38902b0677983ca", size: this.expanded ? "16" : "24", icon: this.icon ?? iconSearch, variant: this.expanded ? "tertiary" : this.variant, "data-testid": "button", onClick: () => this.expandInput(), tabindex: this.expanded ? -1 : 0, color: this.hasFocus ? "input-search-icon--color--focus" : void 0, class: {
      "btn-search": true,
      "btn-search--expanded": this.expanded
    }, "aria-label": this.ariaLabelSearchIconButton ?? (this.expanded ? "Close search" : "Open search") }), h("div", { key: "55dea6846c14c8f03faa59404ee10d387139f1d7", class: {
      expanded: this.expanded,
      fullWidth: this.fullWidth,
      collapsed: !this.expanded,
      "disable-pointer": !this.expanded,
      "input-container": true
    }, "data-testid": "input-wrapper" }, h("input", { key: "a4ebc553fa9551236d02802f905045c532cca874", class: {
