...
const DropdownHeader = class {
  ...
  label;
  render() {
    return h(Host, { key: "344ee40eb79112952390e6d971b03740fd00bb52" }, h("ix-typography", { key: "71d34e8253de3b76cffe037070fb642aa9b1e25d", class: "category-text", format: "h5" }, this.label));
  }
};
