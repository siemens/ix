import { r as registerInstance, c as createEvent, g as getElement, h, F as Fragment, H as Host } from "./global-Cx3A0XQN.js";
...
const Checkbox = class {
  ...
  render() {
    return h(Host, { key: "fbfd77baf91cc5f3d5c75f722dcfb3436056eb2f", "aria-checked": a11yBoolean(this.checked), "aria-disabled": a11yBoolean(this.disabled), role: "checkbox", class: {
      disabled: this.disabled,
      checked: this.checked,
      indeterminate: this.indeterminate,
      "label-less": this.isLabelLess
    }, onFocus: () => this.touched = true, onBlur: () => this.ixBlur.emit() }, h("label", { key: "2454208b720f01112d412c6e792ec34db7bb73fa" }, h("input", { key: "d893d5164fe5fb36d0053c889d79d66fefd5031a", "aria-checked": a11yBoolean(this.checked), required: this.required, disabled: this.disabled, checked: this.checked, ref: this.inputRef, type: "checkbox", onChange: () => this.setCheckedState(!this.checked) }), h("div", { key: "7f014d3a78da96b8c6701abed1da9752b2f84471", class: "checkbox-button" }, h("button", { key: "b6f140a55f17b1607e2bbb7cfbce9b6307a87672", disabled: this.disabled, class: {
      checked: this.checked
    }, onClick: () => this.setCheckedState(!this.checked) }, this.renderCheckmark())), h("ix-typography", { key: "6098cb74eaaaafaa61a8e2e88a142792007753b1", format: "label", textColor: this.disabled ? "weak" : "std" }, this.label, h("slot", { key: "e6025e5f71e768336d9ea5a788f111eb8dd77c36", onSlotchange: () => this.updateDefaultSlotElements(), ref: (element) => this.defaultSlotElement = element }))));
  }
