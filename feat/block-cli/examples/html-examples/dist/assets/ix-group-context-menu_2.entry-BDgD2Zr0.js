import { r as registerInstance, g as getElement, h, H as Host, c as createEvent } from "./global-C8IWpzMv.js";
...
const GroupContextMenu = class {
  ...
  render() {
    return h(Host, { key: "db3c0e0393e460f37e657145db3561062df10bc2" }, h("ix-icon-button", { key: "29f2d096ce1b6ea9c9831e3b24507af3d5cc8a7d", class: { hide: !this.showContextMenu }, size: "24", variant: "subtle-tertiary", icon: iconContextMenu }), h("slot", { key: "d3ab3f021ab1738f36df486661474225a98f2515", onSlotchange: () => this.onSlotChange() }));
  }
};
