...
import { e as iconMoreMenu, k as iconChevronDown } from "./index-ClV1Tffv-Cwm_ckfF.js";
...
const CardList = class {
  ...
  render() {
    return h(Host, { key: "a04af8658a718874cc35b3e596e2193e63a36e34" }, h(CardListTitle, { key: "1efcf558e992c1dd38049cf3962965d43d76cefe", isCollapsed: this.collapse, label: this.label, showAllLabel: this.i18nShowAll, showAllCounter: this.showAllCount === void 0 ? this.numberOfAllChildElements : this.showAllCount, onClick: () => this.onCardListVisibilityToggle(), onShowAllClick: (e) => this.onShowAllClick(e), hideShowAll: this.hideShowAll }), h("div", { key: "fb09830f333590d00408476aab6264101ea2d135", class: {
      CardList__Overflow: true
    }, style: this.computeMaskLayer() }, h("div", { key: "1da39542864f1c6e55ad7c294bfd9453129338b7", class: {
    ...
    }, onScroll: () => this.onCardListScroll() }, h("slot", { key: "9bf485e9da88c470a8398bc848929c75de717b90", onSlotchange: () => this.changeVisibilityOfSlotChildren() }), this.isShowMoreCardVisible() ? h("ix-card", { class: {
