...
import { s as iconCloseSmall } from "./index-Cl7fhG1I-C77BCFLW.js";
import { a as a11yBoolean } from "./a11y-B5k8YVR0-BOSd6BQK.js";
import { D as DefaultMixins } from "./component-Chfbghog-DFMCI9TH.js";
import { I as InheritAriaAttributesMixin } from "./inherit-aria-attributes.mixin-CBuZQFB--BfuUgoYq.js";
...
const Chip = class extends Mixin(...DefaultMixins, InheritAriaAttributesMixin) {
  ...
  render() {
    ...
    return h(Host, { key: "4ea3382eac0c256dca49859da3f262344bbe1b5d", role: this.getHostRole(needsGroupRole), class: {
      inactive: this.inactive
    } }, h("div", { key: "56048f85f348d1b1f6f099bf973133dc25cad8b7", ref: this.containerElementRef, class: wrapClasses, style: customWrapStyle }, h("button", { key: "ccf2ca3426137f7acd4137b2c3ea213942c5783b", type: "button", class: "chip-main", ...this.inheritAriaAttributes, disabled: this.inactive, style: customMainStyle }, h("div", { key: "9a5dd7134d269ca5b233760be54b194339f99502", class: "content-wrapper" }, this.icon && h("ix-icon", { key: "eee27a259feec2ea62453c9c0493688701c72da8", class: {
      "with-icon": true
    }, name: this.icon, size: "24", "aria-label": this.ariaLabelIcon, "aria-hidden": a11yBoolean(iconIsDecorative), style: this.getIconStyle(variant) }), h("span", { key: "ec7026fe89ff77ff417cb47f63519700a56b939e", class: "slot-container" }, h("slot", { key: "fb7bd1091d83ea4fb4ebd865c219158b6b99c012" })))), showClose && h("button", { key: "9ebc8234961167462fc772b38720230b970c208a", type: "button", class: "chip-close", "aria-label": this.ariaLabelCloseButton, onClick: (event) => {
      this.closeChip.emit(event);
      event.stopPropagation();
    } }, h("ix-icon", { key: "508d9b30ed177738b3cb0ef56b3117e8e30560f9", class: "chip-close__icon", name: iconCloseSmall, size: "16", "aria-hidden": "true" }))), this.getTooltip());
  }
  static get watchers() {
    return {
      "role": [{
