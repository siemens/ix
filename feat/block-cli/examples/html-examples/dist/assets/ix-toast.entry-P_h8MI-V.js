...
const Toast = class {
  ...
  render() {
    ...
    return h(Host, { key: "c89706cb174bfff1a7c33bbb83a49430505940e6", role: "alert", "aria-live": "polite", "aria-atomic": "true", class: "animate__animated animate__fadeIn" }, h("div", { key: "027fd6476508e8f0332bb356f3822db00f6d85d1", class: "toast-body", onPointerLeave: () => {
      this.touched = false;
    }, onPointerEnter: () => {
      this.touched = true;
    } }, (this.type || this.icon) && !this.hideIcon ? h("div", { class: "toast-icon" }, this.getIcon()) : null, h("div", { key: "3e9e6950d76fc6c6e0253d11cec55909b67bbe80", class: "toast-content" }, this.toastTitle ? h("ix-typography", { class: "toast-title", format: "h5" }, this.toastTitle) : null, h("div", { key: "95a54c91e8b670ad146bd30228597d91eddb8475", class: "toast-message" }, h("slot", { key: "a4f778413764d5374ffcae62f4ddd7169fc53da2" })), h("div", { key: "e4995e27b081c42190692ca0e6f31fdba9134ac8", class: "toast-action" }, h("slot", { key: "a40581f55497b6952014e97846497432fbc975b3", name: "action" }))), h("div", { key: "4c2187d89746ce20f9164376a00a327e13d7a555", class: "toast-close" }, h("ix-icon-button", { key: "6ead8c7424d908f0b40389a5d46db50eb131795d", icon: iconClose, iconColor: "color-soft-text", size: "24", variant: "tertiary", onClick: () => this.closeToast.emit(), "aria-label": this.ariaLabelCloseIconButton }))), !this.preventAutoClose && h("div", { key: "b57f2d0ad896983fd4937d6a661286dac4942344", class: progressBarClass.join(" "), style: progressBarStyle, onAnimationEnd: () => {
      this.close();
    }, onTransitionEnd: () => {
      if (this.progress === 0) {
        this.close();
