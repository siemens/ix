...
const MenuItem = class {
  ...
  render() {
    ...
    const menuContent = [
      this.icon && h("ix-icon", { key: "191dcadf853e18d0dba7d6e57cc05fefc7be76e9", class: "tab-icon", name: this.icon, "aria-hidden": "true" }),
      this.notifications ? h("div", { class: "notification" }, h("div", { class: "pill" }, this.notifications)) : null,
      h("span", { key: "3bf1c0cfba1df778c41f6885c5cbd6a4df18b162", id: this.internalItemId, class: "tab-text text-default" }, this.label, h("slot", { key: "e4264011b1bd10d9c0845319d4642e4c95bfb451" }))
    ];
    return h(Host, { key: "ecb58d6cf30ec4782f7363d8eb891f0529d2da3d", class: {
