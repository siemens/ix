...
import { c as createClassMutationObserver } from "./validation-CTBekLDe-YfJiut_i.js";
import { h as hasAnyText, H as HelperText$1 } from "./helper-text-util-C9sLzo0k-Cqh9DVOn.js";
...
const FormFieldLabel = class {
  ...
  render() {
    return h(Host, { key: "80cb15c048ae7e527627f3085a4f26b94494b3cb", onClick: () => this.focusOnClick() }, h("label", Object.assign({ key: "cad4063524fa721d4903b8f2f65c62674cb0e178", htmlFor: this.htmlFor }, this.a11yAttributes, { ref: this.labelRef }), h("ix-typography", { key: "e1febaa198f8b370e2e4198d6e6a3af36adc8c7a", textColor: this.isInvalid ? "alarm" : "soft", format: "label" }, h("slot", { key: "74813916cc127783f8f01610f7c8e5da2e46800e" }), this.required && h("span", { key: "9caa80b15506fa5a2465f0d5311037050f3bab42" }, "*"))));
  }
  get hostElement() {
