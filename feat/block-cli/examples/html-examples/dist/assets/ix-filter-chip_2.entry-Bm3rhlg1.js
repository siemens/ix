import { r as registerInstance, c as createEvent, g as getElement, h, H as Host, M as Mixin } from "./global-Cr1KQvOo.js";
...
import { F as FocusVisibleMixin } from "./focus-visible.mixin-hmwoArrc-DkF16-uS.js";
...
const SelectItem = class extends Mixin(...DefaultMixins, FocusVisibleMixin, ComponentIdMixin) {
  ...
  render() {
    ...
    return h(Host, { key: "49c1b18068206e0f565be1bc02473b4b5c8820be", ...ariaAttributes, id: this.getHostElementId(), class: {
      [IX_FOCUS_VISIBLE]: true
    }, "aria-hidden": "true", role: "presentation" }, h("ix-dropdown-item", { key: "2385eeedfa22c1cadab17161fedf6e3af9c92028", "aria-hidden": "true", role: "option", class: {
