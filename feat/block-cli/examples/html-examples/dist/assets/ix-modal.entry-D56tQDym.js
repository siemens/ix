...
const Modal = class {
  ...
  render() {
    return h(Host, { key: "d5bb63f7716950339e3ab3be9cdf6e4bd914e958", class: {
      visible: this.modalVisible,
      "no-backdrop": this.hideBackdrop,
      "align-center": this.centered
    } }, h("div", { key: "ce234129ecd33f05b4049a90633dabc590244178", class: "dialog-backdrop" }, h("dialog", { key: "65700de4d4e4e440ed81bdab67e9c54641aac02e", "aria-modal": a11yBoolean(true), "aria-describedby": this.ariaAttributes["aria-describedby"], "aria-labelledby": this.ariaAttributes["aria-labelledby"], class: {
      modal: true,
      [`modal-size-${this.size}`]: true
    }, onClose: () => this.dismissModal(), onMouseDown: (event) => this.onMouseDown(event), onMouseUp: (event) => this.onMouseUp(event), onCancel: (e) => {
      e.preventDefault();
      this.dismissModal();
    } }, h("slot", { key: "7a4bdf139d88ba4342d2cd6a2867683081c8f9e5" }))));
  }
  get hostElement() {
