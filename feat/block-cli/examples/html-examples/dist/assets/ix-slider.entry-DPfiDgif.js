...
const Slider = class {
  ...
  render() {
    ...
    return h(Host, { key: "e1f46d8733a6c2785759d0f0ad002f9c266a5c01", class: {
      disabled: this.disabled,
      invalid: this.isInvalid,
      info: this.isInfo,
      valid: this.isValid,
      warning: this.isWarning
    }, onPointerDown: () => setTimeout(() => this.showTooltip = true) }, h("ix-field-wrapper", { key: "4a2f49773dc29d3851888167a0756464390162db", label: this.label, helperText: this.helperText, invalidText: this.invalidText, infoText: this.infoText, warningText: this.warningText, validText: this.validText, showTextAsTooltip: this.showTextAsTooltip, isValid: this.isValid, isInfo: this.isInfo, isWarning: this.isWarning, isInvalid: this.isInvalid, controlRef: this.controlRef }, h("div", { key: "05a4ffcd8618bda99e82b58f7a1cd63984b22774", class: "slider-container" }, h("div", { key: "701698c785b84ff69521d6f19d42172034d61856", class: "slider" }, h("div", { key: "fa6eca54334a47cf1a76ecfd1957ee5ddbf1cb53", class: "track" }, h("div", { key: "e3dca9054009b7129ebe1faeee7da17c3ae00224", ref: this.thumbRef, class: "thumb", style: {
      left: `calc(${valueInPercentage} * (100% - 1rem))`
    } }), h("svg", { key: "50c9699acd262c568e7b0557d1afec0d80897bda", class: "ticks", xmlns: "http://www.w3.org/2000/svg" }, this.marker?.filter((markerValue) => markerValue >= this.min && markerValue <= this.max).map((markerValue) => {
    ...
    }))), h("input", { key: "16f14c311e91febce5a96b517366dfeb41398af1", id: "slider", ref: this.controlRef, type: "range", list: this.marker ? "markers" : void 0, step: this.step, min: this.min, max: this.max, value: this.rangeInput, tabindex: this.disabled ? -1 : 0, onInput: (event) => this.onInput(event), onFocus: () => {
    ...
    }, role: "slider", "aria-valuenow": this.rangeInput, "aria-valuemin": this.min, "aria-valuemax": this.max, ...this.a11yAttributes }), h("ix-tooltip", { key: "a9d98bdf1431435c454d372676b32b19cd66b026", ref: this.tooltipRef, class: {
      "hide-tooltip": !this.showTooltip
    }, animationFrame: true, for: this.thumbRef.waitForCurrent() }, this.rangeInput)), this.hasLabels && h("div", { key: "3f83e2354a4fd2452a4b409b4ae7d65d2235492a", class: "label" }, h("div", { key: "5b66cb5e89dbf6cebcae0f1462422ca45c322cb8" }, h("slot", { key: "93e5fd81989262ec2dc01eb1d61ffadecb5aba4b", name: "label-start" })), h("div", { key: "072259eb1f6a1bf24628fa5e5dad2df2134a42c8" }, h("slot", { key: "52b4e4429d8e48121667fff12717b0bfee2e25a0", name: "label-end" }))))));
  }
