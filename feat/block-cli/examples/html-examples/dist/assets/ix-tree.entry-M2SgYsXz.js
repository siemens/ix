...
const Tree = class {
  ...
  render() {
    return h(Host, { key: "a07d147f8d5ac48023d99161e79b77e0e63f87ec", onClick: (event) => this.onTreeItemClick(event) }, h("slot", { key: "dcdf8246aced83c30135fa359bff24450dff1de0" }));
  }
  static get watchers() {
    return {
      "model": [{
