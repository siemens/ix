...
const Slider = class {
  ...
  render() {
    ...
    return h(Host, { key: "d748e3dd783e28c368a8b7cce95468edb54c6c48", class: {
    ...
    }, onPointerDown: () => setTimeout(() => this.showTooltip = true) }, h("ix-field-wrapper", { key: "04bc39c2e354bee6c6154d17acb166ca2b16c4c2", label: this.label, helperText: this.helperText, invalidText: this.invalidText, infoText: this.infoText, warningText: this.warningText, validText: this.validText, showTextAsTooltip: this.showTextAsTooltip, isValid: this.isValid, isInfo: this.isInfo, isWarning: this.isWarning, isInvalid: this.isInvalid, controlRef: this.controlRef }, h("div", { key: "6c8c6588029ede9b9169009c3b3988e985df73b5", class: "slider-container" }, h("div", { key: "e485c80095676b90a523e5559e40c784c21fb89f", class: "slider" }, h("div", { key: "42f4a240ce28aba05c5d59f1193a8c7a393ac03e", class: "track" }, h("div", { key: "d98b8acd26881de40595ec3fc68234df5c63a202", ref: this.thumbRef, class: "thumb", style: {
      left: `calc(${valueInPercentage} * (100% - 1rem))`
    } }), h("svg", { key: "4134dde08546b0671be79a52dc654fff7a53a1fe", class: "ticks", xmlns: "http://www.w3.org/2000/svg" }, this.marker?.filter((markerValue) => markerValue >= this.min && markerValue <= this.max).map((markerValue) => {
    ...
    }))), h("input", { key: "87022d3f2b8cf486d7e79056e759551a267befea", id: "slider", ref: this.controlRef, type: "range", list: this.marker ? "markers" : void 0, step: this.step, min: this.min, max: this.max, value: this.rangeInput, tabindex: this.disabled ? -1 : 0, onInput: (event) => this.onInput(event), onFocus: () => {
    ...
    }, role: "slider", "aria-valuenow": this.rangeInput, "aria-valuemin": this.min, "aria-valuemax": this.max, ...this.a11yAttributes }), h("ix-tooltip", { key: "f157b6a61050774381d4418ffb2d7d1f3de5dc9b", ref: this.tooltipRef, class: {
      "hide-tooltip": !this.showTooltip
    }, animationFrame: true, for: this.thumbRef.waitForCurrent() }, this.rangeInput)), this.hasLabels && h("div", { key: "bda376d5ef7d5a0664fa9b5600e08825031d0c22", class: "label" }, h("div", { key: "ca1a13fa8ad6fa50bc4740a8d918c98cf981db59" }, h("slot", { key: "f0276172c4e7751a4f09ec25ecda385c432419a0", name: "label-start" })), h("div", { key: "537beac35570e23acc9eacd09e9430b71390756c" }, h("slot", { key: "5da696a89ae8484c8c03f5766fc6e8f11a2c4970", name: "label-end" }))), this.error ? h("ix-typography", { textColor: "alarm" }, this.error) : null)));
  }
