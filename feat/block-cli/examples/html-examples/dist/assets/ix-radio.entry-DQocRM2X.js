...
import { c as createClassMutationObserver } from "./validation-3877QBzA-Cg5a-YOP.js";
...
const Radio = class {
  ...
  render() {
    ...
    return h(Host, { key: "9be7521676f6afbbc7f5c7f977f73f156a2fda2b", "aria-checked": a11yBoolean(this.checked), "aria-disabled": a11yBoolean(this.disabled), role: "radio", tabindex: tabIndex, class: {
      ...
      if (this.disabled)
        return;
      this.setCheckedState(true);
    }, onKeyDown: (event) => this.onKeyDown(event), onBlur: () => this.ixBlur.emit() }, h("label", { key: "3d777a372d65b6a7c4fb6a0bdd1333b4b567c1f7" }, h("div", { key: "b6dafb4186bc1c646d59ec57bec668169e254016", class: "radio-button" }, h("div", { key: "256e110300a3b822788ce7dce5d5a50dbb931212", "aria-hidden": "true", class: {
      ["radio-checkmark"]: true,
      checked: this.checked
    } }, h("div", { key: "8ff255ed5bd4fd609967267ab4edbc998c2b209c", class: "checkmark", style: { visibility: this.checked ? "visible" : "hidden" } }))), this.label && h("ix-typography", { key: "c9dea8d2f1671c398216e82e292bc760df3a8d02", format: "label", textColor: this.disabled ? "weak" : "std" }, this.label, h("slot", { key: "d5185276d477fd5fb93e400eacd7139a1a04aa66" }))));
  }
