...
import { B as BaseButton } from "./base-button-DZdtpLxn-CXmN3hUZ.js";
...
const DateDropdown = class extends Mixin(...DefaultMixins) {
  ...
  render() {
    ...
    return h(Host, { key: "ffdc61a63812e950369048949a2994da8a13979d", onFocusout: (event) => {
      const relatedTarget = event.relatedTarget;
      if (!relatedTarget) {
        return;
      }
      this.closeDropdown();
    }, role: "presentation" }, h("ix-button", { key: "7969f25adb0b513f7fa44018097de48cdf998f2d", "data-testid": "date-dropdown-trigger", "data-date-dropdown-trigger": true, variant: this.variant, loading: this.loading, icon: iconHistory, ref: this.triggerRef, disabled: this.disabled, ...this.inheritAriaAttributes, "aria-haspopup": "true", "aria-expanded": a11yBoolean(this.show), "aria-controls": "date-dropdown", "aria-label": ariaLabel, [TRAP_FOCUS_EXCLUDE_ATTRIBUTE]: true }, this.getButtonLabel()), h("ix-dropdown", { key: "246d320cbd83b2be60285a2d4e87cd59c120d746", focusTrapOptions: {
    ...
    } }, h("div", { key: "f0ae64383c060528879763f4eb08b5a85f866f87", class: "container" }, this.dateRangeOptions?.length > 1 && h("div", { key: "90064516da7aa0488f29bc0699c92e40d5f193cc", class: {
    ...
    } }, dateRangeOption.label))), h("div", { key: "0065ab9c12e9ab5b8007d7a6cfc361fcc2efd3d8", class: "picker-wrapper" }, h("ix-date-picker", { key: "858c2f9f24ebe6a7d8c8172cc8ab57d006c882f7", ref: this.datePickerRef, embedded: true, locale: this.locale, onDateChange: (e) => {
      e.stopPropagation();
      this.currentRangeValue = {
        ...e.detail,
        id: "custom"
      };
    }, onDateRangeChange: (e) => e.stopPropagation(), format: this.format, singleSelection: this.singleSelection, from: this.from || this.currentRangeValue?.from, to: this.to || this.currentRangeValue?.to, minDate: this.minDate, maxDate: this.maxDate, today: this.today, weekStartIndex: this.weekStartIndex, showWeekNumbers: this.showWeekNumbers }), h("div", { key: "2279b3bea4bd0d7cc091dc84c2971d8af4cf28df", class: "pull-right" }, h("ix-button", { key: "6cf2a94da5fe6a1a6e51c29aa3ecd5610275b7cc", onClick: () => {
      if (this.currentRangeValue) {
        this.onDateSelect(this.currentRangeValue);
        this.closeDropdown();
      }
