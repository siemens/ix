import { r as registerInstance, g as getElement, f as forceUpdate, h, H as Host } from "./global-C_dy4gBz.js";
...
const Panes = class {
  ...
  render() {
    return h(Host, { key: "66a974ec930defc6ce1a7f3c478da0cd58d4bce0" }, !this.isMobile ? this.layout == "full-vertical" ? h("div", { class: "side-panes-wrapper" }, h("div", { class: {
      row: true,
