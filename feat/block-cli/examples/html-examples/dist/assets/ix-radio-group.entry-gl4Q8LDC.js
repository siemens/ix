...
const RadiobuttonGroup = class {
  ...
  render() {
    return h(Host, { key: "3c2da9ab2b037d47014f861c0ad947ed6ac9e68d", onIxBlur: () => this.touched = true, ref: this.groupRef, role: "radiogroup" }, h("ix-field-wrapper", { key: "d166f291774458798ded5eff83d571a1b1fe240e", label: this.label, helperText: this.helperText, invalidText: this.invalidText, infoText: this.infoText, warningText: this.warningText, validText: this.validText, showTextAsTooltip: this.showTextAsTooltip, isValid: this.isValid, isInfo: this.isInfo, isWarning: this.isWarning, isInvalid: this.isInvalid, controlRef: this.groupRef }, h("div", { key: "04fcf12e8788382e390e9897c6355dfc84f8560f", class: {
      "checkbox-container": true,
      "row-layout": this.direction === "row"
    } }, h("slot", { key: "502bd4df6901be75f980375990a8dba9f89c4835" }))));
  }
  static get watchers() {
    return {
      "value": [{
