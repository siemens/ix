...
const Popover = class extends Mixin(...DefaultMixins, InheritAriaAttributesMixin, ComponentIdMixin) {
  ...
  render() {
    return h(Host, { key: "4f950b982f88f7b1c171220aabc9bfddf305a009", class: { visible: this.show }, "data-ix-popover": this.popoverPanelId }, h("dialog", { key: "4263dd81252f57f8d1514a2c3274230a7fbaf5f5", ref: this.dialogRef, id: this.popoverPanelId, class: "dialog", popover: "manual", inert: !this.show, ...this.inheritAriaAttributes, role: this.inheritAriaAttributes["role"] ?? "dialog", onMouseEnter: () => this.onDialogMouseEnter(), onMouseLeave: () => this.onDialogMouseLeave() }, h("div", { key: "70f5b120a66d6bc75453fc7e9d119b6c52f15eb5", class: "popover-container" }, h("div", { key: "045369860f743752681c93bafe7c00102faff1a8", class: "popover-body" }, h("slot", { key: "b894c837344e7eeaa3d6506590d24ecbf73c051d" })), this.hasSpike ? h("div", { class: "spike" }) : null)));
  }
  static get watchers() {
    return {
      "role": [{
