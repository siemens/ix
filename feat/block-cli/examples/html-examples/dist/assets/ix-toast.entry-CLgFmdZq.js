...
import { r as iconClose, a as iconWarning, c as iconSuccess, b as iconError, i as iconInfo } from "./index-ClV1Tffv-Cwm_ckfF.js";
...
const Toast = class {
  ...
  render() {
    ...
    return h(Host, { key: "ab52a49eb30adcb692fcef65c9517ca91e729d29", class: "animate__animated animate__fadeIn" }, h("div", { key: "84943a8638c5c696ce3f51fe693725ccbc8fbd00", class: "toast-body", onPointerLeave: () => {
      this.touched = false;
    }, onPointerEnter: () => {
      this.touched = true;
    } }, (this.type || this.icon) && !this.hideIcon ? h("div", { class: "toast-icon" }, this.getIcon()) : null, h("div", { key: "a77a559be7cffcf8d49a49beaa4787baece49c59", class: "toast-content" }, this.toastTitle ? h("ix-typography", { class: "toast-title", format: "h5" }, this.toastTitle) : null, h("div", { key: "9fa3007562ae52c3228326255ff784e40b6973d7", class: "toast-message" }, h("slot", { key: "dbe05a3386935c485fc636e610f020c2a65e944d" })), h("div", { key: "19acc868da3d584ec5f56173bc9ab7c13ae8bf7b", class: "toast-action" }, h("slot", { key: "ad0cef8b888cc0a69b02f94eec37e6b68cf21c7e", name: "action" }))), h("div", { key: "5e26691f923d584144200878b9a15a218abe263a", class: "toast-close" }, h("ix-icon-button", { key: "40dfab1c9d524a73fd9913097dd4c3fbc42e4569", icon: iconClose, iconColor: "color-soft-text", size: "24", variant: "tertiary", onClick: () => this.closeToast.emit(), "aria-label": this.ariaLabelCloseIconButton }))), !this.preventAutoClose && h("div", { key: "8530abe8bb92bcfebcc5fd62f6dddcca1d641fa9", class: progressBarClass.join(" "), style: progressBarStyle, onAnimationEnd: () => {
      this.close();
    }, onTransitionEnd: () => {
      if (this.progress === 0) {
        this.close();
