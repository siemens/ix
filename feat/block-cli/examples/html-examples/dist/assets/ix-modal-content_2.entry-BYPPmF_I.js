import { r as registerInstance, h, H as Host, c as createEvent, g as getElement } from "./global-B1t25MFd.js";
...
const ModalHeader = class {
  ...
  render() {
    return h(Host, { key: "572fdfc64b41a4d3295a406b05587610dc89ec8f" }, this.icon ? h("ix-icon", { name: this.icon, color: this.iconColor, size: "32", "aria-label": this.ariaLabelIcon }) : null, h("div", { key: "854589b72118fb1d88e197e74ae31fe6403bd7e3", class: "modal-title" }, h("ix-typography", { key: "84fc06aa0cef06a4697db4347cf7d17bfbf57e1b", format: "h5" }, h("slot", { key: "36026c77dbc781024946b2de14146fe2c2b7022b" }))), !this.hideClose ? h("ix-icon-button", { class: "modal-close", onClick: (event) => this.onCloseClick(event), variant: "tertiary", icon: iconClose, iconColor: "color-soft-text", "aria-label": this.ariaLabelCloseIconButton }) : null);
  }
