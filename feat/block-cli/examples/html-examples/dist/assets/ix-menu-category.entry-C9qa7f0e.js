...
const MenuCategory = class extends Mixin(...DefaultMixins) {
  ...
  render() {
    return h(Host, { key: "939b82160a175ffcd1898358e4ec9678e50fc5dd", class: {
    ...
    } }, h("ix-menu-item", { key: "f250ca97f3bfd382ff453021f3c69537579bc170", "aria-haspopup": "true", "aria-expanded": this.showItems || this.showDropdown ? "true" : "false", ref: this.categoryParentRef, class: "category-parent", active: this.isNestedItemActive(), notifications: this.notifications, icon: this.icon, onClick: (e) => this.onCategoryClick(e), onKeyDown: (event) => this.onKeyDown(event), tooltipText: this.tooltipText, isCategory: true }, h("span", { key: "bba17387700a53ac4d72eac50739285c85456e05", class: "category" }, h("span", { key: "aeed30d07e6563a2043408e9f31f39f647329650", class: "category-text" }, this.label), h("ix-icon", { key: "9cb90b62b42ef440ad4ddeab5b3a255cc2df00c6", name: iconChevronDownSmall, class: {
      "category-chevron": true,
      "category-chevron--open": this.showItems
    }, "aria-hidden": "true" }))), h("div", { key: "3586af1ec63e65ab02a2ac37507c685ffaef36b1", ref: (ref) => this.menuItemsContainer = ref, class: {
      "menu-items": true,
      "menu-items--expanded": this.showItems,
      "menu-items--collapsed": !this.showItems
    }, role: "menu", onKeyDown: (e) => this.onMenuItemsKeyDown(e) }, this.showItems ? h("slot", null) : null), h("ix-dropdown", { key: "f1e075b3991ba22ef011383f322f5477e3c16469", ref: this.dropdownRef, hostRole: "menu", "aria-label": this.label, closeBehavior: "both", show: this.showDropdown, onShowChange: ({ detail: dropdownShow }) => {
      if (dropdownShow) {
        return;
      }
    ...
    } }, h("ix-dropdown-item", { key: "9ef1f832349fa2735ceb7123624e17c8ebd41941", class: "category-dropdown-header", tabindex: -1, "aria-hidden": "true" }, h("ix-typography", { key: "9ffc014feac341a0c37e4b6dd19d9ce85752e91a", format: "label", bold: true, textColor: "std" }, this.label)), h("ix-divider", { key: "054b7de81f9d309dee3e451d8d4b23fa83a35aff" }), h("slot", { key: "3bcf3b6172f0df1e1e3575296c94123de7094f0b" })));
  }
