...
import { n as iconHistory } from "./index-DgUGsIlh-CLxQRaVd.js";
...
import { B as BaseButton } from "./base-button-DZdtpLxn-pLLOE8Sr.js";
import { b as a11yHostAttributes, a as a11yBoolean } from "./a11y-C21npbUc-CU_Bg8RX.js";
import { T as TRAP_FOCUS_EXCLUDE_ATTRIBUTE } from "./focus-trap-IK9ialav-CffRa992.js";
...
const DateDropdown = class extends Mixin(...DefaultMixins) {
  ...
  render() {
    ...
    return h(Host, { key: "0d594274db3f5820b6345f587c604d119b03e058", onFocusout: (event) => {
      const relatedTarget = event.relatedTarget;
      if (!relatedTarget) {
        return;
      }
      this.closeDropdown();
    }, role: "presentation" }, h("ix-button", { key: "5071986ad111202d426597c1ac914277b5cd7b0a", "data-testid": "date-dropdown-trigger", "data-date-dropdown-trigger": true, variant: this.variant, loading: this.loading, icon: iconHistory, ref: this.triggerRef, disabled: this.disabled, ...this.inheritAriaAttributes, "aria-haspopup": "true", "aria-expanded": a11yBoolean(this.show), "aria-controls": "date-dropdown", "aria-label": ariaLabel, [TRAP_FOCUS_EXCLUDE_ATTRIBUTE]: true }, this.getButtonLabel()), h("ix-dropdown", { key: "9f7541d957dbec4a3af51a107740ed11566368cd", focusTrapOptions: {
    ...
    } }, h("div", { key: "5f76ff57ab9f1326cea36750e1e19b710033d5e8", class: "container" }, this.dateRangeOptions?.length > 1 && h("div", { key: "1b0b0887c20817c7be361f13dfcd9d050c05cad5", class: {
    ...
    } }, dateRangeOption.label))), h("div", { key: "855d52697d23ad58d8359f4dade55d4c97c5b576", class: "picker-wrapper" }, h("ix-date-picker", { key: "de38ab0474d671515db231a50b2299a6f97c0a78", ref: this.datePickerRef, embedded: true, locale: this.locale, onDateChange: (e) => {
      e.stopPropagation();
      this.currentRangeValue = {
        ...e.detail,
        id: "custom"
      };
    }, onDateRangeChange: (e) => e.stopPropagation(), format: this.format, singleSelection: this.singleSelection, from: this.from || this.currentRangeValue?.from, to: this.to || this.currentRangeValue?.to, minDate: this.minDate, maxDate: this.maxDate, today: this.today, weekStartIndex: this.weekStartIndex, showWeekNumbers: this.showWeekNumbers }), h("div", { key: "79b64ec8f88dff7b6b7b7e3f81d8262f5fa3d88e", class: "pull-right" }, h("ix-button", { key: "18291b38601b7d8f8b7537e76b82c89974227f0e", onClick: () => {
      if (this.currentRangeValue) {
        this.onDateSelect(this.currentRangeValue);
        this.closeDropdown();
      }
