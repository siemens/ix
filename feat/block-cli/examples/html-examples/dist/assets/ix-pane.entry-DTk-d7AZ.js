...
import { G as iconDoubleChevronDown, H as iconDoubleChevronRight, I as iconDoubleChevronUp, J as iconDoubleChevronLeft, r as iconClose } from "./index-CwfZ4aN6-mXhHymhu.js";
...
const Pane = class {
  ...
  render() {
    ...
    return h(Host, { key: "e6feb5283079964a8ddd081ec7571d73466c07c1", class: {
    ...
    }, "aria-expanded": a11yBoolean(this.expanded) }, h("aside", { key: "7eee6d5bdc649afb49992c75b59df4929b32f9b9", id: `pane-${this.composition}`, class: {
      "top-bottom-pane": this.isBottomTopPane && !this.isMobile,
      "left-right-pane": this.isLeftRightPane && !this.isMobile,
      "mobile-pane": this.isMobile,
      expanded: this.expanded
    } }, h("div", { key: "6bcebd183787b43d3e6e9cdf4efa94fb56463a5b", id: "title-div", class: {
    ...
    } }, h("ix-icon-button", { key: "461958616fed2228a99d690b66e4cc0eb851f876", class: "title-icon", size: "24", icon: this.expanded ? this.isMobile || this.hideOnCollapse ? iconClose : this.expandIcon : this.minimizeIcon, iconColor: this.expanded && (this.isMobile || this.hideOnCollapse) ? "color-soft-text" : void 0, variant: "subtle-tertiary", onClick: () => this.dispatchExpandedChangedEvent(), "aria-controls": `pane-${this.composition}`, "aria-label": paneButtonAriaLabel }), h("div", { key: "fabc1e6f1f7a130d326dd981afd4f6989feda4fd", class: {
      "title-text": true,
      rotate
    } }, this.icon && h("ix-icon", { key: "e0deb6f5bd8c520b81f280275cc173f228d82298", class: "pane-icon", size: "24", name: this.icon, "aria-label": this.ariaLabelIcon }), h("div", { key: "a4c27b869be70d49b5eb006aa541dae77ddee37d", class: "title-text-overflow" }, h("ix-typography", { key: "477d78a473dc0dbe3d7a3268b65984118c5661ea", format: "h4" }, this.heading)), this.expanded && h("div", { key: "949be55e131f6290e6fff527810122836df1e754", class: "slot-header" }, h("slot", { key: "58ee3ff7b08b7588ba43598eb1b47a932610ef19", name: "header" })))), h("div", { key: "4737699e00693c9a451bc1cdc13937cb52a2cc4e", class: "side-pane-content", hidden: !this.showContent }, h("slot", { key: "d77a10e4b88689573dbe2360e20970037eaee493" }))));
  }
  static get watchers() {
    return {
      "expanded": [{
