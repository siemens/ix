...
import { s as shouldSuppressInternalValidation } from "./validation-YeAaQqsK-CQfTnaKj.js";
...
function TextareaElement(props) {
  return h("textarea", { readOnly: props.readonly, disabled: props.disabled, maxLength: props.maxLength, minLength: props.minLength, cols: props.textareaCols, rows: props.textareaRows, ref: props.textAreaRef, class: {
