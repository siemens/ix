...
const MenuSettings = class {
  ...
  render() {
    return h(Host, { key: "cc3891dd33fead6f6e06a114be0cba596665d164", slot: "ix-menu-settings", class: {
      show: this.show,
      ["legacy-tabs"]: !this.suppressLegacyTabs
    } }, h("div", { key: "766d6853cbaa158116a46ae1c9e4ccad8bad6825", class: "settings-header" }, h("h2", { key: "17aab0e7c55ad74a5430ad2468c7706d057bd00b", class: "text-h2" }, this.label), h("ix-icon-button", { key: "80ec65e7bc3cef64593d7ba9bade855a68a4bc3c", variant: "tertiary", size: "24", icon: iconClose, iconColor: "color-soft-text", "aria-label": this.ariaLabelCloseButton, onClick: (e) => this.close.emit({
