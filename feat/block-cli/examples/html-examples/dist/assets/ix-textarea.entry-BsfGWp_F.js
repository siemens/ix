...
import { m as mapValidationResult, g as checkInternalValidity, T as TextareaElement, d as onInputBlurWithChange, j as onInputFocus } from "./input.fc-CyTJ73r0-MncRToPr.js";
...
const Textarea = class {
  ...
  render() {
    var _a;
    return h(Host, { key: "3b5a558715aab896baa94263c519f2d9b24733e9", class: {
      disabled: this.disabled,
      readonly: this.readonly
    } }, h("ix-field-wrapper", { key: "36aff9dc667aac21337a49a99f792dbb6c9fcf8c", required: this.required, label: this.label, helperText: this.helperText, invalidText: this.invalidText, infoText: this.infoText, warningText: this.warningText, validText: this.validText, showTextAsTooltip: this.showTextAsTooltip, isInvalid: this.isInvalid, isValid: this.isValid, isInfo: this.isInfo, isWarning: this.isWarning, controlRef: this.textAreaRef }, !!this.maxLength && this.maxLength > 0 && h("ix-typography", { key: "55d7959db9fea8226cf241b5e16e227a8b04744e", class: "bottom-text", slot: "bottom-right", textColor: "soft" }, ((_a = this.value) !== null && _a !== void 0 ? _a : "").length, "/", this.maxLength), h("div", { key: "dfb043c6f47ec7e945b842a3bf738cf51a49a70e", class: "input-wrapper" }, h(TextareaElement, { key: "93f96547f872d74139deb9956fe2827a86222557", minLength: this.minLength, maxLength: this.maxLength, textareaCols: this.textareaCols, textareaRows: this.textareaRows, textareaHeight: this.isManuallyResized ? this.manualHeight : this.textareaHeight, textareaWidth: this.isManuallyResized ? this.manualWidth : this.textareaWidth, resizeBehavior: this.resizeBehavior, readonly: this.readonly, disabled: this.disabled, isInvalid: this.isInvalid, required: this.required, value: this.value, placeholder: this.placeholder, textAreaRef: this.textAreaRef, onFocus: () => onInputFocus(this, this.value), valueChange: (value) => this.valueChange.emit(value), updateFormInternalValue: (value) => this.updateFormInternalValue(value), onBlur: () => {
