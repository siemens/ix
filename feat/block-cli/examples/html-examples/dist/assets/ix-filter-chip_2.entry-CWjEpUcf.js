import { r as registerInstance, c as createEvent, g as getElement, h, H as Host, M as Mixin } from "./global-B1t25MFd.js";
import { n as iconCloseSmall } from "./index-CwfZ4aN6-mXhHymhu.js";
import { I as IX_FOCUS_VISIBLE_ACTIVE, a as IX_FOCUS_VISIBLE } from "./focus-utilities-Cmy8BJlr-BZaPzC8e.js";
import { F as FocusVisibleMixin } from "./focus-visible.mixin-DafJ39p9-Cuo2tcKA.js";
...
const SelectItem = class extends Mixin(...DefaultMixins, FocusVisibleMixin, ComponentIdMixin) {
  ...
  render() {
    ...
    return h(Host, { key: "8d809fb7ab077092ab6fb9aaf0d6fa11b84d223a", ...ariaAttributes, id: this.getHostElementId(), class: {
      [IX_FOCUS_VISIBLE]: true
    }, "aria-hidden": "true", role: "presentation" }, h("ix-dropdown-item", { key: "829e232cfd379b2b2de97bae9e5343289960cffa", "aria-hidden": "true", role: "option", class: {
