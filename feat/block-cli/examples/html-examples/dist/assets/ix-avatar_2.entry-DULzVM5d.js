import { M as Mixin, r as registerInstance, g as getElement, a as readTask, h, F as Fragment, H as Host, c as createEvent } from "./global-DSse0xVy.js";
...
import { P as PROXY_LISTITEM_ID_SUFFIX, u as updateFocusProxyList, F as FocusProxy } from "./focus-proxy-BQyoX-Kl-CfdGw9fi.js";
...
const MenuAvatarItem = class {
  ...
  render() {
    return h("ix-dropdown-item", { key: "202fa9097e985838e2305e7d85fd63e865bae4f4", ref: this.dropdownItemRef, icon: this.icon, label: this.label, onClick: (e) => this.itemClick.emit(e) });
  }
};
