import { g as getElement, r as registerInstance, c as createEvent, h, H as Host } from "./global-Cx3A0XQN.js";
...
const Upload = class {
  ...
  render() {
    ...
    return h(Host, { key: "b8700946d19195326a16928c4d9db0de04c9ab97", ...a11y, "aria-disabled": disabled }, h("div", { key: "80be0cdebcac643c882c6835b70f552940d4e3da", class: {
    ...
    }, onDragOver: (e) => this.fileOver(e), onDragLeave: () => this.fileLeave() }, this.renderUploadState(), h("div", { key: "e6ce52d45fb364817f3ca238d38dc4b761591bad" }, h("input", { key: "1fb56f32088354150e3c2a01c4eed4813b36c280", "aria-label": ariaLabel, "aria-disabled": disabled, multiple: this.multiple, type: "file", class: "upload-browser", id: "upload-browser", ...directoryAttributes, tabindex: "-1", onChange: (e) => {
      this.fileChangeEvent(e);
    }, accept: this.accept, disabled }), h("ix-button", { key: "9c3632ccd0bdfd323062ed7ea5ab19af273559b6", variant: "secondary", "aria-disabled": disabled, onClick: () => this.inputElement.click(), disabled }, this.i18nUploadFile ?? (this.directoryUpload ? "Upload folder…" : "Upload file…")))));
  }
};
