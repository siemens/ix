...
const MenuSettings = class {
  ...
  render() {
    return h(Host, { key: "646e7ba2027d746e09e1033c9a05d6fd4f7c3a10", slot: "ix-menu-settings", class: {
      show: this.show,
      ["legacy-tabs"]: !this.suppressLegacyTabs
    } }, h("div", { key: "30b104e84c2cb7a6bab09cfcfa9d7d133b97d300", class: "settings-header" }, h("h2", { key: "46df2c6be8870008cb2343465273fa8667667d19", class: "text-h2" }, this.label), h("ix-icon-button", { key: "576a0eaecba4e64a7c29bf7710ec774a6e32a905", variant: "tertiary", size: "24", icon: iconClose, iconColor: "color-soft-text", "aria-label": this.ariaLabelCloseButton, onClick: (e) => this.close.emit({
