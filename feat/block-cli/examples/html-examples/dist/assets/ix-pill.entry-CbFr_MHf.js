...
const Pill = class {
  ...
  render() {
    ...
    return h(Host, { key: "89d308c7887ff95cf99d3459fdb4c7d2e171a176", style: this.variant === "custom" ? {
      "--ix-icon-button-color": this.pillColor
    } : {}, class: {
      "align-left": this.alignLeft
    } }, h("div", { key: "d5c2e3af81eda8fe52eb658ca82c614d6a33ff45", ref: this.containerElementRef, style: { ...customStyle }, class: {
      container: true,
    ...
    } }, this.icon && h("ix-icon", { key: "bb46fc09a785b1ae16e8af790cf71565a446d416", class: {
      "with-icon": true
    }, name: this.icon, size: "16", "aria-label": this.ariaLabelIcon }), h("span", { key: "d4271c12c3a1986de75b204803b7bceaad0a8db0", class: "slot-container" }, h("slot", { key: "e00bbe3af010caf7e1c47439929f5380e6d17678", onSlotchange: () => this.checkIfContentAvailable() }))), this.getTooltip());
  }
};
Pill.style = pillCss();
export {
