...
const BaseButton = (props, children) => {
  ...
  if (props.href) {
    return h("a", { ...commonAttributes, href: props.disabled ? void 0 : props.href, target: props.target, role: "button", rel: props.rel, onClick: (e) => handleOnClick(e, props) }, buttonContent);
  }
  return h("button", { ...commonAttributes, onClick: (e) => handleOnClick(e, props), type: props.type }, buttonContent);
};
export {
  BaseButton as B,
