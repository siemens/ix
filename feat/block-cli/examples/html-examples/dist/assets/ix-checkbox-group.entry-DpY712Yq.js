...
const CheckboxGroup = class {
  ...
  render() {
    return h(Host, { key: "8664ed4fdefaef62afcab7643f9654a76c8b96c5", ref: this.groupRef, onIxBlur: () => this.touched = true }, h("ix-field-wrapper", { key: "ff70d6c90b8c2c530f0e6f35f588083e666e533a", label: this.label, helperText: this.helperText, invalidText: this.invalidText, infoText: this.infoText, validText: this.validText, warningText: this.warningText, showTextAsTooltip: this.showTextAsTooltip, isInvalid: this.isInvalid, isInfo: this.isInfo, isValid: this.isValid, isWarning: this.isWarning, controlRef: this.groupRef }, h("div", { key: "81f6f7713e20683da3ce0076a8b9feca69d020cb", class: {
      "checkbox-container": true,
      "row-layout": this.direction === "row"
    } }, h("slot", { key: "c3f76197cbd5846412300214653a8d96bd6a3a50" }))));
  }
  get hostElement() {
