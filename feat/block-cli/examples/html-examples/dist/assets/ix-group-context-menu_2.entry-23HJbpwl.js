import { r as registerInstance, g as getElement, h, H as Host, c as createEvent } from "./global-X6m21_-k.js";
...
const GroupContextMenu = class {
  ...
  render() {
    return h(Host, { key: "5c8c3b0afec0d1ac31b7ecc3842f040beff4abeb" }, h("ix-icon-button", { key: "c2d3843ee4ebf040009e818f7f000a213da57d2b", class: { hide: !this.showContextMenu }, size: "24", variant: "subtle-tertiary", icon: iconContextMenu }), h("slot", { key: "69b56b85de4d4b78d223b7f4c0e7bde98c212637", onSlotchange: () => this.onSlotChange() }));
  }
};
