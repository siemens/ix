import { r as registerInstance, g as getElement, h, H as Host, c as createEvent } from "./global-F68Qu5y3.js";
...
const GroupContextMenu = class {
  ...
  render() {
    return h(Host, { key: "26bfb8120dda0bbab43251771e6cebeb6ca5b024" }, h("ix-icon-button", { key: "5b4b4923cbbd145dbfcc1ebb14df7e51a299a376", class: { hide: !this.showContextMenu }, size: "24", variant: "subtle-tertiary", icon: iconContextMenu }), h("slot", { key: "1c2bb77a6c9b881f5b97117d42812695b960ccf3", onSlotchange: () => this.onSlotChange() }));
  }
};
