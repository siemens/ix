import { M as Mixin, r as registerInstance, g as getElement, h, H as Host, c as createEvent, a as readTask } from "./global-J1r-v9CX.js";
...
import { A as iconClose, e as iconMoreMenu } from "./index-BcWSlcx_-DijX28Uj.js";
...
import { I as InheritAriaAttributesMixin } from "./inherit-aria-attributes.mixin-nCmPujqf-D4tm_8PR.js";
...
const Pill = class extends Mixin(...DefaultMixins) {
  ...
  render() {
    ...
    return h(Host, { key: "8ceb011364a27d429844c4757c18812f43e14948", style: this.variant === "custom" ? {
      "--ix-icon-button-color": this.pillColor
    } : {}, class: {
      "align-left": this.alignLeft
    }, role: hostRole }, h("div", { key: "52a5f45dac3c1c22ce302aabaefe21bcb8d9d590", ref: this.containerElementRef, style: { ...customStyle }, class: {
      container: true,
    ...
    } }, this.icon && h("ix-icon", { key: "d8ced849fa981f48a6914867917deb247f6cca26", class: {
      "with-icon": true
    }, name: this.icon, size: "16", "aria-label": this.ariaLabelIcon, "aria-hidden": a11yBoolean(iconIsDecorative) }), h("span", { key: "fb3dcd6e1fbb0a31877370d6cad2a9ddb3f367bd", class: "slot-container" }, h("slot", { key: "23938b53bafafca32341c0425a93c03c173adb46", onSlotchange: () => this.checkIfContentAvailable() }))), this.getTooltip());
  }
};
Pill.style = pillCss();
...
const TabItem = class extends Mixin(...DefaultMixins, ComponentIdMixin, BaseTabMixin) {
  ...
  render() {
    ...
    return h(Host, { key: "8834afadee96a367e03be58014201168d2ec254e", id: this.getHostElementId(), role: "tab", "aria-selected": a11yBoolean(this.selected), tabIndex: this.selected && !this.disabled ? 0 : -1, class: {
    ...
    } }, variant === "rounded" && h("div", { key: "eb0dce7a1843d13f4ccf95fd6846304ef81b5c9c", class: {
      circle: true
    } }, this.icon && h("ix-icon", { key: "851adccb7c3e1b40f3abfb7b8abcbf1eca01afd6", name: this.icon, size: "24" }), h("slot", { key: "0d9e9197d5a4dd24edae81416b28f7a5d1e9cff2" })), this.icon && variant !== "rounded" && h("ix-icon", { key: "966084753316de9dc35748635c2aa91120e0999c", name: this.icon, size: "16", class: "tab-icon" }), variant === "normal" && h("div", { key: "635f24f3ea17fa569ce629050d9fee82dcee2e92", class: {
      text: !!this.label,
      selected: this.selected,
      disabled: this.disabled
    } }, this.label, h("slot", { key: "fb559adab6c31bdc7b4fbe1469ce2137f9e4c067" })), variant === "rounded" && this.counter !== void 0 && h("div", { key: "c68b0866a678d3a329124c127aa71b2271a43abc", class: {
      counter: true,
      selected: this.selected,
      disabled: this.disabled
    } }, this.counter), this.counter && variant !== "rounded" && h("ix-pill", { key: "02d606ada565dcccc39913a49fe0a4861bb23036", variant: "primary", outline: true, class: "tab-counter" }, this.counter), this.closable && variant !== "rounded" && h("ix-icon-button", { key: "216d2312f78414e0f0cf5642adda113ff84f03cb", "aria-label": this.ariaLabelCloseButton, class: "close-tab", size: "12", variant: "subtle-tertiary", icon: iconClose, onClick: (event) => {
      event.stopPropagation();
      event.preventDefault();
      this.tabClose.emit({
        tabKey: this.tabKey,
...
const TabSet = class {
  ...
  render() {
    return h(Host, { key: "56726b4cba61e9528db1332d251e4a83436e0fe1", onTabChange: () => this.checkPanelsVisibility() }, h("slot", { key: "fd923d2708e4f5bc3022fe79fe7b7242000498bd" }));
  }
};
...
const Tabs = class extends Mixin(...DefaultMixins, InheritAriaAttributesMixin) {
  ...
  render() {
    return h(Host, { key: "255227122295c3dc42e0f0fe5dd6309024a92b4b", onTabClick: (event) => this.onTabClick(event), class: {
      small: this.small
    } }, h("div", { key: "899eb29ebf591a35cacaf7c0629cdb86b1334fcb", ref: this.tabsContainerRef, class: {
      "tabs-container": true,
      top: this.placement === "top",
      bottom: this.placement === "bottom"
    } }, h("div", { key: "06b2f653aa221d16040c360a92dff33cdba6d210", class: {
      "overflow-shadow-container": true,
      "overflow-shadow": this.isTabsOverflow
    } }, h("div", { key: "b0cdb80e4ab55ad30e225465d8190545deab981e", role: "tablist", ...this.inheritAriaAttributes, ref: this.tabsRef, class: {
      tabs: true,
      "tabs-stretched": this.layout === "stretched"
    }, tabIndex: this.isTabsOverflow ? 0 : -1, onKeyDown: (event) => this.onTabsNavigate(event) }, h("slot", { key: "3a46ffb81fa881c9ebb923bff9311476368c71e2" }))), this.isTabsOverflow && this.layout !== "stretched" && h("ix-dropdown-button", { key: "0691d411664ffa91931ce716df00d57694b615c1", ariaLabel: this.ariaLabelMoreTabs, icon: iconMoreMenu, class: {
