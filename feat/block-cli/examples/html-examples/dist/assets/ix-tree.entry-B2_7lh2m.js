...
const Tree = class {
  ...
  render() {
    return h(Host, { key: "b3d7a42926c32f4d244806fca3c8f9f282c00f5b", onClick: (event) => this.onTreeItemClick(event) }, h("slot", { key: "20c49c639b9eb52fcfc9a3da4348522b387e548e" }));
  }
  static get watchers() {
    return {
      "model": [{
