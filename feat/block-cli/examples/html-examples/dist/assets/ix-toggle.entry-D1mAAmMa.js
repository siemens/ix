...
const Toggle = class extends Mixin(...DefaultMixins, InheritAriaAttributesMixin) {
  ...
  render() {
    ...
    return h(Host, { key: "67e9bba4444b5577389c6b5ee79a47040ee1b1c2", ...this.inheritAriaAttributes, role: "switch", tabindex: this.disabled ? -1 : 0, "aria-label": ariaLabel, "aria-checked": ariaChecked, "aria-disabled": a11yBoolean(this.disabled), "aria-required": a11yBoolean(this.required), class: {
    ...
    } }, h("div", { key: "4cc65d17b72d0e5b1a0e23d9d24279d354630f33", class: "wrapper" }, h("div", { key: "21432d7b554cab2d6e14b7405a347332b2a3403d", class: {
      switch: true,
      checked: this.checked,
      indeterminate: this.indeterminate
    }, "aria-hidden": "true" }, h("div", { key: "0f413adb1178d4a1ba7f8d6a59c500369db49cb0", class: "slider" })), !this.hideText && h("ix-typography", { key: "49e0c92438f565898fb14ee59293fa138eba73b5", class: "label", "aria-hidden": "true" }, toggleText)));
  }
