...
const MenuItem = class extends Mixin(...DefaultMixins, InheritAriaAttributesMixin) {
  ...
  render() {
    ...
    const menuContent = [
      this.icon && h("ix-icon", { key: "36fa94ead0698ee7e260090e65ad5da86eb73cb5", class: "tab-icon", name: this.icon, "aria-hidden": "true" }),
      this.notifications ? h("div", { class: "notification" }, h("div", { class: "pill" }, this.notifications)) : null,
      h("span", { key: "fb15ec45ec43fc6fa59fc74a823f3f0669b9eece", id: this.internalItemId, class: "tab-text text-default" }, this.label, h("slot", { key: "ac0c7112a445f100523fd5eabfe9a917b434c8c7" }))
    ];
    const ariaLabel = this.getAriaLabel();
    return h(Host, { key: "09848ad0bf3026c3d1b4af9a4a0fcdd336c3e3ae", class: {
