import { r as registerInstance, c as createEvent, g as getElement, h, H as Host, M as Mixin } from "./global-CRrZCTD3.js";
...
const FilterChip = class {
  ...
  render() {
    return h(Host, { key: "4a4812d88a905a5d206c6ece0690149c774d4166", class: {
      disabled: this.disabled,
      readonly: this.readonly,
      "hide-close-button": this.hideCloseButton
    }, title: this.hostElement.textContent }, h("div", { key: "d18885235e8a8eef90643ffdf826a097cefec941", class: "slot-container" }, h("slot", { key: "384a6fd4177e35a1108d9af466484de46893f852" })), !this.disabled && !this.readonly && !this.hideCloseButton ? h("ix-icon-button", { variant: "tertiary", oval: true, icon: iconCloseSmall, size: "16", disabled: this.disabled, onClick: (event) => {
...
const SelectItem = class extends Mixin(...DefaultMixins, FocusVisibleMixin, ComponentIdMixin) {
  ...
  render() {
    ...
    return h(Host, { key: "a28fdf34069f24622def329068ddf18f05446313", ...ariaAttributes, id: this.getHostElementId(), disableAriaSelectHandling: true, class: {
      [IX_FOCUS_VISIBLE]: true
    }, "aria-hidden": "true", role: "presentation" }, h("ix-dropdown-item", { key: "eb60977b8659bbec7b342dcfe33c9392bf18237e", "aria-hidden": "true", itemRole: "option", class: {
