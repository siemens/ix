...
const Tree = class {
  ...
  render() {
    return h(Host, { key: "4d24fe9dbdd5fb7b1b8b026c258fa980d7806551", onClick: (event) => this.onTreeItemClick(event) }, h("slot", { key: "2d526fedc93a5e5a023950a64b778536c8d962b1" }));
  }
  static get watchers() {
    return {
      "model": [{
