...
import { i as inline, s as shift, o as offset, a as autoUpdate, f as flip, c as computePosition } from "./floating-ui.dom-B6Pk1ink-B8uV3VNw.js";
...
import { b as addFocusTrap } from "./focus-trap-Ci7SFoiU-By66Ri_a.js";
import { q as queryElements, a as IX_FOCUS_VISIBLE, I as IX_FOCUS_VISIBLE_ACTIVE, b as focusElement, c as focusFirstDescendant, d as focusLastDescendant, e as focusElementInContext } from "./focus-utilities-COIIN2Es-jUaNMCSm.js";
import { D as DefaultMixins, r as removeVisibleFocus, h as hasKeyboardMode } from "./component-BUhl9jvG-ByrxCX0G.js";
...
import { T as iconSingleCheck, j as iconChevronRightSmall } from "./index-DLhpBBEI-C3tPjcQ4.js";
import { a as a11yBoolean } from "./a11y-B5k8YVR0-BOSd6BQK.js";
import { C as ComponentIdMixin } from "./id.mixin-CUbYLenp-DR0VgaO1.js";
import { F as FocusVisibleMixin } from "./focus-visible.mixin-BdXDSeim-C6S1rZW3.js";
...
const Dropdown = class extends Mixin(...DefaultMixins) {
  ...
  render() {
    ...
    return h(Host, { key: "8ae3e3bb353ded938f04a472ef9f405d01361e08", ...ariaAttributes, "aria-modal": "true", "data-ix-dropdown": this.dropdownElementId, "data-ix-focus-trap": true, class: {
      "dropdown-menu": true,
      show: this.show,
...
const DropdownItem = class extends Mixin(...DefaultMixins, ComponentIdMixin, FocusVisibleMixin) {
  ...
  render() {
    ...
    return h(Host, { key: "c339357f8c442d70fc60dafbbf22254aaeb1a546", id, role: "menuitem", "aria-disabled": a11yBoolean(this.disabled), "aria-label": this.hostElement.ariaLabel ?? this.ariaLabelButton, class: {
      hover: this.hover,
    ...
    }, ...submenuAriaAttributes }, h("div", { key: "c5e6f9300aba88805f7cb632dde24679e4d84dca", class: {
      "dropdown-item": true,
      "no-checked-field": this.suppressChecked,
      disabled: this.disabled
    } }, !this.suppressChecked ? h("div", { class: "dropdown-item-checked" }, this.checked ? h("ix-icon", { "aria-hidden": "true", class: "checkmark", name: iconSingleCheck, size: "16" }) : null) : null, this.icon ? h("ix-icon", { class: "dropdown-item-icon", name: this.icon, "aria-label": this.ariaLabelIcon }) : null, h("div", { key: "3bf3dc8dd01bdf297ed1e73eca2279470ab9ebe1", class: "dropdown-item-text" }, this.label, h("slot", { key: "69392fcf278c0b96d320b4680b7a23031b5197fe" })), this.isSubMenu ? h("ix-icon", { name: iconChevronRightSmall, class: "submenu-icon" }) : null));
  }
  static get watchers() {
    return {
      "ixFocusVisible": [{
