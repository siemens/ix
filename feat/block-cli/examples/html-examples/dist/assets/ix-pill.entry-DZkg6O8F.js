...
const Pill = class {
  ...
  render() {
    ...
    return h(Host, { key: "e67679395deecef85695a4d0fee799893f77d53b", style: this.variant === "custom" ? {
      "--ix-icon-button-color": this.pillColor
    } : {}, class: {
      "align-left": this.alignLeft
    } }, h("div", { key: "578e10872772ecfde2ffeb5f599638e150cdb6cc", ref: this.containerElementRef, style: Object.assign({}, customStyle), class: {
      container: true,
    ...
    } }, this.icon && h("ix-icon", { key: "c4c915d8d14d6eddf1c221f1b3a5e482468bcf57", class: {
      "with-icon": true
    }, name: this.icon, size: "16", "aria-label": this.ariaLabelIcon }), h("span", { key: "29fa325cf80561bf1f2954b2f3eefc22f7af540d", class: "slot-container" }, h("slot", { key: "16e826879bcb5d74e26af38eb9a6525208ac0ca9", onSlotchange: () => this.checkIfContentAvailable() }))), this.getTooltip());
  }
  get hostElement() {
