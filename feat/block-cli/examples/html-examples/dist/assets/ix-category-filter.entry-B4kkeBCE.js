...
const CategoryFilter = class {
  ...
  render() {
    return h(Host, { key: "64ed46f9a82d5bda42bd07d3280ba77c8dbfc028" }, h("form", { key: "d80fb893bb57b3d27b1e4defee5d4b43ad04e525", ref: (el) => this.formElement = el }, h("div", { key: "78db2d218b024a20d02c92bea6ec34897c540a74", "read-only": this.readonly, class: {
      "input-container": true,
      disabled: this.disabled,
      focus: this.hasFocus,
      readonly: this.readonly,
      "no-icon": this.hideIcon
    } }, h("ix-icon", { key: "6c7fca26b7fe33b38c16b6f87f7031a6dc42dc7d", color: this.getIconColor(), class: { "display-none": this.hideIcon }, name: this.icon ?? iconSearch, size: "16" }), h("div", { key: "ff54b75a1e6923bcd3a6ffb28f66e85dd6b813b8", class: "token-container" }, h("div", { key: "4e6a7d98534cd2d2e4e6ef2119f9ae2c3588a5ef", class: "list-unstyled" }, this.filterTokens.map((value, index) => h("span", { key: value.toString(), class: {
    ...
    } }, this.categories[this.category]?.label), h("input", { key: "e97eeaf0ed4b350ab4358e5d04bdd1d745944c1d", class: {
      "text-input": true,
