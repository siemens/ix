import { M as Mixin, a as registerInstance, g as getElement, h, H as Host } from "./global-B8nXsUf-.js";
import { B as BaseIconButton } from "./base-icon-button-CohA_oca-D0z96kv6.js";
import { g as getFallbackLabelFromIconName, b as a11yHostAttributes } from "./a11y-C21npbUc-CU_Bg8RX.js";
...
import "./base-button-fFKf0UFL-CLNzrfb6.js";
...
const IconButton = class extends Mixin(...DefaultMixins, InheritAriaAttributesMixin) {
  ...
  render() {
    ...
    return h(Host, { key: "5da237b25594e8965f0aeadf008196ce18b20659", class: {
      ...this.getIconSizeClass(),
      disabled: this.disabled || this.loading
    }, tabIndex: this.disabled ? -1 : 0 }, h(BaseIconButton, { key: "e5d6d13e01f625dcd7eabcca48d66dc1a82f840f", ...baseButtonProps }));
  }
...
const Spinner = class {
  ...
  render() {
    ...
    return h(Host, { key: "70b6a8cbf609f9f22ed1fc2c25f2da8853a2a8fa", ...ariaProperties }, h("div", { key: "a705255013f19b2e79421562a2c46b5827b9615a", class: {
