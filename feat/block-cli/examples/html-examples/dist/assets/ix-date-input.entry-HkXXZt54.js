...
import { q as iconCalendar } from "./index-DLhpBBEI-C3tPjcQ4.js";
import { D as DateTime } from "./luxon-wpz4A-OQ-B58AoryR.js";
import { c as createPickerValidityStateTracker, a as addDisposableChangesAndVisibilityObservers, b as adjustPaddingForStartAndEnd, h as handleSubmitOnEnterKeydown, S as SlotEnd, o as onInputBlurWithChange, d as SlotStart, e as emitPickerValidityState } from "./input.fc-mVVYOifc-Dt2B7_tz.js";
...
const DateInput = class extends Mixin(...DefaultMixins, InputPickerMixin) {
  ...
  render() {
    ...
    return h(Host, { key: "f2388fa7c0063ff44879048b0878eef862b9fc59", class: {
      ...
      this.closeDropdown();
    } }, h("ix-field-wrapper", { key: "2eb07a86dfc6ea104109058bf2ed7383df7e0d40", label: this.label, helperText: this.helperText, isInvalid: this.isInvalid, invalidText, infoText: this.infoText, isInfo: this.isInfo, isWarning: this.isWarning, warningText: this.warningText, isValid: this.isValid, validText: this.validText, showTextAsTooltip: this.showTextAsTooltip, required: this.required, controlRef: this.inputElementRef }, this.renderInput()), h("ix-dropdown", { key: "1309511e03ea515972419e61649cb23296c63a5e", "data-testid": "date-dropdown", trigger: this.inputElementRef.waitForCurrent(), ref: this.dropdownElementRef, closeBehavior: "outside", enableTopLayer: this.enableTopLayer, suppressOverflowBehavior: true, show: this.show, onShowChanged: (event) => {
      ...
      return true;
    }, keyboardActivationKeys: ["ArrowUp", "ArrowDown"] }, h("ix-date-picker", { key: "02bb52db6a93cf7f8208f013689e43365aca7119", ref: this.datepickerRef, format: this.format, locale: this.locale, singleSelection: true, from: this.from ?? "", minDate: this.minDate, maxDate: this.maxDate, onDateChange: (event) => {
