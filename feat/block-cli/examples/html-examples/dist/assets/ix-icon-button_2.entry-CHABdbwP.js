...
import { B as BaseIconButton } from "./base-icon-button-DufFLJC--B7pXi9ch.js";
...
import "./base-button-DZdtpLxn-CTGi7raT.js";
...
const IconButton = class extends Mixin(...DefaultMixins, InheritAriaAttributesMixin) {
  ...
  render() {
    ...
    return h(Host, { key: "fe1549c460cf62cd5a179636dc0054d8f1ace659", class: {
      ...this.getIconSizeClass(),
      disabled: this.disabled || this.loading
    }, tabIndex: this.disabled ? -1 : 0 }, h(BaseIconButton, { key: "c8838895ec9e53de62a27da1b785d9f9ed67438c", ...baseButtonProps }));
  }
...
const Spinner = class {
  ...
  render() {
    ...
    return h(Host, { key: "c6d6d39dd958bbd6ec73e80b56428468ada3a5e7", ...ariaProperties }, h("div", { key: "01bcc242d2ede2904510c8f6495fd5afff2ed862", class: {
