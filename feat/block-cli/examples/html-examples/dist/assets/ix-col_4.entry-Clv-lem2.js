import { r as registerInstance, f as forceUpdate, h, H as Host, c as createEvent, F as Fragment, g as getElement } from "./global-Cn4dOqNA.js";
...
const DatePicker = class {
  ...
  render() {
    return h(Host, { key: "3a9fa36ed98d2dc14c9d0bf76f6fcdbc1595c8b2" }, h("ix-date-time-card", { key: "d6da48a85d0c5cb1a6044c16d064782a3beed0c8", corners: this.corners, embedded: this.embedded }, h("div", { key: "56d86df8ea65f1bcdd988451ddbf276a62a8e52a", class: "header", slot: "header" }, h("ix-icon-button", { key: "1899225180b17d1d5d7aa50599f6af7b2c92a4df", onClick: () => this.changeToAdjacentMonth(-1), icon: iconChevronLeftSmall, variant: "tertiary", class: "arrows", "aria-label": this.ariaLabelPreviousMonthButton }), h("div", { key: "cf4f3cf8d11665cabc959aad474aad833aa703f6", class: "selector" }, h("ix-button", { key: "f1aa5c3e87ee65509298de13646a1fd1aaf62c72", variant: "tertiary", ref: this.dropdownButtonRef, "data-testid": "year-month-button" }, h("span", { key: "8a1888092a6360c64b57f71eb52ace9ee1ed03d3", class: "capitalize" }, this.monthNames[this.selectedMonth], " ", this.selectedYear)), h("ix-dropdown", { key: "0922f29fe071cea744094e9553f38b35f113149c", "data-testid": "year-month-dropdown", class: "dropdown", trigger: this.dropdownButtonRef.waitForCurrent(), ignoreRelatedSubmenu: true, placement: "bottom-start", enableTopLayer: this.enableTopLayer }, h("div", { key: "e0f0df699dbafb2dbc5f00e03c5d5dc19e73f529", class: "wrapper" }, h("div", { key: "f34845aec3de4ebf6dc07e869b57c57087ad6fb5", "data-testid": "year-container", class: "overflow", onScroll: () => this.infiniteScrollYears(), ref: this.yearContainerRef }, this.renderYears()), h("div", { key: "519b8269d8f3a429fc1f5fdb8f2661f1cafa03b5", class: "overflow", "data-testid": "month-container" }, this.monthNames.map((month, index) => h("div", { key: month, ref: (ref) => {
      ...
      checkPosition: true
    }, name: iconSingleCheck, size: "16" }), h("div", null, h("span", { class: "capitalize monthMargin" }, `${month} ${this.tempYear}`)))))))), h("ix-icon-button", { key: "0468474f772750fe7f96af5eb6129eeee5e52ee6", onClick: () => this.changeToAdjacentMonth(1), icon: iconChevronRightSmall, variant: "tertiary", class: "arrows", "aria-label": this.ariaLabelNextMonthButton })), h("div", { key: "3b788560f65530ebb8faeb2c7e88d24b7f29bb08", class: {
      grid: true,
      "grid--show-week-numbers": this.showWeekNumbers
    } }, this.showWeekNumbers && h("div", { key: "431517e6490f2fc715dad94b9d7719836df9514a", class: "calendar-item week-day" }), this.dayNames.map((name) => h("div", { key: name, class: "calendar-item week-day" }, h("div", { class: "overflow" }, name.slice(0, 3)))), this.calendar.map((week) => {
    ...
    })), h("div", { key: "d27a5261af7b95549a0d8956f2c267aea0d504fa", class: {
      button: true,
      hidden: this.singleSelection || this.embedded
    } }, h("ix-button", { key: "629a9d41ba40bbc277ea41d1ec35f814949fe42a", onClick: () => this.onDone() }, this.i18nDone))));
  }
  get hostElement() {
