...
import { l as iconSearch, m as iconClear } from "./index-DLhpBBEI-C3tPjcQ4.js";
...
const CategoryFilter = class {
  ...
  render() {
    return h(Host, { key: "dcd0414e76cd09b433927fd3b83da54cdb732994" }, h("form", { key: "7fdd0ac668c6ef3db99c8b90f23ddab1cac71511", ref: (el) => this.formElement = el }, h("div", { key: "7cea0857498099d9fbe2f7f2c314e4a840e33c0b", "read-only": this.readonly, class: {
      "input-container": true,
      disabled: this.disabled,
      focus: this.hasFocus,
      readonly: this.readonly,
      "no-icon": this.hideIcon
    } }, h("ix-icon", { key: "33640acff2348705b3af237efceb01e17336df09", color: this.getIconColor(), class: { "display-none": this.hideIcon }, name: this.icon ?? iconSearch, size: "16" }), h("div", { key: "c3c7b38e9bef022a0f3d2734cb2ff5ba3c13b216", class: "token-container" }, h("div", { key: "4165792ea8227cc9483e130a2ebab5191c1b54ac", class: "list-unstyled" }, this.filterTokens.map((value, index) => h("span", { key: value.toString(), class: {
    ...
    } }, this.categories[this.category]?.label), h("input", { key: "c4d9f0f82e52c01d9d8fb5e25df4071156b569db", class: {
      "text-input": true,
