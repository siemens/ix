...
import { a as TRAP_FOCUS_INCLUDE_ATTRIBUTE } from "./focus-trap-Ci7SFoiU-By66Ri_a.js";
...
const DatetimePicker = class {
  ...
  render() {
    ...
    return h(Host, { key: "65f5a4fbf6bdc687a7812eac4b774eb16b183985" }, h("ix-date-time-card", { key: "9917b997646d8efe403d8f98cedcc07bd4d17856", hideHeader: true, hasFooter: true, embedded: this.embedded, corners: "rounded", noPadding: true }, h("ix-layout-grid", { key: "b62bbce6823520b03a579079ea0fd6899092dc0e", class: "no-padding" }, h("ix-row", { key: "b50881933b4bb67b324c578d943f6837764c97a8", class: "row-separator" }, h("ix-col", { key: "8b5162898c5bf0f95af5fddfb58070dbadc83d41", class: "col-separator" }, h("ix-date-picker", {
      key: "a71c8d68ab9d48fbde81dd669a0e8e8c22e69047",
    ...
    })), h("ix-col", { key: "04a9af30e489d881b71eb4bc2514543423860e76" }, h("ix-time-picker", {
      key: "d1ae35cbd840790d5ac3a099de1980eff2071b82",
      class: "min-width",
      ...
      tabIndex: this.embedded ? -1 : 0,
      [TRAP_FOCUS_INCLUDE_ATTRIBUTE]: this.embedded
    })))), h("div", { key: "8dd68ff7e3258bfeb8cfa8b308f64c450c32f2f2", slot: "footer", class: "btn-select-date-container" }, h("ix-button", { key: "120506288754b8f88a4fd3ba9a101a1e495ce408", class: "btn-select-date", onClick: () => this.onDone() }, this.i18nDone))));
  }
  static get watchers() {
    return {
      "from": [{
