...
const Modal = class {
  ...
  render() {
    return h(Host, { key: "8081cba9740e0bcf5c4fa15206a571c26ca32e26", class: {
      visible: this.modalVisible,
      "no-backdrop": this.hideBackdrop,
      "align-center": this.centered
    } }, h("div", { key: "c7b0944c2ef74e6cbb995aefd4bf71c20ac4832c", class: "dialog-backdrop" }, h("dialog", { key: "512a3605bf5d7fb094be5aaf5afd5a15bca32d71", "aria-modal": a11yBoolean(true), "aria-describedby": this.ariaAttributes["aria-describedby"], "aria-labelledby": this.ariaAttributes["aria-labelledby"], class: {
      modal: true,
      [`modal-size-${this.size}`]: true
    }, onClose: () => this.dismissModal(), onMouseDown: (event) => this.onMouseDown(event), onMouseUp: (event) => this.onMouseUp(event), onCancel: (e) => {
      e.preventDefault();
      this.dismissModal();
    } }, h("slot", { key: "c12d830a4a7ff5c1a07d4a60afc40f9defa30d6f" }))));
  }
};
__decorate([
