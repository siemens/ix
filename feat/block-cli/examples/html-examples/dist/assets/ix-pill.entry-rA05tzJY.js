...
const Pill = class {
  ...
  render() {
    ...
    return h(Host, { key: "4be4ba102ce609ced83bac41be6b8f4b91f50e29", style: this.variant === "custom" ? {
      "--ix-icon-button-color": this.pillColor
    } : {}, class: {
      "align-left": this.alignLeft
    } }, h("div", { key: "d24e3d6b4b34cb9d1517285e439a332768644838", ref: this.containerElementRef, style: Object.assign({}, customStyle), class: {
      container: true,
    ...
    } }, this.icon && h("ix-icon", { key: "0c9c5cfe5b3136b5d8b063fd189f0bd555255f6c", class: {
      "with-icon": true
    }, name: this.icon, size: "16", "aria-label": this.ariaLabelIcon }), h("span", { key: "5cfd41702589e56556e1faf8bde08f0766ae44e6", class: "slot-container" }, h("slot", { key: "fcc2902ab8f460fa7f88c3404a80e30b42cb3b83", onSlotchange: () => this.checkIfContentAvailable() }))), this.getTooltip());
  }
  get hostElement() {
