import { M as Mixin, r as registerInstance, c as createEvent, g as getElement, h, F as Fragment, H as Host } from "./global-B1t25MFd.js";
import { F as iconChevronLeftSmall, j as iconChevronRightSmall } from "./index-CwfZ4aN6-mXhHymhu.js";
import { D as DateTime, I as Info } from "./luxon-wpz4A-OQ-B58AoryR.js";
import { q as queryElements } from "./focus-utilities-Cmy8BJlr-BZaPzC8e.js";
...
const DatePicker = class extends Mixin(...DefaultMixins) {
  ...
  render() {
    return h(Host, { key: "a90e795765d0544c434a07a3b6fd65be5b150531", onKeyDown: (event) => this.onKeyDown(event), onFocusin: () => {
      if (hasKeyboardMode()) {
        this.changeFocusedDay();
      }
    } }, h("ix-date-time-card", { key: "c5e426630c40566465b12e89ce53f586ab727c8e", corners: this.corners, embedded: this.embedded }, h("div", { key: "cf5d0e8f0aec3764788577a8cc293ab3c9524833", class: "header", slot: "header" }, h("ix-icon-button", { key: "83c1a775a1b3497c131c5554f39977ace2e30928", onClick: () => this.changeCalendarView(-1), icon: iconChevronLeftSmall, variant: "tertiary", class: "arrows", "aria-label": this.ariaLabelPreviousMonthButton }), h("div", { key: "ee3fa6c22642a5bf332bff102a78fea26f870fd0", class: "selector" }, h("ix-dropdown-button", { key: "8329f98af431b7a6488e359cd86fd39b5900e11b", focusCheckedItem: true, "aria-label": this.ariaLabelMonthSelection, variant: "tertiary", label: null, onShowChanged: (event) => {
      event.stopPropagation();
    } }, h("ix-typography", { key: "8ec7a6b98609ecc98509505432fac4f196739d8d", bold: true, class: "capitalize", slot: "button-label" }, this.monthNames[this.selectedMonth]), this.renderMonths()), h("ix-dropdown-button", { key: "2dc4fad3daea3ece10dc8a5841e9505d84b3966a", focusCheckedItem: true, "aria-label": this.ariaLabelYearSelection, ref: this.yearDropdownButtonRef, variant: "tertiary", label: null, onShowChanged: (event) => {
      event.stopPropagation();
      if (event.detail) {
        requestAnimationFrameNoNgZone(() => {
    ...
    } }, h("div", { key: "1c6c0b8904f5d7dcac2448c5fd6561fcd2fa5382", class: "infinite-scrolling-spacer" }, h("div", { key: "cc4f298f1172d9eee16a974909100a30f3137410", class: "sentinel", "data-sentinel": "top" })), h("ix-typography", { key: "2b7f1037d2f931e10e2eacf19098b44d26b8d153", bold: true, class: "capitalize", slot: "button-label" }, this.selectedYear), this.renderYears(), h("div", { key: "68d6663839daa19d83a4ba15d74445fcffd30833", class: "infinite-scrolling-spacer" }, h("div", { key: "1f58ea8abc86e006ec90b78381ca660192163b55", class: "sentinel", "data-sentinel": "bottom" })))), h("ix-icon-button", { key: "3e9991e985ceae2de8a28719e093a87e2dc9a322", onClick: () => this.changeCalendarView(1), icon: iconChevronRightSmall, variant: "tertiary", class: "arrows", "aria-label": this.ariaLabelNextMonthButton })), h("div", { key: "533aacc1287ebc294c8e90f2c859928f873534f1", class: {
      grid: true,
      "grid--show-week-numbers": this.showWeekNumbers
    } }, this.showWeekNumbers && h("div", { key: "e3f92435061ccad117545b68d8454e33a2ca627b", class: "calendar-item week-day" }), this.dayNames.map((name) => h("div", { key: name, class: "calendar-item week-day" }, h("div", { class: "overflow" }, name.slice(0, 3)))), this.calendar.map((week) => {
    ...
    })), h("div", { key: "fb83e832900374eba0b21e7d03367ae37f4ac38f", class: {
      button: true,
      hidden: this.singleSelection || this.embedded
    } }, h("ix-button", { key: "e32753dbe5e17a99c09f9dffad8be23243b7ce93", hidden: this.singleSelection || this.embedded, onClick: () => this.onDone() }, this.i18nDone))));
  }
