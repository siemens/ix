...
const MenuAbout = class {
  ...
  render() {
    return h(Host, { key: "8a6145cd6b4385f58682cca594e0651b1addb466", slot: "ix-menu-about", class: {
      show: this.show,
      ["legacy-tabs"]: !this.suppressLegacyTabs
    } }, h("div", { key: "aa8b52e3652aa1df9469d766d1ab8b917f88f1e9", class: "about-header" }, h("h2", { key: "bb9f8288473bb44db2080528d4ca41ec57322591", class: "text-h2" }, this.label), h("ix-icon-button", { key: "33b9d916b7ea64610d5632fa873042b2da2b34bd", variant: "tertiary", size: "24", icon: iconClose, iconColor: "color-soft-text", "aria-label": this.ariaLabelCloseButton, onClick: (e) => this.close.emit({
      name: "ix-menu-about",
      nativeEvent: e
