...
import { N as iconSearch, p as iconClear } from "./index-DgUGsIlh-FNhczk6p.js";
import { B as BaseButton } from "./base-button-fFKf0UFL-CLNzrfb6.js";
...
const CategoryFilter = class {
  ...
  render() {
    return h(Host, { key: "b713a34d05b20d4085ab4c2041c7e47ef48c44e6" }, h("form", { key: "84f584be56d3c50f0d24ab1bdd1e322135233624", ref: (el) => this.formElement = el }, h("div", { key: "25e2ab0ccec737507ac6f9bfe4a959ab77860f67", "read-only": this.readonly, class: {
      "input-container": true,
      disabled: this.disabled,
      focus: this.hasFocus,
      readonly: this.readonly,
      "no-icon": this.hideIcon
    } }, h("ix-icon", { key: "78b4e12d6a5d94b241c3105a980eb6ee5d52d38e", color: this.getIconColor(), class: { "display-none": this.hideIcon }, name: this.icon ?? iconSearch, size: "16" }), h("div", { key: "0e9c6e07540a608e3dda2e23b0358497eceb44c0", class: "token-container" }, h("div", { key: "276fe1052662c6cc64e52e3c6c954b9f502d4467", class: "list-unstyled" }, this.filterTokens.map((value, index) => h("span", { key: value.toString(), class: {
    ...
    } }, this.categories[this.category]?.label), h("input", { key: "47fe384f096498f8aed65616d248d930f2496236", class: {
      "text-input": true,
