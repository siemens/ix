...
const CheckboxGroup = class {
  ...
  render() {
    return h(Host, { key: "612facd95d7711c4274cc225b1e9d1dcc72e6c5b", ref: this.groupRef, onIxBlur: () => this.touched = true }, h("ix-field-wrapper", { key: "8d1eeb0bb728bd0dc187576edc291bdd09beb6ca", label: this.label, helperText: this.helperText, invalidText: this.invalidText, infoText: this.infoText, validText: this.validText, warningText: this.warningText, showTextAsTooltip: this.showTextAsTooltip, isInvalid: this.isInvalid, isInfo: this.isInfo, isValid: this.isValid, isWarning: this.isWarning, controlRef: this.groupRef }, h("div", { key: "b1bc1e97f85c1e74007fd66eecf94fc5989e4fe7", class: {
      "checkbox-container": true,
      "row-layout": this.direction === "row"
    } }, h("slot", { key: "0a2739e47675fbf9e22742504cbc17be46bbd58e" }))));
  }
};
__decorate([
