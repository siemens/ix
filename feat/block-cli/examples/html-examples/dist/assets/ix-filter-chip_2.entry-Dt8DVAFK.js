import { r as registerInstance, c as createEvent, g as getElement, h, H as Host, M as Mixin } from "./global-J1r-v9CX.js";
...
const FilterChip = class {
  ...
  render() {
    return h(Host, { key: "d31aeeae1c818589548696ea5858ff01984c7fca", class: {
      disabled: this.disabled,
      readonly: this.readonly,
      "hide-close-button": this.hideCloseButton
    }, title: this.hostElement.textContent }, h("div", { key: "b6adfc973695d9ad0ae0cfbb21b8f3d886cf120c", class: "slot-container" }, h("slot", { key: "ba8580f0966498a2d9c3013d0b6d653ea15a4e87" })), !this.disabled && !this.readonly && !this.hideCloseButton ? h("ix-icon-button", { variant: "tertiary", oval: true, icon: iconCloseSmall, size: "16", disabled: this.disabled, onClick: (event) => {
...
const SelectItem = class extends Mixin(...DefaultMixins, FocusVisibleMixin, ComponentIdMixin) {
  ...
  render() {
    ...
    return h(Host, { key: "c2f71e95cbfaceae03d14ab45fbb57766ffc9dfa", ...ariaAttributes, id: this.getHostElementId(), disableAriaSelectHandling: true, class: {
      [IX_FOCUS_VISIBLE]: true
    }, "aria-hidden": "true", role: "presentation" }, h("ix-dropdown-item", { key: "3e967f590370248d578b75f4fff16aa6883b4b5b", "aria-hidden": "true", itemRole: "option", class: {
