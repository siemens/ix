...
import { m as mapValidationResult, a as addDisposableChangesAndVisibilityObservers, b as adjustPaddingForStartAndEnd, f as checkInternalValidity, g as getAriaAttributesForInput, d as SlotStart, I as InputElement, i as checkAllowedKeys, o as onInputBlur, S as SlotEnd } from "./input.fc-CPEIRuou-D2Wpu2gW.js";
...
const Input = class {
  ...
  render() {
    ...
    return h(Host, { key: "ffe8426f24d4b2e98b367a80c297bc6ca94a6932", class: {
      disabled: this.disabled,
      readonly: this.readonly
    } }, h("ix-field-wrapper", { key: "5f6beb6f666d5fb9d5f9d23051f484e14c575904", htmlForLabel: this.inputId, required: this.required, label: this.label, helperText: this.helperText, invalidText: this.invalidText, infoText: this.infoText, warningText: this.warningText, validText: this.validText, showTextAsTooltip: this.showTextAsTooltip, isInvalid: this.isInvalid, isValid: this.isValid, isInfo: this.isInfo, isWarning: this.isWarning, controlRef: this.inputRef }, h("div", { key: "52286b54a0ec6f49d244e84ddff3b48e1e027d75", class: "input-wrapper" }, h(SlotStart, { key: "cc38bd0504ae9d6877eb9b641be6ee35f429628b", slotStartRef: this.slotStartRef, onSlotChange: () => this.updatePaddings() }), h(InputElement, { key: "dc01f14a917ea8bd5a66705696fc47b7e8a28e8b", id: this.inputId, readonly: this.readonly, disabled: this.disabled, maxLength: this.maxLength, minLength: this.minLength, pattern: this.pattern, type: this.inputType, isInvalid: this.isInvalid, required: this.required, value: this.value, placeholder: this.placeholder, inputRef: this.inputRef, onKeyPress: (event) => checkAllowedKeys(this, event), valueChange: (value) => this.valueChange.emit(value), updateFormInternalValue: (value) => this.updateFormInternalValue(value), onBlur: () => {
      onInputBlur(this, this.inputRef.current);
      this.touched = true;
    }, ariaAttributes: inputAria, form: (_a = this.formInternals.form) !== null && _a !== void 0 ? _a : void 0, suppressSubmitOnEnter: this.suppressSubmitOnEnter, textAlignment: this.textAlignment }), h(SlotEnd, { key: "252b7d7c2a082160ca8c9f74734ce681682a6bf1", slotEndRef: this.slotEndRef, onSlotChange: () => this.updatePaddings() }, h("ix-icon-button", { key: "795cdf1fdbe4ccf4d41e4a4138db800a8d3aff30", color: "color-weak-text", class: {
      "password-eye": true,
    ...
    } }))), !!this.maxLength && this.maxLength > 0 && h("ix-typography", { key: "9c558d3cfef542b98774a8f968c63c6b39a5cfbc", class: "bottom-text", slot: "bottom-right", textColor: "soft" }, ((_b = this.value) !== null && _b !== void 0 ? _b : "").length, "/", this.maxLength)));
  }
