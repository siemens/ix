...
const CheckboxGroup = class {
  ...
  render() {
    return h(Host, { key: "479b544620d38309e1ac79d65cffc093589edf74", ref: this.groupRef, onIxBlur: () => this.touched = true }, h("ix-field-wrapper", { key: "9dbd822bfa2bec92caf680791130f010785addca", label: this.label, helperText: this.helperText, invalidText: this.invalidText, infoText: this.infoText, validText: this.validText, warningText: this.warningText, showTextAsTooltip: this.showTextAsTooltip, isInvalid: this.isInvalid, isInfo: this.isInfo, isValid: this.isValid, isWarning: this.isWarning, controlRef: this.groupRef }, h("div", { key: "c4bdcd2b4ad30898f0947b24dc6cdcd0d981efc7", class: {
      "checkbox-container": true,
      "row-layout": this.direction === "row"
    } }, h("slot", { key: "ff276b29ec143f7f67376bc49a8bf6be3f138b60" }))));
  }
};
__decorate([
