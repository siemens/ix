import { r as registerInstance, c as createEvent, g as getElement, f as forceUpdate, h, H as Host } from "./global-J1r-v9CX.js";
...
const MenuAbout = class {
  ...
  render() {
    return h(Host, { key: "5598ff574196d3df1dd1994b347edafd33699f3b", slot: "ix-menu-about", class: {
      show: this.show,
      ["legacy-tabs"]: !this.suppressLegacyTabs
    } }, h("div", { key: "40dda0c3e12028476c1a3883f87bff13f24cbde6", class: "about-header" }, h("h2", { key: "7cfbfb8acba7b5d2c456fe19fa821694b1df4ced", class: "text-h2" }, this.label), h("ix-icon-button", { key: "2af6849fab9251d0de88c81df8d43679462e21c0", variant: "tertiary", size: "24", icon: iconClose, iconColor: "color-soft-text", "aria-label": this.ariaLabelCloseButton, onClick: (e) => this.close.emit({
      name: "ix-menu-about",
      nativeEvent: e
