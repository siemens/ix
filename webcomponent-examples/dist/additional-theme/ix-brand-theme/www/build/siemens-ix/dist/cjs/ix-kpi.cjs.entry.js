...
const Kpi = class {
  ...
  render() {
    return (index.h(index.Host, { title: this.getTooltipText(), tabindex: "1", class: {
        stacked: this.orientation === 'vertical',
      } }, index.h("div", { class: {
        'kpi-container': true,
        alarm: this.state === 'alarm',
        warning: this.state === 'warning',
      } }, index.h("span", { class: "kpi-label" }, this.getStateIcon(), index.h("span", { class: "kpi-label-text" }, this.label)), index.h("span", { class: "kpi-value-container" }, index.h("span", { class: "kpi-value" }, this.value), this.unit ? index.h("span", { class: "kpi-unit" }, this.unit) : ''))));
  }
};
Kpi.style = kpiCss;
