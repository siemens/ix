...
const Toast = class {
  ...
  render() {
    ...
    return (index.h(index.Host, { class: "animate__animated animate__fadeIn" }, index.h("div", { class: "toast-body", onPointerLeave: () => {
        ...
        this.progress = 1;
        updateProgress();
      } }, this.type || this.icon ? (index.h("div", { class: "toast-icon" }, this.getIcon())) : null, index.h("div", { class: "toast-content" }, this.toastTitle ? (index.h("div", { class: "toast-title text-default-title-single" }, this.toastTitle)) : null, index.h("div", { class: "toast-message text-default" }, index.h("slot", null))), index.h("div", { class: "toast-close" }, index.h("ix-icon-button", { icon: "close", size: "24", ghost: true, onClick: () => this.closeToast.emit() }))), this.autoClose ? (index.h("div", { class: progressBarClass.join(' '), style: progressBarStyle, ref: (r) => (progressBarElement = r), onAnimationEnd: () => this.close(), onTransitionEnd: () => {
        if (this.progress === 0) {
          this.close();
        }
      } })) : null));
