...
const Menu = class {
  ...
  render() {
    ...
    })))), index.h("div", { class: "bottom-tab-divider" }), this.enableSettings && !this.isSettingsEmpty ? (index.h("ix-menu-item", { id: "settings", class: {
        'internal-tab': true,
        'bottom-tab': true,
...
const MenuAbout$1 = class {
  ...
  render() {
    return (index.h(index.Host, { class: {
      ...
      } }, index.h("div", { class: "about-header" }, index.h("h2", { class: "text-h2" }, this.label), index.h("ix-icon-button", { ghost: true, size: "24", icon: "close", onClick: (e) => this.close.emit(e) })), index.h("ix-tabs", { selected: this.getSelectedTabIndex(this.activeTabLabel), class: "about-tabs" }, this.getTabItems()), index.h("div", { class: "about-items" }, index.h("slot", null))));
  }
...
const MenuAboutNews = class {
  ...
  render() {
    return (index.h(index.Host, { class: {
      ...
      } }, this.i18nShowMore))) : null, index.h("div", { id: "arrow" })));
  }
};
