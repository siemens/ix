...
const Tabs = class {
  ...
  render() {
    return (index.h(index.Host, null, index.h("div", { class: "overflow-shadow", style: this.getArrowStyle(this.showPreviousArrow()) }), index.h("div", { class: "arrow", style: this.getArrowStyle(this.showPreviousArrow()), onClick: () => this.move(this.scrollAmount, true) }, index.h("span", { class: "glyph glyph-chevron-left-small" })), index.h("div", { class: "tab-items" }, index.h("div", { class: "items-content" }, index.h("slot", null))), index.h("div", { class: "overflow-shadow right", style: this.getArrowStyle(this.showNextArrow()) }), index.h("div", { class: "arrow right", style: this.getArrowStyle(this.showNextArrow()), onClick: () => this.move(-this.scrollAmount, true) }, index.h("span", { class: "glyph glyph-chevron-right-small" }))));
  }
