  ...
  render() {
    ...
    return (index.h(index.Host, null, index.h("div", { class: {
      ...
      (((_c = this.value) === null || _c === void 0 ? void 0 : _c.length) || this.inputFilterText) ? (index.h("ix-icon-button", { class: "clear", icon: "clear", ghost: true, oval: true, size: "24", onClick: (e) => {
        ...
        e.stopPropagation();
        this.clear();
      } })) : null, this.disabled || this.readonly ? null : (index.h("div", { class: "chevron-down-container", ref: (ref) => {
        if (this.editable)
          this.dropdownWrapperRef = ref;
      } }, index.h("ix-icon", { class: "chevron", name: "chevron-down-small" }))))))), index.h("ix-dropdown", { ref: (ref) => (this.dropdownRef = ref), show: this.dropdownShow, style: {
        width: '100%',
      }, class: {
