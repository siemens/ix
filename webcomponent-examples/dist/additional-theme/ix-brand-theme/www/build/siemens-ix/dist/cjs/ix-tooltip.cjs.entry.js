...
const Tooltip = class {
  ...
  render() {
    ...
    return (index.h(index.Host, { class: {
      ...
      } }, index.h("div", { class: 'tooltip-title' }, this.titleIcon ? (index.h("ix-icon", { size: "12", name: this.titleIcon })) : null, (_a = (index.h("ix-typography", { variant: "default-title" }, this.titleContent, index.h("slot", { name: "title" })))) !== null && _a !== void 0 ? _a : null), index.h("div", { class: tooltipContentClass }, index.h("slot", null)), index.h("div", { class: "arrow" })));
  }
