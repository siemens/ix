...
const ExpandingSearch = class {
  ...
  render() {
    ...
    } }, h("ix-icon-button", { key: "e773bc67a18476c86d530e14a0b062f1b10caae7", size: this.expanded ? "16" : "24", icon: this.icon, ghost: true, variant: "primary", "data-testid": "button", onClick: () => this.expandInput(), tabindex: this.expanded ? -1 : 0, color: this.hasFocus ? "input-search-icon--color--focus" : void 0, class: {
      "btn-search": true,
