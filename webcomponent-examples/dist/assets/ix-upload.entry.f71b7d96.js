...
const Upload = class {
  ...
  render() {
    ...
    }, accept: this.accept, disabled }), h("ix-button", { key: "26d667a21e99922522704d3f5117412f686224bc", tabindex: "-1", outline: true, onClick: () => this.inputElement.click(), disabled }, this.i18nUploadFile))));
  }
  get hostElement() {
