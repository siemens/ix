...
import { O as OnListener } from "./listener-b87c1f3d.d1f91f6d.js";
...
const Slider = class {
  ...
  render() {
    ...
    } }), h("div", { key: "b54ae34bda82b7f0277ae361c5139845830dc85d", class: "ticks" }, this.marker ? this.marker.map((markerValue) => {
    ...
    }) : null)), h("input", Object.assign({ key: "219884ecfc35a76f0722782af2607c64b19a57aa", id: "slider", type: "range", list: this.marker ? "markers" : void 0, step: this.step, min: this.min, max: this.max, value: this.rangeInput, tabindex: this.disabled ? -1 : 0, onInput: (event) => this.onInput(event), style: {
