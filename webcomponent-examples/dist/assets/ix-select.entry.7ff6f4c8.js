...
const Select = class {
  ...
  render() {
    ...
    } }, h("div", { key: "176f0b1a0cf1a8a01f18ad3e51e213efa9519832", class: "input-container" }, h("div", { key: "f98e3fb5cda142a387ab6c3c7f8497e92b9e82e3", class: "chips" }, this.isMultipleMode ? (_a = this.selectedItems) === null || _a === void 0 ? void 0 : _a.map((item) => h("ix-filter-chip", { disabled: this.disabled || this.readonly, key: item.value, onCloseClick: (e) => {
      e.preventDefault();
      e.stopPropagation();
      this.itemClick(item.value);
    } }, item.label)) : "", h("div", { key: "92b52ba5d7bc22b96a82a9cdbd9112630e60e4a6", class: "trigger" }, h("input", { key: "a5b4c6e747d9bc3b1e5212daa8e9d3f461c3bf18", autocomplete: "off", "data-testid": "input", disabled: this.disabled, readOnly: this.readonly, type: "text", class: {
