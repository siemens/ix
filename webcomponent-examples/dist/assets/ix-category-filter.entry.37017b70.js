...
import { B as BaseButton } from "./base-button-1b40b11d.1d94eb87.js";
...
const CategoryFilter = class {
  ...
  render() {
    var _a;
    return h(Host, { key: "b67d46f80076d8f5b9054e55e203d887337ec473" }, h("form", { key: "bb191e83cd3f763e7e499b0755e2b1f64bf28bfc", ref: (el) => this.formElement = el }, h("div", { key: "8505dcfd3334b0f4f1ca6ab295c9ca92c16cdf6b", "read-only": this.readonly, class: {
      "input-container": true,
      disabled: this.disabled,
      focus: this.hasFocus,
      readonly: this.readonly,
      "no-icon": this.hideIcon
    } }, h("ix-icon", { key: "74a4adbe6ed8ad59dd4931f89a755e87f09b98a1", color: this.getIconColor(), class: { "d-none": this.hideIcon }, name: this.icon, size: "16" }), h("div", { key: "a9f3429de8aec546ccf5ac10bd4047ee38a9df51", class: "token-container" }, h("ul", { key: "2ac4037d9f2c8a5c7f1e224999ff6643443dd46c", class: "list-unstyled" }, this.filterTokens.map((value, index) => h("li", { key: value.toString(), class: {
    ...
    } }, (_a = this.categories[this.category]) === null || _a === void 0 ? void 0 : _a.label), h("input", { key: "82f12ea3f63509e6275e1ebbea29240a734aeba6", class: {
      "text-input": true,
