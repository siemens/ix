...
function CardListTitle(props) {
  ...
  } }), h("ix-typography", { class: "CardList_Title__Label", variant: "large-single" }, props.label), !props.hideShowAll && h("ix-button", { class: "CardList__Title__Show__All", ghost: true, onClick: props.onShowAllClick }, h("span", null, props.showAllLabel), h("span", null, !isNaN(props.showAllCounter) ? ` (${props.showAllCounter})` : null)));
}
const CardList = class {
  ...
  render() {
    return h(Host, { key: "8164956edee5c3fa0d3f68af175c04a653aa7043" }, h(CardListTitle, { key: "4001ba1a1fbc3dd244297380698907902f37932a", isCollapsed: this.collapse, label: this.label, showAllLabel: this.i18nShowAll, showAllCounter: this.showAllCount === void 0 ? this.numberOfAllChildElements : this.showAllCount, onClick: () => this.onCardListVisibilityToggle(), onShowAllClick: (e) => this.onShowAllClick(e), hideShowAll: this.hideShowAll }), h("div", { key: "0a72db4811cd78f9ba067d592218eafd9e69fc8e", class: {
      CardList__Overflow: true
    }, style: this.computeMaskLayer() }, h("div", { key: "4bf8fe61b17c5ab7b4ad4d0cf0bfaf3cd9c83008", class: {
    ...
    }, onScroll: () => this.onCardListScroll() }, h("slot", { key: "2ed30ff94867a85b37678cc3fdef28770837d790", onSlotchange: () => this.changeVisibilityOfSlotChildren() }), this.isShowMoreCardVisible() ? h("ix-card", { class: {
