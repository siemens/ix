...
const Pill = class {
  ...
  render() {
    ...
    return h(Host, { key: "1bbd11e090e378d36040a08ca0f6acc01bdfc2f7", style: this.variant === "custom" ? {
      "--ix-icon-button-color": (_b = this.pillColor) !== null && _b !== void 0 ? _b : this.color
    } : {}, title: this.el.textContent, class: {
      "align-left": this.alignLeft
    } }, h("div", { key: "185e005a8842833cfe55a19ec1c06dc45afa2647", style: Object.assign({}, customStyle), class: {
      container: true,
      ...
      closable: false,
      icon: !!this.icon
    } }, h("ix-icon", { key: "256012d0b9ff2c19f0f5787453365f9c3a14d150", class: {
      "with-icon": true,
      hidden: this.icon === void 0 || this.icon === ""
    }, name: this.icon, size: "16" }), h("span", { key: "7e6df9c95355b084a795a5836ed1b2525e6792ea", class: "slot-container" }, h("slot", { key: "9a454c6e3b13bd688dff6ba53304ea04bc9aa5e6" }))));
  }
  get el() {
