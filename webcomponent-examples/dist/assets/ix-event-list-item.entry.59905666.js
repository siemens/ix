...
const EventListItem = class {
  ...
  render() {
    ...
    return h(Host, { key: "ea6803280e270d6b6c4dc0023de76812bc7e90ed", class: {
      disabled: this.disabled
    } }, h("div", { key: "75efa47c7a119ea2d7aa659f5c2709fa34cfb3eb", class: {
      "event-list-item": true,
      selected: this.selected,
      disabled: this.disabled
    } }, h("div", { key: "74d747f6b58ce8b56343983e3f4cc1c97e0623fc", class: `indicator ${!((_c = this.itemColor) !== null && _c !== void 0 ? _c : this.color) ? "indicator-empty" : ""}`, style: {
      "background-color": ((_d = this.itemColor) !== null && _d !== void 0 ? _d : this.color) ? color : "inherit",
      opacity: `${this.disabled ? 0.4 : 1}`
    } }), h("div", { key: "b32602b0c89701f487cf10b1600c2ed039e86498", class: "event-list-item-container" }, h("div", { key: "d3298c260d4f74aa91a747a61b93203fab354432", class: "event-content" }, h("slot", { key: "45c7a053766b5f7ce3dcae9d74bb22201c0dba9b" })), this.chevron && h("ix-icon", { name: "chevron-right", size: "16", class: "chevron-icon" }))));
  }
};
