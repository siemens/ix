...
const Menu = class {
  ...
  render() {
    ...
    return h(Host, { key: "e3390dbde8a79b02db176cd53cfc9b6a6eb0ccbd", class: {
      ...
      "burger-menu": true
    } }), this.breakpoint === "sm" && this.applicationLayoutContext.appSwitchConfig && h("ix-icon-button", { onClick: () => showAppSwitch(this.applicationLayoutContext.appSwitchConfig), icon: "apps", ghost: true, class: "app-switch" })), h("div", { key: "14ef64bc805a19192c6004c77130b734ebd90809", id: "menu-tabs", style: {
      display: "contents"
