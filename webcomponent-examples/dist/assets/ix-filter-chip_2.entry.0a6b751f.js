...
const FilterChip = class {
  ...
  render() {
    return h(Host, { key: "a4d7097df0582282fbd3550741fa0a231a4c782a", class: { disabled: this.disabled, readonly: this.readonly }, title: this.el.textContent }, h("div", { key: "659346141b7c2645f0970629e6a8a53c52ee0759", class: "slot-container" }, h("slot", { key: "0799a1aa00aeae148532b56e847d2713f782e862" })), !this.disabled && !this.readonly ? h("ix-icon-button", { ghost: true, oval: true, icon: "close-small", size: "16", tabindex: this.disabled ? -1 : 0, variant: "primary", disabled: this.disabled, onClick: (e) => this.onCloseClick(e) }) : null);
  }
  get el() {
