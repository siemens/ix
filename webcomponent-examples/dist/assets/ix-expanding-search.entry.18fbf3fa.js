...
const ExpandingSearch = class {
  ...
  render() {
    return h(Host, { key: "fd70f74b8c961ba043bd2cfe646bf2ab287b7edf", class: {
      expanded: this.expanded,
      "right-position": this.expanded,
      fullWidth: this.fullWidth
    } }, h("ix-icon-button", { key: "afb4150bf7b4847e79723ec9595913eea9facecc", size: this.expanded ? "16" : "24", icon: this.icon, ghost: true, variant: "primary", "data-testid": "button", onClick: () => this.expandInput(), tabindex: this.expanded ? -1 : 0, color: this.hasFocus ? "input-search-icon--color--focus" : void 0, class: {
      "btn-search": true,
      "btn-search--expanded": this.expanded
    } }), h("div", { key: "69c41e59e7d3e780b50a8619049d44044aae699d", class: {
      expanded: this.expanded,
      fullWidth: this.fullWidth,
      collapsed: !this.expanded,
      "disable-pointer": !this.expanded,
      "input-container": true
    }, "data-testid": "input-wrapper" }, h("input", { key: "57daef5e26aa3dc16d9e8043ccfa14d2c4983cf6", class: {
      "form-control": true,
      input: this.expanded,
      "disable-pointer": !this.expanded,
