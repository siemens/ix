...
const Menu = class {
  ...
  render() {
    var _a, _b;
    return h(Host, { key: "f96e5769eabac81269111fa13dd1b85644f897e6", class: {
      expanded: this.expand,
      [`breakpoint-${this.breakpoint}`]: true
    }, slot: "menu" }, h("nav", { key: "a7155f904044921b26b9e3740270d3ec3cce513c", class: {
      menu: true,
      expanded: this.expand
    } }, h("div", { key: "4e02e47fbcdb0718ecff56cb3373d0de11bdb8cb", class: "menu-buttons" }, this.breakpoint !== "sm" && h("ix-menu-expand-icon", { key: "eb044c0771361b7906177bc74d83a572964afc09", breakpoint: this.breakpoint, expanded: this.expand, pinned: this.pinned, class: "menu-expand-icon", ixAriaLabel: this.i18nExpandSidebar, onClick: async () => this.toggleMenu() }), this.breakpoint === "sm" && ((_a = this.applicationLayoutContext) === null || _a === void 0 ? void 0 : _a.appSwitchConfig) && h("ix-icon-button", { key: "726c67cc25b24ac1e48d0803ae84f076f47ca0b7", onClick: () => {
      var _a2;
      if ((_a2 = this.applicationLayoutContext) === null || _a2 === void 0 ? void 0 : _a2.appSwitchConfig) {
        showAppSwitch(this.applicationLayoutContext.appSwitchConfig);
      }
    }, icon: "apps", ghost: true })), h("div", { key: "f5dfc27a27bb8f7d37f9350f72c0916067c979f8", id: "menu-tabs", style: {
      display: "contents"
    }, onClick: (e) => this.onMenuItemsClick(e) }, h("div", { key: "ee03f22eb7310e66de17252892f9d6ea97c67233", class: "tabs-shadow-container" }, h("div", { key: "d5b47a2b127f0172cd0a76689e0c29c8fcb5ca97", class: {
      "tabs--shadow": true,
      "tabs--shadow-top": true,
      "tabs--shadow--show": this.itemsScrollShadowTop
    } }), h("div", { key: "772da6c3da5e3eeb7dda3d62c5b74cca6b2fba7d", class: {
      tabs: true,
      "show-scrollbar": this.expand
    }, onScroll: () => this.handleOverflowIndicator() }, h("div", { key: "45c0740cee734106959383f5f8ac864cca807454", class: "menu-avatar" }, h("slot", { key: "8988cd4f951319458ad0b1e94642ca1dd6ba598b", name: "ix-menu-avatar" })), h("slot", { key: "7f108c59b3bfc84576c9978e12b6abc136f22d1a", name: "home" }), this.breakpoint !== "sm" || !this.isHiddenFromViewport() ? h("slot", null) : null), h("div", { key: "6791539585b178386b6e8c1ba868e92f6c28ae85", class: {
      "tabs--shadow": true,
      "tabs--shadow-bottom": true,
      "tabs--shadow--show": this.itemsScrollShadowBottom
    } }))), h("div", { key: "94b1a2cb79fd5d3fe804e6aee7e2ac3729e1ee68", class: "bottom-tab-divider" }), this.settings ? h("ix-menu-item", { disabled: this.isHiddenFromViewport(), id: "settings", class: {
      "internal-tab": true,
      "bottom-tab": true,
      active: this.showSettings
    }, icon: "cogwheel", onClick: async () => this.toggleSettings(!this.showSettings), label: this.i18nSettings }) : null, h("div", { key: "1b3d5e59235cc486a0fe3222605cc0d3410ff6ee", onClick: (e) => this.onMenuItemsClick(e) }, h("slot", { key: "287de3f62a3c9534f18c808032f9b50066b37093", name: "bottom" })), h("div", { key: "a52fd54d0092fd0058af41658456f6bd08dd087d", id: "popover-area" }), this.about ? h("ix-menu-item", { disabled: this.isHiddenFromViewport(), id: "aboutAndLegal", class: {
      "internal-tab": true,
      "bottom-tab": true,
      active: this.showAbout
    }, icon: "info", onClick: async () => this.toggleAbout(!this.showAbout), label: this.i18nLegal }) : null, this.enableToggleTheme ? h("ix-menu-item", { disabled: this.isHiddenFromViewport(), id: "toggleTheme", onClick: () => themeSwitcher.toggleMode(), class: "internal-tab bottom-tab", icon: "light-dark", label: this.i18nToggleTheme }) : null, this.enableMapExpand || ((_b = this.applicationLayoutContext) === null || _b === void 0 ? void 0 : _b.sidebar) ? h("ix-menu-item", { disabled: this.isHiddenFromViewport(), id: "menu-collapse", onClick: () => this.sidebarToggle(), class: "internal-tab bottom-tab", icon: `${this.getCollapseIcon()}`, label: this.getCollapseText() }) : null), h("div", { key: "1b7fc6c3486a5f09c0e1e0899af5628b5029a156", class: {
      "menu-overlay": true,
      ...
      this.checkTransition();
    } }, h("div", { key: "16260da7408110f09bcf35c7bca37d21ff9e47b1", class: "menu-overlay-container" }, this.showSettings ? h("slot", { name: "ix-menu-settings" }) : null), h("div", { key: "bde0f8f348e3490a94149b7eccbed19d00ca2a63", class: "menu-overlay-container" }, this.showAbout ? h("slot", { name: "ix-menu-about" }) : null)));
  }
  get hostElement() {
