...
const ExpandingSearch = class {
  ...
  render() {
    return h(Host, { key: "bcb1ca47c9ad17a20fd6f2fd02a8eef8739f9de2", class: {
      expanded: this.expanded,
      "right-position": this.expanded,
      fullWidth: this.fullWidth
    } }, h("ix-icon-button", { key: "14f9d42caca8c525b2d866fedde1a27e564793b3", size: this.expanded ? "16" : "24", icon: this.icon, ghost: true, variant: "primary", "data-testid": "button", onClick: () => this.expandInput(), tabindex: this.expanded ? -1 : 0, color: this.hasFocus ? "input-search-icon--color--focus" : void 0, class: {
      "btn-search": true,
      "btn-search--expanded": this.expanded
    } }), h("div", { key: "a1b5b7ed57ea1f3ccd1d728b86bbb686204dc4c3", class: {
      expanded: this.expanded,
      fullWidth: this.fullWidth,
      collapsed: !this.expanded,
      "disable-pointer": !this.expanded,
      "input-container": true
    }, "data-testid": "input-wrapper" }, h("input", { key: "b8d99d4076dfa798c23558ec366e02320b139c2b", class: {
      "form-control": true,
      input: this.expanded,
      "disable-pointer": !this.expanded,
