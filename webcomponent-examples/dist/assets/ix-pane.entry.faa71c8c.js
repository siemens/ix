...
const Pane = class {
  ...
  render() {
    ...
    } }, h("ix-icon-button", { key: "e9e308ae81e48e90e2636f050112c757b58bc16d", class: "title-icon", size: "24", icon: this.expanded ? this.isMobile || this.hideOnCollapse ? "close" : this.expandIcon : this.minimizeIcon, ghost: true, onClick: () => {
