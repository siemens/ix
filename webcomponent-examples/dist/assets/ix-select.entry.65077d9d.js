...
import { O as OnListener } from "./listener-cf8cb0b2.a92eb453.js";
...
const Select = class {
  ...
  render() {
    ...
    } }, h("div", { key: "68fd990dca31dcd85ce40c7976d1e6841f6916c3", class: "input-container" }, h("div", { key: "7ca63a0aeb267e042bf0699d51316af5ad9f87c5", class: "chips" }, this.isMultipleMode ? (_a = this.selectedItems) === null || _a === void 0 ? void 0 : _a.map((item) => h("ix-filter-chip", { disabled: this.disabled || this.readonly, key: item.value, onCloseClick: (e) => {
      e.preventDefault();
      e.stopPropagation();
      this.itemClick(item.value);
    } }, item.label)) : "", h("div", { key: "0ff312e92b3235e17daac6e861a6dac456f96bfd", class: "trigger" }, h("input", { key: "0f56fd65161c8b08a937d936e674cdbde529205f", autocomplete: "off", "data-testid": "input", disabled: this.disabled, readOnly: this.readonly, type: "text", class: {
