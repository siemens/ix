import { r as registerInstance, h } from "./index.1d750c9d.js";
import { g as getButtonClasses } from "./base-button-0b6635df.0cea0e71.js";
const buttonCss = ".sc-ix-button-h{display:inline-block;height:2rem}[disabled].sc-ix-button-h{pointer-events:none}";
const Button = class {
  constructor(hostRef) {
