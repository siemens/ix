...
const Select = class {
  ...
  render() {
    ...
    }, placeholder: this.editable ? this.i18nPlaceholderEditable : this.i18nPlaceholder, value: this.inputValue, ref: (ref) => this.inputRef = ref, onInput: () => this.filterItemsWithTypeahead() }), this.disabled || this.readonly ? null : h("div", { class: "chevron-down-container", ref: (ref) => {
      if (this.editable)
        this.dropdownWrapperRef = ref;
