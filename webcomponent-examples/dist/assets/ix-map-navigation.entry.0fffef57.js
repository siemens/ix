...
const MapNavigation = class {
  ...
  render() {
    return h(Host, { key: "2946dcb874fe6142c5e46fc0e631528f9c252acd" }, h("slot", { key: "1dade6736fb8ca41922269af3613069109e0f7e1", name: "menu" }), h("div", { key: "ebf94a90f8d8bc250f50e3b6b81ab9529403ced4", class: "map-nav" }, h("div", { key: "ca6e3fb3f7222e415a2c3b0a0485852e0d24eb27", class: "map-nav-sidebar" }, h("div", { key: "eedd75c6ed28651eb0dacc304c2a6bb74a3acb48", class: "map-nav-header" }, h("ix-application-header", { key: "29c589f85db676ffd91bb12488e70de7e2e4dbe1", name: this.applicationName, class: "map-nav-header-brand" }, h("slot", { key: "c19497c92151dffa74f57177b67b4ba4e0927598", slot: "logo", name: "logo" }))), h("div", { key: "4b3f49c7a748481ba6644748cf81b97346a93e86", class: "map-nav-sidebar-content" }, h("div", { key: "2f3ae2b3b2b82259c9d50f84446b3c3b9187595e", class: "map-nav-sidebar-static-content" }, h("div", { key: "55256b8072af12003597c805c5b79e5996326199", class: "map-nav-title" }, this.navigationTitle), this.hideContextMenu ? "" : h("ix-icon-button", { icon: "context-menu", ghost: true, size: "24", variant: "secondary", onClick: (_) => this.contextMenuClick.emit() })), h("div", { key: "fb536c51269368ac94db2464fa040992c1bfb272", class: "map-nav-sidebar-user-content" }, h("slot", { key: "46a3481ffdb3b1fd94dbcb3e4100d36abd3ec800", name: "sidebar-content" })))), h("div", { key: "68e57564835c8813e97a6a5ca27bb6560744b635", class: "content" }, h("div", { key: "51fe8de82f713940d867a5d369a4e9c520f8a13b", class: {
      "map-nav-header-content": true,
      "bg-2": true,
      empty: !this.hasContentHeader
    } }, h("slot", { key: "bb2fd5b5bb1577353c85780fa3f285702f1d224e", name: "content-header", onSlotchange: (e) => this.checkHasContentHeader(e) })), h("main", { key: "2735c1d81e97f98b9a9e5652ee7d281e233a21a6" }, h("slot", { key: "830e9656af5d9e46e0d39202abd82ad9fe1ce7fa" }), h("slot", { key: "7bf4f8bce525e3572acdeb08a852e029e7f5cd09", name: "overlay" })))));
  }
  get hostElement() {
