import { r as registerInstance, c as createEvent, h, H as Host, g as getElement } from "./index.e1ef5048.js";
...
function CardListTitle(props) {
  ...
  } }), h("ix-typography", { variant: "large-single" }, props.label), !props.hideShowAll && h("ix-button", { class: "CardList__Title__Show__All", ghost: true, onClick: props.onShowAllClick }, h("span", null, props.showAllLabel), h("span", null, !isNaN(props.showAllCounter) ? ` (${props.showAllCounter})` : null)));
}
const CardList = class {
  ...
  render() {
    return h(Host, { key: "c52ee605d2f81a82788543defb031d99a7629eca" }, h(CardListTitle, { key: "976f9943a705914b148bec2cfbf90d44a63905c3", isCollapsed: this.collapse, label: this.label, showAllLabel: this.i18nShowAll, showAllCounter: this.showAllCount === void 0 ? this.numberOfAllChildElements : this.showAllCount, onClick: () => this.onCardListVisibilityToggle(), onShowAllClick: (e) => this.onShowAllClick(e), hideShowAll: this.hideShowAll }), h("div", { key: "cbf01e7d4cc781ccf3458fcb4e0a3c70e4cea062", class: {
