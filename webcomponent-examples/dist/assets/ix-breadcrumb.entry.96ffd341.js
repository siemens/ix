import { r as registerInstance, c as createEvent, h, f as forceUpdate, H as Host, g as getElement } from "./index.8b3d29f9.js";
...
const Breadcrumb = class {
  ...
  render() {
    ...
    return h(Host, { key: "d4a7d70b996b0e613a05a53896aedcaf786cb05b" }, h("ix-dropdown", { key: "545dd5b645297725ef8b58c2619ebff9cdc0b0c1", id: this.previousDropdownId, "aria-label": this.ariaLabelPreviousButton, trigger: ((_a = this.items) === null || _a === void 0 ? void 0 : _a.length) > this.visibleItemCount ? this.previousButtonRef : null, onShowChanged: ({ detail }) => {
