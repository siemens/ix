...
const MessageBar = class {
  ...
  render() {
    return h(Host, { key: "5cfbf8a6f0410db0bce4d9313b67eeaca3fd7ee1" }, h("div", { key: "0379523394cfcb8c662bfc1e9b4b6f22f1516d61", class: { "message-container": true, [this.type]: true }, role: "alert", ref: (el) => this.divElement = el }, h("ix-icon", { key: "9b94770ff17de637c2dd4924fff67b04d537a137", color: this.color, name: this.icon }), h("div", { key: "e1144a9ccf300e73b3cba522db91966c9bf1b3f1", class: "message-content" }, h("slot", { key: "bffed0ff54c91f4fcb836dbc706931372b3fb42e" })), this.dismissible ? h("ix-icon-button", { icon: "close", size: "24", ghost: true, onClick: () => {
