...
const Modal = class {
  ...
  render() {
    return h(Host, { key: "843063a6cabaa8ed0d6f0da512fd79b3df2f11f7", class: {
      visible: this.modalVisible,
      "no-backdrop": this.backdrop === false,
      "align-center": this.centered
    } }, h("div", { key: "c1419057ffea6a493dd8870894f491727209a0b3", class: "dialog-backdrop" }, h("dialog", { key: "fc8d67009dbc4563287d87f3a60fe775cd92e1ba", "aria-modal": a11yBoolean(true), "aria-describedby": this.ariaAttributes["aria-describedby"], "aria-labelledby": this.ariaAttributes["aria-labelledby"], class: {
      modal: true,
      [`modal-size-${this.size}`]: true
    }, onClose: () => this.dismissModal(), onClick: (event) => this.onModalClick(event), onCancel: (e) => {
      e.preventDefault();
      this.dismissModal();
    } }, h("slot", { key: "7daaff4237ace41e3545af9831f039174c8336bb" }))));
  }
  get hostElement() {
