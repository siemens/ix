...
const Pill = class {
  ...
  render() {
    ...
    return h(Host, { key: "fc3ca2234413519bf308271b813a502ec96845da", style: this.variant === "custom" ? {
      "--ix-icon-button-color": (_b = this.pillColor) !== null && _b !== void 0 ? _b : this.color
    } : {}, title: this.el.textContent, class: {
      "align-left": this.alignLeft
    } }, h("div", { key: "81b028190502b87483dac081bbaa9329e93b9fec", style: Object.assign({}, customStyle), class: {
      container: true,
      ...
      closable: false,
      icon: !!this.icon
    } }, h("ix-icon", { key: "c5f27260952730dedfdce7bc341e738db605ae27", class: {
      "with-icon": true,
      hidden: this.icon === void 0 || this.icon === ""
    }, name: this.icon, size: "16" }), h("span", { key: "739e00c0eb7759eaf9171fa2a47cdb8beabb8db5", class: "slot-container" }, h("slot", { key: "bacf82e695b210a406a44ded08f7131bcc885904" }))));
  }
  get el() {
