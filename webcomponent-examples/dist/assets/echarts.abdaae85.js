...
function registerEChartsThemes(echartsInstance) {
  const echarts2 = echartsInstance !== null && echartsInstance !== void 0 ? echartsInstance : window.echarts;
  if (!echarts2) {
  ...
  [
    ...
    echarts2.registerTheme(themeBundle.themeName, themeBundle.theme);
  });
}
