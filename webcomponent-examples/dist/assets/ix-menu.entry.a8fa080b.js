...
const Menu = class {
  ...
  render() {
    var _a;
    return h(Host, { key: "163f3eb69b53b9f886732636b08ce02caca32c0a", class: {
      expanded: this.expand,
      [`breakpoint-${this.breakpoint}`]: true
    }, slot: "menu" }, h("aside", { key: "3e9e36c841496033c50d35b3d8ab949768a10891", class: {
      menu: true,
      expanded: this.expand
    }, onClick: () => {
      this.resetActiveTab();
    } }, h("div", { key: "c932fdc4cdb04d4a0dc9e02c6bd115a762d48545", class: "menu-buttons" }, this.breakpoint !== "sm" && h("ix-menu-expand-icon", { breakpoint: this.breakpoint, expanded: this.expand, pinned: this.pinned, class: "menu-expand-icon", ixAriaLabel: this.i18nExpandSidebar, onClick: async () => this.toggleMenu() }), this.breakpoint === "sm" && this.applicationLayoutContext.appSwitchConfig && h("ix-icon-button", { onClick: () => showAppSwitch(this.applicationLayoutContext.appSwitchConfig), icon: "apps", ghost: true })), h("div", { key: "70ecfe9bff9b3899236a6269e1feb06edcf587e2", id: "menu-tabs", style: {
      display: "contents"
    }, onClick: (e) => this.onMenuItemsClick(e) }, h("div", { key: "771db6885a9325197b411f15285763576b83a36e", class: "tabs-shadow-container" }, h("div", { key: "796d87981487650ea92b7df6ce10881308ef95d1", class: {
      "tabs--shadow": true,
      "tabs--shadow-top": true,
      "tabs--shadow--show": this.itemsScrollShadowTop
    } }), h("div", { key: "1e64c116f5c3ddf8c39325d5dfb7b4fb47bcab98", class: {
      tabs: true,
      "show-scrollbar": this.expand
    }, onScroll: () => this.handleOverflowIndicator() }, h("div", { key: "eaf3ab7ef9f990b1ab48d2e8114384db807bfdbb", class: "menu-avatar" }, h("slot", { key: "30265b114009657467f99be3be4147c9ed9225ba", name: "ix-menu-avatar" })), h("slot", { key: "7effd3f698cd36f0043392b97e9356ccc6c0a086", name: "home" }), this.breakpoint !== "sm" || !this.isHiddenFromViewport() ? h("slot", null) : null), h("div", { key: "f9371b347feaf85a48a0a98c8f6673c55ccfc9ab", class: {
      "tabs--shadow": true,
      "tabs--shadow-bottom": true,
      "tabs--shadow--show": this.itemsScrollShadowBottom
    } }))), h("div", { key: "2f20401f2677326b9ab8c73f20f73ffc7ff6a45c", class: "bottom-tab-divider" }), this.settings ? h("ix-menu-item", { disabled: this.isHiddenFromViewport(), id: "settings", class: {
      "internal-tab": true,
      "bottom-tab": true,
      active: this.showSettings
    }, icon: "cogwheel", onClick: async () => this.toggleSettings(!this.showSettings), label: this.i18nSettings }) : null, h("div", { key: "e2ddb76e2ce83212758351913724f7449499bf5c", onClick: (e) => this.onMenuItemsClick(e) }, h("slot", { key: "36fa7b8bee9e41987ade7e7a3f757cf9f0499f41", name: "bottom" })), h("div", { key: "b7d3b9ac49a46efaa47bea7f47d472f7d501147d", id: "popover-area" }), this.about ? h("ix-menu-item", { disabled: this.isHiddenFromViewport(), id: "aboutAndLegal", class: {
      "internal-tab": true,
      "bottom-tab": true,
      active: this.showAbout
    }, icon: "info", onClick: async () => this.toggleAbout(!this.showAbout), label: this.i18nLegal }) : null, this.enableToggleTheme ? h("ix-menu-item", { disabled: this.isHiddenFromViewport(), id: "toggleTheme", onClick: () => themeSwitcher.toggleMode(), class: "internal-tab bottom-tab", icon: "light-dark", label: this.i18nToggleTheme }) : null, this.enableMapExpand || ((_a = this.applicationLayoutContext) === null || _a === void 0 ? void 0 : _a.sidebar) ? h("ix-menu-item", { disabled: this.isHiddenFromViewport(), id: "menu-collapse", onClick: () => this.sidebarToggle(), class: "internal-tab bottom-tab", icon: `${this.getCollapseIcon()}`, label: this.getCollapseText() }) : null), h("div", { key: "2838af050e40933cdb3169969357e4b042810b58", class: {
      "menu-overlay": true,
      ...
      this.checkTransition();
    } }, h("div", { key: "c832d48ff956bd6cc86a2505bc6d96294655623c", class: "menu-overlay-container" }, this.showSettings ? h("slot", { name: "ix-menu-settings" }) : null), h("div", { key: "499f34297b052f7b8afa113b027657fc342aa7c4", class: "menu-overlay-container" }, this.showAbout ? h("slot", { name: "ix-menu-about" }) : null)));
  }
  get hostElement() {
