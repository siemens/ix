import { r as registerInstance, c as createEvent, h, F as Fragment, H as Host, g as getElement } from "./index.f81f48a8.js";
...
const DatePicker = class {
  ...
  todayClass(day) {
    ...
    return {
      ...
      disabled: !this.isWithinMinMax(daaay) || this.start && daaay.toISO() < this.start.toISO() && this.end === null && this.range
    };
  }
  selectDay(day) {
