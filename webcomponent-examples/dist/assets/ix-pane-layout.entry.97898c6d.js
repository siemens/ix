import { r as registerInstance, f as forceUpdate, h, H as Host, g as getElement } from "./global.2bfd6008.js";
...
const Panes = class {
  ...
  render() {
    return h(Host, { key: "5ba8d72c60ff8d3d7cfd51b6dbe6e9e1f3e759ac" }, !this.isMobile ? this.layout == "full-vertical" ? h("div", { class: "side-panes-wrapper" }, h("div", { class: {
      row: true,
