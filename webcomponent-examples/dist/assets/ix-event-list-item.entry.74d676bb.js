...
import { a as a11yBoolean } from "./a11y-2e34777f.c1195600.js";
...
const EventListItem = class {
  ...
  render() {
    ...
    return h(Host, { key: "115c40df6986d283ac53ecc1ef7d5cfbe751864e", class: {
      disabled: this.disabled
    } }, h("li", { key: "431cc4b56030d9f5db39923380067fdb98e77b88", "aria-disabled": a11yBoolean(this.disabled), class: {
      "event-list-item": true,
      selected: this.selected,
      disabled: this.disabled
    } }, h("div", { key: "44cc672e3416136a20c4f256c6c6ffd9f82097d5", class: `indicator ${!((_c = this.itemColor) !== null && _c !== void 0 ? _c : this.color) ? "indicator-empty" : ""}`, style: {
      "background-color": ((_d = this.itemColor) !== null && _d !== void 0 ? _d : this.color) ? color : "inherit",
      opacity: `${this.disabled ? 0.4 : 1}`
    } }), h("div", { key: "d894014deacd0fd725c0e88e57e5d40a4d329113", class: "event-list-item-container" }, h("div", { key: "3a016426709b4abc7853bc67aeca4a3e11e5d6c1", class: "event-content" }, h("slot", { key: "c5cdf2b4a04834d540af8d8df19a8889ee6e0ffb" })), this.chevron && h("ix-icon", { key: "9646e270e1496247c2ab8223452eb76d2f9f902e", name: "chevron-right", size: "16", class: "chevron-icon" }))));
  }
};
