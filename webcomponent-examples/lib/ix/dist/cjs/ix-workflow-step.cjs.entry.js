...
const WorkflowStep = class {
  ...
  render() {
    const icons = !this.customIconSlot ? (index.h(index.Fragment, null, index.h("ix-icon", { color: "color-1", name: this.iconName === 'warning' ? 'triangle-filled' : 'circle-filled', class: "absolute", size: "24" }), index.h("ix-icon", { color: this.iconColor, name: this.iconName, class: "absolute", size: "24" }))) : ('');
    return (index.h(index.Host, null, index.h("div", { tabIndex: 0, onClick: () => this.select(), class: {
        step: true,
        selected: this.selected,
        vertical: this.vertical,
        disabled: this.disabled,
      } }, index.h("div", { class: "wrapper" }, index.h("div", { class: {
        line: true,
        selected: this.selected,
        [this.status]: true,
        [this.position]: true,
      } }), index.h("div", { class: "iconWrapper" }, icons, index.h("slot", { name: "custom-icon" }))), index.h("div", { class: "text" }, index.h("slot", null)))));
  }
