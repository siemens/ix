...
const MapNavigation = class {
  ...
  render() {
    return (index.h(index.Host, null, index.h("div", { id: "menu-placeholder" }), index.h("div", { class: "map-nav" }, index.h("div", { class: "map-nav-sidebar" }, index.h("div", { class: "map-nav-header" }, index.h("div", { class: "map-nav-header-brand" }, index.h("div", { class: "map-nav-brand-logo" }, index.h("slot", { name: "logo" })), index.h("span", { class: "map-nav-brand-title" }, this.applicationName))), index.h("div", { class: "map-nav-sidebar-content" }, index.h("div", { class: "map-nav-sidebar-static-content" }, index.h("div", { class: "map-nav-title" }, this.navigationTitle), this.hideContextMenu ? ('') : (index.h("ix-icon-button", { icon: "context-menu", ghost: true, size: "24", variant: "Secondary", onClick: (_) => this.contextMenuClick.emit() }))), index.h("div", { class: "map-nav-sidebar-user-content" }, index.h("slot", { name: "sidebar-content" })))), index.h("div", { class: "content" }, index.h("div", { class: "map-nav-header-content bg-2" }, index.h("slot", { name: "content-header" })), index.h("main", null, index.h("slot", null)), index.h("div", { id: "overlay" })))));
  }
...
const MapNavigationOverlay = class {
  ...
  render() {
    return (index.h(index.Host, null, index.h("div", { class: "overlay-header" }, index.h("div", { class: {
        ...
        'background-color': this.color
          ...
          : '',
      } }), index.h("div", { class: "overlay-header-content" }, index.h("ix-icon", { size: "32", name: this.icon }), index.h("span", { class: "overlay-header-title", title: this.name }, this.name)), index.h("ix-icon-button", { class: "overlay-close", invisible: true, icon: "close", size: "24", onClick: () => this.closeClick.emit() })), index.h("slot", null)));
  }
};
