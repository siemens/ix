 ...
 */
import { Element, Component, h, Host, Prop, State, Watch, Fragment, } from '@stencil/core';
export class WorkflowStep {
  ...
  render() {
    const icons = !this.customIconSlot ? (h(Fragment, null,
      h("ix-icon", { color: "color-1", name: this.iconName === 'warning' ? 'triangle-filled' : 'circle-filled', class: "absolute", size: "24" }),
      h("ix-icon", { color: this.iconColor, name: this.iconName, class: "absolute", size: "24" }))) : ('');
    return (h(Host, null,
      h("div", { tabIndex: 0, onClick: () => this.select(), class: {
          step: true,
        ...
        h("div", { class: "wrapper" },
          ...
          h("div", { class: "iconWrapper" },
            icons,
            h("slot", { name: "custom-icon" }))),
        h("div", { class: "text" },
          h("slot", null)))));
  }
