  ...
  render() {
    return (h(Host, null,
      h("div", { class: {
        ...
        h("div", { class: "group-header-clickable", onClick: (e) => this.onHeaderClick(e) },
          h("div", { class: "group-header-selection-indicator" }),
          h("ix-icon", { class: "btn-expand-header", name: `chevron-${this.collapsed ? 'right' : 'down'}-small`, onClick: (e) => this.onExpandClick(e) }),
          h("div", { class: "group-header-content" },
            this.header ? (h("div", { class: "group-header-props-container" },
              h("div", { class: "group-header-title" },
                h("span", { title: this.header }, this.header)),
              h("div", { class: "group-subheader", title: this.subHeader }, this.subHeader))) : null,
            h("slot", { name: "header" }))),
        h("div", { class: { 'group-header-context-button': true, 'd-none': false } },
          h("ix-icon-button", { ref: (ref) => (this.dropdownTriggerRef = ref), size: "24", ghost: true, icon: "context-menu" }),
          h("ix-dropdown", { trigger: this.dropdownTriggerRef },
      ...
      h("div", { class: {
        ...
        h("slot", null)),
      h("div", { class: "d-none" },
        h("ix-group-item", { class: "footer last", suppressSelection: true, focusable: false },
          h("slot", { name: "footer" })))));
  }
