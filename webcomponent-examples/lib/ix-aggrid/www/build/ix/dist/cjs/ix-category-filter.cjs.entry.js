...
const CategoryFilter = class {
  ...
  render() {
    ...
    return (index.h(index.Host, null, index.h("form", { ref: (el) => (this.formElement = el) }, index.h("div", { class: {
      ...
      }, ref: (el) => (this.textInput = el), type: "text", placeholder: this.placeholder, onFocus: () => this.openCategorySelection() }))), index.h("button", { class: {
        btn: true,
        'btn-invisible-secondary': true,
        'btn-oval': true,
        'btn-close': true,
        'd-none': !this.filterTokens.length && !this.category,
      }, onClick: () => this.resetFilter(), tabindex: "1" }, index.h("span", { class: "glyph glyph-error glyph-16" })))), index.h("div", { class: {
