...
const Dropdown = class {
  ...
  async changedShow(newShow) {
    ...
    if (newShow) {
      ...
      if (this.anchorElement) {
        ...
        this.popperInstance = popper.createPopper(this.anchorElement, this.dropdownRef, {
  ...
  render() {
    return (index.h(index.Host, { ref: (ref) => (this.dropdownRef = ref), class: {
        ...
        margin: '0',
        minWidth: '0px',
      } }, index.h("div", { style: { display: 'contents' } }, this.header ? index.h("div", { class: "dropdown-header" }, this.header) : '', index.h("slot", null))));
  }
...
const DropdownItem = class {
  ...
  render() {
    return (index.h(index.Host, { class: {
      ...
      } })) : null, this.label ? index.h("span", { class: "label" }, this.label) : null, index.h("slot", null))));
  }
  get hostElement() { return index.getElement(this); }
};
