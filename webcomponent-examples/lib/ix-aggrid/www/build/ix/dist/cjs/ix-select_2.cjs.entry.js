...
const Select = class {
  ...
  render() {
    ...
    return (index.h(index.Host, null, index.h("div", { class: {
      ...
      } }, index.h("div", { class: "input-container" }, this.isMultipleMode ? (index.h("div", { class: "chips" }, (_a = this.selectedItems) === null || _a === void 0 ? void 0 : _a.map((item) => (index.h("ix-filter-chip", { disabled: this.disabled || this.readonly, onCloseClick: (e) => {
        e.preventDefault();
        e.stopPropagation();
        this.emitItemClick(item.value);
      } }, item.label))))) : null, index.h("div", { class: "trigger" }, index.h("input", { "data-testid": "input", disabled: this.disabled, readOnly: this.readonly, type: "text", class: {
        ...
        : this.i18nPlaceholder, value: this.getInputValue(), ref: (ref) => (this.inputRef = ref), onInput: () => this.filterItemsWithTypeahead() }), this.disabled || this.readonly ? null : (index.h("div", { class: "chevron-down-container", ref: (ref) => {
        if (this.editable)
          this.dropdownWrapperRef = ref;
      } }, index.h("ix-icon", { class: "chevron", name: "chevron-down-small" }))))), this.allowClear && (((_c = this.value) === null || _c === void 0 ? void 0 : _c.length) || this.inputText) ? (index.h("ix-icon-button", { class: "clear", icon: "clear", ghost: true, oval: true, size: "24", onClick: (e) => {
        e.preventDefault();
        e.stopPropagation();
        this.clear();
      } })) : null), index.h("ix-dropdown", { ref: (ref) => (this.dropdownRef = ref), show: this.dropdownShow, style: {
        width: '100%',
      }, class: {
        'd-none': this.disabled ||
          this.readonly ||
          (this.isDropdownEmpty && !this.editable),
      }, anchor: this.dropdownAnchor, trigger: this.dropdownWrapperRef, onShowChanged: (e) => this.dropdownVisibilityChanged(e), placement: "bottom", positioningStrategy: 'fixed', adjustDropdownWidthToReferenceWidth: true }, index.h("div", { class: "select-list-header" }, this.i18nSelectListHeader), index.h("slot", null), index.h("div", { ref: (ref) => (this.addItemRef = ref), class: "d-contents" }), this.itemExists(this.inputText) ? ('') : (index.h("ix-dropdown-item", { "data-testid": "add-item", icon: "plus", class: {
        'add-item': true,
