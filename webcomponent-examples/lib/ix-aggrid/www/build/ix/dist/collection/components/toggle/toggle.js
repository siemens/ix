...
export class CuiToggle {
  ...
  render() {
    return (h(Host, { class: {
      ...
      h("label", { class: "switch", tabindex: this.disabled ? -1 : 0 },
        h("input", { tabindex: "-1", type: "checkbox", checked: this.checked, disabled: this.disabled, indeterminate: this.indeterminate || this.checked === undefined, id: this.hostElement.id, onChange: (e) => this.emitChange(e) }),
        h("span", { class: "slider" },
          h("span", { class: "slider-track" }))),
      !this.hideText ? (h("span", { title: this.getText(), class: "text", onClick: (e) => this.emitChange(e) }, this.getText())) : null));
  }
