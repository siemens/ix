  ...
  render() {
    return (h(Host, { title: this.getTooltipText(), tabindex: "1", class: {
      ...
      h("div", { class: {
        ...
        h("span", { class: "kpi-label" },
          this.getStateIcon(),
          h("span", { class: "kpi-label-text" }, this.label)),
        h("span", { class: "kpi-value-container" },
          h("span", { class: "kpi-value" }, this.value),
          this.unit ? h("span", { class: "kpi-unit" }, this.unit) : ''))));
  }
