...
export class AnimatedTabs {
  ...
  render() {
    return (h(Host, { class: { 'flex-column-reverse': this.tabPlacement === 'bottom' } },
      h("ul", { class: "tabs-container" },
        this.animatedTabs.map((element, index) => (h("li", { class: { bottom: this.tabPlacement === 'bottom' }, onClick: () => this.onTabClick(index), onMouseDown: () => this.onTabMouseDown(index) },
          h("div", { class: {
              'tab-container': true,
              selected: this.selectedIndex === index,
            } },
            h("ix-icon", { name: element.icon }),
            element.count ? (h("span", { class: {
                count: true,
