  ...
  render() {
    return (h(Host, { class: {
      ...
      h("button", { class: {
        ...
        }, "data-testid": "button", onClick: () => this.expandInput(), tabindex: this.expanded ? -1 : 0 },
        h("ix-icon", { class: "btn-search-icon", name: this.icon, size: this.expanded ? '16' : '24', color: this.hasFocus ? 'input-search-icon--color--focus' : undefined })),
      h("div", { class: {
          expanded: this.expanded,
        ...
        h("input", { class: {
            ...
            this.collapseInput();
            this.hasFocus = false;
          }, onFocus: () => (this.hasFocus = true), onInput: (e) => this.onChange(e), tabindex: this.expanded ? 0 : -1 }),
        this.isFieldChanged ? (h("ix-icon-button", { class: "btn-clear", icon: "clear", ghost: true, size: "24", "data-testid": "clear-button", onClick: () => this.clearClicked() })) : null)));
  }
