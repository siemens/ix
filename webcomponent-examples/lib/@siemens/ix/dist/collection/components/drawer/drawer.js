 ...
 */
import { Component, Event, h, Method, Prop, Watch } from '@stencil/core';
...
export class Drawer {
  ...
  render() {
    return (h("div", { class: {
      ...
      }, ref: (el) => (this.divElement = el), "data-testid": "container", id: "div-container" },
      h("div", { class: "header" },
        h("div", { class: "header-content" },
          h("slot", { name: "header" })),
        h("ix-icon-button", { icon: "close", size: "24", ghost: true, onClick: () => this.onCloseClicked(), "data-testid": "close-button" })),
      h("div", { class: "content" },
        h("slot", null))));
  }
