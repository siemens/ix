...
export class MessageBar {
  ...
  render() {
    return (h(Host, null,
      h("div", { class: { 'message-container': true, [this.type]: true }, role: "alert", ref: (el) => (this.divElement = el) },
        h("ix-icon", { color: this.color, name: this.icon }),
        h("div", { class: "message-content" },
          h("slot", null)),
        this.dismissible ? (h("ix-icon-button", { icon: "close", size: "24", ghost: true, onClick: () => {
