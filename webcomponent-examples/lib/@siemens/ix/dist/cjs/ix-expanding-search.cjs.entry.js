...
const ExpandingSearch = class {
  ...
  render() {
    return (index.h(index.Host, { class: {
      ...
      }, "data-testid": "button", onClick: () => this.expandInput(), tabindex: this.expanded ? -1 : 0 }, index.h("ix-icon", { class: "btn-search-icon", name: this.icon, size: this.expanded ? '16' : '24', color: this.hasFocus ? 'input-search-icon--color--focus' : undefined })), index.h("div", { class: {
        expanded: this.expanded,
        collapsed: !this.expanded,
        'disable-pointer': !this.expanded,
        'input-container': true,
      }, "data-testid": "input-wrapper" }, index.h("input", { class: {
        'form-control': true,
        input: this.expanded,
        'disable-pointer': !this.expanded,
        ...
        this.collapseInput();
        this.hasFocus = false;
      }, onFocus: () => (this.hasFocus = true), onInput: (e) => this.onChange(e), tabindex: this.expanded ? 0 : -1 }), this.isFieldChanged ? (index.h("ix-icon-button", { class: "btn-clear", icon: "clear", ghost: true, size: "24", "data-testid": "clear-button", onClick: () => this.clearClicked() })) : null)));
  }
};
