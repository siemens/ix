...
const TabItem = class {
  ...
  render() {
    return (index.h(index.Host, { class: this.tabItemClasses({
        ...
        circle: this.rounded,
      }), tabIndex: 0 }, index.h("div", { class: { circle: this.rounded, text: !this.rounded, selected: this.selected, disabled: this.disabled } }, index.h("slot", null)), index.h("div", { class: { counter: true, selected: this.selected, hidden: !(this.rounded && this.counter !== undefined), disabled: this.disabled } }, this.counter)));
  }
};
