...
const GroupDropdownItem = class {
  ...
  render() {
    return (index.h(index.Host, null, index.h("ix-dropdown-item", { label: this.label, icon: this.icon }, index.h("slot", null))));
  }
};
...
exports.ix_group_dropdown_item = GroupDropdownItem;
