...
| Before                   | After                                                                             |
| ------------------------ | --------------------------------------------------------------------------------- |
| `--theme-color-primary`  | `--si-sys-background-accent`, `--si-sys-border-accent`, or `--si-sys-text-accent` |
| `--theme-color-std-text` | `--si-sys-text-primary`                                                           |
| `--theme-body`           | `--si-sys-typography-body`                                                        |
| `--theme-shadow-4`       | `--si-sys-effects-shadow-4`                                                       |

Replace legacy token references according to how the value is used:
