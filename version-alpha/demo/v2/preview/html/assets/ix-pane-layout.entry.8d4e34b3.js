import { r as registerInstance, f as forceUpdate, h, H as Host, g as getElement } from "./global.78f61b49.js";
...
const Panes = class {
  ...
  render() {
    return h(Host, { key: "42424752e70401984bd2a5d42b22128f956ab320" }, !this.isMobile ? this.layout == "full-vertical" ? h("div", { class: "side-panes-wrapper" }, h("div", { class: {
      row: true,
