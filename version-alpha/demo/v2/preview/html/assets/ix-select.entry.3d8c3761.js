...
const Select = class {
  ...
  render() {
    ...
    } }, h("div", { key: "c0e4e52e89640cb3dd31950f4457bbf0209363ac", class: "input-container" }, h("div", { key: "53375714b199123d27fdb57d51102f7d0be912bb", class: "chips" }, this.isMultipleMode ? (_a = this.selectedItems) === null || _a === void 0 ? void 0 : _a.map((item) => h("ix-filter-chip", { disabled: this.disabled || this.readonly, key: item.value, onCloseClick: (e) => {
      e.preventDefault();
      e.stopPropagation();
      this.itemClick(item.value);
    } }, item.label)) : "", h("div", { key: "42cac6b1306e7b0339c47857a41685952465280c", class: "trigger" }, h("input", { key: "94fe4f82da75de234fb134fb7792f78cb87d2c37", autocomplete: "off", "data-testid": "input", disabled: this.disabled, readOnly: this.readonly, required: this.required, type: "text", class: {
