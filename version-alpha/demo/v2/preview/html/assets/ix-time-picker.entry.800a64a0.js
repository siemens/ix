...
const TimePicker = class {
  ...
  render() {
    ...
    return h(Host, { key: "3324e541eaee13441527be68f301725504662914" }, h("ix-date-time-card", { key: "5cca6cc594555537fabb7559fa772f0108288f02", standaloneAppearance: this.standaloneAppearance, corners: this.corners }, h("div", { key: "23dd6dbf7b2ce70d43ac1175e7142732561e4a4c", class: "header", slot: "header" }, h("ix-typography", { key: "e3357692be47ce40ed0082febf7d2c0e7ce25749", format: "h5" }, this.textTime || "Time")), h("div", { key: "a1b0ccb5870ee7f3bb06ccb0b1d3c24c7df3c892", class: "clock" }, timepickerInformation.map((descriptor, index) => h("div", { class: "flex" }, h("div", { class: { columns: true, hidden: descriptor.hidden } }, h("ix-icon-button", { size: "16", onClick: () => {
      var _a;
    ...
    } }, ":"))), h("div", { key: "cc807c62c8d7f1a6d4d45c1460cdf5f25afdffd6", class: {
      columns: true,
      "default-space": true,
      hidden: this._timeRef === void 0
    } }, h("ix-icon-button", { key: "80fd8ec8d709cfadff53f09b0d2d047e242568a0", size: "16", onClick: () => this.changeTimeReference(), ghost: true, icon: iconChevronUp, variant: "primary", class: "arrows" }), h("div", { key: "e7d47e9686c937fc83c614176e0722885d7c2b55", class: "time-reference" }, this._timeRef), h("ix-icon-button", { key: "7ca882f6dae9cae2bc180b79eff475a7c1ac944f", size: "16", onClick: () => this.changeTimeReference(), ghost: true, icon: iconChevronDown, variant: "primary", class: "arrows" }))), h("div", { key: "63e6c67d7116d607b5b5635f7f47dec23978c126", class: {
      button: true,
      hidden: !this.standaloneAppearance,
      standalone: true
    } }, h("ix-button", { key: "382a7d16a98d76b8687d0e84ecf8efaaa21a6d06", onClick: () => {
      var _a;
