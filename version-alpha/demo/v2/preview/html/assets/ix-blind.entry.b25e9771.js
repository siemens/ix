import { r as registerInstance, c as createEvent, h, F as Fragment, H as Host, g as getElement } from "./global.bff64ac3.js";
...
const Blind = class {
  ...
  render() {
    return h(Host, { key: "a0a59c1fc6d473ce61246ea0234c994480ac60d1", class: {
      [`blind-${this.variant}`]: true
    } }, h("div", { key: "ad3050c9ae503aa55bae3ceca992d79bf5f337fd", class: "blind-header-wrapper" }, h("button", { key: "81d27e4a4acaa79cc4dc362f10d58d89433641ff", class: {
      "blind-header": true,
      [`blind-${this.variant}`]: true,
      closed: this.collapsed
    }, type: "button", "aria-labelledby": `ix-blind-header-title-${this.blindId}`, "aria-controls": `ix-blind-content-section-${this.blindId}`, "aria-expanded": a11yBoolean(!this.collapsed), onClick: () => this.onHeaderClick() }, h("slot", { key: "3881b273421c2f87bdfc5a40018146c76f1803ee", name: "custom-header" })), h("div", { key: "f1f56f907d4bd04e39b3cddf080126f5c1bb5c0e", class: "blind-header-content" }, h("ix-icon", { key: "8f9f0e2ae7d8b41bb0bc1279e4a2249b326b8a18", class: "collapse-icon", name: iconChevronRightSmall, color: this.variant === "filled" || this.variant === "outline" ? "color-primary" : `color-${this.variant}--contrast`, ref: (ref) => this.chevronRef = ref }), h("div", { key: "8ee02b39bae7b5d67508c00c3256e7045f3bcd85", class: "blind-header-title", id: `ix-blind-header-title-${this.blindId}` }, this.label !== void 0 ? h(Fragment, null, this.icon && h("ix-icon", { class: "blind-header-title-icon", name: this.icon, color: this.variant === "filled" || this.variant === "outline" ? "color-std-text" : `color-${this.variant}--contrast` }), h("div", { class: "blind-header-title-row" }, h("div", { class: "blind-header-title-col" }, h("ix-typography", { title: this.label, format: "label-lg", bold: true }, h("div", { class: "blind-header-title-label", title: this.label }, this.label))), this.sublabel && h("div", { class: "blind-header-title-col" }, h("ix-typography", { title: this.sublabel }, h("div", { class: "blind-header-title-sublabel" }, this.sublabel)))), h("div", { class: "header-actions" }, h("slot", { name: "header-actions" }))) : null))), h("section", { key: "ec9c4832154c5b31ef09849480b04cc39822ef95", id: `ix-blind-content-section-${this.blindId}`, "aria-labelledby": `ix-blind-header-title-${this.blindId}` }, h("div", { key: "29d542d3fa8e77949188d48cd733f918ac8377df", class: {
      "blind-content": true,
      hide: this.collapsed
