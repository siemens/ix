    ...
    switch (bundleId) {
      case "ix-icon":
        return __vitePreload(() => import(
          /* webpackMode: "lazy" */
          "./ix-icon.entry.192544eb.js"
        ), true ? ["./ix-icon.entry.192544eb.js","./icon-1f00a566.21c66130.js","./global.1f5cc68d.js","./global.82e3a8d1.css"] : void 0, import.meta.url).then(processMod, consoleError);
    }
  }
  return __vitePreload(() => import(
...
function loadAdditionalTheme() {
  const theme = { "css": "ix-corporate-theme/dist/css/brand-theme.css" };
