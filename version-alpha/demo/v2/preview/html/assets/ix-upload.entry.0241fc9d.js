...
const Upload = class {
  ...
  render() {
    ...
    }, accept: this.accept, disabled }), h("ix-button", { key: "2340bc932ec97f948024c59f40fbe3a0be1aaaa5", "aria-disabled": disabled, outline: true, onClick: () => this.inputElement.click(), disabled }, this.i18nUploadFile))));
  }
  get hostElement() {
