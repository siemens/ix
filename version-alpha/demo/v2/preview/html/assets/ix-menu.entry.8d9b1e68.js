...
const Menu = class {
  ...
  render() {
    var _a, _b;
    return h(Host, { key: "399b24ede589bfad9528bea4392c9054b3d0461b", class: {
      expanded: this.expand,
      [`breakpoint-${this.breakpoint}`]: true
    }, slot: "menu" }, h("nav", { key: "90d7abe543d3626c562c97637f186227a07d8a80", class: {
      menu: true,
      expanded: this.expand
    } }, h("div", { key: "73c45171a05831f52ec82f67212c00e22445643d", class: "menu-buttons" }, this.breakpoint !== "sm" && h("ix-menu-expand-icon", { key: "a60fed4a2191b18903a1bb3a1805e67eda925a00", breakpoint: this.breakpoint, expanded: this.expand, pinned: this.pinned, class: "menu-expand-icon", ixAriaLabel: this.i18nExpandSidebar, onClick: async () => this.toggleMenu(), "data-testid": "expand-collapse-menu" }), this.breakpoint === "sm" && ((_a = this.applicationLayoutContext) === null || _a === void 0 ? void 0 : _a.appSwitchConfig) && h("ix-icon-button", { key: "eeac468e4edf2bc90d52e5f6c1b5ec33b673400d", onClick: () => {
      this.showAppSwitch();
    }, icon: iconApps, ghost: true })), h("div", { key: "14b0349a9f7fd7fb92dffd69d0ce2882e627d29e", id: "menu-tabs", style: {
      display: "contents"
    }, onClick: (e) => this.onMenuItemsClick(e) }, h("div", { key: "dca30d5bf98b83e776fafe7708586a204bbd5de1", class: "tabs-shadow-container" }, h("div", { key: "cb243ca034e6612dad9107a9f53d22e833bee9a3", class: {
      "tabs--shadow": true,
      "tabs--shadow-top": true,
      "tabs--shadow--show": this.itemsScrollShadowTop
    } }), h("div", { key: "997a2f8f8762c25d0e92f223f119af436e6fd4b7", class: {
      tabs: true,
      "show-scrollbar": this.expand
    }, onScroll: () => this.handleOverflowIndicator() }, h("div", { key: "8685278d96b4afce9e68fe780907c1385ad3e730", class: "menu-avatar" }, h("slot", { key: "9d8b09624ae560118a5677c3978d24364b988319", name: "ix-menu-avatar" })), h("slot", { key: "d0098a9a68369713a02e4118ed10abed5fbd64f3", name: "home" }), this.breakpoint !== "sm" || !this.isHiddenFromViewport() ? h("slot", null) : null), h("div", { key: "031fe38db543f6661dd6e950825ecd311752c2bd", class: {
      "tabs--shadow": true,
      "tabs--shadow-bottom": true,
      "tabs--shadow--show": this.itemsScrollShadowBottom
    } }))), h("div", { key: "c02ca069adbc019601db85ba560c303209fc2e3a", class: "bottom-tab-divider" }), this.settings ? h("ix-menu-item", { disabled: this.isHiddenFromViewport(), id: "settings", class: {
      "internal-tab": true,
      "bottom-tab": true,
      active: this.showSettings
    }, icon: iconCogwheel, onClick: async () => this.toggleSettings(!this.showSettings), label: this.i18nSettings }) : null, h("div", { key: "017d2aff04ec6763938d344c18293dccbff99356", onClick: (e) => this.onMenuItemsClick(e) }, h("slot", { key: "a224710759e1a84f500b50497ff0cf442f656ae3", name: "bottom" })), h("div", { key: "ea74cad15c8c3aaff02c7230a9d8298212e2b05a", id: "popover-area" }), this.about ? h("ix-menu-item", { disabled: this.isHiddenFromViewport(), id: "aboutAndLegal", class: {
      "internal-tab": true,
      "bottom-tab": true,
      active: this.showAbout
    }, icon: iconInfo, onClick: async () => this.toggleAbout(!this.showAbout), label: this.i18nLegal }) : null, this.enableToggleTheme ? h("ix-menu-item", { disabled: this.isHiddenFromViewport(), id: "toggleTheme", onClick: () => themeSwitcher.toggleMode(), class: "internal-tab bottom-tab", icon: iconLightDark, label: this.i18nToggleTheme }) : null, this.enableMapExpand || ((_b = this.applicationLayoutContext) === null || _b === void 0 ? void 0 : _b.sidebar) ? h("ix-menu-item", { disabled: this.isHiddenFromViewport(), id: "menu-collapse", onClick: () => this.sidebarToggle(), class: "internal-tab bottom-tab", icon: `${this.getCollapseIcon()}`, label: this.getCollapseText() }) : null), h("div", { key: "04b30df0d35054be5ef65d8fab91a6b92c225fb9", class: {
      "menu-overlay": true,
      ...
      this.checkTransition();
    } }, h("div", { key: "95534ab84a9e2f3d30a1be08b2dd45b4d526a844", class: "menu-overlay-container" }, this.showSettings ? h("slot", { name: "ix-menu-settings" }) : null), h("div", { key: "3d4f4bf7ef1debe0e46b00740298fb6519900acd", class: "menu-overlay-container" }, this.showAbout ? h("slot", { name: "ix-menu-about" }) : null)));
  }
  get hostElement() {
