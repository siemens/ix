...
const Select = class {
  ...
  render() {
    var _a, _b, _c, _d;
    return h(Host, { key: "39ccbd4428065d482f8af2eaacbfdd3721dffceb", "aria-disabled": a11yBoolean(this.disabled), class: {
      disabled: this.disabled
    } }, h("ix-field-wrapper", { key: "3142eebe2c01e11a3f1f3bcdee0e02c07a8f2b40", required: this.required, label: this.label, helperText: this.helperText, invalidText: this.invalidText, infoText: this.infoText, warningText: this.warningText, validText: this.validText, showTextAsTooltip: this.showTextAsTooltip, isInvalid: this.isInvalid, isValid: this.isValid, isInfo: this.isInfo, isWarning: this.isWarning, controlRef: this.inputRef }, h("div", { key: "c210b3e8698db9845397ef565a6c4d8d40e67b16", class: {
      select: true,
      disabled: this.disabled,
    ...
    } }, h("div", { key: "dfa96a13f590e60092cf589956faacfa352d92d3", class: "input-container" }, h("div", { key: "8b2c57abe111f74862923f5f05b6b69713544985", class: "chips" }, this.isMultipleMode ? (_a = this.selectedItems) === null || _a === void 0 ? void 0 : _a.map((item) => h("ix-filter-chip", { disabled: this.disabled || this.readonly, key: item.value, onCloseClick: (e) => {
      e.preventDefault();
      e.stopPropagation();
      this.itemClick(item.value);
    } }, item.label)) : "", h("div", { key: "5ccdefc66727f36f09a301fb2aa3d25804367fca", class: "trigger" }, h("input", { key: "d1ea608660a5a13f072a970e15863073c22e5b71", autocomplete: "off", "data-testid": "input", disabled: this.disabled, readOnly: this.readonly, required: this.required, type: "text", class: {
      ...
      if (this.editable)
        this.dropdownWrapperRef(ref);
    } })))))), h("ix-dropdown", { key: "147af2cb63cade026e164dd599ffa06c2de1e03c", ref: (ref) => this.dropdownElement = ref, show: this.dropdownShow, closeBehavior: this.isMultipleMode ? "outside" : "both", class: {
    ...
    } }, h("div", { key: "3cc95e4001ec81d8cc5acd7b0aa30ea791f5a527", class: {
      "select-list-header": true,
      hidden: this.hideListHeader || this.isDropdownEmpty
    }, title: this.i18nSelectListHeader, onClick: (e) => e.preventDefault() }, this.i18nSelectListHeader), h("slot", { key: "6259694875f4d49c2a4d7c16c689011684d15a7d", onSlotchange: () => {
      this.updateSelection();
    } }), h("div", { key: "6ed9b3aa49aebc042eaf9cdb5197155110f06bbb", ref: (ref) => this.customItemsContainerElement = ref }), this.isAddItemVisible() ? h("ix-dropdown-item", { "data-testid": "add-item", icon: iconPlus, class: {
      "add-item": true
