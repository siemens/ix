import { r as registerInstance, c as createEvent, f as forceUpdate, h, g as getElement, H as Host } from "./global.7dd975c7.js";
...
const MenuSettings = class {
  ...
  render() {
    return h(MenuTabs, { key: "e5a0d1cc238a2c88d9a0c572fbfecefd3a589c38", context: this });
  }
  get el() {
...
const getTabItems = (context) => {
  return context.items.map(({ label }) => {
    return h("ix-tab-item", { selected: label === context.activeTabLabel, onClick: () => {
      if (label) {
