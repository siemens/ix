...
const Menu = class {
  ...
  render() {
    var _a, _b;
    return h(Host, { key: "34acb4f7248d1fdd1dae9cd558ee8fbacf6ccb30", class: {
      expanded: this.expand,
      [`breakpoint-${this.breakpoint}`]: true
    }, slot: "menu" }, h("nav", { key: "92b517494803d6189be1614a04c7c6edb21ecd5a", class: {
      menu: true,
      expanded: this.expand
    } }, h("div", { key: "565601177af87864f2d1512eadb11b5bcea2a5c3", class: "menu-buttons" }, this.breakpoint !== "sm" && h("ix-menu-expand-icon", { key: "860112657f5ebe5d7d2ab14b37868a4f1b13742f", breakpoint: this.breakpoint, expanded: this.expand, pinned: this.pinned, class: "menu-expand-icon", ixAriaLabel: this.i18nExpandSidebar, onClick: async () => this.toggleMenu() }), this.breakpoint === "sm" && ((_a = this.applicationLayoutContext) === null || _a === void 0 ? void 0 : _a.appSwitchConfig) && h("ix-icon-button", { key: "fecb89a154c4ede9e6d4b09c78c4fb985ae13e37", onClick: () => {
      this.showAppSwitch();
    }, icon: "apps", ghost: true })), h("div", { key: "11f0983e123eebe3a82866437c9b8479df109066", id: "menu-tabs", style: {
      display: "contents"
    }, onClick: (e) => this.onMenuItemsClick(e) }, h("div", { key: "d4d76fe04e690a63d76af4b8c84b7cb0b6edc852", class: "tabs-shadow-container" }, h("div", { key: "3c1626e1aac8d92d43969e7b39ecc3551863fee5", class: {
      "tabs--shadow": true,
      "tabs--shadow-top": true,
      "tabs--shadow--show": this.itemsScrollShadowTop
    } }), h("div", { key: "2629b6c82d46e117077422cc9b500af773190398", class: {
      tabs: true,
      "show-scrollbar": this.expand
    }, onScroll: () => this.handleOverflowIndicator() }, h("div", { key: "1cffcb3f33e4c8badffb6ddd775599ff6730bfe3", class: "menu-avatar" }, h("slot", { key: "5ea94f9820f30b00e60eea1ccfe8173882240d66", name: "ix-menu-avatar" })), h("slot", { key: "8a35be3679f329141cb25808ddb9823a7098bbed", name: "home" }), this.breakpoint !== "sm" || !this.isHiddenFromViewport() ? h("slot", null) : null), h("div", { key: "2846791805325640f24db3868594f92705f103f8", class: {
      "tabs--shadow": true,
      "tabs--shadow-bottom": true,
      "tabs--shadow--show": this.itemsScrollShadowBottom
    } }))), h("div", { key: "91e34e2c7fc757cca8c2c2b27b98d86a19a107c6", class: "bottom-tab-divider" }), this.settings ? h("ix-menu-item", { disabled: this.isHiddenFromViewport(), id: "settings", class: {
      "internal-tab": true,
      "bottom-tab": true,
      active: this.showSettings
    }, icon: "cogwheel", onClick: async () => this.toggleSettings(!this.showSettings), label: this.i18nSettings }) : null, h("div", { key: "5947d048b397e8526a329fd1e6e3a91e0acf8eb8", onClick: (e) => this.onMenuItemsClick(e) }, h("slot", { key: "4c0329d3a438da60058f0d39ff5fb27f4700930c", name: "bottom" })), h("div", { key: "846223c5ffefc3f20bbf216af267201eee43a483", id: "popover-area" }), this.about ? h("ix-menu-item", { disabled: this.isHiddenFromViewport(), id: "aboutAndLegal", class: {
      "internal-tab": true,
      "bottom-tab": true,
      active: this.showAbout
    }, icon: "info", onClick: async () => this.toggleAbout(!this.showAbout), label: this.i18nLegal }) : null, this.enableToggleTheme ? h("ix-menu-item", { disabled: this.isHiddenFromViewport(), id: "toggleTheme", onClick: () => themeSwitcher.toggleMode(), class: "internal-tab bottom-tab", icon: "light-dark", label: this.i18nToggleTheme }) : null, this.enableMapExpand || ((_b = this.applicationLayoutContext) === null || _b === void 0 ? void 0 : _b.sidebar) ? h("ix-menu-item", { disabled: this.isHiddenFromViewport(), id: "menu-collapse", onClick: () => this.sidebarToggle(), class: "internal-tab bottom-tab", icon: `${this.getCollapseIcon()}`, label: this.getCollapseText() }) : null), h("div", { key: "b626b582889704483c57da30d427646f3860350e", class: {
      "menu-overlay": true,
      ...
      this.checkTransition();
    } }, h("div", { key: "0992a73e9576c1d59c2aaeea3c56d1be08df9506", class: "menu-overlay-container" }, this.showSettings ? h("slot", { name: "ix-menu-settings" }) : null), h("div", { key: "d762f782b8d129ae7337e5a8d99e8b123cd3afcb", class: "menu-overlay-container" }, this.showAbout ? h("slot", { name: "ix-menu-about" }) : null)));
  }
  get hostElement() {
