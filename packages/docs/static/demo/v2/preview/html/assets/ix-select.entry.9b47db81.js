...
const Select = class {
  ...
  render() {
    ...
    } }, h("div", { key: "36fb0119739e50e0b7ad33206b9ac2af13a2d02a", class: "input-container" }, h("div", { key: "69cd6098ab12694ccbb9f379fe306d20e058ab7d", class: "chips" }, this.isMultipleMode ? (_a = this.selectedItems) === null || _a === void 0 ? void 0 : _a.map((item) => h("ix-filter-chip", { disabled: this.disabled || this.readonly, key: item.value, onCloseClick: (e) => {
      e.preventDefault();
      e.stopPropagation();
      this.itemClick(item.value);
    } }, item.label)) : "", h("div", { key: "10b6f384260f0137b92063c6277601b30d91e71e", class: "trigger" }, h("input", { key: "71222c3c2fce7115a28e1ddc798c1c947195b6c0", autocomplete: "off", "data-testid": "input", disabled: this.disabled, readOnly: this.readonly, required: this.required, type: "text", class: {
