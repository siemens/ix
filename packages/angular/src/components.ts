...
@ProxyCmp({
  defineCustomElementFn: undefined,
  inputs: ['adjustDropdownWidthToReferenceWidth', 'adjustDropdownWidthToReferenceWith', 'anchor', 'closeBehavior', 'enableQuickActions', 'header', 'placement', 'positioningStrategy', 'show', 'trigger'],
