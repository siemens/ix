...
@ProxyCmp({
  inputs: ['appIcon', 'appIconAlt', 'ariaLabelAppSwitchIconButton', 'ariaLabelMenuExpandIconButton', 'ariaLabelMoreMenuIconButton', 'companyLogo', 'companyLogoAlt', 'name', 'nameSuffix', 'primaryNavigation', 'showMenu']
})
@Component({
