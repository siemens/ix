...
@ProxyCmp({
  inputs: ['anchor', 'closeBehavior', 'enableTopLayer', 'header', 'intersectionRoot', 'placement', 'positioningStrategy', 'show', 'suppressAutomaticPlacement', 'trigger'],
