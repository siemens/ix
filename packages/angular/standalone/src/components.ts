...
@ProxyCmp({
  ...
  inputs: ['corners', 'format', 'hourInterval', 'millisecondInterval', 'minuteInterval', 'secondInterval', 'showHour', 'showMilliseconds', 'showMinutes', 'showSeconds', 'standaloneAppearance', 'textSelectTime', 'textTime', 'time', 'timeReference'],
