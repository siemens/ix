...
@ProxyCmp({
  ...
  inputs: ['ariaLabelFilterInput', 'ariaLabelResetButton', 'categories', 'disableSearch', 'disabled', 'enableTopLayer', 'filterState', 'hasError', 'hideIcon', 'i18nAllValuesSelectedButton', 'i18nAllValuesSelectedHeader', 'i18nAllValuesSelectedSubtext', 'i18nNoCategoryMatchHeader', 'i18nNoMatchesFound', 'i18nNoOperandMatchHeader', 'i18nNoValueMatchHeader', 'i18nPlainText', 'i18nRemoveInputSubtext', 'i18nRemoveValueSubtext', 'i18nSeeAllOptions', 'icon', 'isLoading', 'labelCategories', 'labelOperands', 'labelValues', 'nonSelectableCategories', 'operands', 'placeholder', 'readonly', 'staticOperand', 'suggestions', 'uniqueCategories']
})
@Component({
