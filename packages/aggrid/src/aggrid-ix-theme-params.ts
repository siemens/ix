...
export const aggridIxThemeParams = {
  ...
  'pickerButtonBackgroundColor': `var(--si-sys-background-2)`,
  'pickerListBackgroundColor': `var(--si-sys-background-3)`,
  ...
  'rowLoadingSkeletonEffectColor': `var(--si-sys-background-hover)`,
  ...
  'tabBarBorder': `false`,
  'tabBorderColor': `var(--si-sys-border-4)`,
  'tabHoverBackgroundColor': `var(--si-sys-background-hover)`,
