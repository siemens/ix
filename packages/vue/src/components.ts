...
export const IxAnimatedTab = /*@__PURE__*/ defineContainer<JSX.IxAnimatedTab>('ix-animated-tab', defineIxAnimatedTab, [
  'icon',
  'count'
]);


export const IxAnimatedTabs = /*@__PURE__*/ defineContainer<JSX.IxAnimatedTabs>('ix-animated-tabs', defineIxAnimatedTabs, [
  'disableAnimations',
  'selectedIndex',
  'tabPlacement',
  'tabClick'
...
export const IxCounterPill = /*@__PURE__*/ defineContainer<JSX.IxCounterPill>('ix-counter-pill', defineIxCounterPill, [
  'variant',
  'outline',
  'background',
  'color',
...
export const IxGroupDropdownItem = /*@__PURE__*/ defineContainer<JSX.IxGroupDropdownItem>('ix-group-dropdown-item', defineIxGroupDropdownItem, [
  'label',
  'icon'
]);
...
export const IxModalContainer = /*@__PURE__*/ defineContainer<JSX.IxModalContainer>('ix-modal-container', defineIxModalContainer);
