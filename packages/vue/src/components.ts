...
export const IxBlind = /*@__PURE__*/ defineContainer<JSX.IxBlind>(
  'ix-blind',
  undefined,
  ['collapsed', 'label', 'collapsedChange']
);
...
export const IxButton = /*@__PURE__*/ defineContainer<JSX.IxButton>(
  'ix-button',
  undefined,
  ['variant', 'outline', 'invisible', 'ghost', 'selected', 'disabled', 'type']
);
...
export const IxDateTimeCard = /*@__PURE__*/ defineContainer<JSX.IxDateTimeCard>(
  'ix-date-time-card',
  undefined,
  ['individual', 'corners']
);
...
export const IxExpandingSearch =
  /*@__PURE__*/ defineContainer<JSX.IxExpandingSearch>(
    'ix-expanding-search',
    undefined,
    ['icon', 'placeholder', 'value', 'valueChange']
  );
...
export const IxMenuAvatar = /*@__PURE__*/ defineContainer<JSX.IxMenuAvatar>(
  'ix-menu-avatar',
  undefined,
  ['top', 'bottom', 'i18nLogout', 'logoutClick']
);
...
export const IxMenuItem = /*@__PURE__*/ defineContainer<JSX.IxMenuItem>(
  'ix-menu-item',
  undefined,
  ['home', 'bottom', 'tabIcon', 'notifications', 'active', 'disabled']
);
...
export const IxTree = /*@__PURE__*/ defineContainer<JSX.IxTree>(
  'ix-tree',
  undefined,
  ['root', 'model', 'renderItem', 'context', 'contextChange', 'nodeRemoved']
);
...
export const IxWorkflowStep = /*@__PURE__*/ defineContainer<JSX.IxWorkflowStep>(
  'ix-workflow-step',
  undefined,
  ['vertical', 'disabled', 'status', 'clickable', 'selected', 'position']
);
