...
We prepared a video for you in our Siemens-internal knowledge board. Access it [here](https://mylearningworld.siemens.com/web/es/app/knowledge-board/lex_auth_0142543970762915841020).

:::info
You can still access the Figma libraries for v2.0.0 in the **Archive** project (find the link in the main library).
:::
