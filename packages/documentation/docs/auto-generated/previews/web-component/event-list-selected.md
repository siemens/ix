...
<!-- Auto generated! Please edit here: packages/html-test-app/src/preview-examples/event-list-selected.html -->

```html
<ix-event-list>
  <ix-event-list-item color="color-primary">Text 1</ix-event-list-item>
  <ix-event-list-item color="color-primary" selected>Text 2</ix-event-list-item>
