...
- **Field:** Use the appropriate field based on the type of input data, e.g. use [text inputs](../input-legacy.md) for text-based data, [checkboxes](forms-checkbox.md) for selecting from a list of predefined options, or [toggle switches](../toggle.md) for a binary choice.
