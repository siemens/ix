...
import { type BorderlessChangedEvent, type CustomCloseEvent, type CustomLabelChangeEvent, type DateChangeEvent, type DateRangeChangeEvent, type DateTimeDateChangeEvent, type DateTimeSelectEvent, type ExpandedChangedEvent, type FilterState, type InputState, type IxBreadcrumbCustomEvent, type IxCardListCustomEvent, type IxCategoryFilterCustomEvent, type IxDateDropdownCustomEvent, type IxDatePickerCustomEvent, type IxDatetimePickerCustomEvent, type IxGroupItemCustomEvent, type IxMenuAboutCustomEvent, type IxMenuAboutItemCustomEvent, type IxMenuAboutNewsCustomEvent, type IxMenuAvatarItemCustomEvent, type IxMenuSettingsCustomEvent, type IxMenuSettingsItemCustomEvent, type IxModalHeaderCustomEvent, type IxPaneCustomEvent, type IxSplitButtonCustomEvent, type IxSplitButtonItemCustomEvent, type IxTabItemCustomEvent, type IxUploadCustomEvent, type TabClickDetail, type VariantChangedEvent } from "@siemens/ix";
...
export const IxFormField: StencilReactComponent<IxFormFieldElement, IxFormFieldEvents> = /*@__PURE__*/ createComponent<IxFormFieldElement, IxFormFieldEvents>({
...
export const IxModalExample: StencilReactComponent<IxModalExampleElement, IxModalExampleEvents> = /*@__PURE__*/ createComponent<IxModalExampleElement, IxModalExampleEvents>({
...
export const IxSplitButtonItem: StencilReactComponent<IxSplitButtonItemElement, IxSplitButtonItemEvents> = /*@__PURE__*/ createComponent<IxSplitButtonItemElement, IxSplitButtonItemEvents>({
