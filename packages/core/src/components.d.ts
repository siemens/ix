...
} from './components/card-accordion/card-accordion.types';
...
} from './components/date-dropdown/date-dropdown.types';
...
import {
  ...
  DateTimeSelectEvent,
} from './components/datetime-picker/datetime-picker.types';
...
} from './components/utils/menu-tabs/menu-tabs-utils';
...
import {
  ...
  SlotChangedEvent,
  VariantChangedEvent,
} from './components/pane/pane.types';
import {
  ProgressIndicatorSize,
  ProgressIndicatorStatus,
} from './components/progress-indicator/progress-indicator.types';
...
export namespace Components {
  ...
  interface IxSelectItem {
     ...
     */
    onItemClick: (
      event?: CustomEvent<HTMLIxDropdownItemElement>
    ) => Promise<void>;
    /**
...
declare global {
  interface HTMLIxActionCardElement
    extends Components.IxActionCard,
      HTMLStencilElement {}
  var HTMLIxActionCardElement: {
    prototype: HTMLIxActionCardElement;
    new (): HTMLIxActionCardElement;
  };
  interface HTMLIxApplicationElement
    extends Components.IxApplication,
      HTMLStencilElement {}
  ...
  interface HTMLIxApplicationHeaderElement
    extends Components.IxApplicationHeader,
      HTMLStencilElement {
    addEventListener<K extends keyof HTMLIxApplicationHeaderElementEventMap>(
      type: K,
      listener: (
        this: HTMLIxApplicationHeaderElement,
        ev: IxApplicationHeaderCustomEvent<
          HTMLIxApplicationHeaderElementEventMap[K]
        >
      ) => any,
    ...
    removeEventListener<K extends keyof HTMLIxApplicationHeaderElementEventMap>(
      type: K,
      listener: (
        this: HTMLIxApplicationHeaderElement,
        ev: IxApplicationHeaderCustomEvent<
  ...
  interface HTMLIxApplicationSidebarElement
    extends Components.IxApplicationSidebar,
      HTMLStencilElement {}
  var HTMLIxApplicationSidebarElement: {
    prototype: HTMLIxApplicationSidebarElement;
    new (): HTMLIxApplicationSidebarElement;
  };
  interface HTMLIxApplicationSwitchModalElement
    extends Components.IxApplicationSwitchModal,
      HTMLStencilElement {}
  ...
  interface HTMLIxAvatarElement
    extends Components.IxAvatar,
      HTMLStencilElement {}
  ...
  interface HTMLIxBlindElement extends Components.IxBlind, HTMLStencilElement {
    addEventListener<K extends keyof HTMLIxBlindElementEventMap>(
      type: K,
      listener: (
        this: HTMLIxBlindElement,
        ev: IxBlindCustomEvent<HTMLIxBlindElementEventMap[K]>
      ) => any,
      options?: boolean | AddEventListenerOptions
    ): void;
    addEventListener<K extends keyof DocumentEventMap>(
    ...
    removeEventListener<K extends keyof HTMLIxBlindElementEventMap>(
      type: K,
      listener: (
        this: HTMLIxBlindElement,
        ev: IxBlindCustomEvent<HTMLIxBlindElementEventMap[K]>
  ...
  interface HTMLIxBreadcrumbElement
    extends Components.IxBreadcrumb,
      HTMLStencilElement {
    addEventListener<K extends keyof HTMLIxBreadcrumbElementEventMap>(
      type: K,
      listener: (
        this: HTMLIxBreadcrumbElement,
        ev: IxBreadcrumbCustomEvent<HTMLIxBreadcrumbElementEventMap[K]>
      ) => any,
      options?: boolean | AddEventListenerOptions
    ): void;
    addEventListener<K extends keyof DocumentEventMap>(
    ...
    removeEventListener<K extends keyof HTMLIxBreadcrumbElementEventMap>(
      type: K,
      listener: (
        this: HTMLIxBreadcrumbElement,
        ev: IxBreadcrumbCustomEvent<HTMLIxBreadcrumbElementEventMap[K]>
  ...
  interface HTMLIxBreadcrumbItemElement
    extends Components.IxBreadcrumbItem,
      HTMLStencilElement {
    addEventListener<K extends keyof HTMLIxBreadcrumbItemElementEventMap>(
      type: K,
      listener: (
        this: HTMLIxBreadcrumbItemElement,
        ev: IxBreadcrumbItemCustomEvent<HTMLIxBreadcrumbItemElementEventMap[K]>
      ) => any,
      options?: boolean | AddEventListenerOptions
    ): void;
    addEventListener<K extends keyof DocumentEventMap>(
    ...
    removeEventListener<K extends keyof HTMLIxBreadcrumbItemElementEventMap>(
      type: K,
      listener: (
        this: HTMLIxBreadcrumbItemElement,
        ev: IxBreadcrumbItemCustomEvent<HTMLIxBreadcrumbItemElementEventMap[K]>
  ...
  interface HTMLIxButtonElement
    extends Components.IxButton,
      HTMLStencilElement {}
  ...
  interface HTMLIxCardAccordionElement
    extends Components.IxCardAccordion,
      HTMLStencilElement {
    addEventListener<K extends keyof HTMLIxCardAccordionElementEventMap>(
      type: K,
      listener: (
        this: HTMLIxCardAccordionElement,
        ev: IxCardAccordionCustomEvent<HTMLIxCardAccordionElementEventMap[K]>
      ) => any,
      options?: boolean | AddEventListenerOptions
    ): void;
    addEventListener<K extends keyof DocumentEventMap>(
    ...
    removeEventListener<K extends keyof HTMLIxCardAccordionElementEventMap>(
      type: K,
      listener: (
        this: HTMLIxCardAccordionElement,
        ev: IxCardAccordionCustomEvent<HTMLIxCardAccordionElementEventMap[K]>
  ...
  interface HTMLIxCardContentElement
    extends Components.IxCardContent,
      HTMLStencilElement {}
  ...
  interface HTMLIxCardListElement
    extends Components.IxCardList,
      HTMLStencilElement {
    addEventListener<K extends keyof HTMLIxCardListElementEventMap>(
      type: K,
      listener: (
        this: HTMLIxCardListElement,
        ev: IxCardListCustomEvent<HTMLIxCardListElementEventMap[K]>
      ) => any,
      options?: boolean | AddEventListenerOptions
    ): void;
    addEventListener<K extends keyof DocumentEventMap>(
    ...
    removeEventListener<K extends keyof HTMLIxCardListElementEventMap>(
      type: K,
      listener: (
        this: HTMLIxCardListElement,
        ev: IxCardListCustomEvent<HTMLIxCardListElementEventMap[K]>
  ...
  interface HTMLIxCardTitleElement
    extends Components.IxCardTitle,
      HTMLStencilElement {}
  ...
  interface HTMLIxCategoryFilterElement
    extends Components.IxCategoryFilter,
      HTMLStencilElement {
    addEventListener<K extends keyof HTMLIxCategoryFilterElementEventMap>(
      type: K,
      listener: (
        this: HTMLIxCategoryFilterElement,
        ev: IxCategoryFilterCustomEvent<HTMLIxCategoryFilterElementEventMap[K]>
      ) => any,
      options?: boolean | AddEventListenerOptions
    ): void;
    addEventListener<K extends keyof DocumentEventMap>(
    ...
    removeEventListener<K extends keyof HTMLIxCategoryFilterElementEventMap>(
      type: K,
      listener: (
        this: HTMLIxCategoryFilterElement,
        ev: IxCategoryFilterCustomEvent<HTMLIxCategoryFilterElementEventMap[K]>
   ...
   * @form-ready
   */
  interface HTMLIxCheckboxElement
    extends Components.IxCheckbox,
      HTMLStencilElement {
    addEventListener<K extends keyof HTMLIxCheckboxElementEventMap>(
      type: K,
      listener: (
        this: HTMLIxCheckboxElement,
        ev: IxCheckboxCustomEvent<HTMLIxCheckboxElementEventMap[K]>
      ) => any,
      options?: boolean | AddEventListenerOptions
    ): void;
    addEventListener<K extends keyof DocumentEventMap>(
    ...
    removeEventListener<K extends keyof HTMLIxCheckboxElementEventMap>(
      type: K,
      listener: (
        this: HTMLIxCheckboxElement,
        ev: IxCheckboxCustomEvent<HTMLIxCheckboxElementEventMap[K]>
   ...
   * @form-ready
   */
  interface HTMLIxCheckboxGroupElement
    extends Components.IxCheckboxGroup,
      HTMLStencilElement {}
  ...
  interface HTMLIxChipElement extends Components.IxChip, HTMLStencilElement {
    addEventListener<K extends keyof HTMLIxChipElementEventMap>(
      type: K,
      listener: (
        this: HTMLIxChipElement,
        ev: IxChipCustomEvent<HTMLIxChipElementEventMap[K]>
      ) => any,
      options?: boolean | AddEventListenerOptions
    ): void;
    addEventListener<K extends keyof DocumentEventMap>(
    ...
    removeEventListener<K extends keyof HTMLIxChipElementEventMap>(
      type: K,
      listener: (
        this: HTMLIxChipElement,
        ev: IxChipCustomEvent<HTMLIxChipElementEventMap[K]>
  ...
  interface HTMLIxContentElement
    extends Components.IxContent,
      HTMLStencilElement {}
  ...
  interface HTMLIxContentHeaderElement
    extends Components.IxContentHeader,
      HTMLStencilElement {
    addEventListener<K extends keyof HTMLIxContentHeaderElementEventMap>(
      type: K,
      listener: (
        this: HTMLIxContentHeaderElement,
        ev: IxContentHeaderCustomEvent<HTMLIxContentHeaderElementEventMap[K]>
      ) => any,
      options?: boolean | AddEventListenerOptions
    ): void;
    addEventListener<K extends keyof DocumentEventMap>(
    ...
    removeEventListener<K extends keyof HTMLIxContentHeaderElementEventMap>(
      type: K,
      listener: (
        this: HTMLIxContentHeaderElement,
        ev: IxContentHeaderCustomEvent<HTMLIxContentHeaderElementEventMap[K]>
  ...
  interface HTMLIxCssGridElement
    extends Components.IxCssGrid,
      HTMLStencilElement {}
  var HTMLIxCssGridElement: {
    prototype: HTMLIxCssGridElement;
    new (): HTMLIxCssGridElement;
  };
  interface HTMLIxCssGridItemElement
    extends Components.IxCssGridItem,
      HTMLStencilElement {}
  var HTMLIxCssGridItemElement: {
    prototype: HTMLIxCssGridItemElement;
    new (): HTMLIxCssGridItemElement;
  };
  interface HTMLIxCustomFieldElement
    extends Components.IxCustomField,
      HTMLStencilElement {}
  ...
  interface HTMLIxDateDropdownElement
    extends Components.IxDateDropdown,
      HTMLStencilElement {
    addEventListener<K extends keyof HTMLIxDateDropdownElementEventMap>(
      type: K,
      listener: (
        this: HTMLIxDateDropdownElement,
        ev: IxDateDropdownCustomEvent<HTMLIxDateDropdownElementEventMap[K]>
      ) => any,
      options?: boolean | AddEventListenerOptions
    ): void;
    addEventListener<K extends keyof DocumentEventMap>(
    ...
    removeEventListener<K extends keyof HTMLIxDateDropdownElementEventMap>(
      type: K,
      listener: (
        this: HTMLIxDateDropdownElement,
        ev: IxDateDropdownCustomEvent<HTMLIxDateDropdownElementEventMap[K]>
   ...
   * @form-ready
   */
  interface HTMLIxDateInputElement
    extends Components.IxDateInput,
      HTMLStencilElement {
    addEventListener<K extends keyof HTMLIxDateInputElementEventMap>(
      type: K,
      listener: (
        this: HTMLIxDateInputElement,
        ev: IxDateInputCustomEvent<HTMLIxDateInputElementEventMap[K]>
      ) => any,
      options?: boolean | AddEventListenerOptions
    ): void;
    addEventListener<K extends keyof DocumentEventMap>(
    ...
    removeEventListener<K extends keyof HTMLIxDateInputElementEventMap>(
      type: K,
      listener: (
        this: HTMLIxDateInputElement,
        ev: IxDateInputCustomEvent<HTMLIxDateInputElementEventMap[K]>
  ...
  interface HTMLIxDatePickerElement
    extends Components.IxDatePicker,
      HTMLStencilElement {
    addEventListener<K extends keyof HTMLIxDatePickerElementEventMap>(
      type: K,
      listener: (
        this: HTMLIxDatePickerElement,
        ev: IxDatePickerCustomEvent<HTMLIxDatePickerElementEventMap[K]>
      ) => any,
      options?: boolean | AddEventListenerOptions
    ): void;
    addEventListener<K extends keyof DocumentEventMap>(
    ...
    removeEventListener<K extends keyof HTMLIxDatePickerElementEventMap>(
      type: K,
      listener: (
        this: HTMLIxDatePickerElement,
        ev: IxDatePickerCustomEvent<HTMLIxDatePickerElementEventMap[K]>
  ...
  interface HTMLIxDateTimeCardElement
    extends Components.IxDateTimeCard,
      HTMLStencilElement {}
  ...
  interface HTMLIxDatetimePickerElement
    extends Components.IxDatetimePicker,
      HTMLStencilElement {
    addEventListener<K extends keyof HTMLIxDatetimePickerElementEventMap>(
      type: K,
      listener: (
        this: HTMLIxDatetimePickerElement,
        ev: IxDatetimePickerCustomEvent<HTMLIxDatetimePickerElementEventMap[K]>
      ) => any,
      options?: boolean | AddEventListenerOptions
    ): void;
    addEventListener<K extends keyof DocumentEventMap>(
    ...
    removeEventListener<K extends keyof HTMLIxDatetimePickerElementEventMap>(
      type: K,
      listener: (
        this: HTMLIxDatetimePickerElement,
        ev: IxDatetimePickerCustomEvent<HTMLIxDatetimePickerElementEventMap[K]>
  ...
  interface HTMLIxDividerElement
    extends Components.IxDivider,
      HTMLStencilElement {}
   ...
   * @deprecated Will be removed with 5.0.0, use ix-pane as successor
   */
  interface HTMLIxDrawerElement
    extends Components.IxDrawer,
      HTMLStencilElement {
    addEventListener<K extends keyof HTMLIxDrawerElementEventMap>(
      type: K,
      listener: (
        this: HTMLIxDrawerElement,
        ev: IxDrawerCustomEvent<HTMLIxDrawerElementEventMap[K]>
      ) => any,
      options?: boolean | AddEventListenerOptions
    ): void;
    addEventListener<K extends keyof DocumentEventMap>(
    ...
    removeEventListener<K extends keyof HTMLIxDrawerElementEventMap>(
      type: K,
      listener: (
        this: HTMLIxDrawerElement,
        ev: IxDrawerCustomEvent<HTMLIxDrawerElementEventMap[K]>
  ...
  interface HTMLIxDropdownElement
    extends Components.IxDropdown,
      HTMLStencilElement {
    addEventListener<K extends keyof HTMLIxDropdownElementEventMap>(
      type: K,
      listener: (
        this: HTMLIxDropdownElement,
        ev: IxDropdownCustomEvent<HTMLIxDropdownElementEventMap[K]>
      ) => any,
      options?: boolean | AddEventListenerOptions
    ): void;
    addEventListener<K extends keyof DocumentEventMap>(
    ...
    removeEventListener<K extends keyof HTMLIxDropdownElementEventMap>(
      type: K,
      listener: (
        this: HTMLIxDropdownElement,
        ev: IxDropdownCustomEvent<HTMLIxDropdownElementEventMap[K]>
  ...
  interface HTMLIxDropdownButtonElement
    extends Components.IxDropdownButton,
      HTMLStencilElement {}
  ...
  interface HTMLIxDropdownHeaderElement
    extends Components.IxDropdownHeader,
      HTMLStencilElement {}
  ...
  interface HTMLIxDropdownItemElement
    extends Components.IxDropdownItem,
      HTMLStencilElement {
    addEventListener<K extends keyof HTMLIxDropdownItemElementEventMap>(
      type: K,
      listener: (
        this: HTMLIxDropdownItemElement,
        ev: IxDropdownItemCustomEvent<HTMLIxDropdownItemElementEventMap[K]>
      ) => any,
      options?: boolean | AddEventListenerOptions
    ): void;
    addEventListener<K extends keyof DocumentEventMap>(
    ...
    removeEventListener<K extends keyof HTMLIxDropdownItemElementEventMap>(
      type: K,
      listener: (
        this: HTMLIxDropdownItemElement,
        ev: IxDropdownItemCustomEvent<HTMLIxDropdownItemElementEventMap[K]>
  ...
  interface HTMLIxDropdownQuickActionsElement
  ...
  interface HTMLIxEmptyStateElement
    extends Components.IxEmptyState,
      HTMLStencilElement {
    addEventListener<K extends keyof HTMLIxEmptyStateElementEventMap>(
      type: K,
      listener: (
        this: HTMLIxEmptyStateElement,
        ev: IxEmptyStateCustomEvent<HTMLIxEmptyStateElementEventMap[K]>
      ) => any,
      options?: boolean | AddEventListenerOptions
    ): void;
    addEventListener<K extends keyof DocumentEventMap>(
    ...
    removeEventListener<K extends keyof HTMLIxEmptyStateElementEventMap>(
      type: K,
      listener: (
        this: HTMLIxEmptyStateElement,
        ev: IxEmptyStateCustomEvent<HTMLIxEmptyStateElementEventMap[K]>
  ...
  interface HTMLIxEventListElement
    extends Components.IxEventList,
      HTMLStencilElement {}
  ...
  interface HTMLIxEventListItemElement
    extends Components.IxEventListItem,
      HTMLStencilElement {
    addEventListener<K extends keyof HTMLIxEventListItemElementEventMap>(
      type: K,
      listener: (
        this: HTMLIxEventListItemElement,
        ev: IxEventListItemCustomEvent<HTMLIxEventListItemElementEventMap[K]>
      ) => any,
      options?: boolean | AddEventListenerOptions
    ): void;
    addEventListener<K extends keyof DocumentEventMap>(
    ...
    removeEventListener<K extends keyof HTMLIxEventListItemElementEventMap>(
      type: K,
      listener: (
        this: HTMLIxEventListItemElement,
        ev: IxEventListItemCustomEvent<HTMLIxEventListItemElementEventMap[K]>
  ...
  interface HTMLIxExpandingSearchElement
    extends Components.IxExpandingSearch,
      HTMLStencilElement {
    addEventListener<K extends keyof HTMLIxExpandingSearchElementEventMap>(
      type: K,
      listener: (
        this: HTMLIxExpandingSearchElement,
        ev: IxExpandingSearchCustomEvent<
          HTMLIxExpandingSearchElementEventMap[K]
        >
      ) => any,
      options?: boolean | AddEventListenerOptions
    ): void;
    ...
    removeEventListener<K extends keyof HTMLIxExpandingSearchElementEventMap>(
      type: K,
      listener: (
        this: HTMLIxExpandingSearchElement,
        ev: IxExpandingSearchCustomEvent<
  ...
  interface HTMLIxFieldLabelElement
    extends Components.IxFieldLabel,
      HTMLStencilElement {}
  var HTMLIxFieldLabelElement: {
    prototype: HTMLIxFieldLabelElement;
    new (): HTMLIxFieldLabelElement;
  };
  interface HTMLIxFieldWrapperElement
    extends Components.IxFieldWrapper,
      HTMLStencilElement {}
  ...
  interface HTMLIxFilterChipElement
    extends Components.IxFilterChip,
      HTMLStencilElement {
    addEventListener<K extends keyof HTMLIxFilterChipElementEventMap>(
      type: K,
      listener: (
        this: HTMLIxFilterChipElement,
        ev: IxFilterChipCustomEvent<HTMLIxFilterChipElementEventMap[K]>
      ) => any,
      options?: boolean | AddEventListenerOptions
    ): void;
    addEventListener<K extends keyof DocumentEventMap>(
    ...
    removeEventListener<K extends keyof HTMLIxFilterChipElementEventMap>(
      type: K,
      listener: (
        this: HTMLIxFilterChipElement,
        ev: IxFilterChipCustomEvent<HTMLIxFilterChipElementEventMap[K]>
  ...
  interface HTMLIxFlipTileElement
    extends Components.IxFlipTile,
      HTMLStencilElement {
    addEventListener<K extends keyof HTMLIxFlipTileElementEventMap>(
      type: K,
      listener: (
        this: HTMLIxFlipTileElement,
        ev: IxFlipTileCustomEvent<HTMLIxFlipTileElementEventMap[K]>
      ) => any,
      options?: boolean | AddEventListenerOptions
    ): void;
    addEventListener<K extends keyof DocumentEventMap>(
    ...
    removeEventListener<K extends keyof HTMLIxFlipTileElementEventMap>(
      type: K,
      listener: (
        this: HTMLIxFlipTileElement,
        ev: IxFlipTileCustomEvent<HTMLIxFlipTileElementEventMap[K]>
  ...
  interface HTMLIxFlipTileContentElement
  ...
  interface HTMLIxGroupElement extends Components.IxGroup, HTMLStencilElement {
    addEventListener<K extends keyof HTMLIxGroupElementEventMap>(
      type: K,
      listener: (
        this: HTMLIxGroupElement,
        ev: IxGroupCustomEvent<HTMLIxGroupElementEventMap[K]>
      ) => any,
      options?: boolean | AddEventListenerOptions
    ): void;
    addEventListener<K extends keyof DocumentEventMap>(
    ...
    removeEventListener<K extends keyof HTMLIxGroupElementEventMap>(
      type: K,
      listener: (
        this: HTMLIxGroupElement,
        ev: IxGroupCustomEvent<HTMLIxGroupElementEventMap[K]>
  ...
  interface HTMLIxGroupContextMenuElement
  ...
  interface HTMLIxGroupItemElement
    extends Components.IxGroupItem,
      HTMLStencilElement {
    addEventListener<K extends keyof HTMLIxGroupItemElementEventMap>(
      type: K,
      listener: (
        this: HTMLIxGroupItemElement,
        ev: IxGroupItemCustomEvent<HTMLIxGroupItemElementEventMap[K]>
      ) => any,
      options?: boolean | AddEventListenerOptions
    ): void;
    addEventListener<K extends keyof DocumentEventMap>(
    ...
    removeEventListener<K extends keyof HTMLIxGroupItemElementEventMap>(
      type: K,
      listener: (
        this: HTMLIxGroupItemElement,
        ev: IxGroupItemCustomEvent<HTMLIxGroupItemElementEventMap[K]>
  ...
  interface HTMLIxHelperTextElement
    extends Components.IxHelperText,
      HTMLStencilElement {}
  var HTMLIxHelperTextElement: {
    prototype: HTMLIxHelperTextElement;
    new (): HTMLIxHelperTextElement;
  };
  interface HTMLIxIconButtonElement
    extends Components.IxIconButton,
      HTMLStencilElement {}
  ...
  interface HTMLIxIconToggleButtonElement
    extends Components.IxIconToggleButton,
      HTMLStencilElement {
    addEventListener<K extends keyof HTMLIxIconToggleButtonElementEventMap>(
      type: K,
      listener: (
        this: HTMLIxIconToggleButtonElement,
        ev: IxIconToggleButtonCustomEvent<
          HTMLIxIconToggleButtonElementEventMap[K]
        >
      ) => any,
      options?: boolean | AddEventListenerOptions
    ): void;
    ...
    removeEventListener<K extends keyof HTMLIxIconToggleButtonElementEventMap>(
      type: K,
      listener: (
        this: HTMLIxIconToggleButtonElement,
        ev: IxIconToggleButtonCustomEvent<
  ...
  interface HTMLIxInputElement extends Components.IxInput, HTMLStencilElement {
    addEventListener<K extends keyof HTMLIxInputElementEventMap>(
      type: K,
      listener: (
        this: HTMLIxInputElement,
        ev: IxInputCustomEvent<HTMLIxInputElementEventMap[K]>
      ) => any,
      options?: boolean | AddEventListenerOptions
    ): void;
    addEventListener<K extends keyof DocumentEventMap>(
    ...
    removeEventListener<K extends keyof HTMLIxInputElementEventMap>(
      type: K,
      listener: (
        this: HTMLIxInputElement,
        ev: IxInputCustomEvent<HTMLIxInputElementEventMap[K]>
   ...
   * Use the 'ix-input' component instead
   */
  interface HTMLIxInputGroupElement
    extends Components.IxInputGroup,
      HTMLStencilElement {}
  var HTMLIxInputGroupElement: {
    prototype: HTMLIxInputGroupElement;
    new (): HTMLIxInputGroupElement;
  };
  interface HTMLIxKeyValueElement
    extends Components.IxKeyValue,
      HTMLStencilElement {}
  var HTMLIxKeyValueElement: {
    prototype: HTMLIxKeyValueElement;
    new (): HTMLIxKeyValueElement;
  };
  interface HTMLIxKeyValueListElement
    extends Components.IxKeyValueList,
      HTMLStencilElement {}
  ...
  interface HTMLIxLayoutAutoElement
    extends Components.IxLayoutAuto,
      HTMLStencilElement {}
  var HTMLIxLayoutAutoElement: {
    prototype: HTMLIxLayoutAutoElement;
    new (): HTMLIxLayoutAutoElement;
  };
  interface HTMLIxLayoutGridElement
    extends Components.IxLayoutGrid,
      HTMLStencilElement {}
  var HTMLIxLayoutGridElement: {
    prototype: HTMLIxLayoutGridElement;
    new (): HTMLIxLayoutGridElement;
  };
  interface HTMLIxLinkButtonElement
    extends Components.IxLinkButton,
      HTMLStencilElement {}
  ...
  interface HTMLIxMenuElement extends Components.IxMenu, HTMLStencilElement {
    addEventListener<K extends keyof HTMLIxMenuElementEventMap>(
      type: K,
      listener: (
        this: HTMLIxMenuElement,
        ev: IxMenuCustomEvent<HTMLIxMenuElementEventMap[K]>
      ) => any,
      options?: boolean | AddEventListenerOptions
    ): void;
    addEventListener<K extends keyof DocumentEventMap>(
    ...
    removeEventListener<K extends keyof HTMLIxMenuElementEventMap>(
      type: K,
      listener: (
        this: HTMLIxMenuElement,
        ev: IxMenuCustomEvent<HTMLIxMenuElementEventMap[K]>
  ...
  interface HTMLIxMenuAboutElement
    extends Components.IxMenuAbout,
      HTMLStencilElement {
    addEventListener<K extends keyof HTMLIxMenuAboutElementEventMap>(
      type: K,
      listener: (
        this: HTMLIxMenuAboutElement,
        ev: IxMenuAboutCustomEvent<HTMLIxMenuAboutElementEventMap[K]>
      ) => any,
      options?: boolean | AddEventListenerOptions
    ): void;
    addEventListener<K extends keyof DocumentEventMap>(
    ...
    removeEventListener<K extends keyof HTMLIxMenuAboutElementEventMap>(
      type: K,
      listener: (
        this: HTMLIxMenuAboutElement,
        ev: IxMenuAboutCustomEvent<HTMLIxMenuAboutElementEventMap[K]>
  ...
  interface HTMLIxMenuAboutItemElement
    extends Components.IxMenuAboutItem,
      HTMLStencilElement {
    addEventListener<K extends keyof HTMLIxMenuAboutItemElementEventMap>(
      type: K,
      listener: (
        this: HTMLIxMenuAboutItemElement,
        ev: IxMenuAboutItemCustomEvent<HTMLIxMenuAboutItemElementEventMap[K]>
      ) => any,
      options?: boolean | AddEventListenerOptions
    ): void;
    addEventListener<K extends keyof DocumentEventMap>(
    ...
    removeEventListener<K extends keyof HTMLIxMenuAboutItemElementEventMap>(
      type: K,
      listener: (
        this: HTMLIxMenuAboutItemElement,
        ev: IxMenuAboutItemCustomEvent<HTMLIxMenuAboutItemElementEventMap[K]>
  ...
  interface HTMLIxMenuAboutNewsElement
    extends Components.IxMenuAboutNews,
      HTMLStencilElement {
    addEventListener<K extends keyof HTMLIxMenuAboutNewsElementEventMap>(
      type: K,
      listener: (
        this: HTMLIxMenuAboutNewsElement,
        ev: IxMenuAboutNewsCustomEvent<HTMLIxMenuAboutNewsElementEventMap[K]>
      ) => any,
      options?: boolean | AddEventListenerOptions
    ): void;
    addEventListener<K extends keyof DocumentEventMap>(
    ...
    removeEventListener<K extends keyof HTMLIxMenuAboutNewsElementEventMap>(
      type: K,
      listener: (
        this: HTMLIxMenuAboutNewsElement,
        ev: IxMenuAboutNewsCustomEvent<HTMLIxMenuAboutNewsElementEventMap[K]>
  ...
  interface HTMLIxMenuAvatarElement
    extends Components.IxMenuAvatar,
      HTMLStencilElement {
    addEventListener<K extends keyof HTMLIxMenuAvatarElementEventMap>(
      type: K,
      listener: (
        this: HTMLIxMenuAvatarElement,
        ev: IxMenuAvatarCustomEvent<HTMLIxMenuAvatarElementEventMap[K]>
      ) => any,
      options?: boolean | AddEventListenerOptions
    ): void;
    addEventListener<K extends keyof DocumentEventMap>(
    ...
    removeEventListener<K extends keyof HTMLIxMenuAvatarElementEventMap>(
      type: K,
      listener: (
        this: HTMLIxMenuAvatarElement,
        ev: IxMenuAvatarCustomEvent<HTMLIxMenuAvatarElementEventMap[K]>
  ...
  interface HTMLIxMenuAvatarItemElement
    extends Components.IxMenuAvatarItem,
      HTMLStencilElement {
    addEventListener<K extends keyof HTMLIxMenuAvatarItemElementEventMap>(
      type: K,
      listener: (
        this: HTMLIxMenuAvatarItemElement,
        ev: IxMenuAvatarItemCustomEvent<HTMLIxMenuAvatarItemElementEventMap[K]>
      ) => any,
      options?: boolean | AddEventListenerOptions
    ): void;
    addEventListener<K extends keyof DocumentEventMap>(
    ...
    removeEventListener<K extends keyof HTMLIxMenuAvatarItemElementEventMap>(
      type: K,
      listener: (
        this: HTMLIxMenuAvatarItemElement,
        ev: IxMenuAvatarItemCustomEvent<HTMLIxMenuAvatarItemElementEventMap[K]>
  ...
  interface HTMLIxMenuCategoryElement
    extends Components.IxMenuCategory,
      HTMLStencilElement {
    addEventListener<K extends keyof HTMLIxMenuCategoryElementEventMap>(
      type: K,
      listener: (
        this: HTMLIxMenuCategoryElement,
        ev: IxMenuCategoryCustomEvent<HTMLIxMenuCategoryElementEventMap[K]>
      ) => any,
      options?: boolean | AddEventListenerOptions
    ): void;
    addEventListener<K extends keyof DocumentEventMap>(
    ...
    removeEventListener<K extends keyof HTMLIxMenuCategoryElementEventMap>(
      type: K,
      listener: (
        this: HTMLIxMenuCategoryElement,
        ev: IxMenuCategoryCustomEvent<HTMLIxMenuCategoryElementEventMap[K]>
  ...
  interface HTMLIxMenuExpandIconElement
    extends Components.IxMenuExpandIcon,
      HTMLStencilElement {}
  var HTMLIxMenuExpandIconElement: {
    prototype: HTMLIxMenuExpandIconElement;
    new (): HTMLIxMenuExpandIconElement;
  };
  interface HTMLIxMenuItemElement
    extends Components.IxMenuItem,
      HTMLStencilElement {}
  ...
  interface HTMLIxMenuSettingsElement
    extends Components.IxMenuSettings,
      HTMLStencilElement {
    addEventListener<K extends keyof HTMLIxMenuSettingsElementEventMap>(
      type: K,
      listener: (
        this: HTMLIxMenuSettingsElement,
        ev: IxMenuSettingsCustomEvent<HTMLIxMenuSettingsElementEventMap[K]>
      ) => any,
      options?: boolean | AddEventListenerOptions
    ): void;
    addEventListener<K extends keyof DocumentEventMap>(
    ...
    removeEventListener<K extends keyof HTMLIxMenuSettingsElementEventMap>(
      type: K,
      listener: (
        this: HTMLIxMenuSettingsElement,
        ev: IxMenuSettingsCustomEvent<HTMLIxMenuSettingsElementEventMap[K]>
  ...
  interface HTMLIxMenuSettingsItemElement
    extends Components.IxMenuSettingsItem,
      HTMLStencilElement {
    addEventListener<K extends keyof HTMLIxMenuSettingsItemElementEventMap>(
      type: K,
      listener: (
        this: HTMLIxMenuSettingsItemElement,
        ev: IxMenuSettingsItemCustomEvent<
          HTMLIxMenuSettingsItemElementEventMap[K]
        >
      ) => any,
      options?: boolean | AddEventListenerOptions
    ): void;
    ...
    removeEventListener<K extends keyof HTMLIxMenuSettingsItemElementEventMap>(
      type: K,
      listener: (
        this: HTMLIxMenuSettingsItemElement,
        ev: IxMenuSettingsItemCustomEvent<
  ...
  interface HTMLIxMessageBarElement
    extends Components.IxMessageBar,
      HTMLStencilElement {
    addEventListener<K extends keyof HTMLIxMessageBarElementEventMap>(
      type: K,
      listener: (
        this: HTMLIxMessageBarElement,
        ev: IxMessageBarCustomEvent<HTMLIxMessageBarElementEventMap[K]>
      ) => any,
      options?: boolean | AddEventListenerOptions
    ): void;
    addEventListener<K extends keyof DocumentEventMap>(
    ...
    removeEventListener<K extends keyof HTMLIxMessageBarElementEventMap>(
      type: K,
      listener: (
        this: HTMLIxMessageBarElement,
        ev: IxMessageBarCustomEvent<HTMLIxMessageBarElementEventMap[K]>
  ...
  interface HTMLIxModalElement extends Components.IxModal, HTMLStencilElement {
    addEventListener<K extends keyof HTMLIxModalElementEventMap>(
      type: K,
      listener: (
        this: HTMLIxModalElement,
        ev: IxModalCustomEvent<HTMLIxModalElementEventMap[K]>
      ) => any,
      options?: boolean | AddEventListenerOptions
    ): void;
    addEventListener<K extends keyof DocumentEventMap>(
    ...
    removeEventListener<K extends keyof HTMLIxModalElementEventMap>(
      type: K,
      listener: (
        this: HTMLIxModalElement,
        ev: IxModalCustomEvent<HTMLIxModalElementEventMap[K]>
  ...
  interface HTMLIxModalContentElement
    extends Components.IxModalContent,
      HTMLStencilElement {}
  var HTMLIxModalContentElement: {
    prototype: HTMLIxModalContentElement;
    new (): HTMLIxModalContentElement;
  };
  interface HTMLIxModalFooterElement
    extends Components.IxModalFooter,
      HTMLStencilElement {}
  ...
  interface HTMLIxModalHeaderElement
    extends Components.IxModalHeader,
      HTMLStencilElement {
    addEventListener<K extends keyof HTMLIxModalHeaderElementEventMap>(
      type: K,
      listener: (
        this: HTMLIxModalHeaderElement,
        ev: IxModalHeaderCustomEvent<HTMLIxModalHeaderElementEventMap[K]>
      ) => any,
      options?: boolean | AddEventListenerOptions
    ): void;
    addEventListener<K extends keyof DocumentEventMap>(
    ...
    removeEventListener<K extends keyof HTMLIxModalHeaderElementEventMap>(
      type: K,
      listener: (
        this: HTMLIxModalHeaderElement,
        ev: IxModalHeaderCustomEvent<HTMLIxModalHeaderElementEventMap[K]>
  ...
  interface HTMLIxModalLoadingElement
    extends Components.IxModalLoading,
      HTMLStencilElement {}
   ...
   * @form-ready
   */
  interface HTMLIxNumberInputElement
    extends Components.IxNumberInput,
      HTMLStencilElement {
    addEventListener<K extends keyof HTMLIxNumberInputElementEventMap>(
      type: K,
      listener: (
        this: HTMLIxNumberInputElement,
        ev: IxNumberInputCustomEvent<HTMLIxNumberInputElementEventMap[K]>
      ) => any,
      options?: boolean | AddEventListenerOptions
    ): void;
    addEventListener<K extends keyof DocumentEventMap>(
    ...
    removeEventListener<K extends keyof HTMLIxNumberInputElementEventMap>(
      type: K,
      listener: (
        this: HTMLIxNumberInputElement,
        ev: IxNumberInputCustomEvent<HTMLIxNumberInputElementEventMap[K]>
  ...
  interface HTMLIxPaginationElement
    extends Components.IxPagination,
      HTMLStencilElement {
    addEventListener<K extends keyof HTMLIxPaginationElementEventMap>(
      type: K,
      listener: (
        this: HTMLIxPaginationElement,
        ev: IxPaginationCustomEvent<HTMLIxPaginationElementEventMap[K]>
      ) => any,
      options?: boolean | AddEventListenerOptions
    ): void;
    addEventListener<K extends keyof DocumentEventMap>(
    ...
    removeEventListener<K extends keyof HTMLIxPaginationElementEventMap>(
      type: K,
      listener: (
        this: HTMLIxPaginationElement,
        ev: IxPaginationCustomEvent<HTMLIxPaginationElementEventMap[K]>
  ...
  interface HTMLIxPaneElement extends Components.IxPane, HTMLStencilElement {
    addEventListener<K extends keyof HTMLIxPaneElementEventMap>(
      type: K,
      listener: (
        this: HTMLIxPaneElement,
        ev: IxPaneCustomEvent<HTMLIxPaneElementEventMap[K]>
      ) => any,
      options?: boolean | AddEventListenerOptions
    ): void;
    addEventListener<K extends keyof DocumentEventMap>(
    ...
    removeEventListener<K extends keyof HTMLIxPaneElementEventMap>(
      type: K,
      listener: (
        this: HTMLIxPaneElement,
        ev: IxPaneCustomEvent<HTMLIxPaneElementEventMap[K]>
  ...
  interface HTMLIxPaneLayoutElement
    extends Components.IxPaneLayout,
      HTMLStencilElement {}
   ...
   * @since 3.2.0
   */
  interface HTMLIxProgressIndicatorElement
  ...
  interface HTMLIxPushCardElement
    extends Components.IxPushCard,
      HTMLStencilElement {}
  ...
  interface HTMLIxRadioElement extends Components.IxRadio, HTMLStencilElement {
    addEventListener<K extends keyof HTMLIxRadioElementEventMap>(
      type: K,
      listener: (
        this: HTMLIxRadioElement,
        ev: IxRadioCustomEvent<HTMLIxRadioElementEventMap[K]>
      ) => any,
      options?: boolean | AddEventListenerOptions
    ): void;
    addEventListener<K extends keyof DocumentEventMap>(
    ...
    removeEventListener<K extends keyof HTMLIxRadioElementEventMap>(
      type: K,
      listener: (
        this: HTMLIxRadioElement,
        ev: IxRadioCustomEvent<HTMLIxRadioElementEventMap[K]>
   ...
   * @form-ready
   */
  interface HTMLIxRadioGroupElement
    extends Components.IxRadioGroup,
      HTMLStencilElement {
    addEventListener<K extends keyof HTMLIxRadioGroupElementEventMap>(
      type: K,
      listener: (
        this: HTMLIxRadioGroupElement,
        ev: IxRadioGroupCustomEvent<HTMLIxRadioGroupElementEventMap[K]>
      ) => any,
      options?: boolean | AddEventListenerOptions
    ): void;
    addEventListener<K extends keyof DocumentEventMap>(
    ...
    removeEventListener<K extends keyof HTMLIxRadioGroupElementEventMap>(
      type: K,
      listener: (
        this: HTMLIxRadioGroupElement,
        ev: IxRadioGroupCustomEvent<HTMLIxRadioGroupElementEventMap[K]>
   ...
   * @form-ready
   */
  interface HTMLIxSelectElement
    extends Components.IxSelect,
      HTMLStencilElement {
    addEventListener<K extends keyof HTMLIxSelectElementEventMap>(
      type: K,
      listener: (
        this: HTMLIxSelectElement,
        ev: IxSelectCustomEvent<HTMLIxSelectElementEventMap[K]>
      ) => any,
      options?: boolean | AddEventListenerOptions
    ): void;
    addEventListener<K extends keyof DocumentEventMap>(
    ...
    removeEventListener<K extends keyof HTMLIxSelectElementEventMap>(
      type: K,
      listener: (
        this: HTMLIxSelectElement,
        ev: IxSelectCustomEvent<HTMLIxSelectElementEventMap[K]>
  ...
  interface HTMLIxSelectItemElement
    extends Components.IxSelectItem,
      HTMLStencilElement {
    addEventListener<K extends keyof HTMLIxSelectItemElementEventMap>(
      type: K,
      listener: (
        this: HTMLIxSelectItemElement,
        ev: IxSelectItemCustomEvent<HTMLIxSelectItemElementEventMap[K]>
      ) => any,
      options?: boolean | AddEventListenerOptions
    ): void;
    addEventListener<K extends keyof DocumentEventMap>(
    ...
    removeEventListener<K extends keyof HTMLIxSelectItemElementEventMap>(
      type: K,
      listener: (
        this: HTMLIxSelectItemElement,
        ev: IxSelectItemCustomEvent<HTMLIxSelectItemElementEventMap[K]>
   ...
   * @form-ready
   */
  interface HTMLIxSliderElement
    extends Components.IxSlider,
      HTMLStencilElement {
    addEventListener<K extends keyof HTMLIxSliderElementEventMap>(
      type: K,
      listener: (
        this: HTMLIxSliderElement,
        ev: IxSliderCustomEvent<HTMLIxSliderElementEventMap[K]>
      ) => any,
      options?: boolean | AddEventListenerOptions
    ): void;
    addEventListener<K extends keyof DocumentEventMap>(
    ...
    removeEventListener<K extends keyof HTMLIxSliderElementEventMap>(
      type: K,
      listener: (
        this: HTMLIxSliderElement,
        ev: IxSliderCustomEvent<HTMLIxSliderElementEventMap[K]>
  ...
  interface HTMLIxSpinnerElement
    extends Components.IxSpinner,
      HTMLStencilElement {}
  ...
  interface HTMLIxSplitButtonElement
    extends Components.IxSplitButton,
      HTMLStencilElement {
    addEventListener<K extends keyof HTMLIxSplitButtonElementEventMap>(
      type: K,
      listener: (
        this: HTMLIxSplitButtonElement,
        ev: IxSplitButtonCustomEvent<HTMLIxSplitButtonElementEventMap[K]>
      ) => any,
      options?: boolean | AddEventListenerOptions
    ): void;
    addEventListener<K extends keyof DocumentEventMap>(
    ...
    removeEventListener<K extends keyof HTMLIxSplitButtonElementEventMap>(
      type: K,
      listener: (
        this: HTMLIxSplitButtonElement,
        ev: IxSplitButtonCustomEvent<HTMLIxSplitButtonElementEventMap[K]>
  ...
  interface HTMLIxTabItemElement
    extends Components.IxTabItem,
      HTMLStencilElement {
    addEventListener<K extends keyof HTMLIxTabItemElementEventMap>(
      type: K,
      listener: (
        this: HTMLIxTabItemElement,
        ev: IxTabItemCustomEvent<HTMLIxTabItemElementEventMap[K]>
      ) => any,
      options?: boolean | AddEventListenerOptions
    ): void;
    addEventListener<K extends keyof DocumentEventMap>(
    ...
    removeEventListener<K extends keyof HTMLIxTabItemElementEventMap>(
      type: K,
      listener: (
        this: HTMLIxTabItemElement,
        ev: IxTabItemCustomEvent<HTMLIxTabItemElementEventMap[K]>
  ...
  interface HTMLIxTabsElement extends Components.IxTabs, HTMLStencilElement {
    addEventListener<K extends keyof HTMLIxTabsElementEventMap>(
      type: K,
      listener: (
        this: HTMLIxTabsElement,
        ev: IxTabsCustomEvent<HTMLIxTabsElementEventMap[K]>
      ) => any,
      options?: boolean | AddEventListenerOptions
    ): void;
    addEventListener<K extends keyof DocumentEventMap>(
    ...
    removeEventListener<K extends keyof HTMLIxTabsElementEventMap>(
      type: K,
      listener: (
        this: HTMLIxTabsElement,
        ev: IxTabsCustomEvent<HTMLIxTabsElementEventMap[K]>
   ...
   * @form-ready
   */
  interface HTMLIxTextareaElement
    extends Components.IxTextarea,
      HTMLStencilElement {
    addEventListener<K extends keyof HTMLIxTextareaElementEventMap>(
      type: K,
      listener: (
        this: HTMLIxTextareaElement,
        ev: IxTextareaCustomEvent<HTMLIxTextareaElementEventMap[K]>
      ) => any,
      options?: boolean | AddEventListenerOptions
    ): void;
    addEventListener<K extends keyof DocumentEventMap>(
    ...
    removeEventListener<K extends keyof HTMLIxTextareaElementEventMap>(
      type: K,
      listener: (
        this: HTMLIxTextareaElement,
        ev: IxTextareaCustomEvent<HTMLIxTextareaElementEventMap[K]>
   ...
   * @form-ready
   */
  interface HTMLIxTimeInputElement
    extends Components.IxTimeInput,
      HTMLStencilElement {
    addEventListener<K extends keyof HTMLIxTimeInputElementEventMap>(
      type: K,
      listener: (
        this: HTMLIxTimeInputElement,
        ev: IxTimeInputCustomEvent<HTMLIxTimeInputElementEventMap[K]>
      ) => any,
      options?: boolean | AddEventListenerOptions
    ): void;
    addEventListener<K extends keyof DocumentEventMap>(
    ...
    removeEventListener<K extends keyof HTMLIxTimeInputElementEventMap>(
      type: K,
      listener: (
        this: HTMLIxTimeInputElement,
        ev: IxTimeInputCustomEvent<HTMLIxTimeInputElementEventMap[K]>
  ...
  interface HTMLIxTimePickerElement
    extends Components.IxTimePicker,
      HTMLStencilElement {
    addEventListener<K extends keyof HTMLIxTimePickerElementEventMap>(
      type: K,
      listener: (
        this: HTMLIxTimePickerElement,
        ev: IxTimePickerCustomEvent<HTMLIxTimePickerElementEventMap[K]>
      ) => any,
      options?: boolean | AddEventListenerOptions
    ): void;
    addEventListener<K extends keyof DocumentEventMap>(
    ...
    removeEventListener<K extends keyof HTMLIxTimePickerElementEventMap>(
      type: K,
      listener: (
        this: HTMLIxTimePickerElement,
        ev: IxTimePickerCustomEvent<HTMLIxTimePickerElementEventMap[K]>
  ...
  interface HTMLIxToastElement extends Components.IxToast, HTMLStencilElement {
    addEventListener<K extends keyof HTMLIxToastElementEventMap>(
      type: K,
      listener: (
        this: HTMLIxToastElement,
        ev: IxToastCustomEvent<HTMLIxToastElementEventMap[K]>
      ) => any,
      options?: boolean | AddEventListenerOptions
    ): void;
    addEventListener<K extends keyof DocumentEventMap>(
    ...
    removeEventListener<K extends keyof HTMLIxToastElementEventMap>(
      type: K,
      listener: (
        this: HTMLIxToastElement,
        ev: IxToastCustomEvent<HTMLIxToastElementEventMap[K]>
  ...
  interface HTMLIxToastContainerElement
    extends Components.IxToastContainer,
      HTMLStencilElement {}
   ...
   * @form-ready
   */
  interface HTMLIxToggleElement
    extends Components.IxToggle,
      HTMLStencilElement {
    addEventListener<K extends keyof HTMLIxToggleElementEventMap>(
      type: K,
      listener: (
        this: HTMLIxToggleElement,
        ev: IxToggleCustomEvent<HTMLIxToggleElementEventMap[K]>
      ) => any,
      options?: boolean | AddEventListenerOptions
    ): void;
    addEventListener<K extends keyof DocumentEventMap>(
    ...
    removeEventListener<K extends keyof HTMLIxToggleElementEventMap>(
      type: K,
      listener: (
        this: HTMLIxToggleElement,
        ev: IxToggleCustomEvent<HTMLIxToggleElementEventMap[K]>
  ...
  interface HTMLIxToggleButtonElement
    extends Components.IxToggleButton,
      HTMLStencilElement {
    addEventListener<K extends keyof HTMLIxToggleButtonElementEventMap>(
      type: K,
      listener: (
        this: HTMLIxToggleButtonElement,
        ev: IxToggleButtonCustomEvent<HTMLIxToggleButtonElementEventMap[K]>
      ) => any,
      options?: boolean | AddEventListenerOptions
    ): void;
    addEventListener<K extends keyof DocumentEventMap>(
    ...
    removeEventListener<K extends keyof HTMLIxToggleButtonElementEventMap>(
      type: K,
      listener: (
        this: HTMLIxToggleButtonElement,
        ev: IxToggleButtonCustomEvent<HTMLIxToggleButtonElementEventMap[K]>
  ...
  interface HTMLIxTooltipElement
    extends Components.IxTooltip,
      HTMLStencilElement {}
  ...
  interface HTMLIxTreeElement extends Components.IxTree, HTMLStencilElement {
    addEventListener<K extends keyof HTMLIxTreeElementEventMap>(
      type: K,
      listener: (
        this: HTMLIxTreeElement,
        ev: IxTreeCustomEvent<HTMLIxTreeElementEventMap[K]>
      ) => any,
      options?: boolean | AddEventListenerOptions
    ): void;
    addEventListener<K extends keyof DocumentEventMap>(
    ...
    removeEventListener<K extends keyof HTMLIxTreeElementEventMap>(
      type: K,
      listener: (
        this: HTMLIxTreeElement,
        ev: IxTreeCustomEvent<HTMLIxTreeElementEventMap[K]>
  ...
  interface HTMLIxTreeItemElement
    extends Components.IxTreeItem,
      HTMLStencilElement {
    addEventListener<K extends keyof HTMLIxTreeItemElementEventMap>(
      type: K,
      listener: (
        this: HTMLIxTreeItemElement,
        ev: IxTreeItemCustomEvent<HTMLIxTreeItemElementEventMap[K]>
      ) => any,
      options?: boolean | AddEventListenerOptions
    ): void;
    addEventListener<K extends keyof DocumentEventMap>(
    ...
    removeEventListener<K extends keyof HTMLIxTreeItemElementEventMap>(
      type: K,
      listener: (
        this: HTMLIxTreeItemElement,
        ev: IxTreeItemCustomEvent<HTMLIxTreeItemElementEventMap[K]>
  ...
  interface HTMLIxTypographyElement
    extends Components.IxTypography,
      HTMLStencilElement {}
  ...
  interface HTMLIxUploadElement
    extends Components.IxUpload,
      HTMLStencilElement {
    addEventListener<K extends keyof HTMLIxUploadElementEventMap>(
      type: K,
      listener: (
        this: HTMLIxUploadElement,
        ev: IxUploadCustomEvent<HTMLIxUploadElementEventMap[K]>
      ) => any,
      options?: boolean | AddEventListenerOptions
    ): void;
    addEventListener<K extends keyof DocumentEventMap>(
    ...
    removeEventListener<K extends keyof HTMLIxUploadElementEventMap>(
      type: K,
      listener: (
        this: HTMLIxUploadElement,
        ev: IxUploadCustomEvent<HTMLIxUploadElementEventMap[K]>
   ...
   * Not maintained anymore.
   */
  interface HTMLIxValidationTooltipElement
  ...
  interface HTMLIxWorkflowStepElement
    extends Components.IxWorkflowStep,
      HTMLStencilElement {
    addEventListener<K extends keyof HTMLIxWorkflowStepElementEventMap>(
      type: K,
      listener: (
        this: HTMLIxWorkflowStepElement,
        ev: IxWorkflowStepCustomEvent<HTMLIxWorkflowStepElementEventMap[K]>
      ) => any,
      options?: boolean | AddEventListenerOptions
    ): void;
    addEventListener<K extends keyof DocumentEventMap>(
    ...
    removeEventListener<K extends keyof HTMLIxWorkflowStepElementEventMap>(
      type: K,
      listener: (
        this: HTMLIxWorkflowStepElement,
        ev: IxWorkflowStepCustomEvent<HTMLIxWorkflowStepElementEventMap[K]>
  ...
  interface HTMLIxWorkflowStepsElement
    extends Components.IxWorkflowSteps,
      HTMLStencilElement {
    addEventListener<K extends keyof HTMLIxWorkflowStepsElementEventMap>(
      type: K,
      listener: (
        this: HTMLIxWorkflowStepsElement,
        ev: IxWorkflowStepsCustomEvent<HTMLIxWorkflowStepsElementEventMap[K]>
      ) => any,
      options?: boolean | AddEventListenerOptions
    ): void;
    addEventListener<K extends keyof DocumentEventMap>(
    ...
    removeEventListener<K extends keyof HTMLIxWorkflowStepsElementEventMap>(
      type: K,
      listener: (
        this: HTMLIxWorkflowStepsElement,
        ev: IxWorkflowStepsCustomEvent<HTMLIxWorkflowStepsElementEventMap[K]>
...
declare namespace LocalJSX {
  ...
  interface IxBreadcrumb {
     ...
     */
    onNextClick?: (
      event: IxBreadcrumbCustomEvent<{ event: UIEvent; item: string }>
    ) => void;
    /**
     * Ghost breadcrumbs will not show solid backgrounds on individual crumbs unless there is a mouse event (e.g. hover)
     * @default false
  ...
  interface IxCardAccordion {
    ...
    collapse?: boolean;
    onAccordionExpand?: (
      event: IxCardAccordionCustomEvent<CardAccordionExpandChangeEvent>
    ) => void;
    /**
     * Show accordion with different color variants
     * @since 4.0.0
  ...
  interface IxDateDropdown {
     ...
     */
    onDateRangeChange?: (
      event: IxDateDropdownCustomEvent<DateRangeChangeEvent>
    ) => void;
    /**
     * Shows week numbers displayed on the left side of the date picker
     * @since 3.0.0
  ...
  interface IxDateInput {
    ...
    onValidityStateChange?: (
      event: IxDateInputCustomEvent<DateInputValidityState>
    ) => void;
    /**
     * Input change event.
     */
  ...
  interface IxDatePicker {
     ...
     */
    onDateRangeChange?: (
      event: IxDatePickerCustomEvent<DateChangeEvent>
    ) => void;
    /**
  ...
  interface IxDropdownItem {
    ...
    label?: string;
    onItemClick?: (
      event: IxDropdownItemCustomEvent<HTMLIxDropdownItemElement>
    ) => void;
    /**
     * @default false
     */
  ...
  interface IxGroupItem {
     ...
     */
    onSelectedChanged?: (
      event: IxGroupItemCustomEvent<HTMLIxGroupItemElement>
    ) => void;
    /**
     * Group item secondary text
     */
  ...
  interface IxMenuAboutItem {
     ...
     */
    onLabelChange?: (
      event: IxMenuAboutItemCustomEvent<CustomLabelChangeEvent>
    ) => void;
  }
  interface IxMenuAboutNews {
    /**
  ...
  interface IxMenuSettingsItem {
     ...
     */
    onLabelChange?: (
      event: IxMenuSettingsItemCustomEvent<CustomLabelChangeEvent>
    ) => void;
  }
  interface IxMessageBar {
    /**
  ...
  interface IxNumberInput {
     ...
     */
    onValidityStateChange?: (
      event: IxNumberInputCustomEvent<ValidityState>
    ) => void;
    /**
  ...
  interface IxPane {
     ...
     */
    onBorderlessChanged?: (
      event: IxPaneCustomEvent<BorderlessChangedEvent>
    ) => void;
    /**
     * This event is triggered when the pane either expands or contracts
     */
    onExpandedChanged?: (
      event: IxPaneCustomEvent<ExpandedChangedEvent>
    ) => void;
    onHideOnCollapseChanged?: (
      event: IxPaneCustomEvent<HideOnCollapseChangedEvent>
    ) => void;
  ...
  interface IxTextarea {
     ...
     */
    onValidityStateChange?: (
      event: IxTextareaCustomEvent<ValidityState>
    ) => void;
    /**
  ...
  interface IxTimeInput {
     ...
     */
    onValidityStateChange?: (
      event: IxTimeInputCustomEvent<TimeInputValidityState>
    ) => void;
    /**
     * Input change event.
     */
  ...
  interface IxTree {
     ...
     */
    onNodeToggled?: (
      event: IxTreeCustomEvent<{ id: string; isExpanded: boolean }>
    ) => void;
    /**
     * Render function of tree items
     */
  ...
  interface IxWorkflowStep {
    ...
    disabled?: boolean;
    onSelectedChanged?: (
      event: IxWorkflowStepCustomEvent<HTMLIxWorkflowStepElement>
    ) => void;
    /**
     * Activate navigation click
     * @default 'undefined'
  ...
  interface IntrinsicElements {
    'ix-action-card': Omit<IxActionCard, keyof IxActionCardAttributes> & {
      [K in keyof IxActionCard &
        keyof IxActionCardAttributes]?: IxActionCard[K];
    } & {
      [K in keyof IxActionCard &
        keyof IxActionCardAttributes as `attr:${K}`]?: IxActionCardAttributes[K];
    } & {
      [K in keyof IxActionCard &
        keyof IxActionCardAttributes as `prop:${K}`]?: IxActionCard[K];
    };
    'ix-application': Omit<IxApplication, keyof IxApplicationAttributes> & {
      [K in keyof IxApplication &
        keyof IxApplicationAttributes]?: IxApplication[K];
    } & {
      [K in keyof IxApplication &
        keyof IxApplicationAttributes as `attr:${K}`]?: IxApplicationAttributes[K];
    } & {
      [K in keyof IxApplication &
        keyof IxApplicationAttributes as `prop:${K}`]?: IxApplication[K];
    };
    'ix-application-header': Omit<
      IxApplicationHeader,
      keyof IxApplicationHeaderAttributes
    > & {
      [K in keyof IxApplicationHeader &
        keyof IxApplicationHeaderAttributes]?: IxApplicationHeader[K];
    } & {
      [K in keyof IxApplicationHeader &
        keyof IxApplicationHeaderAttributes as `attr:${K}`]?: IxApplicationHeaderAttributes[K];
    } & {
      [K in keyof IxApplicationHeader &
        keyof IxApplicationHeaderAttributes as `prop:${K}`]?: IxApplicationHeader[K];
    };
    'ix-application-sidebar': IxApplicationSidebar;
    'ix-application-switch-modal': IxApplicationSwitchModal;
    'ix-avatar': Omit<IxAvatar, keyof IxAvatarAttributes> & {
      [K in keyof IxAvatar & keyof IxAvatarAttributes]?: IxAvatar[K];
    } & {
      [K in keyof IxAvatar &
        keyof IxAvatarAttributes as `attr:${K}`]?: IxAvatarAttributes[K];
    } & {
      [K in keyof IxAvatar &
        keyof IxAvatarAttributes as `prop:${K}`]?: IxAvatar[K];
    };
    'ix-blind': Omit<IxBlind, keyof IxBlindAttributes> & {
      [K in keyof IxBlind & keyof IxBlindAttributes]?: IxBlind[K];
    } & {
      [K in keyof IxBlind &
        keyof IxBlindAttributes as `attr:${K}`]?: IxBlindAttributes[K];
    } & {
      [K in keyof IxBlind &
        keyof IxBlindAttributes as `prop:${K}`]?: IxBlind[K];
    };
    'ix-breadcrumb': Omit<IxBreadcrumb, keyof IxBreadcrumbAttributes> & {
      [K in keyof IxBreadcrumb &
        keyof IxBreadcrumbAttributes]?: IxBreadcrumb[K];
    } & {
      [K in keyof IxBreadcrumb &
        keyof IxBreadcrumbAttributes as `attr:${K}`]?: IxBreadcrumbAttributes[K];
    } & {
      [K in keyof IxBreadcrumb &
        keyof IxBreadcrumbAttributes as `prop:${K}`]?: IxBreadcrumb[K];
    };
    'ix-breadcrumb-item': Omit<
      IxBreadcrumbItem,
      keyof IxBreadcrumbItemAttributes
    > & {
      [K in keyof IxBreadcrumbItem &
        keyof IxBreadcrumbItemAttributes]?: IxBreadcrumbItem[K];
    } & {
      [K in keyof IxBreadcrumbItem &
        keyof IxBreadcrumbItemAttributes as `attr:${K}`]?: IxBreadcrumbItemAttributes[K];
    } & {
      [K in keyof IxBreadcrumbItem &
        keyof IxBreadcrumbItemAttributes as `prop:${K}`]?: IxBreadcrumbItem[K];
    };
    'ix-button': Omit<IxButton, keyof IxButtonAttributes> & {
      [K in keyof IxButton & keyof IxButtonAttributes]?: IxButton[K];
    } & {
      [K in keyof IxButton &
        keyof IxButtonAttributes as `attr:${K}`]?: IxButtonAttributes[K];
    } & {
      [K in keyof IxButton &
        keyof IxButtonAttributes as `prop:${K}`]?: IxButton[K];
    };
    'ix-card': Omit<IxCard, keyof IxCardAttributes> & {
      [K in keyof IxCard & keyof IxCardAttributes]?: IxCard[K];
    } & {
      [K in keyof IxCard &
        keyof IxCardAttributes as `attr:${K}`]?: IxCardAttributes[K];
    } & {
      [K in keyof IxCard & keyof IxCardAttributes as `prop:${K}`]?: IxCard[K];
    };
    'ix-card-accordion': Omit<
      IxCardAccordion,
      keyof IxCardAccordionAttributes
    > & {
      [K in keyof IxCardAccordion &
        keyof IxCardAccordionAttributes]?: IxCardAccordion[K];
    } & {
      [K in keyof IxCardAccordion &
        keyof IxCardAccordionAttributes as `attr:${K}`]?: IxCardAccordionAttributes[K];
    } & {
      [K in keyof IxCardAccordion &
        keyof IxCardAccordionAttributes as `prop:${K}`]?: IxCardAccordion[K];
    };
    'ix-card-content': IxCardContent;
    'ix-card-list': Omit<IxCardList, keyof IxCardListAttributes> & {
      [K in keyof IxCardList & keyof IxCardListAttributes]?: IxCardList[K];
    } & {
      [K in keyof IxCardList &
        keyof IxCardListAttributes as `attr:${K}`]?: IxCardListAttributes[K];
    } & {
      [K in keyof IxCardList &
        keyof IxCardListAttributes as `prop:${K}`]?: IxCardList[K];
    };
    'ix-card-title': IxCardTitle;
    'ix-category-filter': Omit<
      IxCategoryFilter,
      keyof IxCategoryFilterAttributes
    > & {
      [K in keyof IxCategoryFilter &
        keyof IxCategoryFilterAttributes]?: IxCategoryFilter[K];
    } & {
      [K in keyof IxCategoryFilter &
        keyof IxCategoryFilterAttributes as `attr:${K}`]?: IxCategoryFilterAttributes[K];
    } & {
      [K in keyof IxCategoryFilter &
        keyof IxCategoryFilterAttributes as `prop:${K}`]?: IxCategoryFilter[K];
    };
    'ix-checkbox': Omit<IxCheckbox, keyof IxCheckboxAttributes> & {
      [K in keyof IxCheckbox & keyof IxCheckboxAttributes]?: IxCheckbox[K];
    } & {
      [K in keyof IxCheckbox &
        keyof IxCheckboxAttributes as `attr:${K}`]?: IxCheckboxAttributes[K];
    } & {
      [K in keyof IxCheckbox &
        keyof IxCheckboxAttributes as `prop:${K}`]?: IxCheckbox[K];
    };
    'ix-checkbox-group': Omit<
      IxCheckboxGroup,
      keyof IxCheckboxGroupAttributes
    > & {
      [K in keyof IxCheckboxGroup &
        keyof IxCheckboxGroupAttributes]?: IxCheckboxGroup[K];
    } & {
      [K in keyof IxCheckboxGroup &
        keyof IxCheckboxGroupAttributes as `attr:${K}`]?: IxCheckboxGroupAttributes[K];
    } & {
      [K in keyof IxCheckboxGroup &
        keyof IxCheckboxGroupAttributes as `prop:${K}`]?: IxCheckboxGroup[K];
    };
    'ix-chip': Omit<IxChip, keyof IxChipAttributes> & {
      [K in keyof IxChip & keyof IxChipAttributes]?: IxChip[K];
    } & {
      [K in keyof IxChip &
        keyof IxChipAttributes as `attr:${K}`]?: IxChipAttributes[K];
    } & {
      [K in keyof IxChip & keyof IxChipAttributes as `prop:${K}`]?: IxChip[K];
    };
    'ix-col': Omit<IxCol, keyof IxColAttributes> & {
      [K in keyof IxCol & keyof IxColAttributes]?: IxCol[K];
    } & {
      [K in keyof IxCol &
        keyof IxColAttributes as `attr:${K}`]?: IxColAttributes[K];
    } & {
      [K in keyof IxCol & keyof IxColAttributes as `prop:${K}`]?: IxCol[K];
    };
    'ix-content': IxContent;
    'ix-content-header': Omit<
      IxContentHeader,
      keyof IxContentHeaderAttributes
    > & {
      [K in keyof IxContentHeader &
        keyof IxContentHeaderAttributes]?: IxContentHeader[K];
    } & {
      [K in keyof IxContentHeader &
        keyof IxContentHeaderAttributes as `attr:${K}`]?: IxContentHeaderAttributes[K];
    } & {
      [K in keyof IxContentHeader &
        keyof IxContentHeaderAttributes as `prop:${K}`]?: IxContentHeader[K];
    };
    'ix-css-grid': IxCssGrid;
    'ix-css-grid-item': Omit<IxCssGridItem, keyof IxCssGridItemAttributes> & {
      [K in keyof IxCssGridItem &
        keyof IxCssGridItemAttributes]?: IxCssGridItem[K];
    } & {
      [K in keyof IxCssGridItem &
        keyof IxCssGridItemAttributes as `attr:${K}`]?: IxCssGridItemAttributes[K];
    } & {
      [K in keyof IxCssGridItem &
        keyof IxCssGridItemAttributes as `prop:${K}`]?: IxCssGridItem[K];
    } & OneOf<'itemName', IxCssGridItem['itemName']>;
    'ix-custom-field': Omit<IxCustomField, keyof IxCustomFieldAttributes> & {
      [K in keyof IxCustomField &
        keyof IxCustomFieldAttributes]?: IxCustomField[K];
    } & {
      [K in keyof IxCustomField &
        keyof IxCustomFieldAttributes as `attr:${K}`]?: IxCustomFieldAttributes[K];
    } & {
      [K in keyof IxCustomField &
        keyof IxCustomFieldAttributes as `prop:${K}`]?: IxCustomField[K];
    };
    'ix-date-dropdown': Omit<IxDateDropdown, keyof IxDateDropdownAttributes> & {
      [K in keyof IxDateDropdown &
        keyof IxDateDropdownAttributes]?: IxDateDropdown[K];
    } & {
      [K in keyof IxDateDropdown &
        keyof IxDateDropdownAttributes as `attr:${K}`]?: IxDateDropdownAttributes[K];
    } & {
      [K in keyof IxDateDropdown &
        keyof IxDateDropdownAttributes as `prop:${K}`]?: IxDateDropdown[K];
    };
    'ix-date-input': Omit<IxDateInput, keyof IxDateInputAttributes> & {
      [K in keyof IxDateInput & keyof IxDateInputAttributes]?: IxDateInput[K];
    } & {
      [K in keyof IxDateInput &
        keyof IxDateInputAttributes as `attr:${K}`]?: IxDateInputAttributes[K];
    } & {
      [K in keyof IxDateInput &
        keyof IxDateInputAttributes as `prop:${K}`]?: IxDateInput[K];
    };
    'ix-date-picker': Omit<IxDatePicker, keyof IxDatePickerAttributes> & {
      [K in keyof IxDatePicker &
        keyof IxDatePickerAttributes]?: IxDatePicker[K];
    } & {
      [K in keyof IxDatePicker &
        keyof IxDatePickerAttributes as `attr:${K}`]?: IxDatePickerAttributes[K];
    } & {
      [K in keyof IxDatePicker &
        keyof IxDatePickerAttributes as `prop:${K}`]?: IxDatePicker[K];
    };
    'ix-date-time-card': Omit<
      IxDateTimeCard,
      keyof IxDateTimeCardAttributes
    > & {
      [K in keyof IxDateTimeCard &
        keyof IxDateTimeCardAttributes]?: IxDateTimeCard[K];
    } & {
      [K in keyof IxDateTimeCard &
        keyof IxDateTimeCardAttributes as `attr:${K}`]?: IxDateTimeCardAttributes[K];
    } & {
      [K in keyof IxDateTimeCard &
        keyof IxDateTimeCardAttributes as `prop:${K}`]?: IxDateTimeCard[K];
    };
    'ix-datetime-picker': Omit<
      IxDatetimePicker,
      keyof IxDatetimePickerAttributes
    > & {
      [K in keyof IxDatetimePicker &
        keyof IxDatetimePickerAttributes]?: IxDatetimePicker[K];
    } & {
      [K in keyof IxDatetimePicker &
        keyof IxDatetimePickerAttributes as `attr:${K}`]?: IxDatetimePickerAttributes[K];
    } & {
      [K in keyof IxDatetimePicker &
        keyof IxDatetimePickerAttributes as `prop:${K}`]?: IxDatetimePicker[K];
    };
    'ix-divider': IxDivider;
    'ix-drawer': Omit<IxDrawer, keyof IxDrawerAttributes> & {
      [K in keyof IxDrawer & keyof IxDrawerAttributes]?: IxDrawer[K];
    } & {
      [K in keyof IxDrawer &
        keyof IxDrawerAttributes as `attr:${K}`]?: IxDrawerAttributes[K];
    } & {
      [K in keyof IxDrawer &
        keyof IxDrawerAttributes as `prop:${K}`]?: IxDrawer[K];
    };
    'ix-dropdown': Omit<IxDropdown, keyof IxDropdownAttributes> & {
      [K in keyof IxDropdown & keyof IxDropdownAttributes]?: IxDropdown[K];
    } & {
      [K in keyof IxDropdown &
        keyof IxDropdownAttributes as `attr:${K}`]?: IxDropdownAttributes[K];
    } & {
      [K in keyof IxDropdown &
        keyof IxDropdownAttributes as `prop:${K}`]?: IxDropdown[K];
    };
    'ix-dropdown-button': Omit<
      IxDropdownButton,
      keyof IxDropdownButtonAttributes
    > & {
      [K in keyof IxDropdownButton &
        keyof IxDropdownButtonAttributes]?: IxDropdownButton[K];
    } & {
      [K in keyof IxDropdownButton &
        keyof IxDropdownButtonAttributes as `attr:${K}`]?: IxDropdownButtonAttributes[K];
    } & {
      [K in keyof IxDropdownButton &
        keyof IxDropdownButtonAttributes as `prop:${K}`]?: IxDropdownButton[K];
    };
    'ix-dropdown-header': Omit<
      IxDropdownHeader,
      keyof IxDropdownHeaderAttributes
    > & {
      [K in keyof IxDropdownHeader &
        keyof IxDropdownHeaderAttributes]?: IxDropdownHeader[K];
    } & {
      [K in keyof IxDropdownHeader &
        keyof IxDropdownHeaderAttributes as `attr:${K}`]?: IxDropdownHeaderAttributes[K];
    } & {
      [K in keyof IxDropdownHeader &
        keyof IxDropdownHeaderAttributes as `prop:${K}`]?: IxDropdownHeader[K];
    };
    'ix-dropdown-item': Omit<IxDropdownItem, keyof IxDropdownItemAttributes> & {
      [K in keyof IxDropdownItem &
        keyof IxDropdownItemAttributes]?: IxDropdownItem[K];
    } & {
      [K in keyof IxDropdownItem &
        keyof IxDropdownItemAttributes as `attr:${K}`]?: IxDropdownItemAttributes[K];
    } & {
      [K in keyof IxDropdownItem &
        keyof IxDropdownItemAttributes as `prop:${K}`]?: IxDropdownItem[K];
    };
    'ix-dropdown-quick-actions': IxDropdownQuickActions;
    'ix-empty-state': Omit<IxEmptyState, keyof IxEmptyStateAttributes> & {
      [K in keyof IxEmptyState &
        keyof IxEmptyStateAttributes]?: IxEmptyState[K];
    } & {
      [K in keyof IxEmptyState &
        keyof IxEmptyStateAttributes as `attr:${K}`]?: IxEmptyStateAttributes[K];
    } & {
      [K in keyof IxEmptyState &
        keyof IxEmptyStateAttributes as `prop:${K}`]?: IxEmptyState[K];
    } & OneOf<'header', IxEmptyState['header']>;
    'ix-event-list': Omit<IxEventList, keyof IxEventListAttributes> & {
      [K in keyof IxEventList & keyof IxEventListAttributes]?: IxEventList[K];
    } & {
      [K in keyof IxEventList &
        keyof IxEventListAttributes as `attr:${K}`]?: IxEventListAttributes[K];
    } & {
      [K in keyof IxEventList &
        keyof IxEventListAttributes as `prop:${K}`]?: IxEventList[K];
    };
    'ix-event-list-item': Omit<
      IxEventListItem,
      keyof IxEventListItemAttributes
    > & {
      [K in keyof IxEventListItem &
        keyof IxEventListItemAttributes]?: IxEventListItem[K];
    } & {
      [K in keyof IxEventListItem &
        keyof IxEventListItemAttributes as `attr:${K}`]?: IxEventListItemAttributes[K];
    } & {
      [K in keyof IxEventListItem &
        keyof IxEventListItemAttributes as `prop:${K}`]?: IxEventListItem[K];
    };
    'ix-expanding-search': Omit<
      IxExpandingSearch,
      keyof IxExpandingSearchAttributes
    > & {
      [K in keyof IxExpandingSearch &
        keyof IxExpandingSearchAttributes]?: IxExpandingSearch[K];
    } & {
      [K in keyof IxExpandingSearch &
        keyof IxExpandingSearchAttributes as `attr:${K}`]?: IxExpandingSearchAttributes[K];
    } & {
      [K in keyof IxExpandingSearch &
        keyof IxExpandingSearchAttributes as `prop:${K}`]?: IxExpandingSearch[K];
    };
    'ix-field-label': Omit<IxFieldLabel, keyof IxFieldLabelAttributes> & {
      [K in keyof IxFieldLabel &
        keyof IxFieldLabelAttributes]?: IxFieldLabel[K];
    } & {
      [K in keyof IxFieldLabel &
        keyof IxFieldLabelAttributes as `attr:${K}`]?: IxFieldLabelAttributes[K];
    } & {
      [K in keyof IxFieldLabel &
        keyof IxFieldLabelAttributes as `prop:${K}`]?: IxFieldLabel[K];
    };
    'ix-field-wrapper': Omit<IxFieldWrapper, keyof IxFieldWrapperAttributes> & {
      [K in keyof IxFieldWrapper &
        keyof IxFieldWrapperAttributes]?: IxFieldWrapper[K];
    } & {
      [K in keyof IxFieldWrapper &
        keyof IxFieldWrapperAttributes as `attr:${K}`]?: IxFieldWrapperAttributes[K];
    } & {
      [K in keyof IxFieldWrapper &
        keyof IxFieldWrapperAttributes as `prop:${K}`]?: IxFieldWrapper[K];
    };
    'ix-filter-chip': Omit<IxFilterChip, keyof IxFilterChipAttributes> & {
      [K in keyof IxFilterChip &
        keyof IxFilterChipAttributes]?: IxFilterChip[K];
    } & {
      [K in keyof IxFilterChip &
        keyof IxFilterChipAttributes as `attr:${K}`]?: IxFilterChipAttributes[K];
    } & {
      [K in keyof IxFilterChip &
        keyof IxFilterChipAttributes as `prop:${K}`]?: IxFilterChip[K];
    };
    'ix-flip-tile': Omit<IxFlipTile, keyof IxFlipTileAttributes> & {
      [K in keyof IxFlipTile & keyof IxFlipTileAttributes]?: IxFlipTile[K];
    } & {
      [K in keyof IxFlipTile &
        keyof IxFlipTileAttributes as `attr:${K}`]?: IxFlipTileAttributes[K];
    } & {
      [K in keyof IxFlipTile &
        keyof IxFlipTileAttributes as `prop:${K}`]?: IxFlipTile[K];
    };
    'ix-flip-tile-content': Omit<
      IxFlipTileContent,
      keyof IxFlipTileContentAttributes
    > & {
      [K in keyof IxFlipTileContent &
        keyof IxFlipTileContentAttributes]?: IxFlipTileContent[K];
    } & {
      [K in keyof IxFlipTileContent &
        keyof IxFlipTileContentAttributes as `attr:${K}`]?: IxFlipTileContentAttributes[K];
    } & {
      [K in keyof IxFlipTileContent &
        keyof IxFlipTileContentAttributes as `prop:${K}`]?: IxFlipTileContent[K];
    };
    'ix-group': Omit<IxGroup, keyof IxGroupAttributes> & {
      [K in keyof IxGroup & keyof IxGroupAttributes]?: IxGroup[K];
    } & {
      [K in keyof IxGroup &
        keyof IxGroupAttributes as `attr:${K}`]?: IxGroupAttributes[K];
    } & {
      [K in keyof IxGroup &
        keyof IxGroupAttributes as `prop:${K}`]?: IxGroup[K];
    };
    'ix-group-context-menu': IxGroupContextMenu;
    'ix-group-item': Omit<IxGroupItem, keyof IxGroupItemAttributes> & {
      [K in keyof IxGroupItem & keyof IxGroupItemAttributes]?: IxGroupItem[K];
    } & {
      [K in keyof IxGroupItem &
        keyof IxGroupItemAttributes as `attr:${K}`]?: IxGroupItemAttributes[K];
    } & {
      [K in keyof IxGroupItem &
        keyof IxGroupItemAttributes as `prop:${K}`]?: IxGroupItem[K];
    };
    'ix-helper-text': Omit<IxHelperText, keyof IxHelperTextAttributes> & {
      [K in keyof IxHelperText &
        keyof IxHelperTextAttributes]?: IxHelperText[K];
    } & {
      [K in keyof IxHelperText &
        keyof IxHelperTextAttributes as `attr:${K}`]?: IxHelperTextAttributes[K];
    } & {
      [K in keyof IxHelperText &
        keyof IxHelperTextAttributes as `prop:${K}`]?: IxHelperText[K];
    };
    'ix-icon-button': Omit<IxIconButton, keyof IxIconButtonAttributes> & {
      [K in keyof IxIconButton &
        keyof IxIconButtonAttributes]?: IxIconButton[K];
    } & {
      [K in keyof IxIconButton &
        keyof IxIconButtonAttributes as `attr:${K}`]?: IxIconButtonAttributes[K];
    } & {
      [K in keyof IxIconButton &
        keyof IxIconButtonAttributes as `prop:${K}`]?: IxIconButton[K];
    };
    'ix-icon-toggle-button': Omit<
      IxIconToggleButton,
      keyof IxIconToggleButtonAttributes
    > & {
      [K in keyof IxIconToggleButton &
        keyof IxIconToggleButtonAttributes]?: IxIconToggleButton[K];
    } & {
      [K in keyof IxIconToggleButton &
        keyof IxIconToggleButtonAttributes as `attr:${K}`]?: IxIconToggleButtonAttributes[K];
    } & {
      [K in keyof IxIconToggleButton &
        keyof IxIconToggleButtonAttributes as `prop:${K}`]?: IxIconToggleButton[K];
    };
    'ix-input': Omit<IxInput, keyof IxInputAttributes> & {
      [K in keyof IxInput & keyof IxInputAttributes]?: IxInput[K];
    } & {
      [K in keyof IxInput &
        keyof IxInputAttributes as `attr:${K}`]?: IxInputAttributes[K];
    } & {
      [K in keyof IxInput &
        keyof IxInputAttributes as `prop:${K}`]?: IxInput[K];
    };
    'ix-input-group': IxInputGroup;
    'ix-key-value': Omit<IxKeyValue, keyof IxKeyValueAttributes> & {
      [K in keyof IxKeyValue & keyof IxKeyValueAttributes]?: IxKeyValue[K];
    } & {
      [K in keyof IxKeyValue &
        keyof IxKeyValueAttributes as `attr:${K}`]?: IxKeyValueAttributes[K];
    } & {
      [K in keyof IxKeyValue &
        keyof IxKeyValueAttributes as `prop:${K}`]?: IxKeyValue[K];
    } & OneOf<'label', IxKeyValue['label']>;
    'ix-key-value-list': Omit<
      IxKeyValueList,
      keyof IxKeyValueListAttributes
    > & {
      [K in keyof IxKeyValueList &
        keyof IxKeyValueListAttributes]?: IxKeyValueList[K];
    } & {
      [K in keyof IxKeyValueList &
        keyof IxKeyValueListAttributes as `attr:${K}`]?: IxKeyValueListAttributes[K];
    } & {
      [K in keyof IxKeyValueList &
        keyof IxKeyValueListAttributes as `prop:${K}`]?: IxKeyValueList[K];
    };
    'ix-kpi': Omit<IxKpi, keyof IxKpiAttributes> & {
      [K in keyof IxKpi & keyof IxKpiAttributes]?: IxKpi[K];
    } & {
      [K in keyof IxKpi &
        keyof IxKpiAttributes as `attr:${K}`]?: IxKpiAttributes[K];
    } & {
      [K in keyof IxKpi & keyof IxKpiAttributes as `prop:${K}`]?: IxKpi[K];
    };
    'ix-layout-auto': IxLayoutAuto;
    'ix-layout-grid': Omit<IxLayoutGrid, keyof IxLayoutGridAttributes> & {
      [K in keyof IxLayoutGrid &
        keyof IxLayoutGridAttributes]?: IxLayoutGrid[K];
    } & {
      [K in keyof IxLayoutGrid &
        keyof IxLayoutGridAttributes as `attr:${K}`]?: IxLayoutGridAttributes[K];
    } & {
      [K in keyof IxLayoutGrid &
        keyof IxLayoutGridAttributes as `prop:${K}`]?: IxLayoutGrid[K];
    };
    'ix-link-button': Omit<IxLinkButton, keyof IxLinkButtonAttributes> & {
      [K in keyof IxLinkButton &
        keyof IxLinkButtonAttributes]?: IxLinkButton[K];
    } & {
      [K in keyof IxLinkButton &
        keyof IxLinkButtonAttributes as `attr:${K}`]?: IxLinkButtonAttributes[K];
    } & {
      [K in keyof IxLinkButton &
        keyof IxLinkButtonAttributes as `prop:${K}`]?: IxLinkButton[K];
    };
    'ix-menu': Omit<IxMenu, keyof IxMenuAttributes> & {
      [K in keyof IxMenu & keyof IxMenuAttributes]?: IxMenu[K];
    } & {
      [K in keyof IxMenu &
        keyof IxMenuAttributes as `attr:${K}`]?: IxMenuAttributes[K];
    } & {
      [K in keyof IxMenu & keyof IxMenuAttributes as `prop:${K}`]?: IxMenu[K];
    };
    'ix-menu-about': Omit<IxMenuAbout, keyof IxMenuAboutAttributes> & {
      [K in keyof IxMenuAbout & keyof IxMenuAboutAttributes]?: IxMenuAbout[K];
    } & {
      [K in keyof IxMenuAbout &
        keyof IxMenuAboutAttributes as `attr:${K}`]?: IxMenuAboutAttributes[K];
    } & {
      [K in keyof IxMenuAbout &
        keyof IxMenuAboutAttributes as `prop:${K}`]?: IxMenuAbout[K];
    };
    'ix-menu-about-item': Omit<
      IxMenuAboutItem,
      keyof IxMenuAboutItemAttributes
    > & {
      [K in keyof IxMenuAboutItem &
        keyof IxMenuAboutItemAttributes]?: IxMenuAboutItem[K];
    } & {
      [K in keyof IxMenuAboutItem &
        keyof IxMenuAboutItemAttributes as `attr:${K}`]?: IxMenuAboutItemAttributes[K];
    } & {
      [K in keyof IxMenuAboutItem &
    ...
    > & {
      [K in keyof IxMenuAboutNews &
        keyof IxMenuAboutNewsAttributes]?: IxMenuAboutNews[K];
    } & {
      [K in keyof IxMenuAboutNews &
        keyof IxMenuAboutNewsAttributes as `attr:${K}`]?: IxMenuAboutNewsAttributes[K];
    } & {
      [K in keyof IxMenuAboutNews &
        keyof IxMenuAboutNewsAttributes as `prop:${K}`]?: IxMenuAboutNews[K];
    };
    'ix-menu-avatar': Omit<IxMenuAvatar, keyof IxMenuAvatarAttributes> & {
      [K in keyof IxMenuAvatar &
        keyof IxMenuAvatarAttributes]?: IxMenuAvatar[K];
    } & {
      [K in keyof IxMenuAvatar &
        keyof IxMenuAvatarAttributes as `attr:${K}`]?: IxMenuAvatarAttributes[K];
    } & {
      [K in keyof IxMenuAvatar &
        keyof IxMenuAvatarAttributes as `prop:${K}`]?: IxMenuAvatar[K];
    };
    'ix-menu-avatar-item': Omit<
      IxMenuAvatarItem,
      keyof IxMenuAvatarItemAttributes
    > & {
      [K in keyof IxMenuAvatarItem &
        keyof IxMenuAvatarItemAttributes]?: IxMenuAvatarItem[K];
    } & {
      [K in keyof IxMenuAvatarItem &
        keyof IxMenuAvatarItemAttributes as `attr:${K}`]?: IxMenuAvatarItemAttributes[K];
    } & {
      [K in keyof IxMenuAvatarItem &
        keyof IxMenuAvatarItemAttributes as `prop:${K}`]?: IxMenuAvatarItem[K];
    };
    'ix-menu-category': Omit<IxMenuCategory, keyof IxMenuCategoryAttributes> & {
      [K in keyof IxMenuCategory &
        keyof IxMenuCategoryAttributes]?: IxMenuCategory[K];
    } & {
      [K in keyof IxMenuCategory &
        keyof IxMenuCategoryAttributes as `attr:${K}`]?: IxMenuCategoryAttributes[K];
    } & {
      [K in keyof IxMenuCategory &
        keyof IxMenuCategoryAttributes as `prop:${K}`]?: IxMenuCategory[K];
    };
    'ix-menu-expand-icon': Omit<
      IxMenuExpandIcon,
      keyof IxMenuExpandIconAttributes
    > & {
      [K in keyof IxMenuExpandIcon &
        keyof IxMenuExpandIconAttributes]?: IxMenuExpandIcon[K];
    } & {
      [K in keyof IxMenuExpandIcon &
        keyof IxMenuExpandIconAttributes as `attr:${K}`]?: IxMenuExpandIconAttributes[K];
    } & {
      [K in keyof IxMenuExpandIcon &
        keyof IxMenuExpandIconAttributes as `prop:${K}`]?: IxMenuExpandIcon[K];
    };
    'ix-menu-item': Omit<IxMenuItem, keyof IxMenuItemAttributes> & {
      [K in keyof IxMenuItem & keyof IxMenuItemAttributes]?: IxMenuItem[K];
    } & {
      [K in keyof IxMenuItem &
        keyof IxMenuItemAttributes as `attr:${K}`]?: IxMenuItemAttributes[K];
    } & {
      [K in keyof IxMenuItem &
        keyof IxMenuItemAttributes as `prop:${K}`]?: IxMenuItem[K];
    };
    'ix-menu-settings': Omit<IxMenuSettings, keyof IxMenuSettingsAttributes> & {
      [K in keyof IxMenuSettings &
        keyof IxMenuSettingsAttributes]?: IxMenuSettings[K];
    } & {
      [K in keyof IxMenuSettings &
        keyof IxMenuSettingsAttributes as `attr:${K}`]?: IxMenuSettingsAttributes[K];
    } & {
      [K in keyof IxMenuSettings &
        keyof IxMenuSettingsAttributes as `prop:${K}`]?: IxMenuSettings[K];
    };
    'ix-menu-settings-item': Omit<
      IxMenuSettingsItem,
      keyof IxMenuSettingsItemAttributes
    > & {
      [K in keyof IxMenuSettingsItem &
        keyof IxMenuSettingsItemAttributes]?: IxMenuSettingsItem[K];
    } & {
      [K in keyof IxMenuSettingsItem &
        keyof IxMenuSettingsItemAttributes as `attr:${K}`]?: IxMenuSettingsItemAttributes[K];
    } & {
      [K in keyof IxMenuSettingsItem &
        keyof IxMenuSettingsItemAttributes as `prop:${K}`]?: IxMenuSettingsItem[K];
    };
    'ix-message-bar': Omit<IxMessageBar, keyof IxMessageBarAttributes> & {
      [K in keyof IxMessageBar &
        keyof IxMessageBarAttributes]?: IxMessageBar[K];
    } & {
      [K in keyof IxMessageBar &
        keyof IxMessageBarAttributes as `attr:${K}`]?: IxMessageBarAttributes[K];
    } & {
      [K in keyof IxMessageBar &
        keyof IxMessageBarAttributes as `prop:${K}`]?: IxMessageBar[K];
    };
    'ix-modal': Omit<IxModal, keyof IxModalAttributes> & {
      [K in keyof IxModal & keyof IxModalAttributes]?: IxModal[K];
    } & {
      [K in keyof IxModal &
        keyof IxModalAttributes as `attr:${K}`]?: IxModalAttributes[K];
    } & {
      [K in keyof IxModal &
        keyof IxModalAttributes as `prop:${K}`]?: IxModal[K];
    };
    'ix-modal-content': IxModalContent;
    'ix-modal-footer': IxModalFooter;
    'ix-modal-header': Omit<IxModalHeader, keyof IxModalHeaderAttributes> & {
      [K in keyof IxModalHeader &
        keyof IxModalHeaderAttributes]?: IxModalHeader[K];
    } & {
      [K in keyof IxModalHeader &
        keyof IxModalHeaderAttributes as `attr:${K}`]?: IxModalHeaderAttributes[K];
    } & {
      [K in keyof IxModalHeader &
        keyof IxModalHeaderAttributes as `prop:${K}`]?: IxModalHeader[K];
    };
    'ix-modal-loading': IxModalLoading;
    'ix-number-input': Omit<IxNumberInput, keyof IxNumberInputAttributes> & {
      [K in keyof IxNumberInput &
        keyof IxNumberInputAttributes]?: IxNumberInput[K];
    } & {
      [K in keyof IxNumberInput &
        keyof IxNumberInputAttributes as `attr:${K}`]?: IxNumberInputAttributes[K];
    } & {
      [K in keyof IxNumberInput &
        keyof IxNumberInputAttributes as `prop:${K}`]?: IxNumberInput[K];
    };
    'ix-pagination': Omit<IxPagination, keyof IxPaginationAttributes> & {
      [K in keyof IxPagination &
        keyof IxPaginationAttributes]?: IxPagination[K];
    } & {
      [K in keyof IxPagination &
        keyof IxPaginationAttributes as `attr:${K}`]?: IxPaginationAttributes[K];
    } & {
      [K in keyof IxPagination &
        keyof IxPaginationAttributes as `prop:${K}`]?: IxPagination[K];
    };
    'ix-pane': Omit<IxPane, keyof IxPaneAttributes> & {
      [K in keyof IxPane & keyof IxPaneAttributes]?: IxPane[K];
    } & {
      [K in keyof IxPane &
        keyof IxPaneAttributes as `attr:${K}`]?: IxPaneAttributes[K];
    } & {
      [K in keyof IxPane & keyof IxPaneAttributes as `prop:${K}`]?: IxPane[K];
    };
    'ix-pane-layout': Omit<IxPaneLayout, keyof IxPaneLayoutAttributes> & {
      [K in keyof IxPaneLayout &
        keyof IxPaneLayoutAttributes]?: IxPaneLayout[K];
    } & {
      [K in keyof IxPaneLayout &
        keyof IxPaneLayoutAttributes as `attr:${K}`]?: IxPaneLayoutAttributes[K];
    } & {
      [K in keyof IxPaneLayout &
        keyof IxPaneLayoutAttributes as `prop:${K}`]?: IxPaneLayout[K];
    };
    'ix-pill': Omit<IxPill, keyof IxPillAttributes> & {
      [K in keyof IxPill & keyof IxPillAttributes]?: IxPill[K];
    } & {
      [K in keyof IxPill &
        keyof IxPillAttributes as `attr:${K}`]?: IxPillAttributes[K];
    } & {
      [K in keyof IxPill & keyof IxPillAttributes as `prop:${K}`]?: IxPill[K];
    };
    'ix-progress-indicator': Omit<
      IxProgressIndicator,
      keyof IxProgressIndicatorAttributes
    > & {
      [K in keyof IxProgressIndicator &
        keyof IxProgressIndicatorAttributes]?: IxProgressIndicator[K];
    } & {
      [K in keyof IxProgressIndicator &
        keyof IxProgressIndicatorAttributes as `attr:${K}`]?: IxProgressIndicatorAttributes[K];
    } & {
      [K in keyof IxProgressIndicator &
        keyof IxProgressIndicatorAttributes as `prop:${K}`]?: IxProgressIndicator[K];
    };
    'ix-push-card': Omit<IxPushCard, keyof IxPushCardAttributes> & {
      [K in keyof IxPushCard & keyof IxPushCardAttributes]?: IxPushCard[K];
    } & {
      [K in keyof IxPushCard &
        keyof IxPushCardAttributes as `attr:${K}`]?: IxPushCardAttributes[K];
    } & {
      [K in keyof IxPushCard &
        keyof IxPushCardAttributes as `prop:${K}`]?: IxPushCard[K];
    };
    'ix-radio': Omit<IxRadio, keyof IxRadioAttributes> & {
      [K in keyof IxRadio & keyof IxRadioAttributes]?: IxRadio[K];
    } & {
      [K in keyof IxRadio &
        keyof IxRadioAttributes as `attr:${K}`]?: IxRadioAttributes[K];
    } & {
      [K in keyof IxRadio &
        keyof IxRadioAttributes as `prop:${K}`]?: IxRadio[K];
    };
    'ix-radio-group': Omit<IxRadioGroup, keyof IxRadioGroupAttributes> & {
      [K in keyof IxRadioGroup &
        keyof IxRadioGroupAttributes]?: IxRadioGroup[K];
    } & {
      [K in keyof IxRadioGroup &
        keyof IxRadioGroupAttributes as `attr:${K}`]?: IxRadioGroupAttributes[K];
    } & {
      [K in keyof IxRadioGroup &
        keyof IxRadioGroupAttributes as `prop:${K}`]?: IxRadioGroup[K];
    };
    'ix-row': IxRow;
    'ix-select': Omit<IxSelect, keyof IxSelectAttributes> & {
      [K in keyof IxSelect & keyof IxSelectAttributes]?: IxSelect[K];
    } & {
      [K in keyof IxSelect &
        keyof IxSelectAttributes as `attr:${K}`]?: IxSelectAttributes[K];
    } & {
      [K in keyof IxSelect &
        keyof IxSelectAttributes as `prop:${K}`]?: IxSelect[K];
    };
    'ix-select-item': Omit<IxSelectItem, keyof IxSelectItemAttributes> & {
      [K in keyof IxSelectItem &
        keyof IxSelectItemAttributes]?: IxSelectItem[K];
    } & {
      [K in keyof IxSelectItem &
        keyof IxSelectItemAttributes as `attr:${K}`]?: IxSelectItemAttributes[K];
    } & {
      [K in keyof IxSelectItem &
        keyof IxSelectItemAttributes as `prop:${K}`]?: IxSelectItem[K];
    } & OneOf<'value', IxSelectItem['value']>;
    'ix-slider': Omit<IxSlider, keyof IxSliderAttributes> & {
      [K in keyof IxSlider & keyof IxSliderAttributes]?: IxSlider[K];
    } & {
      [K in keyof IxSlider &
        keyof IxSliderAttributes as `attr:${K}`]?: IxSliderAttributes[K];
    } & {
      [K in keyof IxSlider &
        keyof IxSliderAttributes as `prop:${K}`]?: IxSlider[K];
    };
    'ix-spinner': Omit<IxSpinner, keyof IxSpinnerAttributes> & {
      [K in keyof IxSpinner & keyof IxSpinnerAttributes]?: IxSpinner[K];
    } & {
      [K in keyof IxSpinner &
        keyof IxSpinnerAttributes as `attr:${K}`]?: IxSpinnerAttributes[K];
    } & {
      [K in keyof IxSpinner &
        keyof IxSpinnerAttributes as `prop:${K}`]?: IxSpinner[K];
    };
    'ix-split-button': Omit<IxSplitButton, keyof IxSplitButtonAttributes> & {
      [K in keyof IxSplitButton &
        keyof IxSplitButtonAttributes]?: IxSplitButton[K];
    } & {
      [K in keyof IxSplitButton &
        keyof IxSplitButtonAttributes as `attr:${K}`]?: IxSplitButtonAttributes[K];
    } & {
      [K in keyof IxSplitButton &
        keyof IxSplitButtonAttributes as `prop:${K}`]?: IxSplitButton[K];
    };
    'ix-tab-item': Omit<IxTabItem, keyof IxTabItemAttributes> & {
      [K in keyof IxTabItem & keyof IxTabItemAttributes]?: IxTabItem[K];
    } & {
      [K in keyof IxTabItem &
        keyof IxTabItemAttributes as `attr:${K}`]?: IxTabItemAttributes[K];
    } & {
      [K in keyof IxTabItem &
        keyof IxTabItemAttributes as `prop:${K}`]?: IxTabItem[K];
    };
    'ix-tabs': Omit<IxTabs, keyof IxTabsAttributes> & {
      [K in keyof IxTabs & keyof IxTabsAttributes]?: IxTabs[K];
    } & {
      [K in keyof IxTabs &
        keyof IxTabsAttributes as `attr:${K}`]?: IxTabsAttributes[K];
    } & {
      [K in keyof IxTabs & keyof IxTabsAttributes as `prop:${K}`]?: IxTabs[K];
    };
    'ix-textarea': Omit<IxTextarea, keyof IxTextareaAttributes> & {
      [K in keyof IxTextarea & keyof IxTextareaAttributes]?: IxTextarea[K];
    } & {
      [K in keyof IxTextarea &
        keyof IxTextareaAttributes as `attr:${K}`]?: IxTextareaAttributes[K];
    } & {
      [K in keyof IxTextarea &
        keyof IxTextareaAttributes as `prop:${K}`]?: IxTextarea[K];
    };
    'ix-tile': Omit<IxTile, keyof IxTileAttributes> & {
      [K in keyof IxTile & keyof IxTileAttributes]?: IxTile[K];
    } & {
      [K in keyof IxTile &
        keyof IxTileAttributes as `attr:${K}`]?: IxTileAttributes[K];
    } & {
      [K in keyof IxTile & keyof IxTileAttributes as `prop:${K}`]?: IxTile[K];
    };
    'ix-time-input': Omit<IxTimeInput, keyof IxTimeInputAttributes> & {
      [K in keyof IxTimeInput & keyof IxTimeInputAttributes]?: IxTimeInput[K];
    } & {
      [K in keyof IxTimeInput &
        keyof IxTimeInputAttributes as `attr:${K}`]?: IxTimeInputAttributes[K];
    } & {
      [K in keyof IxTimeInput &
        keyof IxTimeInputAttributes as `prop:${K}`]?: IxTimeInput[K];
    };
    'ix-time-picker': Omit<IxTimePicker, keyof IxTimePickerAttributes> & {
      [K in keyof IxTimePicker &
        keyof IxTimePickerAttributes]?: IxTimePicker[K];
    } & {
      [K in keyof IxTimePicker &
        keyof IxTimePickerAttributes as `attr:${K}`]?: IxTimePickerAttributes[K];
    } & {
      [K in keyof IxTimePicker &
        keyof IxTimePickerAttributes as `prop:${K}`]?: IxTimePicker[K];
    };
    'ix-toast': Omit<IxToast, keyof IxToastAttributes> & {
      [K in keyof IxToast & keyof IxToastAttributes]?: IxToast[K];
    } & {
      [K in keyof IxToast &
        keyof IxToastAttributes as `attr:${K}`]?: IxToastAttributes[K];
    } & {
      [K in keyof IxToast &
        keyof IxToastAttributes as `prop:${K}`]?: IxToast[K];
    };
    'ix-toast-container': Omit<
      IxToastContainer,
      keyof IxToastContainerAttributes
    > & {
      [K in keyof IxToastContainer &
        keyof IxToastContainerAttributes]?: IxToastContainer[K];
    } & {
      [K in keyof IxToastContainer &
        keyof IxToastContainerAttributes as `attr:${K}`]?: IxToastContainerAttributes[K];
    } & {
      [K in keyof IxToastContainer &
        keyof IxToastContainerAttributes as `prop:${K}`]?: IxToastContainer[K];
    };
    'ix-toggle': Omit<IxToggle, keyof IxToggleAttributes> & {
      [K in keyof IxToggle & keyof IxToggleAttributes]?: IxToggle[K];
    } & {
      [K in keyof IxToggle &
        keyof IxToggleAttributes as `attr:${K}`]?: IxToggleAttributes[K];
    } & {
      [K in keyof IxToggle &
        keyof IxToggleAttributes as `prop:${K}`]?: IxToggle[K];
    };
    'ix-toggle-button': Omit<IxToggleButton, keyof IxToggleButtonAttributes> & {
      [K in keyof IxToggleButton &
        keyof IxToggleButtonAttributes]?: IxToggleButton[K];
    } & {
      [K in keyof IxToggleButton &
        keyof IxToggleButtonAttributes as `attr:${K}`]?: IxToggleButtonAttributes[K];
    } & {
      [K in keyof IxToggleButton &
        keyof IxToggleButtonAttributes as `prop:${K}`]?: IxToggleButton[K];
    };
    'ix-tooltip': Omit<IxTooltip, keyof IxTooltipAttributes> & {
      [K in keyof IxTooltip & keyof IxTooltipAttributes]?: IxTooltip[K];
    } & {
      [K in keyof IxTooltip &
        keyof IxTooltipAttributes as `attr:${K}`]?: IxTooltipAttributes[K];
    } & {
      [K in keyof IxTooltip &
        keyof IxTooltipAttributes as `prop:${K}`]?: IxTooltip[K];
    };
    'ix-tree': Omit<IxTree, keyof IxTreeAttributes> & {
      [K in keyof IxTree & keyof IxTreeAttributes]?: IxTree[K];
    } & {
      [K in keyof IxTree &
        keyof IxTreeAttributes as `attr:${K}`]?: IxTreeAttributes[K];
    } & {
      [K in keyof IxTree & keyof IxTreeAttributes as `prop:${K}`]?: IxTree[K];
    };
    'ix-tree-item': Omit<IxTreeItem, keyof IxTreeItemAttributes> & {
      [K in keyof IxTreeItem & keyof IxTreeItemAttributes]?: IxTreeItem[K];
    } & {
      [K in keyof IxTreeItem &
        keyof IxTreeItemAttributes as `attr:${K}`]?: IxTreeItemAttributes[K];
    } & {
      [K in keyof IxTreeItem &
        keyof IxTreeItemAttributes as `prop:${K}`]?: IxTreeItem[K];
    };
    'ix-typography': Omit<IxTypography, keyof IxTypographyAttributes> & {
      [K in keyof IxTypography &
        keyof IxTypographyAttributes]?: IxTypography[K];
    } & {
      [K in keyof IxTypography &
        keyof IxTypographyAttributes as `attr:${K}`]?: IxTypographyAttributes[K];
    } & {
      [K in keyof IxTypography &
        keyof IxTypographyAttributes as `prop:${K}`]?: IxTypography[K];
    };
    'ix-upload': Omit<IxUpload, keyof IxUploadAttributes> & {
      [K in keyof IxUpload & keyof IxUploadAttributes]?: IxUpload[K];
    } & {
      [K in keyof IxUpload &
        keyof IxUploadAttributes as `attr:${K}`]?: IxUploadAttributes[K];
    } & {
      [K in keyof IxUpload &
        keyof IxUploadAttributes as `prop:${K}`]?: IxUpload[K];
    };
    'ix-validation-tooltip': Omit<
      IxValidationTooltip,
      keyof IxValidationTooltipAttributes
    > & {
      [K in keyof IxValidationTooltip &
        keyof IxValidationTooltipAttributes]?: IxValidationTooltip[K];
    } & {
      [K in keyof IxValidationTooltip &
        keyof IxValidationTooltipAttributes as `attr:${K}`]?: IxValidationTooltipAttributes[K];
    } & {
      [K in keyof IxValidationTooltip &
        keyof IxValidationTooltipAttributes as `prop:${K}`]?: IxValidationTooltip[K];
    };
    'ix-workflow-step': Omit<IxWorkflowStep, keyof IxWorkflowStepAttributes> & {
      [K in keyof IxWorkflowStep &
        keyof IxWorkflowStepAttributes]?: IxWorkflowStep[K];
    } & {
      [K in keyof IxWorkflowStep &
        keyof IxWorkflowStepAttributes as `attr:${K}`]?: IxWorkflowStepAttributes[K];
    } & {
      [K in keyof IxWorkflowStep &
        keyof IxWorkflowStepAttributes as `prop:${K}`]?: IxWorkflowStep[K];
    };
    'ix-workflow-steps': Omit<
      IxWorkflowSteps,
      keyof IxWorkflowStepsAttributes
    > & {
      [K in keyof IxWorkflowSteps &
        keyof IxWorkflowStepsAttributes]?: IxWorkflowSteps[K];
    } & {
      [K in keyof IxWorkflowSteps &
        keyof IxWorkflowStepsAttributes as `attr:${K}`]?: IxWorkflowStepsAttributes[K];
    } & {
      [K in keyof IxWorkflowSteps &
        keyof IxWorkflowStepsAttributes as `prop:${K}`]?: IxWorkflowSteps[K];
    };
  }
}
...
declare module '@stencil/core' {
  export namespace JSX {
    interface IntrinsicElements {
      'ix-action-card': LocalJSX.IntrinsicElements['ix-action-card'] &
        JSXBase.HTMLAttributes<HTMLIxActionCardElement>;
      'ix-application': LocalJSX.IntrinsicElements['ix-application'] &
        JSXBase.HTMLAttributes<HTMLIxApplicationElement>;
      'ix-application-header': LocalJSX.IntrinsicElements['ix-application-header'] &
        JSXBase.HTMLAttributes<HTMLIxApplicationHeaderElement>;
      'ix-application-sidebar': LocalJSX.IntrinsicElements['ix-application-sidebar'] &
        JSXBase.HTMLAttributes<HTMLIxApplicationSidebarElement>;
      'ix-application-switch-modal': LocalJSX.IntrinsicElements['ix-application-switch-modal'] &
        JSXBase.HTMLAttributes<HTMLIxApplicationSwitchModalElement>;
      'ix-avatar': LocalJSX.IntrinsicElements['ix-avatar'] &
        JSXBase.HTMLAttributes<HTMLIxAvatarElement>;
      'ix-blind': LocalJSX.IntrinsicElements['ix-blind'] &
        JSXBase.HTMLAttributes<HTMLIxBlindElement>;
      'ix-breadcrumb': LocalJSX.IntrinsicElements['ix-breadcrumb'] &
        JSXBase.HTMLAttributes<HTMLIxBreadcrumbElement>;
      'ix-breadcrumb-item': LocalJSX.IntrinsicElements['ix-breadcrumb-item'] &
        JSXBase.HTMLAttributes<HTMLIxBreadcrumbItemElement>;
      'ix-button': LocalJSX.IntrinsicElements['ix-button'] &
        JSXBase.HTMLAttributes<HTMLIxButtonElement>;
      'ix-card': LocalJSX.IntrinsicElements['ix-card'] &
        JSXBase.HTMLAttributes<HTMLIxCardElement>;
      'ix-card-accordion': LocalJSX.IntrinsicElements['ix-card-accordion'] &
        JSXBase.HTMLAttributes<HTMLIxCardAccordionElement>;
      'ix-card-content': LocalJSX.IntrinsicElements['ix-card-content'] &
        JSXBase.HTMLAttributes<HTMLIxCardContentElement>;
      'ix-card-list': LocalJSX.IntrinsicElements['ix-card-list'] &
        JSXBase.HTMLAttributes<HTMLIxCardListElement>;
      'ix-card-title': LocalJSX.IntrinsicElements['ix-card-title'] &
        JSXBase.HTMLAttributes<HTMLIxCardTitleElement>;
      'ix-category-filter': LocalJSX.IntrinsicElements['ix-category-filter'] &
        JSXBase.HTMLAttributes<HTMLIxCategoryFilterElement>;
      /**
       * @form-ready
       */
      'ix-checkbox': LocalJSX.IntrinsicElements['ix-checkbox'] &
        JSXBase.HTMLAttributes<HTMLIxCheckboxElement>;
      /**
       * @form-ready
       */
      'ix-checkbox-group': LocalJSX.IntrinsicElements['ix-checkbox-group'] &
        JSXBase.HTMLAttributes<HTMLIxCheckboxGroupElement>;
      'ix-chip': LocalJSX.IntrinsicElements['ix-chip'] &
        JSXBase.HTMLAttributes<HTMLIxChipElement>;
      'ix-col': LocalJSX.IntrinsicElements['ix-col'] &
        JSXBase.HTMLAttributes<HTMLIxColElement>;
      'ix-content': LocalJSX.IntrinsicElements['ix-content'] &
        JSXBase.HTMLAttributes<HTMLIxContentElement>;
      'ix-content-header': LocalJSX.IntrinsicElements['ix-content-header'] &
        JSXBase.HTMLAttributes<HTMLIxContentHeaderElement>;
      'ix-css-grid': LocalJSX.IntrinsicElements['ix-css-grid'] &
        JSXBase.HTMLAttributes<HTMLIxCssGridElement>;
      'ix-css-grid-item': LocalJSX.IntrinsicElements['ix-css-grid-item'] &
        JSXBase.HTMLAttributes<HTMLIxCssGridItemElement>;
      'ix-custom-field': LocalJSX.IntrinsicElements['ix-custom-field'] &
        JSXBase.HTMLAttributes<HTMLIxCustomFieldElement>;
      'ix-date-dropdown': LocalJSX.IntrinsicElements['ix-date-dropdown'] &
        JSXBase.HTMLAttributes<HTMLIxDateDropdownElement>;
      /**
       * @form-ready
       */
      'ix-date-input': LocalJSX.IntrinsicElements['ix-date-input'] &
        JSXBase.HTMLAttributes<HTMLIxDateInputElement>;
      'ix-date-picker': LocalJSX.IntrinsicElements['ix-date-picker'] &
        JSXBase.HTMLAttributes<HTMLIxDatePickerElement>;
      'ix-date-time-card': LocalJSX.IntrinsicElements['ix-date-time-card'] &
        JSXBase.HTMLAttributes<HTMLIxDateTimeCardElement>;
      'ix-datetime-picker': LocalJSX.IntrinsicElements['ix-datetime-picker'] &
        JSXBase.HTMLAttributes<HTMLIxDatetimePickerElement>;
      'ix-divider': LocalJSX.IntrinsicElements['ix-divider'] &
        JSXBase.HTMLAttributes<HTMLIxDividerElement>;
      /**
       * @deprecated Will be removed with 5.0.0, use ix-pane as successor
       */
      'ix-drawer': LocalJSX.IntrinsicElements['ix-drawer'] &
        JSXBase.HTMLAttributes<HTMLIxDrawerElement>;
      'ix-dropdown': LocalJSX.IntrinsicElements['ix-dropdown'] &
        JSXBase.HTMLAttributes<HTMLIxDropdownElement>;
      'ix-dropdown-button': LocalJSX.IntrinsicElements['ix-dropdown-button'] &
        JSXBase.HTMLAttributes<HTMLIxDropdownButtonElement>;
      'ix-dropdown-header': LocalJSX.IntrinsicElements['ix-dropdown-header'] &
        JSXBase.HTMLAttributes<HTMLIxDropdownHeaderElement>;
      'ix-dropdown-item': LocalJSX.IntrinsicElements['ix-dropdown-item'] &
        JSXBase.HTMLAttributes<HTMLIxDropdownItemElement>;
      'ix-dropdown-quick-actions': LocalJSX.IntrinsicElements['ix-dropdown-quick-actions'] &
        JSXBase.HTMLAttributes<HTMLIxDropdownQuickActionsElement>;
      'ix-empty-state': LocalJSX.IntrinsicElements['ix-empty-state'] &
        JSXBase.HTMLAttributes<HTMLIxEmptyStateElement>;
      'ix-event-list': LocalJSX.IntrinsicElements['ix-event-list'] &
        JSXBase.HTMLAttributes<HTMLIxEventListElement>;
      'ix-event-list-item': LocalJSX.IntrinsicElements['ix-event-list-item'] &
        JSXBase.HTMLAttributes<HTMLIxEventListItemElement>;
      'ix-expanding-search': LocalJSX.IntrinsicElements['ix-expanding-search'] &
        JSXBase.HTMLAttributes<HTMLIxExpandingSearchElement>;
      'ix-field-label': LocalJSX.IntrinsicElements['ix-field-label'] &
        JSXBase.HTMLAttributes<HTMLIxFieldLabelElement>;
      'ix-field-wrapper': LocalJSX.IntrinsicElements['ix-field-wrapper'] &
        JSXBase.HTMLAttributes<HTMLIxFieldWrapperElement>;
      'ix-filter-chip': LocalJSX.IntrinsicElements['ix-filter-chip'] &
        JSXBase.HTMLAttributes<HTMLIxFilterChipElement>;
      'ix-flip-tile': LocalJSX.IntrinsicElements['ix-flip-tile'] &
        JSXBase.HTMLAttributes<HTMLIxFlipTileElement>;
      'ix-flip-tile-content': LocalJSX.IntrinsicElements['ix-flip-tile-content'] &
        JSXBase.HTMLAttributes<HTMLIxFlipTileContentElement>;
      'ix-group': LocalJSX.IntrinsicElements['ix-group'] &
        JSXBase.HTMLAttributes<HTMLIxGroupElement>;
      'ix-group-context-menu': LocalJSX.IntrinsicElements['ix-group-context-menu'] &
        JSXBase.HTMLAttributes<HTMLIxGroupContextMenuElement>;
      'ix-group-item': LocalJSX.IntrinsicElements['ix-group-item'] &
        JSXBase.HTMLAttributes<HTMLIxGroupItemElement>;
      'ix-helper-text': LocalJSX.IntrinsicElements['ix-helper-text'] &
        JSXBase.HTMLAttributes<HTMLIxHelperTextElement>;
      'ix-icon-button': LocalJSX.IntrinsicElements['ix-icon-button'] &
        JSXBase.HTMLAttributes<HTMLIxIconButtonElement>;
      'ix-icon-toggle-button': LocalJSX.IntrinsicElements['ix-icon-toggle-button'] &
        JSXBase.HTMLAttributes<HTMLIxIconToggleButtonElement>;
      /**
       * @form-ready
       */
      'ix-input': LocalJSX.IntrinsicElements['ix-input'] &
        JSXBase.HTMLAttributes<HTMLIxInputElement>;
      /**
       * @deprecated Since 3.0.0. Will be removed with 5.0.0
       * Not maintained anymore.
       * Use the 'ix-input' component instead
       */
      'ix-input-group': LocalJSX.IntrinsicElements['ix-input-group'] &
        JSXBase.HTMLAttributes<HTMLIxInputGroupElement>;
      'ix-key-value': LocalJSX.IntrinsicElements['ix-key-value'] &
        JSXBase.HTMLAttributes<HTMLIxKeyValueElement>;
      'ix-key-value-list': LocalJSX.IntrinsicElements['ix-key-value-list'] &
        JSXBase.HTMLAttributes<HTMLIxKeyValueListElement>;
      'ix-kpi': LocalJSX.IntrinsicElements['ix-kpi'] &
        JSXBase.HTMLAttributes<HTMLIxKpiElement>;
      'ix-layout-auto': LocalJSX.IntrinsicElements['ix-layout-auto'] &
        JSXBase.HTMLAttributes<HTMLIxLayoutAutoElement>;
      'ix-layout-grid': LocalJSX.IntrinsicElements['ix-layout-grid'] &
        JSXBase.HTMLAttributes<HTMLIxLayoutGridElement>;
      'ix-link-button': LocalJSX.IntrinsicElements['ix-link-button'] &
        JSXBase.HTMLAttributes<HTMLIxLinkButtonElement>;
      'ix-menu': LocalJSX.IntrinsicElements['ix-menu'] &
        JSXBase.HTMLAttributes<HTMLIxMenuElement>;
      'ix-menu-about': LocalJSX.IntrinsicElements['ix-menu-about'] &
        JSXBase.HTMLAttributes<HTMLIxMenuAboutElement>;
      'ix-menu-about-item': LocalJSX.IntrinsicElements['ix-menu-about-item'] &
        JSXBase.HTMLAttributes<HTMLIxMenuAboutItemElement>;
      'ix-menu-about-news': LocalJSX.IntrinsicElements['ix-menu-about-news'] &
        JSXBase.HTMLAttributes<HTMLIxMenuAboutNewsElement>;
      'ix-menu-avatar': LocalJSX.IntrinsicElements['ix-menu-avatar'] &
        JSXBase.HTMLAttributes<HTMLIxMenuAvatarElement>;
      'ix-menu-avatar-item': LocalJSX.IntrinsicElements['ix-menu-avatar-item'] &
        JSXBase.HTMLAttributes<HTMLIxMenuAvatarItemElement>;
      'ix-menu-category': LocalJSX.IntrinsicElements['ix-menu-category'] &
        JSXBase.HTMLAttributes<HTMLIxMenuCategoryElement>;
      'ix-menu-expand-icon': LocalJSX.IntrinsicElements['ix-menu-expand-icon'] &
        JSXBase.HTMLAttributes<HTMLIxMenuExpandIconElement>;
      'ix-menu-item': LocalJSX.IntrinsicElements['ix-menu-item'] &
        JSXBase.HTMLAttributes<HTMLIxMenuItemElement>;
      'ix-menu-settings': LocalJSX.IntrinsicElements['ix-menu-settings'] &
        JSXBase.HTMLAttributes<HTMLIxMenuSettingsElement>;
      'ix-menu-settings-item': LocalJSX.IntrinsicElements['ix-menu-settings-item'] &
        JSXBase.HTMLAttributes<HTMLIxMenuSettingsItemElement>;
      'ix-message-bar': LocalJSX.IntrinsicElements['ix-message-bar'] &
        JSXBase.HTMLAttributes<HTMLIxMessageBarElement>;
      'ix-modal': LocalJSX.IntrinsicElements['ix-modal'] &
        JSXBase.HTMLAttributes<HTMLIxModalElement>;
      'ix-modal-content': LocalJSX.IntrinsicElements['ix-modal-content'] &
        JSXBase.HTMLAttributes<HTMLIxModalContentElement>;
      'ix-modal-footer': LocalJSX.IntrinsicElements['ix-modal-footer'] &
        JSXBase.HTMLAttributes<HTMLIxModalFooterElement>;
      'ix-modal-header': LocalJSX.IntrinsicElements['ix-modal-header'] &
        JSXBase.HTMLAttributes<HTMLIxModalHeaderElement>;
      'ix-modal-loading': LocalJSX.IntrinsicElements['ix-modal-loading'] &
        JSXBase.HTMLAttributes<HTMLIxModalLoadingElement>;
      /**
       * @form-ready
       */
      'ix-number-input': LocalJSX.IntrinsicElements['ix-number-input'] &
        JSXBase.HTMLAttributes<HTMLIxNumberInputElement>;
      'ix-pagination': LocalJSX.IntrinsicElements['ix-pagination'] &
        JSXBase.HTMLAttributes<HTMLIxPaginationElement>;
      'ix-pane': LocalJSX.IntrinsicElements['ix-pane'] &
        JSXBase.HTMLAttributes<HTMLIxPaneElement>;
      'ix-pane-layout': LocalJSX.IntrinsicElements['ix-pane-layout'] &
        JSXBase.HTMLAttributes<HTMLIxPaneLayoutElement>;
      'ix-pill': LocalJSX.IntrinsicElements['ix-pill'] &
        JSXBase.HTMLAttributes<HTMLIxPillElement>;
      /**
       * @since 3.2.0
       */
      'ix-progress-indicator': LocalJSX.IntrinsicElements['ix-progress-indicator'] &
        JSXBase.HTMLAttributes<HTMLIxProgressIndicatorElement>;
      'ix-push-card': LocalJSX.IntrinsicElements['ix-push-card'] &
        JSXBase.HTMLAttributes<HTMLIxPushCardElement>;
      /**
       * @form-ready
       */
      'ix-radio': LocalJSX.IntrinsicElements['ix-radio'] &
        JSXBase.HTMLAttributes<HTMLIxRadioElement>;
      /**
       * @form-ready
       */
      'ix-radio-group': LocalJSX.IntrinsicElements['ix-radio-group'] &
        JSXBase.HTMLAttributes<HTMLIxRadioGroupElement>;
      'ix-row': LocalJSX.IntrinsicElements['ix-row'] &
        JSXBase.HTMLAttributes<HTMLIxRowElement>;
      /**
       * @form-ready
       */
      'ix-select': LocalJSX.IxSelect &
        JSXBase.HTMLAttributes<HTMLIxSelectElement>;
      'ix-select-item': LocalJSX.IxSelectItem &
        JSXBase.HTMLAttributes<HTMLIxSelectItemElement>;
      /**
       * @form-ready
       */
      'ix-slider': LocalJSX.IxSlider &
        JSXBase.HTMLAttributes<HTMLIxSliderElement>;
      'ix-spinner': LocalJSX.IxSpinner &
        JSXBase.HTMLAttributes<HTMLIxSpinnerElement>;
      'ix-split-button': LocalJSX.IxSplitButton &
        JSXBase.HTMLAttributes<HTMLIxSplitButtonElement>;
      'ix-tab-item': LocalJSX.IxTabItem &
        JSXBase.HTMLAttributes<HTMLIxTabItemElement>;
      'ix-tabs': LocalJSX.IxTabs & JSXBase.HTMLAttributes<HTMLIxTabsElement>;
      /**
       * @form-ready
       */
      'ix-textarea': LocalJSX.IntrinsicElements['ix-textarea'] &
        JSXBase.HTMLAttributes<HTMLIxTextareaElement>;
      'ix-tile': LocalJSX.IntrinsicElements['ix-tile'] &
        JSXBase.HTMLAttributes<HTMLIxTileElement>;
      /**
       * @since 3.2.0
       * @form-ready
       */
      'ix-time-input': LocalJSX.IntrinsicElements['ix-time-input'] &
        JSXBase.HTMLAttributes<HTMLIxTimeInputElement>;
      'ix-time-picker': LocalJSX.IntrinsicElements['ix-time-picker'] &
        JSXBase.HTMLAttributes<HTMLIxTimePickerElement>;
      'ix-toast': LocalJSX.IntrinsicElements['ix-toast'] &
        JSXBase.HTMLAttributes<HTMLIxToastElement>;
      'ix-toast-container': LocalJSX.IntrinsicElements['ix-toast-container'] &
        JSXBase.HTMLAttributes<HTMLIxToastContainerElement>;
      /**
       * @form-ready
       */
      'ix-toggle': LocalJSX.IntrinsicElements['ix-toggle'] &
        JSXBase.HTMLAttributes<HTMLIxToggleElement>;
      'ix-toggle-button': LocalJSX.IntrinsicElements['ix-toggle-button'] &
        JSXBase.HTMLAttributes<HTMLIxToggleButtonElement>;
      'ix-tooltip': LocalJSX.IntrinsicElements['ix-tooltip'] &
        JSXBase.HTMLAttributes<HTMLIxTooltipElement>;
      'ix-tree': LocalJSX.IntrinsicElements['ix-tree'] &
        JSXBase.HTMLAttributes<HTMLIxTreeElement>;
      'ix-tree-item': LocalJSX.IntrinsicElements['ix-tree-item'] &
        JSXBase.HTMLAttributes<HTMLIxTreeItemElement>;
      'ix-typography': LocalJSX.IntrinsicElements['ix-typography'] &
        JSXBase.HTMLAttributes<HTMLIxTypographyElement>;
      'ix-upload': LocalJSX.IntrinsicElements['ix-upload'] &
        JSXBase.HTMLAttributes<HTMLIxUploadElement>;
      /**
       * @deprecated Since 3.0.0. Will be removed with 4.0.0
       * Not maintained anymore.
       */
      'ix-validation-tooltip': LocalJSX.IntrinsicElements['ix-validation-tooltip'] &
        JSXBase.HTMLAttributes<HTMLIxValidationTooltipElement>;
      'ix-workflow-step': LocalJSX.IntrinsicElements['ix-workflow-step'] &
        JSXBase.HTMLAttributes<HTMLIxWorkflowStepElement>;
      'ix-workflow-steps': LocalJSX.IntrinsicElements['ix-workflow-steps'] &
        JSXBase.HTMLAttributes<HTMLIxWorkflowStepsElement>;
    }
  }
}
