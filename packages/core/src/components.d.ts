...
export namespace Components {
    ...
    interface IxDatetimeInput {
        ...
        "showSeconds": boolean;
        /**
          * Show time reference input Per default time reference is aligned with
          * @see { this.timeFormat}
         */
...
declare global {
    ...
    interface HTMLIxDateInputElementEventMap {
        "dateChange": DateChangeEventRework;
        "dateSelect": DateChangeEventRework;
        "ixChange": DateInputEvent;
        "ixFocus": DateInputEvent;
        "ixBlur": DateInputEvent;
        "ixClear": void;
    }
    /**
     * @since 2.1.0
    ...
    interface HTMLIxDatetimeInputElementEventMap {
        "fromDateChange": string;
        "toDateChange": string;
        "fromTimeChange": string;
        "toTimeChange": string;
        "dateSelect": DateTimeSelectEvent;
        "ixChange": DatetimeInputEvent;
        "ixFocus": DatetimeInputEvent;
        "ixBlur": DatetimeInputEvent;
        "ixClear": string;
    }
    /**
     * @since 2.1.0
