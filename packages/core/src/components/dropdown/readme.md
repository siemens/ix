...
| ------------------------------------- | ------------------------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ---------------- |
| `adjustDropdownWidthToReferenceWidth` | `adjust-dropdown-width-to-reference-width` | <span style="color:red">**[DEPRECATED]**</span> Will be removed. Not used anymore<br/><br/>Adjust dropdown width to the parent width                                                                                        | `boolean`                                                                                                                                                                                                    | `false`          |
