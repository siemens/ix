...
export class Pagination {
  ...
  /**
   * ARIA label for the jump to previous pages button
   */
  @Prop() ariaLabelJumpPreviousPages = 'Jump to previous pages';

  /**
   * ARIA label for the jump to next pages button
   */
  @Prop() ariaLabelJumpNextPages = 'Jump to next pages';
  ...
  private getPageButton(index: number) {
    const baseButtonProps: BaseButtonProps = {
      ...
      ariaAttributes: {
        ...
        'aria-current': this.selectedPage === index ? 'page' : undefined,
      },
    };
  ...
  private renderPageButtons() {
    ...
    if (hasOverflowStart) {
      ...
      pageButtons.push(
        ...
        }, this.ariaLabelJumpPreviousPages)
      );
  ...
  private getJumpButton(onClick: () => void, ariaLabel: string) {
      ...
      <Host>
        <nav aria-label="Pagination">
          <ix-icon-button
            ...
            aria-disabled={this.selectedPage === 0 ? 'true' : undefined}
            tabIndex={this.selectedPage === 0 ? -1 : 0}
            variant="subtle-tertiary"
          ...
          <ix-icon-button
            ...
            aria-disabled={
              this.selectedPage === this.count - 1 ? 'true' : undefined
            }
          ></ix-icon-button>
