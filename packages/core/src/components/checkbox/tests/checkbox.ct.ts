...
regressionTest('validation works when noValidate is not set (default)', async ({ mount, page }) => {
  await mount(
    `
      <form>
...
regressionTest('noValidate=true disables validation', async ({ mount, page }) => {
  await mount(
    `
      <form novalidate>
        <ix-checkbox label="Accept Terms" value="terms" required></ix-checkbox>
...
regressionTest('validation behavior with blur when noValidate is not set', async ({ mount, page }) => {
  await mount(
    `
      <form>
        <ix-checkbox label="Accept Terms" value="terms" required></ix-checkbox>
...
regressionTest('no validation on blur when noValidate=true', async ({ mount, page }) => {
  await mount(
    `
      <form novalidate>
        <ix-checkbox label="Accept Terms" value="terms" required></ix-checkbox>
...
regressionTest('validation with named checkbox group when noValidate is not set', async ({ mount, page }) => {
  await mount(
    `
      <form>
...
regressionTest('noValidate=true disables validation for named checkbox group', async ({ mount, page }) => {
  await mount(
    `
      <form novalidate>
        <ix-checkbox label="Option 1" name="options" value="option1" required></ix-checkbox>
...
regressionTest('validation with checkbox inside checkbox-group when noValidate is not set', async ({ mount, page }) => {
  await mount(
    `
      <form>
...
regressionTest('noValidate=true disables validation for checkbox inside checkbox-group', async ({ mount, page }) => {
  await mount(
    `
      <form novalidate>
        <ix-checkbox-group label="Options">
