...
export const CUSTOM_BADGE_BACKGROUND = 'var(--si-sys-color-data-categorical-9)';
export const CUSTOM_BADGE_COLOR = 'var(--si-sys-color-text-inverse)';
export const CUSTOM_BADGE_OUTLINE_COLOR = 'var(--si-sys-color-text-primary)';
