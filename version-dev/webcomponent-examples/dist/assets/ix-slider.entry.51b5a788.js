...
const Slider = class {
  ...
  render() {
    ...
    return h(Host, { key: "9ee04cb55cb647a66588ab7528b2e9e7ffed4001", class: {
      disabled: this.disabled,
      error: !!this.error
    }, onPointerDown: () => setTimeout(() => this.showTooltip = true) }, h("div", { key: "9c9441d9d53c79223fbfead7d8ae3b4e73d54512", class: "slider" }, h("div", { key: "ef0081a78ec1af433149515c0a75d6fedaee32d2", class: "track" }, h("div", { key: "671517c64ccb46fd87e6ee13d679dc47261a1ae6", class: "thumb", style: {
      left: `calc(${valueInPercentage} * 100% - 8px)`
    } }), h("div", { key: "4fef11468c6cbcd1cd2ce011e1d01d590fd47cad", class: "ticks" }, this.marker ? this.marker.map((markerValue) => {
    ...
    }) : null)), h("input", Object.assign({ key: "b4e64c111ce62291ea95df664f0e93776ee44dff", id: "slider", type: "range", list: this.marker ? "markers" : void 0, step: this.step, min: this.min, max: this.max, value: this.rangeInput, tabindex: this.disabled ? -1 : 0, onInput: (event) => this.onInput(event), style: {
      ...
      this.showTooltip = false;
    }, role: "slider", "aria-valuenow": this.rangeInput, "aria-valuemin": this.min, "aria-valuemax": this.max }, this.a11yAttributes)), h("ix-tooltip", { key: "806dcdc54a71600079aec806e38c3ee1038574ed", class: {
      "hide-tooltip": !this.showTooltip
    }, animationFrame: true }, this.rangeInput)), h("div", { key: "928a7560cbe0d3ff7485c5258a8ea7013a0af2fe", class: "label" }, h("div", { key: "81bdc42045babb5f5665363dd93b0552812b23ab", class: "label-start" }, h("slot", { key: "c188f166df37f95b1411c5c7e2bbc46ecb1a3b1b", name: "label-start" })), h("div", { key: "a9ee8309761ec050f78d63dbd7b032bc7fd1133d", class: "label-end" }, h("slot", { key: "346af695abf79289da09ac2620a4a6ee72afbdb8", name: "label-end" }))), this.error ? h("ix-typography", { class: "label-error", color: "alarm" }, this.error) : null);
  }
  get hostElement() {
