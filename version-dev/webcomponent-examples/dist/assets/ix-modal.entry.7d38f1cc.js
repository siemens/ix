...
const Modal = class {
  ...
  render() {
    return h(Host, { key: "c96bf18eeec05c1363ca83f0cc68ab65f1e50b60", class: {
      visible: this.modalVisible,
      "no-backdrop": this.backdrop === false,
      "align-center": this.centered
    } }, h("div", { key: "ad4c5d6d14c7c20ef8d4150372b6d147217aa7f4", class: "dialog-backdrop" }, h("dialog", { key: "e9cc1d8ab815b6809266eadde437244639eb9597", "aria-modal": a11yBoolean(true), "aria-describedby": this.ariaAttributes["aria-describedby"], "aria-labelledby": this.ariaAttributes["aria-labelledby"], class: {
      modal: true,
      [`modal-size-${this.size}`]: true
    }, onClose: () => this.dismissModal(), onClick: (event) => this.onModalClick(event), onCancel: (e) => {
      e.preventDefault();
      this.dismissModal();
    } }, h("slot", { key: "96d3bad846bbb2541aa8a99313574dd539e9b2e5" }))));
  }
  get hostElement() {
