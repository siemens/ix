import { r as registerInstance, c as createEvent, h, H as Host, g as getElement } from "./index.e885955d.js";
...
const Menu = class {
  ...
  render() {
    ...
    return h(Host, { class: {
      ...
      this.resetActiveTab();
    } }, h("div", { class: "menu-buttons" }, h("ix-burger-menu", { onClick: async () => this.toggleMenu(), expanded: this.expand, ixAriaLabel: this.i18nExpandSidebar, pinned: this.showPinned, class: {
      "burger-menu": true
    } }), this.breakpoint === "sm" && this.applicationLayoutContext.appSwitchConfig && h("ix-icon-button", { onClick: () => showAppSwitch(this.applicationLayoutContext.appSwitchConfig), icon: "apps", ghost: true, class: "app-switch" })), h("div", { class: "menu-avatar" }, h("slot", { name: "ix-menu-avatar" })), h("div", { id: "menu-tabs", style: {
      display: "contents"
