...
import { O as OnListener } from "./listener-23c93aa7.64fd4f83.js";
...
const Select = class {
  ...
  render() {
    ...
    } }, h("div", { key: "5457a0d20ad7242cd846eed525c5b0b16ac0d83d", class: "input-container" }, h("div", { key: "0ef7de5167e84c91cd37b2173712a5ffb4cb8098", class: "chips" }, this.isMultipleMode ? (_a = this.selectedItems) === null || _a === void 0 ? void 0 : _a.map((item) => h("ix-filter-chip", { disabled: this.disabled || this.readonly, key: item.value, onCloseClick: (e) => {
      e.preventDefault();
      e.stopPropagation();
      this.itemClick(item.value);
    } }, item.label)) : "", h("div", { key: "1a892994b8edac949885b740fad4bd3f8aa41db2", class: "trigger" }, h("input", { key: "d20af5812e4ddb15b641f4ab2e8397263a1ce3e1", autocomplete: "off", "data-testid": "input", disabled: this.disabled, readOnly: this.readonly, type: "text", class: {
