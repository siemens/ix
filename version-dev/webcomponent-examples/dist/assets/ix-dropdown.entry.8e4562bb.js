...
const Dropdown = class {
  ...
  render() {
    return h(Host, { key: "50c10772e717d235adb6b94ca9bed6cb65b1c5c1", "data-ix-dropdown": this.localUId, ref: (ref) => this.dropdownRef = ref, class: {
      "dropdown-menu": true,
      show: this.show,
      overflow: true
    }, style: {
    ...
    }, role: "list", onClick: (event) => this.onDropdownClick(event) }, h("div", { key: "15ab5a3ec921b6cbfb817787ae80f45e4d40d3d0", style: { display: "contents" } }, this.header && h("div", { class: "dropdown-header" }, this.header), h("slot", { key: "43bf3da23fc7b56354de0c12f5cccf8a74c09858" })));
  }
  get hostElement() {
