import { r as registerInstance, c as createEvent, h, H as Host } from "./index.06e375ce.js";
...
const ExpandingSearch = class {
  ...
  render() {
    ...
    } }, h("ix-icon-button", { key: "960286296bba24fa10228927d446f23c542e3404", size: this.expanded ? "16" : "24", icon: this.icon, ghost: true, variant: "primary", "data-testid": "button", onClick: () => this.expandInput(), tabindex: this.expanded ? -1 : 0, color: this.hasFocus ? "input-search-icon--color--focus" : void 0, class: {
      "btn-search": true,
