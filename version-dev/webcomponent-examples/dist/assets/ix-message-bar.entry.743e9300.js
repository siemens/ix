...
const MessageBar = class {
  ...
  render() {
    return h(Host, { key: "0283438c309c2bb612fda2fa62564b99d58be7d2" }, h("div", { key: "84964ea374591bdfcf662859c12c79fc63441964", class: { "message-container": true, [this.type]: true }, role: "alert", ref: (el) => this.divElement = el }, h("ix-icon", { key: "a7205ce2bffac6f3aad8df7ce642f5e97fad7c33", color: this.color, name: this.icon }), h("div", { key: "6e84a9bbefdc48af163f293c48f07d103e03b81a", class: "message-content" }, h("slot", { key: "36637f640f08429e8b0fc40a6d4356a67bb29d5a" })), this.dismissible ? h("ix-icon-button", { icon: "close", size: "24", ghost: true, onClick: () => {
