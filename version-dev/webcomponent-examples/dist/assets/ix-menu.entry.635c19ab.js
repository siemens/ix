...
const Menu = class {
  ...
  render() {
    ...
    return h(Host, { key: "dc5f861c533377667d90c4447fa69883ccd25a9c", class: {
      ...
      "burger-menu": true
    } }), this.breakpoint === "sm" && this.applicationLayoutContext.appSwitchConfig && h("ix-icon-button", { onClick: () => showAppSwitch(this.applicationLayoutContext.appSwitchConfig), icon: "apps", ghost: true, class: "app-switch" })), h("div", { key: "2dced6457117ed28c2779da6da36b530c617d456", class: "menu-avatar" }, h("slot", { key: "b980dd0ce062fad908d2abd77eac8d12dd113fe6", name: "ix-menu-avatar" })), h("div", { key: "5b46b35286c6d96abf3f0f0c997e7d9a9062ce09", id: "menu-tabs", style: {
      display: "contents"
