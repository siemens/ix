...
const Menu = class {
  ...
  render() {
    var _a;
    return h(Host, { key: "281912c031426c6bc9dcdad5e0d9246f0730b0e9", class: {
      expanded: this.expand,
      [`breakpoint-${this.breakpoint}`]: true
    }, slot: "menu" }, h("aside", { key: "c4a5ec073fcad3cb7306f14ae6fcc9a82d21475c", class: {
      menu: true,
      expanded: this.expand
    }, onClick: () => {
      this.resetActiveTab();
    } }, h("div", { key: "1881596defcefc84a45f36bbbe0ae060135c215a", class: "menu-buttons" }, h("ix-burger-menu", { key: "4dbb0b8c15187b48f7c5fc086fc1ce0ac96b2cba", onClick: async () => this.toggleMenu(), expanded: this.expand, ixAriaLabel: this.i18nExpandSidebar, pinned: this.showPinned, class: {
      "burger-menu": true
    } }), this.breakpoint === "sm" && this.applicationLayoutContext.appSwitchConfig && h("ix-icon-button", { onClick: () => showAppSwitch(this.applicationLayoutContext.appSwitchConfig), icon: "apps", ghost: true, class: "app-switch" })), h("div", { key: "62c5939648cd2611074864d7718355076efef934", class: "menu-avatar" }, h("slot", { key: "104f030f86b58479342c416b3819d2e92e48721c", name: "ix-menu-avatar" })), h("div", { key: "f04c58a659affd11564dfb428991020b70637143", id: "menu-tabs", style: {
      display: "contents"
    }, onClick: (e) => this.onMenuItemsClick(e) }, h("div", { key: "1e462c43fe53bed087a77bfde2e4fa6083981a7f", class: "tabs-top" }, h("slot", { key: "f8d25bf7dd8a9a75837c779501fc78cc1857310b", name: "home" })), h("div", { key: "831ab373c743e8181e7a19b27c44e174b0e8919b", class: "tabs-shadow-container" }, h("div", { key: "1549acd05e4447adf5f1351de58b6dc86947c6d2", class: {
      "tabs--shadow": true,
      "tabs--shadow-top": true,
      "tabs--shadow--show": this.itemsScrollShadowTop
    } }), h("div", { key: "f87e30ce243c6ff9972bf369faf71fae32b36e9d", class: "tabs", onScroll: () => this.handleOverflowIndicator() }, this.breakpoint !== "sm" || !this.isHiddenFromViewport() ? h("slot", null) : null), h("div", { key: "be8c781040f11401ae2eb257c08f64b59f76a158", class: {
      "tabs--shadow": true,
      "tabs--shadow-bottom": true,
      "tabs--shadow--show": this.itemsScrollShadowBottom
    } }))), h("div", { key: "f1d7303c903ca56b234637e7c2446e460d101602", class: "bottom-tab-divider" }), this.settings ? h("ix-menu-item", { disabled: this.isHiddenFromViewport(), id: "settings", class: {
      "internal-tab": true,
      "bottom-tab": true,
      active: this.showSettings
    }, icon: "cogwheel", onClick: async () => this.toggleSettings(!this.showSettings) }, this.i18nSettings) : null, h("div", { key: "f3afe24a35d113393b75bc44097c25b5dbc62872", onClick: (e) => this.onMenuItemsClick(e) }, h("slot", { key: "c2b59e93b67a3af109675f72875b81fcf5db3490", name: "bottom" })), h("div", { key: "6317fe414b7902db3d3a83e030fe47ba7d34af76", id: "popover-area" }), this.about ? h("ix-menu-item", { disabled: this.isHiddenFromViewport(), id: "aboutAndLegal", class: {
      "internal-tab": true,
      "bottom-tab": true,
      active: this.showAbout
    }, icon: "info", onClick: async () => this.toggleAbout(!this.showAbout) }, this.i18nLegal) : null, this.enableToggleTheme ? h("ix-menu-item", { disabled: this.isHiddenFromViewport(), id: "toggleTheme", onClick: () => themeSwitcher.toggleMode(), class: "internal-tab bottom-tab", icon: "bulb" }, this.i18nToggleTheme) : null, this.enableMapExpand || ((_a = this.applicationLayoutContext) === null || _a === void 0 ? void 0 : _a.sidebar) ? h("ix-menu-item", { disabled: this.isHiddenFromViewport(), id: "menu-collapse", onClick: () => this.sidebarToggle(), class: "internal-tab bottom-tab", icon: `${this.getCollapseIcon()}` }, this.getCollapseText()) : null), h("div", { key: "218a51c8d72b47137e3b6fe16438d4152d1df160", class: {
      "menu-overlay": true,
      ...
      this.checkTransition();
    } }, h("div", { key: "52cdd64c99d30e3cd6b7ed76425cf9171df1d457", class: "menu-overlay-container" }, this.showSettings ? h("slot", { name: "ix-menu-settings" }) : null), h("div", { key: "99d885392534e2d4e8ef16255af7fe3615fdaad9", class: "menu-overlay-container" }, this.showAbout ? h("slot", { name: "ix-menu-about" }) : null)));
  }
  get hostElement() {
