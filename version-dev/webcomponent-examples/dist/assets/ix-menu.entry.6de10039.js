import { r as registerInstance, c as createEvent, h, H as Host, g as getElement } from "./index.a4168768.js";
...
import { a as applicationLayoutService, m as menuController } from "./menu-service-04c1257c.2a83ce59.js";
...
const Menu = class {
  ...
  render() {
    ...
    return h(Host, { class: {
    ...
    } }), h("div", { class: "tabs", onScroll: () => this.handleOverflowIndicator() }, this.breakpoint !== "sm" || !this.isHiddenFromViewport() ? h("slot", null) : null), h("div", { class: {
      "tabs--shadow": true,
      "tabs--shadow-bottom": true,
      "tabs--shadow--show": this.itemsScrollShadowBottom
    } }))), h("div", { class: "bottom-tab-divider" }), this.settings ? h("ix-menu-item", { disabled: this.isHiddenFromViewport(), id: "settings", class: {
      "internal-tab": true,
      "bottom-tab": true,
      active: this.showSettings
    }, icon: "cogwheel", onClick: async () => this.toggleSettings(!this.showSettings) }, this.i18nSettings) : null, h("div", { onClick: (e) => this.onMenuItemsClick(e) }, h("slot", { name: "bottom" })), h("div", { id: "popover-area" }), this.about ? h("ix-menu-item", { disabled: this.isHiddenFromViewport(), id: "aboutAndLegal", class: {
      "internal-tab": true,
      "bottom-tab": true,
      ...
      this.checkTransition();
    } }, h("div", { class: "menu-overlay-container" }, this.showSettings ? h("slot", { name: "ix-menu-settings" }) : null), h("div", { class: "menu-overlay-container" }, this.showAbout ? h("slot", { name: "ix-menu-about" }) : null)));
  }
  get hostElement() {
