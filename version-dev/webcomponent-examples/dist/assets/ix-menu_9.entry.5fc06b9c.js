import { r as registerInstance, c as createEvent, h, H as Host, g as getElement, f as forceUpdate } from "./index.8d008fd3.js";
...
const MenuItem = class {
  ...
  render() {
    ...
    return h(Host, Object.assign({ class: {
      ...
      active: this.active
    } }, extendedAttributes), h("button", { class: "tab", title: this.title, tabIndex: 0, role: "listitem" }, h("ix-icon", { name: (_a = this.icon) !== null && _a !== void 0 ? _a : this.tabIcon }), h("div", { class: "notification" }, this.notifications ? h("div", { class: "pill" }, this.notifications) : null), h("span", { class: "tab-text text-default" }, h("slot", null))));
  }
  get hostElement() {
    return getElement(this);
  }
