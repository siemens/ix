...
const TimePicker = class {
  ...
  render() {
    ...
    return h(Host, { key: "c14669d5a0004a81e86304806c200759468b208e" }, h("ix-date-time-card", { key: "5871b02325fdc7ea77cca61c3af3d54e4f7f0aac", standaloneAppearance: this.standaloneAppearance, corners: this.corners }, h("div", { key: "28f49ed9b028189f820cf3b1c6af1934da76872d", class: "header", slot: "header" }, h("ix-typography", { key: "6b5582047d19743b8769fd7074cfc6993276e82e", variant: "default-title" }, this.textTime || "Time")), h("div", { key: "a078ede2c5daac068c98756a530c2c9a4731db98", class: "clock" }, timepickerInformation.map((descriptor, index) => h("div", { class: "flex" }, h("div", { class: { columns: true, hidden: descriptor.hidden } }, h("ix-icon-button", { size: "16", onClick: () => this._time = this._time.plus({
      [descriptor.unit]: 1
    ...
    } }, ":"))), h("div", { key: "054fdcb2794a6fa5e0d83b8f1c0f9811e5d06f89", class: {
      columns: true,
      "default-space": true,
      hidden: this._timeRef === void 0
    } }, h("ix-icon-button", { key: "addc8829f2620c3c6d94d381fa4a8ed682d735b9", size: "16", onClick: () => this.changeTimeReference(), ghost: true, icon: "chevron-up", variant: "primary", class: "arrows" }), h("div", { key: "f67bd702ed4cec3feeb4c1714127b2a28db57d85", class: "time-reference" }, this._timeRef), h("ix-icon-button", { key: "68b6446294929175e18346f5a45cbd5b9c5ff657", size: "16", onClick: () => this.changeTimeReference(), ghost: true, icon: "chevron-down", variant: "primary", class: "arrows" }))), h("div", { key: "d2209c007693216033d9db23ff35d5f0d87596a6", class: { button: true, hidden: !this.standaloneAppearance } }, h("ix-button", { key: "c95eac573aadf45259dd95465f309e34438e9a4d", onClick: () => {
