import { r as registerInstance, c as createEvent, h, F as Fragment, H as Host, g as getElement } from "./index.dde3fc09.js";
...
const Toggle = class {
  ...
  render() {
    return h(Host, { key: "8a892b2dabc3640ec8c03b6def162ab474b981ce", class: {
      disabled: this.disabled
    }, onClick: () => this.onCheckedChange(!this.checked) }, h("input", { key: "6c76cbb6fa834fe1060a2f8d4291bdbfc25bdd88", disabled: this.disabled, indeterminate: this.indeterminate, checked: this.checked, role: "switch", tabindex: 0, type: "checkbox", "aria-checked": a11yBoolean(this.checked), onChange: (event) => this.onCheckedChange(event.target.checked) }), h("label", { key: "92e180be69ebb00df335db478de7642067a11de5", class: "switch", tabIndex: -1 }, h("span", { key: "1f2fff5f621cf526ba2de3fd457a85b3e80d75f5", class: "slider" })), !this.hideText ? h(Fragment, null, !this.indeterminate ? h("span", { class: "toggle-text", "aria-hidden": a11yBoolean(true) }, this.checked ? this.textOn : this.textOff) : h("span", { class: "toggle-text", "aria-hidden": a11yBoolean(true) }, this.textIndeterminate)) : null);
  }
  get hostElement() {
