import { r as registerInstance, h, H as Host } from "./index.50306e0d.js";
...
const PushCard = class {
  ...
  render() {
    ...
    return h(Host, null, h("ix-card", { variant: this.variant }, h("ix-card-title", null, this.icon ? h("ix-icon", { class: "icon", name: this.icon, size: "32" }) : null, h("span", { class: "notification" }, (_a = this.notification) !== null && _a !== void 0 ? _a : 0), h("slot", { name: "title-action" })), h("ix-card-content", null, h("ix-typography", { color, format: "h4" }, this.heading), h("ix-typography", { color }, this.subheading)), h("ix-card-accordion", null, h("slot", null))));
  }
};
