...
const FilterChip = class {
  ...
  render() {
    return h(Host, { key: "ca27885d56840c47a5bea6fd7ab060c3fc2569f9", class: { disabled: this.disabled, readonly: this.readonly }, title: this.el.textContent }, h("div", { key: "85914a7b558bad5a6f01fa7cd5941f9e98e65bd4", class: "slot-container" }, h("slot", { key: "f62ea413775363bea2dfa25950ba5f81cba316b2" })), !this.disabled && !this.readonly ? h("ix-icon-button", { ghost: true, oval: true, icon: "close-small", size: "16", tabindex: this.disabled ? -1 : 0, variant: "primary", disabled: this.disabled, onClick: (e) => this.onCloseClick(e) }) : null);
  }
  get el() {
...
const SelectItem = class {
  ...
  render() {
    return h(Host, { key: "1220c0b2f1864e182270aab43595a0dbb6855be5" }, h("ix-dropdown-item", { key: "322e468fc4f6a577d333591c6d0f4f413e99b249", class: {
