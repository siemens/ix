...
const ApplicationSwitchModal = class {
  ...
  render() {
    var _a, _b, _c, _d;
    return h(Host, { key: "8f1ea6a5e34238ee8bc211f08a6591f5f9ec7fae" }, h("ix-modal-header", { key: "86ba66bb246dc55b678b8d8c2a92f5966a5ff33f", icon: "apps" }, ((_a = this.config) === null || _a === void 0 ? void 0 : _a.i18nAppSwitch) || "Switch to application"), h("ix-modal-content", { key: "509e80be3957b22d6e2af847a06e2e7d71700ee7", class: "content" }, h("div", { key: "94bd27c958b15d461ff2d931a45cf51edf1a2b21", class: "content-apps" }, (!this.config || ((_b = this.config) === null || _b === void 0 ? void 0 : _b.apps.length) === 0) && h("div", { class: "loading" }, h("ix-spinner", { size: "medium", variant: "primary" }), h("span", null, ((_c = this.config) === null || _c === void 0 ? void 0 : _c.i18nLoadingApps) || "Loading available applications...")), (_d = this.config) === null || _d === void 0 ? void 0 : _d.apps.map((appEntry) => {
      var _a2;
