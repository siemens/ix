...
const Toggle = class {
  ...
  render() {
    return h(Host, { key: "47550101b70e0240fec5c5712174ae2e0b11eceb", class: {
      disabled: this.disabled
    }, onClick: () => this.onCheckedChange(!this.checked) }, h("input", { key: "c6f98fd8396dcc144306d782995054d1c047e2c1", disabled: this.disabled, indeterminate: this.indeterminate, checked: this.checked, role: "switch", tabindex: 0, type: "checkbox", "aria-checked": a11yBoolean(this.checked), onChange: (event) => this.onCheckedChange(event.target.checked) }), h("label", { key: "8ad4696395ee3a77219de65e4f0e6cf8b4a6ef10", class: "switch", tabIndex: -1 }, h("span", { key: "116ca4bd7fec00fb2600c100f51293fb2b534bdc", class: "slider" })), !this.hideText ? h(Fragment, null, !this.indeterminate ? h("span", { class: "toggle-text", "aria-hidden": a11yBoolean(true) }, this.checked ? this.textOn : this.textOff) : h("span", { class: "toggle-text", "aria-hidden": a11yBoolean(true) }, this.textIndeterminate)) : null);
  }
  get hostElement() {
