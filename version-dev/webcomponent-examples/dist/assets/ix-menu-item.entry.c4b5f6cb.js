...
const MenuItem = class {
  ...
  render() {
    ...
    return h(Host, Object.assign({ key: "0fd41a48dd3a01c97e88ba67403bbd97128b9232", class: {
      disabled: this.disabled,
      "home-tab": this.home,
      "bottom-tab": this.bottom,
      active: this.active,
      "tab-nested": this.isHostedInsideCategory
    } }, extendedAttributes), h("button", { key: "90de5dde45739b70ade261ec97da1990bd0e5150", class: "tab", title: this.title, tabIndex: this.disabled ? -1 : 0, role: "listitem" }, h("ix-icon", { key: "b8110de5446126dcd697e37aa96c2b897d1f03e2", class: "tab-icon", name: (_a = this.icon) !== null && _a !== void 0 ? _a : this.tabIcon }), h("div", { key: "c0d6183e21dd67457521130590e32485c76bd869", class: "notification" }, this.notifications ? h("div", { class: "pill" }, this.notifications) : null), h("span", { key: "50ed4411e9c277c52c691cd5b87bc71e8b34911f", class: "tab-text text-default" }, h("slot", { key: "61c0f5b5c6c6959d2051eea7e369a926abc710fc" }))));
  }
  get hostElement() {
