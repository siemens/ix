...
const inputGroupCss = ".sc-ix-input-group-h{position:relative;display:flex;flex-wrap:wrap;align-items:stretch;width:100%}.sc-ix-input-group-h .group.sc-ix-input-group{display:flex;position:absolute;align-items:center;height:100%}.sc-ix-input-group-h .group-start.sc-ix-input-group{left:0px;height:2rem}.sc-ix-input-group-h .group-end.sc-ix-input-group{right:0px;height:2rem}.sc-ix-input-group-h .sc-ix-input-group-s>*{display:flex}";
