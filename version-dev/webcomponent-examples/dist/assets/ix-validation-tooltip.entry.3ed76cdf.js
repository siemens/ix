import { r as registerInstance, h, H as Host, g as getElement } from "./index.a7625982.js";
import { a as autoUpdate, i as inline, s as shift, o as offset, f as flip, b as arrow, c as computePosition } from "./floating-ui.dom.esm-cbe44820.60534149.js";
...
const ValidationTooltip = class {
  ...
  render() {
    var _a, _b;
    return h(Host, { key: "ce1b7224d55fd0d05bb3d881604844de5cfbfbb4" }, h("slot", { key: "068969bca6d54f785df3347f232c41514dae13b0" }), h("div", { key: "e0130ca1c1186d919d2a970fc9fac1375ecffcf9", role: "tooltip", style: {
      display: "none",
      position: "fixed",
      top: "0",
      left: "0",
    ...
    }, class: "validation-tooltip text-default" }, this.message, h("slot", { key: "524b598332c0330592ef323704d4b890ce9cc1c2", name: "tooltip-message" }), h("div", { key: "d52f46b4977097ab251b83830307a84e6b03802e", id: "arrow" })));
  }
  get hostElement() {
