import { r as registerInstance, c as createEvent, h, H as Host, g as getElement } from "./index.b719f867.js";
...
const Upload = class {
  ...
  render() {
    return h(Host, { key: "900ebc399a7c834f89cc06f9bca969bc21ab603f" }, h("div", { key: "cd2484fdfcef9db2911a5336c3be56e30001dd89", class: {
    ...
    }, onDragOver: (e) => this.fileOver(e), onDragLeave: () => this.fileLeave(), draggable: !this.disabled }, this.renderUploadState(), h("div", { key: "1464a7737c0eaa7b5e8ac95977c30c0ad1c46b56" }, h("input", { key: "89e02815b2bf7362921c85ea8a4d186006112c88", multiple: this.multiple, type: "file", class: "upload-browser", id: "upload-browser", onChange: (e) => {
      this.fileChangeEvent(e);
    }, accept: this.accept }), h("ix-button", { key: "de608b802ac5ac7449baff24f7d2a198e4b99e60", tabindex: "-1", outline: true, onClick: () => this.inputElement.click(), disabled: this.disabled || this.state === UploadFileState.LOADING }, this.i18nUploadFile))));
  }
  get hostElement() {
