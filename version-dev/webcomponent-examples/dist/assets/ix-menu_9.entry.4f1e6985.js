import { r as registerInstance, c as createEvent, h, H as Host, g as getElement, f as forceUpdate } from "./index.bb42fc32.js";
...
const Menu = class {
  ...
  isMenuItemClicked(event) {
    ...
    const menuItems = path.filter((element) => element.id !== "more-tab").filter((element) => {
