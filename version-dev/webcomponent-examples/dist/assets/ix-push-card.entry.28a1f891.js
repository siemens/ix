...
const PushCard = class {
  ...
  render() {
    ...
    return h(Host, { key: "1c3c6f9f31bd6f433fcabf263ab181853971de2a" }, h("ix-card", { key: "801325d159bc33d53320d7794523c76de297e2a1", variant: this.variant }, h("ix-card-content", { key: "a793751181c2ce9d7443945bd1f6984f170fedf0" }, h("ix-card-title", { key: "dffc1f10737ed41191851db9b4db92d0e90b2a91" }, this.icon ? h("ix-icon", { class: "icon", name: this.icon, size: "32" }) : null, h("span", { key: "9ed9b0c322a9206fad8b6331e0f03b4e9edc0d8c", class: "notification" }, (_a = this.notification) !== null && _a !== void 0 ? _a : 0), h("slot", { key: "611f7ccdbf5568dbb104324590a8078a7eb14ee2", name: "title-action" })), h("ix-typography", { key: "60a3984552a3f95e704132a26d554604998c5fa9", color, format: "h4" }, this.heading), h("ix-typography", { key: "a37025522a0d4a5df30b7c23da7fd3ea05568808", color }, this.subheading)), h("ix-card-accordion", { key: "1edb5bd256b961b1d0f3085d077b27792b65b0a0", collapse: this.collapse }, h("slot", { key: "889f13131063c034d4880f0362a372dfe2895a64" }))));
  }
};
