...
const selectItemCss = ".sc-ix-select-item-h{display:block;position:relative}.sc-ix-select-item-h>ix-dropdown-item.sc-ix-select-item{width:100%}.d-none.sc-ix-select-item-h{display:none}";
