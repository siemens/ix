import { r as registerInstance, f as forceUpdate, h, H as Host, c as createEvent, F as Fragment, g as getElement } from "./index.18e27e15.js";
import { m as matchBreakpoint } from "./breakpoints-d5c2f627.f0d6212d.js";
import { D as DateTime_1, I as Info_1 } from "./luxon-761b9b2d.e4dd57df.js";
...
const LayoutGrid = class {
  ...
  render() {
    return h(Host, { key: "f9e0a0a0ca4ec617f5b7e957a717093b7e3fb695", class: {
      "no-margin": this.noMargin
    }, style: {
      "--ix-layout-grid-columns": `${this.columns}`,
      "--ix-layout-grid-gutter": `${this.gap}px`
    } }, h("slot", { key: "df02bf5f450c6a0edd561442d6d2cc03f690c41a" }));
  }
};
...
const Row = class {
  ...
  render() {
    return h(Host, { key: "989476c41cdc78bb5b26975cd96846a942f1ec59" }, h("slot", { key: "4550fe91ac3b9e29cd4399378cad6a166cfb0d49" }));
  }
};
