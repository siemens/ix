...
const Select = class {
  ...
  render() {
    var _a, _b, _c;
    return h(Host, { key: "9deb3dd4ac16bce59e388ddbd81d4d4d509e709b" }, h("div", { key: "21d5457598e63b89a5f7aa30e06c4cf1360097f7", class: {
      select: true,
    ...
    } }, h("div", { key: "35bb3c434fd6c907dd5d54f9f453e1141058d683", class: "input-container" }, h("div", { key: "ba714286898508c253a12a7c11377481f29426a0", class: "chips" }, this.isMultipleMode ? (_a = this.selectedItems) === null || _a === void 0 ? void 0 : _a.map((item) => h("ix-filter-chip", { disabled: this.disabled || this.readonly, key: item.value, onCloseClick: (e) => {
      e.preventDefault();
      e.stopPropagation();
      this.itemClick(item.value);
    } }, item.label)) : "", h("div", { key: "ca101926cd6ce38b5fc0bde07cdd748e9c362be8", class: "trigger" }, h("input", { key: "39fe2b0bb43dbc90203cd844eec93162caa24617", autocomplete: "off", "data-testid": "input", disabled: this.disabled, readOnly: this.readonly, type: "text", class: {
      ...
      if (this.editable)
        this.dropdownWrapperRef = ref;
    } }))))), h("ix-dropdown", { key: "e01c8552c625d99a140979ed0c5a8090e73b7193", ref: (ref) => this.dropdownRef = ref, show: this.dropdownShow, closeBehavior: this.isMultipleMode ? "outside" : "both", class: {
    ...
    } }, h("div", { key: "16f5a3c90e808228f40148f22084ea8a9e7fef51", class: {
      "select-list-header": true,
      hidden: this.hideListHeader || this.isDropdownEmpty
    }, title: this.i18nSelectListHeader }, this.i18nSelectListHeader), h("slot", { key: "54f5d943708db69a01adc1d2a016e263f8b1d3bf" }), h("div", { key: "18ffee3df4f3270ac1c639717715cf5f62827abd", ref: (ref) => this.addItemRef = ref, class: "d-contents" }), this.isAddItemVisible() ? h("ix-dropdown-item", { "data-testid": "add-item", icon: "plus", class: {
      "add-item": true
