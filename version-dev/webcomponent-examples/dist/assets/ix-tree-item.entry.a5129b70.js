...
const TreeItem = class {
  ...
  render() {
    var _a, _b, _c;
    return h(Host, { key: "01d4b219dd31534888b45a2afb438b5263006ed2", class: {
      selected: (_a = this.context) === null || _a === void 0 ? void 0 : _a.isSelected
    } }, h("div", { key: "09cf9df2ccf6f4dcc2d0abfb2e555a231e952e97", class: "icon-toggle-container", onClick: (e) => {
      e.preventDefault();
      this.toggle.emit();
    ...
    }, color: `color-${((_c = this.context) === null || _c === void 0 ? void 0 : _c.isExpanded) ? "primary" : "std-text"}` }) : null), h("div", { key: "c9510bf39ec4e931200679c6f2b56f94c5a448b2", class: "tree-node-container", onClick: () => {
      this.itemClick.emit();
    } }, this.text, h("slot", { key: "33abe46cbc28d86af20947e6d0a37e7cb9f1761a" })));
  }
};
