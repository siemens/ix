import { r as registerInstance, h, H as Host, g as getElement, c as createEvent } from "./index.18e27e15.js";
...
const GroupContextMenu = class {
  ...
  render() {
    return h(Host, { key: "88f7b1a2026b6960443a93c21c6ff46395b1163b" }, h("ix-icon-button", { key: "d57a46325a2e197a76bb4a25df505a3aa27f7d9b", class: { hide: !this.showContextMenu }, size: "24", ghost: true, icon: "context-menu" }), h("slot", { key: "1f191ee6f0aaf53a79d61c9ea0bfd2f4906d13a0", onSlotchange: () => this.onSlotChange() }));
  }
  get hostElement() {
