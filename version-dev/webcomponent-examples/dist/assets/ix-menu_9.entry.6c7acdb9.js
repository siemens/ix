import { r as registerInstance, c as createEvent, h, H as Host, g as getElement, f as forceUpdate } from "./index.fceb1a46.js";
...
const Menu = class {
  ...
  render() {
    return h(Host, { class: {
      ...
      [`mode-${this.mode}`]: true
    }, slot: "menu" }, h("div", { class: {
      menu: true,
      expanded: this.expand
    }, onClick: () => {
      this.resetActiveTab();
    } }, h("ix-burger-menu", { onClick: async () => this.toggleMenu(), expanded: this.expand, pinned: this.showPinned, class: {
      "burger-menu": true
