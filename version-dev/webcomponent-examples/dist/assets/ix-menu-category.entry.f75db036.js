...
const MenuCategory = class {
  ...
  render() {
    return h(Host, { key: "fe8b350622d7dbe0e72f93fb60c475b24070e668", class: {
      expanded: this.showItems
    } }, h("ix-menu-item", { key: "3d0d7b0db39b14ff39040308540fc191e50e28b9", class: "category-parent", active: this.isNestedItemActive(), notifications: this.notifications, icon: this.icon, onClick: (e) => this.onCategoryClicked(e) }, h("div", { key: "b504722df218f6d230cf2276ed9de5e923752184", class: "category" }, this.label, h("ix-icon", { key: "4026c1ec5a6b8f1bc3c9bfb99780ae6dc9050711", name: "chevron-down-small", class: {
      "category-chevron": true,
      "category-chevron--open": this.showItems
    } }))), h("div", { key: "882cb80ef4ded21b05d0c73523a0db7116c7032a", ref: (ref) => this.menuItemsContainer = ref, class: {
      "menu-items": true,
      "menu-items--expanded": this.showItems
    } }, this.showItems ? h("slot", null) : null), h("ix-dropdown", { key: "3c890ed19d1ad04f069d545099918a5349da9567", closeBehavior: "both", show: this.showDropdown, onShowChanged: ({ detail: dropdownShown }) => {
    ...
    } }, h("ix-dropdown-item", { key: "e765a902ce64bab5e4bf3c0af5e5a80a62457135", class: "category-dropdown-header" }, h("ix-typography", { key: "7c58db5f057f277ba34d8c03dbaa34a9c4b2bfb7", variant: "default-title-single", color: "std" }, this.label)), h("ix-divider", { key: "f6408b76cd0b4c19d2bf6260ee3a1cd9c41c91ec" }), h("slot", { key: "e2f21493e29857e86d6479cd41cdaafc7755203a" })));
  }
  get hostElement() {
