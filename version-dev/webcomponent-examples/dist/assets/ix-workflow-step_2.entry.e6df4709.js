...
const WorkflowStep = class {
  ...
  render() {
    ...
    return h(Host, { onClick: () => this.onStepClick() }, h("div", { tabIndex: 0, onClick: () => this.select(), class: {
      step: true,
...
const workflowStepsCss = ":host *,:host *::after,:host *::before{box-sizing:border-box}:host .steps{display:flex}:host .steps.vertical{display:block}";
