...
const EventListItem = class {
  ...
  render() {
    ...
    return h(Host, { key: "b57219ba81d7a60ccdf68d523e2e5750f46ae9f8", class: {
      disabled: this.disabled
    } }, h("div", { key: "5b1f4bb898842f3b56dea21d9609fd7fcb59c367", class: {
      "event-list-item": true,
      selected: this.selected,
      disabled: this.disabled
    } }, h("div", { key: "2a8cc68c539d9e829ad7fab61849a18b2290f4e9", class: `indicator ${!((_c = this.itemColor) !== null && _c !== void 0 ? _c : this.color) ? "indicator-empty" : ""}`, style: {
      "background-color": ((_d = this.itemColor) !== null && _d !== void 0 ? _d : this.color) ? color : "inherit",
      opacity: `${this.disabled ? 0.4 : 1}`
    } }), h("div", { key: "08663e91481c2b50263da5f0f383b01c98b724ee", class: "event-list-item-container" }, h("div", { key: "b50cd3fe26d907fc9486693fd244a138c1b4ac19", class: "event-content" }, h("slot", { key: "78039f56d141a9d5efa38bb0f710a63e063dbde3" })), this.chevron && h("ix-icon", { name: "chevron-right", size: "16", class: "chevron-icon" }))));
  }
};
