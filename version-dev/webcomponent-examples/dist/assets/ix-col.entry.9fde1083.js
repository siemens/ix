import { r as registerInstance, f as forceUpdate, h, H as Host } from "./index.435ccc59.js";
import { m as matchBreakpoint } from "./breakpoints-b8d59fd9.085d9a48.js";
const colCss = ":host{box-sizing:border-box;position:relative;flex-basis:0;flex-grow:1;width:100%;max-width:100%;min-height:1px;padding-left:calc(var(--ix-grid-gutter) * 0.5);padding-right:calc(var(--ix-grid-gutter) * 0.5)}";
const Col = class {
  constructor(hostRef) {
