...
const Toast = class {
  ...
  render() {
    ...
    return h(Host, { key: "61958706aeafdcd8caab81b30c1b21391be14e76", class: "animate__animated animate__fadeIn" }, h("div", { key: "4113cefa1125df0b1d558688a3e9643604ae2409", class: "toast-body", onPointerLeave: () => {
      this.touched = false;
    }, onPointerEnter: () => {
      this.touched = true;
    } }, this.type || this.icon ? h("div", { class: "toast-icon" }, this.getIcon()) : null, h("div", { key: "fd69fac6fe5bbb0ed79a88caa5371c144eb67209", class: "toast-content" }, this.toastTitle ? h("div", { class: "toast-title" }, this.toastTitle) : null, h("div", { key: "19861b23076083bbf0a81dd93360b469cf9b5719", class: "toast-message" }, h("slot", { key: "46c598bd3a3b716f28c897669396bd276de3a2dd" }))), h("div", { key: "d9cc6cc3ac3fb29ee8ef30b2435560d4188325af", class: "toast-close" }, h("ix-icon-button", { key: "ec5156fd66c4c86777fd7d18db04bf7921219128", icon: "close", size: "24", ghost: true, onClick: () => this.closeToast.emit() }))), this.autoClose ? h("div", { class: progressBarClass.join(" "), style: progressBarStyle, onAnimationEnd: () => {
      this.close();
    }, onTransitionEnd: () => {
      if (this.progress === 0) {
        this.close();
