...
const Upload = class {
  ...
  render() {
    return h(Host, { key: "bd827dc81d4b587c277eed8b2d7f9e0e53e6170a" }, h("div", { key: "cf838b553059a8374c241b2b152867e5b4315566", class: {
    ...
    }, onDragOver: (e) => this.fileOver(e), onDragLeave: () => this.fileLeave(), draggable: !this.disabled }, this.renderUploadState(), h("div", { key: "76c5b9128a3bf3837e4d6e0a67a002946f9a7839" }, h("input", { key: "ca4357f6a257ad0c0f65ba09bc647f8524cc6eac", multiple: this.multiple, type: "file", class: "upload-browser", id: "upload-browser", onChange: (e) => {
      this.fileChangeEvent(e);
    }, accept: this.accept }), h("ix-button", { key: "a19f009ad035876c429822266bc4d6e42265af57", tabindex: "-1", outline: true, onClick: () => this.inputElement.click(), disabled: this.disabled || this.state === UploadFileState.LOADING }, this.i18nUploadFile))));
  }
  get hostElement() {
