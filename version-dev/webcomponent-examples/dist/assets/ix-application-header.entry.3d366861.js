...
const ApplicationHeader = class {
  ...
  render() {
    return h(Host, { class: { [`breakpoint-${this.breakpoint}`]: true } }, this.breakpoint === "sm" ? h("ix-burger-menu", { onClick: () => this.onMenuClick(), expanded: this.menuExpanded }) : null, h("div", { class: "logo" }, h("slot", { name: "logo" })), h("div", { class: "name" }, this.name), h("slot", null));
  }
  get hostElement() {
