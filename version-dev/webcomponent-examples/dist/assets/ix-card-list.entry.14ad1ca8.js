...
const CardList = class {
  ...
  render() {
    return h(Host, { key: "54a63f1b336f25b15cb9c723b8347569de331fc3" }, h(CardListTitle, { key: "a8d0210506269c6efa5a26db9f6612733215da3a", isCollapsed: this.collapse, label: this.label, showAllLabel: this.i18nShowAll, showAllCounter: this.showAllCount === void 0 ? this.numberOfAllChildElements : this.showAllCount, onClick: () => this.onCardListVisibilityToggle(), onShowAllClick: (e) => this.onShowAllClick(e) }), h("div", { key: "a62241d4b0b7942b63e39b73785a48abf03c3872", class: {
      CardList__Overflow: true
    }, style: this.computeMaskLayer() }, h("div", { key: "23569910236f9f27a1302c9e4aec152895ce08c8", class: {
    ...
    }, onScroll: () => this.onCardListScroll() }, h("slot", { key: "7ddcc0cef252ef387a831d19c830ab8ba9f12220", onSlotchange: () => this.changeVisibilityOfSlotChildren() }), this.isShowMoreCardVisible() ? h("ix-card", { class: {
