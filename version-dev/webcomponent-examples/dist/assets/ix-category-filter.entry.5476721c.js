...
import { B as BaseButton } from "./base-button-355ac631.c050e44b.js";
...
const CategoryFilter = class {
  ...
  render() {
    var _a;
    return h(Host, { key: "cc3dc7c04df765937137a41cf3df4ca39252a6e3" }, h("form", { key: "f796cbde7dbe9be60be7efb49516d989ddc39e20", ref: (el) => this.formElement = el }, h("div", { key: "5d3474e987e954b6e8294b43fafa7cc09e120521", "read-only": this.readonly, class: {
      "input-container": true,
      disabled: this.disabled,
      focus: this.hasFocus,
      readonly: this.readonly,
      "no-icon": this.hideIcon
    } }, h("ix-icon", { key: "7b7a9bf1301c983b2f250997e66e68dcbc5200fc", color: this.getIconColor(), class: { "d-none": this.hideIcon }, name: this.icon, size: "16" }), h("div", { key: "1f8a3772207b60ba5c26f571fe9ec9818ae3c92c", class: "token-container" }, h("ul", { key: "f1a65953c53c72e9e1d89306d29bb5f8f3731465", class: "list-unstyled" }, this.filterTokens.map((value, index) => h("li", { key: value.toString(), class: {
    ...
    } }, (_a = this.categories[this.category]) === null || _a === void 0 ? void 0 : _a.label), h("input", { key: "3070133fa73d7ec6107689ddc1220a2edfc4ed73", class: {
      "text-input": true,
