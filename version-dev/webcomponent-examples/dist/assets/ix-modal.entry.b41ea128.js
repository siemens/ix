...
const Modal = class {
  ...
  render() {
    return h(Host, { key: "7c18080b0c96d74d23cc12c582f188fb0fe37d93", class: {
      visible: this.modalVisible,
      "no-backdrop": this.backdrop === false,
      "align-center": this.centered
    } }, h("div", { key: "c84592f03e4d511a139de95c1040b353dc7c1c7c", class: "dialog-backdrop" }, h("dialog", { key: "0ee0e087eec04a992e6d3267176dbcd15befb28f", "aria-modal": a11yBoolean(true), "aria-describedby": this.ariaAttributes["aria-describedby"], "aria-labelledby": this.ariaAttributes["aria-labelledby"], class: {
      modal: true,
      [`modal-size-${this.size}`]: true
    }, onClose: () => this.dismissModal(), onClick: (event) => this.onModalClick(event), onCancel: (e) => {
      e.preventDefault();
      this.dismissModal();
    } }, h("slot", { key: "97fd9e6adbe6287bc084546dcd3c4a0d472160a3" }))));
  }
  get hostElement() {
