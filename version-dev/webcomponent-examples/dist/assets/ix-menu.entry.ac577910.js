...
const Menu = class {
  ...
  render() {
    ...
    return h(Host, { key: "57ed22e20f5555a24082927f659fb3350e379714", class: {
      ...
      "burger-menu": true
    } }), this.breakpoint === "sm" && this.applicationLayoutContext.appSwitchConfig && h("ix-icon-button", { onClick: () => showAppSwitch(this.applicationLayoutContext.appSwitchConfig), icon: "apps", ghost: true, class: "app-switch" })), h("div", { key: "29ba7536d7dd3edf4c2e801290a7c60ef54c1648", id: "menu-tabs", style: {
      display: "contents"
