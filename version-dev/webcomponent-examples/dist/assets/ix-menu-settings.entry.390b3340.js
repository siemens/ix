import { r as registerInstance, c as createEvent, h, f as forceUpdate, H as Host, g as getElement } from "./index.18e27e15.js";
...
const MenuAbout = class {
  ...
  render() {
    return h(Host, { key: "0e32f39f65b33ea9404892b23017f3df81d49990", slot: "ix-menu-settings", class: {
      show: this.show
    } }, h("div", { key: "a7556fd9d6a07730862d2bbc3bdfe20ddcd4c15a", class: "settings-header" }, h("h2", { key: "d42cf6abee25a6672c0776fc1d19a476998f3d43", class: "text-h2" }, this.label), h("ix-icon-button", { key: "faad6491e1a0ff2bf4b4194baca6b77593028455", ghost: true, size: "24", icon: "close", onClick: (e) => this.close.emit({
      name: "ix-menu-settings",
      nativeEvent: e
    }) })), h("ix-tabs", { key: "311aae8427d5f1145af95c7df628576b56d2bd26" }, this.getTabItems()), h("slot", { key: "88a4fe0130a8432cb3bfca2d94e617ff2c98695c" }));
  }
  get el() {
...
MenuAbout.style = IxMenuSettingsStyle0;
export {
