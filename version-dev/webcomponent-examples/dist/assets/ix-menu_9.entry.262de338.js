import { r as registerInstance, c as createEvent, h, H as Host, g as getElement, f as forceUpdate } from "./index.f1cc59d7.js";
import { a as anime } from "./anime.es-185e9087.87a18bcc.js";
import { a as useContextConsumer, A as ApplicationLayoutContext } from "./context-d85805f3.26accaf2.js";
...
const Menu = class {
  ...
  componentDidLoad() {
    ...
    if (this.breakpoints !== void 0 && this.breakpoints.length > 0) {
  ...
  onBreakpointChange(mode) {
    ...
    if ((_b = this.applicationLayoutContext) === null || _b === void 0 ? void 0 : _b.hideHeader) {
      return;
    }
...
const MenuItem = class {
  ...
  render() {
    ...
    return h(Host, Object.assign({ class: {
      ...
      active: this.active
    } }, extendedAttributes), h("button", { class: "tab", title: this.title, tabIndex: 0, role: "listitem" }, h("ix-icon", { class: "tab-icon", name: (_a = this.icon) !== null && _a !== void 0 ? _a : this.tabIcon }), h("div", { class: "notification" }, this.notifications ? h("div", { class: "pill" }, this.notifications) : null), h("span", { class: "tab-text text-default" }, h("slot", null))));
  }
  get hostElement() {
    return getElement(this);
  }
