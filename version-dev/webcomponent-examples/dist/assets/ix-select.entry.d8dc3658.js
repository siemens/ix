...
import { O as OnListener } from "./listener-498990a0.9113cedf.js";
...
const Select = class {
  ...
  render() {
    ...
    } }, item.label)) : "", h("div", { class: "trigger" }, h("input", { autocomplete: "off", "data-testid": "input", disabled: this.disabled, readOnly: this.readonly, type: "text", class: {
