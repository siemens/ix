...
const DatetimePickerRework = class {
  ...
  render() {
    return h(Host, null, h("ix-layout-grid", { class: "no-padding" }, h("ix-row", null, h("ix-col", { class: "no-padding" }, h("ix-date-picker-rework", { ref: (ref) => this.datePickerElement = ref, corners: "left", range: this.range, onDateChange: (event) => this.onDateChange(event), from: this.from, to: this.to, format: this.dateFormat, minDate: this.minDate, maxDate: this.maxDate, weekStartIndex: this.weekStartIndex, standaloneAppearance: false })), h("ix-col", { class: "no-padding" }, h("ix-time-picker-rework", { class: "min-width", ref: (ref) => this.timePickerElement = ref, corners: "right", standaloneAppearance: false, showHours: this.showHour, showMinutes: this.showMinutes, showSeconds: this.showSeconds, onTimeChange: (event) => this.onTimeChange(event), format: this.timeFormat, time: this.time }))), h("ix-row", null, h("ix-col", null, h("ix-button", { class: "btn-select-date btn-md-width", onClick: () => this.onDone() }, this.textSelectDate)))));
  }
};
DatetimePickerRework.style = datetimePickerReworkCss;
export {
  DatetimePickerRework as ix_datetime_picker_rework
};
