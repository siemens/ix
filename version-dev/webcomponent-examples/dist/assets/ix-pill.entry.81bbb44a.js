...
const Pill = class {
  ...
  render() {
    ...
    return h(Host, { key: "e0cfc6b9b261222744a4c2772d96a53c581c8a7c", style: this.variant === "custom" ? {
      "--ix-icon-button-color": (_b = this.pillColor) !== null && _b !== void 0 ? _b : this.color
    } : {}, title: this.el.textContent, class: {
      "align-left": this.alignLeft
    } }, h("div", { key: "40aba41d5c927a4477eb74aefa43a5065012f026", style: Object.assign({}, customStyle), class: {
      container: true,
      ...
      closable: false,
      icon: !!this.icon
    } }, h("ix-icon", { key: "1caa299505c7dc6610442e0220659f069c6c0d61", class: {
      "with-icon": true,
      hidden: this.icon === void 0 || this.icon === ""
    }, name: this.icon, size: "16" }), h("span", { key: "3e5f1d88e8d548ac5836f8c5c43ba55413e1a57f", class: "slot-container" }, h("slot", { key: "7b2330ace586ab765fe841401d20fb4ae8cc2a26" }))));
  }
  get el() {
