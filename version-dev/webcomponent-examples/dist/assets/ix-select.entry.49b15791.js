import { r as registerInstance, c as createEvent, h, H as Host, g as getElement } from "./index.fe983127.js";
...
const Select = class {
  ...
  render() {
    ...
    } }, h("div", { key: "300d5e259d4bb3c65a888e1f0842897e06f1a160", class: "input-container" }, h("div", { key: "d59a18d4b7f988ce950074b0bb3127c2c285c882", class: "chips" }, this.isMultipleMode ? (_a = this.selectedItems) === null || _a === void 0 ? void 0 : _a.map((item) => h("ix-filter-chip", { disabled: this.disabled || this.readonly, key: item.value, onCloseClick: (e) => {
      e.preventDefault();
      e.stopPropagation();
      this.itemClick(item.value);
    } }, item.label)) : "", h("div", { key: "fafd86131a6ecfb882c5f93787b44c4a699c0db1", class: "trigger" }, h("input", { key: "1bf6fa1ee03af5ce7069f62d6529234b72d40467", autocomplete: "off", "data-testid": "input", disabled: this.disabled, readOnly: this.readonly, type: "text", class: {
