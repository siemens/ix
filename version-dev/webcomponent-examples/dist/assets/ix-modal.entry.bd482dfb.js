...
const Modal = class {
  ...
  render() {
    return h(Host, { key: "75913cb8d02d562cb177d0a9109c7abfce0c589d", class: {
      visible: this.modalVisible,
      "no-backdrop": this.backdrop === false,
      "align-center": this.centered
    } }, h("div", { key: "f3452aa76f442e933189a10f3f5b5bf124718ae2", class: "dialog-backdrop" }, h("dialog", { key: "ee154e8081284d0d603b05aa575c14897b3d984c", "aria-modal": a11yBoolean(true), "aria-describedby": this.ariaAttributes["aria-describedby"], "aria-labelledby": this.ariaAttributes["aria-labelledby"], class: {
      modal: true,
      [`modal-size-${this.size}`]: true
    }, onClose: () => this.dismissModal(), onClick: (event) => this.onModalClick(event), onCancel: (e) => {
      e.preventDefault();
      this.dismissModal();
    } }, h("slot", { key: "69cc8d56a658736d2665e4606a55d2009eed1c38" }))));
  }
  get hostElement() {
