...
const TabItem = class {
  ...
  render() {
    return h(Host, { key: "cbb959666da903b78cd5e0f1e439277c645536a8", class: this.tabItemClasses({
    ...
    } }, h("div", { key: "8e742db0142001fe4c870fcb755487c0a17db183", class: {
      circle: this.rounded,
      text: !this.rounded,
      selected: this.selected,
      disabled: this.disabled
    } }, h("slot", { key: "51022cf1cfea87bce353ee1dddcc1aaf37810c8b" })), h("div", { key: "e5544ce11ec6e621b67cfc1f25ef7ca9cca7be35", class: {
      counter: true,
      selected: this.selected,
...
const Tabs = class {
  ...
  render() {
    return h(Host, { key: "4da465ae6f16304ed0f63a0942788ed09a9eb226" }, h("div", { key: "7b2a73ff59c50ea1f96a84b2136c9e14cd687ebb", class: "arrow", "data-arrow-left": true, onClick: () => this.move(this.scrollAmount, true) }, h("ix-icon", { key: "1f3b51ebc1aa6f557c66e420b581cbc1ad317a58", name: "chevron-left-small" })), h("div", { key: "647822dd1f708e2573514c63e8ac817009c98a7f", class: {
      "tab-items": true,
    ...
    } }, h("div", { key: "01c06bb52c5c1030c2e6888728117034b4797c85", class: "items-content" }, h("slot", { key: "d3f0202e2a2660aa90d065ea6c0d430709c71e01" }))), h("div", { key: "95311fd3f4f73d69eeee08e26d643d4f704123b1", class: "arrow right", "data-arrow-right": true, onClick: () => this.move(-this.scrollAmount, true) }, h("ix-icon", { key: "b526a9b908da549e85bfe49874621be00ee2edae", name: "chevron-right-small" })));
  }
  get hostElement() {
