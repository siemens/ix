...
const ExpandingSearch = class {
  ...
  render() {
    return h(Host, { key: "6a2588f177ecc33a8e9fe105d1e6d1bdb474acd7", class: {
      expanded: this.expanded,
      "right-position": this.expanded,
      fullWidth: this.fullWidth
    } }, h("ix-icon-button", { key: "d70a207d4a7eb845f79db17633055160826ac8f5", size: this.expanded ? "16" : "24", icon: this.icon, ghost: true, variant: "primary", "data-testid": "button", onClick: () => this.expandInput(), tabindex: this.expanded ? -1 : 0, color: this.hasFocus ? "input-search-icon--color--focus" : void 0, class: {
      "btn-search": true,
      "btn-search--expanded": this.expanded
    } }), h("div", { key: "41906509762b7fa32c4e5454f12e7f0a24c1745d", class: {
      expanded: this.expanded,
      fullWidth: this.fullWidth,
      collapsed: !this.expanded,
      "disable-pointer": !this.expanded,
      "input-container": true
    }, "data-testid": "input-wrapper" }, h("input", { key: "448b100091d8b754500c11dd9075ce1d9f9eacf7", class: {
      "form-control": true,
      input: this.expanded,
      "disable-pointer": !this.expanded,
