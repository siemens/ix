...
if (process.env.DO_ACCESSIBILITY_AUDIT) {
  test('toggle-button-primary-outline - accessibility check', async ({ page }) => {
    await page.goto('/preview/toggle-button-primary-outline');
...
test('toggle-button-primary-outline', async ({ page }) => {
  await page.goto('/preview/toggle-button-primary-outline');
  ...
  await expect(page.locator('body')).toMatchAriaSnapshot({
    name: 'toggle-button-primary-outline.aria-snapshot.yaml',
  });
});
