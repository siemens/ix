...
if (process.env.DO_ACCESSIBILITY_AUDIT) {
  test('toggle-button-primary-ghost - accessibility check', async ({ page }) => {
    await page.goto('/preview/toggle-button-primary-ghost');
...
test('toggle-button-primary-ghost', async ({ page }) => {
  await page.goto('/preview/toggle-button-primary-ghost');
  ...
  await expect(page.locator('body')).toMatchAriaSnapshot({
    name: 'toggle-button-primary-ghost.aria-snapshot.yaml',
  });
});
