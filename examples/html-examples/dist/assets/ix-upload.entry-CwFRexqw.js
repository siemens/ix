...
const Upload = class {
  ...
  render() {
    ...
    return h(Host, Object.assign({ key: "00c05373c715388a90804b8b2eabf689d60acc0f" }, a11y, { "aria-disabled": disabled }), h("div", { key: "66db4112acaab05bde6107578684e3a1fb1de614", class: {
    ...
    }, onDragOver: (e) => this.fileOver(e), onDragLeave: () => this.fileLeave(), draggable: !this.disabled }, this.renderUploadState(), h("div", { key: "dafe7449f460a9409b9ee2de54f00b15865b2883" }, h("input", { key: "797d303d7dd90f4c611a65deb80d41261c4a9cae", "aria-label": ariaLabel, "aria-disabled": disabled, multiple: this.multiple, type: "file", class: "upload-browser", id: "upload-browser", tabindex: "-1", onChange: (e) => {
      this.fileChangeEvent(e);
    }, accept: this.accept, disabled }), h("ix-button", { key: "e8993aa0d8a3b07dfdc49f3d6c8616b5ce2e89a0", variant: "secondary", "aria-disabled": disabled, onClick: () => this.inputElement.click(), disabled }, this.i18nUploadFile))));
  }
  get hostElement() {
