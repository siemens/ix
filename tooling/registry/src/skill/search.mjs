...
const COMPONENT_KINDS = ['component', 'example', 'pattern'];
...
function usageError(message) {
  throw new SearchError(
    `${message}\nUsage: search.mjs [--query <text>] [--figma-id <id> ...] [--component-name <name> ...] [--kind component|example|pattern] [--framework html|react|angular|angular-standalone|vue] [--version <version-or-tag>] [--project-dir <path>] [--registry-url <url>] [--limit <n>] [--local-index <file>]`,
    'error'
  );
}
