...
const checkboxGroupCss = () => `:host{display:inline-block;position:relative}:host .checkbox-container{display:flex;flex-direction:column;gap:0.5rem;margin:0.375rem 0;flex-wrap:wrap}:host .checkbox-container.row-layout{flex-direction:row}`;
...
const CheckboxGroup = class {
  ...
  render() {
    return h(Host, { key: "70b6117996506553cddddbcf8c80252d65e4e634", ref: this.groupRef, onIxBlur: () => this.touched = true }, h("ix-field-wrapper", { key: "6ac7a3bb045c485d96dfdf738e78824cf330979e", label: this.label, helperText: this.helperText, invalidText: this.invalidText, infoText: this.infoText, validText: this.validText, warningText: this.warningText, showTextAsTooltip: this.showTextAsTooltip, isInvalid: this.isInvalid, isInfo: this.isInfo, isValid: this.isValid, isWarning: this.isWarning, controlRef: this.groupRef }, h("div", { key: "3f464db5e5956a8930b0a6ab6227399a39b2dfab", class: {
      "checkbox-container": true,
      "row-layout": this.direction === "row"
    } }, h("slot", { key: "fa2378a86fd32300535daa1ad1e09fad960e4b0c" }))));
  }
};
__decorate([
