...
const Menu = class {
  ...
  render() {
    ...
    return h(Host, { key: "5f3db6167eb5ce4de1db9dc101d7a9c070fbe688", class: {
      expanded: this.expand,
      [`breakpoint-${this.breakpoint}`]: true
    }, slot: "menu" }, h("nav", { key: "c1db698b552c5142a201e8f1e8326212baf46ce6", "aria-label": this.applicationName, class: {
      menu: true,
      expanded: this.expand
    } }, h("div", { key: "c8946a1f8ff5af63b73d6ca7c650105de15b8f8d", class: "menu-buttons" }, this.breakpoint !== "sm" && h("ix-menu-expand-icon", { key: "b30b834cdee6f1475b6d7c5649550dc091f0c01d", breakpoint: this.breakpoint, expanded: this.expand, "i18n-expand": this.i18nExpand, "i18n-collapse": this.i18nCollapse, pinned: this.pinned, class: "menu-expand-icon", onClick: async () => this.toggleMenu(), "data-testid": "expand-collapse-menu" }), this.breakpoint === "sm" && this.applicationLayoutContext?.appSwitchConfig && h("ix-icon-button", { key: "63910cbfa3ed354538e829d8c6900b2ae6faca10", onClick: () => {
      this.showAppSwitch();
    }, icon: iconApps, variant: "subtle-tertiary" })), h("div", { key: "6f7e5fb72bc4c09e5cfabf1d55595bdf48499cee", role: "menubar", "aria-orientation": "vertical", "aria-label": this.i18nAriaLabelMenu, "aria-description": this.i18nNavigationHint, class: {
      "menu-navigation": true,
      "menu-navigation--fill": this.shouldFillMenuNavigation
    }, tabIndex: 0, onKeyDown: (e) => this.handleMenuKeyDown(e), onFocusin: (e) => this.handleMenuFocusIn(e), onFocusout: () => this.resetRovingTabIndex() }, h("div", { key: "a739c7bfbcfff364418cbd9a3699a9efe71f4dfa", id: "menu-tabs", style: {
      display: "contents"
    }, onClick: (e) => this.onMenuItemsClick(e) }, h("div", { key: "ba21343f2dc6db427a6d4b2390b5be0cbd996d42", class: "tabs-shadow-container" }, h("div", { key: "3dc75541692ba7abb93eb639d6ea7c9b6d66179d", class: {
      "tabs--shadow": true,
      "tabs--shadow-top": true,
      "tabs--shadow--show": this.itemsScrollShadowTop
    } }), h("div", { key: "a09efcda59cf520e61a6892ab6dd30c55e5915dc", class: {
      tabs: true,
      "show-scrollbar": this.expand
    }, onScroll: () => this.handleOverflowIndicator() }, h("div", { key: "9563045a62e17bb7a25948bbba6e9defdfa281be", class: "menu-avatar" }, h("slot", { key: "bb0448845ab4b6c4e41bd88742135f0fe6d747e7", name: "ix-menu-avatar" })), h("slot", { key: "517f51f0e35376ca913a8a0c83f062428a210f16", name: "home" }), this.breakpoint !== "sm" || !this.isHiddenFromViewport() ? h("slot", null) : null), h("div", { key: "821f4be9c50c78138e430fcf1db1da61d86d7673", class: {
      "tabs--shadow": true,
      "tabs--shadow-bottom": true,
      "tabs--shadow--show": this.itemsScrollShadowBottom
    } }))), h("div", { key: "8afb8abd44588e2330ed638e275009d63086aa1c", onClick: (e) => this.onMenuItemsClick(e) }, h("slot", { key: "ae16dabe2f33e21aece643794986069a6f63c9da", name: "bottom", onSlotchange: () => this.updateBottomSlotState() })), h("div", { key: "6983268436dbc5751970d6951dec92c81e37cd6e", class: "bottom-tab-divider" }), h("div", { key: "c27bf1ed51c3510cfde118f2f13d7300ba843499", class: "menu-utility-controls" }, this.settings ? h("ix-menu-item", { disabled: this.isHiddenFromViewport(), id: "settings", class: {
      "internal-tab": true,
      "bottom-tab": true,
    ...
    }, icon: iconInfo, onClick: async () => this.toggleAbout(!this.showAbout), label: this.i18nLegal, "aria-haspopup": "dialog", "aria-expanded": this.showAbout.toString(), "aria-controls": "menu-overlay" }) : null)), h("div", { key: "60e17fc67ebaf713d5a92885029c728f3f15d82b", id: "popover-area" })), h("section", { key: "b75c8452215f7656bad8bd174452b7a87004a7a4", id: "menu-overlay", role: "dialog", "aria-label": overlayLabel, class: {
      "menu-overlay": true,
      ...
      this.checkTransition();
    } }, h("div", { key: "25c6801e3b86ee237874737b75b178a9c2b4949d", class: "menu-overlay-container" }, this.showSettings ? h("slot", { name: "ix-menu-settings" }) : null), h("div", { key: "5c26b1c1a72cb138726cb4e94fb309242064ed2d", class: "menu-overlay-container" }, this.showAbout ? h("slot", { name: "ix-menu-about" }) : null)));
  }
  static get watchers() {
    return {
      "expand": [{
