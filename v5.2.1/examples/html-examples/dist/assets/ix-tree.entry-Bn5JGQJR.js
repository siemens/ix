...
const Tree = class {
  ...
  render() {
    return h(Host, { key: "32da3560b48f5b5e0e9e2c2239302f17e70a9001", onClick: (event) => this.onTreeItemClick(event) }, h("slot", { key: "81b75160e3c681151267e558af0e7c847559e106" }));
  }
  static get watchers() {
    return {
      "model": [{
