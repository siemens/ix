import { g as getElement, r as registerInstance, c as createEvent, h, H as Host } from "./global-Do6maBom.js";
...
const Upload = class {
  ...
  render() {
    ...
    return h(Host, { key: "7351c1d7aeca85edf0f5c8de88f3a72a20d36b19", ...a11y, "aria-disabled": disabled }, h("div", { key: "311a9689762e907949c222689641d744187f09b8", class: {
    ...
    }, onDragOver: (e) => this.fileOver(e), onDragLeave: () => this.fileLeave() }, this.renderUploadState(), h("div", { key: "a4db389ce321d91229e84acffa638842bd2b69ea" }, h("input", { key: "bbf245abf3e6c121a1e0fec063eee52c21971d62", "aria-label": ariaLabel, "aria-disabled": disabled, multiple: this.multiple, type: "file", class: "upload-browser", id: "upload-browser", ...directoryAttributes, tabindex: "-1", onChange: (e) => {
      this.fileChangeEvent(e);
    }, accept: this.accept, disabled }), h("ix-button", { key: "440663ff8a5c2cda6de92ba948d0a85175e25b81", variant: "secondary", "aria-disabled": disabled, onClick: () => this.inputElement.click(), disabled }, this.i18nUploadFile ?? (this.directoryUpload ? "Upload folder…" : "Upload file…")))));
  }
};
