...
import { c as createPickerValidityStateTracker, a as addDisposableChangesAndVisibilityObservers, b as adjustPaddingForStartAndEnd, h as handleSubmitOnEnterKeydown, S as SlotEnd, o as onInputBlurWithChange, d as SlotStart, e as emitPickerValidityState } from "./input.fc-Cwmx0lGN-CUAAuycg.js";
...
const DateInput = class extends Mixin(...DefaultMixins, InputPickerMixin) {
  ...
  render() {
    ...
    return h(Host, { key: "5b35bcf562a7ad94ae7a05fab6897c2c433c7757", class: {
      ...
      this.closeDropdown();
    } }, h("ix-field-wrapper", { key: "d1a09d8d3c0b4614bffd34fbd6f359d6235571d5", label: this.label, helperText: this.helperText, isInvalid: this.isInvalid, invalidText, infoText: this.infoText, isInfo: this.isInfo, isWarning: this.isWarning, warningText: this.warningText, isValid: this.isValid, validText: this.validText, showTextAsTooltip: this.showTextAsTooltip, required: this.required, controlRef: this.inputElementRef }, this.renderInput()), h("ix-dropdown", { key: "ec59bafd9329c29a63e0adcc06142d74bf5f7381", "data-testid": "date-dropdown", trigger: this.inputElementRef.waitForCurrent(), ref: this.dropdownElementRef, closeBehavior: "outside", enableTopLayer: this.enableTopLayer, suppressOverflowBehavior: true, show: this.show, onShowChanged: (event) => {
      ...
      return true;
    }, keyboardActivationKeys: ["ArrowUp", "ArrowDown"] }, h("ix-date-picker", { key: "4370582d1b36f63903dceedd08587dd373d63939", ref: this.datepickerRef, format: this.format, locale: this.locale, singleSelection: true, from: this.from ?? "", minDate: this.minDate, maxDate: this.maxDate, onDateChange: (event) => {
