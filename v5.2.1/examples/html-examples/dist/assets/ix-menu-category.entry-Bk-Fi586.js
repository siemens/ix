...
const MenuCategory = class extends Mixin(...DefaultMixins, InheritAriaAttributesMixin) {
  ...
  render() {
    ...
    return h(Host, { key: "5e2ea1050f7e743f5e82c716f572e73c71420b6d", class: {
    ...
    } }, h("ix-menu-item", { key: "033b1283117453a4627e4803fa01046eba4fb99a", ...inheritedA11yWithoutRole, "aria-haspopup": "menu", "aria-expanded": this.showItems || this.showDropdown ? "true" : "false", id: this.categoryId, ref: this.categoryParentRef, class: "category-parent", active: this.isNestedItemActive(), notifications: this.notifications, icon: this.icon, onClick: (e) => this.onCategoryClick(e), onKeyDown: (event) => this.onKeyDown(event), tooltipText: this.tooltipText, isCategory: true, menuCategoryLabel: this.label }, h("span", { key: "6e942ab9578c2a056785bdd999a479a13f1c3d8c", class: "category" }, h("span", { key: "43901ec266ba7d2bb0f879c16cd03bc5974de3d2", class: "category-text" }, this.label), h("ix-icon", { key: "56bcabb7c798d44e78c28aa2312488ea00488518", name: iconChevronDownSmall, class: {
      "category-chevron": true,
      "category-chevron--open": this.showItems
    }, "aria-hidden": "true" }))), h("div", { key: "0c478982cb7fa465a8a9e8b342661d7eb9103437", ref: (ref) => this.menuItemsContainer = ref, class: {
      "menu-items": true,
      "menu-items--expanded": this.showItems,
      "menu-items--collapsed": !this.showItems
    }, role: "menu", "aria-labelledby": this.categoryId, onKeyDown: (e) => this.onMenuItemsKeyDown(e) }, this.showItems ? h("slot", null) : null), h("ix-dropdown", { key: "c231a3202558d2f04a6e95c9f73a9dd57a60b532", ref: this.dropdownRef, hostRole: "menu", "aria-label": this.label, closeBehavior: "both", show: this.showDropdown, onShowChange: ({ detail }) => this.onDropdownShowChange(detail), onShowChanged: ({ detail }) => this.onDropdownShowChanged(detail), class: "category-dropdown", anchor: this.hostElement, placement: "right-start", offset: {
      mainAxis: 3
    ...
    }, onFocusout: () => this.onDropdownFocusOut() }, h("ix-dropdown-item", { key: "bc17bc4b1f78c500a1198e9cb0dff6ae15aef21a", class: "category-dropdown-header", tabindex: -1, "aria-hidden": "true" }, h("ix-typography", { key: "a335c29bf1bdeee2d2a58050b403d4a94df2ba6f", format: "label", bold: true, textColor: "std" }, this.label)), h("ix-divider", { key: "32d0cc4cfbb8b3590086756a4a17d5419e23398a" }), h("slot", { key: "ccd487bf41ffa74173a056b05b5641183de0b974" })));
  }
