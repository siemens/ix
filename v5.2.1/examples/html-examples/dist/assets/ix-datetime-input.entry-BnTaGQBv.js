...
import { c as createPickerValidityStateTracker, h as handleSubmitOnEnterKeydown, e as emitPickerValidityState, a as addDisposableChangesAndVisibilityObservers, b as adjustPaddingForStartAndEnd, S as SlotEnd, f as onInputFocus, o as onInputBlurWithChange, d as SlotStart } from "./input.fc-Cwmx0lGN-CUAAuycg.js";
import { i as isWithinTimePickerConstraints, g as getTimePickerConstraintBounds } from "./time-picker-constraints-Bsg2RskF-BAygNgGp.js";
...
const DatetimeInput = class extends Mixin(...DefaultMixins, InputPickerMixin) {
  ...
  render() {
    ...
    return h(Host, { key: "09fb37b1e7e0f237346dedf442f85fd62e320796", class: {
      disabled: this.disabled,
      readonly: this.readonly
    } }, h("ix-field-wrapper", { key: "d5212bcac921bace2619763e8f68e38c6023272c", controlRef: this.inputElementRef, helperText: this.helperText, infoText: this.infoText, invalidText, isInfo: this.isInfo, isInvalid: this.isInvalid, isValid: this.isValid, isWarning: this.isWarning, label: this.label, required: this.required, showTextAsTooltip: this.showTextAsTooltip, validText: this.validText, warningText: this.warningText }, this.renderInput()), h("ix-dropdown", { key: "efd159c13a41e64ab0bd8c9977ce96c3ee3ce93e", class: "datetime-dropdown", closeBehavior: "outside", "data-testid": "datetime-dropdown", enableTopLayer: this.enableTopLayer, ref: this.dropdownElementRef, show: this.show, suppressOverflowBehavior: true, trigger: this.inputElementRef.waitForCurrent(), onShowChanged: (event) => {
