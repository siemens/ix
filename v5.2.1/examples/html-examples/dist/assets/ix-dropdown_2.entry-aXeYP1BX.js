...
import { q as queryElements, a as IX_FOCUS_VISIBLE, I as IX_FOCUS_VISIBLE_ACTIVE, c as focusElement, d as focusFirstDescendant, e as focusLastDescendant, b as focusElementInContext } from "./focus-utilities-6ZxKp7Jn-D8qr1Jms.js";
import { D as DefaultMixins, r as removeVisibleFocus, h as hasKeyboardMode } from "./component-DqJSHc3A-D5InBSMm.js";
import { m as makeRef } from "./make-ref-Djkc69iv-BpP6uHEs.js";
import { r as requestAnimationFrameNoNgZone } from "./requestAnimationFrame-BEuV0Xpe-CBtvTq-Q.js";
import { d as dropdownController, h as hasDropdownItemWrapperImplemented } from "./dropdown-controller-Jfg3ZWk6-Dkh7kLy3.js";
...
const dropdownCss = () => `@charset "UTF-8";:host{--ix-dropdown--background:var(--si-sys-background-3);--ix-dropdown--border-radius:var(--theme-default-border-radius);--ix-dropdown--z-index:var(--theme-z-index-dropdown);--ix-dropdown--box-shadow:var(--si-sys-effects-shadow-4);--ix-dropdown--color:var(--si-sys-text-primary);--ix-dropdown-header--color:var(--si-sys-text-secondary)}:host{background-color:var(--ix-dropdown--background);border-radius:var(--ix-dropdown--border-radius);min-width:0px;z-index:var(--ix-dropdown--z-index);box-shadow:var(--ix-dropdown--box-shadow);padding:0.25rem 0px}:host *,:host *::after,:host *::before{box-sizing:border-box}:host *{--ix-scrollbar-border:var(--si-sys-border-4);--ix-scrollbar-background:var(--si-sys-background-1)}:host *::-webkit-scrollbar-button{display:none}@-moz-document url-prefix(){:host *{scrollbar-color:var(--ix-scrollbar-border) var(--ix-scrollbar-background);scrollbar-width:thin}}:host *{}:host *::-webkit-scrollbar{width:0.5rem;height:0.5rem}:host *{}:host *::-webkit-scrollbar-track{border-radius:5px;background:var(--si-sys-background-1)}:host *::-webkit-scrollbar-track:hover{background:var(--si-sys-background-1)}:host *{}:host *::-webkit-scrollbar-thumb{border-radius:5px;background:var(--si-sys-border-4)}:host *{}:host *::-webkit-scrollbar-thumb:hover{background:var(--si-sys-border-2)}:host *::-webkit-scrollbar-corner{display:none}:host .dropdown-header{display:flex;align-items:center;height:2.5rem;color:var(--ix-dropdown-header--color);padding:0 1rem}:host(.overflow){max-height:calc(50vh - 3rem);overflow-y:auto}:host(:not(.show)){display:none !important}.dialog{margin:0;border:none;outline:none;padding:0.25rem 0px;min-width:0;max-width:100vw;width:-moz-max-content;width:max-content;height:-moz-fit-content;height:fit-content;background-color:var(--ix-dropdown--background);border-radius:var(--ix-dropdown--border-radius);box-shadow:var(--ix-dropdown--box-shadow);overflow-x:visible;overflow-y:visible;inset:unset;color-scheme:inherit;color:var(--ix-dropdown--color);box-sizing:border-box}.dialog *,.dialog *::after,.dialog *::before{box-sizing:border-box}.dialog .dropdown-container{display:block;position:relative}.dialog .dropdown-header{display:flex;align-items:center;height:2.5rem;color:var(--ix-dropdown-header--color);padding:0 1rem}.dialog.overflow{max-height:calc(50vh - 3rem);overflow-y:auto}`;
let sequenceId = 0;
const Dropdown = class extends Mixin(...DefaultMixins) {
  ...
  render() {
    ...
    return h(Host, { key: "3194534204ccd95f33b319841726c16d43fac731", ...ariaAttributes, "aria-modal": "true", "data-ix-dropdown": this.dropdownElementId, "data-ix-focus-trap": true, class: {
      "dropdown-menu": true,
      show: this.show,
...
const dropdownItemCss = () => `@charset "UTF-8";:host{--ix-dropdown-item-checkmark--color:var(--si-sys-text-accent);--ix-dropdown-item-icon--color:var(--si-sys-text-primary);--ix-dropdown-item--color--disabled:var(--si-sys-text-disabled);--ix-dropdown-item--border-color--focus:var(--si-sys-effects-focus);--ix-dropdown-item--outline-color--focus:var(--si-sys-effects-focus)}:host{display:flex;flex-direction:row;position:relative;height:2.5rem;width:auto;overflow:hidden;cursor:pointer}:host *,:host *::after,:host *::before{box-sizing:border-box}:host *{--ix-scrollbar-border:var(--si-sys-border-4);--ix-scrollbar-background:var(--si-sys-background-1)}:host *::-webkit-scrollbar-button{display:none}@-moz-document url-prefix(){:host *{scrollbar-color:var(--ix-scrollbar-border) var(--ix-scrollbar-background);scrollbar-width:thin}}:host *{}:host *::-webkit-scrollbar{width:0.5rem;height:0.5rem}:host *{}:host *::-webkit-scrollbar-track{border-radius:5px;background:var(--si-sys-background-1)}:host *::-webkit-scrollbar-track:hover{background:var(--si-sys-background-1)}:host *{}:host *::-webkit-scrollbar-thumb{border-radius:5px;background:var(--si-sys-border-4)}:host *{}:host *::-webkit-scrollbar-thumb:hover{background:var(--si-sys-border-2)}:host *::-webkit-scrollbar-corner{display:none}:host .dropdown-item{all:unset;display:flex;flex-direction:row;align-items:center;position:relative;height:calc(100% - 2px);border:0.0625rem solid transparent;white-space:nowrap;width:calc(100% - 0.5rem - 1.5rem);padding:0 0.5rem;padding-right:1.5rem}:host .dropdown-item.no-checked-field{width:calc(100% - 1rem - 1.5rem);padding:0 1rem;padding-right:1.5rem}:host .dropdown-item-checked{display:flex;align-items:center;justify-content:center;position:relative;height:100%;width:1rem;min-width:1rem;margin-right:0.5rem;color:var(--ix-dropdown-item-checkmark--color)}:host .dropdown-item-icon{margin-right:0.5rem;color:var(--ix-dropdown-item-icon--color)}:host .dropdown-item-text{display:block;position:relative;overflow:hidden;text-overflow:ellipsis;white-space:pre}:host .dropdown-item-end{margin-left:auto}:host(.icon-only) .dropdown-item-icon{margin-right:0px}:host(.icon-only) .dropdown-item-checked{display:none}:host(.icon-only) .dropdown-item{width:calc(100% - 0.5rem - 0.5rem);padding:0 0.5rem;padding-right:0.5rem}:host(.submenu) .dropdown-item{width:calc(100% - 0.5rem - 0.5rem);padding:0 0.5rem;padding-right:0.5rem}:host(:not(.disabled):not(:disabled).hover),:host(:not(.disabled):not(:disabled):hover){background-color:var(--si-sys-background-hover)}:host(:not(.disabled):not(:disabled).active),:host(:not(.disabled):not(:disabled):active){background-color:var(--si-sys-background-active)}:host(.disabled){pointer-events:none;color:var(--ix-dropdown-item--color--disabled) !important}:host(.disabled) .dropdown-item-icon{color:var(--ix-dropdown-item--color--disabled) !important}:host(:focus-visible){outline:none}:host(:focus-visible) .dropdown-item{border-color:var(--ix-dropdown-item--border-color--focus)}:host(.ix-focused){outline:none}:host(.ix-focused) .dropdown-item{border-color:var(--ix-dropdown-item--border-color--focus)}:host(.outline-visible){outline:0.0625rem solid var(--ix-dropdown-item--outline-color--focus);outline-offset:-0.0625rem}:host([hidden]){display:none !important}`;
const DropdownItem = class extends Mixin(...DefaultMixins, ComponentIdMixin, FocusVisibleMixin) {
  ...
  render() {
    ...
    return h(Host, { key: "b127711c1216db0c78a4f548ada7b53c8d889fc3", id, role: this.itemRole, "aria-disabled": a11yBoolean(this.disabled), "aria-label": this.hostElement.ariaLabel ?? this.ariaLabelButton, class: {
      hover: this.hover,
    ...
    }, ...submenuAriaAttributes }, h("div", { key: "a315b9ac4e605cc72943aefe59006c61584a1142", class: {
      "dropdown-item": true,
      "no-checked-field": this.suppressChecked,
      disabled: this.disabled
    } }, !this.suppressChecked ? h("div", { class: "dropdown-item-checked" }, this.checked ? h("ix-icon", { "aria-hidden": "true", class: "checkmark", name: iconSingleCheck, size: "16" }) : null) : null, this.icon ? h("ix-icon", { class: "dropdown-item-icon", name: this.icon, "aria-label": this.ariaLabelIcon }) : null, h("div", { key: "4910db1d84b6ce9af4fb9fd2e1dea4ce019f00c8", class: "dropdown-item-text" }, this.label, h("slot", { key: "1b8f1eb510854339623fc2caa0c1d8487817fb66" })), h("div", { key: "6cc4bd918d82fbf06ef942d625b90f32dd849033", class: "dropdown-item-end" }, h("slot", { key: "9030d4aa6a9d800eebfbf35a0297e2748294c7a7", name: "end" }), this.isSubMenu ? h("ix-icon", { name: iconChevronRightSmall, class: "submenu-icon" }) : null)));
  }
  static get watchers() {
    return {
      "ixFocusVisible": [{
