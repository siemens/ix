...
const Radio = class {
  ...
  render() {
    ...
    return h(Host, { key: "69d99cc5f2db4487f1b9638b4f13f17a62352ff1", "aria-checked": a11yBoolean(this.checked), "aria-disabled": a11yBoolean(this.disabled), role: "radio", tabindex: tabIndex, class: {
      ...
      if (this.disabled)
        return;
      this.setCheckedState(true);
    }, onKeyDown: (event) => this.onKeyDown(event), onBlur: () => this.ixBlur.emit() }, h("label", { key: "20d33273ebbd470436c3459c19357baa362e6e5a" }, h("div", { key: "8985de14bb6bc213caf7aeb1b146eae67b3f0f20", class: "radio-button" }, h("div", { key: "ce99233ffeaf3052676ba6a6f5294aafdf24863a", "aria-hidden": "true", class: {
      ["radio-checkmark"]: true,
      checked: this.checked
    } }, h("div", { key: "76a92fd2ab167c7e26d9a27858ada261b924c919", class: "checkmark", style: { visibility: this.checked ? "visible" : "hidden" } }))), this.label && h("ix-typography", { key: "9cd6ca36f724291c2afbabac52bec29ce8f52257", format: "label", textColor: this.disabled ? "weak" : "std" }, this.label, h("slot", { key: "cb1579f01bb711a9cdfedbcda820b171acc9f3f7" }))));
  }
