...
const Tree = class {
  ...
  render() {
    return h(Host, { key: "45c9b0a2f4710f94587df4b5f4c29c7e57761081", onClick: (event) => this.onTreeItemClick(event) }, h("slot", { key: "b434a03c0d026b33e7c770998aa592f7b3627d24" }));
  }
  static get watchers() {
    return {
      "model": [{
