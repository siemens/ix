...
const Breadcrumb = class extends Mixin(...DefaultMixins) {
  ...
  render() {
    ...
    return h(Host, { key: "823e0db6a32aad8b73e9ea5b7ab0432d9f9f430a", ...this.inheritAriaAttributes, role: "navigation" }, this.items?.length > this.visibleItemCount && h("ix-dropdown-button", { key: "5dcb02dfef25a46a78f6298b7c764c3e5c45d883", "aria-label": this.ariaLabelPreviousButton, label: "...", variant: "tertiary", class: "previous-button", enableTopLayer: this.enableTopLayer }, h("ix-icon", { key: "b48e7be4cf5ade9aea31020d6ba4ea3af78e3869", slot: "button-label", name: iconChevronRightSmall, size: "16", class: "chevron" }), this.items.slice(0, this.items.length - this.visibleItemCount).map((item) => {
    ...
    })), h("div", { key: "f8a5d28cd7ad7c4fa89ec94cc32e134df9fa2a83", class: "crumb-items" }, h("slot", { key: "7beb01a8aab72a8fb5908ad38f4f168794f33d82" })), this.shouldRenderNextDropdown && h("ix-dropdown-button", { key: "eabcace8e80ea30320051664743d5f7879fa7756", label: labelLastItem.label ?? labelLastItem.innerText, class: "next-button", variant: "tertiary", enableTopLayer: this.enableTopLayer, "aria-current": "page" }, h("ix-icon", { key: "dbb5171eddc8dfd72d5ab387afdb2b1ead9856fd", slot: "button-label", name: iconChevronRightSmall, size: "16", class: "chevron" }), this.nextItems?.map((item) => h("ix-dropdown-item", { label: item.label, onClick: (e) => {
      this.nextClick.emit({
        event: e,
        item
      });
