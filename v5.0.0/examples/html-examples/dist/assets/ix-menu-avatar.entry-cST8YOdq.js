...
const MenuAvatar = class {
  ...
  render() {
    ...
    return h(Host, { key: "1ad38b611cfa84a7e6aba40739018c4b4e6fc7a0", slot: "ix-menu-avatar" }, h("button", { key: "a21cd6a0c19ddf58c478d479bbd9a8f06b116f8a", class: "nav-item top-item avatar no-hover", id: this.avatarElementId, tabIndex: 0 }, h("ix-avatar", { key: "e0af99425cc6cc1acc388ba954133d86484af6d6", image: this.image, initials: this.initials }), h("div", { key: "cf692d613618d7aa2d307dd0bcdaaf6cdf44aa99", class: "avatar-name" }, h("span", { key: "f49d878eb6e1625292574f358d06267e4ef66636", class: "text-default-single" }, this.top), h("span", { key: "be03fd0d3a0934d4f5f2ebf1fa10289a570da46a", class: "text-default-single" }, this.bottom))), !!tooltipText && h("ix-tooltip", { key: "fcbc250c66bbe392fff51116a94748042eee064b", ref: this.tooltipRef, for: `#${this.avatarElementId}`, placement: "right", "aria-hidden": a11yBoolean(ariaHidden), "aria-label": this.ariaLabelTooltip }, tooltipText), h("ix-dropdown", { key: "072f4c07b718c48768c4aa0605ea16c078997ef1", trigger: this.hostElement, placement: "right-start", hidden: !this.showContextMenu && this.hideLogoutButton, offset: {
      mainAxis: 16
    }, onShowChanged: (event) => {
      if (event.detail && this.tooltipRef.current) {
        this.tooltipRef.current.hideTooltip(0);
      }
    }, enableTopLayer: this.enableTopLayer }, h("slot", { key: "6231747c7a7b9d21aaf7297ac31746b161c3c471", onSlotchange: () => this.onSlotChange() }), !this.hideLogoutButton && h("ix-menu-avatar-item", { key: "abf4454b7328866053333caf503e49baa6a04f7f", label: this.i18nLogout, icon: iconLogOut, onClick: (e) => {
