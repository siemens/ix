...
import { o as iconCalendar } from "./index-DgUGsIlh-CLxQRaVd.js";
import { D as DateTime } from "./datetime-D1WplX1z-grPSvmS5.js";
import { c as createPickerValidityStateTracker, h as handleSubmitOnEnterKeydown, e as emitPickerValidityState, a as addDisposableChangesAndVisibilityObservers, b as adjustPaddingForStartAndEnd, S as SlotEnd, f as onInputFocus, o as onInputBlurWithChange, d as SlotStart } from "./input.fc-CE3kP-L_-CJg1QFxX.js";
...
import { I as InputPickerMixin, h as handleIconClick, o as openDropdown, c as closeDropdown, a as createValidityState } from "./input-picker.mixin-DudWFH-e-CNV4gGeP.js";
...
import { c as createClassMutationObserver, g as getValidationText, H as HookValidationLifecycle } from "./validation-VVt5EFy0-BqxSDzD2.js";
...
const DatetimeInput = class extends Mixin(...DefaultMixins, InputPickerMixin) {
  ...
  render() {
    ...
    return h(Host, { key: "f7835c08e3f5152b7afbb492e25be545c23d60cc", class: {
      disabled: this.disabled,
      readonly: this.readonly
    } }, h("ix-field-wrapper", { key: "be3cc779d47841cf269ba88ca6b3f8a669be9ea4", controlRef: this.inputElementRef, helperText: this.helperText, infoText: this.infoText, invalidText, isInfo: this.isInfo, isInvalid: this.isInvalid, isValid: this.isValid, isWarning: this.isWarning, label: this.label, required: this.required, showTextAsTooltip: this.showTextAsTooltip, validText: this.validText, warningText: this.warningText }, this.renderInput()), h("ix-dropdown", { key: "80470624be8185f75450deee3673854cf1b63d55", class: "datetime-dropdown", closeBehavior: "outside", "data-testid": "datetime-dropdown", enableTopLayer: this.enableTopLayer, ref: this.dropdownElementRef, show: this.show, suppressOverflowBehavior: true, trigger: this.inputElementRef.waitForCurrent(), onShowChanged: (event) => {
