...
import { m as mapValidationResult, e as checkInternalValidity, T as TextareaElement, j as onInputBlurWithChange, k as onInputFocus, h as getAriaAttributesForInput } from "./input.fc-CE3kP-L_-DH2hp2Eu.js";
...
const Textarea = class {
  ...
  render() {
    return h(Host, { key: "b48943feeffaa8ba1ca1ac8c54fe9cfd2cf42354", class: {
      disabled: this.disabled,
      readonly: this.readonly
    } }, h("ix-field-wrapper", { key: "d7d2f10ad8d40d802beb4dd4464097ac68ea04d9", required: this.required, label: this.label, helperText: this.helperText, invalidText: this.invalidText, infoText: this.infoText, warningText: this.warningText, validText: this.validText, showTextAsTooltip: this.showTextAsTooltip, isInvalid: this.isInvalid, isValid: this.isValid, isInfo: this.isInfo, isWarning: this.isWarning, controlRef: this.textAreaRef }, !!this.maxLength && this.maxLength > 0 && h("ix-typography", { key: "c9d3348935c49de47d36652c98b9d8a3ab2eb9a5", class: "bottom-text", slot: "bottom-right", textColor: "soft" }, (this.value ?? "").length, "/", this.maxLength), h("div", { key: "c515537de44de9f90d64105c94c6ec696cfb8cbf", class: "input-wrapper" }, h(TextareaElement, { key: "d0ff02fc22038e585acadaa407dd9a914f82e5bd", id: this.inputId, minLength: this.minLength, maxLength: this.maxLength, textareaCols: this.textareaCols, textareaRows: this.textareaRows, textareaHeight: this.getTextareaHeight(), textareaWidth: this.getTextareaWidth(), resizeBehavior: this.resizeBehavior, readonly: this.readonly, disabled: this.disabled, isInvalid: this.isInvalid, required: this.required, value: this.value, placeholder: this.placeholder, textAreaRef: this.textAreaRef, ariaAttributes: getAriaAttributesForInput(this), onFocus: () => onInputFocus(this, this.value), valueChange: (value) => this.valueChange.emit(value), updateFormInternalValue: (value) => this.updateFormInternalValue(value), onBlur: () => {
