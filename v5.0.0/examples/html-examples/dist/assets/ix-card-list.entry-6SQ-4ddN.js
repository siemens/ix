import { r as registerInstance, c as createEvent, g as getElement, h, H as Host, F as Fragment } from "./global-Cx3A0XQN.js";
...
const CardList = class {
  ...
  render() {
    return h(Host, { key: "ac11ba7d8b9e640e9f2b5ddb57ce5076bbd8ba8a" }, h(CardListTitle, { key: "8a7d6eb95e8632635e1a197595ba5d6bec1e5f8c", isCollapsed: this.collapse, label: this.label, showAllLabel: this.i18nShowAll, showAllCounter: this.showAllCount === void 0 ? this.numberOfAllChildElements : this.showAllCount, showLess: this.isShowingAll, labelShowLess: this.i18nShowLess, onClick: () => this.onCardListVisibilityToggle(), onShowAllClick: (e) => this.onShowAllClick(e), hideShowAll: this.hideShowAll }), h("div", { key: "cc857fc065ba2b90cb51b8cf3e688fdbd2075d2f", class: {
      CardList__Overflow: true
    }, style: this.computeMaskLayer() }, h("div", { key: "51d5d4b9be82f186af7f3fe21707bc909a186acd", class: {
    ...
    }, onScroll: () => this.onCardListScroll() }, h("slot", { key: "2aca13a303355515124c5d6075b23c91db1d4bf5", onSlotchange: () => {
      this.changeVisibilityOfSlotChildren();
