import { r as registerInstance, g as getElement, f as forceUpdate, h, H as Host } from "./global-Cx3A0XQN.js";
...
const Panes = class {
  ...
  render() {
    return h(Host, { key: "106a70ecae1be20cbd2ef01cfab09252af8c2228" }, !this.isMobile ? this.layout == "full-vertical" ? h("div", { class: "side-panes-wrapper" }, h("div", { class: {
      row: true,
