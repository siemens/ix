...
const Kpi = class {
  ...
  render() {
    return h(Host, { key: "8d0152519c8e02668c9b1f5169205dcdfddba0f3", title: this.getTooltipText(), tabindex: "1", class: {
      stacked: this.orientation === "vertical"
    } }, h("div", { key: "ca12402bfb8a1c2dc8c2f14e24e903c43c437412", class: {
      "kpi-container": true,
      alarm: this.state === "alarm",
      warning: this.state === "warning"
    } }, h("span", { key: "71feb013f76a28f399b13b48c25681a8e8606221", class: "kpi-label" }, this.getStateIcon(), h("span", { key: "44a8dd898d550165869bea9244ec51956ac9497d", class: "kpi-label-text" }, this.label)), h("span", { key: "202d13c4044140342376bbbd85a32ec0a2a5e6b6", class: "kpi-value-container" }, h("span", { key: "1062f73a2cf32e04754603eb73c061d5a5adcbe1", class: "kpi-value" }, this.value), this.unit ? h("span", { class: "kpi-unit" }, this.unit) : "")));
  }
};
Kpi.style = kpiCss();
export {
