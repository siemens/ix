import { r as registerInstance, f as forceUpdate, h, H as Host, M as Mixin, c as createEvent, g as getElement } from "./global-Cx3A0XQN.js";
...
import { O as OnListener } from "./listener-BjluJgvO-CMTj_HqD.js";
...
const Col = class {
  ...
  render() {
    return h(Host, { key: "3dd5c8998d4dc5bec0009e7be71ca4704b4195f9", style: {
      ...this.getColumnSizeStyling()
    } }, h("slot", { key: "f2a10b4250d7369c7ce9f19cc4ccd98fd7bca2bf" }));
  }
};
Col.style = colCss();
...
const LayoutGrid = class {
  ...
  columns = 12;
  render() {
    return h(Host, { key: "139ebce3b08114ebcc6e70150b7b67dfb9bafe12", class: {
      "no-margin": this.noMargin
    }, style: {
      "--ix-layout-grid-columns": `${this.columns}`,
      "--ix-layout-grid-gutter": `${this.gap}px`
    } }, h("slot", { key: "02b2f8c63bf553c6fb14ffe82e2ead18209dc949" }));
  }
};
...
const Row = class {
  ...
  render() {
    return h(Host, { key: "f04d35dbe04b7859fc0f1298ca79ab1432053716" }, h("slot", { key: "5fec8d59f04a0e77e47217e6ce1997f93d9df223" }));
  }
};
Row.style = rowCss();
...
const TimePicker = class extends Mixin(...DefaultMixins) {
  ...
  render() {
    const { bounds } = this.getUnitSelectionContext();
    return h(Host, { key: "a6edda7426af12d2faf653b18d83f77f67acb544" }, h("ix-date-time-card", { key: "9b85762d42ab4d39f72547e4e63cd8e8cb54a516", embedded: this.embedded, timePickerAppearance: true, corners: this.corners, hasFooter: !this.dateTimePickerAppearance, hideHeader: this.hideHeader }, h("div", { key: "5f0e7d816c892eed6f8c06a039a86db02cc775bf", class: "header", slot: "header" }, h("ix-typography", { key: "9f46b50fd45baf3c739ab2f6a67b439af3aca5c4", format: "body" }, this.i18nHeader)), h("div", { key: "5fabe1a375e3e3c2fb34e1417e7d35cd25fba8ac", class: "clock" }, this.timePickerDescriptors.map((descriptor, index) => {
    ...
    }), this.timeRef && h("div", { key: "1b1d4a67148e94ab5cccbd092b29a6728419a2ad", class: "flex" }, h("div", { key: "6bb2259e228996add2550d043f3bea474b6fcc5f", class: "column-separator" }), h("div", { key: "67a288544cb5d972a40f6ca81f21aeef5143e852", class: "columns" }, h("div", { key: "945a2de9a1da9cc69bafef422f060cdc7d999710", class: "column-header", title: "AM/PM" }), h("div", { key: "9b8c4f122f3a88294c9b67bdfb7f4bee307ba50b", role: "listbox", "aria-label": "AM/PM", class: "element-list", tabindex: -1 }, h("button", { key: "fd87aa2b4b833525184024cd87c64e9c7078f5e2", role: "option", "aria-selected": this.timeRef === "AM" ? "true" : "false", "data-am-pm-id": "AM", class: {
      selected: this.timeRef === "AM",
      "element-container": true
    }, onClick: () => this.changeTimeReference("AM"), tabindex: "0", "aria-label": "AM" }, "AM"), h("button", { key: "f5a1834c6d7a2fe60d8612deccc746c03da2b635", role: "option", "aria-selected": this.timeRef === "PM" ? "true" : "false", "data-am-pm-id": "PM", class: {
      selected: this.timeRef === "PM",
      "element-container": true
    }, onClick: () => this.changeTimeReference("PM"), tabindex: "0", "aria-label": "PM" }, "PM"))))), h("div", { key: "18ddbd31f16383d484e35c1959f5ab98ef355c4a", class: {
      footer: true,
      "footer--compact": this.timePickerDescriptors.length <= 2
    }, slot: "footer" }, h("ix-button", { key: "a9aaaee3da2e700c1a45c2ecd29e01e2c66f8ef8", class: "confirm-button", disabled: this.isConfirmDisabled(), onClick: () => {
