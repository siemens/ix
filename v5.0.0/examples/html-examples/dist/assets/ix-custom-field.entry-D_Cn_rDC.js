...
const CustomField = class {
  ...
  render() {
    return h(Host, { key: "79c264b6973fdb749fa6d7997c0ddcec47e8358d" }, h("ix-field-wrapper", { key: "000fa09762d1cce3ed8ef00a40bb4e3a5fff489a", label: this.label, helperText: this.helperText, infoText: this.infoText, warningText: this.warningText, invalidText: this.invalidText, validText: this.validText, showTextAsTooltip: this.showTextAsTooltip, isInvalid: this.isInvalid, isValid: this.isValid, isInfo: this.isInfo, isWarning: this.isWarning, required: this.required }, h("slot", { key: "8cb969a0f22731e9ced384d25f300566b65021c7" })));
  }
};
__decorate([
