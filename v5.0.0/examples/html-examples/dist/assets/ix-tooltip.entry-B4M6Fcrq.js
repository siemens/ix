...
const Tooltip = class {
  ...
  render() {
    return h(Host, { key: "fa706ce1e65b59ec99d393cef736e0bc02b56c56", role: "tooltip", class: { visible: this.visible } }, h("dialog", { key: "bada1f3b75941cb9d945d6dec6a38439bae3c393", ref: this.dialogRef, id: "tooltip-" + this.instance, class: "dialog", popover: "manual", inert: !this.visible }, h("div", { key: "d6dfa346a3e73e4133c743dc82a94d3f509871ff", class: "tooltip-container" }, h("div", { key: "a0fc560e9853049d8c53d05ae79702c44877fa71", class: "content-wrapper" }, h("div", { key: "6c40ae197047c0a32c9c097f61699bda358474e1", class: "tooltip-title" }, h("slot", { key: "ab9f59b5d034646367390c47fc682e173f83ba30", name: "title-icon", onSlotchange: (e) => this.handleTitleIconSlotChange(e) }), h("ix-typography", { key: "219b1b8a68bf35cb54741bbd1613594bf7a8ebf2", format: "h5" }, this.titleContent, h("slot", { key: "67ad85f56168d17e3b4d53b401ee20995d8071f6", name: "title-content" }))), h("slot", { key: "bc2fb872daab671affd282d3097b1fffb3374258" }), h("div", { key: "911c9d4afbcf043a28bfabb0fe3d925709a304b1", class: "arrow" })))));
  }
};
