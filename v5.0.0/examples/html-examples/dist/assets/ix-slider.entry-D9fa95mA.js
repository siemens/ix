...
const Slider = class {
  ...
  render() {
    ...
    return h(Host, { key: "33023f6cb4b1409121ba18c939039664e9a7c901", class: {
      disabled: this.disabled,
      invalid: this.isInvalid,
      info: this.isInfo,
      valid: this.isValid,
      warning: this.isWarning
    }, onPointerDown: () => setTimeout(() => this.showTooltip = true) }, h("ix-field-wrapper", { key: "9a2012050230f9fd582c718513ec7161e3fc42c0", label: this.label, helperText: this.helperText, invalidText: this.invalidText, infoText: this.infoText, warningText: this.warningText, validText: this.validText, showTextAsTooltip: this.showTextAsTooltip, isValid: this.isValid, isInfo: this.isInfo, isWarning: this.isWarning, isInvalid: this.isInvalid, controlRef: this.controlRef }, h("div", { key: "a64915efcbb1666ce5140f90ff62b9cc2702f1a7", class: "slider-container" }, h("div", { key: "d5931a499c0fcb7dac9223b5b53d69ac36c50ec1", class: "slider" }, h("div", { key: "47c5dd757f7231f032937dbd94644409525b7e20", class: "track" }, h("div", { key: "ca662fb9a6de248871abc8a5473a6135196e67a2", ref: this.thumbRef, class: "thumb", style: {
      left: `calc(${valueInPercentage} * (100% - 1rem))`
    } }), h("svg", { key: "7248a383c69eb319b1c27f47b52b63d5b2816ecd", class: "ticks", xmlns: "http://www.w3.org/2000/svg" }, this.marker?.filter((markerValue) => markerValue >= this.min && markerValue <= this.max).map((markerValue) => {
    ...
    }))), h("input", { key: "8c7344d1fa493c28d3ac65b3a8e05ba2ca31e82c", id: "slider", ref: this.controlRef, type: "range", list: this.marker ? "markers" : void 0, step: this.step, min: this.min, max: this.max, value: this.rangeInput, tabindex: this.disabled ? -1 : 0, onInput: (event) => this.onInput(event), onFocus: () => {
    ...
    }, role: "slider", "aria-valuenow": this.rangeInput, "aria-valuemin": this.min, "aria-valuemax": this.max, ...this.a11yAttributes }), h("ix-tooltip", { key: "bf6b16ad9a28d2a01f895996aa654330ec9137cb", ref: this.tooltipRef, class: {
      "hide-tooltip": !this.showTooltip
    }, animationFrame: true, for: this.thumbRef.waitForCurrent() }, this.rangeInput)), this.hasLabels && h("div", { key: "f43a4dff52fc20045d92a6543f8bf162bd04e13d", class: "label" }, h("div", { key: "bc6af6ba75b3add258417108eeb5506c34c9cf84" }, h("slot", { key: "3f096eda700a5936b3ffb3cfb1ae1ec3df583e4c", name: "label-start" })), h("div", { key: "bfbf6af6671ee262950373dabbac3c54d7df859e" }, h("slot", { key: "3f2e3fe945307e535327829cbbc999244e5a794f", name: "label-end" }))))));
  }
