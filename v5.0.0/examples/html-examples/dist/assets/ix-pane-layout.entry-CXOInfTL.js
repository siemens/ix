import { r as registerInstance, g as getElement, f as forceUpdate, h, H as Host } from "./global-F68Qu5y3.js";
...
const Panes = class {
  ...
  render() {
    return h(Host, { key: "734943c09641fe9a94845917c64f635db32ec850" }, !this.isMobile ? this.layout == "full-vertical" ? h("div", { class: "side-panes-wrapper" }, h("div", { class: {
      row: true,
