...
import { B as iconEye } from "./index-DgUGsIlh-FNhczk6p.js";
...
const FlipTile = class {
  ...
  render() {
    return h(Host, { key: "e4c797e51ca3ea7d491dc5112d6189bbba1ed221", class: {
    ...
    } }, h("div", { key: "2bb799d51b64f6a90c7e386d03571d81b7e69593", class: "flip-tile-container" }, h("div", { key: "6bba32b7096917d80f05ed019395470ec9663ce4", class: "flip-tile-header" }, h("div", { key: "f68f8a92dc4cdacb10217d2dae3fcb358016c456", class: "header-slot-container text-l-title" }, h("slot", { key: "8d7f3bd81670836ed6eef8baab1541f8437885e1", name: "header" })), h("ix-icon-button", { key: "f0ec012e29e6f0cccd6a749f413771d020143269", icon: iconEye, variant: "tertiary", onClick: () => this.toggleIndex(), "aria-label": this.ariaLabelEyeIconButton })), h("div", { key: "c8814e8728e63993a09b37034f7dbf6c9cc4682b", class: "content-container" }, h("slot", { key: "0c9cabcda1550b8161d7dfe36715df32cb70691a" })), h("div", { key: "7177644c8749e7c2f02673adafb40e2befe0572a", class: {
      footer: true,
      "show-footer": this.hasFooterSlot
    } }, h("slot", { key: "9c79f9879e92f2cc534ecb3b6287060ace9a360c", name: "footer", onSlotchange: (event) => this.handleFooterSlotChange(event) }))));
  }
  static get watchers() {
    return {
      "index": [{
