import { r as registerInstance, c as createEvent, g as getElement, h, F as Fragment, H as Host } from "./global-C8IWpzMv.js";
...
const Checkbox = class {
  ...
  render() {
    return h(Host, { key: "384f4b8c6c7a195636399ec7b730aafe38cf26de", "aria-checked": a11yBoolean(this.checked), "aria-disabled": a11yBoolean(this.disabled), role: "checkbox", class: {
      disabled: this.disabled,
      checked: this.checked,
      indeterminate: this.indeterminate,
      "label-less": this.isLabelLess
    }, onFocus: () => this.touched = true, onBlur: () => this.ixBlur.emit() }, h("label", { key: "20abc47de29d94903789842caaffd51257f1d72c" }, h("input", { key: "17bf5f62b8c8ef0b33acd324b5314f383e7712c9", "aria-checked": a11yBoolean(this.checked), required: this.required, disabled: this.disabled, checked: this.checked, ref: this.inputRef, type: "checkbox", onChange: () => this.setCheckedState(!this.checked) }), h("div", { key: "2efc633b64ddb27539267adb780ec22834b6807e", class: "checkbox-button" }, h("button", { key: "1b2000fa19a62d1e736dda5463167fb01087dbf1", disabled: this.disabled, class: {
      checked: this.checked
    }, onClick: () => this.setCheckedState(!this.checked) }, this.renderCheckmark())), h("ix-typography", { key: "fb6ef4a6432a9223d9a1018ffebdbedb403de4c3", format: "label", textColor: this.disabled ? "weak" : "std" }, this.label, h("slot", { key: "a52c432d4ed52ac9bfdf61584e03ab635eb736cf", onSlotchange: () => this.updateDefaultSlotElements(), ref: (element) => this.defaultSlotElement = element }))));
  }
