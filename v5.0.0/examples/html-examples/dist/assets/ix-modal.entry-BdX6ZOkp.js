...
const Modal = class {
  ...
  render() {
    return h(Host, { key: "7a062d6fdf3da6d5fdbf2a24666f58395d7cc5c1", class: {
      visible: this.modalVisible,
      "no-backdrop": this.hideBackdrop,
      "align-center": this.centered,
      "non-blocking": this.isNonBlocking
    } }, h("div", { key: "eb96daedf100e97a613db65625073eb71a5ff063", class: "dialog-backdrop" }, h("dialog", { key: "6bd3a107971976838b0681ac6042364434d04680", "aria-modal": a11yBoolean(!this.isNonBlocking), "aria-describedby": this.ariaAttributes["aria-describedby"], "aria-labelledby": this.ariaAttributes["aria-labelledby"], class: {
      modal: true,
      ...
      e.preventDefault();
      void this.dismissModal();
    } }, h("slot", { key: "5e0c66ead9a64acec778c66d403499ac8c092de4" }))));
  }
};
