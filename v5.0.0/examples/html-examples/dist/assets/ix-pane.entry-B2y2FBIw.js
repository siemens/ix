...
import { w as iconDoubleChevronDown, y as iconDoubleChevronRight, z as iconDoubleChevronUp, x as iconDoubleChevronLeft, r as iconClose } from "./index-DgUGsIlh-FNhczk6p.js";
...
const Pane = class {
  ...
  render() {
    ...
    return h(Host, { key: "17eeec7194a08af2eecea56c8c7cbbd97ecb7022", class: {
    ...
    }, "aria-expanded": a11yBoolean(this.expanded) }, h("aside", { key: "5d7a6e1e761c2227215859550c8faa6c0d96be07", id: `pane-${this.composition}`, class: {
      "top-bottom-pane": this.isBottomTopPane && !this.isMobile,
      "left-right-pane": this.isLeftRightPane && !this.isMobile,
      "mobile-pane": this.isMobile,
      expanded: this.expanded
    } }, h("div", { key: "044a9eaa18e2ec4dab559fecbd8d58331aeb6e1c", id: "title-div", class: {
    ...
    } }, h("ix-icon-button", { key: "ff6b0847a337188f3d5364507d456c383f5fed7e", class: "title-icon", size: "24", icon: this.expanded ? this.isMobile || this.hideOnCollapse ? iconClose : this.expandIcon : this.minimizeIcon, iconColor: this.expanded && (this.isMobile || this.hideOnCollapse) ? "color-soft-text" : void 0, variant: "subtle-tertiary", onClick: () => this.dispatchExpandedChangedEvent(), "aria-controls": `pane-${this.composition}`, "aria-label": paneButtonAriaLabel }), h("div", { key: "2a96b60dc300f316c7a70b54ce639b0ab27dcfdb", class: {
      "title-text": true,
      rotate
    } }, this.icon && h("ix-icon", { key: "81e36e45bea57970e585d725a487babd2eeaf21c", class: "pane-icon", size: "24", name: this.icon, "aria-label": this.ariaLabelIcon }), h("div", { key: "6d755cc5575cdf9b3d097df1bc4763f58c1e6252", class: "title-text-overflow" }, h("ix-typography", { key: "1f0fb2980445b5451f1fe107595a370778be448b", format: "h4" }, this.heading)), this.expanded && h("div", { key: "86e2e62c98ceb49ab0cc417c1a04d27900c0f2c9", class: "slot-header" }, h("slot", { key: "43e6a433b713806a37df6a0c6f8b0a4b5fb0a61b", name: "header" })))), h("div", { key: "bc50e7bd859d868c35d4ceb3561090e173ff9684", class: {
      "side-pane-content": true,
      "no-padding": this.noPadding
    }, hidden: !this.showContent }, h("slot", { key: "c506f18fb29bbe1ef145ba54994e47e6f7edbb07" }))));
  }
  static get watchers() {
    return {
      "expanded": [{
