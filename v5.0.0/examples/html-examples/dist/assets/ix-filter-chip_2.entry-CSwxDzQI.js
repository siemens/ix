import { r as registerInstance, c as createEvent, g as getElement, h, H as Host, M as Mixin } from "./global-Cx3A0XQN.js";
...
const FilterChip = class {
  ...
  render() {
    return h(Host, { key: "8707fe986a359b6113a206a1c75bbccc1a73662b", class: { disabled: this.disabled, readonly: this.readonly }, title: this.hostElement.textContent }, h("div", { key: "bffed72acb8a5346b84a5a42afe6c6341534127c", class: "slot-container" }, h("slot", { key: "97f5706ecf3c2659acfdfadbbc99a242c49fc892" })), !this.disabled && !this.readonly ? h("ix-icon-button", { variant: "tertiary", oval: true, icon: iconCloseSmall, size: "16", disabled: this.disabled, onClick: (event) => {
