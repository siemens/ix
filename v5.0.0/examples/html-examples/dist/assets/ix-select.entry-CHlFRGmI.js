...
import { P as PROXY_LISTITEM_ID_SUFFIX, a as PROXY_LIST_ID_SUFFIX, u as updateFocusProxyList, F as FocusProxy } from "./focus-proxy-BQyoX-Kl-Bts-X_Co.js";
...
import { H as HookValidationLifecycle } from "./validation-VVt5EFy0-BbxVucMm.js";
...
const Select = class extends Mixin(...DefaultMixins, ComponentIdMixin, AriaActiveDescendantMixin) {
  ...
  render() {
    return h(Host, { key: "062a5467bdf5b5a8fdd126869ee2d617b8542fd6", id: this.getHostElementId(), class: {
      readonly: this.readonly,
      disabled: this.disabled,
      "show-focus-outline": this.hasInputFocus && !this.dropdownItemsVisualFocused
    }, tabIndex: this.disabled ? -1 : 0 }, h("ix-field-wrapper", { key: "69d58f2cfb842537a8d2ff0465f9c594f0ca521e", required: this.required, label: this.label, helperText: this.helperText, invalidText: this.invalidText, infoText: this.infoText, warningText: this.warningText, validText: this.validText, showTextAsTooltip: this.showTextAsTooltip, isInvalid: this.isInvalid, isValid: this.isValid, isInfo: this.isInfo, isWarning: this.isWarning, controlRef: this.inputRef }, h("div", { key: "3897f260ed7c09e422f86012503077bf48c55efd", class: {
      select: true,
      disabled: this.disabled,
      readonly: this.readonly
    }, ref: (ref) => {
    ...
    } }, h("div", { key: "1c1ae8b1d79eaa72ae5723bc27a5cd0d2c77781e", class: "input-container" }, h("div", { key: "f478a608d1577279b0a91fdb5fda0573fa82402e", class: "chips" }, this.isMultipleMode && this.items.length !== 0 && (this.shouldDisplayAllChip() ? this.renderAllChip() : this.selectedItems?.map((item) => this.renderChip(item))), h("div", { key: "0240c0dcd9660b6812fc66f86fa7d6cec06f587c", class: "trigger" }, h("input", { key: "45b48318b490ca6231fe410ab2c665694e38d39c", id: `${this.hostId}-input`, role: "combobox", "aria-controls": `${this.hostId}-proxy-listbox`, "aria-expanded": a11yBoolean(this.dropdownShow), "aria-autocomplete": "list", "aria-disabled": a11yBoolean(this.disabled), autocomplete: "off", "data-testid": "input", disabled: this.disabled, readOnly: this.readonly, required: this.required, type: "text", class: {
    ...
    } }, h("div", { key: "1dc8b4de499fb314cef63ebe5f0e0827f6b62575", "aria-hidden": "true", class: {
      "select-list-header": true,
      hidden: this.hideListHeader || this.isDropdownEmpty
    }, title: this.i18nSelectListHeader, onClick: (e) => e.preventDefault() }, this.i18nSelectListHeader), h("slot", { key: "5ee45e3149a820af873c2b7758bf2284573ced69", onSlotchange: () => {
      this.updateSelection();
    } }), h(FocusProxy, { key: "aaa144e45852e065baf3e7a6125aa7888ce0fdd0", hostId: this.hostId, otherProps: {
    ...
    } }), this.isDropdownEmpty && !this.editable && h("div", { key: "228a0598296a04734abc9e325762f563c7ce6852", class: "select-list-header" }, this.i18nNoMatches)));
  }
