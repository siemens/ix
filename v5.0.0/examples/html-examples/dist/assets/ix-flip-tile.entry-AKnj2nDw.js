...
const FlipTile = class {
  ...
  render() {
    return h(Host, { key: "2e4003aacddf122e10d8f6d3ef9d28bee772989e", class: {
    ...
    } }, h("div", { key: "c669c8aae83d243d0084d29b0ed547ce41df20e1", class: "flip-tile-container" }, h("div", { key: "b969b2a170bf51b6a65780da4c57c0068f95ffb3", class: "flip-tile-header" }, h("div", { key: "23f7ef90efd3a24c4ca90e8c1610ca60334134f6", class: "header-slot-container text-l-title" }, h("slot", { key: "5071d084314f3459257f4a793cc855a70bd2bf73", name: "header" })), h("ix-icon-button", { key: "06c4f95c6db63ee52c862653c3883ccccc4c0b64", icon: iconEye, variant: "tertiary", onClick: () => this.toggleIndex(), "aria-label": this.ariaLabelEyeIconButton })), h("div", { key: "16866b53e12520d98541172e14552609ed7b9ba8", class: "content-container" }, h("slot", { key: "224d003560e2ef4b565f525306fd3916dae28635" })), h("div", { key: "3cc6ae0864bba185c3aaf243763f384ba58a072f", class: {
      footer: true,
      "show-footer": this.hasFooterSlot
    } }, h("slot", { key: "3a3ece0417a26ad093dc33233cb736ba6c764395", name: "footer", onSlotchange: (event) => this.handleFooterSlotChange(event) }))));
  }
  static get watchers() {
    return {
      "index": [{
