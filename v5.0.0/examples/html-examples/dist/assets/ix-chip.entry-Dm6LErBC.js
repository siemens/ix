...
const Chip = class extends Mixin(...DefaultMixins, InheritAriaAttributesMixin) {
  ...
  render() {
    ...
    return h(Host, { key: "9dfd0cf7ab219551126b3f778be68973baad1c3e", role: this.getHostRole(needsGroupRole), class: {
      inactive: this.inactive
    } }, h("div", { key: "0ab426e9ae03048ae7e611a1670880bea417b1e3", ref: this.containerElementRef, class: wrapClasses, style: customWrapStyle }, h("button", { key: "31aad110f4a7f0157d4eb2a792ea65952605afd3", type: "button", class: "chip-main", ...this.inheritAriaAttributes, disabled: this.inactive, style: customMainStyle }, h("div", { key: "e5e66b5495b48019d34ade43027d2d664e9b4fcc", class: "content-wrapper" }, this.icon && h("ix-icon", { key: "f5b16508c29ec9f298596b108e6be4a8e82fda75", class: {
      "with-icon": true
    }, name: this.icon, size: "24", "aria-label": this.ariaLabelIcon, "aria-hidden": a11yBoolean(iconIsDecorative), style: this.getIconStyle(variant) }), h("span", { key: "d89eb31a15add1dde9aef7db68b72317acdca9d8", class: "slot-container" }, h("slot", { key: "7737bfd4297ef13fe237f38b73c9a42252b77992" })))), showClose && h("button", { key: "3fba720fe79108f9879f85729de774012ae6d0ef", type: "button", class: "chip-close", "aria-label": this.ariaLabelCloseButton, onClick: (event) => {
      this.closeChip.emit(event);
      event.stopPropagation();
    } }, h("ix-icon", { key: "a10cbd2739ebe9d4001bf9dc95998f393c724ef5", class: "chip-close__icon", name: iconCloseSmall, size: "16", "aria-hidden": "true" }))), this.getTooltip());
  }
  static get watchers() {
    return {
      "role": [{
