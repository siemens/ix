...
const CheckboxGroup = class {
  ...
  render() {
    return h(Host, { key: "9fc7d0a20d4583d0e1122e338619bf782e327a04", ref: this.groupRef, onIxBlur: () => this.touched = true }, h("ix-field-wrapper", { key: "8e6b410a5838aa079e290c2f692bfd4f8421edd5", label: this.label, helperText: this.helperText, invalidText: this.invalidText, infoText: this.infoText, validText: this.validText, warningText: this.warningText, showTextAsTooltip: this.showTextAsTooltip, isInvalid: this.isInvalid, isInfo: this.isInfo, isValid: this.isValid, isWarning: this.isWarning, controlRef: this.groupRef }, h("div", { key: "4816704e499894805c96dfe1b50073b8f6a09d7c", class: {
      "checkbox-container": true,
      "row-layout": this.direction === "row"
    } }, h("slot", { key: "90c7c2cfc6c813ddeb0159f2ef86353ea5107060" }))));
  }
};
__decorate([
