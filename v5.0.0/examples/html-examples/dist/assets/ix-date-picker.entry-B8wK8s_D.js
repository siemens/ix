...
const DatePicker = class extends Mixin(...DefaultMixins) {
  ...
  render() {
    return h(Host, { key: "1d18859460c81a75c3d6de476c023f1be89e28ec", onKeyDown: (event) => this.onKeyDown(event), onFocusin: () => {
      if (hasKeyboardMode()) {
        this.changeFocusedDay();
      }
    } }, h("ix-date-time-card", { key: "ea7a2d2a83fd0f61da22f49490133ec54f2da359", corners: this.corners, embedded: this.embedded }, h("div", { key: "06b3f7c1bbbe6d79160cb6f3884c729ab082a610", class: "header", slot: "header" }, h("ix-icon-button", { key: "04df89ae3ad8b1023e24a6c97b6eee4791f0e50c", onClick: () => this.changeCalendarView(-1), icon: iconChevronLeftSmall, variant: "tertiary", class: "arrows", "aria-label": this.ariaLabelPreviousMonthButton }), h("div", { key: "97e374713c4cdefa19cc87b937c6ff90ce6b637a", class: "selector" }, h("ix-dropdown-button", { key: "ab3ad1303a25675d33cf28c6da35c911094bcc72", class: "month-selector", focusCheckedItem: true, "aria-label": this.ariaLabelMonthSelection, variant: "tertiary", label: null, onShowChanged: (event) => {
      event.stopPropagation();
    } }, h("ix-typography", { key: "e5f48b79c92dacb194e5d87db367a9e9ddad8d1d", bold: true, class: "capitalize", slot: "button-label" }, this.monthNames[this.selectedMonth]), this.renderMonths()), h("ix-dropdown-button", { key: "df39ea240a30e45ab36d5b4069c61eeadd827b43", class: "year-selector", focusCheckedItem: true, "aria-label": this.ariaLabelYearSelection, ref: this.yearDropdownButtonRef, variant: "tertiary", label: null, onShowChanged: (event) => {
      event.stopPropagation();
      if (event.detail) {
        requestAnimationFrameNoNgZone(() => {
    ...
    } }, h("div", { key: "9bd10fe87e9063a3106168ca353bf00298c8a21f", class: "infinite-scrolling-spacer" }, h("div", { key: "f53563aa2b00b23ca54c4f8e05fc44cc967e3b7f", class: "sentinel", "data-sentinel": "top" })), h("ix-typography", { key: "f10b06771a2a132ff6ce0b914b2cdc5040baadeb", bold: true, class: "capitalize", slot: "button-label" }, this.selectedYear), this.renderYears(), h("div", { key: "6780c2307cd1aa575b3fa489d76d9d17cfd7eeb9", class: "infinite-scrolling-spacer" }, h("div", { key: "3af2f893e371aa9a68659e590954a479292cfa79", class: "sentinel", "data-sentinel": "bottom" })))), h("ix-icon-button", { key: "22a563313ef6f96c72a0b161fc3ae59ffecd9e2a", onClick: () => this.changeCalendarView(1), icon: iconChevronRightSmall, variant: "tertiary", class: "arrows", "aria-label": this.ariaLabelNextMonthButton })), h("div", { key: "65ed9c6485bd9af0faaa1825feed3d4ebe99348d", role: "grid", class: {
      grid: true,
      "grid--show-week-numbers": this.showWeekNumbers
    } }, h("div", { key: "5ef4c7c4a2935a3fbe628499bca0384e4a433993", role: "row" }, this.showWeekNumbers && h("div", { key: "ae15928259c7e4235fe3852999e1288b8614c325", class: "calendar-item week-day", role: "columnheader" }), this.dayNames.map((name) => h("div", { key: name, class: "calendar-item week-day", role: "columnheader" }, h("div", { class: "overflow" }, name.slice(0, 3))))), this.calendar.map((week) => {
    ...
    })), h("div", { key: "b7280e7f3433fd37307a2337df228b79e9ce6f6e", class: {
      button: true,
      hidden: this.singleSelection || this.embedded
    } }, h("ix-button", { key: "3152a091feef03697d5a62830151dbf0fba8af44", hidden: this.singleSelection || this.embedded, onClick: () => this.onDone() }, this.i18nDone))));
  }
