...
import { B as BaseButton } from "./base-button-DZdtpLxn-DweJabkL.js";
...
const DateDropdown = class extends Mixin(...DefaultMixins) {
  ...
  render() {
    ...
    return h(Host, { key: "8418a1beab68fb64298a14283bf372f24a3464c8", onFocusout: (event) => {
      const relatedTarget = event.relatedTarget;
      if (!relatedTarget) {
        return;
      }
      this.closeDropdown();
    }, role: "presentation" }, h("ix-button", { key: "4e842b9bb701768c697ebafdc15b65ddd6dafc10", "data-testid": "date-dropdown-trigger", "data-date-dropdown-trigger": true, variant: this.variant, loading: this.loading, icon: iconHistory, ref: this.triggerRef, disabled: this.disabled, ...this.inheritAriaAttributes, "aria-haspopup": "true", "aria-expanded": a11yBoolean(this.show), "aria-controls": "date-dropdown", "aria-label": ariaLabel, [TRAP_FOCUS_EXCLUDE_ATTRIBUTE]: true }, this.getButtonLabel()), h("ix-dropdown", { key: "6838d8e691abdb9b5d36b7a16bf8d995ddb16b5b", focusTrapOptions: {
    ...
    } }, h("div", { key: "a30373a4c942cb746d3102e6179b3c1704d6ef44", class: "container" }, this.dateRangeOptions?.length > 1 && h("div", { key: "a8ea4af58b0d100aa0568617ccd2108769a5ca7e", class: {
    ...
    } }, dateRangeOption.label))), h("div", { key: "f33161924edc59c86299b0ca91cd74d64aa2c327", class: "picker-wrapper" }, h("ix-date-picker", { key: "8e602178f3225bc7565268e1abb205c7fc3d4c37", ref: this.datePickerRef, embedded: true, locale: this.locale, onDateChange: (e) => {
      e.stopPropagation();
      this.currentRangeValue = {
        ...e.detail,
        id: "custom"
      };
    }, onDateRangeChange: (e) => e.stopPropagation(), format: this.format, singleSelection: this.singleSelection, from: this.from || this.currentRangeValue?.from, to: this.to || this.currentRangeValue?.to, minDate: this.minDate, maxDate: this.maxDate, today: this.today, weekStartIndex: this.weekStartIndex, showWeekNumbers: this.showWeekNumbers }), h("div", { key: "05e837528bde6e6797db6440ffcb46ca27ac3f93", class: "pull-right" }, h("ix-button", { key: "864747d3bc3639bdac9499f6920ab13bd0a62491", onClick: () => {
      if (this.currentRangeValue) {
        this.onDateSelect(this.currentRangeValue);
        this.closeDropdown();
      }
