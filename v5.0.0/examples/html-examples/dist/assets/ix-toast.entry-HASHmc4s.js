...
const Toast = class {
  ...
  render() {
    ...
    return h(Host, { key: "c48572d09f860e0a965c9988973cce2f70d2becc", role: "alert", "aria-live": "polite", "aria-atomic": "true", class: "animate__animated animate__fadeIn" }, h("div", { key: "66a3c6bfaf830f2ef23fd1d5fc0380ff3a8a7ba0", class: "toast-body", onPointerLeave: () => {
      this.touched = false;
    }, onPointerEnter: () => {
      this.touched = true;
    } }, (this.type || this.icon) && !this.hideIcon ? h("div", { class: "toast-icon" }, this.getIcon()) : null, h("div", { key: "91a6d20413558e6aa8b8202af208cda621d4bff4", class: "toast-content" }, this.toastTitle ? h("ix-typography", { class: "toast-title", format: "h5" }, this.toastTitle) : null, h("div", { key: "4d288ae5642033379354f6edec6da80169febedd", class: "toast-message" }, h("slot", { key: "b0bd97e15ff9f15bc5816fe861d4577e8c373570" })), h("div", { key: "ca3cce88f052d03ddfa509420b28e0a67de07d92", class: "toast-action" }, h("slot", { key: "7bd8ee1dae26a145c4416ad54dbf81061e5577ce", name: "action" }))), h("div", { key: "b893027727c9cb175e381396ac45838ea72f7790", class: "toast-close" }, h("ix-icon-button", { key: "9f663eb23d05cc330a792f366f6843f04c51440a", icon: iconClose, iconColor: "color-soft-text", size: "24", variant: "tertiary", onClick: () => this.closeToast.emit(), "aria-label": this.ariaLabelCloseIconButton }))), !this.preventAutoClose && h("div", { key: "37d3000f8fc7fcd1bc6794f03b6a0d81557d32b3", class: progressBarClass.join(" "), style: progressBarStyle, onAnimationEnd: () => {
      this.close();
    }, onTransitionEnd: () => {
      if (this.progress === 0) {
        this.close();
