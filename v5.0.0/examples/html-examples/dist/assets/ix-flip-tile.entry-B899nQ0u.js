...
const FlipTile = class {
  ...
  render() {
    return h(Host, { key: "bd8a2eb3386c164bd4ff179a7ea1ff1417efd117", class: {
    ...
    } }, h("div", { key: "823700f1744d08fa59eb9239063c050277334e93", class: "flip-tile-container" }, h("div", { key: "ab310b191e33bba773efa243a71144b9890d1154", class: "flip-tile-header" }, h("div", { key: "fe7f64da4f6f121ae7c720914af5b5209d06b3bb", class: "header-slot-container text-l-title" }, h("slot", { key: "3cb760ed96320f30686774a0a80589e1cfafc8e5", name: "header" })), h("ix-icon-button", { key: "beee248ddcd7dd6c2e4e9541a047059f88732712", icon: iconEye, variant: "tertiary", onClick: () => this.toggleIndex(), "aria-label": this.ariaLabelEyeIconButton })), h("div", { key: "519e64b7595189feb560ee18e5de637bf39180ad", class: "content-container" }, h("slot", { key: "3d69bdf97614d3848429aafd25beee6fdc4269ea" })), h("div", { key: "853f0bd49c86fc59dc2e3328ddd45f7f758ad0c4", class: {
      footer: true,
      "show-footer": this.hasFooterSlot
    } }, h("slot", { key: "e812377f159e158b1bbd6d890c357a8a86c07541", name: "footer", onSlotchange: (event) => this.handleFooterSlotChange(event) }))));
  }
  static get watchers() {
    return {
      "index": [{
