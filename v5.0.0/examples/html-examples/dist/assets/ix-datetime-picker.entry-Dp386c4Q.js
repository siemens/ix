...
import { a as TRAP_FOCUS_INCLUDE_ATTRIBUTE } from "./focus-trap-DTPUFpoe-Z3TwaH2V.js";
...
const DatetimePicker = class {
  ...
  render() {
    ...
    return h(Host, { key: "cbba077ebaf587f967ce515f11e18fe2e43eaf1f" }, h("ix-date-time-card", { key: "a4cdfb34fd16e58942eab146efff49952c6608b1", hideHeader: true, hasFooter: true, embedded: this.embedded, corners: "rounded", noPadding: true }, h("ix-layout-grid", { key: "c56710ce4d880c76b7e58168a282c72e00fbdc75", class: "no-padding" }, h("ix-row", { key: "597178bdde9a7d7ee884e51846cf8da263ee0419", class: "row-separator" }, h("ix-col", { key: "d753a2e3223711a47a35703f4623399efe16fc32", class: "col-separator" }, h("ix-date-picker", {
      key: "1b7d576358be70cb097a8f0e8f6d150644cb9cfb",
    ...
    })), h("ix-col", { key: "88a3f5209ba259ddc0e8ad32aa05ba73a83fabea" }, h("ix-time-picker", {
      key: "19e1fefb58164caaa8d3ee37839aede1be0af2dc",
      class: "min-width",
      ...
      tabIndex: this.embedded ? -1 : 0,
      [TRAP_FOCUS_INCLUDE_ATTRIBUTE]: this.embedded
    })))), h("div", { key: "7092dc4d1e8803bbf813db139a877e67b175b94a", slot: "footer", class: "btn-select-date-container" }, h("ix-button", { key: "b495dc4e5fcf9f910c250ebd7d8cc4951e07a51b", class: "btn-select-date", onClick: () => this.onDone() }, this.i18nDone))));
  }
  static get watchers() {
    return {
      "from": [{
