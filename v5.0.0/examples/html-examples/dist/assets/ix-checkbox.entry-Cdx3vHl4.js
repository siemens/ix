...
const Checkbox = class {
  ...
  render() {
    return h(Host, { key: "27fcc3d8b7a7c276bd70c3fae4e81ae2dbc6b9a7", "aria-checked": a11yBoolean(this.checked), "aria-disabled": a11yBoolean(this.disabled), role: "checkbox", class: {
      disabled: this.disabled,
      checked: this.checked,
      indeterminate: this.indeterminate,
      "label-less": this.isLabelLess
    }, onFocus: () => this.touched = true, onBlur: () => this.ixBlur.emit() }, h("label", { key: "60bdea18f82155cd75b69e88ba474791bcdb20d4" }, h("input", { key: "88471ba607d8278915a0d0234b562d92a5a6f093", "aria-checked": a11yBoolean(this.checked), required: this.required, disabled: this.disabled, checked: this.checked, ref: this.inputRef, type: "checkbox", onChange: () => this.setCheckedState(!this.checked) }), h("div", { key: "ba9143d623cb8c2a8e98281d91dbdac07962b760", class: "checkbox-button" }, h("button", { key: "94284c54f63167e713d13f23c5de50675d998d97", disabled: this.disabled, class: {
      checked: this.checked
    }, onClick: () => this.setCheckedState(!this.checked) }, this.renderCheckmark())), h("ix-typography", { key: "ed60accf58c02ae6a79ee9ef24e62781033198bc", format: "label", textColor: this.disabled ? "weak" : "std" }, this.label, h("slot", { key: "2a46d6a98c5d311a2832734f11691a9b95b349f1", onSlotchange: () => this.updateDefaultSlotElements(), ref: (element) => this.defaultSlotElement = element }))));
  }
