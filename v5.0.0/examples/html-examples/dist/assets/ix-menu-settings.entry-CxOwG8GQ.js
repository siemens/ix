import { a as registerInstance, c as createEvent, g as getElement, f as forceUpdate, h, H as Host } from "./global-B8nXsUf-.js";
import { r as iconClose } from "./index-DgUGsIlh-FNhczk6p.js";
...
const MenuSettings = class {
  ...
  render() {
    return h(Host, { key: "dee3ffc4c3b97134735ca00ab12323c70d2e78ae", slot: "ix-menu-settings", class: {
      show: this.show,
      ["legacy-tabs"]: !this.suppressLegacyTabs
    } }, h("div", { key: "d6f13159e828c6c1666de15be88e7ed4ebc308ae", class: "settings-header" }, h("h2", { key: "08f990883ac3cdc80a4368e2bd9a36ac791e455e", class: "text-h2" }, this.label), h("ix-icon-button", { key: "44aefd45d7e5f9354c0707c4a81fe22ff20ef69f", variant: "tertiary", size: "24", icon: iconClose, iconColor: "color-soft-text", "aria-label": this.ariaLabelCloseButton, onClick: (e) => this.close.emit({
