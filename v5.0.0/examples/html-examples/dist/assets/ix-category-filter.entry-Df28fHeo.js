...
import { r as iconSearch, q as iconClear } from "./index-DgUGsIlh-CLxQRaVd.js";
...
const CategoryFilter = class {
  ...
  render() {
    return h(Host, { key: "a6731ab1bc92484c8f7420ab74e144146c47ad5d" }, h("form", { key: "97b6f5f6bc4fc0b452d725d375924387e1c0dd21", ref: (el) => this.formElement = el }, h("div", { key: "b5b0a1c793713184fda790527be770b25fb1a89f", "read-only": this.readonly, class: {
      "input-container": true,
      disabled: this.disabled,
      focus: this.hasFocus,
      readonly: this.readonly,
      "no-icon": this.hideIcon
    } }, h("ix-icon", { key: "cf331949ca5e5c06fb082f5c92c5708435a4b057", color: this.getIconColor(), class: { "display-none": this.hideIcon }, name: this.icon ?? iconSearch, size: "16" }), h("div", { key: "804f46e81d2df9d96c0392c50ba6b2a81cd80588", class: "token-container" }, h("div", { key: "f5f923e1a143f7bd40a20cbb31666d8872dde2fc", class: "list-unstyled" }, this.filterTokens.map((value, index) => h("span", { key: value.toString(), class: {
    ...
    } }, this.categories[this.category]?.label), h("input", { key: "ce2fbed09069995b117b284f14427138ba7ac894", class: {
      "text-input": true,
