...
const RangeField = class extends Mixin(...DefaultMixins) {
  ...
  render() {
    return h(Host, { key: "29c7f6d10af31b782fc5027082c4a2539f1cbb89", class: { "hide-arrow": this.hideArrow }, role: "group" }, !this.hideArrow && h("ix-icon", { key: "48c791902c3d3627a66c6ecf2646cff8b7eab8d3", "aria-hidden": "true", class: {
      "range-delimiter": true,
      "has-label": this.hasLabel
    }, name: iconArrowRight }), h("slot", { key: "62fa3b5e0f9ccb4494e2cdf2c3feb9cd1d597343" }));
  }
};
