...
const DatePicker = class extends Mixin(...DefaultMixins) {
  ...
  render() {
    return h(Host, { key: "792306b2e9e2a2a40bb7f893eb7973a4203f2b0c", onKeyDown: (event) => this.onKeyDown(event), onFocusin: () => {
      if (hasKeyboardMode()) {
        this.changeFocusedDay();
      }
    } }, h("ix-date-time-card", { key: "9354237ae9fcfc9204cc8356960665c9ed976f93", corners: this.corners, embedded: this.embedded }, h("div", { key: "c83546fae6dca1265197985154b56a07eb3d55e6", class: "header", slot: "header" }, h("ix-icon-button", { key: "a24fa43a84b5610134cea0ac6bbd010bd4aea179", onClick: () => this.changeCalendarView(-1), icon: iconChevronLeftSmall, variant: "tertiary", class: "arrows", "aria-label": this.ariaLabelPreviousMonthButton }), h("div", { key: "4b37bbd568552ac0c2e0b388f15cdb5362f84cb0", class: "selector" }, h("ix-dropdown-button", { key: "64144923911fd042b9a6092fdc023dd875cec14f", class: "month-selector", focusCheckedItem: true, "aria-label": this.ariaLabelMonthSelection, variant: "tertiary", label: null, onShowChanged: (event) => {
      event.stopPropagation();
    } }, h("ix-typography", { key: "4fd2a05d70b90cd7c3db8420283cfd1922a57080", bold: true, class: "capitalize", slot: "button-label" }, this.monthNames[this.selectedMonth]), this.renderMonths()), h("ix-dropdown-button", { key: "3ae91c2a411c60b034a4f333b228634b933df7a1", class: "year-selector", focusCheckedItem: true, "aria-label": this.ariaLabelYearSelection, ref: this.yearDropdownButtonRef, variant: "tertiary", label: null, onShowChanged: (event) => {
      event.stopPropagation();
      if (event.detail) {
        requestAnimationFrameNoNgZone(() => {
    ...
    } }, h("div", { key: "ec62dc4f12ab649f12fce244daf6214230844171", class: "infinite-scrolling-spacer" }, h("div", { key: "9a2cbf4d148a03a2e09aff07f7bf469241655184", class: "sentinel", "data-sentinel": "top" })), h("ix-typography", { key: "000306484356ee15ff03ed61acb9d1953969b95a", bold: true, class: "capitalize", slot: "button-label" }, this.selectedYear), this.renderYears(), h("div", { key: "9c3655e82b3aeac15d880c8d412e48a633a6ebcc", class: "infinite-scrolling-spacer" }, h("div", { key: "97c21af45ae2467fa4c1707ba9a1d7fc2656b963", class: "sentinel", "data-sentinel": "bottom" })))), h("ix-icon-button", { key: "e6402d0d9ee64ca485eb0caadc01739d4441dbc0", onClick: () => this.changeCalendarView(1), icon: iconChevronRightSmall, variant: "tertiary", class: "arrows", "aria-label": this.ariaLabelNextMonthButton })), h("div", { key: "e8faa36ad2d309f1f931881c4896d7dac7dd4d47", role: "grid", class: {
      grid: true,
      "grid--show-week-numbers": this.showWeekNumbers
    } }, h("div", { key: "a1b41b00e63710654b847a36f21ac25b71106a51", role: "row" }, this.showWeekNumbers && h("div", { key: "f191a057b1d652db2fd15e3942c5163b7b822d26", class: "calendar-item week-day", role: "columnheader" }), this.dayNames.map((name) => h("div", { key: name, class: "calendar-item week-day", role: "columnheader" }, h("div", { class: "overflow" }, name.slice(0, 3))))), this.calendar.map((week) => {
    ...
    })), h("div", { key: "3119ad673abdffc9a434a6fb162380d364c25238", class: {
      button: true,
      hidden: this.singleSelection || this.embedded
    } }, h("ix-button", { key: "020610f0799ba310739436f8f5f59c1c0b4be7cc", hidden: this.singleSelection || this.embedded, onClick: () => this.onDone() }, this.i18nDone))));
  }
