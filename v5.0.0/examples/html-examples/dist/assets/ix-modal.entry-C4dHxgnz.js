...
const Modal = class {
  ...
  render() {
    return h(Host, { key: "d9da20df3ae43bd6b842fff4202e99d23b3ae0c4", class: {
      visible: this.modalVisible,
      "no-backdrop": this.hideBackdrop,
      "align-center": this.centered,
      "non-blocking": this.isNonBlocking
    } }, h("div", { key: "8e7c36d181249cb989dbb4e393fdc0e0ada9f4ad", class: "dialog-backdrop" }, h("dialog", { key: "52d5884b8dc229b391591c40cbb4ac1b73ac5914", "aria-modal": a11yBoolean(!this.isNonBlocking), "aria-describedby": this.ariaAttributes["aria-describedby"], "aria-labelledby": this.ariaAttributes["aria-labelledby"], class: {
      modal: true,
      ...
      e.preventDefault();
      void this.dismissModal();
    } }, h("slot", { key: "d393eac88ea9373ae8ba8d8d90dde21536866266" }))));
  }
};
