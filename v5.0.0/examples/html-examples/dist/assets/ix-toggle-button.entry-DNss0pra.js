...
const ToggleButton = class extends Mixin(...DefaultMixins, InheritAriaAttributesMixin) {
  ...
  render() {
    ...
    return h(Host, { key: "b486dcb4e9c0b05eaf86aa8e5a6af2712ee9a282", class: {
      disabled: this.disabled || this.loading
    } }, h(BaseButton, { key: "df82eb0c23a2ef08956712ea5cd3362b082b1ee0", ...baseButtonProps }, h("slot", { key: "fa64b8f2b54740fe128f94d3e743d72d064b2a66" })));
  }
  static get watchers() {
    return {
      "role": [{
