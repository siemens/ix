...
- avatar
  - angular: [angular/avatar.ts](../../examples/angular-examples/src/preview-examples/avatar.ts)
  - angular-standalone: [angular-standalone/avatar.ts](../../examples/angular-standalone-examples/src/preview-examples/avatar.ts)
  - html: [html/avatar.html](../../examples/html-examples/src/preview-examples/avatar.html)
  - react: [react/avatar.tsx](../../examples/react-examples/src/preview-examples/avatar.tsx)
  - vue: [vue/avatar.vue](../../examples/vue-examples/src/preview-examples/avatar.vue)
- avatar-image
  - angular: [angular/avatar-image.ts](../../examples/angular-examples/src/preview-examples/avatar-image.ts)
  - angular-standalone: [angular-standalone/avatar-image.ts](../../examples/angular-standalone-examples/src/preview-examples/avatar-image.ts)
  - html: [html/avatar-image.html](../../examples/html-examples/src/preview-examples/avatar-image.html)
  - react: [react/avatar-image.tsx](../../examples/react-examples/src/preview-examples/avatar-image.tsx)
  - vue: [vue/avatar-image.vue](../../examples/vue-examples/src/preview-examples/avatar-image.vue)
- avatar-initials
  - angular: [angular/avatar-initials.ts](../../examples/angular-examples/src/preview-examples/avatar-initials.ts)
  - angular-standalone: [angular-standalone/avatar-initials.ts](../../examples/angular-standalone-examples/src/preview-examples/avatar-initials.ts)
  - html: [html/avatar-initials.html](../../examples/html-examples/src/preview-examples/avatar-initials.html)
  - react: [react/avatar-initials.tsx](../../examples/react-examples/src/preview-examples/avatar-initials.tsx)
  - vue: [vue/avatar-initials.vue](../../examples/vue-examples/src/preview-examples/avatar-initials.vue)
