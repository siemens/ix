...
- content
  - angular:
    - `angular/content.html`: [source](../../examples/angular-examples/src/preview-examples/content.html)
    - `angular/content.ts`: [source](../../examples/angular-examples/src/preview-examples/content.ts)
  - angular-standalone:
    - `angular-standalone/content.html`: [source](../../examples/angular-standalone-examples/src/preview-examples/content.html)
    - `angular-standalone/content.ts`: [source](../../examples/angular-standalone-examples/src/preview-examples/content.ts)
  - html:
    - `html/content.html`: [source](../../examples/html-examples/src/preview-examples/content.html)
  - react:
    - `react/content.tsx`: [source](../../examples/react-examples/src/preview-examples/content.tsx)
  - vue:
    - `vue/content.vue`: [source](../../examples/vue-examples/src/preview-examples/content.vue)
- content-header
  - angular:
